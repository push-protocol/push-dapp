...
function ViewChannelItem({ channelObjectProp }) {
    ...
    const fetchChannelJson = async () => {
        try {
            ...
            const channelSubscribers = await postReq(
    ...
    const verifyChannel = () => {
        ...
        epnsWriteProvider
            ...
            .catch((err) => {
                ...
                toaster.update(notificationToast(), {
                    render:
                        "Transacion Failed: " + err.error?.message ||
                        "Unknown Error",
                                ...
                                {isVerified && (
                                    ...
                                    >
                                        <GoVerified
                                            size={18}
                                            color={
                                                themes.viewChannelVerifiedBadge
                                            }
                                        />
                                    </Subscribers>
                                )}
                                ...
                                <FlexBox style={{ marginBottom: "5px" }}>
                                    <Subscribers>
                                        <IoMdPeople
                                            size={20}
                                            color={
                                                themes.viewChannelSecondaryIcon
                                            }
                                        />
                                        <SubscribersCount>
                                            {memberCount}
                        ...
                        <ChannelActions>
                            ...
                            {!loading && isPushAdmin && (
                                ...
                                >
                                    ...
                                    <ActionTitle hideit={bLoading}>
                                        Block channel
                                    </ActionTitle>
                                </SubscribeButton>
                            )}
                            {!loading &&
                                (isPushAdmin || canVerify) &&
                                !isVerified && (
                                    <SubscribeButton
                                    ...
                                    >
                                        ...
                                        <ActionTitle hideit={vLoading}>
                                            Verify Channel
                                        </ActionTitle>
                                    </SubscribeButton>
                                )}
                            {!loading &&
                                (isPushAdmin || canUnverify) &&
                                isVerified && (
                                    <UnsubscribeButton
