                ...
                <Content padding="10px 20px 20px">
                    <Item align="flex-start">
                        ...
                        <H3 color={themes.createColor}>
                            ...
                            (EPNS) makes it extremely easy to open and maintain
                            a genuine channel of communication with your users.
                        </H3>
                    </Item>
                </Content>
            </Section>
            ...
            {!uploadDone && (
                <Section>
                    <Content padding="50px 20px 20px">
                        <Item align="flex-start">
                            <H3 color="#e20880">
                                Upload Channel Logo to start the process. Make
                                sure image is 128x128px.
                            </H3>
                        </Item>
