...
const tokens = function (amount) {
    return bn(amount).mul(bn(10).pow(18)).toString();
};
const tokensBN = function (amount) {
...
export default function PoolCard({
    ...
    const [txInProgressWithdraw, setTxInProgressWithdraw] =
    ...
    const fillMax = async () => {
        ...
        setDepositAmountToken(
            parseInt(balance.toString().replace(/\D/, "")) || 0
        );
    };
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {numberWithCommas(
                                    formatTokens(
                                        pushPoolStats.rewardForCurrentEpoch
                                    )
                                )}{" "}
                                PUSH
                            </PoolBoxMsg>
                        ...
                        >
                            ...
                            >
                                {numberWithCommas(
                                    formatTokens(pushPoolStats.poolBalance)
                                )}{" "}
                                {poolName == "Uniswap LP Pool (UNI-V2)"
                                    ? "UNI-V2"
                                    : "PUSH"}
                ...
                >
                    ...
                    <ItemH margin="0px">
                        <Item bg="#000" margin="5px 10px" radius="12px">
                            ...
                            <PoolBoxMsg>
                                {userData.potentialUserReward} PUSH
                            </PoolBoxMsg>
                        </Item>
                        ...
                        <Item bg="#000" margin="5px 10px" radius="12px">
                            ...
                            <PoolBoxMsg>
                                {userData.totalAvailableReward} PUSH
                            </PoolBoxMsg>
                        </Item>
                    </ItemH>
                </Item>
                        ...
                        {!showDepSlip && (
                            <>
                                ...
                                <ItemH>
                                    <ButtonAlt
                                        bg={
                                            depositApproved ? "#999" : "#e20880"
                                        }
                                        onClick={approveDeposit}
                                        disabled={
                                            depositApproved ? true : false
                                        }
                                    >
                                        {!depositApproved &&
                                            !txInProgressApprDep && (
