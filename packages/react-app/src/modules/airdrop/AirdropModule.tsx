  ...
  return (
    <Container>
      ...
      <Item align="flex-start" padding="20px 0px">
        <Para margin="10px 0px 0px 0px" color={theme.color}>Thanks for the ton of support, feedback, encouragement and helping us out in every step! As a small token of our gratitude, we are dropping <B color={theme.color}>1200 $PUSH</B> to anyone who:</Para>

        <Para margin="20px 0px 0px 20px" color={theme.color}>- Donated to us on <B color={theme.color}>Gitcoin grants round 6 or 7</B></Para>
        <Para margin="10px 0px 0px 20px" color={theme.color}>- Used our dApp on or before <B color={theme.color}>20th March, 2021</B>: <AMod href="https://app.epns.io" target="_blank" title="Visit our dApp">EPNS dApp</AMod></Para>
      </Item>
