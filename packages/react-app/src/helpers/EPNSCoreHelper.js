                ...
                .then((response) => {
                    ...
                    response.forEach(function (item) {
                        if (
                            ...
                            filteredResponse = ethers.utils.toUtf8String(
                                item.args.identity
                            );
                        }
                    });
                ...
                .then((response) => {
                    ...
                    const hash =
                        channel === COINDESK_CHANNEL_ADDR
                            ...
                            ? ENS_HASH
                            : response;
                    return EPNSCoreHelper.getJsonFileFromIdentity(
                        hash,
                        channel
                    );
        ...
        return new Promise((resolve, reject) => {
            ...
            contract
                ...
                .then((response) => {
                    ...
                    if (enableLogs)
                        console.log(
                            "Public Key Registry Response: " + response
                        );
                    if (enableLogs)
                        console.log(
                            "Public Key Registry Filtered: " + filteredResponse
                        );
