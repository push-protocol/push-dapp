      ...
      <NavigationContextProvider>
        <UserContextProvider>
          ...
          <ParentContainer headerHeight={GLOBALS.CONSTANTS.HEADER_HEIGHT}>
            ...
            {!active && (
              <Item justify="flex-start" padding="15px">
                ...
                >
                  <H2 textTransform="uppercase" spacing="0.1em">
                    ...
                    <Span weight="200" color={darkMode ? themeDark : themeLight}>
                      {' '}
                      Your Wallet
                    </Span>
                  </H2>
                ...
                <Item flex="initial" padding="30px 15px" radius="12px">
                  <StyledItem>
                    <span> Note: </span> The EPNS protocol has been under development for 1+ year, and completed a{' '}
                    <C href="https://epns.io/EPNS-Protocol-Audit2021.pdf" target="_blank">
                      {' '}
                      ChainSafe audit{' '}
                    </C>{' '}
                    in October 2021. However, the mainnet is still a new product milestone. Always DYOR, and anticipate
                    bugs and UI improvements. Learn how to report any bugs in our{' '}
                    <C href="https://discord.com/invite/YVPB99F9W5" target="_blank">
                      Discord.
                    </C>
                  </StyledItem>
                </Item>
...
const ProviderButton = styled.button`
  ...
  outline: 0;
  providerbuttonbox-shadow: 0px 15px 20px -5px rgba(0, 0, 0, 0.1);
  border-radius: 15px;
