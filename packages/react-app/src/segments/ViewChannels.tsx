...
function ViewChannels() {
    ...
    React.useEffect(() => {
        const parsedChannel = window.location.href
            .toString()
            .slice(window.location.href.toString().length - 42);
        ...
        <ThemeProvider theme={themes}>
            <Container>
                {!loading && channels.length == 0 ? (
                    ...
                    <ScrollItem>
                        {!loading && (
                            <ItemH padding="10px 0px" flex="initial">
                                <Item flex="1" margin="10px" minWidth="320px">
                                    <SearchBar
                                        type="text"
                                        value={search}
                                        onChange={(e: any) =>
                                    ...
                                    >
                                        <AiOutlineSearch
                                            size={20}
                                            style={{
                                                color: themes.viewChannelSearchIcon,
                                            }}
                                        />
                                    </Item>
                                </Item>
