...
function GovernancePage({ epnsReadProvider, epnsWriteProvide }) {
    ...
    React.useEffect(() => {
        ...
        Promise.all(allDelegateesPromise).then((allDelegatees) => {
            ...
            const sortedDelegatees = [...delegateesAbove75k].sort(
                votingPowerSorter
            );
            setPushDelegatees(sortedDelegatees);

            // calculate for  the nominees (i.e peoplw who have voting power less than 75k)
            const delegateesBelow75k = allDelegatees.filter(
                ({ votingPower }) => {
                    return votingPower < VOTING_TRESHOLD;
                }
            );

            const sortedNominees = [...delegateesBelow75k].sort(
                votingPowerSorter
            );
                ...
                <Content themes={themes.mainBg} padding="20px 20px 30px 20px">
                                                    ...
                                                    >
                                                        ...
                                                        <Input
                                                            ...
                                                            onChange={async (
                                                                ...
                                                                setNewDelegateeAddress(
                                                                    e.target
                                                                        .value
                                                                );
                                                                setNewDelegateeVotingPower(
                                                                    null
                                                                );
                                                            }}
                                                        />
                                                        {newDelegateeVotingPower &&
                                                            newDelegateeAddress && (
                                                                <StatsInnerTitle>
                                                                    Voting
                                                                    Power:{" "}
                    ...
                    >
                        <StatsCard
                            ...
                            bg={themes.mainBg}
                        >
                            <StatsHeading bg="#35c5f3">
                                Meet the PUSH Nominees
                            </StatsHeading>
                            <NomineeContainer>
                                {delegateesLoading ? (
                                    <ContainerInfo>
                        ...
                        <Item align="stretch" margin="0px 0px 0px 0px">
                            <QnAItem>
                                ...
                                {showAnswers[0] && (
                                    <Answer>
                                        <Span>
                                            Active community members who have at
                                            least <b>75,000 $PUSH</b> delegated
                                            to them. They will be able to create
                                            proposals on Snapshot that are
                                            approved on the{" "}
                                            <AMod href="https://gov.epns.io/">
                                                {" "}
                                                forum{" "}
                                            </AMod>
                                        </Span>
                            ...
                            <QnAItem>
                                ...
                                {showAnswers[1] && (
                                    <Answer>
                                        <Span>
                                            Active community members who can be
                                            delegated $PUSH to vote for
                                            proposals Snapshot. If you wish to
                                            be PUSH Nominee, submit your
                                            nomination
                            ...
                            <QnAItem>
                                ...
                                {showAnswers[2] && (
                                    <Answer>
                                        ...
                                        <Span>
                                            Now, once your nomination receives
                                            minimum of 10 likes, We will be
                                            adding your wallet address on our
                                            Governance Front end within 5-7
                                            days. And later community members
                                            can start delegating votes to you.
                                        </Span>
                                    </Answer>
                                )}
                            </QnAItem>
                            ...
                            <QnAItem>
                                ...
                                >
                                    <Span color={themes.color}>
                                        What if I don't wish to be a PUSH
                                        Nominee?
                                    </Span>
                                    <BsChevronExpand size={20} color={"#ddd"} />
                                </Question>
                                ...
                                {showAnswers[3] && (
                                    <Answer>
                                        <Span>
                                            No problem! You can show support to
                                            your favourite PUSH Nominees by
                                            liking their nominations{" "}
                                            <AMod href="https://gov.epns.io/t/epns-push-delegatee-nominations/21">
                                                here
                                            </AMod>
                                            .
                                ...
                                {showAnswers[4] && (
                                    <Answer>
                                        <Span>
                                            ...
                                            and introduce yoursef on the
                                            platform in the suggested format.
                                        </Span>
                                    </Answer>
                                )}
                            </QnAItem>
                            ...
                            <QnAItem>
                                ...
                                >
                                    <Span color={themes.color}>
                                        What happens to the delegated voting
                                        power when I sell my PUSH tokens?
                                    </Span>
                                    <BsChevronExpand size={20} color={"#ddd"} />
                                </Question>
                                ...
                                {showAnswers[5] && (
                                    <Answer>
                                        <Span>
                                            If you delegate your voting power to
                                            someone/yourself and later you sell
                                            your PUSH tokens, then the voting
                                            power of those tokens gets revoked.
                                            Now the new owner gets to decide
                                            whom to delegate to.{" "}
                                        </Span>
                                    </Answer>
                                )}
                                ...
                                {showAnswers[6] && (
                                    <Answer>
                                        <Span>
                                            ...
                                            >
                                                EPNS Governance - Snapshot
                                                Portal
                                            </AMod>{" "}
                                            to view the ongoing on-chain
                                            proposals and cast your vote.
                                        </Span>
                                    </Answer>
                                )}
                            </QnAItem>
