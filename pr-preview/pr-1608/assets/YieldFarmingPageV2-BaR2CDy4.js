...
`,en=p(O)`
  ...
  font-size: 0.625rem;
  text-align:left;
`,ge="data:image/svg+xml,%3csvg%20width='17'%20height='17'%20viewBox='0%200%2017%2017'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20clip-path='url(%23clip0_15284_45077)'%3e%3cpath%20d='M8.5%2014.5C11.8137%2014.5%2014.5%2011.8137%2014.5%208.5C14.5%205.18629%2011.8137%202.5%208.5%202.5C5.18629%202.5%202.5%205.18629%202.5%208.5C2.5%2011.8137%205.18629%2014.5%208.5%2014.5Z'%20stroke='%23797D8F'%20stroke-width='1.2'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M8%208C8.13261%208%208.25979%208.05268%208.35355%208.14645C8.44732%208.24021%208.5%208.36739%208.5%208.5V11C8.5%2011.1326%208.55268%2011.2598%208.64645%2011.3536C8.74021%2011.4473%208.86739%2011.5%209%2011.5'%20stroke='%23797D8F'%20stroke-width='1.2'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M8.25%206.5C8.66421%206.5%209%206.16421%209%205.75C9%205.33579%208.66421%205%208.25%205C7.83579%205%207.5%205.33579%207.5%205.75C7.5%206.16421%207.83579%206.5%208.25%206.5Z'%20fill='%23797D8F'/%3e%3c/g%3e%3cdefs%3e%3cclipPath%20id='clip0_15284_45077'%3e%3crect%20width='16'%20height='16'%20fill='white'%20transform='translate(0.5%200.5)'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e",G=n=>n.div(y.from(10).pow(18)).toString(),X=n=>{var t;return(t=n==null?void 0:n.toString())==null?void 0:t.replace(/\B(?=(\d{3})+(?!\d))/g,",")},tn=function(n,t=null){return y.from(n)},nn=function(n){return n.div(tn(10).pow(18))},wt=({poolName:n,userData:t,PoolStats:a,poolAddress:o,getUserData:s,tokenAddress:i,setActiveTab:r})=>{const{account:l,provider:d}=Ce(),[h,m]=u.useState(!1),[x,F]=u.useState(!1),[I,w]=u.useState(!1),[U,B]=u.useState(null),[K,te]=u.useState(null),[Y,re]=u.useState(null),{userPushSDKInstance:W}=Ot(j=>j.user),{handleConnectWallet:L}=u.useContext($t),[b,R]=u.useState(0),T=Be(),k=Ve(),ee=async()=>{if(!W.signer){L();return}if(!x){if((t==null?void 0:t.totalAvailableReward)==0){re("No Rewards to Claim"),F(!1);return}F(!0);var j=d.getSigner(l);new A(o,v.yieldFarming,j).massHarvest().then(async f=>{T.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{await d.waitForTransaction(f.hash),T.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:S=>e.jsx(he,{size:S,color:"green"})}),s(),F(!1)}catch(S){T.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${S.name}+ ")`,toastType:"ERROR",getToastIcon:z=>e.jsx($,{size:z,color:"red"})}),F(!1)}}).catch(f=>{T.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Cancelled!",toastType:"ERROR",getToastIcon:S=>e.jsx($,{size:S,color:"red"})}),F(!1)})}},J=async()=>{if(!W.signer){L();return}if(h)return;m(!0);const j=G(t.epochStakeNext);if(j==0){te("Nothing to unstake, Stake Now in new reward program."),m(!1);return}var f=d.getSigner(l);let S=new A(c.staking,v.staking,f);await S.balanceOf(l,i),S.withdraw(i,y.from(j).mul(y.from(10).pow(18))).then(async z=>{T.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{await d.waitForTransaction(z.hash),T.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:C=>e.jsx(he,{size:C,color:"green"})}),m(!1),s()}catch(C){console.error("Error",C),T.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${C.name}+ ")`,toastType:"ERROR",getToastIcon:P=>e.jsx($,{size:P,color:"red"})}),m(!1)}}).catch(z=>{T.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Cancelled!",toastType:"ERROR",getToastIcon:C=>e.jsx($,{size:C,color:"red"})}),m(!1)})},we=async()=>{if(!W.signer){L();return}if(I)return;let j=3;const f=G(t.epochStakeNext);if(f==0){T.showMessageToast({toastTitle:"Error",toastMessage:"Nothing to Withdraw!",toastType:"ERROR",getToastIcon:H=>e.jsx($,{size:H,color:"red"})}),w(!1),B(null);return}var S=d.getSigner(l);let z=new A(c.staking,v.staking,S);const C=i===c.pushToken?c.pushCoreV2:c.stakingV2;var P=new A(i,v.pushToken,S);let V=await P.allowance(l,C),q=G(V);parseInt(q)>=parseInt(f)?(j=2,R(50)):(j=3,R(33)),w(!0),B(`Withdrawing 1/${j}`);let se;se=z.withdraw(i,y.from(f).mul(y.from(10).pow(18))),se.then(async H=>{if(T.showLoaderToast({loaderMessage:"Withdrawing! Please Wait..."}),await d.waitForTransaction(H.hash),T.showMessageToast({toastTitle:"Success",toastMessage:"Successfully withdrawn!",toastType:"SUCCESS",getToastIcon:pe=>e.jsx(he,{size:pe,color:"green"})}),i===c.pushToken){var de=new A(i,v.pushToken,S);let pe=await de.allowance(l,c.pushCoreV2),ye=G(pe);parseInt(ye)>=parseInt(f)?ne(H,f,j):(H=de.approve(c.pushCoreV2,y.from(f).mul(y.from(10).pow(18))),B(`Approving 2/${j}`),R(66),H.then(async ae=>{T.showLoaderToast({loaderMessage:"Approving! Please Wait..."}),await d.waitForTransaction(ae.hash),T.showMessageToast({toastTitle:"Success",toastMessage:"Successfully Approved!",toastType:"SUCCESS",getToastIcon:oe=>e.jsx(he,{size:oe,color:"green"})}),ne(ae,f,j)}).catch(ae=>{console.error("Error in approving 2",ae),T.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Failed! Could Not Approve",toastType:"ERROR",getToastIcon:oe=>e.jsx($,{size:oe,color:"red"})}),w(!1),B(null),s(),R(0)}))}else{var de=new A(i,v.pushToken,S);let ye=await de.allowance(l,c.stakingV2),ae=G(ye);parseInt(ae)>=parseInt(f)?D(H,f,j):(H=de.approve(c.stakingV2,y.from(f).mul(y.from(10).pow(18))),B(`Approving 2/${j}`),R(66),H.then(async oe=>{T.showLoaderToast({loaderMessage:"Approving! Please Wait..."}),await d.waitForTransaction(oe.hash),T.showMessageToast({toastTitle:"Success",toastMessage:"Successfully Approved!",toastType:"SUCCESS",getToastIcon:De=>e.jsx(he,{size:De,color:"green"})}),D(oe,f,j)}).catch(oe=>{console.error("Error in approving",oe),T.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Failed! Could Not Approve",toastType:"ERROR",getToastIcon:De=>e.jsx($,{size:De,color:"red"})}),w(!1),B(null),s(),R(0)}))}}).catch(H=>{console.error("Error in withdrawing: ",H),T.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Failed! Could Not Withdraw!",toastType:"ERROR",getToastIcon:de=>e.jsx($,{size:de,color:"red"})}),w(!1),B(null),R(0)})},D=async(j,f,S)=>{if(!W.signer){L();return}var z=d.getSigner(l),C=new A(c.stakingV2,v.stakingV2,z);B(`Staking ${S}/${S}`),R(100),j=C.deposit(i,y.from(f).mul(y.from(10).pow(18))),j.then(async P=>{T.showLoaderToast({loaderMessage:"Depositing to V2 ! Please Wait..."}),await d.waitForTransaction(P.hash),T.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!Successfully Deposited the UNI-V2 Token to V2 ",toastType:"SUCCESS",getToastIcon:V=>e.jsx(he,{size:V,color:"green"})}),w(!1),s(),B(null),r(0)}).catch(P=>{console.error("Error in depositing: ",P),T.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Failed! Could Not Deposit the Amount",toastType:"ERROR",getToastIcon:V=>e.jsx($,{size:V,color:"red"})}),w(!1),s(),B(null),R(0)})},ne=async(j,f,S)=>{if(!W.signer){L();return}var z=d.getSigner(l);let C=new A(c.pushCoreV2,v.pushCoreV2,z);B(`Staking ${S}/${S}`),R(100),j=C.stake(y.from(f).mul(y.from(10).pow(18))),j.then(async P=>{T.showLoaderToast({loaderMessage:"Depositing to V2 ! Please Wait..."}),await d.waitForTransaction(P.hash),T.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed! Successfully Deposited the Push Token to V2 ",toastType:"SUCCESS",getToastIcon:V=>e.jsx(he,{size:V,color:"green"})}),w(!1),s(),B(null),r(0)}).catch(P=>{console.error("Error in depositing: ",P),T.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Failed! Could Not Deposit Push Token",toastType:"ERROR",getToastIcon:V=>e.jsx($,{size:V,color:"red"})}),w(!1),s(),B(null),R(0)})};u.useEffect(()=>{re(null),te(null)},[l]);const _=ve(600);return e.jsxs(an,{margin:n==="UNI-V2"?" 10px 0 10px 10px ":"  10px 10px 10px 0",children:[e.jsx(M,{margin:"0px 0px 20px 0",children:a?e.jsxs(e.Fragment,{children:[e.jsxs(sn,{children:[n==="UNI-V2"?"Uniswap V2 Staking Pool":"PUSH Staking Pool ",e.jsx(on,{children:"Deprecated"})]}),e.jsxs(st,{children:["Current APR"," ",e.jsx(Te,{color:"#D53A94",fontWeight:"600",children:"0%"})]})]}):e.jsxs(Ue,{padding:"15px 15px 0 15px",children:[e.jsx(g,{height:"15px",width:"234px",margin:"0 0 10px 0"}),e.jsx(g,{height:"15px",width:"112px"})]})}),e.jsxs(M,{children:[e.jsxs(ln,{border:`1px solid ${k.stakingBorder}`,borderRadius:"16px",children:[e.jsx(M,{margin:_?"0px 6px 0 0 ":"0px 18px 0px 0px",padding:_?" 7px":"10px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(st,{children:"Current Reward"}),e.jsx(O,{fontSize:_?"18px":"24px",fontWeight:"600",color:"#D53A94",letterSpacing:"normal",children:"0 PUSH"})]}):e.jsxs(Ue,{padding:_?"0px":"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:_?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(g,{height:"12px",width:_?"65px":"100px}"})]})}),e.jsx(rn,{width:"10px",height:"100%"}),e.jsx(M,{margin:_?"0px 6px 0 0 ":"0px 18px 0px 0px",padding:_?" 7px":"10px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(st,{children:"Total Staked"}),e.jsxs(pn,{fontSize:_?"18px":"24px",fontWeight:"600",letterSpacing:"normal",children:[X(G(a==null?void 0:a.poolBalance))," ",n=="UNI-V2"?"UNI-V2":"PUSH"]})]}):e.jsxs(Ue,{padding:_?"0px":"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:_?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(g,{height:"12px",width:_?"65px":"100px}"})]})})]}),e.jsx(E,{alignSelf:"end",margin:"12px 13px 24px 0px",color:"#575D73",letterSpacing:"normal",children:a?e.jsxs(e.Fragment,{children:[e.jsx(ft,{padding:"0px 5px 0px 0px",children:"Current Epoch"}),e.jsx(ft,{margin:"0 0 0 5px",children:"100 / 100"})]}):e.jsx(Ue,{padding:"6px 0px 0 15px",children:e.jsx(g,{height:"17px",width:"124px"})})}),e.jsx(dn,{children:t?e.jsxs(M,{children:[e.jsxs(E,{justifyContent:"space-between",margin:_?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Oe,{children:["User Deposit",e.jsx($e,{children:e.jsx(Z,{ToolTipTitle:"User Deposited",ToolTipBody:`Amount of ${n} Token User Staked`,children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(We,{children:[" ",G(t==null?void 0:t.epochStakeNext)," ",n=="UNI-V2"?"UNI-V2":"PUSH"]})]}),e.jsxs(E,{justifyContent:"space-between",margin:_?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Oe,{children:["Rewards Claimed",e.jsx($e,{children:e.jsx(Z,{ToolTipTitle:"Rewards Claimed",ToolTipBody:"Amount of Push Claimed by User",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(We,{children:[" ",X(((t==null?void 0:t.totalAccumulatedReward)-(t==null?void 0:t.totalAvailableReward)).toFixed(2))," ","PUSH"]})]}),e.jsxs(E,{justifyContent:"space-between",margin:_?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Oe,{children:["Current Epoch Reward",e.jsx($e,{children:e.jsx(Z,{ToolTipTitle:"Current Epoch Reward",ToolTipBody:"Displays the approximate latest reward amount for current epoch",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsx(We,{children:"0 PUSH"})]}),e.jsxs(E,{justifyContent:"space-between",margin:_?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Oe,{children:["Available for Claiming",e.jsx($e,{children:e.jsx(Z,{ToolTipTitle:"Available for Claiming",ToolTipBody:"Amount of Push Token Available to claim",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(We,{children:[X(t==null?void 0:t.totalAvailableReward)," PUSH"]})]})]}):e.jsxs(ke,{padding:"16px 15px 16px 15px",width:"100%",maxWidth:" -webkit-fill-available",borderRadius:"5px",children:[e.jsxs(E,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(E,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(E,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(E,{justifyContent:"space-between",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]})]})})]}),e.jsx(cn,{padding:_?"0px ":"0px 14px",margin:"24px 0px 0px 0px",children:t?e.jsxs(e.Fragment,{children:[e.jsx(St,{children:G(t==null?void 0:t.epochStakeNext)==="0"?e.jsx(Z,{error:!0,ToolTipTitle:"Nothing to Withdraw, so you cannot Migrate.",ToolTipWidth:"16rem",bottom:"-50px",margin:"0 0 15px 0",children:e.jsx(Fe,{border:"none",cursor:"default",background:k.disableButtonBg,color:k.disabledButtonText,children:e.jsx(bt,{children:!I&&U==null&&e.jsxs(_e,{color:k.disabledButtonText,weight:"400",cursor:"default",children:["Migrate to ",n==="UNI-V2"?"UNI-V2 ":"PUSH Fee"," Pool"]})})})}):e.jsxs(un,{onClick:we,children:[e.jsx(hn,{style:{width:`${b}%`}}),e.jsxs(bt,{children:[!I&&U==null&&e.jsxs(_e,{color:"#FFF",weight:"400",cursor:"pointer",children:["Migrate to ",n==="UNI-V2"?"UNI-V2 ":"PUSH Fee"," Pool"]}),I&&U!=null&&e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:U,titleColor:"#FFF"})]})]})}),e.jsxs(St,{children:[G(t==null?void 0:t.epochStakeNext)==="0"?e.jsx(Z,{error:!0,ToolTipTitle:K||"Nothing to unstake, Stake First",ToolTipWidth:"16rem",margin:"0 10px 0 0",bottom:"-30px",children:e.jsx(Fe,{border:"none",cursor:"default",background:k.disableButtonBg,color:k.disabledButtonText,children:h?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:k.activeButtonText,title:"Claiming",titleColor:k.activeButtonText}):` Unstake ${n}`})}):e.jsx(Fe,{border:`1px solid ${k.activeButtonText}`,background:"transparent",color:k.activeButtonText,cursor:"pointer",margin:"0 10px 0 0",onClick:J,children:h?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:k.activeButtonText,title:"Unstaking",titleColor:k.activeButtonText}):` Unstake ${n}`}),(t==null?void 0:t.totalAvailableReward)==="0.00"?e.jsx(Z,{bottom:"-30px",ToolTipTitle:"No Rewards to Claim",error:!0,ToolTipWidth:"10rem",children:e.jsx(Fe,{border:"none",cursor:"default",background:k.disableButtonBg,color:k.disabledButtonText,children:x?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:k.activeButtonText,title:"Claiming",titleColor:k.activeButtonText}):" Claim Rewards"})}):e.jsx(Fe,{border:`1px solid ${k.activeButtonText}`,background:"transparent",color:k.activeButtonText,cursor:"pointer",onClick:ee,children:x?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:k.activeButtonText,title:"Claiming",titleColor:k.activeButtonText}):"Claim Rewards"})]})]}):e.jsxs(Ue,{width:"100%",children:[e.jsx(g,{height:"49px",width:"100%",margin:"0 0 11px 0"}),e.jsx(g,{height:"49px",width:"100%"})]})})]})},an=p(ze)`
...
`;Q.coreContractChain;const gn=({setActiveTab:n})=>{const{account:t,provider:a}=Ce(),[o,s]=u.useState(null),[i,r]=u.useState(null),[l,d]=u.useState(null),[h,m]=u.useState(null),[x,F]=u.useState(null),[I,w]=u.useState(null),[U,B]=u.useState(null),[K,te]=u.useState(null),[Y,re]=u.useState(null),[W,L]=u.useState(null),b=a==null?void 0:a.getSigner(t),R=u.useCallback(async()=>{const D=await je.getInstance().getPoolStats();w({...D})},[o,i,l,h,x]),T=u.useCallback(async()=>{const D=await je.getInstance().getPUSHPoolStats();B({...D})},[o,i,l,h,x]),k=u.useCallback(async D=>{const ne=await je.getInstance().getLPPoolStats(D);te({...ne})},[o,i,l,h,x]),ee=u.useCallback(async()=>{const D=await je.getInstance().getUserData(h);re({...D})},[h]),J=u.useCallback(async()=>{const D=await je.getInstance().getUserData(l);L({...D})},[l]);u.useEffect(()=>{let D=new A(c.pushToken,v.pushToken,b),ne=new A(c.staking,v.staking,b),_=new A(c.depYieldFarmPUSH,v.yieldFarming,b),j=new A(c.depYieldFarmLP,v.yieldFarming,b),f=new A(c.uniswapV2Router02,v.uniswapV2Router02,b);if(s(D),r(ne),m(_),d(j),F(f),b&&t){var S=a.getSigner(t);let z=new A(c.pushToken,v.pushToken,S),C=new A(c.staking,v.staking,S),P=new A(c.depYieldFarmPUSH,v.yieldFarming,S),V=new A(c.depYieldFarmLP,v.yieldFarming,S),q=new A(c.uniswapV2Router02,v.uniswapV2Router02,S);s(z),r(C),m(P),d(V),F(q)}},[t]),u.useEffect(()=>{o!=null&&i!=null&&h!=null&&(je.getInstance().init(t,o,i,h,l,x),R())},[R]),u.useEffect(()=>{I&&we(I)},[I]);const we=async D=>{T(),k(D),ee(),J()};return e.jsxs(e.Fragment,{children:[e.jsx(jt,{logo:"WarningCircle",title:"This reward program (V1) has ended.",body:"To continue earning rewards please migrate to new pools.",setActiveTab:n}),e.jsxs(mn,{children:[e.jsx(wt,{poolName:"PUSH",userData:Y,PoolStats:U,poolAddress:c.depYieldFarmPUSH,getUserData:ee,getPoolStats:T,tokenAddress:c.pushToken,setActiveTab:n}),e.jsx(wt,{poolName:"UNI-V2",userData:W,PoolStats:K,poolAddress:c.depYieldFarmLP,getUserData:J,getPoolStats:k,tokenAddress:c.uniV2LPToken,setActiveTab:n})]})]})},mn=p(E)`
...
`,Un=({lpPoolStats:n,userDataLP:t,getLpPoolStats:a,getUserDataLP:o})=>{const{account:s,provider:i}=Ce(),[r,l]=u.useState(!1),[d,h]=u.useState(!1),[m,x]=u.useState(null),[F,I]=u.useState(null),w=Be(),U=Ve(),B=async()=>{if(r)return;l(!0);const R=G(t.epochStakeNext);if(R==0){I("Nothing to unstake. You need to stake first"),l(!1);return}var T=i.getSigner(s);let k=new A(c.stakingV2,v.stakingV2,T);await k.balanceOf(s,c.uniV2LPToken),k.withdraw(c.uniV2LPToken,y.from(R).mul(y.from(10).pow(18))).then(async ee=>{w.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{await i.waitForTransaction(ee.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:J=>e.jsx(he,{size:J,color:"green"})}),l(!1),a(),o()}catch(J){console.error("Error",J),w.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${J.name}+ ")`,toastType:"ERROR",getToastIcon:we=>e.jsx($,{size:we,color:"red"})}),l(!1)}}).catch(ee=>{w.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Cancelled!",toastType:"ERROR",getToastIcon:J=>e.jsx($,{size:J,color:"red"})}),l(!1)})},K=async()=>{if(!d){if((t==null?void 0:t.totalAvailableReward)==0){x("No Rewards to Claim!");return}if(console.debug("Lp POOL stats",n),!n.currentEpochLP||n.currentEpochLP==1){w.showMessageToast({toastTitle:"Error",toastMessage:"Harvest unlocks from Epoch 2!)",toastType:"ERROR",getToastIcon:T=>e.jsx($,{size:T,color:"red"})});return}h(!0);var R=i.getSigner(s);new A(c.yieldFarmLP,v.yieldFarming,R).massHarvest().then(async T=>{w.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{await i.waitForTransaction(T.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:k=>e.jsx(he,{size:k,color:"green"})}),o(),h(!1)}catch(k){w.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${k.name}+ ")`,toastType:"ERROR",getToastIcon:ee=>e.jsx($,{size:ee,color:"red"})}),h(!1)}}).catch(T=>{w.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Cancelled!",toastType:"ERROR",getToastIcon:k=>e.jsx($,{size:k,color:"red"})}),h(!1)})}};u.useEffect(()=>{x(null),I(null)},[s]);const te=()=>{(n==null?void 0:n.currentEpochLP.toNumber())+1<=(n==null?void 0:n.totalEpochLP.toNumber())?re():w.showMessageToast({toastTitle:"Error",toastMessage:"Epochs have ended!",toastType:"ERROR",getToastIcon:R=>e.jsx($,{size:R,color:"red"})})},{isModalOpen:Y,showModal:re,ModalComponent:W}=tt(),L=Be(),b=ve(600);return e.jsxs(In,{children:[e.jsx(W,{InnerComponent:Rt,InnerComponentProps:{title:"Uni-V2",getUserData:o,getPoolStats:a,setUnstakeErrorMessage:I,setWithdrawErrorMessage:x},toastObject:L,modalPosition:nt.ON_PARENT}),e.jsx(M,{margin:"0px 0px 20px 0px",children:n?e.jsxs(e.Fragment,{children:[e.jsx(Nn,{children:"Uniswap V2 LP Staking Pool"}),e.jsxs(xt,{children:["Current APR"," ",e.jsxs(Te,{color:"#D53A94",fontWeight:"600",children:[">",X(n==null?void 0:n.stakingAPR),"%"]})]})]}):e.jsxs(Ne,{padding:"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:"234px",margin:"0 0 10px 0"}),e.jsx(g,{height:"12px",width:"112px"})]})}),e.jsxs(M,{flex:"5",children:[e.jsxs(Ln,{border:`1px solid ${U.stakingBorder}`,borderRadius:"16px",children:[e.jsx(M,{margin:b?"0px 6px 0 0 ":"0px 18px 0px 0px",padding:b?" 7px":"10px",children:n?e.jsxs(e.Fragment,{children:[e.jsx(xt,{children:"Current Reward"}),e.jsxs(O,{fontSize:b?"18px":"24px",fontWeight:"600",color:"#D53A94",letterSpacing:"normal",children:[X(G(n==null?void 0:n.rewardForCurrentEpoch))," PUSH"]})]}):e.jsxs(Ne,{padding:b?"0px":"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:b?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(g,{height:"12px",width:b?"65px":"100px}"})]})}),e.jsx(Dn,{width:"10px",height:"100%"}),e.jsx(M,{margin:b?"0 0 0 6px":"0 0 0 18px",padding:b?" 7px":"10px",children:n?e.jsxs(e.Fragment,{children:[e.jsx(xt,{children:"Total Staked"}),e.jsxs(zn,{fontSize:b?"18px":"24px",fontWeight:"600",letterSpacing:"normal",children:[X(G(n==null?void 0:n.poolBalance))," UNI-V2"]})]}):e.jsxs(Ne,{padding:b?"0px":"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:b?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(g,{height:"12px",width:b?"65px":"100px}"})]})})]}),e.jsx(E,{alignSelf:"end",margin:"12px 13px 24px 0px",color:"#575D73",letterSpacing:"normal",children:n?e.jsxs(e.Fragment,{children:[e.jsx(Mt,{children:"Current Epoch"}),e.jsxs(Mt,{children:[Math.min(n==null?void 0:n.currentEpochLP,n==null?void 0:n.totalEpochLP).toString(),"/",n==null?void 0:n.totalEpochLP.toString()]})]}):e.jsx(Ne,{padding:"5px 0px 0 15px",children:e.jsx(g,{height:"12px",width:"124px"})})}),t?e.jsxs(M,{children:[e.jsxs(E,{justifyContent:"space-between",margin:b?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ge,{children:["User Deposit",e.jsx(Ke,{children:e.jsx(Z,{ToolTipTitle:"User Deposited",ToolTipBody:"Amount of PUSH Token User Staked",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Ye,{children:[G(t==null?void 0:t.epochStakeNext)," UNI-V2"]})]}),e.jsxs(E,{justifyContent:"space-between",margin:b?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ge,{children:["Rewards Claimed",e.jsx(Ke,{children:e.jsx(Z,{ToolTipTitle:"Rewards Claimed",ToolTipBody:"Amount of Push Claimed by User",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Ye,{children:[" ",X(((t==null?void 0:t.totalAccumulatedReward)-(t==null?void 0:t.totalAvailableReward)).toFixed(2))," ","PUSH"]})]}),e.jsxs(E,{justifyContent:"space-between",margin:b?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ge,{children:["Current Epoch Reward",e.jsx(Ke,{children:e.jsx(Z,{ToolTipTitle:"Current Epoch Reward",ToolTipBody:"Displays the approximate latest reward amount for current epoch",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Ye,{children:[" ",X(t==null?void 0:t.potentialUserReward)," PUSH"]})]}),e.jsxs(E,{justifyContent:"space-between",margin:b?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ge,{children:["Available for Claiming",e.jsx(Ke,{children:e.jsx(Z,{ToolTipTitle:"Available for Claiming",ToolTipBody:"Amount of Push Token Available to claim",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Ye,{children:[" ",X(t==null?void 0:t.totalAvailableReward)," PUSH"]})]})]}):e.jsxs(ke,{padding:"0 15px 15px 15px",width:"100%",maxWidth:" -webkit-fill-available",borderRadius:"5px",children:[e.jsxs(E,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(E,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(E,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(E,{justifyContent:"space-between",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]})]})]}),e.jsx(M,{padding:b?"0px ":"0px 14px",margin:"24px 0px 24px 0px",children:t?e.jsxs(e.Fragment,{children:[e.jsx(E,{children:e.jsx(Vn,{onClick:()=>{te()},children:"Stake $UNI-V2 LP Tokens"})}),e.jsxs(Bn,{children:[G(t==null?void 0:t.epochStakeNext)==="0"?e.jsx(Z,{error:!0,ToolTipTitle:"Nothing to unstake! Stake First.",ToolTipWidth:"16rem",margin:"0 10px 0 0",bottom:"-30px",children:e.jsx(Je,{border:"none",background:U.disableButtonBg,cursor:"default",color:U.disabledButtonText,children:r?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:"#D53A94"}):"Unstake $UNI-V2"})}):e.jsx(Je,{border:`1px solid ${U.activeButtonText}`,background:"transparent",color:U.activeButtonText,cursor:"pointer",onClick:B,style:{margin:"0px 10px 0px 0px"},children:r?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:U.activeButtonText,title:"Unstaking",titleColor:U.activeButtonText}):"Unstake $UNI-V2"}),(t==null?void 0:t.totalAvailableReward)==="0.00"?e.jsx(Z,{bottom:"-30px",left:"40px",ToolTipTitle:"No Rewards to Claim!",error:!0,ToolTipWidth:"10rem",children:e.jsx(Je,{border:"none",cursor:"default",background:U.disableButtonBg,color:U.disabledButtonText,children:d?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:"#FFFFF"}):"Claim Rewards"})}):e.jsx(Je,{border:`1px solid ${U.activeButtonText}`,background:"transparent",color:U.activeButtonText,cursor:"pointer",onClick:()=>K(),children:d?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:U.activeButtonText,title:"Claiming",titleColor:U.activeButtonText}):"Claim Rewards"})]})]}):e.jsxs(Ne,{width:"100%",children:[e.jsx(g,{height:"49px",width:"100%",margin:"0 0 8px 0"}),e.jsx(g,{height:"49px",width:"100%"})]})})]})},In=p(ze)`
  border: 1px solid ${n=>n.theme.stakingBorder};
  border-radius: 24px;
  padding: 20px;
...
`,p(g)`
  ...
  width: 100%;
  border-radius: 2px;
`;const _n=n=>u.createElement("svg",{width:29,height:28,viewBox:"0 0 29 28",fill:"none",xmlns:"http://www.w3.org/2000/svg",...n},u.createElement("path",{d:"M26.1673 14.0002C26.1673 20.4431 20.9436 25.6668 14.5007 25.6668C8.05773 25.6668 2.83398 20.4431 2.83398 14.0002C2.83398 7.55725 8.05773 2.3335 14.5007 2.3335C20.9436 2.3335 26.1673 7.55725 26.1673 14.0002Z",fill:"#30CC8B"}),u.createElement("path",{d:"M20.6751 8.5083L12.7593 16.4335L9.49146 13.175L7.8418 14.8246L12.7616 19.7328L22.3254 10.158L20.6751 8.5083Z",fill:"white"})),On=({onClose:n,InnerComponentProps:t})=>{const{currentTransactionNo:a,totalTransactionNo:o,transactionSteps:s,transactionText:i,setCurrentTransactionNo:r,setTotalTransactionNo:l,setTransactionSteps:d,claimRewards:h,unstakeTokensPaginated:m}=t,x=()=>{d(0),n()},F=async()=>{d(0),l(0),r(0),i!=null&&i.includes("Unstaking")?m():h()};return e.jsx($n,{children:o?e.jsxs(e.Fragment,{children:[e.jsx(E,{justifyContent:"end",children:e.jsx(mt,{onClick:()=>x(),style:{cursor:"pointer"}})}),s===0&&e.jsxs(e.Fragment,{children:[e.jsx(Yt,{size:42,color:xe.COLORS.PRIMARY_PINK,type:Jt.PROCESSING}),e.jsxs(M,{gap:"24px",margin:"16px 0 0 0",children:[e.jsxs(M,{children:[e.jsxs(O,{fontSize:"28px",fontWeight:"500",letterSpacing:"normal",children:["Please sign transaction ",a,"/",o]}),e.jsx(O,{fontSize:"18px",fontWeight:"400",color:"#657795",children:"Processing your request"})]}),e.jsx(O,{fontSize:"18px",fontWeight:"400",color:"#657795",children:i}),e.jsx(M,{padding:"16px",children:e.jsx(O,{fontSize:"16px",fontWeight:"400",color:"#D53A94",children:"Confirm the request in your wallet"})})]})]}),s===1&&e.jsxs(M,{gap:"24px",children:[e.jsx(M,{gap:"9px",children:e.jsx(O,{fontSize:"28px",fontWeight:"500",letterSpacing:"normal",children:"Transaction Error"})}),e.jsx(M,{children:e.jsx(Ft,{onClick:F,children:"Retry"})})]}),s===2&&e.jsxs(M,{gap:"24px",children:[e.jsxs(M,{children:[e.jsx(_n,{height:"50px",width:"50px"}),e.jsxs(M,{gap:"9px",children:[e.jsx(O,{fontSize:"28px",fontWeight:"500",letterSpacing:"normal",children:"Transactions Successful"}),e.jsx(O,{fontSize:"18px",fontWeight:"400",color:"#657795",children:"You have claimed all the rewards."})]})]}),e.jsx(M,{onClick:x,children:e.jsx(Ft,{children:"Close"})})]})]}):e.jsx(Yt,{size:42,color:xe.COLORS.PRIMARY_PINK,type:Jt.PROCESSING})})},$n=p(M)`
  min-width: 493px;
  padding: 32px 24px;
`,Ft=p(fe)`
  min-width: 200px;
...
`,Wn=({userDataPush:n,getUserDataPush:t,PUSHPoolstats:a,getPUSHPoolStats:o})=>{const{account:s,provider:i}=Ce(),[r,l]=u.useState(!1),[d,h]=u.useState(!1),[m,x]=u.useState(null),[F,I]=u.useState(null),[w,U]=u.useState(0),[B,K]=u.useState(0),[te,Y]=u.useState(0),[re,W]=u.useState(""),L=Be(),b=Ve(),R=async C=>{var P=i.getSigner(s);let V=new A(c.pushToken,v.pushToken,P);if(await V.holderDelegation(s,C.address))return!0;try{L.showLoaderToast({loaderMessage:"Delegating! Please wait.."});const q=await V.setHolderDelegation(C.address,"true");return await i.waitForTransaction(q.hash),L.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed! Address Delegated",toastType:"SUCCESS",getToastIcon:se=>e.jsx(he,{size:se,color:"green"})}),!0}catch(q){return console.error("Error in delegating",q),L.showMessageToast({toastTitle:"Error",toastMessage:`Transaction failed! ${q.reason}`,toastType:"ERROR",getToastIcon:se=>e.jsx($,{size:se,color:"red"})}),l(!1),!1}},T=async C=>{const P=(await C.userFeesInfo(s)).lastClaimedBlock;if(P.toNumber()!==0){const V=await C.genesisEpoch(),q=await C.epochDuration();return(P-V)/q}},k=async()=>{if(d)return;if(h(!0),(n==null?void 0:n.availableRewards)==0){I("No Rewards to Claim"),h(!1);return}var C=i.getSigner(s);let P=new A(c.pushCoreV2,v.pushCoreV2,C);const V=a==null?void 0:a.currentEpochNumber,q=14;if(!await R(P))return;let se=1;se=await T(P),S(),h(!1);let H=0;V-se<q,H=Math.ceil((V-se)/q),K(H),H!=0&&(await ee(H,se,P,q),t(),Y(2),U(0))},ee=async(C,P,V,q)=>{const se=a==null?void 0:a.currentEpochNumber;let H=0;for(let de=0;de<C;de++){let pe=P;P+=q;let ye=Math.min(P,se-1);W(`Claiming the rewards from Epoch ${pe} to ${ye} `),await V.harvestPaginated(ye,{gasLimit:91e4}).then(async ae=>{try{L.showLoaderToast({loaderMessage:"Waiting for confirmation"}),await i.waitForTransaction(ae.hash),L.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:oe=>e.jsx(he,{size:oe,color:"green"})}),H++,U(H)}catch{console.error("Error in the transaction",ae);return}}).catch(ae=>{throw console.error("Error in claiming the reward",ae),L.showMessageToast({toastTitle:"Error",toastMessage:`Transaction failed! ${ae.reason}`,toastType:"ERROR",getToastIcon:oe=>e.jsx($,{size:oe,color:"red"})}),W(""),l(!1),t(),Y(1),U(0),ae})}},J=async()=>{if(r)return;if(l(!0),G(n==null?void 0:n.userStaked)==0){x("Nothing to unstake, You need to stake first"),l(!1);return}var C=i.getSigner(s);let P=new A(c.pushCoreV2,v.pushCoreV2,C);const V=await R(P);if(h(!1),!V)return;const q=a==null?void 0:a.currentEpochNumber,se=14;let H=0;if(H=await T(P),H>=q-1){l(!1),x("PUSH cannot be unstaked until current epoch is over."),L.showMessageToast({toastTitle:"Unstaking Error",toastMessage:"You cannot unstake until Current Epoch gets over.",toastType:"ERROR",getToastIcon:pe=>e.jsx($,{size:pe,color:"red"})});return}S();const de=Math.ceil((q-H)/se);K(de),de>1&&await ee(de-1,H,P,se),W("Unstaking Your Push Tokens. Please wait..."),P.unstake().then(async pe=>{L.showLoaderToast({loaderMessage:"Unstaking! Waiting for Confirmation..."});try{await i.waitForTransaction(pe.hash),L.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:ye=>e.jsx(he,{size:ye,color:"green"})}),o(),t(),l(!1),Y(2),U(0)}catch(ye){console.error("Error",ye),L.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${ye.name}+ ")`,toastType:"ERROR",getToastIcon:ae=>e.jsx($,{size:ae,color:"red"})}),W(""),l(!1)}}).catch(pe=>{console.error("Error: ",pe);const ye=pe.reason.includes("PushCoreV2::unstake:"),ae=pe.reason.includes("PushCoreV2::harvestPaginated:");if(ye||ae)x("PUSH cannot be unstaked until current epoch is over.");else{let oe=pe.reason.slice(pe.reason.indexOf("::")+1);oe=oe.replace("unstake:",""),L.showMessageToast({toastTitle:"Error",toastMessage:`${oe}`,toastType:"ERROR",getToastIcon:De=>e.jsx($,{size:De,color:"red"})})}l(!1),t(),Y(1),U(0)})};u.useEffect(()=>{I(null),x(null)},[s]);const{isModalOpen:we,showModal:D,ModalComponent:ne}=tt(),_=Be(),j=ve(600),{isModalOpen:f,showModal:S,ModalComponent:z}=tt();return e.jsxs(Yn,{children:[e.jsx(ne,{InnerComponent:Rt,InnerComponentProps:{title:"PUSH",getUserData:t,getPoolStats:o,setUnstakeErrorMessage:x,setWithdrawErrorMessage:I},toastObject:_,modalPosition:nt.ON_PARENT}),e.jsx(z,{InnerComponent:On,InnerComponentProps:{currentTransactionNo:w,totalTransactionNo:B,transactionSteps:te,transactionText:re,setCurrentTransactionNo:U,setTotalTransactionNo:K,setTransactionSteps:Y,claimRewards:k,unstakeTokensPaginated:J},onConfirm:()=>{},modalPadding:"0px",modalPosition:nt.ON_ROOT}),e.jsx(M,{margin:"0px 0px 20px 0px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(Jn,{children:"PUSH Fee Staking Pool"}),e.jsxs(qn,{children:["Current APR",e.jsxs(Te,{color:"#D53A94",fontWeight:"600",margin:"0 5px 0 5px",children:[">",X(a==null?void 0:a.stakingAPR),"% + Fee"]}),e.jsx(Hn,{})]})]}):e.jsxs(Le,{padding:"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:"234px",margin:"0 0 10px 0"}),e.jsx(g,{height:"12px",width:"112px"})]})}),e.jsxs(M,{flex:"5",children:[e.jsxs(Zn,{border:`1px solid ${b.stakingBorder}`,borderRadius:"16px",children:[e.jsx(M,{margin:j?"0px 6px 0 0 ":"0px 18px 0px 0px",padding:j?" 7px":"10px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(It,{children:"Current Reward"}),e.jsxs(O,{fontSize:j?"18px":"24px",fontWeight:"600",color:"#D53A94",letterSpacing:"normal",children:[X(G(a==null?void 0:a.currentReward))," PUSH"]})]}):e.jsxs(Le,{padding:j?"0px":"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:j?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(g,{height:"12px",width:j?"65px":"100px}"})]})}),e.jsx(Xn,{width:"10px",height:"100%"}),e.jsx(M,{margin:j?"0 0 0 6px":"0 0 0 18px",padding:j?" 7px":"10px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(It,{children:"Total Staked"}),e.jsxs(Qn,{fontSize:j?"18px":"24px",fontWeight:"600",letterSpacing:"normal",children:[X(G(a==null?void 0:a.totalStakedAmount))," PUSH"]})]}):e.jsxs(Le,{padding:j?"0px":"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:j?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(g,{height:"12px",width:j?"65px":"100px}"})]})})]}),e.jsx(E,{alignSelf:"end",margin:"12px 13px 24px 0px",color:"#575D73",letterSpacing:"normal",children:a?e.jsxs(e.Fragment,{children:[e.jsx(Nt,{children:"Current Epoch"}),e.jsx(Nt,{children:a==null?void 0:a.currentEpochNumber})]}):e.jsx(Le,{padding:"5px 0px 0 15px",children:e.jsx(g,{height:"12px",width:"124px"})})}),n?e.jsxs(M,{children:[e.jsxs(E,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(qe,{children:["User Deposit",e.jsx(Ze,{children:e.jsx(Z,{ToolTipTitle:"User Deposited",ToolTipBody:"Amount of PUSH Token User Staked",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Xe,{children:[" ",X(G(n==null?void 0:n.userStaked))," PUSH"]})]}),e.jsxs(E,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(qe,{children:["Rewards Claimed",e.jsx(Ze,{children:e.jsx(Z,{ToolTipTitle:"Rewards Claimed",ToolTipBody:"Amount of Push Claimed by User",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Xe,{children:[" ",X((n==null?void 0:n.claimedReward).toFixed(2))," PUSH"]})]}),e.jsxs(E,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(qe,{children:["Current Epoch Reward",e.jsx(Ze,{children:e.jsx(Z,{ToolTipTitle:"Current Epoch Reward",ToolTipBody:"Displays the approximate latest reward amount for current epoch",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Xe,{children:[" ",X((n==null?void 0:n.potentialReward).toFixed(2))," PUSH"]})]}),e.jsxs(E,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(qe,{children:["Available for Claiming",e.jsx(Ze,{children:e.jsx(Z,{ToolTipTitle:"Available for Claiming",ToolTipBody:"Amount of Push Token Available to claim",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Xe,{children:[" ",X((n==null?void 0:n.availableRewards).toFixed(2))," PUSH"]})]})]}):e.jsxs(ke,{padding:"0 15px 15px 15px",width:"100%",maxWidth:" -webkit-fill-available",borderRadius:"5px",children:[e.jsxs(E,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(E,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(E,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(E,{justifyContent:"space-between",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]})]})]}),e.jsx(M,{padding:j?"0px ":"0px 14px",margin:"24px 0px 24px 0px",children:n?e.jsxs(e.Fragment,{children:[e.jsx(E,{children:e.jsx(ta,{onClick:D,children:" Stake $PUSH"})}),e.jsxs(ea,{children:[(a==null?void 0:a.currentEpochNumber)<=2?e.jsx(Ut,{ToolTipTitle:"You can unstake once epoch 2 ends.",ButtonTitle:"Unstake PUSH"}):G(n==null?void 0:n.userStaked)==0||m!==null?e.jsx(Ut,{ToolTipTitle:m||"Nothing to unstake, Stake First",ButtonTitle:"Unstake PUSH"}):e.jsx(Qe,{border:`1px solid ${b.activeButtonText}`,background:"transparent",color:b.activeButtonText,cursor:"pointer",onClick:J,style:{margin:"0px 10px 0px 0px"},children:r?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:b.activeButtonText,title:"Unstaking",titleColor:b.activeButtonText}):"Unstake $PUSH"}),(n==null?void 0:n.availableRewards)===0?e.jsx(Z,{bottom:"-30px",ToolTipTitle:"No Rewards to Claim",error:!0,left:"40px",ToolTipWidth:"10rem",children:e.jsx(Qe,{border:"none",background:b.disableButtonBg,cursor:"default",color:b.disabledButtonText,children:d?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:"#D53A94"}):"Claim Rewards"})}):e.jsx(Qe,{border:`1px solid ${b.activeButtonText}`,background:"transparent",color:b.activeButtonText,cursor:"pointer",onClick:k,children:d?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:b.activeButtonText,title:"Claiming",titleColor:b.activeButtonText}):"Claim Rewards"})]})]}):e.jsxs(Le,{width:"100%",children:[e.jsx(g,{height:"49px",width:"100%",margin:"0 0 8px 0"}),e.jsx(g,{height:"49px",width:"100%"})]})})]})},Ut=n=>{const t=Ve();return e.jsx(Z,{error:!0,ToolTipTitle:n.ToolTipTitle,ToolTipWidth:"16rem",margin:"0 10px 0 0",bottom:"-30px",children:e.jsx(Qe,{border:"none",background:t.disableButtonBg,cursor:"default",color:t.disabledButtonText,children:n.ButtonTitle})})},Hn=()=>{const[n,t]=u.useState(!1),a=()=>t(!1),o=u.useRef(null);return Gt(o,()=>a()),e.jsxs(Gn,{ref:o,children:[e.jsx(le,{onClick:()=>t(!n),src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}}),n&&e.jsx(Kn,{id:"channel",children:e.jsx(Tt,{title:"",body:"Push Fee Pool APR distributes yield farming rewards + fee earned by protocol. More Info "})})]})},Gn=p.div`
  width: 34%;
  width: 100%;
  min-width: none;
  max-width: none;
...
`,p(g)`
  ...
  width: 100%;
  border-radius: 2px;
`;const na=({setActiveTab:n})=>{const{provider:t,account:a,chainId:o}=Ce(),[s,i]=u.useState(),[r,l]=u.useState(),[d,h]=u.useState(),[m,x]=u.useState(),[F,I]=u.useState(),[w,U]=u.useState(null),[B,K]=u.useState(null),[te,Y]=u.useState(null),[re,W]=u.useState(null),[L,b]=u.useState(null),R=t==null?void 0:t.getSigner(a),T=u.useCallback(async()=>{const D=await Ee.getInstance().getPoolStats(t);U({...D})},[r,s,m,d,F,t]),k=u.useCallback(async()=>{const D=await Ee.getInstance().getPoolStats(t),ne=await Ee.getInstance().getLPPoolStats(D);K({...ne})},[r,s,m,d,F,t]),ee=u.useCallback(async()=>{},[]),J=u.useCallback(async()=>{const D=await Ee.getInstance().getUserDataLP();Y({...D})},[r,s,m,d,F]),we=u.useCallback(async()=>{const[D,ne]=await Ee.getInstance().getUserDataPUSH(t);b({...D}),W({...ne})},[r,s,m,d,F,t]);return u.useEffect(()=>{if(o!==Q.coreContractChain&&o!==Q.mainnetCoreContractChain)return;K(null),Y(null),b(null),W(null);let D=new A(c.stakingV2,v.stakingV2,R),ne=new A(c.pushToken,v.pushToken,R),_=new A(c.pushCoreV2,v.pushCoreV2,R),j=new A(c.yieldFarmLP,v.yieldFarming,R),f=new A(c.uniswapV2Router02,v.uniswapV2Router02,R);if(l(D),i(ne),x(_),h(j),I(f),R&&a){var S=t==null?void 0:t.getSigner(a);let z=new A(c.stakingV2,v.stakingV2,S),C=new A(c.pushToken,v.pushToken,S),P=new A(c.pushCoreV2,v.pushCoreV2,S),V=new A(c.yieldFarmLP,v.yieldFarming,S),q=new A(c.uniswapV2Router02,v.uniswapV2Router02,S);l(z),i(C),x(P),h(V),I(q)}Ee.getInstance().init(a,D,ne,_,j,f),T(),J(),k(),we()},[a,o]),e.jsxs(e.Fragment,{children:[e.jsx(jt,{logo:"announcement",title:"New V2 Pools are now Live! Stake or migrate now.",body:"Users who were part of the previous Push staking program, need to migrate to new pools to continue earning rewards. Click",setActiveTab:n}),e.jsx(fn,{getLpPoolStats:k,poolStats:w,setPoolStats:U}),e.jsx(yn,{poolStats:w}),e.jsxs(aa,{children:[e.jsx(Wn,{userDataPush:re,getUserDataPush:we,PUSHPoolstats:L,getPUSHPoolStats:ee}),e.jsx(Un,{lpPoolStats:B,userDataLP:te,getLpPoolStats:k,getUserDataLP:J})]})]})},aa=p(E)`
  @media (max-width: 1300px) {
    flex-direction: column;
  }
...
`,Bt=p(Te)`
  ...
  height: 17px;
  width: fit-content;
`,qt=()=>e.jsx(Vt,{children:e.jsx(Lt,{})}),Vt=p(ze)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
`});export{ba as __tla,qt as default};
