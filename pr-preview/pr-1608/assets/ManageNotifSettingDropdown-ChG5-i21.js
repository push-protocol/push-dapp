import{bK as u,cE as T,ct as xe,bR as f,eK as fe,bV as n,bQ as se,cu as oe,cz as re,c5 as P,cV as be,cy as ae,bP as ie,cA as j,eB as we,b$ as le,c0 as ce,d7 as A,eD as Se,cJ as de,cK as O,d8 as pe,eg as me,ep as ye,hF as je,__tla as ve}from"./index-MGHANYEF.js";import{I as Ce,R as Me,__tla as Te}from"./RangeSlider-Du3k-C7f.js";let z,ue,he,ge,$,De=Promise.all([(()=>{try{return ve}catch{}})(),(()=>{try{return Te}catch{}})()]).then(async()=>{let B,V,D,W,w,R,F,H,K,U,J,N,Q,X,Y,q,I,G,Z,ee,te,_,ne;z=({children:t,renderDropdownContainer:r,showDropdown:s,toggleDropdown:a,closeDropdown:o,containerPadding:h,centerOnMobile:i})=>{const d=f.useRef(null),p=f.useRef(null);return fe(d,p,o),n.jsxs(B,{ref:d,onClick:a,children:[t,s&&n.jsx(V,{containerPadding:h,centerOnMobile:i,children:n.jsx("div",{ref:p,onClick:e=>e.stopPropagation(),children:r})})]})},B=u.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
