import{ad as u,b7 as T,aY as xe,ak as f,dc as fe,ao as n,aj as se,aZ as oe,b2 as re,aA as A,bo as be,b1 as ae,ai as ie,b3 as j,d3 as we,au as le,av as ce,bC as P,d5 as Se,bc as de,bd as O,bD as pe,cK as me,cT as ye,fK as je,__tla as ve}from"./index-DKAwhGs-.js";import{I as Ce,R as Me,__tla as Te}from"./RangeSlider-D_XBbtXk.js";let k,ue,he,ge,$,De=Promise.all([(()=>{try{return ve}catch{}})(),(()=>{try{return Te}catch{}})()]).then(async()=>{let B,W,D,V,w,z,F,H,U,K,N,Y,J,X,Z,q,I,G,Q,ee,te,_,ne;k=({children:t,renderDropdownContainer:r,showDropdown:s,toggleDropdown:a,closeDropdown:o,containerPadding:h,centerOnMobile:i})=>{const d=f.useRef(null),p=f.useRef(null);return fe(d,p,o),n.jsxs(B,{ref:d,onClick:a,children:[t,s&&n.jsx(W,{containerPadding:h,centerOnMobile:i,children:n.jsx("div",{ref:p,onClick:e=>e.stopPropagation(),children:r})})]})},B=u.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
