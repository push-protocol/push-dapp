...
`;X.coreContractChain;const gn=({setActiveTab:n})=>{const{account:t,provider:a}=Ce(),[o,s]=u.useState(null),[i,r]=u.useState(null),[l,d]=u.useState(null),[h,m]=u.useState(null),[x,F]=u.useState(null),[I,w]=u.useState(null),[U,B]=u.useState(null),[G,te]=u.useState(null),[J,re]=u.useState(null),[_,L]=u.useState(null),b=a==null?void 0:a.getSigner(t),R=u.useCallback(async()=>{const D=await je.getInstance().getPoolStats();w({...D})},[o,i,l,h,x]),T=u.useCallback(async()=>{const D=await je.getInstance().getPUSHPoolStats();B({...D})},[o,i,l,h,x]),k=u.useCallback(async D=>{const ne=await je.getInstance().getLPPoolStats(D);te({...ne})},[o,i,l,h,x]),ee=u.useCallback(async()=>{const D=await je.getInstance().getUserData(h);re({...D})},[h]),q=u.useCallback(async()=>{const D=await je.getInstance().getUserData(l);L({...D})},[l]);u.useEffect(()=>{let D=new A(c.pushToken,v.pushToken,b),ne=new A(c.staking,v.staking,b),O=new A(c.depYieldFarmPUSH,v.yieldFarming,b),j=new A(c.depYieldFarmLP,v.yieldFarming,b),f=new A(c.uniswapV2Router02,v.uniswapV2Router02,b);if(s(D),r(ne),m(O),d(j),F(f),b&&t){var S=a.getSigner(t);let z=new A(c.pushToken,v.pushToken,S),C=new A(c.staking,v.staking,S),P=new A(c.depYieldFarmPUSH,v.yieldFarming,S),V=new A(c.depYieldFarmLP,v.yieldFarming,S),K=new A(c.uniswapV2Router02,v.uniswapV2Router02,S);s(z),r(C),m(P),d(V),F(K)}},[t]),u.useEffect(()=>{o!=null&&i!=null&&h!=null&&(je.getInstance().init(t,o,i,h,l,x),R())},[R]),u.useEffect(()=>{I&&we(I)},[I]);const we=async D=>{T(),k(D),ee(),q()};return e.jsxs(e.Fragment,{children:[e.jsx(jt,{logo:"WarningCircle",title:"This reward program (V1) has ended.",body:"To continue earning rewards please migrate to new pools.",setActiveTab:n}),e.jsxs(mn,{children:[e.jsx(wt,{poolName:"PUSH",userData:J,PoolStats:U,poolAddress:c.depYieldFarmPUSH,getUserData:ee,getPoolStats:T,tokenAddress:c.pushToken,setActiveTab:n}),e.jsx(wt,{poolName:"UNI-V2",userData:_,PoolStats:G,poolAddress:c.depYieldFarmLP,getUserData:q,getPoolStats:k,tokenAddress:c.uniV2LPToken,setActiveTab:n})]})]})},mn=p(E)`
...
`,yn=({poolStats:n})=>{function t(o){return o==null?void 0:o.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",")}const a=Re(600);return e.jsx(Tn,{justifyContent:"stretch",children:n?e.jsxs(e.Fragment,{children:[e.jsx(Et,{fontSize:a?"16px":"18px",textAlign:"left",fontWeight:600,children:"Push Price"}),e.jsxs(E,{gap:"5px",justifyContent:"flex-end",children:[e.jsxs(Et,{fontSize:a?"18px ":"24px",textAlign:"left",fontWeight:600,children:["$",t(n==null?void 0:n.pushPrice.toFixed(2))]}),e.jsx(le,{width:"25px",height:a?"20px":"27px",src:_t("svg/uniswapLogo.svg"),alt:"Uniswap Logo"})]})]}):e.jsxs(wn,{children:[e.jsx(g,{height:"12px",width:"135px",margin:"10px 0 10px 0"}),e.jsx(g,{height:"12px",width:"135px",margin:"10px 0 10px 0"})]})})},Tn=p(E)`
  flex-direction: row;
...
`,p(g)`
  ...
  width: 100%;
  border-radius: 2px;
`;const On=n=>u.createElement("svg",{width:29,height:28,viewBox:"0 0 29 28",fill:"none",xmlns:"http://www.w3.org/2000/svg",...n},u.createElement("path",{d:"M26.1673 14.0002C26.1673 20.4431 20.9436 25.6668 14.5007 25.6668C8.05773 25.6668 2.83398 20.4431 2.83398 14.0002C2.83398 7.55725 8.05773 2.3335 14.5007 2.3335C20.9436 2.3335 26.1673 7.55725 26.1673 14.0002Z",fill:"#30CC8B"}),u.createElement("path",{d:"M20.6751 8.5083L12.7593 16.4335L9.49146 13.175L7.8418 14.8246L12.7616 19.7328L22.3254 10.158L20.6751 8.5083Z",fill:"white"})),$n=({onClose:n,InnerComponentProps:t})=>{const{currentTransactionNo:a,totalTransactionNo:o,transactionSteps:s,transactionText:i,setCurrentTransactionNo:r,setTotalTransactionNo:l,setTransactionSteps:d,claimRewards:h,unstakeTokensPaginated:m}=t,x=()=>{d(0),n()},F=async()=>{d(0),l(0),r(0),i!=null&&i.includes("Unstaking")?m():h()};return e.jsx(Hn,{children:o?e.jsxs(e.Fragment,{children:[e.jsx(E,{justifyContent:"end",children:e.jsx(mt,{onClick:()=>x(),style:{cursor:"pointer"}})}),s===0&&e.jsxs(e.Fragment,{children:[e.jsx(Jt,{size:42,color:xe.COLORS.PRIMARY_PINK,type:qt.PROCESSING}),e.jsxs(M,{gap:"24px",margin:"16px 0 0 0",children:[e.jsxs(M,{children:[e.jsxs($,{fontSize:"28px",fontWeight:"500",letterSpacing:"-0.84px",children:["Please sign transaction ",a,"/",o]}),e.jsx($,{fontSize:"18px",fontWeight:"400",color:"#657795",children:"Processing your request"})]}),e.jsx($,{fontSize:"18px",fontWeight:"400",color:"#657795",children:i}),e.jsx(M,{padding:"16px",children:e.jsx($,{fontSize:"16px",fontWeight:"400",color:"#D53A94",children:"Confirm the request in your wallet"})})]})]}),s===1&&e.jsxs(M,{gap:"24px",children:[e.jsx(M,{gap:"9px",children:e.jsx($,{fontSize:"28px",fontWeight:"500",letterSpacing:"-0.84px",children:"Transaction Error"})}),e.jsx(M,{children:e.jsx(Ft,{onClick:F,children:"Retry"})})]}),s===2&&e.jsxs(M,{gap:"24px",children:[e.jsxs(M,{children:[e.jsx(On,{height:"50px",width:"50px"}),e.jsxs(M,{gap:"9px",children:[e.jsx($,{fontSize:"28px",fontWeight:"500",letterSpacing:"-0.84px",children:"Transactions Successful"}),e.jsx($,{fontSize:"18px",fontWeight:"400",color:"#657795",children:"You have claimed all the rewards."})]})]}),e.jsx(M,{onClick:x,children:e.jsx(Ft,{children:"Close"})})]})]}):e.jsx(Jt,{size:42,color:xe.COLORS.PRIMARY_PINK,type:qt.PROCESSING})})},Hn=p(M)`
  min-width: 493px;
  padding: 32px 24px;
`,Ft=p(fe)`
  min-width: 200px;
...
`,_n=({userDataPush:n,getUserDataPush:t,PUSHPoolstats:a,getPUSHPoolStats:o})=>{const{account:s,provider:i}=Ce(),[r,l]=u.useState(!1),[d,h]=u.useState(!1),[m,x]=u.useState(null),[F,I]=u.useState(null),[w,U]=u.useState(0),[B,G]=u.useState(0),[te,J]=u.useState(0),[re,_]=u.useState(""),L=Be(),b=Ve(),R=async C=>{var P=i.getSigner(s);let V=new A(c.pushToken,v.pushToken,P);if(await V.holderDelegation(s,C.address))return!0;try{L.showLoaderToast({loaderMessage:"Delegating! Please wait.."});const K=await V.setHolderDelegation(C.address,"true");return await i.waitForTransaction(K.hash),L.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed! Address Delegated",toastType:"SUCCESS",getToastIcon:se=>e.jsx(he,{size:se,color:"green"})}),!0}catch(K){return console.error("Error in delegating",K),L.showMessageToast({toastTitle:"Error",toastMessage:`Transaction failed! ${K.reason}`,toastType:"ERROR",getToastIcon:se=>e.jsx(H,{size:se,color:"red"})}),l(!1),!1}},T=async C=>{const P=(await C.userFeesInfo(s)).lastClaimedBlock;if(P.toNumber()!==0){const V=await C.genesisEpoch(),K=await C.epochDuration();return(P-V)/K}},k=async()=>{if(d)return;if(h(!0),(n==null?void 0:n.availableRewards)==0){I("No Rewards to Claim"),h(!1);return}var C=i.getSigner(s);let P=new A(c.pushCoreV2,v.pushCoreV2,C);const V=a==null?void 0:a.currentEpochNumber,K=14;if(!await R(P))return;let se=1;se=await T(P),S(),h(!1);let W=0;V-se<K,W=Math.ceil((V-se)/K),G(W),W!=0&&(await ee(W,se,P,K),t(),J(2),U(0))},ee=async(C,P,V,K)=>{const se=a==null?void 0:a.currentEpochNumber;let W=0;for(let de=0;de<C;de++){let pe=P;P+=K;let ye=Math.min(P,se-1);_(`Claiming the rewards from Epoch ${pe} to ${ye} `),await V.harvestPaginated(ye,{gasLimit:91e4}).then(async ae=>{try{L.showLoaderToast({loaderMessage:"Waiting for confirmation"}),await i.waitForTransaction(ae.hash),L.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:oe=>e.jsx(he,{size:oe,color:"green"})}),W++,U(W)}catch{console.error("Error in the transaction",ae);return}}).catch(ae=>{throw console.error("Error in claiming the reward",ae),L.showMessageToast({toastTitle:"Error",toastMessage:`Transaction failed! ${ae.reason}`,toastType:"ERROR",getToastIcon:oe=>e.jsx(H,{size:oe,color:"red"})}),_(""),l(!1),t(),J(1),U(0),ae})}},q=async()=>{if(r)return;if(l(!0),Y(n==null?void 0:n.userStaked)==0){x("Nothing to unstake, You need to stake first"),l(!1);return}var C=i.getSigner(s);let P=new A(c.pushCoreV2,v.pushCoreV2,C);const V=await R(P);if(h(!1),!V)return;const K=a==null?void 0:a.currentEpochNumber,se=14;let W=0;if(W=await T(P),W>=K-1){l(!1),x("PUSH cannot be unstaked until current epoch is over."),L.showMessageToast({toastTitle:"Unstaking Error",toastMessage:"You cannot unstake until Current Epoch gets over.",toastType:"ERROR",getToastIcon:pe=>e.jsx(H,{size:pe,color:"red"})});return}S();const de=Math.ceil((K-W)/se);G(de),de>1&&await ee(de-1,W,P,se),_("Unstaking Your Push Tokens. Please wait..."),P.unstake().then(async pe=>{L.showLoaderToast({loaderMessage:"Unstaking! Waiting for Confirmation..."});try{await i.waitForTransaction(pe.hash),L.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:ye=>e.jsx(he,{size:ye,color:"green"})}),o(),t(),l(!1),J(2),U(0)}catch(ye){console.error("Error",ye),L.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${ye.name}+ ")`,toastType:"ERROR",getToastIcon:ae=>e.jsx(H,{size:ae,color:"red"})}),_(""),l(!1)}}).catch(pe=>{console.error("Error: ",pe);const ye=pe.reason.includes("PushCoreV2::unstake:"),ae=pe.reason.includes("PushCoreV2::harvestPaginated:");if(ye||ae)x("PUSH cannot be unstaked until current epoch is over.");else{let oe=pe.reason.slice(pe.reason.indexOf("::")+1);oe=oe.replace("unstake:",""),L.showMessageToast({toastTitle:"Error",toastMessage:`${oe}`,toastType:"ERROR",getToastIcon:De=>e.jsx(H,{size:De,color:"red"})})}l(!1),t(),J(1),U(0)})};u.useEffect(()=>{I(null),x(null)},[s]);const{isModalOpen:we,showModal:D,ModalComponent:ne}=tt(),O=Be(),j=Re(600),{isModalOpen:f,showModal:S,ModalComponent:z}=tt();return e.jsxs(Jn,{children:[e.jsx(ne,{InnerComponent:Rt,InnerComponentProps:{title:"PUSH",getUserData:t,getPoolStats:o,setUnstakeErrorMessage:x,setWithdrawErrorMessage:I},toastObject:O,modalPosition:nt.ON_PARENT}),e.jsx(z,{InnerComponent:$n,InnerComponentProps:{currentTransactionNo:w,totalTransactionNo:B,transactionSteps:te,transactionText:re,setCurrentTransactionNo:U,setTotalTransactionNo:G,setTransactionSteps:J,claimRewards:k,unstakeTokensPaginated:q},onConfirm:()=>{},modalPadding:"0px",modalPosition:nt.ON_ROOT}),e.jsx(M,{margin:"0px 0px 20px 0px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(qn,{children:"PUSH Fee Staking Pool"}),e.jsxs(Kn,{children:["Current APR",e.jsxs(Te,{color:"#D53A94",fontWeight:"600",margin:"0 5px 0 5px",children:[">",Q(a==null?void 0:a.stakingAPR),"% + Fee"]}),e.jsx(Wn,{})]})]}):e.jsxs(Le,{padding:"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:"234px",margin:"0 0 10px 0"}),e.jsx(g,{height:"12px",width:"112px"})]})}),e.jsxs(M,{flex:"5",children:[e.jsxs(Zn,{border:`1px solid ${b.stakingBorder}`,borderRadius:"16px",children:[e.jsx(M,{margin:j?"0px 6px 0 0 ":"0px 18px 0px 0px",padding:j?" 7px":"10px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(It,{children:"Current Reward"}),e.jsxs($,{fontSize:j?"18px":"24px",fontWeight:"600",color:"#D53A94",letterSpacing:"-0.03em",children:[Q(Y(a==null?void 0:a.currentReward))," PUSH"]})]}):e.jsxs(Le,{padding:j?"0px":"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:j?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(g,{height:"12px",width:j?"65px":"100px}"})]})}),e.jsx(Qn,{width:"10px",height:"100%"}),e.jsx(M,{margin:j?"0 0 0 6px":"0 0 0 18px",padding:j?" 7px":"10px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(It,{children:"Total Staked"}),e.jsxs(Xn,{fontSize:j?"18px":"24px",fontWeight:"600",letterSpacing:"-0.03em",children:[Q(Y(a==null?void 0:a.totalStakedAmount))," PUSH"]})]}):e.jsxs(Le,{padding:j?"0px":"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:j?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(g,{height:"12px",width:j?"65px":"100px}"})]})})]}),e.jsx(E,{alignSelf:"end",margin:"12px 13px 24px 0px",color:"#575D73",letterSpacing:"-0.03em",children:a?e.jsxs(e.Fragment,{children:[e.jsx(Nt,{children:"Current Epoch"}),e.jsx(Nt,{children:a==null?void 0:a.currentEpochNumber})]}):e.jsx(Le,{padding:"5px 0px 0 15px",children:e.jsx(g,{height:"12px",width:"124px"})})}),n?e.jsxs(M,{children:[e.jsxs(E,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ke,{children:["User Deposit",e.jsx(Ze,{children:e.jsx(Z,{ToolTipTitle:"User Deposited",ToolTipBody:"Amount of PUSH Token User Staked",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Qe,{children:[" ",Q(Y(n==null?void 0:n.userStaked))," PUSH"]})]}),e.jsxs(E,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ke,{children:["Rewards Claimed",e.jsx(Ze,{children:e.jsx(Z,{ToolTipTitle:"Rewards Claimed",ToolTipBody:"Amount of Push Claimed by User",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Qe,{children:[" ",Q((n==null?void 0:n.claimedReward).toFixed(2))," PUSH"]})]}),e.jsxs(E,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ke,{children:["Current Epoch Reward",e.jsx(Ze,{children:e.jsx(Z,{ToolTipTitle:"Current Epoch Reward",ToolTipBody:"Displays the approximate latest reward amount for current epoch",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Qe,{children:[" ",Q((n==null?void 0:n.potentialReward).toFixed(2))," PUSH"]})]}),e.jsxs(E,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ke,{children:["Available for Claiming",e.jsx(Ze,{children:e.jsx(Z,{ToolTipTitle:"Available for Claiming",ToolTipBody:"Amount of Push Token Available to claim",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Qe,{children:[" ",Q((n==null?void 0:n.availableRewards).toFixed(2))," PUSH"]})]})]}):e.jsxs(ke,{padding:"0 15px 15px 15px",width:"100%",maxWidth:" -webkit-fill-available",borderRadius:"5px",children:[e.jsxs(E,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(E,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(E,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(E,{justifyContent:"space-between",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]})]})]}),e.jsx(M,{padding:j?"0px ":"0px 14px",margin:"24px 0px 24px 0px",children:n?e.jsxs(e.Fragment,{children:[e.jsx(E,{children:e.jsx(ta,{onClick:D,children:" Stake $PUSH"})}),e.jsxs(ea,{children:[(a==null?void 0:a.currentEpochNumber)<=2?e.jsx(Ut,{ToolTipTitle:"You can unstake once epoch 2 ends.",ButtonTitle:"Unstake PUSH"}):Y(n==null?void 0:n.userStaked)==0||m!==null?e.jsx(Ut,{ToolTipTitle:m||"Nothing to unstake, Stake First",ButtonTitle:"Unstake PUSH"}):e.jsx(Xe,{border:`1px solid ${b.activeButtonText}`,background:"transparent",color:b.activeButtonText,cursor:"pointer",onClick:q,style:{margin:"0px 10px 0px 0px"},children:r?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:b.activeButtonText,title:"Unstaking",titleColor:b.activeButtonText}):"Unstake $PUSH"}),(n==null?void 0:n.availableRewards)===0?e.jsx(Z,{bottom:"-30px",ToolTipTitle:"No Rewards to Claim",error:!0,left:"40px",ToolTipWidth:"10rem",children:e.jsx(Xe,{border:"none",background:b.disableButtonBg,cursor:"default",color:b.disabledButtonText,children:d?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:"#D53A94"}):"Claim Rewards"})}):e.jsx(Xe,{border:`1px solid ${b.activeButtonText}`,background:"transparent",color:b.activeButtonText,cursor:"pointer",onClick:k,children:d?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:b.activeButtonText,title:"Claiming",titleColor:b.activeButtonText}):"Claim Rewards"})]})]}):e.jsxs(Le,{width:"100%",children:[e.jsx(g,{height:"49px",width:"100%",margin:"0 0 8px 0"}),e.jsx(g,{height:"49px",width:"100%"})]})})]})},Ut=n=>{const t=Ve();return e.jsx(Z,{error:!0,ToolTipTitle:n.ToolTipTitle,ToolTipWidth:"16rem",margin:"0 10px 0 0",bottom:"-30px",children:e.jsx(Xe,{border:"none",background:t.disableButtonBg,cursor:"default",color:t.disabledButtonText,children:n.ButtonTitle})})},Wn=()=>{const[n,t]=u.useState(!1),a=()=>t(!1),o=u.useRef(null);return Yt(o,()=>a()),e.jsxs(Yn,{ref:o,children:[e.jsx(le,{onClick:()=>t(!n),src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}}),n&&e.jsx(Gn,{id:"channel",children:e.jsx(Tt,{title:"",body:"Push Fee Pool APR distributes yield farming rewards + fee earned by protocol. More Info "})})]})},Yn=p.div`
  width: 34%;
  width: 100%;
  min-width: none;
  max-width: none;
...
`;X.coreContractChain;let Lt,Dt,zt,gt,Bt,Vt;Lt=()=>{fa.pageview("/yield");const[n,t]=u.useState(0),[a,o]=u.useState(!1),{account:s,chainId:i,switchChain:r}=Ce(),l=()=>{const x=X.allowedNetworks[0];i!==1&&i!==5&&r(x)};u.useEffect(()=>{i!==1&&i!==11155111&&(h(),l())},[i]);const{isModalOpen:d,showModal:h,ModalComponent:m}=tt();return e.jsxs(Dt,{children:[e.jsx(m,{InnerComponent:ia,onConfirm:()=>{},modalPadding:"0px",modalPosition:nt.ON_PARENT}),e.jsxs(zt,{children:[e.jsx(gt,{isActive:!n,onClick:()=>{o(!0),t(0)},children:"Yield Farming V2"}),e.jsxs(gt,{isActive:n,onClick:()=>{o(!1),t(1)},children:["Yield Farming V1 ",e.jsx(Bt,{children:"Deprecated"})]})]}),n===0&&e.jsx(na,{setActiveTab:t}),n===1&&e.jsx(gn,{setActiveTab:t})]})},Dt=p(ze)`
	align-items: stretch;
	align-self: center;
  flex: 1;
	background: ${n=>n.theme.default.bg};
