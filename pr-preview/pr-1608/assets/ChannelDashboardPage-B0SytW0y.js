...
`,ro=b.p`
  ...
  margin-left: 12px;
  color: ${e=>e.theme.editChannelPrimaryText};
`,ao=50,oo=fe.coreContractChain;function so({DropdownRef:e,isDropdownOpen:n,closeDropdown:i}){pt();const{account:r,chainId:s}=Se(),{epnsWriteProvider:d,epnsCommWriteProvider:o}=Z(_=>_.contracts),{channelDetails:a}=Z(_=>_.admin),{CHANNNEL_DEACTIVATED_STATE:c,CHANNEL_BLOCKED_STATE:p}=Z(_=>_.channels);Z(_=>_.user),ae.useContext(ei);const h=pe(),{channelState:l}=a,f=oo===s,u=He(425),{isModalOpen:g,showModal:A,ModalComponent:x}=ft(),{isModalOpen:m,showModal:E,ModalComponent:y}=ft(),{isModalOpen:B,showModal:S,ModalComponent:D}=ft(),C=n&&!g&&!m&&!B;Ne(e,()=>C&&i()),ae.useState(!1),ae.useState(ao);const[j,Q]=ae.useState(0),T=l===c,M=l===p,O=M||T;ae.useEffect(()=>{Q(+Yc.formatBigNumberToMetric(a.poolContribution,!0))},[r,a.poolContribution]),Be();const U=()=>{M||(T?E():A())},z=Be(),L=d.reactivateChannel,w=Be(),I=()=>d.deactivateChannel(),k=Be(),R=async(_,H)=>{if(!(_==""||H=="")&&!(_<60))try{const P=_+"+"+H,N=_i(P);return d.addSubGraph(N)}catch(P){console.error(P)}};return t.jsxs(t.Fragment,{children:[t.jsx("div",{children:t.jsx(lo,{background:h,children:t.jsxs(co,{children:[fe.appEnv!=="prod"&&t.jsx(on,{disabled:O,onClick:()=>!O&&S(),children:t.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[t.jsx(vt,{src:va,alt:"cube"}),t.jsx("div",{style:{width:"10px"}}),"Add SubGraph Details"]})}),f&&t.jsx(on,{isChannelDeactivated:T,onClick:U,children:t.jsx(ho,{isChannelBlocked:M,isChannelDeactivated:T,children:t.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[M?t.jsx(vt,{src:tn,alt:"red-bell"}):T?t.jsx(vt,{src:Ca,alt:"green-bell"}):t.jsx(vt,{src:tn,alt:"red-bell"}),t.jsx("div",{style:{width:"10px"}}),M?"Channel Blocked":T?"Activate Channel":"Deactivate Channel"]})})})]})})}),t.jsx(x,{InnerComponent:Sa,onConfirm:I,toastObject:w,modalPosition:xt.ON_ROOT}),t.jsx(y,{InnerComponent:La,onConfirm:L,toastObject:z,modalMargin:u?"10rem 1rem 0 1rem":"",modalPosition:xt.ON_ROOT}),t.jsx(D,{InnerComponent:Ia,onConfirm:R,toastObject:k,modalPosition:xt.ON_ROOT})]})}const lo=b.div`
  position: absolute;
  right: 20px;
  display: flex;
  flex-direction: column-reverse;
