import{bR as v,c9 as Fn,ca as Lc,cb as be,bV as t,cc as st,cd as De,ce as je,cf as lt,cg as ct,ch as zc,ci as re,cj as Jt,ck as Hn,cl as Oc,cm as Vt,cn as Xt,co as ge,cp as $n,cq as dt,cr as Nc,cs as Fc,bK as b,bP as pe,ct as ie,b$ as Le,c0 as ze,cu as Z,bY as W,bO as de,cv as ht,cw as ji,cx as Bi,cy as Be,bQ as Se,c3 as Ve,cz as pt,bT as Kt,bS as Zt,cA as Qe,c5 as fe,bL as ee,c4 as Hc,cB as $c,cC as ut,cD as Gc,cE as Te,c2 as ke,cF as gt,cG as ae,cH as Oe,bN as J,cI as Ne,cJ as Fe,cK as ne,bW as ue,cL as Gn,cM as Si,cN as Ti,cO as Wc,cP as Re,cQ as He,cR as Wn,cS as qn,bU as _e,cT as qc,cU as ki,cV as ei,cW as ft,cX as Yc,cY as xt,cZ as _i,c_ as Jc,c$ as Yn,d0 as Jn,d1 as Vc,d2 as Xc,d3 as Kc,d4 as Zc,d5 as mt,d6 as Vn,d7 as Mi,d8 as Di,d9 as ed,da as td,db as Xn,dc as id,dd as nd,de as rd,df as Kn,dg as Zn,dh as ti,di as ad,dj as od,dk as er,dl as sd,dm as ld,dn as cd,bH as At,dp as tr,dq as ir,dr as dd,ds as hd,bX as pd,dt as ud,du as gd,dv as fd,dw as Qi,dx as xd,dy as nr,dz as rr,dA as md,dB as Ad,dC as wd,dD as bd,dE as yd,dF as Ri,bM as $e,c7 as vd,c8 as Cd,__tla as Id}from"./index-CmyWu-jr.js";import{S as Ed,N as jd,__tla as Bd}from"./RedCircle-1V6XhLLO.js";import{M as ar,g as or,S as Sd,F as Pi,m as Ui,a as sr,C as lr,b as cr,i as Td,c as kd,__tla as _d}from"./ChannelInfoList-BdcD9dg6.js";import{T as Md,__tla as Dd}from"./Tag-CaomWg_C.js";import{M as Qd,A as Rd,__tla as Pd}from"./EmptyNotificationSettings-Co0Sjy_B.js";import{D as Ud,__tla as Ld}from"./index-CQFQFFOt.js";import{D as zd,__tla as Od}from"./entry-CJF3b5Me.js";import{__tla as Nd}from"./TransitionGroupContext-FKi9d7HL.js";import{__tla as Fd}from"./index.es-DKhfqnYF.js";import"./browser-CeceZ__e.js";import{__tla as Hd}from"./index.esm-50wg2tBq.js";let dr,$d=Promise.all([(()=>{try{return Id}catch{}})(),(()=>{try{return Bd}catch{}})(),(()=>{try{return _d}catch{}})(),(()=>{try{return Dd}catch{}})(),(()=>{try{return Pd}catch{}})(),(()=>{try{return Ld}catch{}})(),(()=>{try{return Od}catch{}})(),(()=>{try{return Nd}catch{}})(),(()=>{try{return Fd}catch{}})(),(()=>{try{return Hd}catch{}})()]).then(async()=>{const hr=e=>{const[n,i]=v.useState(!1),[r,s]=v.useState(null),d=v.useCallback(async(a,...c)=>{i(!0);try{const p=await a(...c);return i(!1),p}catch(p){throw i(!1),s(p),p}},[]),o=v.useCallback(async(...a)=>{try{return await d(e,...a)}catch(c){throw console.error(c),c}},[e,d]);return{loading:n,error:r,executeAsyncFunction:o}};function pr(e,n=0,i=1){return Lc(e,n,i)}function ur(e){e=e.slice(1);const n=new RegExp(`.{1,${e.length>=6?2:1}}`,"g");let i=e.match(n);return i&&i[0].length===1&&(i=i.map(r=>r+r)),i?`rgb${i.length===4?"a":""}(${i.map((r,s)=>s<3?parseInt(r,16):Math.round(parseInt(r,16)/255*1e3)/1e3).join(", ")})`:""}function Li(e){if(e.type)return e;if(e.charAt(0)==="#")return Li(ur(e));const n=e.indexOf("("),i=e.substring(0,n);if(["rgb","rgba","hsl","hsla","color"].indexOf(i)===-1)throw new Error(Fn(9,e));let r=e.substring(n+1,e.length-1),s;if(i==="color"){if(r=r.split(" "),s=r.shift(),r.length===4&&r[3].charAt(0)==="/"&&(r[3]=r[3].slice(1)),["srgb","display-p3","a98-rgb","prophoto-rgb","rec-2020"].indexOf(s)===-1)throw new Error(Fn(10,s))}else r=r.split(",");return r=r.map(d=>parseFloat(d)),{type:i,values:r,colorSpace:s}}function gr(e){const{type:n,colorSpace:i}=e;let{values:r}=e;return n.indexOf("rgb")!==-1?r=r.map((s,d)=>d<3?parseInt(s,10):s):n.indexOf("hsl")!==-1&&(r[1]=`${r[1]}%`,r[2]=`${r[2]}%`),n.indexOf("color")!==-1?r=`${i} ${r.join(" ")}`:r=`${r.join(", ")}`,`${n}(${r})`}function fr(e,n){return e=Li(e),n=pr(n),(e.type==="rgb"||e.type==="hsl")&&(e.type+="a"),e.type==="color"?e.values[3]=`/${n}`:e.values[3]=n,gr(e)}const xr=v.createContext(),mr=()=>v.useContext(xr)??!1;function Ar(e){return String(e).match(/[\d.\-+]*\s*(.*)/)[1]||""}function wr(e){return parseFloat(e)}function br(e){const{className:n,classes:i,pulsate:r=!1,rippleX:s,rippleY:d,rippleSize:o,in:a,onExited:c,timeout:p}=e,[h,l]=v.useState(!1),f=be(n,i.ripple,i.rippleVisible,r&&i.ripplePulsate),u={width:o,height:o,top:-(o/2)+d,left:-(o/2)+s},g=be(i.child,h&&i.childLeaving,r&&i.childPulsate);return!a&&!h&&l(!0),v.useEffect(()=>{if(!a&&c!=null){const A=setTimeout(c,p);return()=>{clearTimeout(A)}}},[c,a,p]),t.jsx("span",{className:f,style:u,children:t.jsx("span",{className:g})})}const ye=st("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),yr=["center","classes","className"];let wt=e=>e,zi,Oi,Ni,Fi;const ii=550,vr=80,Cr=De(zi||(zi=wt`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`,ro=b.p`
  ...
  margin-left: 12px;
  color: ${e=>e.theme.editChannelPrimaryText};
`,ao=50,oo=fe.coreContractChain;function so({DropdownRef:e,isDropdownOpen:n,closeDropdown:i}){pt();const{account:r,chainId:s}=Se(),{epnsWriteProvider:d,epnsCommWriteProvider:o}=Z(_=>_.contracts),{channelDetails:a}=Z(_=>_.admin),{CHANNNEL_DEACTIVATED_STATE:c,CHANNEL_BLOCKED_STATE:p}=Z(_=>_.channels);Z(_=>_.user),ae.useContext(ei);const h=pe(),{channelState:l}=a,f=oo===s,u=He(425),{isModalOpen:g,showModal:A,ModalComponent:x}=ft(),{isModalOpen:m,showModal:E,ModalComponent:y}=ft(),{isModalOpen:B,showModal:S,ModalComponent:D}=ft(),C=n&&!g&&!m&&!B;Ne(e,()=>C&&i()),ae.useState(!1),ae.useState(ao);const[j,Q]=ae.useState(0),T=l===c,M=l===p,z=M||T;ae.useEffect(()=>{Q(+Yc.formatBigNumberToMetric(a.poolContribution,!0))},[r,a.poolContribution]),Be();const U=()=>{M||(T?E():A())},O=Be(),L=d.reactivateChannel,w=Be(),I=()=>d.deactivateChannel(),k=Be(),R=async(_,H)=>{if(!(_==""||H=="")&&!(_<60))try{const P=_+"+"+H,N=_i(P);return d.addSubGraph(N)}catch(P){console.error(P)}};return t.jsxs(t.Fragment,{children:[t.jsx("div",{children:t.jsx(lo,{background:h,children:t.jsxs(co,{children:[fe.appEnv!=="prod"&&t.jsx(on,{disabled:z,onClick:()=>!z&&S(),children:t.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[t.jsx(vt,{src:va,alt:"cube"}),t.jsx("div",{style:{width:"10px"}}),"Add SubGraph Details"]})}),f&&t.jsx(on,{isChannelDeactivated:T,onClick:U,children:t.jsx(ho,{isChannelBlocked:M,isChannelDeactivated:T,children:t.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[M?t.jsx(vt,{src:tn,alt:"red-bell"}):T?t.jsx(vt,{src:Ca,alt:"green-bell"}):t.jsx(vt,{src:tn,alt:"red-bell"}),t.jsx("div",{style:{width:"10px"}}),M?"Channel Blocked":T?"Activate Channel":"Deactivate Channel"]})})})]})})}),t.jsx(x,{InnerComponent:Sa,onConfirm:I,toastObject:w,modalPosition:xt.ON_ROOT}),t.jsx(y,{InnerComponent:La,onConfirm:L,toastObject:O,modalMargin:u?"10rem 1rem 0 1rem":"",modalPosition:xt.ON_ROOT}),t.jsx(D,{InnerComponent:Ia,onConfirm:R,toastObject:k,modalPosition:xt.ON_ROOT})]})}const lo=b.div`
  position: absolute;
  right: 20px;
  display: flex;
  flex-direction: column-reverse;
...
`,vt=b.img`
  ...
  padding: 0;
  margin: 0;
`;function sn(){const e=ae.useRef(null),[n,i]=ae.useState(!1);pe();const r=()=>{i(d=>!d)},s=()=>{i(!1)};return t.jsxs(ie,{flex:"0",ref:e,children:[t.jsx(po,{active:n,onClick:r}),n&&t.jsx(so,{DropdownRef:e,isDropdownOpen:n,closeDropdown:s})]})}b.div`
  flex: 1;
  display: flex;
...
`,dn=b(Jn)`
  ...
  border: 1px solid;
  border-color: ${e=>e.theme.default.borderColor};
`,_o=({isToggleOn:e,onToggle:n})=>t.jsxs(Mo,{children:[t.jsx(Do,{id:"toggle-switch",type:"checkbox",defaultChecked:e,onClick:n}),t.jsx(hn,{htmlFor:"toggle-switch"})]}),Mo=b.div`
  position: relative;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,Wo=({channelStakeFees:e,setStakeFeesChoosen:n,setProcessingInfo:i,handleCreateChannel:r})=>{const{loading:s,error:d,executeAsyncFunction:o}=hr(Td),{provider:a,account:c}=Se(),[p,h]=v.useState(0),[l,f]=v.useState(!1),u=He(600),g=async m=>{f(!0);const E=await Ui({noOfTokens:m,provider:a,account:c});i(E+"PUSH Tokens minted successfully!"),f(!1),h(E)},A=async()=>{const m=await kd({address:c,provider:a});h(m)},x=async()=>{await o({provider:a})};return v.useEffect(()=>{A()},[p]),t.jsx(v.Fragment,{children:t.jsxs(Ko,{children:[t.jsxs(W,{self:"center",maxWidth:"800px",width:"100%",margin:"60px 0px 0px 0px",children:[t.jsxs(qo,{children:[t.jsx("p",{children:"Amount for Staking"}),t.jsxs(Yo,{children:[t.jsxs("b",{children:[e," PUSH"]}),t.jsxs(Jo,{children:["Balance: ",p]})]})]}),l?t.jsx(Le,{type:ze.SEAMLESS}):t.jsx(Pi,{onMintPushToken:g,noOfPushTokensToCheck:50}),t.jsxs(Vo,{children:["Don't see Push token in your wallet?",t.jsx(Xo,{onClick:x,children:"Import Token "}),s&&t.jsx("span",{children:t.jsx(Le,{type:ze.SEAMLESS,spinnerSize:20})})]})]}),t.jsx(W,{width:"12.2em",self:"stretch",align:"stretch",margin:u?"70px auto 50px auto":"100px auto 50px auto",children:t.jsx(Ve,{bg:"#e20880",color:"#fff",flex:"1",radius:"15px",padding:"20px 10px",onClick:()=>{n(!0),r()},children:t.jsx(de,{color:"#fff",weight:"600",textTransform:"none",line:"22px",size:"16px",children:"Create Channel"})})})]})})},qo=b.div`
  width: 97%;
  display: flex;
  justify-content: space-between;
  height: 100px;
...
`,qe=e=>e.trim().length==0;function gc({closeEditChannel:e,UploadLogoComponent:n,displayUplaodLogoModal:i}){const{account:r,provider:s}=Se(),{channelDetails:d,aliasDetails:{isAliasVerified:o,aliasAddrFromContract:a}}=Z(G=>G.admin),{epnsReadProvider:c,epnsWriteProvider:p}=Z(G=>G.contracts),h=50,[l,f]=v.useState(d==null?void 0:d.name),[u,g]=v.useState(d==null?void 0:d.info),[A,x]=v.useState(d==null?void 0:d.url),[m,E]=v.useState(d==null?void 0:d.icon),[y,B]=v.useState(d==null?void 0:d.icon),[S,D]=v.useState(d==null?void 0:d.icon),[C,j]=v.useState(S),[Q,T]=v.useState(null),[M,z]=v.useState(!1),[U,O]=v.useState({name:"",description:"",address:"",url:""}),[L,w]=v.useState(!1),[I,k]=v.useState(0),[R,_]=v.useState(0),[H,P]=v.useState(!1),N=Be();v.useEffect(()=>{r&&async function(){const G=await c.channelUpdateCounter(r);k(h*(Number(G)+1))}()},[r]),v.useEffect(()=>{!r||!s||async function(){const G=await or({address:r,provider:s,contractAddress:_e.epnscore});_(parseInt(G));const K=parseInt(G);K>=I&&K!=0?z(!0):z(!1)}()},[r,s]);const F=async()=>{if(w(!0),!s)return;const G=s.getSigner(r);N.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{const K=await sr({signer:G,contractAddress:_e.epnscore,amount:I-R});console.debug("response",K),K&&(w(!1),_(I),z(!0),N.showMessageToast({toastTitle:"Success",toastMessage:"Successfully approved Push!",toastType:"SUCCESS",getToastIcon:se=>t.jsx(Fe,{size:se,color:"green"})}))}catch(K){console.error(K),K.code=="ACTION_REJECTED"?N.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:se=>t.jsx(ne,{size:se,color:"red"})}):(N.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in approving PUSH Token",toastType:"ERROR",getToastIcon:se=>t.jsx(ne,{size:se,color:"red"})}),console.error("Error --> %o",K),console.error({err:K}))}w(!1)},X=()=>{P(!1)},he=He(600),te=v.useRef(null);Ne(te,()=>{X()});const V=()=>(O(""),qe(l)||qe(u)||qe(A)?(qe(l)&&O(G=>({...G,name:"Please, enter the channel name."})),qe(u)&&O(G=>({...G,description:"Please, enter the channel description"})),qe(A)&&O(G=>({...G,url:"Please, enter the channel url"})),!1):jt(l,125)?jt(A,125)?ui(A)?!0:(O(G=>({...G,url:"Channel URL is invalid! Please enter a valid url!"})),!1):(O(G=>({...G,url:"Channel Url should not exceed 125 characters! Please retry!"})),!1):(O(G=>({...G,name:"Channel Name should not exceed 125 characters! Please retry!"})),!1)),Y=()=>!(l!==(d==null?void 0:d.name)||u!==(d==null?void 0:d.info)||A!==(d==null?void 0:d.url)||y!==(d==null?void 0:d.icon)),oe=async G=>{try{if(!V())return;w(!0);const K=JSON.stringify({name:l,info:u,url:A,icon:y,aliasDetails:d.aliasDetails||nr({chainId:parseInt(d.chain_id),address:d.address})});console.debug(K);const se=await rr(K);console.debug("IPFS storagePointer:",se);const le="1+"+se,Ie=_i(le),ce=ki(I.toString(),18);N.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const Ae=await p.updateChannelMeta(r,Ie,ce,{gasLimit:1e6});console.debug(Ae),await Ae.wait(),w(!1),N.showMessageToast({toastTitle:"Success",toastMessage:"Channel Updated Successfully",toastType:"SUCCESS",getToastIcon:ve=>t.jsx(Fe,{size:ve,color:"green"})}),setTimeout(()=>{window.location.reload()},2e3)}catch(K){w(!1),console.error(K.message),K.code=="ACTION_REJECTED"?N.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:se=>t.jsx(ne,{size:se,color:"red"})}):(N.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in updating channel Details",toastType:"ERROR",getToastIcon:se=>t.jsx(ne,{size:se,color:"red"})}),console.error("Error --> %o",K),console.error({err:K}))}},me=async G=>{await Ui({noOfTokens:G,provider:s,account:r})};return v.useEffect(()=>{S&&(console.debug("Image cropped",S),Rn(S,function(G){const K=Pn(G);console.debug("response",K),K.success&&(console.debug("Cropped Image....",S),B(S))}))},[S]),t.jsxs(fc,{ref:te,children:[t.jsx(n,{InnerComponent:nc,InnerComponentProps:{setChannelLogo:E,channelLogo:m,croppedImage:S,setCroppedImage:D,setChannelFile:B,imageSrc:C,setImageSrc:j,imageType:Q,setImageType:T,errorInfo:U,setErrorInfo:O},modalPosition:xt.ON_PARENT}),t.jsxs(xc,{children:[t.jsxs(wc,{children:[t.jsx(bc,{src:m}),t.jsx(mc,{onClick:()=>{i(),P(!0)},children:"Upload Logo"})]}),!he&&t.jsx(yc,{}),t.jsx(Kl,{channelName:l,setChannelName:f,channelInfo:u,setChannelInfo:g,channelURL:A,setChannelURL:x,editChannel:oe,errorInfo:U,setErrorInfo:O})]}),t.jsxs(vc,{children:[t.jsxs("div",{children:[t.jsx(Cc,{children:"Channel edit fee"}),t.jsx(Ic,{children:"Editing channel details requires fees to be deposited"})]}),t.jsxs(ie,{flex:"0",children:[M?t.jsx(Ac,{src:ic}):null,t.jsxs(Ec,{children:[I," PUSH"]})]})]}),t.jsx(Pi,{noOfPushTokensToCheck:I,containerProps:{width:"100%"},onMintPushToken:me}),L?t.jsx(t.Fragment,{children:t.jsxs(jc,{children:[t.jsx(Spinner,{size:42,color:ee.COLORS.PRIMARY_PINK,type:Si.PROCESSING}),t.jsx(Bc,{children:"Verifying Transaction"})]})}):t.jsx(t.Fragment,{children:t.jsxs(Sc,{children:[t.jsx(Tc,{onClick:e,children:"Cancel"}),R>=I?t.jsx(Ii,{disabled:Y(),style:{background:Y()?" #F4DCEA":"#CF1C84"},onClick:oe,children:"Save Changes"}):t.jsx(Ii,{onClick:F,children:"Approve PUSH"})]})})]})}const fc=b(ue)`
  padding: 0px;
...
`;fe.coreContractChain;function Qc(){vd.pageview("/channel_dashboard");const[e,n]=ae.useState(!0),[i,r]=ae.useState(null),s=()=>r(null);return ae.useEffect(()=>{i&&s()},[i]),t.jsxs(Rc,{children:[e?t.jsx(_c,{}):t.jsx(Zi,{}),i&&t.jsx(jd,{notification:i,clearToast:s})]})}const Rc=b(ke)`
  align-items: center;
  align-self: center;
  background: ${e=>e.theme.default.bg};
...
`;b.div`
  ...
  margin-bottom: 15px;
  overflow: hidden;
`;let zn;dr=()=>t.jsx(zn,{children:t.jsx(Qc,{})}),zn=b(Cd)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
  justify-content: flex-start;
`});export{$d as __tla,dr as default};
