...
`,R=r(y)`
  ...
  justify-content: center;
  align-items: center;
`,X=()=>{let{spaceid:t}=Te();return a.jsx(H,{children:a.jsx(U,{spaceid:t})})},H=r(me)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
`});export{we as __tla,X as default};
