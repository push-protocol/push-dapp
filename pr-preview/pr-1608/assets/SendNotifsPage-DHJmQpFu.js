import{ad as s,ae as t,af as l,ag as D,aC as m,b2 as u,aj as N,aZ as T,b9 as a,ao as e,fm as f,ax as h,aA as A,aD as L,__tla as $}from"./index-DKAwhGs-.js";import{S as x,__tla as O}from"./SendNotifications-DCxsajOI.js";import{__tla as p}from"./index-DyXXt5L3.js";import{__tla as g}from"./Tag-BtRsVR8M.js";import{__tla as R}from"./TransitionGroupContext-BkRCa2Ra.js";let _,G=Promise.all([(()=>{try{return $}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return p}catch{}})(),(()=>{try{return g}catch{}})(),(()=>{try{return R}catch{}})()]).then(async()=>{A.coreContractChain;function M(){m.pageview("/send_notificaiton"),u(),N(),T(n=>n.contracts),T(n=>n.admin),A.coreContractChain;const[r,J]=a.useState(2),[d,b]=a.useState(!0);a.useState(null),a.useState(null);const[c,j]=a.useState(!0);a.useState([]);const[E,I]=a.useState(null),U=()=>I(null);return a.useEffect(()=>{E&&U()},[E]),e.jsx(i,{children:r===2&&d?e.jsxs(e.Fragment,{children:[!c&&e.jsx(f,{replace:!0,to:"/dashboard"}),c&&e.jsx(x,{})]}):e.jsx(S,{children:"Channel details are being loaded, please wait\u2026"})})}let i,S,o;i=s(h)`
  align-items: center;
  align-self: center;
