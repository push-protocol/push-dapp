...
`,Ae=10,Dt=({showFilter:e,setShowFilter:c,search:n,setSearch:s})=>{const d=Re(),{userPushSDKInstance:l}=ie(r=>r.user),w=a.useRef(null);Xe(w,()=>e&&c(!1));const{account:f,provider:b,chainId:S}=Ne(),{notifications:g,page:x,finishedFetching:P,toggle:R}=ie(r=>r.notifications),O=fe(),[T,E]=a.useState(null),N=()=>E(null),{run:C,welcomeNotifs:J}=ie(r=>r.userJourney),[v,Z]=a.useState(10),[Y,K]=a.useState([]),[q,X]=a.useState([]),[G,ae]=a.useState(!1),[ee,I]=a.useState([]),[U,V]=a.useState(!1),[W,B]=a.useState(!1),[Q,te]=a.useState(!1),{readOnlyWallet:le}=a.useContext(cr),[ge,ce]=a.useState(!0),de=Ve(),xe=()=>{de("/snap")},h=({msg:r})=>t.jsx(Bt,{children:t.jsx(Lt,{children:r})});a.useEffect(()=>{T&&N()},[T]);const A=()=>ae(!1),$=async(r,o,m,y)=>{if(m==null&&(m=new Date("January 1, 2000")),y==null&&(y=new Date("January 1, 3000")),m=m.getTime()/1e3,y=y.getTime()/1e3,!Q){B(!0),te(!0),ae(!0);var p={channels:o,date:{lowDate:m,highDate:y}};o.length==0&&delete p.channels,X([]);try{let k=[];for(const L of Y){let F;const z=L.message.match(/\[timestamp:(.*?)\]/);z?F=z[1]:F=L.epoch,(p.channels===void 0||p.channels.includes(L.channel))&&F>=m&&F<=y&&(r===""||L.message.toLowerCase().includes(r.toLowerCase()))&&k.push(L)}I(k)}catch(k){console.error(k)}finally{te(!1),B(!1)}}};a.useEffect(()=>{X(ee)},[ee]);const ne=async()=>{if(!(Q||P||!l)){te(!0);try{const r=await l.notification.list("INBOX",{raw:!0,page:x,limit:Ae}),o=se.utils.parseApiResponse(r);d(ur(o)),o.length===0&&d(Qe())}catch(r){console.error(r)}finally{te(!1)}}},ye=async()=>{B(!0),te(!0);try{const r=await l.notification.list("INBOX",{raw:!0,page:1,limit:Ae});g.length||d(hr());const o=se.utils.parseApiResponse(r),m=new Map,y=new Map;r.forEach(p=>{m.set(p.payload.data.sid,p.epoch),y.set(p.payload.data.sid,p.sender)}),o.forEach(p=>{p.date=m.get(p.sid),p.epoch=new Date(p.date).getTime()/1e3,p.channel=y.get(p.sid)}),d(mr({notifs:o,pageSize:Ae})),o.length===0&&d(Qe())}catch(r){console.error(r)}finally{B(!1),te(!1)}},_e=async()=>{V(!0);try{const r=await l.notification.list("INBOX",{limit:1e5,page:x,raw:!0}),o=se.utils.parseApiResponse(r),m=new Map,y=new Map;r.forEach(p=>{m.set(p.payload.data.sid,p.epoch),y.set(p.payload.data.sid,p.sender)}),o.forEach(p=>{p.date=m.get(p.sid),p.epoch=new Date(p.date).getTime()/1e3,p.channel=y.get(p.sid)}),K(o)}catch(r){console.error(r)}finally{V(!1)}};a.useEffect(()=>{(l==null?void 0:l.account)==le||!l||(ye(),_e())},[R,l]);const i=async()=>{G?Z(v+10):ne()},j=r=>G?Number(r)===v-1:Number(r)===g.length-1&&!P&&!W,_=async({secret:r,title:o,message:m,image:y,cta:p})=>{try{let k=await re.decryptWithWalletRPCMethod(b,r,f);const L=await re.decryptWithAES(m,k);let F=await re.decryptWithAES(o,k),z=await re.decryptWithAES(y,k),pe=await re.decryptWithAES(p,k);return{title:F,body:L,image:z,cta:pe}}catch(k){k.code===4001?(console.error(k),H.dark(t.jsx(h,{msg:"User denied message decryption"}),{position:"bottom-right",type:H.TYPE.ERROR,autoClose:5e3,hideProgressBar:!0,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0})):k.code===-32601?(console.error(k),H.dark(t.jsx(h,{msg:"Your wallet doesn't support message decryption."}),{position:"bottom-right",type:H.TYPE.ERROR,autoClose:5e3,hideProgressBar:!0,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0})):(console.error(k),H.dark(t.jsx(h,{msg:"There was an error in message decryption"}),{position:"bottom-right",type:H.TYPE.ERROR,autoClose:5e3,hideProgressBar:!0,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0}))}};return t.jsx(Ce,{theme:O,children:t.jsxs(Mt,{children:[t.jsx("div",{ref:w,children:t.jsx(Le,{notifications:Y,filterNotifications:$,filter:G,reset:A,loadFilter:U,showFilter:e,setShowFilter:c,search:n,setSearch:s})}),t.jsxs(zt,{children:[ge&&t.jsx(t.Fragment,{children:t.jsxs(Ft,{flexWrap:"nowrap",children:[t.jsx(dr,{}),t.jsxs(Gt,{justifyContent:"space-between",children:[t.jsx(Ke,{fontSize:"14px",fontWeight:"400",children:"Get Notifications directly in MetaMask using Push Snap."}),t.jsxs(Wt,{onClick:xe,children:["Install Push Snap ",t.jsx(pr,{})," "]})]}),t.jsx(Ut,{onClick:()=>{ce(!1)}})]})}),(!C&&!g.length||!C&&G&&!q.length||C&&!J.length)&&!Q&&t.jsx("div",{style:{textAlign:"center"},children:t.jsx(rt,{title:"You currently have no notifications, try subscribing to some channels."})}),g&&t.jsxs(Pt,{id:"scrollstyle-secondary",children:[W&&t.jsx(oe,{padding:"10px 20px",children:t.jsx(ve,{type:Ee.SEAMLESS})}),C&&J.map((r,o)=>{const{cta:m,title:y,message:p,app:k,icon:L,image:F,blockchain:z,url:pe}=r;return t.jsx(ze,{children:t.jsx(Oe,{notificationTitle:y,notificationBody:p,cta:m,app:k,icon:L,image:F,theme:O.scheme,chainName:z,url:pe})},`${p}+${y}`)}),(G?q:g).map((r,o)=>{const{cta:m,title:y,message:p,app:k,icon:L,image:F,secret:z,notification:pe,blockchain:or,url:sr}=r;if(!C)return t.jsxs(ze,{children:[j(o)&&t.jsx(tt,{onEnter:()=>i()}),t.jsx(Oe,{notificationTitle:y,notificationBody:p,cta:m,app:k,icon:L,image:F,isSecret:z!="",decryptFn:()=>_({secret:z,title:y,message:p,image:F,cta:m}),chainName:or,theme:O.scheme,url:sr})]},o)}),Q&&!W&&t.jsx(oe,{padding:"10px 20px",children:t.jsx(ve,{type:Ee.SEAMLESS})})]}),T&&t.jsx(De,{notification:T,clearToast:N})]})]})})},Mt=u.div`
  display: flex;
  flex: 1;
  flex-direction: column;
  height: 85%;
...
`,Te=10,Ht=({showFilter:e,setShowFilter:c,search:n,setSearch:s})=>{const d=Re(),{userPushSDKInstance:l}=ie(i=>i.user),w=a.useRef(null);Xe(w,()=>e&&c(!1));const{account:f,chainId:b,provider:S}=Ne(),{epnsCommReadProvider:g}=ie(i=>i.contracts),{subscriptionStatus:x}=ie(i=>i.channels),P=fe(),[R,O]=a.useState(null),T=()=>O(null),{run:E}=ie(i=>i.userJourney),{notifications:N,page:C,finishedFetching:J}=ie(i=>i.spam);g==null||g.address;const[v,Z]=a.useState([]),[Y,K]=a.useState(!1),[q,X]=a.useState([]),[G,ae]=a.useState(!1),[ee,I]=a.useState([]),[U,V]=a.useState(!1),[W,B]=a.useState(!1);je.coreContractChain;const Q=({msg:i})=>t.jsx(Vt,{children:t.jsx(Qt,{children:i})});a.useEffect(()=>{R&&T()},[R]);const te={POLYGON_TEST_AMOY:80002,ETH_TEST_KOVAN:42,ETH_TEST_GOERLI:5,ETH_TEST_SEPOLIA:11155111,POLYGON_MAINNET:137,ETH_MAINNET:1},le=()=>ae(!1),ge=async(i,j,_,r)=>{if(W)return;B(!0),V(!0),ae(!0),_==null&&(_=new Date("January 1, 2000")),r==null&&(r=new Date("January 1, 3000")),_=_.getTime()/1e3,r=r.getTime()/1e3;var o={channels:j,date:{lowDate:_,highDate:r}};j.length==0&&delete o.channels,X([]);let m=[];for(const y of v){let p;const k=y.message.match(/\[timestamp:(.*?)\]/);k?p=k[1]:p=y.epoch,(o.channels===void 0||o.channels.includes(y.channel))&&p>=_&&p<=r&&y.message.toLowerCase().includes(i.toLowerCase())&&m.push(y)}I(m),B(!1),V(!1)};a.useEffect(()=>{console.debug(q,ee),X(ee)},[ee]);const ce=async()=>{if(!(W||J||E||!l)){B(!0);try{const i=await l.notification.list("SPAM",{limit:Te,page:C,raw:!0});let j=se.utils.parseApiResponse(i);j.forEach((r,o)=>{r.date=i[o].epoch,r.epoch=new Date(r.date).getTime()/1e3});const _=i.map(async(r,o)=>{r.channel=i[o].sender;let m=i[o].sender;return{...r}});j=await Promise.all(_),d(xr(j)),j.length===0&&d(Ze())}catch(i){console.error(i)}finally{B(!1)}}},de=async()=>{if(!(W||U||E)){V(!0),B(!0);try{const i=await l.notification.list("SPAM",{limit:Te,page:1,raw:!0});N.length||d(Ie());let j=se.utils.parseApiResponse(i);j.forEach((r,o)=>{r.date=i[o].epoch,r.epoch=new Date(r.date).getTime()/1e3});const _=j.map(async(r,o)=>{r.channel=i[o].sender;let m=i[o].sender;return{...r}});j=await Promise.all(_),j.length===0&&d(Ze())}catch(i){console.error(i)}finally{V(!1),B(!1)}}},xe=async()=>{K(!0);try{const i=await l.notification.list("SPAM",{limit:1e5,page:1,raw:!0});N.length||d(Ie());let j=se.utils.parseApiResponse(i);j.forEach((o,m)=>{o.date=i[m].epoch,o.epoch=new Date(o.date).getTime()/1e3});const _=j.map(async(o,m)=>{o.channel=i[m].sender;let y=i[m].sender;return{...o}});j=await Promise.all(_),console.debug(j);let r=j.filter(o=>!ye(o.channel));d(fr({notifs:r,pageSize:Te})),Z(r)}catch(i){console.error(i)}finally{V(!1),B(!1),K(!1)}};a.useEffect(()=>{l&&(de(),xe())},[l]),a.useEffect(()=>{g&&ce()},[g,f]);const h=async()=>{ce(),d(Ie())},A=i=>Number(i)===N.length-1&&!J&&!U,$=gr(),ne=async(i,j)=>{if(!i)return;let _=i;if(!_)return;console.debug(_),$.showLoaderToast({loaderMessage:"Waiting for Confirmation..."}),console.debug(S,f);const r=await S.getSigner(f);console.debug(r),console.debug({signer:r,channelAddress:ke(i,te[j]),userAddress:ke(f,b)}),await se.channels.subscribe({signer:r,channelAddress:ke(i,b),userAddress:ke(f,b),onSuccess:()=>{$.showMessageToast({toastTitle:"Success",toastMessage:"Successfully opted into channel !",toastType:"SUCCESS",getToastIcon:o=>t.jsx(br,{size:o,color:"green"})}),d(wr({channelAddress:i,status:!0}))},onError:o=>{console.error(o),$.showMessageToast({toastTitle:"Error",toastMessage:"There was an error opting into channel",toastType:"ERROR",getToastIcon:m=>t.jsx(Sr,{size:m,color:"red"})})},env:je.pushNodesEnv})},ye=i=>x[i],_e=async({secret:i,title:j,message:_,image:r,cta:o})=>{try{let m=await re.decryptWithWalletRPCMethod(S,i,f);const y=await re.decryptWithAES(_,m);let p=await re.decryptWithAES(j,m),k=await re.decryptWithAES(r,m),L=await re.decryptWithAES(o,m);return{title:p,body:y,image:k,cta:L}}catch(m){m.code===4001?(console.error(m),H.dark(t.jsx(Q,{msg:"User denied message decryption"}),{position:"bottom-right",type:H.TYPE.ERROR,autoClose:5e3,hideProgressBar:!0,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0})):m.code===-32601?(console.error(m),H.dark(t.jsx(Q,{msg:"Your wallet doesn't support message decryption."}),{position:"bottom-right",type:H.TYPE.ERROR,autoClose:5e3,hideProgressBar:!0,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0})):(console.error(m),H.dark(t.jsx(Q,{msg:"There was an error in message decryption"}),{position:"bottom-right",type:H.TYPE.ERROR,autoClose:5e3,hideProgressBar:!0,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0}))}};return t.jsx(Ce,{theme:P,children:t.jsxs(Kt,{children:[t.jsx("div",{ref:w,children:t.jsx(Le,{notifications:v,filterNotifications:ge,filter:G,reset:le,loadFilter:Y,showFilter:e,setShowFilter:c,search:n,setSearch:s})}),t.jsxs($r,{children:[N&&t.jsxs(Yt,{id:"scrollstyle-secondary",children:[U&&t.jsx(oe,{padding:"10px 20px",children:t.jsx(ve,{type:Ee.SEAMLESS})}),(G&&!E?q:v).map((i,j)=>{const{cta:_,title:r,message:o,app:m,icon:y,image:p,secret:k,notification:L,channel:F,blockchain:z,url:pe}=i;return t.jsxs(Xt,{children:[A(j)&&!W&&t.jsx(tt,{onEnter:h}),t.jsx(Oe,{notificationTitle:r,notificationBody:o,cta:_,app:m,icon:y,image:p,theme:P.scheme,subscribeFn:()=>ne(F,z),isSpam:!0,isSubscribedFn:async()=>ye(F),isSecret:k!="",decryptFn:()=>_e({secret:k,title:r,message:o,image:p,cta:_}),chainName:z,url:pe})]},j)}),W&&!U&&t.jsx(ve,{type:Ee.SEAMLESS})]}),(!N.length||G&&!q.length)&&!W&&t.jsx(Jt,{children:t.jsx(rt,{title:"You currently have no spam notifications."})}),R&&t.jsx(De,{notification:R,clearToast:T})]})]})})},Jt=u.div`
  padding: 20px;
  display: flex;
  justify-content: center;
  align-items: center;
...
`,Qt=u.div`
  margin: 0px 10px;
`,Zt=({isSpam:e})=>{const[c,n]=a.useState(!e),[s,d]=a.useState(!1),[l,w]=a.useState("");fe();const f=Ve(),b=()=>n(g=>!g),S=g=>{b(),d(!1),w(""),f(g)};return t.jsxs(qt,{children:[t.jsx(er,{children:t.jsxs(tr,{children:[t.jsx(He,{isActive:c,onClick:()=>S($e.Inbox),children:"Inbox"}),t.jsx(He,{isActive:!c,onClick:()=>S($e.Spam),children:"Spam"})]})}),c?t.jsx(Dt,{showFilter:s,setShowFilter:d,search:l,setSearch:w}):t.jsx(Ht,{showFilter:s,setShowFilter:d,search:l,setSearch:w})]})},qt=u.div`
  height: 100%;
  width: 100%;
`,er=u.div`
  margin: 0px 30px;
...
`;const rr=je.coreContractChain,ar=({isSpam:e})=>{yr.pageview($e.Inbox);const c=Re(),{account:n,chainId:s,provider:d}=Ne(),{epnsReadProvider:l,epnsCommReadProvider:w}=ie(x=>x.contracts),[f,b]=he.useState(null),S=()=>b(null);fe();const g=rr===s;return he.useEffect(()=>{f&&S()},[f]),he.useEffect(()=>{s&&async function(){const x=g?d:new vr(je.coreRPC),P=new qe(Er.epnscore,et.epnscore,x),R=jr[s].commAddress,O=new qe(R,et.epnsComm,d);c(kr(O)),c(Ar(P))}()},[n,s]),he.useEffect(()=>{!l||!w||(l.pushChannelAdmin().then(x=>{c(Tr(x))}).catch(x=>{console.error({err:x})}),l!=null&&w!=null&&(_r.getInstance().init(n,l,w),Cr.getInstance().init(n,l,w,s)))},[l,w]),t.jsx(ir,{children:t.jsxs(nr,{children:[t.jsx("div",{className:"joyride"}),t.jsx(Zt,{isSpam:e}),f&&t.jsx(De,{notification:f,clearToast:S})]})})},ir=u(Rr)`
  align-items: stretch;
  align-self: stretch;
  flex: 1;
  background: ${e=>e.theme.default.bg};
