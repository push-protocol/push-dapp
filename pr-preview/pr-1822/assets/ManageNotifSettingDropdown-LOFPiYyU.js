import{b6 as d,bp as E,cz as re,a_ as f,cA as ae,b1 as t,aY as q,b$ as G,b_ as X,bi as R,cB as ie,cC as Q,b9 as Z,bT as v,cD as le,cE as ce,cF as de,bq as pe,bY as ge,b3 as ee,b4 as te,cG as k,cH as he,cI as ne,cJ as O,c2 as se,cK as xe,cL as ue,cM as fe,__tla as we}from"./index-B2b9jQwN.js";import{u as Se,n as me}from"./notifSetting-DrLKauYy.js";let I,oe,be=Promise.all([(()=>{try{return we}catch{}})()]).then(async()=>{let P,_,$,B,W,V,H,F,z,U,Y,J,K,L,N;I=({children:n,renderDropdownContainer:p,showDropdown:a,toggleDropdown:g,closeDropdown:s,containerPadding:x,centerOnMobile:i})=>{const c=f.useRef(null),l=f.useRef(null);return ae(c,l,s),t.jsxs(P,{ref:c,onClick:g,children:[n,a&&t.jsx(_,{containerPadding:x,centerOnMobile:i,children:t.jsx("div",{ref:l,onClick:e=>e.stopPropagation(),children:p})})]})},P=d.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
