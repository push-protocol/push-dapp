import{aV as u,bP as T,bE as xe,b0 as f,dW as fe,b4 as n,a$ as se,bF as oe,bK as re,bg as P,c4 as be,bJ as ae,a_ as ie,bL as j,dN as we,ba as le,bb as de,ci as $,dP as Se,bU as ce,bV as O,cj as pe,ds as me,dB as ye,gr as je,__tla as ve}from"./index-DaUqqMTB.js";import{I as Ce,R as Me,__tla as Te}from"./RangeSlider-CH9GetDX.js";let _,ue,he,ge,A,De=Promise.all([(()=>{try{return ve}catch{}})(),(()=>{try{return Te}catch{}})()]).then(async()=>{let B,W,D,V,w,z,F,U,H,N,J,K,X,Y,q,G,I,Q,Z,ee,te,R,ne;_=({children:t,renderDropdownContainer:r,showDropdown:s,toggleDropdown:a,closeDropdown:o,containerPadding:h,centerOnMobile:i})=>{const c=f.useRef(null),p=f.useRef(null);return fe(c,p,o),n.jsxs(B,{ref:c,onClick:a,children:[t,s&&n.jsx(W,{containerPadding:h,centerOnMobile:i,children:n.jsx("div",{ref:p,onClick:e=>e.stopPropagation(),children:r})})]})},B=u.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
