...
`,Ze=s.div`
  ...
  ${({active:e})=>e==="active"&&_e`
    ...
    `};
`,kt=({heading:e,subHeading:o})=>{const i=J();return t.jsx(Ne,{theme:i,children:t.jsxs(gn,{children:[t.jsx(mn,{style:{color:i.default.color},children:e}),t.jsx(un,{style:{color:i.modalMessageColor},children:o})]})})},gn=s.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  margin-bottom: 4%;
...
`,un=s.h4`
  ...
  margin: 0;
  padding: 0;
`,et=B.forwardRef(({title:e},o)=>{const i=J();return t.jsx(Ne,{theme:i,children:t.jsxs(fn,{children:[t.jsx(wn,{style:{color:i.modalMessageColor},children:e}),t.jsx(bn,{ref:o,radius:"12px",padding:"0.8rem",border:"1px solid #BAC4D6",style:{color:i.modalMessageColor}})]})})}),fn=s.div`
  display: flex;
  flex-direction: column;
  margin: 3% 0%;
`,wn=s.h4`
...
`,bn=s(pt)`
  ...
  width: 100%;
`,Rt=({text:e,onClick:o,isLoading:i,topMargin:n,loaderTitle:a})=>{const r=J();return t.jsx(Ne,{theme:r,children:t.jsx(yn,{style:{marginTop:n||"55px"},children:i?t.jsx(Cn,{children:t.jsx(lt,{type:dt.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:a??"",titleColor:"#fff"})}):t.jsx(te,{onClick:o,variant:"primary",size:"large",children:e})})})},yn=s.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  // margin-top: 55px;
