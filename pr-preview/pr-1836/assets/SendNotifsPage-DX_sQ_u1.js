import{e6 as s,eM as t,eN as l,eO as D,eQ as u,e_ as N,dY as m,e$ as T,eg as e,e1 as a,f0 as h,eb as L,ei as _,e7 as f,__tla as $}from"./index-BH9N2ONG.js";import{S as x,__tla as O}from"./SendNotifications-CXtlCjRB.js";import{__tla as p}from"./index-CIO6Gh5B.js";import{__tla as g}from"./Tag-CdmRXc5Z.js";import{__tla as R}from"./TransitionGroupContext-CyYPq4s0.js";let A,G=Promise.all([(()=>{try{return $}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return p}catch{}})(),(()=>{try{return g}catch{}})(),(()=>{try{return R}catch{}})()]).then(async()=>{_.coreContractChain;function M(){u.pageview("/send_notificaiton"),N(),m(),T(n=>n.contracts),T(n=>n.admin),_.coreContractChain;const[r,J]=e.useState(2),[d,y]=e.useState(!0);e.useState(null),e.useState(null);const[c,b]=e.useState(!0);e.useState([]);const[E,I]=e.useState(null),U=()=>I(null);return e.useEffect(()=>{E&&U()},[E]),a.jsx(i,{children:r===2&&d?a.jsxs(a.Fragment,{children:[!c&&a.jsx(h,{replace:!0,to:"/dashboard"}),c&&a.jsx(x,{})]}):a.jsx(S,{children:"Channel details are being loaded, please wait\u2026"})})}let i,S,o;i=s(L)`
  align-items: center;
  align-self: center;
