import{b6 as s,bL as t,bM as l,bN as D,bP as N,bY as u,aZ as L,bZ as T,bh as e,b2 as a,b_ as h,bb as m,bj as A,b7 as f,__tla as $}from"./index-DcdI-yAp.js";import{S as b,__tla as x}from"./SendNotifications-BKwvbLpr.js";import{__tla as O}from"./index-MrLuXhvi.js";import{__tla as R}from"./TransitionGroupContext-Cy7p60ZL.js";let M,g=Promise.all([(()=>{try{return $}catch{}})(),(()=>{try{return x}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return R}catch{}})()]).then(async()=>{A.coreContractChain;function _(){N.pageview("/send_notificaiton"),u(),L(),T(r=>r.contracts),T(r=>r.admin),A.coreContractChain;const[n,p]=e.useState(2),[I,G]=e.useState(!0);e.useState(null),e.useState(null);const[o,J]=e.useState(!0);e.useState([]);const[E,d]=e.useState(null),U=()=>d(null);return e.useEffect(()=>{E&&U()},[E]),a.jsx(i,{children:n===2&&I?a.jsxs(a.Fragment,{children:[!o&&a.jsx(h,{replace:!0,to:"/channel"}),o&&a.jsx(b,{})]}):a.jsx(S,{children:"Channel details are being loaded, please wait\u2026"})})}let i,S,c;i=s(m)`
  align-items: center;
  align-self: center;
