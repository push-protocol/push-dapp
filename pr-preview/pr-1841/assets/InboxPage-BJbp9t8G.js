...
`,Ke=r.div`
  margin: 0px 10px;
`,Xe=({isSpam:s})=>{const[E,$]=p.useState(!s),[w,d]=p.useState(!1),[c,u]=p.useState("");K();const m=we(),A=()=>$(f=>!f),b=f=>{A(),d(!1),u(""),m(f)};return e.jsxs(Ze,{children:[e.jsx(qe,{children:e.jsxs(Qe,{children:[e.jsx(ue,{isActive:E,onClick:()=>b(ge.Inbox),children:"Inbox"}),e.jsx(ue,{isActive:!E,onClick:()=>b(ge.Spam),children:"Spam"})]})}),E?e.jsx(Ie,{showFilter:w,setShowFilter:d,search:c,setSearch:u}):e.jsx(He,{showFilter:w,setShowFilter:d,search:c,setSearch:u})]})},Ze=r.div`
  height: 100%;
  width: 100%;
`,qe=r.div`
  margin: 0px 30px;
