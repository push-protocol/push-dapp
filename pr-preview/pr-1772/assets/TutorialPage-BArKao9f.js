import{cA as a,gb as e,gc as i,gd as g,ge as s,gp as A,cD as I,gq as M,cv as t,gg as n,gh as m,gj as N,cF as u,gk as U,cH as T,gy as $,cB as L,__tla as b}from"./index-CsBd_uFp.js";let h,j=Promise.all([(()=>{try{return b}catch{}})()]).then(async()=>{function E(){const r=A(),l=I(),{run:S}=M(p=>p.userJourney),f=()=>{S===!1&&r($(!0))};return t.jsx(c,{children:t.jsxs(n,{children:[t.jsxs(n,{align:"stretch",justify:"flex-start",margin:"0px 0px 40px 0px",children:[t.jsx(m,{children:t.jsx(s,{weight:"400",size:"32px",color:l.color,children:"Live Walkthrough"})}),t.jsx(s,{color:l.default.secondaryColor,weight:"400",size:"16px",textTransform:"none",textAlign:"center",spacing:"normal",margin:"0px 0px",children:"Let's walk you through the core functions of Push (EPNS), the communication protocol of Web3!"})]}),t.jsx(n,{justify:"flex-start",children:t.jsx(x,{children:t.jsxs(o,{onClick:()=>{f()},hover:"#e20880",children:[t.jsx(s,{color:l.color,children:"\u{1F449} Show me everything!"}),t.jsx(N,{size:20,color:"#ddd"})]})})})]})})}let c,o,d,x,D;c=a(u)`
  align-items: center;
  align-self: center;
...
`,h=()=>t.jsx(D,{children:t.jsx(E,{})}),D=a(L)`
  ...
  align-self: stretch;
  justify-content: flex-start;
`});export{j as __tla,h as default};
