import{e6 as d,ep as O,fC as re,d_ as f,fD as ae,e1 as t,dY as q,e$ as G,e_ as X,ei as R,fE as ie,fF as Q,e9 as Z,eT as v,fG as le,fH as ce,fI as de,eq as pe,eY as ge,e3 as ee,e4 as te,fJ as k,fK as he,fL as ne,fM as E,f4 as se,fN as ue,fO as xe,fP as fe,__tla as we}from"./index-eMY4ycnC.js";import{u as Se,n as me}from"./notifSetting-DrLKauYy.js";let I,oe,je=Promise.all([(()=>{try{return we}catch{}})()]).then(async()=>{let A,_,$,B,W,V,H,F,z,U,N,Y,J,L,K;I=({children:n,renderDropdownContainer:p,showDropdown:a,toggleDropdown:g,closeDropdown:s,containerPadding:u,centerOnMobile:i})=>{const c=f.useRef(null),l=f.useRef(null);return ae(c,l,s),t.jsxs(A,{ref:c,onClick:g,children:[n,a&&t.jsx(_,{containerPadding:u,centerOnMobile:i,children:t.jsx("div",{ref:l,onClick:e=>e.stopPropagation(),children:p})})]})},A=d.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
