import{k8 as Pt,k9 as Ja,cs as l,ka as ie,cv as e,kb as Ue,kc as Se,kd as ke,ke as Oe,hw as _e,kf as Ya,hv as Q,kg as it,kh as Ut,ki as Xa,kj as Fe,kk as at,kl as je,km as Ot,kn as _t,cA as o,cD as Z,h0 as G,cx as qa,cy as Qa,gq as U,cH as ee,ge as ce,h$ as ot,cW as Ft,jU as Za,h3 as de,cq as me,cw as eo,gn as ae,cU as to,gp as Ee,cN as no,cP as io,gi as ve,cM as se,gb as O,gl as ao,ko as oo,kp as Me,kq as ro,cT as Ge,cF as Ve,cE as He,cK as V,gv as rt,gd as I,gN as ue,h9 as fe,ha as J,gg as Y,gT as Gt,gU as st,kr as lt,iD as so,ks as lo,iv as Re,h_ as Vt,kt as Ht,cO as We,ih as co,cR as Wt,gP as Ie,jH as po,gQ as De,ku as Kt,kv as ho,ii as Jt,h2 as Yt,cr as xo,kw as go,kx as mo,ky as uo,kz as ct,i4 as Xt,h7 as dt,gC as pt,kA as fo,cu as Co,gs as wo,gw as yo,kB as bo,kC as jo,hp as vo,kD as To,kE as Ao,gc as Ce,kF as So,kG as ko,kH as Eo,kI as Mo,kJ as ht,gf as Ro,cB as Io,__tla as Do}from"./index-CsBd_uFp.js";import{S as No,N as Lo,__tla as zo}from"./RedCircle-DQoGS6ZX.js";import{M as qt,S as $o,F as Qt,C as Zt,a as en,__tla as Bo}from"./ChannelInfoList-BuAhJnva.js";import{a as Po,__tla as Uo}from"./Tag-C2mZ4Axo.js";import{a as tn,m as nn,b as an,__tla as Oo}from"./PushTokenContractHelper-6WQyX1eL.js";import{M as _o,a as Fo,__tla as Go}from"./EmptyNotificationSettings-BfGXCEbp.js";import{a as on,b as rn,__tla as Vo}from"./ValidationHelper-CuO3xISn.js";import{I as Ho,__tla as Wo}from"./ImportPushTokenMessage-D4W3sm1g.js";import{v as Ko,C as Jo,__tla as Yo}from"./CreateChannel-DX29k72n.js";import{__tla as Xo}from"./TransitionGroupContext-DGo3tjlY.js";import{__tla as qo}from"./index.esm-B7gwDku0.js";import{__tla as Qo}from"./Stepper-mB-nhrU4.js";import{__tla as Zo}from"./StakingVariant-CDmhX2Ee.js";import{__tla as er}from"./useMutation-CDgEuLCp.js";import{__tla as tr}from"./index.esm-Bw0z0FSD.js";import"./Common.form-iMV6nXze.js";let sn,nr=Promise.all([(()=>{try{return Do}catch{}})(),(()=>{try{return zo}catch{}})(),(()=>{try{return Bo}catch{}})(),(()=>{try{return Uo}catch{}})(),(()=>{try{return Oo}catch{}})(),(()=>{try{return Go}catch{}})(),(()=>{try{return Vo}catch{}})(),(()=>{try{return Wo}catch{}})(),(()=>{try{return Yo}catch{}})(),(()=>{try{return Xo}catch{}})(),(()=>{try{return qo}catch{}})(),(()=>{try{return Qo}catch{}})(),(()=>{try{return Zo}catch{}})(),(()=>{try{return er}catch{}})(),(()=>{try{return tr}catch{}})()]).then(async()=>{function ln(t,a=0,n=1){return Ja(t,a,n)}function cn(t){t=t.slice(1);const a=new RegExp(`.{1,${t.length>=6?2:1}}`,"g");let n=t.match(a);return n&&n[0].length===1&&(n=n.map(i=>i+i)),n?`rgb${n.length===4?"a":""}(${n.map((i,s)=>s<3?parseInt(i,16):Math.round(parseInt(i,16)/255*1e3)/1e3).join(", ")})`:""}function xt(t){if(t.type)return t;if(t.charAt(0)==="#")return xt(cn(t));const a=t.indexOf("("),n=t.substring(0,a);if(["rgb","rgba","hsl","hsla","color"].indexOf(n)===-1)throw new Error(Pt(9,t));let i=t.substring(a+1,t.length-1),s;if(n==="color"){if(i=i.split(" "),s=i.shift(),i.length===4&&i[3].charAt(0)==="/"&&(i[3]=i[3].slice(1)),["srgb","display-p3","a98-rgb","prophoto-rgb","rec-2020"].indexOf(s)===-1)throw new Error(Pt(10,s))}else i=i.split(",");return i=i.map(r=>parseFloat(r)),{type:n,values:i,colorSpace:s}}function dn(t){const{type:a,colorSpace:n}=t;let{values:i}=t;return a.indexOf("rgb")!==-1?i=i.map((s,r)=>r<3?parseInt(s,10):s):a.indexOf("hsl")!==-1&&(i[1]=`${i[1]}%`,i[2]=`${i[2]}%`),a.indexOf("color")!==-1?i=`${n} ${i.join(" ")}`:i=`${i.join(", ")}`,`${a}(${i})`}function pn(t,a){return t=xt(t),a=ln(a),(t.type==="rgb"||t.type==="hsl")&&(t.type+="a"),t.type==="color"?t.values[3]=`/${a}`:t.values[3]=a,dn(t)}function hn(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function xn(t){return parseFloat(t)}function gn(t){const{className:a,classes:n,pulsate:i=!1,rippleX:s,rippleY:r,rippleSize:f,in:h,onExited:c,timeout:d}=t,[m,u]=l.useState(!1),x=ie(a,n.ripple,n.rippleVisible,i&&n.ripplePulsate),g={width:f,height:f,top:-(f/2)+r,left:-(f/2)+s},p=ie(n.child,m&&n.childLeaving,i&&n.childPulsate);return!h&&!m&&u(!0),l.useEffect(()=>{if(!h&&c!=null){const E=setTimeout(c,d);return()=>{clearTimeout(E)}}},[c,h,d]),e.jsx("span",{className:x,style:g,children:e.jsx("span",{className:p})})}const ne=Ue("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),mn=["center","classes","className"];let Ne=t=>t,gt,mt,ut,ft;const Ke=550,un=80,fn=Se(gt||(gt=Ne`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`,Ua=10;let Nt=null;const Oa=()=>{Z();const{account:t,chainId:a,wallet:n}=me(),{channelDetails:i,delegatees:s,aliasDetails:{aliasAddr:r,aliasEthAddr:f,isAliasVerified:h,aliasAddrFromContract:c}}=U(w=>w.admin),{processingState:d}=U(w=>w.channelCreation),{epnsWriteProvider:m}=U(w=>w.contracts);U(w=>w.user),l.useContext(Yt);const u=i&&i!=="unfetched",x=de(),g=Ee(),[p,E]=l.useState(!1);l.useState(!0);const[L,z]=l.useState(!1),$=se.coreContractChain===a,C=Re(600);l.useEffect(()=>{if(!$||!i||c||i==="unfetched")return;const w=So(i);if(w){const{address:T,chainId:F}=w;g(ko(T)),g(Eo(F))}else g(Me(0))},[i,c]);const A=async w=>{let{aliasAddress:T=null,isAliasVerified:F=null}=await Xt.getInstance().getChannelDetailsFromAddress(w);return T=="NULL"&&(T=null),{aliasAddress:T,aliasVerified:F}};l.useEffect(()=>{!$||!c||d===0||(Nt=setInterval(async()=>{const{aliasAddress:w,aliasVerified:T}=await A(t);w?(g(Mo(w)),T?(g(ht(!0)),g(Me(0))):(g(Me(2)),g(ht(!1)))):d!=0&&d!=1&&g(Me(1))},Ua*1e3))},[c]),r!==null&&clearInterval(Nt);const b=async()=>{try{x.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const w=await m.destroyTimeBoundChannel(t,{gasLimit:1e6});console.debug(w),console.debug("Check: "+t),await w.wait(),x.showMessageToast({toastTitle:"Success",toastMessage:"Successfully deleted the channel",toastType:"SUCCESS",getToastIcon:T=>e.jsx(J,{size:T,color:"green"})}),g(lt(null))}catch(w){console.error(w),w.code=="ACTION_REJECTED"?x.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:T=>e.jsx(J,{size:T,color:"red"})}):x.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in deleting the channel",toastType:"ERROR",getToastIcon:T=>e.jsx(J,{size:T,color:"red"})})}},D=()=>{z(!0)},H=()=>{z(!1)},{isModalOpen:K,showModal:R,ModalComponent:B}=Ie();return e.jsxs(G,{children:[(i==="unfetched"||d===null)&&e.jsx(jt,{}),i!=="unfetched"&&e.jsxs(Y,{justifyContent:d===0&&"flex-start",height:"fit-content",children:[!i&&d===0&&e.jsx(Jo,{}),u&&d!==null&&e.jsx(_a,{children:L?e.jsx(Aa,{closeEditChannel:H,UploadLogoComponent:B,displayUplaodLogoModal:R,isUploadLogoModalOpen:K}):e.jsxs(e.Fragment,{children:[i&&!C&&e.jsxs(G,{zIndex:"1",gap:"8px",children:[!p&&$&&e.jsx(ae,{onClick:D,size:"small",variant:"outline",children:"Edit Channel"}),!p&&e.jsx(Mt,{}),p&&$&&e.jsx(ae,{onClick:b,size:"small",variant:"danger",children:"Delete Channel"})]}),i?e.jsx(Ji,{isChannelExpired:p,setIsChannelExpired:E,showEditChannel:D,destroyChannel:b}):""]})}),d!==0&&d!==null&&u&&!L&&e.jsx(e.Fragment,{children:e.jsx(Jn,{aliasEthAccount:f,setAliasVerified:ht})})]})]})},_a=o(Y)`
  ...
  @media ${I.mobileL} {
    ...
    min-height: calc(100vh - ${O.CONSTANTS.HEADER_HEIGHT}px - ${Ce.BIG_MODULES.MOBILE.TOP});
    overflow-y: scroll;
    border-radius: ${O.ADJUSTMENTS.RADIUS.LARGE} ${O.ADJUSTMENTS.RADIUS.LARGE} 0 0;
  }
`;se.coreContractChain;function Fa(){Ro.pageview("/channel_dashboard");const[t,a]=V.useState(!0),[n,i]=V.useState(null),s=()=>i(null);return V.useEffect(()=>{n&&s()},[n]),e.jsxs(e.Fragment,{children:[t?e.jsx(Oa,{}):e.jsx(jt,{}),n&&e.jsx(Lo,{notification:n,clearToast:s})]})}o.div`
  flex: 1;
  display: flex;
