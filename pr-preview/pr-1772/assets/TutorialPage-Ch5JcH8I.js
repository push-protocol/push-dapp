import{a_ as s,by as e,bz as a,bA as T,bB as i,bN as A,b1 as I,bO as M,aZ as t,bD as n,bE as N,bG as m,b3 as u,bH as b,b5 as h,bY as $,a$ as U,__tla as L}from"./index-6c19uI7z.js";let E,G=Promise.all([(()=>{try{return L}catch{}})()]).then(async()=>{function S(){const r=A(),l=I(),{run:f}=M(p=>p.userJourney),g=()=>{f===!1&&r($(!0))};return t.jsx(c,{children:t.jsxs(n,{children:[t.jsxs(n,{align:"stretch",justify:"flex-start",margin:"0px 0px 40px 0px",children:[t.jsx(N,{children:t.jsx(i,{weight:"400",size:"32px",color:l.color,children:"Live Walkthrough"})}),t.jsx(i,{color:l.default.secondaryColor,weight:"400",size:"16px",textTransform:"none",textAlign:"center",spacing:"normal",margin:"0px 0px",children:"Let's walk you through the core functions of Push (EPNS), the communication protocol of Web3!"})]}),t.jsx(n,{justify:"flex-start",children:t.jsx(x,{children:t.jsxs(o,{onClick:()=>{g()},hover:"#e20880",children:[t.jsx(i,{color:l.color,children:"\u{1F449} Show me everything!"}),t.jsx(m,{size:20,color:"#ddd"})]})})})]})})}let c,o,d,x,D;c=s(u)`
  align-items: center;
  align-self: center;
