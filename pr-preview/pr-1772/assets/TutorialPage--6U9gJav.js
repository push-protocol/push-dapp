import{a_ as s,bz as e,bA as a,bB as T,bC as i,bO as I,b1 as A,bP as M,aZ as t,bE as n,bF as m,bH as N,b3 as u,bI as b,b5 as h,bZ as $,a$ as U,__tla as L}from"./index-DTrHFZuM.js";let E,G=Promise.all([(()=>{try{return L}catch{}})()]).then(async()=>{function S(){const r=I(),l=A(),{run:f}=M(p=>p.userJourney),g=()=>{f===!1&&r($(!0))};return t.jsx(c,{children:t.jsxs(n,{children:[t.jsxs(n,{align:"stretch",justify:"flex-start",margin:"0px 0px 40px 0px",children:[t.jsx(m,{children:t.jsx(i,{weight:"400",size:"32px",color:l.color,children:"Live Walkthrough"})}),t.jsx(i,{color:l.default.secondaryColor,weight:"400",size:"16px",textTransform:"none",textAlign:"center",spacing:"normal",margin:"0px 0px",children:"Let's walk you through the core functions of Push (EPNS), the communication protocol of Web3!"})]}),t.jsx(n,{justify:"flex-start",children:t.jsx(x,{children:t.jsxs(o,{onClick:()=>{g()},hover:"#e20880",children:[t.jsx(i,{color:l.color,children:"\u{1F449} Show me everything!"}),t.jsx(N,{size:20,color:"#ddd"})]})})})]})})}let c,o,d,x,D;c=s(u)`
  align-items: center;
  align-self: center;
