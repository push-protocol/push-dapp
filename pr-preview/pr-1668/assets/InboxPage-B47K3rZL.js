...
`,qt=u.div`
  margin: 0px 10px;
`,Zt=({isSpam:e})=>{const[c,n]=a.useState(!e),[s,d]=a.useState(!1),[l,w]=a.useState("");fe();const f=Ve(),b=()=>n(g=>!g),y=g=>{b(),d(!1),w(""),f(g)};return t.jsxs(Qt,{children:[t.jsx(er,{children:t.jsxs(tr,{children:[t.jsx(He,{isActive:c,onClick:()=>y(Ie.Inbox),children:"Inbox"}),t.jsx(He,{isActive:!c,onClick:()=>y(Ie.Spam),children:"Spam"})]})}),c?t.jsx(Dt,{showFilter:s,setShowFilter:d,search:l,setSearch:w}):t.jsx(Ht,{showFilter:s,setShowFilter:d,search:l,setSearch:w})]})},Qt=u.div`
  height: 100%;
  width: 100%;
`,er=u.div`
  margin: 0px 30px;
