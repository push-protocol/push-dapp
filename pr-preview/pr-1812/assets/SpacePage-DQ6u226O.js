...
`,y=r(R)`
  ...
  justify-content: center;
  align-items: center;
`,X=()=>{let{spaceid:t}=Te();return s.jsx(B,{children:s.jsx($,{spaceid:t})})},B=r(me)`
  flex: 1;
