import{cA as s,gb as t,gc as l,gd as D,gf as u,gp as m,cq as N,gq as T,cK as a,cv as e,gr as h,cF as L,cM as A,cB as f,__tla as g}from"./index-B9hAuE8R.js";import{S as $,__tla as x}from"./SendNotifications-C1xm19TY.js";import{__tla as p}from"./index-DqSylZnx.js";import{__tla as O}from"./Tag-CXC09f8S.js";import{__tla as R}from"./TransitionGroupContext-Di0uiZpY.js";let _,G=Promise.all([(()=>{try{return g}catch{}})(),(()=>{try{return x}catch{}})(),(()=>{try{return p}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return R}catch{}})()]).then(async()=>{A.coreContractChain;function M(){u.pageview("/send_notificaiton"),m(),N(),T(n=>n.contracts),T(n=>n.admin),A.coreContractChain;const[r,J]=a.useState(2),[d,y]=a.useState(!0);a.useState(null),a.useState(null);const[o,b]=a.useState(!0);a.useState([]);const[E,I]=a.useState(null),U=()=>I(null);return a.useEffect(()=>{E&&U()},[E]),e.jsx(c,{children:r===2&&d?e.jsxs(e.Fragment,{children:[!o&&e.jsx(h,{replace:!0,to:"/dashboard"}),o&&e.jsx($,{})]}):e.jsx(i,{children:"Channel details are being loaded, please wait\u2026"})})}let c,i,S;c=s(L)`
  align-items: center;
  align-self: center;
