import{aV as s,aW as t,aX as l,aY as D,bi as u,bK as m,a$ as N,bF as T,bR as a,b4 as e,g3 as h,bd as L,bg as A,bj as f,__tla as $}from"./index-BDykAaHA.js";import{S as x,__tla as O}from"./SendNotifications-B831qbdE.js";import{__tla as g}from"./index-DSBsylDO.js";import{__tla as p}from"./Tag-BvkyLUcE.js";import{__tla as R}from"./TransitionGroupContext-C6Nq25DI.js";let _,G=Promise.all([(()=>{try{return $}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return g}catch{}})(),(()=>{try{return p}catch{}})(),(()=>{try{return R}catch{}})()]).then(async()=>{A.coreContractChain;function M(){u.pageview("/send_notificaiton"),m(),N(),T(n=>n.contracts),T(n=>n.admin),A.coreContractChain;const[r,b]=a.useState(2),[d,J]=a.useState(!0);a.useState(null),a.useState(null);const[c,j]=a.useState(!0);a.useState([]);const[E,I]=a.useState(null),U=()=>I(null);return a.useEffect(()=>{E&&U()},[E]),e.jsx(i,{children:r===2&&d?e.jsxs(e.Fragment,{children:[!c&&e.jsx(h,{replace:!0,to:"/dashboard"}),c&&e.jsx(x,{})]}):e.jsx(S,{children:"Channel details are being loaded, please wait\u2026"})})}let i,S,o;i=s(L)`
  align-items: center;
  align-self: center;
