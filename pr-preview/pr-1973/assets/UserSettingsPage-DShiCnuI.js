import{go as xe,eb as ue,gv as ge,gw as fe,e7 as a,f6 as U,gx as P,dV as I,f1 as A,dX as l,dW as z,f0 as R,gy as B,gz as G,d_ as e,gA as me,gm as Se,eN as u,fv as we,g4 as be,e2 as je,d$ as ye,eh as Ee,gB as _e,fm as Te,gC as $e,fn as Me,eQ as $,gt as H,gD as ve,gE as Oe,eS as D,gF as Ie,e0 as Ae,e1 as De,el as Ne,gG as ke,eU as Ce,eL as f,eM as M,eW as Le,__tla as Ue}from"./index-T0u25OEh.js";import{c as Pe,__tla as ze}from"./cloneDeep-DK_coF03.js";import{E as Re,__tla as Be}from"./EmptyNotificationSettings-DUQK47f_.js";import{L as Ge,__tla as He}from"./LoaderSpinner--sGhuDit.js";import{__tla as Je}from"./index.esm-B8G_Z_Tv.js";let J,We=Promise.all([(()=>{try{return Ue}catch{}})(),(()=>{try{return ze}catch{}})(),(()=>{try{return Be}catch{}})(),(()=>{try{return He}catch{}})(),(()=>{try{return Je}catch{}})()]).then(async()=>{const W=async({channel:t})=>{try{return await xe.channels.getChannel({channel:t,env:ue.appEnv})}catch(c){throw console.error(c),new Error(c.message)}},F=async({userCaipAddress:t})=>{var p,d;const c=fe.userSubscriptions(t);try{return(d=(p=await ge(c))==null?void 0:p.data)==null?void 0:d.subscriptions}catch(w){throw new Error(w.message)}},q=()=>{const{account:t,chainId:c}=I(),{subscriptionStatus:p,userSettings:d}=A(i=>i.channels),[w,h]=l.useState([]),[v,y]=l.useState(!0),E=z(),b=R(),_=()=>{E("/channels")},T=async i=>{const r=await W({channel:i});if(r)return{channel:i,id:r.id,icon:r.icon,name:r.name,channel_settings:r.channel_settings}},m=async i=>{const r=await Promise.all(Object.keys(i).map(async x=>{const n=await T(x);if(n)return n}));h(r)};l.useEffect(()=>{t&&async function(){if(y(!0),Object.keys(p).length===0){const i=Se(t,c),r=await F({userCaipAddress:i}),x={},n={};r.map(({channel:s,user_settings:S})=>{x[s]=!0,n[s]=S?JSON.parse(S):null}),b(B(x)),b(G(n)),await m(x)}else await m(p);y(!1)}()},[t]);const j=l.useMemo(()=>Pe(d),[d]);return e.jsx(e.Fragment,{children:v?e.jsx(e.Fragment,{children:e.jsx(N,{children:e.jsx(Ge,{})})}):e.jsx(e.Fragment,{children:w.length>0?w.map((i,r)=>e.jsx(e.Fragment,{children:i&&e.jsxs(e.Fragment,{children:[e.jsxs(K,{children:[e.jsxs(X,{children:[e.jsx(Q,{src:i.icon}),e.jsx(V,{children:i.name})]}),e.jsx(me,{userSetting:j[i.channel],centerOnMobile:!1,channelDetail:i,onSuccessOptout:()=>{h(x=>x.filter(n=>(n==null?void 0:n.id)!==i.id))},children:e.jsx(Y,{})})]},i.id),r!==w.length-1&&e.jsx(Z,{})]})})):e.jsx(N,{children:e.jsx(Re,{title:"No Channel Opt-ins",description:"Opt-in channels to manage your notification preferences",buttonTitle:"Go to Channels",onClick:_,showTopBorder:!1})})})})},K=a.div`
  display: flex;
  flex-direction: row;
