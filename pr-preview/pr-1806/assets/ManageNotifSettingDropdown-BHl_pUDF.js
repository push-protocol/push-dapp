import{a_ as d,bg as O,cp as re,b7 as f,cq as ae,aZ as t,b9 as K,bP as X,bO as Y,bd as P,cr as ie,cs as Z,b1 as Q,bG as v,ct as le,cu as ce,cv as de,cw as pe,bM as ge,bU as ee,bV as te,cx as R,cy as he,cz as ne,cA as E,b$ as se,cB as xe,cC as ue,cD as fe,__tla as we}from"./index-BpxRGpaG.js";import{u as Se,n as me}from"./notifSetting-DrLKauYy.js";let z,oe,be=Promise.all([(()=>{try{return we}catch{}})()]).then(async()=>{let k,_,$,B,V,W,U,H,I,F,N,q,G,A,J;z=({children:n,renderDropdownContainer:p,showDropdown:a,toggleDropdown:g,closeDropdown:s,containerPadding:x,centerOnMobile:i})=>{const c=f.useRef(null),l=f.useRef(null);return ae(c,l,s),t.jsxs(k,{ref:c,onClick:g,children:[n,a&&t.jsx(_,{containerPadding:x,centerOnMobile:i,children:t.jsx("div",{ref:l,onClick:e=>e.stopPropagation(),children:p})})]})},k=d.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
