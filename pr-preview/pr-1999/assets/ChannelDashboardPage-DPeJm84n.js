...
`,Ze=s.div`
  ...
  ${({active:e})=>e==="active"&&Fe`
    ...
    `};
`,kt=({heading:e,subHeading:o})=>{const i=X();return t.jsx(ze,{theme:i,children:t.jsxs(gn,{children:[t.jsx(mn,{style:{color:i.default.color},children:e}),t.jsx(un,{style:{color:i.modalMessageColor},children:o})]})})},gn=s.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  margin-bottom: 4%;
...
`,bn=s(pt)`
  ...
  width: 100%;
`,Rt=({text:e,onClick:o,isLoading:i,topMargin:n,loaderTitle:a})=>{const r=X();return t.jsx(ze,{theme:r,children:t.jsx(yn,{style:{marginTop:n||"55px"},children:i?t.jsx(Cn,{children:t.jsx(lt,{type:dt.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:a??"",titleColor:"#fff"})}):t.jsx(te,{onClick:o,variant:"primary",size:"large",children:e})})})},yn=s.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  // margin-top: 55px;
...
`,Ut=({title:e,description:o,Button:i,style:n})=>{const a=X(),r=ge(700);return t.jsxs(vo,{style:n,children:[t.jsxs(K,{align:"flex-start",children:[t.jsx(Co,{style:{color:a.color},children:e}),!r&&t.jsxs(t.Fragment,{children:[t.jsx("div",{style:{height:"4px"}}),t.jsx(jo,{children:o})]})]}),i]})},Co=s.div`
  font-weight: 600;
  font-size: 18px;
  line-height: 150%;
  display: flex;
...
`,tt=({children:e})=>t.jsx($o,{children:e}),$o=s.div`
  ...
  margin-left: 8px;
  max-height: 20px;
`,Ft=e=>{const o=(i,n)=>i.toLowerCase()===n.toLowerCase();return t.jsx(Po,{style:e.style,isLoading:e.isLoading,children:t.jsx(K,{flex:"5",justify:"flex-start",align:"stretch",children:e.isLoading?t.jsx(Uo,{children:t.jsx(lt,{type:dt.SEAMLESS})}):t.jsxs(t.Fragment,{children:[e.items&&e.items.length>0&&e.items.map(i=>{var n,a;return t.jsxs("div",{children:[t.jsx(Bo,{}),t.jsxs(K,{direction:"row",justify:"space-between",padding:"9.5px 0px",children:[t.jsxs(K,{direction:"row",justify:"flex-start",margin:"0px 0px 0px -15px",children:[e.isAddress?t.jsx(_o,{children:t.jsx(So,{delegateAddress:i,maxWidth:"200px"})}):t.jsxs(t.Fragment,{children:[t.jsx(Oo,{children:i.description}),i.type===2&&t.jsx(tt,{children:"Range"}),i.type===3&&t.jsx(tt,{children:"Multi-Range"})]}),e.isAddress&&o(e.account,i)&&t.jsx(tt,{children:"Creator"})]}),e.isAddress===!0&&((n=e.addressDropdownOptions)==null?void 0:n.length)>0&&!o(e.account,i)&&t.jsx(_t,{options:e.addressDropdownOptions,item:i}),e.isAddress===!1&&((a=e.settingsDropdownOptions)==null?void 0:a.length)>0&&t.jsx(_t,{options:e.settingsDropdownOptions,item:i})]})]},e.isAddress?i:i.description||i.index)}),e.items&&e.items.length===0&&e.isAddress===!1&&t.jsx($r,{title:"No settings added",description:"Add settings for users to customize their notification preferences.",onClick:e.onClickEmptyListButton,buttonTitle:e.emptyListButtonTitle})]})})})},Po=s.div`
...
`;re.coreContractChain;function Pa(){Tr.pageview("/channel_dashboard");const[e,o]=B.useState(!0),[i,n]=B.useState(null),a=()=>n(null);return B.useEffect(()=>{i&&a()},[i]),t.jsxs(t.Fragment,{children:[e?t.jsx(Na,{}):t.jsx(Mt,{}),i&&t.jsx(Ar,{notification:i,clearToast:a})]})}s.div`
  ...
  margin-bottom: 15px;
  overflow: hidden;
`;let Kt;fi=()=>t.jsx(Kt,{children:t.jsx(Pa,{})}),Kt=s(Sr)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
  justify-content: flex-start;
