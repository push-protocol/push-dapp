import{q as i,X,m as t,L as ce,dj as J,dk as Q,d1 as c,d6 as w,dE as he,x as ge,z as me,r as l,dF as fe,ds as ue,dG as we,dP as Ce,f7 as C,I as g,G as ee,ey as te,f8 as je,dD as be,__tla as ye}from"./index-DVrWTDQT.js";import{U as ve,b as ke,__tla as Le}from"./UniswapWidget-A20aI0ZE.js";import{E as Me,__tla as $e}from"./EmptyNotificationSettings-DFOTcljh.js";import{T as j,__tla as _e}from"./Tag-BWW3iseB.js";let ie,oe,ne,re,se,He=Promise.all([(()=>{try{return ye}catch{}})(),(()=>{try{return Le}catch{}})(),(()=>{try{return $e}catch{}})(),(()=>{try{return _e}catch{}})()]).then(async()=>{let b,y,v,k,L,M,$,_,H,T,S,m,z,f,A,P,E;ne=({text:e,onClick:r,isLoading:o,color:n,backgroundColor:s,border:a,topMargin:d,loaderTitle:p,padding:x})=>{const h=X();return t.jsx(ce,{theme:h,children:t.jsx(b,{style:{marginTop:d||"55px"},children:o?t.jsx(y,{children:t.jsx(J,{type:Q.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:p??"",titleColor:"#fff"})}):t.jsx(v,{onClick:r,color:n,backgroundColor:s,border:a,style:{padding:x||"16px"},children:e})})})},b=i.div`
  display: flex;
...
`,u=({options:e,item:r})=>{const[o,n]=l.useState(!1),s=l.useRef();return be(s,()=>n(!1)),t.jsxs("div",{children:[t.jsx(I,{onClick:()=>n(!0)}),o&&t.jsx(U,{onMouseLeave:()=>n(!1),ref:s,children:e.map(({icon:a,onClick:d,text:p},x)=>t.jsxs(G,{onClick:()=>d(r),index:x,children:[a,t.jsx(R,{children:p})]},x))})]})},I=i(je)`
