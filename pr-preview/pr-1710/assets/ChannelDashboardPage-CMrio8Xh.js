import{gQ as En,gR as Bo,r as o,gS as xe,m as e,gT as Qe,gU as Ie,gV as je,gW as Ze,e3 as et,gX as Oo,e2 as Q,gY as ut,gZ as Mn,g_ as Fo,g$ as ft,h0 as wt,h1 as oe,h2 as In,h3 as tt,h4 as Uo,h5 as _o,q as r,X as te,eu as V,di as Ne,dj as $e,dd as _,I as M,d1 as ee,er as nt,_ as Pt,gf as Bt,es as Te,x as Se,d7 as He,dc as it,dY as bt,dX as yt,d5 as Re,z as le,c_ as G,d8 as Go,h6 as Vo,h7 as rt,h8 as Ho,D as Ae,n as ke,L as at,R as Z,dk as Le,d0 as L,du as Pe,eJ as Be,ev as X,d3 as ne,dA as Rn,dB as Ot,h9 as Ft,fg as Wo,dp as De,f7 as Oe,eq as Dn,ha as zn,dZ as Ee,eQ as Ko,fz as Ut,eh as Ct,dw as ot,g2 as Yo,dx as st,fB as _t,hb as Jo,dv as Nn,eR as $n,da as qo,hc as Xo,hd as Qo,he as Zo,fA as lt,eP as Ln,ec as Gt,dr as Vt,hf as es,A as ts,hg as Pn,hh as ns,fJ as is,hi as rs,dl as Bn,hj as as,df as On,gi as os,d4 as ss,o as ls,y as ds,hk as cs,dD as Ht,fC as ps,hl as Fn,fy as Un,hm as xs,hn as hs,ho as gs,hp as ms,hq as us,hr as Wt,c$ as Fe,d2 as fs,S as ws,__tla as bs}from"./index-C03HJSIT.js";import{S as ys,N as Cs,__tla as vs}from"./RedCircle-DZrpVXod.js";import{M as _n,S as js,F as Kt,C as Gn,a as Vn,__tla as Ts}from"./ChannelInfoList-CldXG4q4.js";import{a as Ss,__tla as As}from"./Tag-eA0n56Ab.js";import{g as Hn,m as Yt,a as Wn,i as ks,c as Es,__tla as Ms}from"./UniswapWidget-CXXDODfv.js";import{M as Is,a as Rs,__tla as Ds}from"./EmptyNotificationSettings-BY8TtPa6.js";import{D as zs,__tla as Ns}from"./index-B_QhcoW7.js";import{D as $s,__tla as Ls}from"./entry-Bam_WbQ0.js";import{u as Ps,I as Kn,t as Yn,h as Jn,__tla as Bs}from"./LogoSizeHelper-DWSv5KDT.js";import{__tla as Os}from"./TransitionGroupContext-DH86Mqur.js";import{__tla as Fs}from"./slicedToArray-D9ukL5_A.js";import{__tla as Us}from"./index.es-BMwmSEzu.js";import"./browser-CeceZ__e.js";import{__tla as _s}from"./index.esm-YkTUJL7J.js";let qn,Gs=Promise.all([(()=>{try{return bs}catch{}})(),(()=>{try{return vs}catch{}})(),(()=>{try{return Ts}catch{}})(),(()=>{try{return As}catch{}})(),(()=>{try{return Ms}catch{}})(),(()=>{try{return Ds}catch{}})(),(()=>{try{return Ns}catch{}})(),(()=>{try{return Ls}catch{}})(),(()=>{try{return Bs}catch{}})(),(()=>{try{return Os}catch{}})(),(()=>{try{return Fs}catch{}})(),(()=>{try{return Us}catch{}})(),(()=>{try{return _s}catch{}})()]).then(async()=>{function Xn(t,i=0,n=1){return Bo(t,i,n)}function Qn(t){t=t.slice(1);const i=new RegExp(`.{1,${t.length>=6?2:1}}`,"g");let n=t.match(i);return n&&n[0].length===1&&(n=n.map(a=>a+a)),n?`rgb${n.length===4?"a":""}(${n.map((a,d)=>d<3?parseInt(a,16):Math.round(parseInt(a,16)/255*1e3)/1e3).join(", ")})`:""}function Jt(t){if(t.type)return t;if(t.charAt(0)==="#")return Jt(Qn(t));const i=t.indexOf("("),n=t.substring(0,i);if(["rgb","rgba","hsl","hsla","color"].indexOf(n)===-1)throw new Error(En(9,t));let a=t.substring(i+1,t.length-1),d;if(n==="color"){if(a=a.split(" "),d=a.shift(),a.length===4&&a[3].charAt(0)==="/"&&(a[3]=a[3].slice(1)),["srgb","display-p3","a98-rgb","prophoto-rgb","rec-2020"].indexOf(d)===-1)throw new Error(En(10,d))}else a=a.split(",");return a=a.map(s=>parseFloat(s)),{type:n,values:a,colorSpace:d}}function Zn(t){const{type:i,colorSpace:n}=t;let{values:a}=t;return i.indexOf("rgb")!==-1?a=a.map((d,s)=>s<3?parseInt(d,10):d):i.indexOf("hsl")!==-1&&(a[1]=`${a[1]}%`,a[2]=`${a[2]}%`),i.indexOf("color")!==-1?a=`${n} ${a.join(" ")}`:a=`${a.join(", ")}`,`${i}(${a})`}function ei(t,i){return t=Jt(t),i=Xn(i),(t.type==="rgb"||t.type==="hsl")&&(t.type+="a"),t.type==="color"?t.values[3]=`/${i}`:t.values[3]=i,Zn(t)}const ti=o.createContext(),ni=()=>o.useContext(ti)??!1;function ii(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function ri(t){return parseFloat(t)}function ai(t){const{className:i,classes:n,pulsate:a=!1,rippleX:d,rippleY:s,rippleSize:c,in:l,onExited:x,timeout:m}=t,[g,u]=o.useState(!1),p=xe(i,n.ripple,n.rippleVisible,a&&n.ripplePulsate),f={width:c,height:c,top:-(c/2)+s,left:-(c/2)+d},h=xe(n.child,g&&n.childLeaving,a&&n.childPulsate);return!l&&!g&&u(!0),o.useEffect(()=>{if(!l&&x!=null){const T=setTimeout(x,m);return()=>{clearTimeout(T)}}},[x,l,m]),e.jsx("span",{className:p,style:f,children:e.jsx("span",{className:h})})}const he=Qe("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),oi=["center","classes","className"];let dt=t=>t,qt,Xt,Qt,Zt;const vt=550,si=80,li=Ie(qt||(qt=dt`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`)),Ri=t=>{const{classes:i,variant:n,color:a}=t,d={root:["root",`color${oe(a)}`,n],dashed:["dashed",`dashedColor${oe(a)}`],bar1:["bar",`barColor${oe(a)}`,(n==="indeterminate"||n==="query")&&"bar1Indeterminate",n==="determinate"&&"bar1Determinate",n==="buffer"&&"bar1Buffer"],bar2:["bar",n!=="buffer"&&`barColor${oe(a)}`,n==="buffer"&&`color${oe(a)}`,(n==="indeterminate"||n==="query")&&"bar2Indeterminate",n==="buffer"&&"bar2Buffer"]};return wt(d,Ai,i)},Tt=(t,i)=>i==="inherit"?"currentColor":t.vars?t.vars.palette.LinearProgress[`${i}Bg`]:t.palette.mode==="light"?Uo(t.palette[i].main,.62):_o(t.palette[i].main,.5),Di=je("span",{name:"MuiLinearProgress",slot:"Root",overridesResolver:(t,i)=>{const{ownerState:n}=t;return[i.root,i[`color${oe(n.color)}`],i[n.variant]]}})(({ownerState:t,theme:i})=>Q({position:"relative",overflow:"hidden",display:"block",height:4,zIndex:0,"@media print":{colorAdjust:"exact"},backgroundColor:Tt(i,t.color)},t.color==="inherit"&&t.variant!=="buffer"&&{backgroundColor:"none","&::before":{content:'""',position:"absolute",left:0,top:0,right:0,bottom:0,backgroundColor:"currentColor",opacity:.3}},t.variant==="buffer"&&{backgroundColor:"transparent"},t.variant==="query"&&{transform:"rotate(180deg)"})),zi=je("span",{name:"MuiLinearProgress",slot:"Dashed",overridesResolver:(t,i)=>{const{ownerState:n}=t;return[i.dashed,i[`dashedColor${oe(n.color)}`]]}})(({ownerState:t,theme:i})=>{const n=Tt(i,t.color);return Q({position:"absolute",marginTop:0,height:"100%",width:"100%"},t.color==="inherit"&&{opacity:.3},{backgroundImage:`radial-gradient(${n} 0%, ${n} 16%, transparent 42%)`,backgroundSize:"10px 10px",backgroundPosition:"0 -23px"})},tt(rn||(rn=Ue`
  ...
  `),Ii)),Ni=je("span",{name:"MuiLinearProgress",slot:"Bar1",overridesResolver:(t,i)=>{const{ownerState:n}=t;return[i.bar,i[`barColor${oe(n.color)}`],(n.variant==="indeterminate"||n.variant==="query")&&i.bar1Indeterminate,n.variant==="determinate"&&i.bar1Determinate,n.variant==="buffer"&&i.bar1Buffer]}})(({ownerState:t,theme:i})=>Q({width:"100%",position:"absolute",left:0,bottom:0,top:0,transition:"transform 0.2s linear",transformOrigin:"left",backgroundColor:t.color==="inherit"?"currentColor":(i.vars||i).palette[t.color].main},t.variant==="determinate"&&{transition:`transform .${jt}s linear`},t.variant==="buffer"&&{zIndex:1,transition:`transform .${jt}s linear`}),({ownerState:t})=>(t.variant==="indeterminate"||t.variant==="query")&&tt(an||(an=Ue`
    ...
    `),Ei)),$i=je("span",{name:"MuiLinearProgress",slot:"Bar2",overridesResolver:(t,i)=>{const{ownerState:n}=t;return[i.bar,i[`barColor${oe(n.color)}`],(n.variant==="indeterminate"||n.variant==="query")&&i.bar2Indeterminate,n.variant==="buffer"&&i.bar2Buffer]}})(({ownerState:t,theme:i})=>Q({width:"100%",position:"absolute",left:0,bottom:0,top:0,transition:"transform 0.2s linear",transformOrigin:"left"},t.variant!=="buffer"&&{backgroundColor:t.color==="inherit"?"currentColor":(i.vars||i).palette[t.color].main},t.color==="inherit"&&{opacity:.3},t.variant==="buffer"&&{backgroundColor:Tt(i,t.color),transition:`transform .${jt}s linear`}),({ownerState:t})=>(t.variant==="indeterminate"||t.variant==="query")&&tt(on||(on=Ue`
      width: auto;
      animation: ${0} 2.1s cubic-bezier(0.165, 0.84, 0.44, 1) 1.15s infinite;
    `),Mi)),Li=o.forwardRef(function(t,i){const n=Ze({props:t,name:"MuiLinearProgress"}),{className:a,color:d="primary",value:s,valueBuffer:c,variant:l="indeterminate"}=n,x=et(n,ki),m=Q({},n,{color:d,variant:l}),g=Ri(m),u=ni(),p={},f={bar1:{},bar2:{}};if((l==="determinate"||l==="buffer")&&s!==void 0){p["aria-valuenow"]=Math.round(s),p["aria-valuemin"]=0,p["aria-valuemax"]=100;let h=s-100;u&&(h=-h),f.bar1.transform=`translateX(${h}%)`}if(l==="buffer"&&c!==void 0){let h=(c||0)-100;u&&(h=-h),f.bar2.transform=`translateX(${h}%)`}return e.jsxs(Di,Q({className:xe(g.root,a),ownerState:m,role:"progressbar"},p,{ref:i},x,{children:[l==="buffer"?e.jsx(zi,{className:g.dashed,ownerState:m}):null,e.jsx(Ni,{className:g.bar1,ownerState:m,style:f.bar1}),l==="determinate"?null:e.jsx($i,{className:g.bar2,ownerState:m,style:f.bar2})]}))});function Pi(t){return ut("MuiSkeleton",t)}Qe("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const Bi=["animation","className","component","height","style","variant","width"];let ct=t=>t,sn,ln,dn,cn;const Oi=t=>{const{classes:i,variant:n,animation:a,hasChildren:d,width:s,height:c}=t;return wt({root:["root",n,a,d&&"withChildren",d&&!s&&"fitContent",d&&!c&&"heightAuto"]},Pi,i)},Fi=Ie(sn||(sn=ct`
  0% {
    opacity: 1;
  }
...
`,Hi=r.div`
  ...
  display: flex;
  flex-direction: column;
`,Wi=()=>{var n,a;const t=te(),{aliasDetails:{aliasChainId:i}}=_(d=>d.admin);return e.jsxs(M,{margin:"15px 20px 15px 20px",flex:"1",display:"flex",direction:"column",children:[e.jsxs(ee,{textAlign:"center",margin:"30px 0px 0px 0px",color:t.color,size:"16px",textTransform:"none",weight:"500",children:["We\u2019re setting up your channel on the ",(a=(n=nt[i])==null?void 0:n.label)==null?void 0:a.split(" ")[0]," Alias Network."]})," ",e.jsx(ee,{textAlign:"center",margin:"5px 0px 60px 0px",color:t.color,size:"16px",textTransform:"none",weight:"500",children:"This usually takes around 5 minutes."}),e.jsxs(M,{display:"flex",direction:"row",align:"center",margin:"50px 0px",children:[e.jsx(Pt,{color:"#cf1c84",loading:!0,height:13,width:4}),e.jsx(Bt,{margin:"auto 15px",textTransform:"none",color:t.color,size:"16px",weight:"600",children:"Processing"})]})]})},Ki=()=>{var a;Te();const t=te(),{switchChain:i}=Se(),{aliasDetails:{aliasChainId:n}}=_(d=>d.admin);return e.jsxs(M,{margin:"15px 20px 15px 20px",flex:"1",display:"flex",direction:"column",children:[e.jsxs(ee,{textAlign:"center",margin:"30px 0px 0px 0px",color:t.color,size:"16px",textTransform:"none",weight:"500",line:"24px",children:["Change your wallet network to ",e.jsx(Yi,{children:(a=nt[n])==null?void 0:a.label})," to start ",e.jsx("br",{}),"verifying your Channel Alias."]}),e.jsx(M,{width:"12.2em",self:"center",align:"center",margin:"100px auto 50px auto",children:e.jsx(He,{bg:"#e20880",color:"#fff",radius:"15px",padding:"20px 20px",onClick:()=>i(n),children:e.jsx(ee,{color:"#fff",weight:"600",textTransform:"none",line:"22px",size:"16px",children:"Change Network"})})})]})},Yi=r.b`
  color: #cf1c84;
`,Ji=({aliasEthAccount:t,setAliasVerified:i})=>{const n=te(),{account:a,provider:d,chainId:s}=Se(),c=d.getSigner(a),l=it(),x=new bt(nt[s].commAddress,yt.epnsComm,c),[m,g]=o.useState(""),[u,p]=o.useState(!1),f=t,h={80002:{label:"Amoy MATIC",url:"https://faucet.polygon.technology/"},97:{label:"Testnet BNB",url:"https://testnet.bnbchain.org/faucet-smart"},11155420:{label:"Sepolia OpETH",url:"https://faucet.quicknode.com/optimism/sepolia"},2442:{label:"Polygon zkEVM ETH",url:"https://faucet.polygon.technology/"},421614:{label:"Sepolia ArbETH",url:"https://faucet.quicknode.com/arbitrum/sepolia"},123:{label:"Fuse SPARK",url:"https://chaindrop.org/?chainid=123&token=0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"},111557560:{label:"Cyber ETH",url:"https://cyber-testnet.testnets.rollbridge.app/"}},T=async()=>{f==t&&y()},w=async()=>{const{aliasVerified:z}=await Ho({account:a,chainId:s}).then(b=>b?(l(i(b.is_alias_verified)),{aliasVerified:b.is_alias_verified}):{aliasVerified:null});return{aliasVerified:z}},y=()=>{g("Processing"),x.verifyChannelAlias(f).then(async z=>{console.debug(z),g("Transaction Sent! It usually takes 5mins to verify."),await z.wait(1),setTimeout(()=>{g("Transaction Mined!")},2e3),setTimeout(()=>{g("Loading...")},2e3);const b=setInterval(async()=>{const{aliasVerified:A}=await w();A&&(setTimeout(()=>{p(!0)},1e3),clearInterval(b),l(rt(0)))},5e3)}).catch(()=>{g("There was an error"),setTimeout(()=>{g("")},2e3)})};return e.jsxs(M,{margin:"15px 20px 15px 20px",flex:"1",display:"flex",direction:"column",children:[e.jsx(Re,{textAlign:"center",margin:"60px 0px 0px 0px",color:n.color,fontSize:"16px",textTransform:"none",fontWeight:"500",lineHeight:"24px",maxWidth:"400px",children:"You\u2019re almost there! Verify the Channel Alias to enable sending notifications from it."}),m===""&&e.jsx(ee,{textAlign:"center",margin:"60px 0px 0px 0px",color:"#CF1C84",size:"16px",textTransform:"none",weight:"500",line:"24px",children:a}),m===""&&le.appEnv!=="prod"&&e.jsxs(Re,{padding:"10px",margin:"10px",borderRadius:G.ADJUSTMENTS.RADIUS.SMALL,background:n.default.secondaryBg,color:n.default.secondaryColor,children:["You will need"," ",e.jsx(Go,{href:h[s].url,target:"_blank",children:h[s].label})," ","to proceed."]}),!u&&(m?e.jsxs(M,{display:"flex",direction:"row",align:"center",margin:"60px 0px 0px 0px",children:[e.jsx(Pt,{color:"#cf1c84",loading:!0,height:13,width:4}),e.jsx(ee,{color:n.color,weight:"600",textTransform:"none",line:"22px",size:"16px",margin:"0px 10px",children:m})]}):e.jsx(M,{width:"15em",self:"center",align:"center",margin:"60px auto 0px auto",children:e.jsx(He,{bg:"#e20880",color:"#fff",radius:"15px",padding:"20px 10px",onClick:T,children:e.jsx(ee,{color:"#fff",weight:"600",textTransform:"none",line:"22px",size:"16px",children:"Verify Alias Address"})})})),u&&e.jsxs(M,{display:"flex",direction:"row",align:"center",margin:"60px 0px 0px 0px",children:[e.jsx(Vo,{color:"#30CC8B",size:30}),e.jsx(ee,{color:n.color,weight:"600",textTransform:"none",line:"22px",size:"16px",margin:"0px 10px",children:"Verification Complete"})]})]})},qi=({aliasEthAccount:t,setAliasVerified:i})=>{const{processingState:n}=_(a=>a.channelCreation);return e.jsxs(ke,{children:[e.jsxs(Xi,{children:[e.jsxs(At,{type:n>=1?"active":"inactive",active:n==1?"active":"inactive",children:[e.jsx("div",{children:"Waiting for Setup"}),e.jsx(St,{type:n>=1?"active":"inactive"})]}),e.jsxs(At,{type:n>=2?"active":"inactive",active:n==2?"active":"inactive",children:[e.jsx("div",{children:"Change Network"}),e.jsx(St,{type:n>=2?"active":"inactive"})]}),e.jsxs(At,{type:n>=3?"active":"inactive",active:n==3?"active":"inactive",children:[e.jsx("div",{children:"Verify Alias Network"}),e.jsx(St,{type:n>=3?"active":"inactive"})]}),e.jsx(Qi,{})]}),n===1&&e.jsx(Wi,{}),n===2&&e.jsx(Ki,{}),n===3&&e.jsx(Ji,{aliasEthAccount:t,setAliasVerified:i})]})},Xi=r.div`
  display: flex;
  flex-direction: row;
...
`,rr=r(Le)`
  ...
  width: 100%;
`,ar=({onConfirm:t,onClose:i,toastObject:n})=>{const a=Z.useRef();te();const[d,s]=Z.useState(!1),c=()=>!d&&i(),l=Z.useRef(null);Pe(l,()=>c());const x=()=>{var g;s(!0);const m=(g=a==null?void 0:a.current)==null?void 0:g.value;t(m).then(async u=>{console.debug(u),n.showMessageToast({toastTitle:"Delegate Added",toastMessage:"Delegate has been added successfully",toastType:"SUCCESS",getToastIcon:p=>e.jsx(Be,{size:p,color:"green"})}),i()}).catch(u=>{console.error({err:u}),n.showMessageToast({toastTitle:"Transaction Failed",toastMessage:"Adding a delegate failed.",toastType:"ERROR",getToastIcon:p=>e.jsx(X,{size:p,color:"red"})})}).finally(()=>{s(!1)})};return e.jsxs(or,{ref:l,children:[e.jsx(xn,{heading:"Add Delegate",subHeading:"Add an account who can send notifications on behalf of the channel"}),e.jsx(kt,{ref:a,title:"Delegate Address"}),e.jsx(_n,{text:"Add Delegate",onClick:x,isLoading:d})]})},or=r.div`
  width: 30vw;
  display: flex;
  flex-direction: column;
  margin: 6% 1%;
...
`,Ur=r.p`
  ...
  margin-left: 12px;
  color: ${t=>t.theme.editChannelPrimaryText};
`,_r=50,Gr=le.coreContractChain;function Vr({DropdownRef:t,isDropdownOpen:i,closeDropdown:n}){it();const{account:a,chainId:d}=Se(),{epnsWriteProvider:s,epnsCommWriteProvider:c}=_(q=>q.contracts),{channelDetails:l}=_(q=>q.admin),{CHANNNEL_DEACTIVATED_STATE:x,CHANNEL_BLOCKED_STATE:m}=_(q=>q.channels);_(q=>q.user),Z.useContext(Ct);const g=te(),{channelState:u}=l,p=Gr===d,f=Oe(425),{isModalOpen:h,showModal:T,ModalComponent:w}=ot(),{isModalOpen:y,showModal:z,ModalComponent:b}=ot(),{isModalOpen:A,showModal:S,ModalComponent:P}=ot(),k=i&&!h&&!y&&!A;Pe(t,()=>k&&n()),Z.useState(!1),Z.useState(_r);const[H,B]=Z.useState(0),C=u===x,v=u===m,W=v||C;Z.useEffect(()=>{B(+Yo.formatBigNumberToMetric(l.poolContribution,!0))},[a,l.poolContribution]),Te();const J=()=>{v||(C?z():T())},O=Te(),I=s.reactivateChannel,R=Te(),E=()=>s.deactivateChannel(),ve=Te(),ue=async(q,we)=>{if(!(q==""||we=="")&&!(q<60))try{const K=q+"+"+we,Y=_t(K);return s.addSubGraph(Y)}catch(K){console.error(K)}};return e.jsxs(e.Fragment,{children:[e.jsx("div",{children:e.jsx(Hr,{background:g,children:e.jsxs(Wr,{children:[le.appEnv!=="prod"&&e.jsx(fn,{disabled:W,onClick:()=>!W&&S(),children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[e.jsx(xt,{src:sr,alt:"cube"}),e.jsx("div",{style:{width:"10px"}}),"Add SubGraph Details"]})}),p&&e.jsx(fn,{isChannelDeactivated:C,onClick:J,children:e.jsx(Kr,{isChannelBlocked:v,isChannelDeactivated:C,children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[v?e.jsx(xt,{src:hn,alt:"red-bell"}):C?e.jsx(xt,{src:lr,alt:"green-bell"}):e.jsx(xt,{src:hn,alt:"red-bell"}),e.jsx("div",{style:{width:"10px"}}),v?"Channel Blocked":C?"Activate Channel":"Deactivate Channel"]})})})]})})}),e.jsx(w,{InnerComponent:hr,onConfirm:E,toastObject:R,modalPosition:st.ON_ROOT}),e.jsx(b,{InnerComponent:Cr,onConfirm:I,toastObject:O,modalMargin:f?"10rem 1rem 0 1rem":"",modalPosition:st.ON_ROOT}),e.jsx(P,{InnerComponent:dr,onConfirm:ue,toastObject:ve,modalPosition:st.ON_ROOT})]})}const Hr=r.div`
  position: absolute;
  right: 20px;
  display: flex;
  flex-direction: column-reverse;
...
`,Sa=({progress:t,processingInfo:i,progressInfo:n})=>{const a=te();return e.jsxs(ke,{children:[e.jsx(Aa,{children:e.jsx(ka,{children:n})}),e.jsx(Li,{sx:{width:"30em",margin:"50px auto",color:"#cf1c84",height:"6px",borderRadius:"20px","@media (max-width:600px)":{width:"100%"}},color:"inherit",variant:"determinate",value:t}),e.jsxs(M,{display:"flex",direction:"row",align:"center",margin:"0px 0px",children:[e.jsx(Pt,{color:"#cf1c84",loading:!0,height:13,width:2.5}),e.jsx(Bt,{margin:"auto 15px",textTransform:"none",color:a.color,size:"16px",weight:"500",children:i})]})]})},Aa=r.div`
  width: 60%;
  display: flex;
  justify-content: center;
  height: 167px;
...
`,Ea=({channelStakeFees:t,setStakeFeesChoosen:i,setProcessingInfo:n,handleCreateChannel:a})=>{const{loading:d,error:s,executeAsyncFunction:c}=Ps(ks),{provider:l,account:x}=Se(),[m,g]=o.useState(0),[u,p]=o.useState(!1),f=Oe(600),h=async y=>{p(!0);const z=await Yt({noOfTokens:y,provider:l,account:x});n(z+"PUSH Tokens minted successfully!"),p(!1),g(z)},T=async()=>{const y=await Es({address:x,provider:l});g(y)},w=async()=>{await c({provider:l})};return o.useEffect(()=>{T()},[m]),e.jsx(o.Fragment,{children:e.jsxs(Na,{children:[e.jsxs(M,{self:"center",maxWidth:"800px",width:"100%",margin:"60px 0px 0px 0px",children:[e.jsxs(Ma,{children:[e.jsx("p",{children:"Amount for Staking"}),e.jsxs(Ia,{children:[e.jsxs("b",{children:[t," PUSH"]}),e.jsxs(Ra,{children:["Balance: ",m]})]})]}),u?e.jsx(Ne,{type:$e.SEAMLESS}):e.jsx(Kt,{onMintPushToken:h,noOfPushTokensToCheck:50}),e.jsxs(Da,{children:["Don't see Push token in your wallet?",e.jsx(za,{onClick:w,children:"Import Token "}),d&&e.jsx("span",{children:e.jsx(Ne,{type:$e.SEAMLESS,spinnerSize:20})})]})]}),e.jsx(M,{width:"12.2em",self:"stretch",align:"stretch",margin:f?"70px auto 50px auto":"100px auto 50px auto",children:e.jsx(He,{bg:"#e20880",color:"#fff",flex:"1",radius:"15px",padding:"20px 10px",onClick:()=>{i(!0),a()},children:e.jsx(ee,{color:"#fff",weight:"600",textTransform:"none",line:"22px",size:"16px",children:"Create Channel"})})})]})})},Ma=r.div`
  width: 97%;
  display: flex;
  justify-content: space-between;
  height: 100px;
...
`,Io=10;let Tn=null;const Ro=()=>{te();const{account:t,chainId:i}=Se(),{channelDetails:n,delegatees:a,aliasDetails:{aliasAddr:d,aliasEthAddr:s,isAliasVerified:c,aliasAddrFromContract:l}}=_(C=>C.admin),{processingState:x}=_(C=>C.channelCreation),{epnsWriteProvider:m}=_(C=>C.contracts);_(C=>C.user),o.useContext(Ct);const g=n&&n!=="unfetched",u=Te(),p=it(),[f,h]=o.useState(!1);o.useState(!0);const[T,w]=o.useState(!1),y=le.coreContractChain===i,z=Oe(600);o.useEffect(()=>{if(!y||!n||l||n==="unfetched")return;const{address:C,chainId:v}=hs(n);C?(p(gs(C)),p(ms(v))):p(rt(0))},[n,l]);const b=async C=>{let{aliasAddress:v=null,isAliasVerified:W=null}=await Ln.getInstance().getChannelDetailsFromAddress(C);return v=="NULL"&&(v=null),{aliasAddress:v,aliasVerified:W}};o.useEffect(()=>{!y||!l||x===0||(Tn=setInterval(async()=>{const{aliasAddress:C,aliasVerified:v}=await b(t);C?(p(us(C)),v?(p(Wt(!0)),p(rt(0))):(p(rt(2)),p(Wt(!1)))):x!=0&&x!=1&&p(rt(1))},Io*1e3))},[l]),d!==null&&clearInterval(Tn);const A=async()=>{try{u.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const C=await m.destroyTimeBoundChannel(t,{gasLimit:1e6});console.debug(C),console.debug("Check: "+t),await C.wait(),u.showMessageToast({toastTitle:"Success",toastMessage:"Successfully deleted the channel",toastType:"SUCCESS",getToastIcon:v=>e.jsx(X,{size:v,color:"green"})}),p(Ft(null))}catch(C){console.error(C),C.code=="ACTION_REJECTED"?u.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:v=>e.jsx(X,{size:v,color:"red"})}):u.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in deleting the channel",toastType:"ERROR",getToastIcon:v=>e.jsx(X,{size:v,color:"red"})})}},S=()=>{w(!0)},P=()=>{w(!1)},{isModalOpen:k,showModal:H,ModalComponent:B}=ot();return e.jsxs(V,{children:[(n==="unfetched"||x===null)&&e.jsx(pn,{}),n!=="unfetched"&&e.jsxs(ne,{justifyContent:x===0&&"flex-start",height:"fit-content",children:[!n&&x===0&&e.jsx(Ua,{}),g&&x!==null&&e.jsx(e.Fragment,{children:T?e.jsx(go,{closeEditChannel:P,UploadLogoComponent:B,displayUplaodLogoModal:H,isUploadLogoModalOpen:k}):e.jsxs(e.Fragment,{children:[n&&!z&&e.jsxs(V,{position:"absolute",top:"0",right:"0",zIndex:"1",children:[!f&&y&&e.jsx(zo,{onClick:S,children:"Edit Channel"}),!f&&e.jsx(wn,{}),f&&y&&e.jsx(Do,{onClick:A,background:"#E93636",color:"#fff",height:"36px",width:"123px",borderRadius:"8px",fontSize:"14px",children:"Delete Channel"})]}),n?e.jsx(qr,{isChannelExpired:f,setIsChannelExpired:h,showEditChannel:S,destroyChannel:A}):""]})}),x!==0&&x!==null&&g&&!T&&e.jsx(e.Fragment,{children:e.jsx(qi,{aliasEthAccount:s,setAliasVerified:Wt})})]})]})},Do=r(Nn)`
  height: ${t=>t.height||"100%"};
  width: ${t=>t.width||"100%"};
`,zo=r(De)`
  width: 7rem;
...
`;le.coreContractChain;function No(){fs.pageview("/channel_dashboard");const[t,i]=Z.useState(!0),[n,a]=Z.useState(null),d=()=>a(null);return Z.useEffect(()=>{n&&d()},[n]),e.jsxs($o,{children:[t?e.jsx(Ro,{}):e.jsx(pn,{}),n&&e.jsx(Cs,{notification:n,clearToast:d})]})}const $o=r(ke)`
  align-items: center;
  align-self: center;
  background: ${t=>t.theme.default.bg};
