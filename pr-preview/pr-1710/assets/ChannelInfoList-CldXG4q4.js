import{q as i,X,m as t,L as ce,di as J,dj as Q,d0 as c,d5 as w,dv as he,x as ge,z as me,r as l,dw as fe,dr as ue,dx as we,dG as je,f7 as j,I as g,G as ee,ej as te,f8 as Ce,du as be,__tla as ye}from"./index-C03HJSIT.js";import{U as ve,b as ke,__tla as Le}from"./UniswapWidget-CXXDODfv.js";import{E as Me,__tla as $e}from"./EmptyNotificationSettings-BY8TtPa6.js";import{T as C,__tla as _e}from"./Tag-eA0n56Ab.js";let ie,oe,ne,re,se,He=Promise.all([(()=>{try{return ye}catch{}})(),(()=>{try{return Le}catch{}})(),(()=>{try{return $e}catch{}})(),(()=>{try{return _e}catch{}})()]).then(async()=>{let b,y,v,k,L,M,$,_,H,T,S,m,z,f,A,P,E;ne=({text:e,onClick:r,isLoading:o,color:n,backgroundColor:s,border:a,topMargin:d,loaderTitle:p,padding:x})=>{const h=X();return t.jsx(ce,{theme:h,children:t.jsx(b,{style:{marginTop:d||"55px"},children:o?t.jsx(y,{children:t.jsx(J,{type:Q.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:p??"",titleColor:"#fff"})}):t.jsx(v,{onClick:r,color:n,backgroundColor:s,border:a,style:{padding:x||"16px"},children:e})})})},b=i.div`
  display: flex;
