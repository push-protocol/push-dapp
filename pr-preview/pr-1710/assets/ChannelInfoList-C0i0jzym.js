import{q as i,X as Q,m as t,L as ce,dj as X,dk as J,d1 as c,d6 as w,dE as he,x as ge,z as me,r as l,dF as fe,ds as ue,dG as we,dP as Ce,eQ as C,I as g,G as ee,ey as te,eR as je,dD as be,__tla as ye}from"./index-BJ4q6mdb.js";import{U as ve,b as ke,__tla as Le}from"./UniswapWidget-CScOT3cN.js";import{E as Me,__tla as $e}from"./EmptyNotificationSettings-DMMq6FJ9.js";import{T as j,__tla as _e}from"./Tag-BJuieDO1.js";let ie,oe,ne,re,se,He=Promise.all([(()=>{try{return ye}catch{}})(),(()=>{try{return Le}catch{}})(),(()=>{try{return $e}catch{}})(),(()=>{try{return _e}catch{}})()]).then(async()=>{let b,y,v,k,L,M,$,_,H,T,S,m,z,f,A,P,E;ne=({text:e,onClick:r,isLoading:o,color:n,backgroundColor:s,border:a,topMargin:d,loaderTitle:p,padding:x})=>{const h=Q();return t.jsx(ce,{theme:h,children:t.jsx(b,{style:{marginTop:d||"55px"},children:o?t.jsx(y,{children:t.jsx(X,{type:J.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:p??"",titleColor:"#fff"})}):t.jsx(v,{onClick:r,color:n,backgroundColor:s,border:a,style:{padding:x||"16px"},children:e})})})},b=i.div`
  display: flex;
...
`;function ae(e){return ee({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"path",attr:{d:"M6.9998 6V3C6.9998 2.44772 7.44752 2 7.9998 2H19.9998C20.5521 2 20.9998 2.44772 20.9998 3V17C20.9998 17.5523 20.5521 18 19.9998 18H16.9998V20.9991C16.9998 21.5519 16.5499 22 15.993 22H4.00666C3.45059 22 3 21.5554 3 20.9991L3.0026 7.00087C3.0027 6.44811 3.45264 6 4.00942 6H6.9998ZM8.9998 6H16.9998V16H18.9998V4H8.9998V6Z"}}]})(e)}function de(e){return ee({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"path",attr:{d:"M6.9998 6V3C6.9998 2.44772 7.44752 2 7.9998 2H19.9998C20.5521 2 20.9998 2.44772 20.9998 3V17C20.9998 17.5523 20.5521 18 19.9998 18H16.9998V20.9991C16.9998 21.5519 16.5499 22 15.993 22H4.00666C3.45059 22 3 21.5554 3 20.9991L3.0026 7.00087C3.0027 6.44811 3.45264 6 4.00942 6H6.9998ZM5.00242 8L5.00019 20H14.9998V8H5.00242ZM8.9998 6H16.9998V16H18.9998V4H8.9998V6Z"}}]})(e)}let F,V,O,D,B,Z,u,I,R,U,G,W,N,Y,q,K;F=({delegateAddress:e,maxWidth:r})=>{const[o,n]=l.useState(e),[s,a]=l.useState(!1),d=C(1200);return l.useEffect(()=>{if(!d)n(e);else{const p=te(e,5);n(p)}},[d]),t.jsx(B,{onMouseLeave:()=>a(!1),minWidth:d?"120px":"350px",children:t.jsx(V,{addressText:o,isCopied:s,setIsCopied:a,delegateAddress:e})})},V=({addressText:e,isCopied:r,setIsCopied:o,delegateAddress:n})=>{const s=C(1e3),[a,d]=l.useState(!1),p=h=>{d(!1)},x=h=>{d(!0)};return t.jsxs("div",{style:{display:"flex",flexDirection:"row",justifyContent:"space-between",width:"100%"},onMouseEnter:x,onMouseLeave:p,children:[t.jsx(Z,{children:te(e,7,7)}),a&&t.jsx(O,{isMobile:s?"10px":"50px",onClick:()=>{navigator.clipboard.writeText(n),o(!0)},children:r?t.jsx(ae,{size:18,color:"white",style:{paddingTop:6}}):t.jsx(de,{size:18,color:"white",style:{paddingTop:6}})})]})},O=i.div`
  cursor: pointer;
...
`,u=({options:e,item:r})=>{const[o,n]=l.useState(!1),s=l.useRef();return be(s,()=>n(!1)),t.jsxs("div",{children:[t.jsx(I,{onClick:()=>n(!0)}),o&&t.jsx(R,{onMouseLeave:()=>n(!1),ref:s,children:e.map(({icon:a,onClick:d,text:p},x)=>t.jsxs(U,{onClick:()=>d(r),index:x,children:[a,t.jsx(G,{children:p})]},x))})]})},I=i(je)`
...
`,G=i.span`
  margin-left: 8px;
`,se=e=>{const r=(o,n)=>o.toLowerCase()===n.toLowerCase();return t.jsx(W,{style:e.style,isLoading:e.isLoading,children:t.jsx(g,{flex:"5",justify:"flex-start",align:"stretch",children:e.isLoading?t.jsx(q,{children:t.jsx(X,{type:J.SEAMLESS})}):t.jsxs(t.Fragment,{children:[e.items&&e.items.length>0&&e.items.map(o=>{var n,s;return t.jsxs("div",{children:[t.jsx(Y,{}),t.jsxs(g,{direction:"row",justify:"space-between",padding:"9.5px 0px",children:[t.jsxs(g,{direction:"row",justify:"flex-start",margin:"0px 0px 0px -15px",children:[e.isAddress?t.jsx(K,{children:t.jsx(F,{delegateAddress:o,maxWidth:"200px"})}):t.jsxs(t.Fragment,{children:[t.jsx(N,{children:o.description}),o.type===2&&t.jsx(j,{children:"Range"}),o.type===3&&t.jsx(j,{children:"Multi-Range"})]}),e.isAddress&&r(e.account,o)&&t.jsx(j,{children:"Creator"})]}),e.isAddress===!0&&((n=e.addressDropdownOptions)==null?void 0:n.length)>0&&!r(e.account,o)&&t.jsx(u,{options:e.addressDropdownOptions,item:o}),e.isAddress===!1&&((s=e.settingsDropdownOptions)==null?void 0:s.length)>0&&t.jsx(u,{options:e.settingsDropdownOptions,item:o})]})]},e.isAddress?o:o.description||o.index)}),e.items&&e.items.length===0&&e.isAddress===!1&&t.jsx(Me,{title:"No settings added",description:"Add settings for users to customize their notification preferences.",onClick:e.onClickEmptyListButton,buttonTitle:e.emptyListButtonTitle})]})})})},W=i.div`
