...
`,p(g)`
  ...
  width: 100%;
  border-radius: 2px;
`;const On=n=>u.createElement("svg",{width:29,height:28,viewBox:"0 0 29 28",fill:"none",xmlns:"http://www.w3.org/2000/svg",...n},u.createElement("path",{d:"M26.1673 14.0002C26.1673 20.4431 20.9436 25.6668 14.5007 25.6668C8.05773 25.6668 2.83398 20.4431 2.83398 14.0002C2.83398 7.55725 8.05773 2.3335 14.5007 2.3335C20.9436 2.3335 26.1673 7.55725 26.1673 14.0002Z",fill:"#30CC8B"}),u.createElement("path",{d:"M20.6751 8.5083L12.7593 16.4335L9.49146 13.175L7.8418 14.8246L12.7616 19.7328L22.3254 10.158L20.6751 8.5083Z",fill:"white"})),$n=({onClose:n,InnerComponentProps:t})=>{const{currentTransactionNo:a,totalTransactionNo:o,transactionSteps:s,transactionText:i,setCurrentTransactionNo:r,setTotalTransactionNo:l,setTransactionSteps:d,claimRewards:h,unstakeTokensPaginated:m}=t,x=()=>{d(0),n()},F=async()=>{d(0),l(0),r(0),i!=null&&i.includes("Unstaking")?m():h()};return e.jsx(Hn,{children:o?e.jsxs(e.Fragment,{children:[e.jsx(E,{justifyContent:"end",children:e.jsx(mt,{onClick:()=>x(),style:{cursor:"pointer"}})}),s===0&&e.jsxs(e.Fragment,{children:[e.jsx(Yt,{size:42,color:xe.COLORS.PRIMARY_PINK,type:Kt.PROCESSING}),e.jsxs(M,{gap:"24px",margin:"16px 0 0 0",children:[e.jsxs(M,{children:[e.jsxs($,{fontSize:"28px",fontWeight:"500",letterSpacing:"normal",children:["Please sign transaction ",a,"/",o]}),e.jsx($,{fontSize:"18px",fontWeight:"400",color:"#657795",children:"Processing your request"})]}),e.jsx($,{fontSize:"18px",fontWeight:"400",color:"#657795",children:i}),e.jsx(M,{padding:"16px",children:e.jsx($,{fontSize:"16px",fontWeight:"400",color:"#D53A94",children:"Confirm the request in your wallet"})})]})]}),s===1&&e.jsxs(M,{gap:"24px",children:[e.jsx(M,{gap:"9px",children:e.jsx($,{fontSize:"28px",fontWeight:"500",letterSpacing:"normal",children:"Transaction Error"})}),e.jsx(M,{children:e.jsx(Ft,{onClick:F,children:"Retry"})})]}),s===2&&e.jsxs(M,{gap:"24px",children:[e.jsxs(M,{children:[e.jsx(On,{height:"50px",width:"50px"}),e.jsxs(M,{gap:"9px",children:[e.jsx($,{fontSize:"28px",fontWeight:"500",letterSpacing:"normal",children:"Transactions Successful"}),e.jsx($,{fontSize:"18px",fontWeight:"400",color:"#657795",children:"You have claimed all the rewards."})]})]}),e.jsx(M,{onClick:x,children:e.jsx(Ft,{children:"Close"})})]})]}):e.jsx(Yt,{size:42,color:xe.COLORS.PRIMARY_PINK,type:Kt.PROCESSING})})},Hn=p(M)`
  min-width: 493px;
  padding: 32px 24px;
`,Ft=p(fe)`
  min-width: 200px;
