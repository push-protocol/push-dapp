...
`,z=o.div`
  ...
  align-items: center;
  height: 80%;
`,_e=()=>{const{account:t,isWalletConnected:n,connect:i,provider:u}=U(),x=nt(),[s,g]=d.useState(!1),[b,S]=d.useState(!1),[y,a]=d.useState(!1),[r,l]=d.useState(null),[L,c]=d.useState({enabled:!1,hrsLeft:0}),[h,C]=d.useState(!1),j="npm:@pushprotocol/snap";async function E(){if(!n){l("Connect your metamask wallet to install Snap"),C(!1);return}l("");const m=await window.ethereum.request({method:"wallet_getSnaps"});console.debug("Snaps installed",m),Object.keys(m).forEach(_=>{_=="npm:@pushprotocol/snap"&&C(!0)})}async function k(m){return await u.getSigner(m).signMessage(`Add address ${m} to receive notifications through Push Snap`)}async function P(){var m;try{await k(t)?t&&(await((m=window.ethereum)==null?void 0:m.request({method:"wallet_invokeSnap",params:{snapId:j,request:{method:"pushproto_addaddress",params:{address:t}}}})),console.debug("Added",t),S(!0)):console.error("Signature Validation Failed")}catch(_){l(_.message)}}async function f(){var _;const m=await((_=window.ethereum)==null?void 0:_.request({method:"wallet_invokeSnap",params:{snapId:j,request:{method:"pushproto_getaddresses"}}}));console.debug(t),m.includes(t)?(a(!0),S(!0)):a(!1)}d.useEffect(()=>{E(),f()},[t,n,h]);async function w(){var Z;if(!n)return;let m=j,_={};await((Z=window.ethereum)==null?void 0:Z.request({method:"wallet_requestSnaps",params:{[m]:_}})),console.info("Snap Installed"),C(!0)}async function T(){if(!n){l("Connect your metamask wallet to install Snap");return}l(""),g(!0);try{n||await i(),h?await P():(await w(),E()),g(!1)}catch(m){g(!1),console.error("Error",m)}}const N=()=>{const{isModalOpen:m,showModal:_,ModalComponent:Z}=rt();return e.jsxs(Ee,{children:[e.jsx(Z,{InnerComponent:lt,modalPadding:"0px",modalPosition:ot.ON_ROOT}),e.jsx(A,{children:e.jsx(ae,{src:ct,width:"276px",height:"202px"})}),e.jsxs(A,{gap:"24px",children:[e.jsxs(A,{gap:"12px",children:[e.jsxs(A,{children:[e.jsx(dt,{fontSize:"34px",fontWeight:"500",color:x.snapPrimaryText,letterSpacing:"normal",children:"Push Snap"}),e.jsx(R,{fontSize:"12px",fontWeight:"400",color:x.modalIconColor,children:"powered by MetaMask"})]}),e.jsx(A,{children:e.jsx(R,{fontSize:"14px",fontWeight:"400",color:x.snapSecondaryText,children:"You\u2019re about to install Push Snap which allows you to receive notifications from Push directly on MetaMask!"})})]}),r&&e.jsx(B,{variant:"error",heading:r,showIcon:!0}),e.jsxs(p,{gap:"spacing-sm",display:"flex",flexDirection:"column",width:"-webkit-fill-available",children:[s&&!h?e.jsx(se,{type:ne.SEAMLESS,spinnerSize:44}):e.jsx(I,{disabled:!!h,onClick:()=>T(),variant:"primary",size:"large",children:h?"Step 1: Completed":"Step 1: Install Snap"}),s&&h?e.jsx(se,{type:ne.SEAMLESS,spinnerSize:44}):e.jsx(I,{disabled:!h,onClick:()=>T(),trailingIcon:e.jsx(xe,{height:24,width:24}),children:"Step 2: Sign In with Metamask"})]}),e.jsxs(De,{gap:"7px",onClick:_,children:[e.jsx(ae,{src:pt,width:16}),e.jsx(R,{color:x.modalIconColor,fontSize:"14px",fontWeight:"400",children:"About this Snap"})]})]})]})};return e.jsx(e.Fragment,{children:b?e.jsx(e.Fragment,{children:e.jsxs(p,{display:"flex",flexDirection:"column",padding:"spacing-none spacing-none spacing-none spacing-xxs",children:[e.jsx(D,{variant:"h4-semibold",children:"Push Snap Settings"}),e.jsx(it,{snoozeDuration:L,setSnoozeDuration:c})]})}):e.jsx(N,{})})},Ee=o(at)`
  width: 438px;
  height: auto;
  border-radius: 32px;
  background: #fff;
...
`,o.div`
  ...
  align-items: center;
  height: 80%;
`;let V,J,K;V=()=>e.jsx(J,{children:e.jsx(Te,{})}),J=o.div`
	align-items: stretch;
	align-self: stretch;
  flex: 1;
	background: ${t=>t.theme.default.bg};
	border-radius: ${v.ADJUSTMENTS.RADIUS.LARGE};
	box-shadow: ${v.ADJUSTMENTS.MODULE_BOX_SHADOW};
	display: flex;
	flex-direction: column;
	flex: initial;
	justify-content: center;
  ...
  margin: ${v.ADJUSTMENTS.MARGIN.MINI_MODULES.DESKTOP};
  height: calc(100vh - ${v.CONSTANTS.HEADER_HEIGHT}px - ${$.MINI_MODULES.DESKTOP.TOP} - ${$.MINI_MODULES.DESKTOP.BOTTOM});
  
  @media ${M.laptop} {
    margin: ${v.ADJUSTMENTS.MARGIN.MINI_MODULES.TABLET};
    height: calc(100vh - ${v.CONSTANTS.HEADER_HEIGHT}px - ${$.MINI_MODULES.TABLET.TOP} - ${$.MINI_MODULES.TABLET.BOTTOM});
  }

  @media ${M.mobileL} {
    margin: ${v.ADJUSTMENTS.MARGIN.MINI_MODULES.MOBILE};
    height: calc(100vh - ${v.CONSTANTS.HEADER_HEIGHT}px - ${$.MINI_MODULES.MOBILE.TOP});
    border: ${v.ADJUSTMENTS.RADIUS.LARGE};
    border-radius: ${v.ADJUSTMENTS.RADIUS.LARGE} ${v.ADJUSTMENTS.RADIUS.LARGE} 0 0;
`,re=()=>e.jsx(K,{children:e.jsx(V,{})}),K=o(gt)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
