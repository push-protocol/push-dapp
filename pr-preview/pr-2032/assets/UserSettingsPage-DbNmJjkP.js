...
`,o.div`
  ...
  align-items: center;
  height: 80%;
`;let q,J,K;q=()=>e.jsx(J,{children:e.jsx(Te,{})}),J=o.div`
	align-items: stretch;
	align-self: stretch;
  flex: 1;
	background: ${t=>t.theme.default.bg};
