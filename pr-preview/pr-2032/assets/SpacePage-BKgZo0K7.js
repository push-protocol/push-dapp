...
`,R=r(y)`
  ...
  justify-content: center;
  align-items: center;
`,X=()=>{let{spaceid:t}=fe();return s.jsx(H,{children:s.jsx(U,{spaceid:t})})},H=r(Te)`
  flex: 1;
