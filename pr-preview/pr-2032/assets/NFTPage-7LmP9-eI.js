...
`,c.div`
  margin: 0px 10px;
`;function Qr({controlAt:e,setControlAt:t,setTokenId:a}){const{account:n,chainId:r,provider:i}=K(),[s,u]=p.useState(null),[l,h]=p.useState(null),[d,x]=p.useState(null),[f,y]=p.useState([]),[m,F]=p.useState(!0),v=r===H.mainnetCoreContractChain?i:new be(H.mainnetCoreRPC);p.useEffect(()=>{if(v&&n){const w=new S(O.rockstarV2,E.rockstarV2,v);u(w);let g=v.getSigner(n);const j=new S(O.rockstarV2,E.rockstarV2,g);h(j);const _=new S(O.NFTRewardsV2,E.NFTRewardsV2,g);x(_)}return()=>{u(null),h(null),x(null)}},[n]),p.useEffect(()=>{s&&J()},[n,s]);const J=async()=>{let w=await b.getTotalSupply(s);F(!1);for(let g=0;g<w;g++){let j=await b.getTokenByIndex(g,s),_=await b.getTokenData(j,s,d),V=_.metadata.replace("ipfs://","https://ipfs.io/ipfs/"),Ue=await(await fetch(`${V}`)).json();_.nftInfo=Ue,await y($e=>[...$e,_])}};return o.jsxs(G,{align:"center",children:[m&&o.jsx(de,{padding:"50px 20px 20px 20px",children:o.jsx(Q,{type:ee.SEAMLESS})}),!m&&f.length!=0&&o.jsx(ce,{id:"scrollstyle-secondary",margin:"20px 0 0 0",children:Object.keys(f).map(w=>{var g;if(f)return o.jsx(At,{NFTObject:f[w],nftReadProvider:s,nftWriteProvider:l,controlAt:e,setControlAt:t,setTokenId:a},(g=f[w])==null?void 0:g.id)})})]})}c.div`
  padding: 20px;
`;function ea({controlAt:e,setControlAt:t,setTokenId:a}){const{account:n,provider:r,chainId:i}=K(),[s,u]=p.useState(null),[l,h]=p.useState(null),[d,x]=p.useState(null),[f,y]=p.useState([]),[m,F]=p.useState(!0),v=i===H.mainnetCoreContractChain?r:new be(H.mainnetCoreRPC);p.useEffect(()=>{if(v&&n){const w=new S(O.rockstar,E.rockstar,v);u(w);let g=v.getSigner(n);const j=new S(O.rockstar,E.rockstar,g);h(j);const _=new S(O.NFTRewards,E.NFTRewards,g);x(_)}},[n]),p.useEffect(()=>{s&&d&&J()},[n,s,l,d]);const J=async()=>{let w=await b.getNFTBalance(n,s);F(!1);for(let g=0;g<w;g++){let j=await b.getTokenOfOwnerByIndex(n,g,s),_=await b.getTokenData(j,s,d);await y(V=>[...V,_])}};return o.jsxs(de,{margin:"32px 0 0 0",children:[m&&o.jsx(Ct,{children:o.jsx(Q,{type:ee.SEAMLESS,spinnerSize:40})}),!m&&f.length==0&&o.jsx(Ct,{children:o.jsx(Ut,{title:"No ROCKSTAR tokens are available in your account"})}),!m&&f.length!=0&&o.jsx(ta,{id:"scrollstyle-secondary",margin:"20px 0 0 0",children:Object.keys(f).map(w=>{if(f[w].id)return o.jsx(Et,{NFTObject:f[w],nftReadProvider:s,nftWriteProvider:l,controlAt:e,setControlAt:t,setTokenId:a},f[w].id)})})]})}const Ct=c.div`
  padding: 20px;
`,ta=c.div`
  display: block;
  align-self: stretch;
  padding: 10px 20px;
`;function na({controlAt:e,setControlAt:t,setTokenId:a}){const{account:n,provider:r,chainId:i}=K(),[s,u]=B.useState(null),[l,h]=B.useState(null),[d,x]=B.useState(null),[f,y]=B.useState([]),[m,F]=B.useState(!0),v=i===H.mainnetCoreContractChain?r:new be(H.mainnetCoreRPC);B.useEffect(()=>{if(v&&n){const g=new S(O.rockstarV2,E.rockstarV2,v);u(g);let j=v.getSigner(n);const _=new S(O.rockstarV2,E.rockstarV2,j);h(_);const V=new S(O.NFTRewardsV2,E.NFTRewardsV2,j);x(V)}},[n]),B.useEffect(()=>{s&&J()},[n,s]);const J=async()=>{let g=await b.getNFTBalance(n,s);F(!1);for(let j=0;j<g;j++){let _=await b.getTokenOfOwnerByIndex(n,j,s);if(_<1||_>100)return;let V=await b.getTokenData(_,s,d),Ue=await w(V.metadata);V.nftInfo=Ue,y($e=>[...$e,V])}},w=async g=>{let j=g.replace("ipfs://","https://ipfs.io/ipfs/");return await(await fetch(`${j}`)).json()};return o.jsxs(de,{margin:"32px 0 0 0",children:[m&&o.jsx(Rt,{children:o.jsx(Q,{type:ee.SEAMLESS,spinnerSize:40})}),!m&&f.length==0&&o.jsx(Rt,{children:o.jsx(Ut,{title:"No ROCKSTAR NFTs are available in your account"})}),!m&&f.length!=0&&o.jsx(ce,{margin:"20px 0 0 0",children:Object.keys(f).map(g=>{if(f)return o.jsx(At,{NFTObject:f[g],nftReadProvider:s,nftWriteProvider:l,controlAt:e,setControlAt:t,setTokenId:a},f[g].id)})})]})}const Rt=c.div`
  padding: 20px;
`;function ra({tokenId:e}){const{account:t,provider:a}=K(),[n,r]=p.useState(null),[i,s]=p.useState(""),[u,l]=p.useState(0),[h,d]=p.useState("");p.useEffect(()=>{if(a&&t){let y=a.getSigner(t);const m=new S(O.rockstar,E.rockstar,y);r(m)}},[t]);const x=async y=>{if(n){if(console.info("\u{1F680} ~ file: TransferNFT.js ~ line 64 ~ handleTransferNFT ~ nftWriteProvider",n),y.preventDefault(),f(i))return l(3),d("Recipient address field is empty! Please retry!"),!1;l(1),d("Transferring NFT...");let F=a.getSigner(t);new S(O.rockstar,E.rockstar,F);var m=n["safeTransferFrom(address,address,uint256)"](t,i,e);const v=await m;console.debug(v),console.info("waiting for tx to finish"),d("Waiting for Transfer tx to finish..."),await a.waitForTransaction(v.hash),d("Transfer successfull! "),l(3)}},f=y=>y.trim().length==0;return o.jsxs(o.Fragment,{children:[o.jsx(G,{children:o.jsx(W,{padding:"10px 20px 20px",children:o.jsxs(M,{align:"flex-start",children:[o.jsx(pe,{textTransform:"uppercase",spacing:"normal",children:o.jsx(D,{weight:"200",children:"Transfer Your NFT!"})}),o.jsx(pe,{textTransform:"uppercase",spacing:"normal",children:o.jsxs(D,{bg:"#674c9f",color:"#fff",weight:"600",padding:"0px 8px",children:["Token #",e]})})]})})}),o.jsx(G,{children:o.jsx(W,{padding:"50px 0px 0px 0px",children:o.jsxs($t,{flex:"1",direction:"column",margin:"0px",justify:"center",size:"1.1rem",onSubmit:x,children:[o.jsxs(M,{margin:"-10px 20px 15px 20px",flex:"1",self:"stretch",align:"stretch",children:[o.jsx(we,{required:!0,placeholder:"Recipient Address",maxlength:"40",padding:"12px",borderBottom:"1px solid #000",weight:"400",size:"1.2em",bg:"#fff",value:i,onChange:y=>{s(y.target.value)}}),i.trim().length==0&&o.jsx(D,{padding:"4px 10px",right:"0px",top:"0px",pos:"absolute",color:"#fff",bg:"#000",size:"0.7rem",z:"1",children:"Recipient Address"})]}),o.jsx(M,{margin:"15px 0px 0px 0px",flex:"1",self:"stretch",align:"stretch",children:o.jsxs(Fe,{bg:"#674c9f",color:"#fff",flex:"1",radius:"0px",padding:"20px 10px",disabled:u==1,children:[u==1&&o.jsx(Q,{type:ee.SEAMLESS,spinnerSize:24,spinnerColor:"#fff"}),u!=1&&o.jsx(we,{cursor:"hand",textTransform:"uppercase",color:"#fff",weight:"400",size:"0.8em",spacing:"normal",type:"submit",value:"Transfer"})]})})]})})}),(u==1||u==3)&&o.jsx(G,{children:o.jsx(W,{padding:"0px 0px 0px 0px",children:o.jsx(M,{color:"#fff",bg:u==1?"#e1087f":"#000",padding:"10px 15px",margin:"15px 0px",children:o.jsx(D,{color:"#fff",textTransform:"uppercase",spacing:"normal",weight:"400",size:"1em",children:h})})})})]})}function aa({tokenId:e}){const{account:t,provider:a}=K(),[n,r]=p.useState(null),[i,s]=p.useState(""),[u,l]=p.useState(0),[h,d]=p.useState("");p.useEffect(()=>{if(a&&t){let y=a.getSigner(t);const m=new S(O.rockstarV2,E.rockstarV2,y);r(m)}},[t]);const x=async y=>{if(n){if(y.preventDefault(),f(i))return l(3),d("Recipient address field is empty! Please retry!"),!1;l(1),d("Transferring NFT...");let F=a.getSigner(t);new S(O.rockstarV2,E.rockstarV2,F);var m=n["safeTransferFrom(address,address,uint256)"](t,i,e);const v=await m;console.debug(v),console.info("waiting for tx to finish"),d("Waiting for Transfer tx to finish..."),await a.waitForTransaction(v.hash),d("Transfer successfull! "),l(3)}},f=y=>y.trim().length==0;return o.jsxs(o.Fragment,{children:[o.jsx(G,{children:o.jsx(W,{padding:"10px 20px 20px",children:o.jsxs(M,{align:"flex-start",children:[o.jsx(pe,{textTransform:"uppercase",spacing:"normal",children:o.jsx(D,{weight:"200",children:"Transfer Your NFT!"})}),o.jsx(pe,{textTransform:"uppercase",spacing:"normal",children:o.jsxs(D,{bg:"#674c9f",color:"#fff",weight:"600",padding:"0px 8px",children:["Token #",e]})})]})})}),o.jsx(G,{children:o.jsx(W,{padding:"50px 0px 0px 0px",children:o.jsxs($t,{flex:"1",direction:"column",margin:"0px",justify:"center",size:"1.1rem",onSubmit:x,children:[o.jsxs(M,{margin:"-10px 20px 15px 20px",flex:"1",self:"stretch",align:"stretch",children:[o.jsx(we,{required:!0,placeholder:"Recipient Address",maxlength:"40",padding:"12px",borderBottom:"1px solid #000",weight:"400",size:"1.2em",bg:"#fff",value:i,onChange:y=>{s(y.target.value)}}),i.trim().length==0&&o.jsx(D,{padding:"4px 10px",right:"0px",top:"0px",pos:"absolute",color:"#fff",bg:"#000",size:"0.7rem",z:"1",children:"Recipient Address"})]}),o.jsx(M,{margin:"15px 0px 0px 0px",flex:"1",self:"stretch",align:"stretch",children:o.jsxs(Fe,{bg:"#674c9f",color:"#fff",flex:"1",radius:"0px",padding:"20px 10px",disabled:u==1,children:[u==1&&o.jsx(Q,{type:ee.SEAMLESS,spinnerSize:24,spinnerColor:"#FFF"}),u!=1&&o.jsx(we,{cursor:"hand",textTransform:"uppercase",color:"#fff",weight:"400",size:"0.8em",spacing:"normal",type:"submit",value:"Transfer"})]})})]})})}),(u==1||u==3)&&o.jsx(G,{children:o.jsx(W,{padding:"0px 0px 0px 0px",children:o.jsx(M,{color:"#fff",bg:u==1?"#e1087f":"#000",padding:"10px 15px",margin:"15px 0px",children:o.jsx(D,{color:"#fff",textTransform:"uppercase",spacing:"normal",weight:"400",size:"1em",children:h})})})})]})}function oa(){ya.pageview("/rockstars");const{account:e}=K(),t=ga(),[a,n]=p.useState(null),[r,i]=p.useState(1),[s,u]=p.useState(2),[l,h]=p.useState([]),d=y=>{let m=[...l];m[y]=!m[y],h(m)};p.useEffect(()=>{x(2)},[e]);const x=y=>{u(y)},f=y=>{y.target.checked?i(0):i(1)};return o.jsx(ia,{children:o.jsxs(G,{children:[o.jsxs(W,{padding:"20px 0px",children:[o.jsxs(de,{alignSelf:"stretch",justifyContent:"flex-start",margin:"0 0 40px 0",children:[o.jsx(pe,{children:o.jsx(D,{weight:"400",size:"32px",color:t.color,children:"Rockstar of Push (EPNS)"})}),o.jsx(D,{color:t.default.secondaryColor,weight:"400",size:"16px",textTransform:"none",textAlign:"center",spacing:"normal",margin:"0px 0px",children:"Thank you community for all your support. Over the next year, we are excited to continue returning our gratitude!"})]}),o.jsx(M,{align:"stretch",justify:"flex-start",margin:"0px 20px 0px 20px",children:o.jsxs(M,{align:"stretch",margin:"0px 0px 20px 0px",children:[o.jsxs(Le,{children:[o.jsxs(ge,{onClick:()=>{d(1)},hover:"#e20880",children:[o.jsx(D,{color:t.color,children:"Does $ROCKSTAR of Push (EPNS) Vol 2 NFTs carry something along with NFTs?"}),o.jsx(Vt,{size:20,color:"#ddd"})]}),l[1]&&o.jsx(xe,{children:o.jsxs(D,{children:["Yes, Each ",o.jsx(Bt,{children:"$ROCKSTAR_V2"})," contains ",o.jsx(Bt,{children:"900 $PUSH"})," tokens that can be claimed instantly!!!"," ",o.jsx(ze,{href:"https://medium.com/ethereum-push-notification-service/push-token-economics-d7f566c29b1a",target:"_blank",title:"Read more about $PUSH tokeneconomics",children:"Learn about $PUSH Token Economics."})]})})]}),o.jsxs(Le,{children:[o.jsxs(ge,{onClick:()=>{d(2)},hover:"#e20880",children:[o.jsx(D,{color:t.color,children:"How to get $ROCKSTAR of Push (EPNS)?"}),o.jsx(Vt,{size:20,color:"#ddd"})]}),l[2]&&o.jsx(xe,{children:o.jsxs(D,{children:["We\u2019ll be distributing one NFT a week (every Monday) to one community member who does something to help us push the envelope forward."," ",o.jsx(ze,{href:"https://medium.com/push-protocol/announcing-volume-2-of-epns-rockstars-64f0b3246604",target:"_blank",title:"Read how to get $ROCKSTAR of Push (EPNS)",children:"Here are some ways by which you can get one!"})]})})]})]})})]}),o.jsx(W,{padding:"20px 0px",bg:"#eee",children:o.jsxs(M,{align:"flex-start",margin:"0px 20px 0px 20px",children:[o.jsxs(sa,{children:[o.jsx(Ne,{className:s===2?"v2":"v1",onClick:()=>{x(2)},children:o.jsx(Me,{children:"ROCKSTAR V2"})}),o.jsx(Ne,{className:s===1?"v2":"v1",onClick:()=>{x(1)},children:o.jsx(Me,{children:"ROCKSTAR V1"})}),o.jsxs(la,{children:[o.jsx("input",{type:"checkbox",className:"checkbox",onChange:f}),"Show mine"]})]}),r===0&&s===1&&o.jsx(ea,{controlAt:r,setControlAt:i,setTokenId:n}),r===0&&s===2&&o.jsx(na,{controlAt:r,setControlAt:i,setTokenId:n}),r===1&&s===1&&o.jsx($r,{controlAt:r,setControlAt:i,setTokenId:n}),r===1&&s===2&&o.jsx(Qr,{controlAt:r,setControlAt:i,setTokenId:n}),r===2&&a&&o.jsx(ra,{tokenId:a}),r===3&&a&&o.jsx(aa,{tokenId:a})]})})]})})}const ia=c(G)`
  align-items: center;
  align-self: center;
...
`;c.button`
  ...
  ${e=>e.disabled&&X`
    ...
    `}
`;let Ne,Me,ge,xe,Le,ze,Nt,Mt;Ne=c(ca)`
  &.v1 {
    background-color: #adb5bd;
  }
  &.v2 {
