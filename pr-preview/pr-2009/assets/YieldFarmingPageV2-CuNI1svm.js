...
`,Me=i(Ce)`
  ...
  border-radius: 5px;
  gap: 5px;
`,Tt=({logo:t,title:s,body:o,setActiveTab:l})=>{const r=Ee(600);return e.jsxs(T,{style:{color:t==="announcement"?"white":"#333"},justifyContent:"stretch",padding:r?"12px":"16px",background:t==="announcement"?"linear-gradient(90deg, #121315 -2.55%, #2A2A39 32.62%, #8E317A 68.34%, #121315 102.97%)":"#FFF7DA",borderRadius:"16px",children:[e.jsx(oe,{width:t==="announcement"?"60px":"32px",height:t==="announcement"?"60px":"32px",src:Ft(`svg/${t}.svg`),alt:"Announcement Logo"}),e.jsxs(y,{margin:t==="announcement"?"0 0 0 16px":"0 0 0 13px",justifyContent:"center",alignItems:"flex-start",gap:t==="announcement"?"4px":"0px",children:[e.jsx(D,{color:"inherit",fontSize:r?"20px":"24px",textAlign:"left",fontWeight:500,children:s}),e.jsxs(D,{color:"inherit",fontSize:r?"12px":"16px",textAlign:"left",fontWeight:500,children:[o," ",s.includes("New V2")&&e.jsxs(e.Fragment,{children:[e.jsx(qt,{onClick:()=>l(1),children:"here"})," to migrate."]})]})]})]})},qt=i(Rt)`
  cursor: pointer;
  color: #fff;
...
`;ge.coreContractChain;const Zt=({setActiveTab:t})=>{const{account:s,provider:o}=ke(),[l,r]=n.useState(null),[a,h]=n.useState(null),[x,d]=n.useState(null),[u,v]=n.useState(null),[E,_]=n.useState(null),[B,N]=n.useState(null),[$,G]=n.useState(null),[O,ee]=n.useState(null),[F,ae]=n.useState(null),[Y,H]=n.useState(null),P=o==null?void 0:o.getSigner(s),V=n.useCallback(async()=>{const U=await be.getInstance().getPoolStats();N({...U})},[l,a,x,u,E]),M=n.useCallback(async()=>{const U=await be.getInstance().getPUSHPoolStats();G({...U})},[l,a,x,u,E]),w=n.useCallback(async U=>{const Q=await be.getInstance().getLPPoolStats(U);ee({...Q})},[l,a,x,u,E]),R=n.useCallback(async()=>{const U=await be.getInstance().getUserData(u);ae({...U})},[u]),J=n.useCallback(async()=>{const U=await be.getInstance().getUserData(x);H({...U})},[x]);n.useEffect(()=>{let U=new C(p.pushToken,k.pushToken,P),Q=new C(p.staking,k.staking,P),Te=new C(p.depYieldFarmPUSH,k.yieldFarming,P),S=new C(p.depYieldFarmLP,k.yieldFarming,P),m=new C(p.uniswapV2Router02,k.uniswapV2Router02,P);if(r(U),h(Q),v(Te),d(S),_(m),P&&s){var g=o.getSigner(s);let b=new C(p.pushToken,k.pushToken,g),j=new C(p.staking,k.staking,g),f=new C(p.depYieldFarmPUSH,k.yieldFarming,g),A=new C(p.depYieldFarmLP,k.yieldFarming,g),z=new C(p.uniswapV2Router02,k.uniswapV2Router02,g);r(b),h(j),v(f),d(A),_(z)}},[s]),n.useEffect(()=>{l!=null&&a!=null&&u!=null&&(be.getInstance().init(s,l,a,u,x,E),V())},[V]),n.useEffect(()=>{B&&we(B)},[B]);const we=async U=>{M(),w(U),R(),J()};return e.jsxs(e.Fragment,{children:[e.jsx(Tt,{logo:"WarningCircle",title:"This reward program (V1) has ended.",body:"To continue earning rewards please migrate to new pools.",setActiveTab:t}),e.jsxs(Xt,{children:[e.jsx(gt,{poolName:"PUSH",userData:F,PoolStats:$,poolAddress:p.depYieldFarmPUSH,getUserData:R,getPoolStats:M,tokenAddress:p.pushToken,setActiveTab:t}),e.jsx(gt,{poolName:"UNI-V2",userData:Y,PoolStats:O,poolAddress:p.depYieldFarmLP,getUserData:J,getPoolStats:w,tokenAddress:p.uniV2LPToken,setActiveTab:t})]})]})},Xt=i(T)`
...
`,Ae=i(Ce)`
  ...
  border-radius: 5px;
  gap: 5px;
`,Fs=({setActiveTab:t})=>{const{provider:s,account:o,chainId:l}=ke(),[r,a]=n.useState(),[h,x]=n.useState(),[d,u]=n.useState(),[v,E]=n.useState(),[_,B]=n.useState(),[N,$]=n.useState(null),[G,O]=n.useState(null),[ee,F]=n.useState(null),[ae,Y]=n.useState(null),[H,P]=n.useState(null),V=s==null?void 0:s.getSigner(o),M=n.useCallback(async()=>{const U=await Re.getInstance().getPoolStats(s);$({...U})},[h,r,v,d,_,s]),w=n.useCallback(async()=>{const U=await Re.getInstance().getPoolStats(s),Q=await Re.getInstance().getLPPoolStats(U);O({...Q})},[h,r,v,d,_,s]),R=n.useCallback(async()=>{},[]),J=n.useCallback(async()=>{const U=await Re.getInstance().getUserDataLP();F({...U})},[h,r,v,d,_]),we=n.useCallback(async()=>{const[U,Q]=await Re.getInstance().getUserDataPUSH(s);P({...U}),Y({...Q})},[h,r,v,d,_,s]);return n.useEffect(()=>{if(l!==ge.coreContractChain&&l!==ge.mainnetCoreContractChain)return;O(null),F(null),P(null),Y(null);let U=new C(p.stakingV2,k.stakingV2,V),Q=new C(p.pushToken,k.pushToken,V),Te=new C(p.pushCoreV2,k.pushCoreV2,V),S=new C(p.yieldFarmLP,k.yieldFarming,V),m=new C(p.uniswapV2Router02,k.uniswapV2Router02,V);if(x(U),a(Q),E(Te),u(S),B(m),V&&o){var g=s==null?void 0:s.getSigner(o);let b=new C(p.stakingV2,k.stakingV2,g),j=new C(p.pushToken,k.pushToken,g),f=new C(p.pushCoreV2,k.pushCoreV2,g),A=new C(p.yieldFarmLP,k.yieldFarming,g),z=new C(p.uniswapV2Router02,k.uniswapV2Router02,g);x(b),a(j),E(f),u(A),B(z)}Re.getInstance().init(o,U,Q,Te,S,m),M(),J(),w(),we()},[o,l]),e.jsxs(e.Fragment,{children:[e.jsx(Tt,{logo:"announcement",title:"New V2 Pools are now Live! Stake or migrate now.",body:"Users who were part of the previous Push staking program, need to migrate to new pools to continue earning rewards. Click",setActiveTab:t}),e.jsx(ss,{getLpPoolStats:w,poolStats:N,setPoolStats:$}),e.jsx(Qt,{poolStats:N}),e.jsxs(Ms,{children:[e.jsx(fs,{userDataPush:ae,getUserDataPush:we,PUSHPoolstats:H,getPUSHPoolStats:R}),e.jsx(ps,{lpPoolStats:G,userDataLP:ee,getLpPoolStats:w,getUserDataLP:J})]})]})},Ms=i(T)`
  @media (max-width: 1300px) {
    flex-direction: column;
  }
...
`,vt=i(me)`
  ...
  height: 17px;
  width: fit-content;
`,It=()=>e.jsx(qs,{children:e.jsx(yt,{})})});export{Xs as __tla,It as default};
