...
`,jn=r.span`
  ${e=>e.hideIt&&je`
      visibility: hidden;
    `};
`,ct=({channelName:e,channelDescription:a,channelLogoSrc:s,height:n})=>t.jsxs(Sn,{style:{borderRadius:n<250?"0.125rem 1rem 1rem 1rem":"1rem 1rem 1rem 0.125rem"},children:[t.jsx(En,{children:"Channel was recently updated"}),t.jsx(Cn,{children:"Previously"}),t.jsxs(kn,{children:[t.jsx(Tn,{children:t.jsx(An,{src:s})}),t.jsxs(Bn,{children:[t.jsx(_n,{children:e}),t.jsx($n,{children:a})]})]})]}),Sn=r(he)`
...
`,$n=r(Ee)`
  ...
  text-align: left;
  margin-top: 3px;
`,dt=({verifierIcon:e,verifierName:a,height:s})=>{const n=(a==null?void 0:a.length)>15?a.substring(0,15)+"...":a;return t.jsxs(Dn,{style:{width:212+(n&&n.length*2)+"px",borderRadius:s<160?"0.125rem 1rem 1rem 1rem":"1rem 1rem 1rem 0.125rem"},children:[t.jsx(pt,{children:"Verified By:"}),t.jsx(Mn,{src:e}),t.jsx(pt,{children:n})]})},Dn=r(he)`
  box-sizing: border-box;
  height: 37px;
  max-height: 37px;
  background: #131313;
...
`,Rt=r.div`
  ...
  overflow: hidden;
`});export{sn as C,rt as S,W,zo as __tla};
