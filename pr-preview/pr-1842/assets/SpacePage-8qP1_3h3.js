...
`,y=r($)`
  ...
  justify-content: center;
  align-items: center;
`,Q=()=>{let{spaceid:t}=Te();return s.jsx(P,{children:s.jsx(R,{spaceid:t})})},P=r(me)`
  flex: 1;
