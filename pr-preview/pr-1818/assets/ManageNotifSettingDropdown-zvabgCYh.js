import{e6 as d,eq as O,fB as re,d_ as f,fC as ae,e1 as t,dY as q,e$ as G,e_ as X,ei as k,fD as ie,fE as Q,e9 as Z,eT as v,fF as le,fG as ce,fH as de,ep as pe,eY as ge,e3 as ee,e4 as te,fI as A,fJ as he,fK as ne,fL as E,f4 as se,fM as ue,fN as xe,fO as fe,__tla as we}from"./index-l_j2la3t.js";import{u as Se,n as me}from"./notifSetting-DrLKauYy.js";let I,oe,je=Promise.all([(()=>{try{return we}catch{}})()]).then(async()=>{let P,_,$,B,W,V,H,F,z,U,N,Y,J,L,K;I=({children:n,renderDropdownContainer:p,showDropdown:a,toggleDropdown:g,closeDropdown:s,containerPadding:u,centerOnMobile:i})=>{const c=f.useRef(null),l=f.useRef(null);return ae(c,l,s),t.jsxs(P,{ref:c,onClick:g,children:[n,a&&t.jsx(_,{containerPadding:u,centerOnMobile:i,children:t.jsx("div",{ref:l,onClick:e=>e.stopPropagation(),children:p})})]})},P=d.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
