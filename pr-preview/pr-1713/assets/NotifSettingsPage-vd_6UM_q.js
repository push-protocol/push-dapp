...
`,te=({checked:t,onChange:h,label:S,description:y})=>e.jsx(C,{margin:"12px 0px 12px 0px",flex:"1",self:"stretch",align:"stretch",children:e.jsxs(C,{direction:"row",align:"center",flex:"1",self:"stretch",justify:"space-between",children:[e.jsxs(C,{flex:"1",self:"stretch",justify:"space-between",align:"flex-start",children:[e.jsx(T,{children:S}),e.jsx(re,{children:y})]}),e.jsx(wt,{checked:t,onChange:h})]})}),we=({onConfirm:t,onClose:h,toastObject:S,InnerComponentProps:y})=>{const i=(y==null?void 0:y.settingToEdit)||void 0,[o,w]=l.useState(!1),[d,a]=l.useState(i?i.description:""),[E,P]=l.useState(i?i.type===1&&i.default||i.type===2&&i.enabled||i.type===3&&i.enabled:!0),[g,k]=l.useState(!!(i&&(i.type===2||i.type===3))),[x,_]=l.useState(i&&(i.type===2||i.type===3)?i.lowerLimit.toString():""),[b,N]=l.useState(i&&(i.type===2||i.type===3)?i.upperLimit.toString():""),[c,$]=l.useState(i&&(i.type===2||i.type===3)&&i.ticker?i.ticker.toString():"1"),[j,F]=l.useState(!!(i&&i.type===3)),[D,B]=l.useState(i&&i.type===2?i.default.toString():""),[W,R]=l.useState(i&&i.type===2?i.default:0),[v,Z]=l.useState(i&&i.type===3?i.default.lower.toString():""),[L,Y]=l.useState(i&&i.type===3?i.default.upper.toString():""),[X,J]=l.useState(i&&i.type===3?i.default.lower:0),[Q,V]=l.useState(i&&i.type===3?i.default.upper:0),[n,p]=l.useState(),r=Je(),A=()=>!o&&h(),oe=l.useRef(null);Ve(oe,()=>A());const Be=s=>{if(s.preventDefault(),w(!0),be({setErrorInfo:p,defaultValue:j?{lower:v,upper:L}:D,settingName:d,lowerLimit:x,type:g?j?3:2:1,upperLimit:b,sliderStep:c})){const m=i?i.index:Math.floor(Math.random()*1e6),Oe=g?j?{type:3,default:{lower:Number(v),upper:Number(L)},enabled:E,description:d,index:m,lowerLimit:Number(x),upperLimit:Number(b),ticker:Number(c)}:{type:2,default:Number(D),enabled:E,description:d,index:m,lowerLimit:Number(x),upperLimit:Number(b),ticker:Number(c)}:{type:1,default:E,description:d,index:m};t(Oe),h()}w(!1)},z=s=>s!==""&&!/^[0-9]+(?:\.[0-9])?$/.test(s),ze=l.useMemo(()=>x!==""&&b!==""&&(j?v!==""&&L!=="":D!=="")&&c!==""&&Number(x)<=Number(b)&&Number(c)>0&&Number(c)<=Number(b)-Number(x)&&(j?Number(v)>=Number(x)&&Number(L)<=Number(b)&&Number(L)>Number(v):Number(D)>=Number(x)&&Number(D)<=Number(b)),[x,b,D,c,v,L,j]);return e.jsx(je,{ref:oe,children:e.jsxs(qe,{onSubmit:Be,children:[e.jsx(Ne,{onClick:A}),e.jsxs(Te,{children:[i?"Edit ":"Add a "," Setting"]}),e.jsxs(C,{margin:"32px 0px 12px 0px",flex:"1",self:"stretch",align:"stretch",children:[e.jsxs(C,{direction:"row",align:"center",flex:"1",self:"stretch",justify:"space-between",children:[e.jsx(T,{children:"Setting Name"}),e.jsx(He,{color:r.editChannelSecondaryText,size:"14px",margin:"0px 8px 0px 0px",weight:"500",children:50-d.length})]}),e.jsx(H,{maxlength:"50",padding:"13px 16px",weight:"400",size:"15px",resize:"none",overflow:"hidden","line-height":"19.5px",margin:"8px 0px 0px 0px",border:r.textAreaBorderColor,focusBorder:r.textAreaFocusBorder,radius:"12px",bg:r.editChannelInputbg,color:r.editChannelPrimaryText,value:d,onChange:s=>{a(s.target.value.slice(0,50)),p(m=>({...m,settingName:void 0}))},autocomplete:"off",hasError:!!(n!=null&&n.settingName)}),e.jsx(U,{children:n==null?void 0:n.settingName})]}),e.jsx(te,{checked:E,onChange:()=>P(s=>!s),label:"Set as default",description:"Setting turned on for users by default"}),e.jsx(te,{checked:g,onChange:()=>k(s=>!s),label:"Range",description:"Set a range for this setting e.g. 1-10"}),g&&e.jsxs(e.Fragment,{children:[e.jsxs(C,{direction:"column",align:"flex-start",flex:"1",self:"stretch",margin:"12px 0px",children:[e.jsx(T,{children:"Range Values"}),e.jsxs(C,{direction:"row",children:[e.jsx(G,{padding:"13px 16px",weight:"400",type:"number",placeholder:"e.g. 0",size:"15px",resize:"none",overflow:"hidden","line-height":"19.5px",margin:"8px 0px 0px 0px",border:r.textAreaBorderColor,focusBorder:r.textAreaFocusBorder,radius:"12px",bg:r.editChannelInputbg,color:r.editChannelPrimaryText,value:x,onChange:s=>{p(m=>({...m,lowerLimit:void 0})),!z(s.target.value)&&_(s.target.value)},autocomplete:"off",hasError:!!(n!=null&&n.lowerLimit)}),e.jsx(T,{padding:"0px 16px",children:"to"}),e.jsx(G,{padding:"13px 16px",weight:"400",type:"number",placeholder:"e.g. 10",size:"15px",resize:"none",overflow:"hidden","line-height":"19.5px",margin:"8px 0px 0px 0px",border:r.textAreaBorderColor,focusBorder:r.textAreaFocusBorder,radius:"12px",bg:r.editChannelInputbg,color:r.editChannelPrimaryText,value:b,onChange:s=>{p(m=>({...m,upperLimit:void 0})),!z(s.target.value)&&N(s.target.value)},autocomplete:"off",hasError:!!(n!=null&&n.upperLimit)})]}),e.jsx(U,{children:n==null?void 0:n.lowerLimit}),e.jsx(U,{children:n==null?void 0:n.upperLimit})]}),e.jsxs(C,{direction:"row",align:"flex-start",flex:"1",self:"stretch",margin:"12px 0px",children:[e.jsx(Se,{checked:j,onChange:()=>F(!j)}),e.jsxs(C,{align:"left",margin:"0px 0px 0px 4px",children:[e.jsx(T,{children:"Enable Multi Range Slider"}),e.jsx(re,{children:"User can select a range of values in the slider"})]})]}),!j&&e.jsxs(C,{direction:"column",align:"stretch",flex:"1",self:"stretch",margin:"12px 0px",children:[e.jsx(T,{children:"Default Value"}),e.jsx(H,{padding:"13px 16px",weight:"400",type:"number",placeholder:"e.g. 5",size:"15px",resize:"none",overflow:"hidden","line-height":"19.5px",margin:"8px 0px 0px 0px",border:r.textAreaBorderColor,focusBorder:r.textAreaFocusBorder,radius:"12px",bg:r.editChannelInputbg,color:r.editChannelPrimaryText,value:D,onChange:s=>{p(m=>({...m,default:void 0})),!z(s.target.value)&&(B(s.target.value),R(Number(s.target.value)))},autocomplete:"off",hasError:!!(n!=null&&n.default)}),e.jsx(U,{children:n==null?void 0:n.default})]}),j&&e.jsxs(C,{direction:"column",align:"flex-start",flex:"1",self:"stretch",margin:"12px 0px",children:[e.jsx(T,{children:"Default Values"}),e.jsxs(C,{direction:"row",children:[e.jsx(G,{padding:"13px 16px",weight:"400",type:"number",placeholder:"e.g. 5",size:"15px",resize:"none",overflow:"hidden","line-height":"19.5px",margin:"8px 0px 0px 0px",border:r.textAreaBorderColor,focusBorder:r.textAreaFocusBorder,radius:"12px",bg:r.editChannelInputbg,color:r.editChannelPrimaryText,value:v,onChange:s=>{p(m=>({...m,defaultStart:void 0})),!z(s.target.value)&&(Z(s.target.value),J(Number(s.target.value)))},autocomplete:"off",hasError:!!(n!=null&&n.defaultStart)}),e.jsx(T,{padding:"0px 16px",children:"to"}),e.jsx(G,{padding:"13px 16px",weight:"400",type:"number",placeholder:"e.g. 8",size:"15px",resize:"none",overflow:"hidden","line-height":"19.5px",margin:"8px 0px 0px 0px",border:r.textAreaBorderColor,focusBorder:r.textAreaFocusBorder,radius:"12px",bg:r.editChannelInputbg,color:r.editChannelPrimaryText,value:L,onChange:s=>{p(m=>({...m,defaultEnd:void 0})),!z(s.target.value)&&(Y(s.target.value),V(Number(s.target.value)))},autocomplete:"off",hasError:!!(n!=null&&n.defaultEnd)})]}),e.jsx(U,{children:(n==null?void 0:n.defaultStart)||(n==null?void 0:n.defaultEnd)})]}),e.jsxs(C,{direction:"column",align:"stretch",flex:"1",self:"stretch",margin:"12px 0px",children:[e.jsx(T,{children:"Slider Step Value"}),e.jsx(H,{padding:"13px 16px",weight:"400",type:"number",placeholder:"e.g. 1",size:"15px",resize:"none",overflow:"hidden","line-height":"19.5px",margin:"8px 0px 0px 0px",border:r.textAreaBorderColor,focusBorder:r.textAreaFocusBorder,radius:"12px",bg:r.editChannelInputbg,color:r.editChannelPrimaryText,value:c,onChange:s=>{p(m=>({...m,sliderStep:void 0})),$(s.target.value),R(x===""?0:Number(x))},autocomplete:"off",hasError:!!(n!=null&&n.sliderStep)}),e.jsx(U,{children:n==null?void 0:n.sliderStep})]}),ze&&e.jsxs(C,{direction:"column",align:"flex-start",flex:"1",self:"stretch",margin:"12px 0px",children:[e.jsx(Ce,{children:"Preview"}),!j&&e.jsxs(ne,{children:[e.jsx(T,{children:x}),e.jsx(Ke,{val:W,min:Number(x),max:Number(b),step:Number(c),defaultVal:Number(D),onChange:({x:s})=>R(s),preview:!0}),e.jsx(T,{children:b})]}),j&&e.jsxs(ne,{children:[e.jsx(T,{children:x}),e.jsx(We,{startVal:X,endVal:Q,min:Number(x),max:Number(b),step:Number(c),defaultStartVal:Number(v),defaultEndVal:Number(L),onChange:({startVal:s,endVal:m})=>{J(s),V(m)},preview:!0}),e.jsx(T,{children:b})]})]})]}),e.jsx(ut,{text:"Save Setting",isLoading:o,topMargin:"20px",padding:"14.5px 26.5px"})]})})},Ne=u(Fe)`
  align-self: flex-end;
...
`,Ee=({title:t,description:h,onCancel:S,disabled:y,onClick:i,feeRequired:o})=>{const{account:w,provider:d}=pe(),[a,E]=l.useState(0),[P,g]=l.useState(!1),[k,x]=l.useState(!1),_=ce();l.useEffect(()=>{!w||!d||async function(){const N=await xt({address:w,provider:d,contractAddress:ue.epnscore});E(parseInt(N));const c=parseInt(N);c>=o&&c!=0?g(!0):g(!1)}()},[w,d]);const b=async()=>{if(x(!0),!d)return;const N=d.getSigner(w);_.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{const c=await ft({signer:N,contractAddress:ue.epnscore,amount:o-a});console.debug("response",c),c&&(x(!1),E(o),g(!0),_.showMessageToast({toastTitle:"Success",toastMessage:"Successfully approved Push!",toastType:"SUCCESS",getToastIcon:$=>e.jsx(xe,{size:$,color:"green"})}))}catch(c){console.error(c),c.code=="ACTION_REJECTED"?_.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:$=>e.jsx(q,{size:$,color:"red"})}):(_.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in approving PUSH Token",toastType:"ERROR",getToastIcon:$=>e.jsx(q,{size:$,color:"red"})}),console.error("Error --> %o",c),console.error({err:c}))}x(!1)};return e.jsxs(e.Fragment,{children:[e.jsxs(Ae,{children:[e.jsxs("div",{children:[e.jsx(Me,{children:t}),e.jsx(De,{children:h})]}),e.jsxs(de,{flex:"0",children:[P?e.jsx(ve,{src:ht}):null,e.jsxs(Le,{children:[o," PUSH"]})]})]}),e.jsx(gt,{noOfPushTokensToCheck:o,containerProps:{width:"100%"},onMintPushToken:async N=>{await mt({noOfTokens:N,provider:d,account:w})}}),k?e.jsx(e.Fragment,{children:e.jsxs(Ie,{children:[e.jsx(Ye,{size:42,color:f.COLORS.PRIMARY_PINK,type:Xe.PROCESSING}),e.jsx(_e,{children:"Verifying Transaction"})]})}):e.jsx(e.Fragment,{children:e.jsxs($e,{children:[e.jsx(ke,{onClick:S,disabled:!1,children:"Cancel"}),a>=o?e.jsx(K,{disabled:y,onClick:i,children:"Save Changes"}):e.jsx(K,{disabled:y,onClick:b,children:"Approve PUSH"})]})})]})},ve=u.img``,Ae=u(le)`
...
`,me=()=>e.jsx(ae,{children:e.jsx(Pe,{})}),ae=u(st)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
  justify-content: flex-start;
