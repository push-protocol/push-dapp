...
`;X.coreContractChain;const gn=({setActiveTab:n})=>{const{account:t,provider:a}=Pe(),[o,s]=u.useState(null),[i,r]=u.useState(null),[l,d]=u.useState(null),[h,y]=u.useState(null),[x,U]=u.useState(null),[I,L]=u.useState(null),[C,$]=u.useState(null),[z,ae]=u.useState(null),[G,ie]=u.useState(null),[Y,D]=u.useState(null),T=a==null?void 0:a.getSigner(t),V=u.useCallback(async()=>{const B=await Ee.getInstance().getPoolStats();L({...B})},[o,i,l,h,x]),M=u.useCallback(async()=>{const B=await Ee.getInstance().getPUSHPoolStats();$({...B})},[o,i,l,h,x]),S=u.useCallback(async B=>{const te=await Ee.getInstance().getLPPoolStats(B);ae({...te})},[o,i,l,h,x]),F=u.useCallback(async()=>{const B=await Ee.getInstance().getUserData(h);ie({...B})},[h]),q=u.useCallback(async()=>{const B=await Ee.getInstance().getUserData(l);D({...B})},[l]);u.useEffect(()=>{let B=new k(c.pushToken,v.pushToken,T),te=new k(c.staking,v.staking,T),we=new k(c.depYieldFarmPUSH,v.yieldFarming,T),j=new k(c.depYieldFarmLP,v.yieldFarming,T),f=new k(c.uniswapV2Router02,v.uniswapV2Router02,T);if(s(B),r(te),y(we),d(j),U(f),T&&t){var w=a.getSigner(t);let P=new k(c.pushToken,v.pushToken,w),A=new k(c.staking,v.staking,w),E=new k(c.depYieldFarmPUSH,v.yieldFarming,w),O=new k(c.depYieldFarmLP,v.yieldFarming,w),_=new k(c.uniswapV2Router02,v.uniswapV2Router02,w);s(P),r(A),y(E),d(O),U(_)}},[t]),u.useEffect(()=>{o!=null&&i!=null&&h!=null&&(Ee.getInstance().init(t,o,i,h,l,x),V())},[V]),u.useEffect(()=>{I&&Te(I)},[I]);const Te=async B=>{M(),S(B),F(),q()};return e.jsxs(e.Fragment,{children:[e.jsx(Et,{logo:"WarningCircle",title:"This reward program (V1) has ended.",body:"To continue earning rewards please migrate to new pools.",setActiveTab:n}),e.jsxs(mn,{children:[e.jsx(ft,{poolName:"PUSH",userData:G,PoolStats:C,poolAddress:c.depYieldFarmPUSH,getUserData:F,getPoolStats:M,tokenAddress:c.pushToken,setActiveTab:n}),e.jsx(ft,{poolName:"UNI-V2",userData:Y,PoolStats:z,poolAddress:c.depYieldFarmLP,getUserData:q,getPoolStats:S,tokenAddress:c.uniV2LPToken,setActiveTab:n})]})]})},mn=p(b)`
...
`,Wn=({userDataPush:n,getUserDataPush:t,PUSHPoolstats:a,getPUSHPoolStats:o})=>{const{account:s,provider:i}=Pe(),[r,l]=u.useState(!1),[d,h]=u.useState(!1),[y,x]=u.useState(null),[U,I]=u.useState(null),[L,C]=u.useState(0),[$,z]=u.useState(0),[ae,G]=u.useState(0),[ie,Y]=u.useState(""),D=Be(),T=Ve(),V=async A=>{var E=i.getSigner(s);let O=new k(c.pushToken,v.pushToken,E);if(await O.holderDelegation(s,A.address))return!0;try{D.showLoaderToast({loaderMessage:"Delegating! Please wait.."});const _=await O.setHolderDelegation(A.address,"true");return await i.waitForTransaction(_.hash),D.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed! Address Delegated",toastType:"SUCCESS",getToastIcon:se=>e.jsx(ue,{size:se,color:"green"})}),!0}catch(_){return console.error("Error in delegating",_),D.showMessageToast({toastTitle:"Error",toastMessage:`Transaction failed! ${_.reason}`,toastType:"ERROR",getToastIcon:se=>e.jsx(H,{size:se,color:"red"})}),l(!1),!1}},M=async A=>{const E=(await A.userFeesInfo(s)).lastClaimedBlock;if(E.toNumber()!==0){const O=await A.genesisEpoch(),_=await A.epochDuration();return(E-O)/_}},S=async()=>{if(d)return;if(h(!0),(n==null?void 0:n.availableRewards)==0){I("No Rewards to Claim"),h(!1);return}var A=i.getSigner(s);let E=new k(c.pushCoreV2,v.pushCoreV2,A);const O=a==null?void 0:a.currentEpochNumber,_=14;if(!await V(E))return;let se=1;se=await M(E),w(),h(!1);let oe=0;O-se<_,oe=Math.ceil((O-se)/_),z(oe),oe!=0&&(await F(oe,se,E,_),t(),G(2),C(0))},F=async(A,E,O,_)=>{const se=a==null?void 0:a.currentEpochNumber;let oe=0;for(let ee=0;ee<A;ee++){let Z=E;E+=_;let me=Math.min(E,se-1);Y(`Claiming the rewards from Epoch ${Z} to ${me} `),await O.harvestPaginated(me,{gasLimit:91e4}).then(async pe=>{try{D.showLoaderToast({loaderMessage:"Waiting for confirmation"}),await i.waitForTransaction(pe.hash),D.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:le=>e.jsx(ue,{size:le,color:"green"})}),oe++,C(oe)}catch{console.error("Error in the transaction",pe);return}}).catch(pe=>{throw console.error("Error in claiming the reward",pe),D.showMessageToast({toastTitle:"Error",toastMessage:`Transaction failed! ${pe.reason}`,toastType:"ERROR",getToastIcon:le=>e.jsx(H,{size:le,color:"red"})}),Y(""),l(!1),t(),G(1),C(0),pe})}},q=async()=>{if(r)return;if(l(!0),J(n==null?void 0:n.userStaked)==0){x("Nothing to unstake, You need to stake first"),l(!1);return}var A=i.getSigner(s);let E=new k(c.pushCoreV2,v.pushCoreV2,A);const O=await V(E);if(h(!1),!O)return;const _=a==null?void 0:a.currentEpochNumber,se=14;let oe=0;if(oe=await M(E),oe>=_-1){l(!1),x("PUSH cannot be unstaked until current epoch is over."),D.showMessageToast({toastTitle:"Unstaking Error",toastMessage:"You cannot unstake until Current Epoch gets over.",toastType:"ERROR",getToastIcon:Z=>e.jsx(H,{size:Z,color:"red"})});return}w();const ee=Math.ceil((_-oe)/se);z(ee),ee>1&&await F(ee-1,oe,E,se),Y("Unstaking Your Push Tokens. Please wait..."),E.unstake().then(async Z=>{D.showLoaderToast({loaderMessage:"Unstaking! Waiting for Confirmation..."});try{await i.waitForTransaction(Z.hash),D.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:me=>e.jsx(ue,{size:me,color:"green"})}),o(),t(),l(!1),G(2),C(0)}catch(me){console.error("Error",me),D.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${me.name}+ ")`,toastType:"ERROR",getToastIcon:pe=>e.jsx(H,{size:pe,color:"red"})}),Y(""),l(!1)}}).catch(Z=>{console.error("Error: ",Z);const me=Z.reason.includes("PushCoreV2::unstake:"),pe=Z.reason.includes("PushCoreV2::harvestPaginated:");if(me||pe)x("PUSH cannot be unstaked until current epoch is over.");else{let le=Z.reason.slice(Z.reason.indexOf("::")+1);le=le.replace("unstake:",""),D.showMessageToast({toastTitle:"Error",toastMessage:`${le}`,toastType:"ERROR",getToastIcon:Se=>e.jsx(H,{size:Se,color:"red"})})}l(!1),t(),G(1),C(0)})};u.useEffect(()=>{I(null),x(null)},[s]);const{isModalOpen:Te,showModal:B,ModalComponent:te}=tt(),we=Be(),j=Re(600),{isModalOpen:f,showModal:w,ModalComponent:P}=tt();return e.jsxs(Jn,{children:[e.jsx(te,{InnerComponent:Mt,InnerComponentProps:{title:"PUSH",getUserData:t,getPoolStats:o,setUnstakeErrorMessage:x,setWithdrawErrorMessage:I},toastObject:we,modalPosition:nt.ON_PARENT}),e.jsx(P,{InnerComponent:_n,InnerComponentProps:{currentTransactionNo:L,totalTransactionNo:$,transactionSteps:ae,transactionText:ie,setCurrentTransactionNo:C,setTotalTransactionNo:z,setTransactionSteps:G,claimRewards:S,unstakeTokensPaginated:q},onConfirm:()=>{},modalPadding:"0px",modalPosition:nt.ON_ROOT}),e.jsx(R,{margin:"0px 0px 20px 0px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(qn,{children:"PUSH Fee Staking Pool"}),e.jsxs(Kn,{children:["Current APR",e.jsxs(ye,{color:"#D53A94",fontWeight:"600",margin:"0 5px 0 5px",children:[">",Q(a==null?void 0:a.stakingAPR),"% + Fee"]}),e.jsx(Hn,{})]})]}):e.jsxs(De,{padding:"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:"234px",margin:"0 0 10px 0"}),e.jsx(g,{height:"12px",width:"112px"})]})}),e.jsxs(R,{flex:"5",children:[e.jsxs(Qn,{border:`1px solid ${T.stakingBorder}`,borderRadius:"16px",children:[e.jsx(R,{margin:j?"0px 6px 0 0 ":"0px 18px 0px 0px",padding:j?" 7px":"10px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(Nt,{children:"Current Reward"}),e.jsxs(W,{fontSize:j?"18px":"24px",fontWeight:"600",color:"#D53A94",letterSpacing:"normal",children:[Q(J(a==null?void 0:a.currentReward))," PUSH"]})]}):e.jsxs(De,{padding:j?"0px":"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:j?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(g,{height:"12px",width:j?"65px":"100px}"})]})}),e.jsx(Zn,{width:"10px",height:"100%"}),e.jsx(R,{margin:j?"0 0 0 6px":"0 0 0 18px",padding:j?" 7px":"10px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(Nt,{children:"Total Staked"}),e.jsxs(Xn,{fontSize:j?"18px":"24px",fontWeight:"600",letterSpacing:"normal",children:[Q(J(a==null?void 0:a.totalStakedAmount))," PUSH"]})]}):e.jsxs(De,{padding:j?"0px":"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:j?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(g,{height:"12px",width:j?"65px":"100px}"})]})})]}),e.jsx(b,{alignSelf:"end",margin:"12px 13px 24px 0px",color:"#575D73",letterSpacing:"normal",children:a?e.jsxs(e.Fragment,{children:[e.jsx(Lt,{children:"Current Epoch"}),e.jsx(Lt,{children:a==null?void 0:a.currentEpochNumber})]}):e.jsx(De,{padding:"5px 0px 0 15px",children:e.jsx(g,{height:"12px",width:"124px"})})}),n?e.jsxs(R,{children:[e.jsxs(b,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ke,{children:["User Deposit",e.jsx(Qe,{children:e.jsx(K,{ToolTipTitle:"User Deposited",ToolTipBody:"Amount of PUSH Token User Staked",children:e.jsx(re,{src:xe,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Ze,{children:[" ",Q(J(n==null?void 0:n.userStaked))," PUSH"]})]}),e.jsxs(b,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ke,{children:["Rewards Claimed",e.jsx(Qe,{children:e.jsx(K,{ToolTipTitle:"Rewards Claimed",ToolTipBody:"Amount of Push Claimed by User",children:e.jsx(re,{src:xe,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Ze,{children:[" ",Q((n==null?void 0:n.claimedReward).toFixed(2))," PUSH"]})]}),e.jsxs(b,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ke,{children:["Current Epoch Reward",e.jsx(Qe,{children:e.jsx(K,{ToolTipTitle:"Current Epoch Reward",ToolTipBody:"Displays the approximate latest reward amount for current epoch",children:e.jsx(re,{src:xe,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Ze,{children:[" ",Q((n==null?void 0:n.potentialReward).toFixed(2))," PUSH"]})]}),e.jsxs(b,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ke,{children:["Available for Claiming",e.jsx(Qe,{children:e.jsx(K,{ToolTipTitle:"Available for Claiming",ToolTipBody:"Amount of Push Token Available to claim",children:e.jsx(re,{src:xe,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Ze,{children:[" ",Q((n==null?void 0:n.availableRewards).toFixed(2))," PUSH"]})]})]}):e.jsxs(Ce,{padding:"0 15px 15px 15px",width:"100%",maxWidth:" -webkit-fill-available",borderRadius:"5px",children:[e.jsxs(b,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(b,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(b,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(b,{justifyContent:"space-between",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]})]})]}),e.jsx(R,{padding:j?"0px ":"0px 14px",margin:"24px 0px 24px 0px",children:n?e.jsxs(e.Fragment,{children:[e.jsx(b,{children:e.jsx(ta,{onClick:B,children:" Stake $PUSH"})}),e.jsxs(ea,{children:[(a==null?void 0:a.currentEpochNumber)<=2?e.jsx(It,{ToolTipTitle:"You can unstake once epoch 2 ends.",ButtonTitle:"Unstake PUSH"}):J(n==null?void 0:n.userStaked)==0||y!==null?e.jsx(It,{ToolTipTitle:y||"Nothing to unstake, Stake First",ButtonTitle:"Unstake PUSH"}):e.jsx(Xe,{border:`1px solid ${T.activeButtonText}`,background:"transparent",color:T.activeButtonText,cursor:"pointer",onClick:q,style:{margin:"0px 10px 0px 0px"},children:r?e.jsx(de,{type:ce.SEAMLESS,spinnerSize:26,spinnerColor:T.activeButtonText,title:"Unstaking",titleColor:T.activeButtonText}):"Unstake $PUSH"}),(n==null?void 0:n.availableRewards)===0?e.jsx(K,{bottom:"-30px",ToolTipTitle:"No Rewards to Claim",error:!0,left:"40px",ToolTipWidth:"10rem",children:e.jsx(Xe,{border:"none",background:T.disableButtonBg,cursor:"default",color:T.disabledButtonText,children:d?e.jsx(de,{type:ce.SEAMLESS,spinnerSize:26,spinnerColor:"#D53A94"}):"Claim Rewards"})}):e.jsx(Xe,{border:`1px solid ${T.activeButtonText}`,background:"transparent",color:T.activeButtonText,cursor:"pointer",onClick:S,children:d?e.jsx(de,{type:ce.SEAMLESS,spinnerSize:26,spinnerColor:T.activeButtonText,title:"Claiming",titleColor:T.activeButtonText}):"Claim Rewards"})]})]}):e.jsxs(De,{width:"100%",children:[e.jsx(g,{height:"49px",width:"100%",margin:"0 0 8px 0"}),e.jsx(g,{height:"49px",width:"100%"})]})})]})},It=n=>{const t=Ve();return e.jsx(K,{error:!0,ToolTipTitle:n.ToolTipTitle,ToolTipWidth:"16rem",margin:"0 10px 0 0",bottom:"-30px",children:e.jsx(Xe,{border:"none",background:t.disableButtonBg,cursor:"default",color:t.disabledButtonText,children:n.ButtonTitle})})},Hn=()=>{const[n,t]=u.useState(!1),a=()=>t(!1),o=u.useRef(null);return Gt(o,()=>a()),e.jsxs(Gn,{ref:o,children:[e.jsx(re,{onClick:()=>t(!n),src:xe,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}}),n&&e.jsx(Yn,{id:"channel",children:e.jsx(wt,{title:"",body:"Push Fee Pool APR distributes yield farming rewards + fee earned by protocol. More Info "})})]})},Gn=p.div`
  width: 34%;
  width: 100%;
  min-width: none;
  max-width: none;
...
`,Vt=p(ye)`
  ...
  height: 17px;
  width: fit-content;
`,Kt=()=>e.jsx(Ot,{children:e.jsx(Dt,{})}),Ot=p(ze)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
`});export{ja as __tla,Kt as default};
