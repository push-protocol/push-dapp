...
`,ze=c(ke)`
  ...
  border-radius: 5px;
  gap: 5px;
`,Kn=({setActiveTab:n})=>{const{provider:t,account:a,chainId:o}=Pe(),[s,i]=u.useState(),[r,l]=u.useState(),[p,h]=u.useState(),[g,x]=u.useState(),[M,F]=u.useState(),[L,O]=u.useState(null),[Y,W]=u.useState(null),[ee,U]=u.useState(null),[ie,G]=u.useState(null),[_,b]=u.useState(null),D=t==null?void 0:t.getSigner(a),I=u.useCallback(async()=>{const z=await Ce.getInstance().getPoolStats(t);O({...z})},[r,s,g,p,M,t]),w=u.useCallback(async()=>{const z=await Ce.getInstance().getPoolStats(t),ne=await Ce.getInstance().getLPPoolStats(z);W({...ne})},[r,s,g,p,M,t]),R=u.useCallback(async()=>{},[]),K=u.useCallback(async()=>{const z=await Ce.getInstance().getUserDataLP();U({...z})},[r,s,g,p,M]),we=u.useCallback(async()=>{const[z,ne]=await Ce.getInstance().getUserDataPUSH(t);b({...z}),G({...ne})},[r,s,g,p,M,t]);return u.useEffect(()=>{if(o!==Q.coreContractChain&&o!==Q.mainnetCoreContractChain)return;W(null),U(null),b(null),G(null);let z=new k(d.stakingV2,A.stakingV2,D),ne=new k(d.pushToken,A.pushToken,D),fe=new k(d.pushCoreV2,A.pushCoreV2,D),j=new k(d.yieldFarmLP,A.yieldFarming,D),f=new k(d.uniswapV2Router02,A.uniswapV2Router02,D);if(l(z),i(ne),x(fe),h(j),F(f),D&&a){var T=t==null?void 0:t.getSigner(a);let P=new k(d.stakingV2,A.stakingV2,T),C=new k(d.pushToken,A.pushToken,T),E=new k(d.pushCoreV2,A.pushCoreV2,T),V=new k(d.yieldFarmLP,A.yieldFarming,T),B=new k(d.uniswapV2Router02,A.uniswapV2Router02,T);l(P),i(C),x(E),h(V),F(B)}Ce.getInstance().init(a,z,ne,fe,j,f),I(),K(),w(),we()},[a,o]),e.jsxs(e.Fragment,{children:[e.jsx(jt,{logo:"announcement",title:"New V2 Pools are now Live! Stake or migrate now.",body:"Users who were part of the previous Push staking program, need to migrate to new pools to continue earning rewards. Click",setActiveTab:n}),e.jsx(yn,{getLpPoolStats:w,poolStats:L,setPoolStats:O}),e.jsx(xn,{poolStats:L}),e.jsxs(qn,{children:[e.jsx(Dn,{userDataPush:ie,getUserDataPush:we,PUSHPoolstats:_,getPUSHPoolStats:R}),e.jsx(An,{lpPoolStats:Y,userDataLP:ee,getLpPoolStats:w,getUserDataLP:K})]})]})},qn=c(S)`
  @media (max-width: 1300px) {
    flex-direction: column;
  }
