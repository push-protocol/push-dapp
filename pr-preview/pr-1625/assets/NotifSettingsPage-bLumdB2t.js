import{e4 as Ge,aV as g,b4 as e,aY as M,c2 as Fe,bS as se,b0 as d,a_ as Je,bT as Ve,cv as He,cb as E,aZ as qe,b5 as le,bE as de,b_ as Ke,a$ as ce,bJ as pe,b3 as ue,bW as We,aW as S,bX as Xe,bU as xe,bV as H,bg as he,bF as Q,bK as Ze,c4 as Ye,c5 as Qe,cc as et,c7 as tt,eg as rt,aX as z,bi as it,bR as ge,bd as at,bj as nt,__tla as ot}from"./index-CUGv7H9a.js";import{__tla as st}from"./Tag-UKZE_S-e.js";import{b as lt,__tla as dt}from"./index.esm-DrT9npMF.js";import{M as ct,g as pt,S as ut,F as xt,m as ht,a as gt,C as mt,b as ft,__tla as bt}from"./ChannelInfoList-BCol2FKm.js";import{I as St,R as yt,__tla as wt}from"./RangeSlider-C8hEMSdN.js";import{I as Nt,__tla as jt}from"./SendNotifications-CLyduSn1.js";import{a as Tt,__tla as Et}from"./EmptyNotificationSettings-DVioUPPq.js";import{__tla as Ct}from"./TransitionGroupContext-BzBAPkXZ.js";import{__tla as vt}from"./index.es-DcyrdZOY.js";import"./browser-CeceZ__e.js";import{__tla as At}from"./index-CiZJ4Omu.js";import{__tla as Mt}from"./index.esm-B-NmPsDn.js";let me,_t=Promise.all([(()=>{try{return ot}catch{}})(),(()=>{try{return st}catch{}})(),(()=>{try{return dt}catch{}})(),(()=>{try{return bt}catch{}})(),(()=>{try{return wt}catch{}})(),(()=>{try{return jt}catch{}})(),(()=>{try{return Et}catch{}})(),(()=>{try{return Ct}catch{}})(),(()=>{try{return vt}catch{}})(),(()=>{try{return At}catch{}})(),(()=>{try{return Mt}catch{}})()]).then(async()=>{function fe(t){return Ge({tag:"svg",attr:{viewBox:"0 0 256 256",fill:"currentColor"},child:[{tag:"path",attr:{d:"M230.14,70.54,185.46,25.85a20,20,0,0,0-28.29,0L33.86,149.17A19.85,19.85,0,0,0,28,163.31V208a20,20,0,0,0,20,20H92.69a19.86,19.86,0,0,0,14.14-5.86L230.14,98.82a20,20,0,0,0,0-28.28ZM91,204H52V165l84-84,39,39ZM192,103,153,64l18.34-18.34,39,39Z"}}]})(t)}const v=t=>t.trim().length==0,be=({setErrorInfo:t,lowerLimit:m,upperLimit:f,type:y,settingName:i,defaultValue:p,sliderStep:w})=>{t(void 0);let c=!1;return v(i)&&(t(n=>({...n,settingName:"Setting Name is required"})),c=!0),(y===2||y===3)&&(v(m)&&(t(n=>({...n,lowerLimit:"Minimum range is required"})),c=!0),v(f)&&(t(n=>({...n,upperLimit:"Maximum range is required"})),c=!0),(typeof p=="string"?v(p):v(p.lower)||v(p.upper))&&(typeof p=="string"?t(n=>({...n,default:"Default value is required"})):(v(p.lower)&&t(n=>({...n,defaultStart:"Default start value is required"})),v(p.upper)&&t(n=>({...n,defaultEnd:"Default end value is required"}))),c=!0),v(w)&&(t(n=>({...n,sliderStep:"Slider step is required"})),c=!0),!v(m)&&!v(f)&&!v(w)&&(Number(m)<0&&(t(n=>({...n,lowerLimit:"Minimum range should be greater than 0"})),c=!0),Number(f)<0&&(t(n=>({...n,upperLimit:"Maximum range should be greater than 0"})),c=!0),Number(m)>Number(f)&&(t(n=>({...n,lowerLimit:"Minimum range should be less than maximum range"})),c=!0),typeof p=="string"?(Number(p)<Number(m)||Number(p)>Number(f))&&(t(n=>({...n,default:"Default value not in range"})),c=!0):((Number(p.lower)<Number(m)||Number(p.lower)>Number(f))&&(t(n=>({...n,defaultStart:"Default value not in range"})),c=!0),(Number(p.upper)<Number(m)||Number(p.upper)>Number(f)||Number(p.lower)>Number(p.upper))&&(t(n=>({...n,defaultEnd:"Default value not in range"})),c=!0)),Number(w)<=0&&(t(n=>({...n,sliderStep:"Slider step should be greater than 0"})),c=!0),Number(w)>Number(f)-Number(m)&&(t(n=>({...n,sliderStep:"Slider step should be less than range"})),c=!0))),!c},Se=({checked:t,onChange:m})=>e.jsx(ye,{id:"Checkbox-switch",type:"checkbox",checked:t,onChange:m}),ye=g.input`
  cursor: pointer;
  z-index: 1;
  border-radius: 15px;
  width: 16px;
...
`,me=()=>e.jsx(ae,{children:e.jsx(Be,{})}),ae=g(nt)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
  justify-content: flex-start;
`});export{_t as __tla,me as default};
