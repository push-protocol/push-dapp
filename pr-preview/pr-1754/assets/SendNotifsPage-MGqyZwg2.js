import{a_ as s,bz as t,bA as l,bB as D,bD as u,bO as m,b9 as N,bP as T,ba as a,aZ as e,bQ as h,b3 as L,bd as A,a$ as f,__tla as $}from"./index-c_sigsiS.js";import{S as x,__tla as O}from"./SendNotifications-DLLqdxjx.js";import{__tla as b}from"./index-CL-E0ZRU.js";import{__tla as p}from"./Tag-D-ok8ol0.js";import{__tla as R}from"./TransitionGroupContext-fMbhUbLx.js";let _,g=Promise.all([(()=>{try{return $}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return b}catch{}})(),(()=>{try{return p}catch{}})(),(()=>{try{return R}catch{}})()]).then(async()=>{A.coreContractChain;function M(){u.pageview("/send_notificaiton"),m(),N(),T(n=>n.contracts),T(n=>n.admin),A.coreContractChain;const[r,G]=a.useState(2),[d,J]=a.useState(!0);a.useState(null),a.useState(null);const[c,y]=a.useState(!0);a.useState([]);const[E,I]=a.useState(null),U=()=>I(null);return a.useEffect(()=>{E&&U()},[E]),e.jsx(i,{children:r===2&&d?e.jsxs(e.Fragment,{children:[!c&&e.jsx(h,{replace:!0,to:"/dashboard"}),c&&e.jsx(x,{})]}):e.jsx(S,{children:"Channel details are being loaded, please wait\u2026"})})}let i,S,o;i=s(L)`
  align-items: center;
  align-self: center;
