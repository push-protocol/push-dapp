...
`,A=c(Z)`
  ...
  box-sizing: border-box;
  border-radius: 4px;
`,$=()=>e.jsx(I,{children:e.jsx(j,{})}),I=c(V)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
