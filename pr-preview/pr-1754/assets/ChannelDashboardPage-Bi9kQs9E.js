import{fx as Pt,fy as Ya,a_ as l,fz as ie,b1 as e,fA as Oe,fB as Se,fC as Me,fD as Ue,d3 as Fe,fE as Ja,d2 as Q,fF as it,fG as Ot,fH as Xa,fI as _e,fJ as at,fK as je,fL as Ut,fM as Ft,b6 as o,b9 as Z,cz as G,b3 as qa,b4 as Qa,b$ as O,bd as ee,bP as ce,dc as ot,bs as _t,eZ as Za,cC as de,aY as me,b2 as eo,bY as ae,bp as to,b_ as Ee,bj as no,bl as io,bT as ve,bi as se,bM as U,bW as ao,fN as oo,fO as ke,fP as ro,bq as Ge,bb as Ve,ba as He,bg as V,ch as rt,bO as I,cl as ue,cI as fe,cJ as Y,bR as J,cr as Gt,cs as st,fQ as lt,dH as so,fR as lo,dz as Re,db as Vt,fS as Ht,bk as We,du as co,bn as Wt,cn as Ie,eM as po,co as De,fT as Kt,fU as ho,dv as Yt,cB as Jt,aZ as xo,fV as go,fW as mo,fX as uo,fY as ct,ep as Xt,cG as dt,c2 as pt,fZ as fo,b0 as bo,ce as Co,ci as wo,f_ as yo,f$ as jo,cY as vo,g0 as To,g1 as Ao,bN as be,g2 as So,g3 as Mo,g4 as Eo,g5 as ko,g6 as ht,bQ as Ro,b7 as Io,__tla as Do}from"./index-BDlt8b4E.js";import{S as No,N as Lo,__tla as zo}from"./RedCircle-gWPNKLxa.js";import{M as qt,S as $o,F as Qt,C as Zt,a as en,__tla as Bo}from"./ChannelInfoList-DLOEr-N8.js";import{a as Po,__tla as Oo}from"./Tag-BdNw74Ml.js";import{g as tn,m as nn,a as an,__tla as Uo}from"./PushTokenContractHelper-AE3yIMFl.js";import{M as Fo,a as _o,__tla as Go}from"./EmptyNotificationSettings-xatmQUgR.js";import{a as on,b as rn,__tla as Vo}from"./ValidationHelper-BVDKlBLk.js";import{I as Ho,__tla as Wo}from"./ImportPushTokenMessage-Ci23uvrZ.js";import{v as Ko,C as Yo,__tla as Jo}from"./CreateChannel-C83pb8QF.js";import{__tla as Xo}from"./TransitionGroupContext-CajkqC3V.js";import{__tla as qo}from"./index.esm-DUwQjSAA.js";import{__tla as Qo}from"./useMutation-bFGPGY7K.js";import{__tla as Zo}from"./Stepper-CxfLb7CS.js";import{__tla as er}from"./index.esm-BWfXNkSA.js";import"./Common.form-LPxQflxb.js";let sn,tr=Promise.all([(()=>{try{return Do}catch{}})(),(()=>{try{return zo}catch{}})(),(()=>{try{return Bo}catch{}})(),(()=>{try{return Oo}catch{}})(),(()=>{try{return Uo}catch{}})(),(()=>{try{return Go}catch{}})(),(()=>{try{return Vo}catch{}})(),(()=>{try{return Wo}catch{}})(),(()=>{try{return Jo}catch{}})(),(()=>{try{return Xo}catch{}})(),(()=>{try{return qo}catch{}})(),(()=>{try{return Qo}catch{}})(),(()=>{try{return Zo}catch{}})(),(()=>{try{return er}catch{}})()]).then(async()=>{function ln(t,a=0,n=1){return Ya(t,a,n)}function cn(t){t=t.slice(1);const a=new RegExp(`.{1,${t.length>=6?2:1}}`,"g");let n=t.match(a);return n&&n[0].length===1&&(n=n.map(i=>i+i)),n?`rgb${n.length===4?"a":""}(${n.map((i,s)=>s<3?parseInt(i,16):Math.round(parseInt(i,16)/255*1e3)/1e3).join(", ")})`:""}function xt(t){if(t.type)return t;if(t.charAt(0)==="#")return xt(cn(t));const a=t.indexOf("("),n=t.substring(0,a);if(["rgb","rgba","hsl","hsla","color"].indexOf(n)===-1)throw new Error(Pt(9,t));let i=t.substring(a+1,t.length-1),s;if(n==="color"){if(i=i.split(" "),s=i.shift(),i.length===4&&i[3].charAt(0)==="/"&&(i[3]=i[3].slice(1)),["srgb","display-p3","a98-rgb","prophoto-rgb","rec-2020"].indexOf(s)===-1)throw new Error(Pt(10,s))}else i=i.split(",");return i=i.map(r=>parseFloat(r)),{type:n,values:i,colorSpace:s}}function dn(t){const{type:a,colorSpace:n}=t;let{values:i}=t;return a.indexOf("rgb")!==-1?i=i.map((s,r)=>r<3?parseInt(s,10):s):a.indexOf("hsl")!==-1&&(i[1]=`${i[1]}%`,i[2]=`${i[2]}%`),a.indexOf("color")!==-1?i=`${n} ${i.join(" ")}`:i=`${i.join(", ")}`,`${a}(${i})`}function pn(t,a){return t=xt(t),a=ln(a),(t.type==="rgb"||t.type==="hsl")&&(t.type+="a"),t.type==="color"?t.values[3]=`/${a}`:t.values[3]=a,dn(t)}function hn(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function xn(t){return parseFloat(t)}function gn(t){const{className:a,classes:n,pulsate:i=!1,rippleX:s,rippleY:r,rippleSize:f,in:h,onExited:c,timeout:d}=t,[m,u]=l.useState(!1),x=ie(a,n.ripple,n.rippleVisible,i&&n.ripplePulsate),g={width:f,height:f,top:-(f/2)+r,left:-(f/2)+s},p=ie(n.child,m&&n.childLeaving,i&&n.childPulsate);return!h&&!m&&u(!0),l.useEffect(()=>{if(!h&&c!=null){const E=setTimeout(c,d);return()=>{clearTimeout(E)}}},[c,h,d]),e.jsx("span",{className:x,style:g,children:e.jsx("span",{className:p})})}const ne=Oe("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),mn=["center","classes","className"];let Ne=t=>t,gt,mt,ut,ft;const Ke=550,un=80,fn=Se(gt||(gt=Ne`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`)),wn=Me("span",{name:"MuiTouchRipple",slot:"Root"})({overflow:"hidden",pointerEvents:"none",position:"absolute",zIndex:0,top:0,right:0,bottom:0,left:0,borderRadius:"inherit"}),yn=Me(gn,{name:"MuiTouchRipple",slot:"Ripple"})(ft||(ft=Ne`
  opacity: 0;
  position: absolute;
...
`),ne.rippleVisible,fn,Ke,({theme:t})=>t.transitions.easing.easeInOut,ne.ripplePulsate,({theme:t})=>t.transitions.duration.shorter,ne.child,ne.childLeaving,bn,Ke,({theme:t})=>t.transitions.easing.easeInOut,ne.childPulsate,Cn,({theme:t})=>t.transitions.easing.easeInOut),jn=l.forwardRef(function(t,a){const n=Ue({props:t,name:"MuiTouchRipple"}),{center:i=!1,classes:s={},className:r}=n,f=Fe(n,mn),[h,c]=l.useState([]),d=l.useRef(0),m=l.useRef(null);l.useEffect(()=>{m.current&&(m.current(),m.current=null)},[h]);const u=l.useRef(!1),x=Ja(),g=l.useRef(null),p=l.useRef(null),E=l.useCallback(b=>{const{pulsate:A,rippleX:y,rippleY:D,rippleSize:H,cb:K}=b;c(R=>[...R,e.jsx(yn,{classes:{ripple:ie(s.ripple,ne.ripple),rippleVisible:ie(s.rippleVisible,ne.rippleVisible),ripplePulsate:ie(s.ripplePulsate,ne.ripplePulsate),child:ie(s.child,ne.child),childLeaving:ie(s.childLeaving,ne.childLeaving),childPulsate:ie(s.childPulsate,ne.childPulsate)},timeout:Ke,pulsate:A,rippleX:y,rippleY:D,rippleSize:H},d.current)]),d.current+=1,m.current=K},[s]),L=l.useCallback((b={},A={},y=()=>{})=>{const{pulsate:D=!1,center:H=i||A.pulsate,fakeElement:K=!1}=A;if((b==null?void 0:b.type)==="mousedown"&&u.current){u.current=!1;return}(b==null?void 0:b.type)==="touchstart"&&(u.current=!0);const R=K?null:p.current,B=R?R.getBoundingClientRect():{width:0,height:0,left:0,top:0};let C,T,_;if(H||b===void 0||b.clientX===0&&b.clientY===0||!b.clientX&&!b.touches)C=Math.round(B.width/2),T=Math.round(B.height/2);else{const{clientX:P,clientY:S}=b.touches&&b.touches.length>0?b.touches[0]:b;C=Math.round(P-B.left),T=Math.round(S-B.top)}if(H)_=Math.sqrt((2*B.width**2+B.height**2)/3),_%2===0&&(_+=1);else{const P=Math.max(Math.abs((R?R.clientWidth:0)-C),C)*2+2,S=Math.max(Math.abs((R?R.clientHeight:0)-T),T)*2+2;_=Math.sqrt(P**2+S**2)}b!=null&&b.touches?g.current===null&&(g.current=()=>{E({pulsate:D,rippleX:C,rippleY:T,rippleSize:_,cb:y})},x.start(un,()=>{g.current&&(g.current(),g.current=null)})):E({pulsate:D,rippleX:C,rippleY:T,rippleSize:_,cb:y})},[i,E,x]),z=l.useCallback(()=>{L({},{pulsate:!0})},[L]),$=l.useCallback((b,A)=>{if(x.clear(),(b==null?void 0:b.type)==="touchend"&&g.current){g.current(),g.current=null,x.start(0,()=>{$(b,A)});return}g.current=null,c(y=>y.length>0?y.slice(1):y),m.current=A},[x]);return l.useImperativeHandle(a,()=>({pulsate:z,start:L,stop:$}),[z,L,$]),e.jsx(wn,Q({className:ie(ne.root,s.root,r),ref:p},f,{children:e.jsx(Po,{component:null,exit:!0,children:h})}))});function vn(t){return it("MuiButtonBase",t)}const Tn=Oe("MuiButtonBase",["root","disabled","focusVisible"]),An=["action","centerRipple","children","className","component","disabled","disableRipple","disableTouchRipple","focusRipple","focusVisibleClassName","LinkComponent","onBlur","onClick","onContextMenu","onDragLeave","onFocus","onFocusVisible","onKeyDown","onKeyUp","onMouseDown","onMouseLeave","onMouseUp","onTouchEnd","onTouchMove","onTouchStart","tabIndex","TouchRippleProps","touchRippleRef","type"],Sn=t=>{const{disabled:a,focusVisible:n,focusVisibleClassName:i,classes:s}=t,r=at({root:["root",a&&"disabled",n&&"focusVisible"]},vn,s);return n&&i&&(r.root+=` ${i}`),r},Mn=Me("button",{name:"MuiButtonBase",slot:"Root",overridesResolver:(t,a)=>a.root})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${Tn.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),En=l.forwardRef(function(t,a){const n=Ue({props:t,name:"MuiButtonBase"}),{action:i,centerRipple:s=!1,children:r,className:f,component:h="button",disabled:c=!1,disableRipple:d=!1,disableTouchRipple:m=!1,focusRipple:u=!1,LinkComponent:x="a",onBlur:g,onClick:p,onContextMenu:E,onDragLeave:L,onFocus:z,onFocusVisible:$,onKeyDown:b,onKeyUp:A,onMouseDown:y,onMouseLeave:D,onMouseUp:H,onTouchEnd:K,onTouchMove:R,onTouchStart:B,tabIndex:C=0,TouchRippleProps:T,touchRippleRef:_,type:P}=n,S=Fe(n,An),M=l.useRef(null),j=l.useRef(null),pe=Ot(j,_),{isFocusVisibleRef:re,onFocus:W,onBlur:he,ref:oe}=Xa(),[F,le]=l.useState(!1);c&&F&&le(!1),l.useImperativeHandle(i,()=>({focusVisible:()=>{le(!0),M.current.focus()}}),[]);const[xe,we]=l.useState(!1);l.useEffect(()=>{we(!0)},[]);const ge=xe&&!d&&!c;l.useEffect(()=>{F&&u&&!d&&xe&&j.current.pulsate()},[d,u,F,xe]);function X(w,$t,Ka=m){return _e(Bt=>($t&&$t(Bt),!Ka&&j.current&&j.current[w](Bt),!0))}const ye=X("start",y),k=X("stop",E),te=X("stop",L),v=X("stop",H),N=X("stop",w=>{F&&w.preventDefault(),D&&D(w)}),q=X("start",B),Ze=X("stop",K),et=X("stop",R),tt=X("stop",w=>{he(w),re.current===!1&&le(!1),g&&g(w)},!1),Be=_e(w=>{M.current||(M.current=w.currentTarget),W(w),re.current===!0&&(le(!0),$&&$(w)),z&&z(w)}),Te=()=>{const w=M.current;return h&&h!=="button"&&!(w.tagName==="A"&&w.href)},nt=l.useRef(!1),Ga=_e(w=>{u&&!nt.current&&F&&j.current&&w.key===" "&&(nt.current=!0,j.current.stop(w,()=>{j.current.start(w)})),w.target===w.currentTarget&&Te()&&w.key===" "&&w.preventDefault(),b&&b(w),w.target===w.currentTarget&&Te()&&w.key==="Enter"&&!c&&(w.preventDefault(),p&&p(w))}),Va=_e(w=>{u&&w.key===" "&&j.current&&F&&!w.defaultPrevented&&(nt.current=!1,j.current.stop(w,()=>{j.current.pulsate(w)})),A&&A(w),p&&w.target===w.currentTarget&&Te()&&w.key===" "&&!w.defaultPrevented&&p(w)});let Pe=h;Pe==="button"&&(S.href||S.to)&&(Pe=x);const Ae={};Pe==="button"?(Ae.type=P===void 0?"button":P,Ae.disabled=c):(!S.href&&!S.to&&(Ae.role="button"),c&&(Ae["aria-disabled"]=c));const Ha=Ot(a,oe,M),zt=Q({},n,{centerRipple:s,component:h,disabled:c,disableRipple:d,disableTouchRipple:m,focusRipple:u,tabIndex:C,focusVisible:F}),Wa=Sn(zt);return e.jsxs(Mn,Q({as:Pe,className:ie(Wa.root,f),ownerState:zt,onBlur:tt,onClick:p,onContextMenu:k,onFocus:Be,onKeyDown:Ga,onKeyUp:Va,onMouseDown:ye,onMouseLeave:N,onMouseUp:v,onDragLeave:te,onTouchEnd:Ze,onTouchMove:et,onTouchStart:q,ref:Ha,tabIndex:c?-1:C,type:P},Ae,S,{children:[r,ge?e.jsx(jn,Q({ref:pe,center:s},T)):null]}))});function kn(t){return it("MuiIconButton",t)}const Rn=Oe("MuiIconButton",["root","disabled","colorInherit","colorPrimary","colorSecondary","colorError","colorInfo","colorSuccess","colorWarning","edgeStart","edgeEnd","sizeSmall","sizeMedium","sizeLarge"]),In=["edge","children","className","color","disabled","disableFocusRipple","size"],Dn=t=>{const{classes:a,disabled:n,color:i,edge:s,size:r}=t,f={root:["root",n&&"disabled",i!=="default"&&`color${je(i)}`,s&&`edge${je(s)}`,`size${je(r)}`]};return at(f,kn,a)},Nn=Me(En,{name:"MuiIconButton",slot:"Root",overridesResolver:(t,a)=>{const{ownerState:n}=t;return[a.root,n.color!=="default"&&a[`color${je(n.color)}`],n.edge&&a[`edge${je(n.edge)}`],a[`size${je(n.size)}`]]}})(({theme:t,ownerState:a})=>Q({textAlign:"center",flex:"0 0 auto",fontSize:t.typography.pxToRem(24),padding:8,borderRadius:"50%",overflow:"visible",color:(t.vars||t).palette.action.active,transition:t.transitions.create("background-color",{duration:t.transitions.duration.shortest})},!a.disableRipple&&{"&:hover":{backgroundColor:t.vars?`rgba(${t.vars.palette.action.activeChannel} / ${t.vars.palette.action.hoverOpacity})`:Ut(t.palette.action.active,t.palette.action.hoverOpacity),"@media (hover: none)":{backgroundColor:"transparent"}}},a.edge==="start"&&{marginLeft:a.size==="small"?-3:-12},a.edge==="end"&&{marginRight:a.size==="small"?-3:-12}),({theme:t,ownerState:a})=>{var n;const i=(n=(t.vars||t).palette)==null?void 0:n[a.color];return Q({},a.color==="inherit"&&{color:"inherit"},a.color!=="inherit"&&a.color!=="default"&&Q({color:i==null?void 0:i.main},!a.disableRipple&&{"&:hover":Q({},i&&{backgroundColor:t.vars?`rgba(${i.mainChannel} / ${t.vars.palette.action.hoverOpacity})`:Ut(i.main,t.palette.action.hoverOpacity)},{"@media (hover: none)":{backgroundColor:"transparent"}})}),a.size==="small"&&{padding:5,fontSize:t.typography.pxToRem(18)},a.size==="large"&&{padding:12,fontSize:t.typography.pxToRem(28)},{[`&.${Rn.disabled}`]:{backgroundColor:"transparent",color:(t.vars||t).palette.action.disabled}})}),Ln=l.forwardRef(function(t,a){const n=Ue({props:t,name:"MuiIconButton"}),{edge:i=!1,children:s,className:r,color:f="default",disabled:h=!1,disableFocusRipple:c=!1,size:d="medium"}=n,m=Fe(n,In),u=Q({},n,{edge:i,color:f,disabled:h,disableFocusRipple:c,size:d}),x=Dn(u);return e.jsx(Nn,Q({className:ie(x.root,r),centerRipple:!0,focusRipple:!c,disabled:h,ref:a},m,{ownerState:u,children:s}))});function zn(t){return it("MuiSkeleton",t)}Oe("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const $n=["animation","className","component","height","style","variant","width"];let Le=t=>t,bt,Ct,wt,yt;const Bn=t=>{const{classes:a,variant:n,animation:i,hasChildren:s,width:r,height:f}=t;return at({root:["root",n,i,s&&"withChildren",s&&!r&&"fitContent",s&&!f&&"heightAuto"]},zn,a)},Pn=Se(bt||(bt=Le`
  0% {
    opacity: 1;
  }
...
`)),Un=Me("span",{name:"MuiSkeleton",slot:"Root",overridesResolver:(t,a)=>{const{ownerState:n}=t;return[a.root,a[n.variant],n.animation!==!1&&a[n.animation],n.hasChildren&&a.withChildren,n.hasChildren&&!n.width&&a.fitContent,n.hasChildren&&!n.height&&a.heightAuto]}})(({theme:t,ownerState:a})=>{const n=hn(t.shape.borderRadius)||"px",i=xn(t.shape.borderRadius);return Q({display:"block",backgroundColor:t.vars?t.vars.palette.Skeleton.bg:pn(t.palette.text.primary,t.palette.mode==="light"?.11:.13),height:"1.2em"},a.variant==="text"&&{marginTop:0,marginBottom:0,height:"auto",transformOrigin:"0 55%",transform:"scale(1, 0.60)",borderRadius:`${i}${n}/${Math.round(i/.6*10)/10}${n}`,"&:empty:before":{content:'"\\00a0"'}},a.variant==="circular"&&{borderRadius:"50%"},a.variant==="rounded"&&{borderRadius:(t.vars||t).shape.borderRadius},a.hasChildren&&{"& > *":{visibility:"hidden"}},a.hasChildren&&!a.width&&{maxWidth:"fit-content"},a.hasChildren&&!a.height&&{height:"auto"})},({ownerState:t})=>t.animation==="pulse"&&Ft(wt||(wt=Le`
    ...
    `),On,(a.vars||a).palette.action.hover)),ze=l.forwardRef(function(t,a){const n=Ue({props:t,name:"MuiSkeleton"}),{animation:i="pulse",className:s,component:r="span",height:f,style:h,variant:c="text",width:d}=n,m=Fe(n,$n),u=Q({},n,{animation:i,component:r,variant:c,hasChildren:!!m.children}),x=Bn(u);return e.jsx(Un,Q({as:r,ref:a,className:ie(x.root,s),ownerState:u},m,{style:Q({width:d,height:f},h)}))}),jt=()=>(Z(),e.jsxs(G,{children:[e.jsxs(Fn,{children:[e.jsxs(_n,{children:[e.jsx(ze,{variant:"rectangular",sx:{bgcolor:"#F4F5FA"},style:{width:"8rem",height:"8rem",borderRadius:"32px",marginRight:"2%"}}),e.jsxs(Gn,{children:[e.jsx(ze,{variant:"rectangular",sx:{bgcolor:"#F4F5FA"},style:{width:"40%",height:"2.2rem",borderRadius:"5px",marginTop:"3%"}}),e.jsx(ze,{variant:"rectangular",sx:{bgcolor:"#F4F5FA"},style:{width:"20%",height:"1.1rem",borderRadius:"5px",marginTop:"2%"}})]})]}),e.jsx(ze,{variant:"rectangular",sx:{bgcolor:"#F4F5FA"},style:{width:"100%",height:"2.7rem",borderRadius:"9px",marginTop:"4%"}})]}),e.jsx(G,{padding:"40px 0 40px 0",children:e.jsx(qa,{type:Qa.SEAMLESS,title:"Loading Channel Details. Please wait..."})})]})),Fn=o.div`
  width: 100%;
  display: flex;
...
`;o.img`
  height: 36px;
  width: 17px;
`;const bi="DD MMM, YYYY",Ci=({onConfirm:t,onClose:a,toastObject:n})=>{const i=Z(),{chainId:s,account:r,provider:f}=me(),h=Ee(),{channelDetails:c,canVerify:d,aliasDetails:{isAliasVerified:m,aliasAddrFromContract:u}}=O(S=>S.admin),{CHANNEL_ACTIVE_STATE:x,CHANNNEL_DEACTIVATED_STATE:g}=O(S=>S.channels),[p,E]=l.useState("");let{channelState:L}=c;L||(L=c.activation_status);const z=L===x,$=L===g,[b,A]=l.useState(!1),[y,D]=l.useState(!1),[H,K]=l.useState(0),R=()=>!b&&a(),B=l.useRef(null);ue(B,()=>R());const C=se.coreContractChain===s;Re(600),l.useEffect(()=>{!c||!C||async function(){const S=c.channelStartBlock.toString(),M=await new Vt(se.coreRPC).getBlock(+S),j=Ht(M.timestamp*1e3);E(j.format(bi))}()},[c]),l.useEffect(()=>{!r||!f||async function(){const S=await tn({address:r,provider:f,contractAddress:We.epnscore});K(parseInt(S));const M=parseInt(S);M>=50&&M!=0?D(!0):D(!1)}()},[r,f]);const T=async S=>{await nn({noOfTokens:S,provider:f,account:r})},_=async()=>{if(A(!0),!f)return;const S=f.getSigner(r);n.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{const M=await an({signer:S,contractAddress:We.epnscore,amount:50-H});console.debug("response",M),M&&(K(50),D(!0),n.showMessageToast({toastTitle:"Success",toastMessage:"Successfully approved Push!",toastType:"SUCCESS",getToastIcon:j=>e.jsx(fe,{size:j,color:"green"})}),A(!1))}catch(M){console.error(M),M.code=="ACTION_REJECTED"?n.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:j=>e.jsx(Y,{size:j,color:"red"})}):(n.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in approving PUSH Token",toastType:"ERROR",getToastIcon:j=>e.jsx(Y,{size:j,color:"red"})}),console.error("Error --> %o",M),console.error({err:M}))}A(!1)},P=async()=>{A(!0);try{const S=Wt("50",18),M=await t(S);n.showMessageToast({toastTitle:"Reactivating channel",toastMessage:"Reactivate channel.",toastType:"SUCCESS",getToastIcon:j=>e.jsx(fe,{size:j,color:"green"})}),await M.wait(),console.info("Transaction Mined!"),n.showMessageToast({toastTitle:"Channel Reactivated",toastMessage:"Channel has been reactivated. You can now send notifications from it",toastType:"SUCCESS",getToastIcon:j=>e.jsx(fe,{size:j,color:"green"})}),h(lt({...c,channelState:x})),a(),A(!1)}catch(S){console.error("Error reactivateChannel",{err:S}),n.showMessageToast({toastTitle:"Transaction Failed",toastMessage:"Channel reactivation failed.",toastType:"ERROR",getToastIcon:M=>e.jsx(Y,{size:M,color:"red"})}),A(!1)}};return e.jsx(He,{theme:i,children:e.jsxs(wi,{ref:B,children:[e.jsxs(yi,{children:[e.jsx(ji,{children:"Reactivate Channel"}),e.jsx(Ln,{onClick:R,style:{padding:"0",marginRight:"0.5rem"},sx:{"&:hover":{backgroundColor:"transparent"}},children:e.jsx(co,{size:"1.5rem",style:{color:i.modalIconColor}})})]}),e.jsxs(Ti,{justifyContent:"flex-start",alignSelf:"stretch",children:[e.jsx(Ai,{src:c.icon}),e.jsxs(At,{alignItems:"flex-start",padding:"5px 0px",children:[e.jsxs(Di,{children:[c.name,d&&e.jsx(Si,{src:"/verify.png"})]}),e.jsxs(At,{alignItems:"flex-start",flex:"initial",padding:"5px 0px",children:[C&&u&&!m||!C&&!m?e.jsx(ki,{children:"Alias Network Setup Pending"}):e.jsxs(vi,{justifyContent:"flex-start",children:[e.jsxs(Mi,{children:[e.jsx("img",{style:{width:"15px"},src:"/subcount.svg",alt:"subscount"}),e.jsx(Ri,{children:c.subscriber_count})]}),e.jsx(Ei,{active:z,children:z?"Active":$?"Deactivated":"Blocked"})]}),p&&e.jsxs(Ii,{children:["Created ",p]})]})]})]}),e.jsxs(Ni,{children:[e.jsx(Li,{children:"Channel reactivation fee"}),e.jsxs(G,{flex:"0",children:[y?e.jsx(zi,{src:$o}):null,e.jsxs($i,{children:[50," PUSH"]})]})]}),e.jsx(Qt,{noOfPushTokensToCheck:50,containerProps:{width:"100%"},onMintPushToken:T}),b?e.jsxs(Pi,{children:[e.jsx(Gt,{size:42,color:U.COLORS.PRIMARY_PINK,type:st.PROCESSING}),e.jsx(Oi,{children:"Verifying Transaction"})]}):e.jsx(Bi,{children:H>=50?e.jsx(Mt,{onClick:P,children:"Reactivate"}):e.jsx(Mt,{onClick:_,children:"Approve PUSH"})})]})})},wi=o.div`
  width: 30vw;
  display: flex;
  flex-direction: column;
  background: ${t=>t.theme.modalContentBackground};
...
`,Oi=o.p`
  ...
  margin-left: 12px;
  color: ${t=>t.theme.editChannelPrimaryText};
`,Ui=50,Fi=se.coreContractChain;function _i({DropdownRef:t,isDropdownOpen:a,closeDropdown:n}){Ee();const{account:i,chainId:s}=me(),{epnsWriteProvider:r,epnsCommWriteProvider:f}=O(W=>W.contracts),{channelDetails:h}=O(W=>W.admin),{CHANNNEL_DEACTIVATED_STATE:c,CHANNEL_BLOCKED_STATE:d}=O(W=>W.channels);O(W=>W.user);const m=Z(),{channelState:u}=h,x=Fi===s,g=Re(425),{isModalOpen:p,showModal:E,ModalComponent:L}=Ie(),{isModalOpen:z,showModal:$,ModalComponent:b}=Ie(),{isModalOpen:A,showModal:y,ModalComponent:D}=Ie(),H=a&&!p&&!z&&!A;ue(t,()=>H&&n()),V.useState(!1),V.useState(Ui);const[K,R]=V.useState(0),B=u===c,C=u===d,T=C||B;V.useEffect(()=>{R(+po.formatBigNumberToMetric(h.poolContribution,!0))},[i,h.poolContribution]),de();const _=()=>{C||(B?$():E())},P=de(),S=r.reactivateChannel,M=de(),j=()=>r.deactivateChannel(),pe=de(),re=async(W,he)=>{if(!(W==""||he=="")&&!(W<60))try{const oe=W+"+"+he,F=Kt(oe);return r.addSubGraph(F)}catch(oe){console.error(oe)}};return e.jsxs(e.Fragment,{children:[e.jsx("div",{children:e.jsx(Gi,{background:m,children:e.jsxs(Vi,{children:[se.appEnv!=="prod"&&e.jsx(Et,{disabled:T,onClick:()=>!T&&y(),children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[e.jsx($e,{src:oi,alt:"cube"}),e.jsx("div",{style:{width:"10px"}}),"Add SubGraph Details"]})}),x&&e.jsx(Et,{isChannelDeactivated:B,onClick:_,children:e.jsx(Hi,{isChannelBlocked:C,isChannelDeactivated:B,children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[C?e.jsx($e,{src:Tt,alt:"red-bell"}):B?e.jsx($e,{src:ri,alt:"green-bell"}):e.jsx($e,{src:Tt,alt:"red-bell"}),e.jsx("div",{style:{width:"10px"}}),C?"Channel Blocked":B?"Activate Channel":"Deactivate Channel"]})})})]})})}),e.jsx(L,{InnerComponent:pi,onConfirm:j,toastObject:M,modalPosition:De.ON_ROOT}),e.jsx(b,{InnerComponent:Ci,onConfirm:S,toastObject:P,modalMargin:g?"10rem 1rem 0 1rem":"",modalPosition:De.ON_ROOT}),e.jsx(D,{InnerComponent:si,onConfirm:re,toastObject:pe,modalPosition:De.ON_ROOT})]})}const Gi=o.div`
  position: absolute;
  right: 20px;
  display: flex;
  flex-direction: column-reverse;
...
`,$e=o.img`
  ...
  padding: 0;
  margin: 0;
`;function kt(){const t=V.useRef(null),[a,n]=V.useState(!1);Z();const i=()=>{n(r=>!r)},s=()=>{n(!1)};return e.jsxs(G,{flex:"0",ref:t,children:[e.jsx(Wi,{active:a,onClick:i}),a&&e.jsx(_i,{DropdownRef:t,isDropdownOpen:a,closeDropdown:s})]})}o.div`
  flex: 1;
  display: flex;
...
`,Ki="DD MMM, YYYY";function Yi({isChannelExpired:t,setIsChannelExpired:a,showEditChannel:n,destroyChannel:i}){var ge,X,ye;const{account:s,chainId:r,wallet:f}=me(),{delegatees:h,channelDetails:c,canVerify:d,aliasDetails:{isAliasVerified:m,aliasAddrFromContract:u}}=O(k=>k.admin),{channelSettings:x}=O(k=>k.channels),{userPushSDKInstance:g}=O(k=>k.user),{handleConnectWalletAndEnableProfile:p}=l.useContext(Jt),{CHANNEL_ACTIVE_STATE:E,CHANNNEL_DEACTIVATED_STATE:L}=O(k=>k.channels),{processingState:z}=O(k=>k.channelCreation),[$,b]=l.useState([]),[A,y]=l.useState("");let{channelState:D}=c;D||(D=c.activation_status);const H=D===E,K=D===L,R=se.coreContractChain===r,B=Re(600),[C,T]=l.useState([s]),[_,P]=l.useState(void 0);O(k=>k.contracts);const S=xo(),{isModalOpen:M,showModal:j,ModalComponent:pe}=Ie(),re=de(),W=async()=>{g.signer||await p({wallet:f}),j()},he=async k=>g.channel.delegate.add(dt(k,r)),oe=c.expiryTime?go(((ge=c.expiryTime)==null?void 0:ge.toString())*1e3):"",F=c.expiryTime?mo(((X=c.expiryTime)==null?void 0:X.toString())*1e3):!0,le=c.expiryTime?uo(((ye=c.expiryTime)==null?void 0:ye.toString())*1e3,14):"";l.useEffect(()=>{c.channelType==ct.TIMEBOUND&&(F||a(!0))},[F]),l.useEffect(()=>{!c||!d||async function(){let k=await Xt.getInstance().getChannelJsonAsync(c.verifiedBy);b(k)}()},[c,d]),l.useEffect(()=>{!c||!R||async function(){const k=c.channelStartBlock.toString(),te=await new Vt(se.coreRPC).getBlock(+k),v=Ht(te.timestamp*1e3);y(v.format(Ki))}()},[c]),l.useEffect(()=>{s&&(!h||!h.length?P(s):P(R?h[0].channel:h[0].alias_address))},[h,s]),l.useEffect(()=>{s&&(async()=>{try{const k=dt(s,r),te=await g.channel.delegate.get({channel:k});if(te){const v=te.map(N=>N);v.unshift(s),T(v)}}catch(k){console.error(k)}})()},[s,r]);const xe=async k=>{let te=g;if(!(!te.signer&&(te=await p({wallet:f}),!te)))return te.channel.delegate.remove(dt(k,r))},we=()=>{S(bo.ChannelSettings)};return e.jsxs(J,{children:[e.jsxs(Xi,{justifyContent:"flex-start",alignSelf:"stretch",children:[e.jsx(qi,{src:c.icon}),e.jsxs(qe,{alignItems:"flex-start",padding:"5px 0px",children:[e.jsxs(sa,{children:[c.name,d&&e.jsx(Qi,{src:"/verify.png"})]}),e.jsxs(qe,{alignItems:"flex-start",flex:"initial",padding:"5px 0px",children:[R&&u&&!m||!R&&!m?e.jsx(ia,{children:"Alias Network Setup Pending"}):e.jsxs(Ji,{justifyContent:"flex-start",children:[e.jsxs(ta,{children:[e.jsx("img",{style:{width:"15px"},src:"/subcount.svg",alt:"subscount"}),e.jsx(aa,{children:c.subscriber_count})]}),e.jsxs(na,{active:H,children:[K&&e.jsx(pt,{width:"12px",src:No,margin:"0 5px 2px 0px",height:"30px"}),H?"Active":K?"Deactivated":"Blocked"]}),c.channelType==ct.TIMEBOUND&&!t&&e.jsxs(G,{background:"#C5EFD1",flex:"0",borderRadius:"25px",margin:"0 0 10px 10px",height:"30px",children:[e.jsx(pt,{width:"16px",src:"svg/ExpiresTimer.svg",alt:"expiryTimer",padding:"0 6px 0 9px"}),e.jsxs(ve,{color:"#30CC8B",fontWeight:"600",padding:"0 9px 0 0",children:["Expires on ",oe]})]}),c.channelType==ct.TIMEBOUND&&t&&e.jsxs(G,{background:"#FFD8D8",flex:"0",borderRadius:"25px",margin:"0 0 10px 10px",height:"30px",children:[e.jsx(pt,{width:"16px",src:"svg/ExpiredTimer.svg",alt:"expiryTimer",padding:"0 6px 0 9px"}),e.jsxs(ve,{color:"#E93636",fontWeight:"600",padding:"0 9px 0 0",children:["Expired on ",oe]})]})]}),A&&e.jsxs(oa,{children:["Created ",A]})]})]})]}),B&&e.jsxs(G,{zIndex:"1",padding:"0 0 15px 0",alignSelf:"center",display:"flex",gap:"8px",children:[!t&&R&&e.jsx(ae,{onClick:n,size:"small",variant:"outline",children:"Edit Channel"}),!t&&e.jsx(kt,{}),t&&R&&e.jsx(ae,{onClick:i,size:"small",variant:"danger",children:"Delete Channel"})]}),t&&e.jsx(J,{alignItems:"flex-start",children:e.jsxs(It,{margin:"25px 0 0 0",children:[e.jsx(ve,{color:"#D53A94",children:"Note:"})," Channel will auto delete on"," ",e.jsx(ve,{fontWeight:"600",children:le})]})}),e.jsx(J,{alignItems:"flex-start",children:e.jsx(It,{children:c.info})}),d&&e.jsx(qe,{alignItems:"flex-start",padding:"5px 0px",children:e.jsx(la,{children:e.jsxs(ra,{children:[e.jsx("span",{children:"verified by:"}),e.jsx(Zi,{src:$.icon}),e.jsx(ea,{children:$.name})]})})}),z===0&&e.jsxs(J,{children:[e.jsx(Ve,{children:e.jsxs(Dt,{flex:"5",minWidth:"280px",self:"stretch",align:"stretch",margin:"10px 0px 30px 0px",radius:"20px",border:"1px solid #D4DCEA",children:[e.jsx(Zt,{title:"Notification Settings",description:"Customize notification preferences for users",Button:e.jsx(Fo,{onClick:we})}),e.jsx(en,{account:s,isAddress:!1,items:x[s],isLoading:!1,onClickEmptyListButton:we,emptyListButtonTitle:"Add Setting"})]})}),e.jsx(Ve,{children:e.jsxs(Dt,{flex:"5",minWidth:"280px",self:"stretch",align:"stretch",margin:"10px 0px 30px 0px",radius:"20px",border:"1px solid #D4DCEA",children:[e.jsx(Zt,{title:"Channel Delegates",description:"Delegates can send notifications on behalf of the channel",Button:e.jsx(_o,{onClick:W})}),e.jsx(en,{account:s,isAddress:!0,items:C,isLoading:!1,addressDropdownOptions:[{text:"Remove",onClick:xe,icon:e.jsx(fo,{})}]})]})})]}),e.jsx(pe,{InnerComponent:ii,onConfirm:he,toastObject:re,modalPosition:De.ON_ROOT})]})}const qe=o(J)`
  @media (max-width: 767px) {
    align-items: center;
  }
`,Ji=o(G)`
...
`,Ce=t=>t.trim().length==0;function va(t,a){var n=new XMLHttpRequest;n.onload=function(){var i=new FileReader;i.onloadend=function(){a(i.result)},i.readAsDataURL(n.response)},n.open("GET",t),n.responseType="blob",n.send()}const Ta=t=>{var a=Ko,n=t.split(";base64,").pop(),i=vo.from(n,"base64"),s=a(i);return s.width>128||s.height>128?(console.error("Image size check failed... returning"),{success:0,info:"Image size check failed, Image should be 128X128PX"}):(console.debug("Image verification",n.charAt(0)),n.charAt(0)==="/"?{success:1,info:"Image checks passed"}:n.charAt(0)==="i"?{success:1,info:"Image checks passed"}:{success:0,info:"Image extension should be jpg or png"})};function Aa({closeEditChannel:t,UploadLogoComponent:a,displayUplaodLogoModal:n}){const{account:i,provider:s}=me(),{channelDetails:r,aliasDetails:{isAliasVerified:f,aliasAddrFromContract:h}}=O(v=>v.admin),{epnsReadProvider:c,epnsWriteProvider:d}=O(v=>v.contracts),m=50,[u,x]=l.useState(r==null?void 0:r.name),[g,p]=l.useState(r==null?void 0:r.info),[E,L]=l.useState(r==null?void 0:r.url),[z,$]=l.useState(r==null?void 0:r.icon),[b,A]=l.useState(r==null?void 0:r.icon),[y,D]=l.useState(r==null?void 0:r.icon),[H,K]=l.useState(y),[R,B]=l.useState(null),[C,T]=l.useState(!1),[_,P]=l.useState({name:"",description:"",address:"",url:""}),[S,M]=l.useState(!1),[j,pe]=l.useState(0),[re,W]=l.useState(0),[he,oe]=l.useState(!1),F=de();l.useEffect(()=>{i&&async function(){const v=await c.channelUpdateCounter(i);pe(m*(Number(v)+1))}()},[i]),l.useEffect(()=>{!i||!s||async function(){const v=await tn({address:i,provider:s,contractAddress:We.epnscore});W(parseInt(v));const N=parseInt(v);N>=j&&N!=0?T(!0):T(!1)}()},[i,s]);const le=async()=>{if(M(!0),!s)return;const v=s.getSigner(i);F.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{const N=await an({signer:v,contractAddress:We.epnscore,amount:j-re});console.debug("response",N),N&&(M(!1),W(j),T(!0),F.showMessageToast({toastTitle:"Success",toastMessage:"Successfully approved Push!",toastType:"SUCCESS",getToastIcon:q=>e.jsx(fe,{size:q,color:"green"})}))}catch(N){console.error(N),N.code=="ACTION_REJECTED"?F.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:q=>e.jsx(Y,{size:q,color:"red"})}):(F.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in approving PUSH Token",toastType:"ERROR",getToastIcon:q=>e.jsx(Y,{size:q,color:"red"})}),console.error("Error --> %o",N),console.error({err:N}))}M(!1)},xe=()=>{oe(!1)},we=Re(600),ge=l.useRef(null);ue(ge,()=>{xe()});const X=()=>(P(""),Ce(u)||Ce(g)||Ce(E)?(Ce(u)&&P(v=>({...v,name:"Please, enter the channel name."})),Ce(g)&&P(v=>({...v,description:"Please, enter the channel description"})),Ce(E)&&P(v=>({...v,url:"Please, enter the channel url"})),!1):rn(u,125)?rn(E,125)?on(E)?!0:(P(v=>({...v,url:"Channel URL is invalid! Please enter a valid url!"})),!1):(P(v=>({...v,url:"Channel Url should not exceed 125 characters! Please retry!"})),!1):(P(v=>({...v,name:"Channel Name should not exceed 125 characters! Please retry!"})),!1)),ye=()=>!(u!==(r==null?void 0:r.name)||g!==(r==null?void 0:r.info)||E!==(r==null?void 0:r.url)||b!==(r==null?void 0:r.icon)),k=async v=>{try{if(!X())return;M(!0);const N=JSON.stringify({name:u,info:g,url:E,icon:b,aliasDetails:r.aliasDetails||To({chainId:parseInt(r.chain_id),address:r.address})});console.debug(N);const q=await Ao(N);console.debug("IPFS storagePointer:",q);const Ze="1+"+q,et=Kt(Ze),tt=Wt(j.toString(),18);F.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const Be=await d.updateChannelMeta(i,et,tt,{gasLimit:1e6});console.debug(Be),await Be.wait(),M(!1),F.showMessageToast({toastTitle:"Success",toastMessage:"Channel Updated Successfully",toastType:"SUCCESS",getToastIcon:Te=>e.jsx(fe,{size:Te,color:"green"})}),setTimeout(()=>{window.location.reload()},2e3)}catch(N){M(!1),console.error(N.message),N.code=="ACTION_REJECTED"?F.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:q=>e.jsx(Y,{size:q,color:"red"})}):(F.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in updating channel Details",toastType:"ERROR",getToastIcon:q=>e.jsx(Y,{size:q,color:"red"})}),console.error("Error --> %o",N),console.error({err:N}))}},te=async v=>{await nn({noOfTokens:v,provider:s,account:i})};return l.useEffect(()=>{y&&(console.debug("Image cropped",y),va(y,function(v){const N=Ta(v);console.debug("response",N),N.success&&(console.debug("Cropped Image....",y),A(y))}))},[y]),e.jsxs(Sa,{ref:ge,children:[e.jsx(a,{InnerComponent:ga,InnerComponentProps:{setChannelLogo:$,channelLogo:z,croppedImage:y,setCroppedImage:D,setChannelFile:A,imageSrc:H,setImageSrc:K,imageType:R,setImageType:B,errorInfo:_,setErrorInfo:P},modalPosition:De.ON_PARENT}),e.jsxs(Ma,{children:[e.jsxs(ka,{children:[e.jsx(Ra,{src:z}),e.jsx(ae,{variant:"secondary",onClick:()=>{n(),oe(!0)},children:"Upload Logo"})]}),!we&&e.jsx(Ia,{}),e.jsx(ca,{channelName:u,setChannelName:x,channelInfo:g,setChannelInfo:p,channelURL:E,setChannelURL:L,editChannel:k,errorInfo:_,setErrorInfo:P})]}),e.jsxs(Da,{children:[e.jsxs("div",{children:[e.jsx(Na,{children:"Channel edit fee"}),e.jsx(La,{children:"Editing channel details requires fees to be deposited"})]}),e.jsxs(G,{flex:"0",children:[C?e.jsx(Ea,{src:xa}):null,e.jsxs(za,{children:[j," PUSH"]})]})]}),e.jsx(Qt,{noOfPushTokensToCheck:j,containerProps:{width:"100%"},onMintPushToken:te}),S?e.jsx(e.Fragment,{children:e.jsxs($a,{children:[e.jsx(Spinner,{size:42,color:U.COLORS.PRIMARY_PINK,type:st.PROCESSING}),e.jsx(Ba,{children:"Verifying Transaction"})]})}):e.jsx(e.Fragment,{children:e.jsxs(Pa,{children:[e.jsx(ae,{onClick:t,variant:"outline",size:"large",children:"Cancel"}),re>=j?e.jsx(ae,{disabled:ye(),onClick:k,size:"large",children:"Save Changes"}):e.jsx(ae,{onClick:le,size:"large",children:"Approve PUSH"})]})})]})}const Sa=o(J)`
  padding: 0px;
...
`,Oa=10;let Nt=null;const Ua=()=>{Z();const{account:t,chainId:a,wallet:n}=me(),{channelDetails:i,delegatees:s,aliasDetails:{aliasAddr:r,aliasEthAddr:f,isAliasVerified:h,aliasAddrFromContract:c}}=O(C=>C.admin),{processingState:d}=O(C=>C.channelCreation),{epnsWriteProvider:m}=O(C=>C.contracts);O(C=>C.user),l.useContext(Jt);const u=i&&i!=="unfetched",x=de(),g=Ee(),[p,E]=l.useState(!1);l.useState(!0);const[L,z]=l.useState(!1),$=se.coreContractChain===a,b=Re(600);l.useEffect(()=>{if(!$||!i||c||i==="unfetched")return;const C=So(i);if(C){const{address:T,chainId:_}=C;g(Mo(T)),g(Eo(_))}else g(ke(0))},[i,c]);const A=async C=>{let{aliasAddress:T=null,isAliasVerified:_=null}=await Xt.getInstance().getChannelDetailsFromAddress(C);return T=="NULL"&&(T=null),{aliasAddress:T,aliasVerified:_}};l.useEffect(()=>{!$||!c||d===0||(Nt=setInterval(async()=>{const{aliasAddress:C,aliasVerified:T}=await A(t);C?(g(ko(C)),T?(g(ht(!0)),g(ke(0))):(g(ke(2)),g(ht(!1)))):d!=0&&d!=1&&g(ke(1))},Oa*1e3))},[c]),r!==null&&clearInterval(Nt);const y=async()=>{try{x.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const C=await m.destroyTimeBoundChannel(t,{gasLimit:1e6});console.debug(C),console.debug("Check: "+t),await C.wait(),x.showMessageToast({toastTitle:"Success",toastMessage:"Successfully deleted the channel",toastType:"SUCCESS",getToastIcon:T=>e.jsx(Y,{size:T,color:"green"})}),g(lt(null))}catch(C){console.error(C),C.code=="ACTION_REJECTED"?x.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:T=>e.jsx(Y,{size:T,color:"red"})}):x.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in deleting the channel",toastType:"ERROR",getToastIcon:T=>e.jsx(Y,{size:T,color:"red"})})}},D=()=>{z(!0)},H=()=>{z(!1)},{isModalOpen:K,showModal:R,ModalComponent:B}=Ie();return e.jsxs(G,{children:[(i==="unfetched"||d===null)&&e.jsx(jt,{}),i!=="unfetched"&&e.jsxs(J,{justifyContent:d===0&&"flex-start",height:"fit-content",children:[!i&&d===0&&e.jsx(Yo,{}),u&&d!==null&&e.jsx(Fa,{children:L?e.jsx(Aa,{closeEditChannel:H,UploadLogoComponent:B,displayUplaodLogoModal:R,isUploadLogoModalOpen:K}):e.jsxs(e.Fragment,{children:[i&&!b&&e.jsxs(G,{zIndex:"1",gap:"8px",children:[!p&&$&&e.jsx(ae,{onClick:D,size:"small",variant:"outline",children:"Edit Channel"}),!p&&e.jsx(kt,{}),p&&$&&e.jsx(ae,{onClick:y,size:"small",variant:"danger",children:"Delete Channel"})]}),i?e.jsx(Yi,{isChannelExpired:p,setIsChannelExpired:E,showEditChannel:D,destroyChannel:y}):""]})}),d!==0&&d!==null&&u&&!L&&e.jsx(e.Fragment,{children:e.jsx(Yn,{aliasEthAccount:f,setAliasVerified:ht})})]})]})},Fa=o(J)`
  align-items: center;
  align-self: center;
...
`;se.coreContractChain;function _a(){Ro.pageview("/channel_dashboard");const[t,a]=V.useState(!0),[n,i]=V.useState(null),s=()=>i(null);return V.useEffect(()=>{n&&s()},[n]),e.jsxs(e.Fragment,{children:[t?e.jsx(Ua,{}):e.jsx(jt,{}),n&&e.jsx(Lo,{notification:n,clearToast:s})]})}o.div`
  flex: 1;
  display: flex;

  margin-bottom: 15px;
  overflow: hidden;
`;let Lt;sn=()=>e.jsx(Lt,{children:e.jsx(_a,{})}),Lt=o(Io)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
  justify-content: flex-start;
`});export{tr as __tla,sn as default};
