...
`;ge.coreContractChain;const Zt=({setActiveTab:t})=>{const{account:s,provider:o}=ye(),[l,r]=n.useState(null),[a,h]=n.useState(null),[x,d]=n.useState(null),[u,v]=n.useState(null),[E,_]=n.useState(null),[B,N]=n.useState(null),[V,G]=n.useState(null),[O,ee]=n.useState(null),[F,ae]=n.useState(null),[Y,H]=n.useState(null),k=o==null?void 0:o.getSigner(s),$=n.useCallback(async()=>{const M=await Ce.getInstance().getPoolStats();N({...M})},[l,a,x,u,E]),U=n.useCallback(async()=>{const M=await Ce.getInstance().getPUSHPoolStats();G({...M})},[l,a,x,u,E]),w=n.useCallback(async M=>{const Q=await Ce.getInstance().getLPPoolStats(M);ee({...Q})},[l,a,x,u,E]),R=n.useCallback(async()=>{const M=await Ce.getInstance().getUserData(u);ae({...M})},[u]),K=n.useCallback(async()=>{const M=await Ce.getInstance().getUserData(x);H({...M})},[x]);n.useEffect(()=>{let M=new b(p.pushToken,y.pushToken,k),Q=new b(p.staking,y.staking,k),Te=new b(p.depYieldFarmPUSH,y.yieldFarming,k),j=new b(p.depYieldFarmLP,y.yieldFarming,k),m=new b(p.uniswapV2Router02,y.uniswapV2Router02,k);if(r(M),h(Q),v(Te),d(j),_(m),k&&s){var g=o.getSigner(s);let C=new b(p.pushToken,y.pushToken,g),S=new b(p.staking,y.staking,g),f=new b(p.depYieldFarmPUSH,y.yieldFarming,g),A=new b(p.depYieldFarmLP,y.yieldFarming,g),z=new b(p.uniswapV2Router02,y.uniswapV2Router02,g);r(C),h(S),v(f),d(A),_(z)}},[s]),n.useEffect(()=>{l!=null&&a!=null&&u!=null&&(Ce.getInstance().init(s,l,a,u,x,E),$())},[$]),n.useEffect(()=>{B&&we(B)},[B]);const we=async M=>{U(),w(M),R(),K()};return e.jsxs(e.Fragment,{children:[e.jsx(wt,{logo:"WarningCircle",title:"This reward program (V1) has ended.",body:"To continue earning rewards please migrate to new pools.",setActiveTab:t}),e.jsxs(Xt,{children:[e.jsx(ht,{poolName:"PUSH",userData:F,PoolStats:V,poolAddress:p.depYieldFarmPUSH,getUserData:R,getPoolStats:U,tokenAddress:p.pushToken,setActiveTab:t}),e.jsx(ht,{poolName:"UNI-V2",userData:Y,PoolStats:O,poolAddress:p.depYieldFarmLP,getUserData:K,getPoolStats:w,tokenAddress:p.uniV2LPToken,setActiveTab:t})]})]})},Xt=i(T)`
...
`,Ds=i.div``;ge.coreContractChain;let yt,kt,Pt,rt,Et;yt=()=>{_s.pageview("/yield");const[t,s]=n.useState(0),[o,l]=n.useState(!1),{account:r,chainId:a,switchChain:h}=ye(),x=()=>{const E=ge.allowedNetworks[0];a!==1&&a!==5&&h(E)};n.useEffect(()=>{a!==1&&a!==11155111&&(u(),x())},[a]);const{isModalOpen:d,showModal:u,ModalComponent:v}=Je();return e.jsxs(kt,{children:[e.jsx(v,{InnerComponent:Us,onConfirm:()=>{},modalPadding:"0px",modalPosition:Ke.ON_PARENT}),e.jsxs(Pt,{children:[e.jsx(rt,{isActive:!t,onClick:()=>{l(!0),s(0)},children:"Yield Farming V2"}),e.jsxs(rt,{isActive:t,onClick:()=>{l(!1),s(1)},children:["Yield Farming V1 ",e.jsx(Et,{children:"Deprecated"})]})]}),t===0&&e.jsx(Rs,{setActiveTab:s}),t===1&&e.jsx(Zt,{setActiveTab:s})]})},kt=i(We)`
	align-items: stretch;
	align-self: center;
  flex: 1;
	background: ${t=>t.theme.default.bg};
