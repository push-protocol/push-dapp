import{e6 as d,ep as E,fA as re,d_ as f,fB as ae,e1 as t,dY as Y,e_ as q,eZ as G,ei as R,fC as ie,fD as Z,e9 as Q,eS as v,fE as le,fF as ce,fG as de,eq as pe,eX as ge,e3 as ee,e4 as te,fH as k,fI as he,fJ as ne,fK as O,f3 as se,fL as ue,fM as xe,fN as fe,__tla as we}from"./index-FTKP3vlI.js";import{u as Se,n as me}from"./notifSetting-DrLKauYy.js";let I,oe,je=Promise.all([(()=>{try{return we}catch{}})()]).then(async()=>{let P,_,B,$,W,V,H,F,z,U,N,J,K,L,X;I=({children:n,renderDropdownContainer:p,showDropdown:a,toggleDropdown:g,closeDropdown:s,containerPadding:u,centerOnMobile:i})=>{const c=f.useRef(null),l=f.useRef(null);return ae(c,l,s),t.jsxs(P,{ref:c,onClick:g,children:[n,a&&t.jsx(_,{containerPadding:u,centerOnMobile:i,children:t.jsx("div",{ref:l,onClick:e=>e.stopPropagation(),children:p})})]})},P=d.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
...
`,U=d.span`
  ${n=>n.hideIt&&E`
      visibility: hidden;
    `};
`,N=({centerOnMobile:n,optOutHandler:p,channelSetting:a,channelDetail:g,userSetting:s,closeDropdown:u})=>{const[i,c]=f.useState(!1),l=Q();return t.jsxs(J,{children:[a&&a.length!=0&&t.jsx(K,{children:t.jsx($,{centerOnMobile:n,channelDetail:g,userSetting:s,channelSetting:a,onSuccessSave:u,children:t.jsxs(L,{flexDirection:"row",children:[t.jsx(se,{width:"20px",height:"20px",src:"svg/manageSettings.svg",alt:"Settings Logo"}),t.jsx(v,{color:l.viewChannelPrimaryText,fontWeight:500,fontSize:"14px",children:"Manage Settings"})]})})}),t.jsxs(L,{flexDirection:"row",onClick:()=>p({setLoading:c}),children:[t.jsx(se,{width:"20px",height:"20px",src:"svg/optout.svg",alt:"Opt-out Logo"}),t.jsxs(v,{color:l.viewChannelPrimaryText,fontWeight:500,fontSize:"14px",children:[i&&t.jsx(ee,{type:te.SEAMLESS,spinnerSize:16,spinnerColor:"#000"}),!i&&t.jsx(X,{hideIt:i,children:"Opt-out"})]})]})]})},oe=n=>{const{children:p,centerOnMobile:a,userSetting:g,channelDetail:s,onSuccessOptout:u}=n,[i,c]=f.useState(!1),{chainId:l,provider:e,account:o,wallet:r}=Y();q(M=>M.user);const S=G(),A=f.useMemo(()=>s&&(s!=null&&s.channel_settings)?JSON.parse(s==null?void 0:s.channel_settings):null,[s]),D=()=>{c(!i)},y=()=>{c(!1)},m=l===R.coreContractChain,j=Z(),C=async({setLoading:M})=>{const b=M||(()=>{});b(!0);try{let x=s.channel;m||(x=s.alias_address),j.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const w=await e.getSigner(o);await ue.channels.unsubscribe({signer:w,channelAddress:k(x,l),userAddress:k(o,l),onSuccess:()=>{S(xe({channelAddress:x,status:!1})),S(fe(x)),j.showMessageToast({toastTitle:"Success",toastMessage:"Successfully opted out of channel !",toastType:"SUCCESS",getToastIcon:h=>t.jsx(ne,{size:h,color:"green"})}),u(),y()},onError:()=>{console.error("opt out error"),j.showMessageToast({toastTitle:"Error",toastMessage:"There was an error opting out of channel",toastType:"ERROR",getToastIcon:h=>t.jsx(O,{size:h,color:"red"})})},env:R.pushNodesEnv})}catch(x){j.showMessageToast({toastTitle:"Error",toastMessage:`There was an error opting into channel ( ${x.message} )`,toastType:"ERROR",getToastIcon:w=>t.jsx(O,{size:w,color:"red"})}),console.error(x)}finally{b(!1)}};return t.jsx(I,{showDropdown:i,toggleDropdown:D,closeDropdown:y,renderDropdownContainer:t.jsx(N,{centerOnMobile:a,userSetting:g,channelSetting:A,channelDetail:s,optOutHandler:C,closeDropdown:y}),containerPadding:"12px 16px",centerOnMobile:a,children:p})},J=d.div`
