import{iL as Pt,iM as Ya,d_ as l,iN as ie,e1 as e,iO as Oe,iP as Se,iQ as Me,iR as Ue,g5 as _e,iS as Ja,g4 as Q,iT as it,iU as Ot,iV as Xa,iW as Fe,iX as at,iY as je,iZ as Ut,i_ as _t,e6 as o,e9 as Z,fB as G,e3 as qa,e4 as Qa,e$ as O,ed as ee,eP as ce,gA as ot,es as Ft,iv as Za,fE as de,dY as me,e2 as eo,eY as ae,eq as to,e_ as Ee,ej as no,el as io,eT as ve,ei as se,eM as U,eW as ao,i$ as oo,j0 as ke,j1 as ro,ep as Ge,eb as Ve,ea as We,eg as V,fi as rt,eO as I,fm as ue,fK as fe,fL as Y,eR as J,fs as Gt,ft as st,j2 as lt,ha as so,j3 as lo,h2 as Re,gz as Vt,j4 as Wt,ek as He,gR as co,en as Ht,fo as Ie,ih as po,fp as De,j5 as Kt,j6 as ho,gS as Yt,fD as Jt,dZ as xo,j7 as go,j8 as mo,j9 as uo,ja as ct,gF as Xt,fI as dt,f4 as pt,jb as fo,e0 as Co,ff as wo,fj as yo,jc as bo,jd as jo,f_ as vo,je as To,jf as Ao,eN as Ce,jg as So,jh as Mo,ji as Eo,jj as ko,jk as ht,eQ as Ro,e7 as Io,__tla as Do}from"./index-BZmdvrlc.js";import{S as No,N as Lo,__tla as zo}from"./RedCircle-2ozoKg5Z.js";import{M as qt,S as $o,F as Qt,C as Zt,a as en,__tla as Bo}from"./ChannelInfoList-CSONEyT5.js";import{a as Po,__tla as Oo}from"./Tag-US9bjQqy.js";import{a as tn,m as nn,b as an,__tla as Uo}from"./PushTokenContractHelper-DAV9cM5Y.js";import{M as _o,a as Fo,__tla as Go}from"./EmptyNotificationSettings-Dpcn6LbH.js";import{a as on,b as rn,__tla as Vo}from"./ValidationHelper-BVpPT788.js";import{I as Wo,__tla as Ho}from"./ImportPushTokenMessage-cfnuXwMi.js";import{v as Ko,C as Yo,__tla as Jo}from"./CreateChannel-80d_sHuJ.js";import{__tla as Xo}from"./TransitionGroupContext-Snm9DBIJ.js";import{__tla as qo}from"./index.esm-B5P76seN.js";import{__tla as Qo}from"./Stepper-BWV9xvmN.js";import{__tla as Zo}from"./StakingVariant-CDdMtw6p.js";import{__tla as er}from"./useMutation-Dk6A35Zf.js";import{__tla as tr}from"./index.esm-LDExghJQ.js";import"./Common.form-iMV6nXze.js";let sn,nr=Promise.all([(()=>{try{return Do}catch{}})(),(()=>{try{return zo}catch{}})(),(()=>{try{return Bo}catch{}})(),(()=>{try{return Oo}catch{}})(),(()=>{try{return Uo}catch{}})(),(()=>{try{return Go}catch{}})(),(()=>{try{return Vo}catch{}})(),(()=>{try{return Ho}catch{}})(),(()=>{try{return Jo}catch{}})(),(()=>{try{return Xo}catch{}})(),(()=>{try{return qo}catch{}})(),(()=>{try{return Qo}catch{}})(),(()=>{try{return Zo}catch{}})(),(()=>{try{return er}catch{}})(),(()=>{try{return tr}catch{}})()]).then(async()=>{function ln(t,a=0,n=1){return Ya(t,a,n)}function cn(t){t=t.slice(1);const a=new RegExp(`.{1,${t.length>=6?2:1}}`,"g");let n=t.match(a);return n&&n[0].length===1&&(n=n.map(i=>i+i)),n?`rgb${n.length===4?"a":""}(${n.map((i,s)=>s<3?parseInt(i,16):Math.round(parseInt(i,16)/255*1e3)/1e3).join(", ")})`:""}function xt(t){if(t.type)return t;if(t.charAt(0)==="#")return xt(cn(t));const a=t.indexOf("("),n=t.substring(0,a);if(["rgb","rgba","hsl","hsla","color"].indexOf(n)===-1)throw new Error(Pt(9,t));let i=t.substring(a+1,t.length-1),s;if(n==="color"){if(i=i.split(" "),s=i.shift(),i.length===4&&i[3].charAt(0)==="/"&&(i[3]=i[3].slice(1)),["srgb","display-p3","a98-rgb","prophoto-rgb","rec-2020"].indexOf(s)===-1)throw new Error(Pt(10,s))}else i=i.split(",");return i=i.map(r=>parseFloat(r)),{type:n,values:i,colorSpace:s}}function dn(t){const{type:a,colorSpace:n}=t;let{values:i}=t;return a.indexOf("rgb")!==-1?i=i.map((s,r)=>r<3?parseInt(s,10):s):a.indexOf("hsl")!==-1&&(i[1]=`${i[1]}%`,i[2]=`${i[2]}%`),a.indexOf("color")!==-1?i=`${n} ${i.join(" ")}`:i=`${i.join(", ")}`,`${a}(${i})`}function pn(t,a){return t=xt(t),a=ln(a),(t.type==="rgb"||t.type==="hsl")&&(t.type+="a"),t.type==="color"?t.values[3]=`/${a}`:t.values[3]=a,dn(t)}function hn(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function xn(t){return parseFloat(t)}function gn(t){const{className:a,classes:n,pulsate:i=!1,rippleX:s,rippleY:r,rippleSize:f,in:h,onExited:c,timeout:d}=t,[m,u]=l.useState(!1),x=ie(a,n.ripple,n.rippleVisible,i&&n.ripplePulsate),g={width:f,height:f,top:-(f/2)+r,left:-(f/2)+s},p=ie(n.child,m&&n.childLeaving,i&&n.childPulsate);return!h&&!m&&u(!0),l.useEffect(()=>{if(!h&&c!=null){const E=setTimeout(c,d);return()=>{clearTimeout(E)}}},[c,h,d]),e.jsx("span",{className:x,style:g,children:e.jsx("span",{className:p})})}const ne=Oe("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),mn=["center","classes","className"];let Ne=t=>t,gt,mt,ut,ft;const Ke=550,un=80,fn=Se(gt||(gt=Ne`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`)),yn=Me("span",{name:"MuiTouchRipple",slot:"Root"})({overflow:"hidden",pointerEvents:"none",position:"absolute",zIndex:0,top:0,right:0,bottom:0,left:0,borderRadius:"inherit"}),bn=Me(gn,{name:"MuiTouchRipple",slot:"Ripple"})(ft||(ft=Ne`
  opacity: 0;
  position: absolute;
...
`,Oi=o.p`
  ...
  margin-left: 12px;
  color: ${t=>t.theme.editChannelPrimaryText};
`,Ui=50,_i=se.coreContractChain;function Fi({DropdownRef:t,isDropdownOpen:a,closeDropdown:n}){Ee();const{account:i,chainId:s}=me(),{epnsWriteProvider:r,epnsCommWriteProvider:f}=O(H=>H.contracts),{channelDetails:h}=O(H=>H.admin),{CHANNNEL_DEACTIVATED_STATE:c,CHANNEL_BLOCKED_STATE:d}=O(H=>H.channels);O(H=>H.user);const m=Z(),{channelState:u}=h,x=_i===s,g=Re(425),{isModalOpen:p,showModal:E,ModalComponent:L}=Ie(),{isModalOpen:z,showModal:$,ModalComponent:C}=Ie(),{isModalOpen:A,showModal:b,ModalComponent:D}=Ie(),W=a&&!p&&!z&&!A;ue(t,()=>W&&n()),V.useState(!1),V.useState(Ui);const[K,R]=V.useState(0),B=u===c,w=u===d,T=w||B;V.useEffect(()=>{R(+po.formatBigNumberToMetric(h.poolContribution,!0))},[i,h.poolContribution]),de();const F=()=>{w||(B?$():E())},P=de(),S=r.reactivateChannel,M=de(),j=()=>r.deactivateChannel(),pe=de(),re=async(H,he)=>{if(!(H==""||he=="")&&!(H<60))try{const oe=H+"+"+he,_=Kt(oe);return r.addSubGraph(_)}catch(oe){console.error(oe)}};return e.jsxs(e.Fragment,{children:[e.jsx("div",{children:e.jsx(Gi,{background:m,children:e.jsxs(Vi,{children:[se.appEnv!=="prod"&&e.jsx(Et,{disabled:T,onClick:()=>!T&&b(),children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[e.jsx($e,{src:oi,alt:"cube"}),e.jsx("div",{style:{width:"10px"}}),"Add SubGraph Details"]})}),x&&e.jsx(Et,{isChannelDeactivated:B,onClick:F,children:e.jsx(Wi,{isChannelBlocked:w,isChannelDeactivated:B,children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[w?e.jsx($e,{src:Tt,alt:"red-bell"}):B?e.jsx($e,{src:ri,alt:"green-bell"}):e.jsx($e,{src:Tt,alt:"red-bell"}),e.jsx("div",{style:{width:"10px"}}),w?"Channel Blocked":B?"Activate Channel":"Deactivate Channel"]})})})]})})}),e.jsx(L,{InnerComponent:pi,onConfirm:j,toastObject:M,modalPosition:De.ON_ROOT}),e.jsx(C,{InnerComponent:wi,onConfirm:S,toastObject:P,modalMargin:g?"10rem 1rem 0 1rem":"",modalPosition:De.ON_ROOT}),e.jsx(D,{InnerComponent:si,onConfirm:re,toastObject:pe,modalPosition:De.ON_ROOT})]})}const Gi=o.div`
  position: absolute;
  right: 20px;
  display: flex;
  flex-direction: column-reverse;
...
`,Oa=10;let Nt=null;const Ua=()=>{Z();const{account:t,chainId:a,wallet:n}=me(),{channelDetails:i,delegatees:s,aliasDetails:{aliasAddr:r,aliasEthAddr:f,isAliasVerified:h,aliasAddrFromContract:c}}=O(w=>w.admin),{processingState:d}=O(w=>w.channelCreation),{epnsWriteProvider:m}=O(w=>w.contracts);O(w=>w.user),l.useContext(Jt);const u=i&&i!=="unfetched",x=de(),g=Ee(),[p,E]=l.useState(!1);l.useState(!0);const[L,z]=l.useState(!1),$=se.coreContractChain===a,C=Re(600);l.useEffect(()=>{if(!$||!i||c||i==="unfetched")return;const w=So(i);if(w){const{address:T,chainId:F}=w;g(Mo(T)),g(Eo(F))}else g(ke(0))},[i,c]);const A=async w=>{let{aliasAddress:T=null,isAliasVerified:F=null}=await Xt.getInstance().getChannelDetailsFromAddress(w);return T=="NULL"&&(T=null),{aliasAddress:T,aliasVerified:F}};l.useEffect(()=>{!$||!c||d===0||(Nt=setInterval(async()=>{const{aliasAddress:w,aliasVerified:T}=await A(t);w?(g(ko(w)),T?(g(ht(!0)),g(ke(0))):(g(ke(2)),g(ht(!1)))):d!=0&&d!=1&&g(ke(1))},Oa*1e3))},[c]),r!==null&&clearInterval(Nt);const b=async()=>{try{x.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const w=await m.destroyTimeBoundChannel(t,{gasLimit:1e6});console.debug(w),console.debug("Check: "+t),await w.wait(),x.showMessageToast({toastTitle:"Success",toastMessage:"Successfully deleted the channel",toastType:"SUCCESS",getToastIcon:T=>e.jsx(Y,{size:T,color:"green"})}),g(lt(null))}catch(w){console.error(w),w.code=="ACTION_REJECTED"?x.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:T=>e.jsx(Y,{size:T,color:"red"})}):x.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in deleting the channel",toastType:"ERROR",getToastIcon:T=>e.jsx(Y,{size:T,color:"red"})})}},D=()=>{z(!0)},W=()=>{z(!1)},{isModalOpen:K,showModal:R,ModalComponent:B}=Ie();return e.jsxs(G,{children:[(i==="unfetched"||d===null)&&e.jsx(jt,{}),i!=="unfetched"&&e.jsxs(J,{justifyContent:d===0&&"flex-start",height:"fit-content",children:[!i&&d===0&&e.jsx(Yo,{}),u&&d!==null&&e.jsx(_a,{children:L?e.jsx(Aa,{closeEditChannel:W,UploadLogoComponent:B,displayUplaodLogoModal:R,isUploadLogoModalOpen:K}):e.jsxs(e.Fragment,{children:[i&&!C&&e.jsxs(G,{zIndex:"1",gap:"8px",children:[!p&&$&&e.jsx(ae,{onClick:D,size:"small",variant:"outline",children:"Edit Channel"}),!p&&e.jsx(kt,{}),p&&$&&e.jsx(ae,{onClick:b,size:"small",variant:"danger",children:"Delete Channel"})]}),i?e.jsx(Yi,{isChannelExpired:p,setIsChannelExpired:E,showEditChannel:D,destroyChannel:b}):""]})}),d!==0&&d!==null&&u&&!L&&e.jsx(e.Fragment,{children:e.jsx(Yn,{aliasEthAccount:f,setAliasVerified:ht})})]})]})},_a=o(J)`
  align-items: center;
  align-self: center;
