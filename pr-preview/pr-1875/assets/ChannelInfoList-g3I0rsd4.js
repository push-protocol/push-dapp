import{e6 as i,e9 as Y,e1 as t,ea as le,e3 as G,e4 as X,eX as q,eN as p,eS as J,dY as pe,ei as xe,d_ as l,fn as ce,f3 as he,gb as ge,fo as me,fx as fe,h1 as w,ed as h,ee as K,g_ as Q,h2 as ue,fl as we,__tla as je}from"./index-FTKP3vlI.js";import{c as Ce,__tla as ye}from"./PushTokenContractHelper-j81Kyflk.js";import{E as be,__tla as ve}from"./EmptyNotificationSettings-DZuj-Nfg.js";import{T as j,__tla as ke}from"./Tag-BSqts8Ac.js";let ee,te,ie,ne,oe,Le=Promise.all([(()=>{try{return je}catch{}})(),(()=>{try{return ye}catch{}})(),(()=>{try{return ve}catch{}})(),(()=>{try{return ke}catch{}})()]).then(async()=>{let C,y,b,v,k,L,_,M,g,S,m,T,H,$;ie=({text:e,onClick:s,isLoading:n,topMargin:o,loaderTitle:r})=>{const a=Y();return t.jsx(le,{theme:a,children:t.jsx(C,{style:{marginTop:o||"55px"},children:n?t.jsx(y,{children:t.jsx(G,{type:X.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:r??"",titleColor:"#fff"})}):t.jsx(q,{onClick:s,variant:"primary",size:"large",children:e})})})},C=i.div`
  display: flex;
...
`,f=({options:e,item:s})=>{const[n,o]=l.useState(!1),r=l.useRef();return we(r,()=>o(!1)),t.jsxs("div",{children:[t.jsx(O,{onClick:()=>o(!0)}),n&&t.jsx(B,{onMouseLeave:()=>o(!1),ref:r,children:e.map(({icon:a,onClick:d,text:x},c)=>t.jsxs(D,{onClick:()=>d(s),index:c,children:[a,t.jsx(Z,{children:x})]},c))})]})},O=i(ue)`
...
`,Z=i.span`
  margin-left: 8px;
`,oe=e=>{const s=(n,o)=>n.toLowerCase()===o.toLowerCase();return t.jsx(I,{style:e.style,isLoading:e.isLoading,children:t.jsx(h,{flex:"5",justify:"flex-start",align:"stretch",children:e.isLoading?t.jsx(W,{children:t.jsx(G,{type:X.SEAMLESS})}):t.jsxs(t.Fragment,{children:[e.items&&e.items.length>0&&e.items.map(n=>{var o,r;return t.jsxs("div",{children:[t.jsx(U,{}),t.jsxs(h,{direction:"row",justify:"space-between",padding:"9.5px 0px",children:[t.jsxs(h,{direction:"row",justify:"flex-start",margin:"0px 0px 0px -15px",children:[e.isAddress?t.jsx(N,{children:t.jsx(z,{delegateAddress:n,maxWidth:"200px"})}):t.jsxs(t.Fragment,{children:[t.jsx(R,{children:n.description}),n.type===2&&t.jsx(j,{children:"Range"}),n.type===3&&t.jsx(j,{children:"Multi-Range"})]}),e.isAddress&&s(e.account,n)&&t.jsx(j,{children:"Creator"})]}),e.isAddress===!0&&((o=e.addressDropdownOptions)==null?void 0:o.length)>0&&!s(e.account,n)&&t.jsx(f,{options:e.addressDropdownOptions,item:n}),e.isAddress===!1&&((r=e.settingsDropdownOptions)==null?void 0:r.length)>0&&t.jsx(f,{options:e.settingsDropdownOptions,item:n})]})]},e.isAddress?n:n.description||n.index)}),e.items&&e.items.length===0&&e.isAddress===!1&&t.jsx(be,{title:"No settings added",description:"Add settings for users to customize their notification preferences.",onClick:e.onClickEmptyListButton,buttonTitle:e.emptyListButtonTitle})]})})})},I=i.div`
