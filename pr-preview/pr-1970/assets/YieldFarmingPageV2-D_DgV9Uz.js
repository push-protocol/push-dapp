...
`,Me=i(Ce)`
  ...
  border-radius: 5px;
  gap: 5px;
`,Tt=({logo:t,title:s,body:o,setActiveTab:l})=>{const r=Ee(600);return e.jsxs(T,{style:{color:t==="announcement"?"white":"#333"},justifyContent:"stretch",padding:r?"12px":"16px",background:t==="announcement"?"linear-gradient(90deg, #121315 -2.55%, #2A2A39 32.62%, #8E317A 68.34%, #121315 102.97%)":"#FFF7DA",borderRadius:"16px",children:[e.jsx(oe,{width:t==="announcement"?"60px":"32px",height:t==="announcement"?"60px":"32px",src:Ft(`svg/${t}.svg`),alt:"Announcement Logo"}),e.jsxs(y,{margin:t==="announcement"?"0 0 0 16px":"0 0 0 13px",justifyContent:"center",alignItems:"flex-start",gap:t==="announcement"?"4px":"0px",children:[e.jsx(D,{color:"inherit",fontSize:r?"20px":"24px",textAlign:"left",fontWeight:500,children:s}),e.jsxs(D,{color:"inherit",fontSize:r?"12px":"16px",textAlign:"left",fontWeight:500,children:[o," ",s.includes("New V2")&&e.jsxs(e.Fragment,{children:[e.jsx(Xt,{onClick:()=>l(1),children:"here"})," to migrate."]})]})]})]})},Xt=i(Rt)`
  cursor: pointer;
  color: #fff;
...
`,vt=i(me)`
  ...
  height: 17px;
  width: fit-content;
`,It=()=>e.jsx(Xs,{children:e.jsx(yt,{})})});export{qs as __tla,It as default};
