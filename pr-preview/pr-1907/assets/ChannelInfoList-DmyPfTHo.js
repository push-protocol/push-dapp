import{cA as i,cD as Y,cv as t,cE as le,cx as q,cy as G,gp as Q,gf as p,gk as J,cq as pe,cQ as xe,cs as l,gR as ce,gE as he,hF as ge,gS as me,g$ as fe,iu as w,cH as h,cM as K,ir as X,iv as ue,gP as we,__tla as je}from"./index-C8uskVBT.js";import{c as Ce,__tla as ye}from"./PushTokenContractHelper-Cc1y9MAp.js";import{E as be,__tla as ve}from"./EmptyNotificationSettings-Bi1unUvl.js";import{T as j,__tla as ke}from"./Tag-DaPpKXzG.js";let ee,te,ie,ne,se,Le=Promise.all([(()=>{try{return je}catch{}})(),(()=>{try{return ye}catch{}})(),(()=>{try{return ve}catch{}})(),(()=>{try{return ke}catch{}})()]).then(async()=>{let C,y,b,v,k,L,M,_,g,H,m,S,T,$;ie=({text:e,onClick:o,isLoading:n,topMargin:s,loaderTitle:r})=>{const a=Y();return t.jsx(le,{theme:a,children:t.jsx(C,{style:{marginTop:s||"55px"},children:n?t.jsx(y,{children:t.jsx(q,{type:G.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:r??"",titleColor:"#fff"})}):t.jsx(Q,{onClick:o,variant:"primary",size:"large",children:e})})})},C=i.div`
  display: flex;
