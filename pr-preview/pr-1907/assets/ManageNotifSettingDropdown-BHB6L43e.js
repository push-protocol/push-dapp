import{cA as d,cV as E,h2 as re,cs as f,h3 as ae,cv as t,cq as Q,gs as X,gr as Y,cQ as L,h4 as ie,h5 as G,cD as Z,gk as v,h6 as le,h7 as ce,h8 as de,cW as he,gp as pe,cx as ee,cy as te,h9 as R,ha as ge,hb as ne,hc as O,gE as se,hd as xe,he as ue,hf as fe,__tla as we}from"./index-C8uskVBT.js";import{u as Se,n as me}from"./notifSetting-DrLKauYy.js";let I,oe,je=Promise.all([(()=>{try{return we}catch{}})()]).then(async()=>{let P,_,$,B,W,V,H,U,z,F,N,q,J,k,K;I=({children:n,renderDropdownContainer:h,showDropdown:a,toggleDropdown:p,closeDropdown:s,containerPadding:x,centerOnMobile:i})=>{const c=f.useRef(null),l=f.useRef(null);return ae(c,l,s),t.jsxs(P,{ref:c,onClick:p,children:[n,a&&t.jsx(_,{containerPadding:x,centerOnMobile:i,children:t.jsx("div",{ref:l,onClick:e=>e.stopPropagation(),children:h})})]})},P=d.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
