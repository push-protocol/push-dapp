...
`,V=r.div`
  ...
  // margin-bottom: 70px;
  box-sizing: border-box !important;
`,U=({spaceid:t})=>{const{account:l,chainId:S}=Z(),[h,e]=s.useState(!0),{getUser:g,connectedUser:d,setConnectedUser:p}=s.useContext(q);w({account:l,chainId:S,env:ge.appEnv}),s.useEffect(()=>{e(!0),p(null)},[l]),s.useEffect(()=>{h&&(p(d),c())},[d]);const c=async()=>{var f;const E=ue({account:l});((f=d==null?void 0:d.wallets)==null?void 0:f.toLowerCase())!==(E==null?void 0:E.toLowerCase())&&await g(),e(!1)};return i.jsx($,{children:h?i.jsx(R,{children:i.jsx(F,{children:i.jsx(Ie,{type:Se.SEAMLESS,spinnerSize:24})})}):i.jsx(_,{spaceid:t})})},$=r.div`
  align-items: stretch;
  align-self: stretch;
  flex: 1;
