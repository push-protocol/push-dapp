...
`;ge.coreContractChain;const qt=({setActiveTab:t})=>{const{account:s,provider:o}=ye(),[l,r]=n.useState(null),[a,h]=n.useState(null),[x,d]=n.useState(null),[u,v]=n.useState(null),[E,_]=n.useState(null),[B,N]=n.useState(null),[$,G]=n.useState(null),[O,ee]=n.useState(null),[F,ae]=n.useState(null),[Y,W]=n.useState(null),k=o==null?void 0:o.getSigner(s),V=n.useCallback(async()=>{const M=await Ce.getInstance().getPoolStats();N({...M})},[l,a,x,u,E]),U=n.useCallback(async()=>{const M=await Ce.getInstance().getPUSHPoolStats();G({...M})},[l,a,x,u,E]),w=n.useCallback(async M=>{const Q=await Ce.getInstance().getLPPoolStats(M);ee({...Q})},[l,a,x,u,E]),R=n.useCallback(async()=>{const M=await Ce.getInstance().getUserData(u);ae({...M})},[u]),K=n.useCallback(async()=>{const M=await Ce.getInstance().getUserData(x);W({...M})},[x]);n.useEffect(()=>{let M=new b(p.pushToken,y.pushToken,k),Q=new b(p.staking,y.staking,k),Te=new b(p.depYieldFarmPUSH,y.yieldFarming,k),j=new b(p.depYieldFarmLP,y.yieldFarming,k),m=new b(p.uniswapV2Router02,y.uniswapV2Router02,k);if(r(M),h(Q),v(Te),d(j),_(m),k&&s){var g=o.getSigner(s);let C=new b(p.pushToken,y.pushToken,g),S=new b(p.staking,y.staking,g),f=new b(p.depYieldFarmPUSH,y.yieldFarming,g),A=new b(p.depYieldFarmLP,y.yieldFarming,g),z=new b(p.uniswapV2Router02,y.uniswapV2Router02,g);r(C),h(S),v(f),d(A),_(z)}},[s]),n.useEffect(()=>{l!=null&&a!=null&&u!=null&&(Ce.getInstance().init(s,l,a,u,x,E),V())},[V]),n.useEffect(()=>{B&&we(B)},[B]);const we=async M=>{U(),w(M),R(),K()};return e.jsxs(e.Fragment,{children:[e.jsx(wt,{logo:"WarningCircle",title:"This reward program (V1) has ended.",body:"To continue earning rewards please migrate to new pools.",setActiveTab:t}),e.jsxs(Xt,{children:[e.jsx(ht,{poolName:"PUSH",userData:F,PoolStats:$,poolAddress:p.depYieldFarmPUSH,getUserData:R,getPoolStats:U,tokenAddress:p.pushToken,setActiveTab:t}),e.jsx(ht,{poolName:"UNI-V2",userData:Y,PoolStats:O,poolAddress:p.depYieldFarmLP,getUserData:K,getPoolStats:w,tokenAddress:p.uniV2LPToken,setActiveTab:t})]})]})},Xt=i(T)`
...
`,Ae=i(be)`
  ...
  border-radius: 5px;
  gap: 5px;
`,Rs=({setActiveTab:t})=>{const{provider:s,account:o,chainId:l}=ye(),[r,a]=n.useState(),[h,x]=n.useState(),[d,u]=n.useState(),[v,E]=n.useState(),[_,B]=n.useState(),[N,$]=n.useState(null),[G,O]=n.useState(null),[ee,F]=n.useState(null),[ae,Y]=n.useState(null),[W,k]=n.useState(null),V=s==null?void 0:s.getSigner(o),U=n.useCallback(async()=>{const M=await Re.getInstance().getPoolStats(s);$({...M})},[h,r,v,d,_,s]),w=n.useCallback(async()=>{const M=await Re.getInstance().getPoolStats(s),Q=await Re.getInstance().getLPPoolStats(M);O({...Q})},[h,r,v,d,_,s]),R=n.useCallback(async()=>{},[]),K=n.useCallback(async()=>{const M=await Re.getInstance().getUserDataLP();F({...M})},[h,r,v,d,_]),we=n.useCallback(async()=>{const[M,Q]=await Re.getInstance().getUserDataPUSH(s);k({...M}),Y({...Q})},[h,r,v,d,_,s]);return n.useEffect(()=>{if(l!==ge.coreContractChain&&l!==ge.mainnetCoreContractChain)return;O(null),F(null),k(null),Y(null);let M=new b(p.stakingV2,y.stakingV2,V),Q=new b(p.pushToken,y.pushToken,V),Te=new b(p.pushCoreV2,y.pushCoreV2,V),j=new b(p.yieldFarmLP,y.yieldFarming,V),m=new b(p.uniswapV2Router02,y.uniswapV2Router02,V);if(x(M),a(Q),E(Te),u(j),B(m),V&&o){var g=s==null?void 0:s.getSigner(o);let C=new b(p.stakingV2,y.stakingV2,g),S=new b(p.pushToken,y.pushToken,g),f=new b(p.pushCoreV2,y.pushCoreV2,g),A=new b(p.yieldFarmLP,y.yieldFarming,g),z=new b(p.uniswapV2Router02,y.uniswapV2Router02,g);x(C),a(S),E(f),u(A),B(z)}Re.getInstance().init(o,M,Q,Te,j,m),U(),K(),w(),we()},[o,l]),e.jsxs(e.Fragment,{children:[e.jsx(wt,{logo:"announcement",title:"New V2 Pools are now Live! Stake or migrate now.",body:"Users who were part of the previous Push staking program, need to migrate to new pools to continue earning rewards. Click",setActiveTab:t}),e.jsx(ts,{getLpPoolStats:w,poolStats:N,setPoolStats:$}),e.jsx(Zt,{poolStats:N}),e.jsxs(Fs,{children:[e.jsx(Ts,{userDataPush:ae,getUserDataPush:we,PUSHPoolstats:W,getPUSHPoolStats:R}),e.jsx(ls,{lpPoolStats:G,userDataLP:ee,getLpPoolStats:w,getUserDataLP:K})]})]})},Fs=i(T)`
  @media (max-width: 1300px) {
    flex-direction: column;
  }
...
`,Ds=i.div``;ge.coreContractChain;let yt,kt,Pt,rt,Et;yt=()=>{_s.pageview("/yield");const[t,s]=n.useState(0),[o,l]=n.useState(!1),{account:r,chainId:a,switchChain:h}=ye(),x=()=>{const E=ge.allowedNetworks[0];a!==1&&a!==5&&h(E)};n.useEffect(()=>{a!==1&&a!==11155111&&(u(),x())},[a]);const{isModalOpen:d,showModal:u,ModalComponent:v}=Je();return e.jsxs(kt,{children:[e.jsx(v,{InnerComponent:Us,onConfirm:()=>{},modalPadding:"0px",modalPosition:Ke.ON_PARENT}),e.jsxs(Pt,{children:[e.jsx(rt,{isActive:!t,onClick:()=>{l(!0),s(0)},children:"Yield Farming V2"}),e.jsxs(rt,{isActive:t,onClick:()=>{l(!1),s(1)},children:["Yield Farming V1 ",e.jsx(Et,{children:"Deprecated"})]})]}),t===0&&e.jsx(Rs,{setActiveTab:s}),t===1&&e.jsx(qt,{setActiveTab:s})]})},kt=i(He)`
	align-items: stretch;
	align-self: center;
  flex: 1;
	background: ${t=>t.theme.default.bg};
