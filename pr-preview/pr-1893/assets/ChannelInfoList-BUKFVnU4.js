import{cA as i,cD as Y,cv as t,cE as le,cx as q,cy as G,gn as Q,gd as p,gi as J,cq as pe,cM as xe,cs as l,gP as ce,gC as he,hs as ge,gQ as me,gZ as fe,ij as w,cH as h,cI as K,ig as X,ik as ue,gN as we,__tla as je}from"./index-BSRcNLz2.js";import{c as Ce,__tla as ye}from"./PushTokenContractHelper-CV5IRJ9c.js";import{E as be,__tla as ve}from"./EmptyNotificationSettings-D_Xj0dZV.js";import{T as j,__tla as ke}from"./Tag-DAVj-8mR.js";let ee,te,ie,ne,se,Le=Promise.all([(()=>{try{return je}catch{}})(),(()=>{try{return ye}catch{}})(),(()=>{try{return ve}catch{}})(),(()=>{try{return ke}catch{}})()]).then(async()=>{let C,y,b,v,k,L,M,_,g,H,m,T,S,$;ie=({text:e,onClick:o,isLoading:n,topMargin:s,loaderTitle:r})=>{const a=Y();return t.jsx(le,{theme:a,children:t.jsx(C,{style:{marginTop:s||"55px"},children:n?t.jsx(y,{children:t.jsx(q,{type:G.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:r??"",titleColor:"#fff"})}):t.jsx(Q,{onClick:o,variant:"primary",size:"large",children:e})})})},C=i.div`
  display: flex;
