import{cA as i,cD as N,cv as t,cE as le,cx as Y,cy as q,gr as Q,gi as p,gn as J,cq as pe,cQ as xe,cs as l,gT as ce,gG as he,hv as ge,gU as me,h0 as fe,ij as w,cH as h,cM as K,ig as X,ik as ue,gR as we,__tla as je}from"./index-DDMjHA4i.js";import{c as Ce,__tla as ye}from"./PushTokenContractHelper-Da41zpBK.js";import{E as be,__tla as ve}from"./EmptyNotificationSettings-Cg4ZA7zN.js";import{T as j,__tla as ke}from"./Tag-DW11dHO6.js";let ee,te,ie,ne,se,Le=Promise.all([(()=>{try{return je}catch{}})(),(()=>{try{return ye}catch{}})(),(()=>{try{return ve}catch{}})(),(()=>{try{return ke}catch{}})()]).then(async()=>{let C,y,b,v,k,L,M,_,g,T,m,H,S,$;ie=({text:e,onClick:o,isLoading:n,topMargin:s,loaderTitle:r})=>{const a=N();return t.jsx(le,{theme:a,children:t.jsx(C,{style:{marginTop:s||"55px"},children:n?t.jsx(y,{children:t.jsx(Y,{type:q.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:r??"",titleColor:"#fff"})}):t.jsx(Q,{onClick:o,variant:"primary",size:"large",children:e})})})},C=i.div`
  display: flex;
...
`,f=({options:e,item:o})=>{const[n,s]=l.useState(!1),r=l.useRef();return we(r,()=>s(!1)),t.jsxs("div",{children:[t.jsx(O,{onClick:()=>s(!0)}),n&&t.jsx(D,{onMouseLeave:()=>s(!1),ref:r,children:e.map(({icon:a,onClick:d,text:x},c)=>t.jsxs(B,{onClick:()=>d(o),index:c,children:[a,t.jsx(Z,{children:x})]},c))})]})},O=i(ue)`
...
`,Z=i.span`
  margin-left: 8px;
`,se=e=>{const o=(n,s)=>n.toLowerCase()===s.toLowerCase();return t.jsx(I,{style:e.style,isLoading:e.isLoading,children:t.jsx(h,{flex:"5",justify:"flex-start",align:"stretch",children:e.isLoading?t.jsx(W,{children:t.jsx(Y,{type:q.SEAMLESS})}):t.jsxs(t.Fragment,{children:[e.items&&e.items.length>0&&e.items.map(n=>{var s,r;return t.jsxs("div",{children:[t.jsx(U,{}),t.jsxs(h,{direction:"row",justify:"space-between",padding:"9.5px 0px",children:[t.jsxs(h,{direction:"row",justify:"flex-start",margin:"0px 0px 0px -15px",children:[e.isAddress?t.jsx(G,{children:t.jsx(z,{delegateAddress:n,maxWidth:"200px"})}):t.jsxs(t.Fragment,{children:[t.jsx(R,{children:n.description}),n.type===2&&t.jsx(j,{children:"Range"}),n.type===3&&t.jsx(j,{children:"Multi-Range"})]}),e.isAddress&&o(e.account,n)&&t.jsx(j,{children:"Creator"})]}),e.isAddress===!0&&((s=e.addressDropdownOptions)==null?void 0:s.length)>0&&!o(e.account,n)&&t.jsx(f,{options:e.addressDropdownOptions,item:n}),e.isAddress===!1&&((r=e.settingsDropdownOptions)==null?void 0:r.length)>0&&t.jsx(f,{options:e.settingsDropdownOptions,item:n})]})]},e.isAddress?n:n.description||n.index)}),e.items&&e.items.length===0&&e.isAddress===!1&&t.jsx(be,{title:"No settings added",description:"Add settings for users to customize their notification preferences.",onClick:e.onClickEmptyListButton,buttonTitle:e.emptyListButtonTitle})]})})})},I=i.div`
