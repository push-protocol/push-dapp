import{cA as s,gg as t,gh as l,gi as D,gk as u,gt as h,cq as m,gu as T,cO as a,cv as e,gv as N,cF as L,cQ as A,cB as f,__tla as g}from"./index-DDMjHA4i.js";import{S as $,__tla as x}from"./SendNotifications-Dmq8uv_O.js";import{__tla as O}from"./index-bUkjgxte.js";import{__tla as p}from"./Tag-DW11dHO6.js";import{__tla as R}from"./TransitionGroupContext-keMd0rhG.js";let _,G=Promise.all([(()=>{try{return g}catch{}})(),(()=>{try{return x}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return p}catch{}})(),(()=>{try{return R}catch{}})()]).then(async()=>{A.coreContractChain;function M(){u.pageview("/send_notificaiton"),h(),m(),T(n=>n.contracts),T(n=>n.admin),A.coreContractChain;const[r,J]=a.useState(2),[d,y]=a.useState(!0);a.useState(null),a.useState(null);const[o,j]=a.useState(!0);a.useState([]);const[E,I]=a.useState(null),U=()=>I(null);return a.useEffect(()=>{E&&U()},[E]),e.jsx(i,{children:r===2&&d?e.jsxs(e.Fragment,{children:[!o&&e.jsx(N,{replace:!0,to:"/dashboard"}),o&&e.jsx($,{})]}):e.jsx(c,{children:"Channel details are being loaded, please wait\u2026"})})}let i,c,S;i=s(L)`
  align-items: center;
  align-self: center;
