import{cA as d,cY as O,h3 as re,cs as f,h4 as ae,cv as t,cq as J,gu as K,gt as Q,cQ as R,h5 as ie,h6 as X,cD as Z,gn as v,h7 as le,h8 as ce,h9 as de,cZ as he,gr as ge,cx as ee,cy as te,ha as k,hb as pe,hc as ne,hd as E,gG as se,he as xe,hf as ue,hg as fe,__tla as we}from"./index-DDMjHA4i.js";import{u as Se,n as me}from"./notifSetting-DrLKauYy.js";let I,oe,je=Promise.all([(()=>{try{return we}catch{}})()]).then(async()=>{let P,_,$,B,W,V,H,U,z,F,N,Y,q,A,G;I=({children:n,renderDropdownContainer:h,showDropdown:a,toggleDropdown:g,closeDropdown:s,containerPadding:x,centerOnMobile:i})=>{const c=f.useRef(null),l=f.useRef(null);return ae(c,l,s),t.jsxs(P,{ref:c,onClick:g,children:[n,a&&t.jsx(_,{containerPadding:x,centerOnMobile:i,children:t.jsx("div",{ref:l,onClick:e=>e.stopPropagation(),children:h})})]})},P=d.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
