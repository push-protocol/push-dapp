...
`,Ae=i(be)`
  ...
  border-radius: 5px;
  gap: 5px;
`,Rs=({setActiveTab:t})=>{const{provider:s,account:o,chainId:l}=ye(),[r,a]=n.useState(),[h,x]=n.useState(),[c,u]=n.useState(),[v,E]=n.useState(),[_,B]=n.useState(),[N,$]=n.useState(null),[G,O]=n.useState(null),[ee,F]=n.useState(null),[ae,Y]=n.useState(null),[W,k]=n.useState(null),V=s==null?void 0:s.getSigner(o),M=n.useCallback(async()=>{const U=await Re.getInstance().getPoolStats(s);$({...U})},[h,r,v,c,_,s]),w=n.useCallback(async()=>{const U=await Re.getInstance().getPoolStats(s),Q=await Re.getInstance().getLPPoolStats(U);O({...Q})},[h,r,v,c,_,s]),R=n.useCallback(async()=>{},[]),J=n.useCallback(async()=>{const U=await Re.getInstance().getUserDataLP();F({...U})},[h,r,v,c,_]),we=n.useCallback(async()=>{const[U,Q]=await Re.getInstance().getUserDataPUSH(s);k({...U}),Y({...Q})},[h,r,v,c,_,s]);return n.useEffect(()=>{if(l!==ge.coreContractChain&&l!==ge.mainnetCoreContractChain)return;O(null),F(null),k(null),Y(null);let U=new b(p.stakingV2,y.stakingV2,V),Q=new b(p.pushToken,y.pushToken,V),Te=new b(p.pushCoreV2,y.pushCoreV2,V),j=new b(p.yieldFarmLP,y.yieldFarming,V),m=new b(p.uniswapV2Router02,y.uniswapV2Router02,V);if(x(U),a(Q),E(Te),u(j),B(m),V&&o){var g=s==null?void 0:s.getSigner(o);let C=new b(p.stakingV2,y.stakingV2,g),S=new b(p.pushToken,y.pushToken,g),f=new b(p.pushCoreV2,y.pushCoreV2,g),A=new b(p.yieldFarmLP,y.yieldFarming,g),z=new b(p.uniswapV2Router02,y.uniswapV2Router02,g);x(C),a(S),E(f),u(A),B(z)}Re.getInstance().init(o,U,Q,Te,j,m),M(),J(),w(),we()},[o,l]),e.jsxs(e.Fragment,{children:[e.jsx(wt,{logo:"announcement",title:"New V2 Pools are now Live! Stake or migrate now.",body:"Users who were part of the previous Push staking program, need to migrate to new pools to continue earning rewards. Click",setActiveTab:t}),e.jsx(ts,{getLpPoolStats:w,poolStats:N,setPoolStats:$}),e.jsx(Zt,{poolStats:N}),e.jsxs(Fs,{children:[e.jsx(Ts,{userDataPush:ae,getUserDataPush:we,PUSHPoolstats:W,getPUSHPoolStats:R}),e.jsx(ls,{lpPoolStats:G,userDataLP:ee,getLpPoolStats:w,getUserDataLP:J})]})]})},Fs=i(T)`
  @media (max-width: 1300px) {
    flex-direction: column;
  }
...
`,Ds=i.div``;ge.coreContractChain;let yt,kt,Pt,rt,Et;yt=()=>{_s.pageview("/yield");const[t,s]=n.useState(0),[o,l]=n.useState(!1),{account:r,chainId:a,switchChain:h}=ye(),x=()=>{const E=ge.allowedNetworks[0];a!==1&&a!==5&&h(E)};n.useEffect(()=>{a!==1&&a!==11155111&&(u(),x())},[a]);const{isModalOpen:c,showModal:u,ModalComponent:v}=Ke();return e.jsxs(kt,{children:[e.jsx(v,{InnerComponent:Ms,onConfirm:()=>{},modalPadding:"0px",modalPosition:Je.ON_PARENT}),e.jsxs(Pt,{children:[e.jsx(rt,{isActive:!t,onClick:()=>{l(!0),s(0)},children:"Yield Farming V2"}),e.jsxs(rt,{isActive:t,onClick:()=>{l(!1),s(1)},children:["Yield Farming V1 ",e.jsx(Et,{children:"Deprecated"})]})]}),t===0&&e.jsx(Rs,{setActiveTab:s}),t===1&&e.jsx(qt,{setActiveTab:s})]})},kt=i(He)`
	align-items: stretch;
	align-self: center;
  flex: 1;
	background: ${t=>t.theme.default.bg};
...
`,Et=i(me)`
  ...
  height: 17px;
  width: fit-content;
`,zt=()=>e.jsx(Js,{children:e.jsx(yt,{})})});export{Xs as __tla,zt as default};
