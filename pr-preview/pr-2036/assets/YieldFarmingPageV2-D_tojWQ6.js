...
`;he.coreContractChain;const Qt=({setActiveTab:t})=>{const{account:s,provider:i}=ke(),[p,n]=r.useState(null),[o,h]=r.useState(null),[x,d]=r.useState(null),[u,v]=r.useState(null),[E,W]=r.useState(null),[B,L]=r.useState(null),[V,G]=r.useState(null),[O,q]=r.useState(null),[M,ae]=r.useState(null),[Y,H]=r.useState(null),P=i==null?void 0:i.getSigner(s),$=r.useCallback(async()=>{const F=await Ce.getInstance().getPoolStats();L({...F})},[p,o,x,u,E]),U=r.useCallback(async()=>{const F=await Ce.getInstance().getPUSHPoolStats();G({...F})},[p,o,x,u,E]),w=r.useCallback(async F=>{const Z=await Ce.getInstance().getLPPoolStats(F);q({...Z})},[p,o,x,u,E]),R=r.useCallback(async()=>{const F=await Ce.getInstance().getUserData(u);ae({...F})},[u]),J=r.useCallback(async()=>{const F=await Ce.getInstance().getUserData(x);H({...F})},[x]);r.useEffect(()=>{let F=new b(l.pushToken,k.pushToken,P),Z=new b(l.staking,k.staking,P),we=new b(l.depYieldFarmPUSH,k.yieldFarming,P),S=new b(l.depYieldFarmLP,k.yieldFarming,P),m=new b(l.uniswapV2Router02,k.uniswapV2Router02,P);if(n(F),h(Z),v(we),d(S),W(m),P&&s){var g=i.getSigner(s);let C=new b(l.pushToken,k.pushToken,g),j=new b(l.staking,k.staking,g),f=new b(l.depYieldFarmPUSH,k.yieldFarming,g),A=new b(l.depYieldFarmLP,k.yieldFarming,g),z=new b(l.uniswapV2Router02,k.uniswapV2Router02,g);n(C),h(j),v(f),d(A),W(z)}},[s]),r.useEffect(()=>{p!=null&&o!=null&&u!=null&&(Ce.getInstance().init(s,p,o,u,x,E),$())},[$]),r.useEffect(()=>{B&&me(B)},[B]);const me=async F=>{U(),w(F),R(),J()};return e.jsxs(e.Fragment,{children:[e.jsx(pt,{logo:"WarningCircle",title:"This reward program (V1) has ended.",body:"To continue earning rewards please migrate to new pools.",setActiveTab:t}),e.jsxs(Xt,{children:[e.jsx(ot,{poolName:"PUSH",userData:M,PoolStats:V,poolAddress:l.depYieldFarmPUSH,getUserData:R,getPoolStats:U,tokenAddress:l.pushToken,setActiveTab:t}),e.jsx(ot,{poolName:"UNI-V2",userData:Y,PoolStats:O,poolAddress:l.depYieldFarmLP,getUserData:J,getPoolStats:w,tokenAddress:l.uniV2LPToken,setActiveTab:t})]})]})},Xt=a(T)`
...
`,Ae=a(be)`
  ...
  border-radius: 5px;
  gap: 5px;
`,ys=({setActiveTab:t})=>{const{provider:s,account:i,chainId:p}=ke(),[n,o]=r.useState(),[h,x]=r.useState(),[d,u]=r.useState(),[v,E]=r.useState(),[W,B]=r.useState(),[L,V]=r.useState(null),[G,O]=r.useState(null),[q,M]=r.useState(null),[ae,Y]=r.useState(null),[H,P]=r.useState(null),$=s==null?void 0:s.getSigner(i),U=r.useCallback(async()=>{const F=await Re.getInstance().getPoolStats(s);V({...F})},[h,n,v,d,W,s]),w=r.useCallback(async()=>{const F=await Re.getInstance().getPoolStats(s),Z=await Re.getInstance().getLPPoolStats(F);O({...Z})},[h,n,v,d,W,s]),R=r.useCallback(async()=>{},[]),J=r.useCallback(async()=>{const F=await Re.getInstance().getUserDataLP();M({...F})},[h,n,v,d,W]),me=r.useCallback(async()=>{const[F,Z]=await Re.getInstance().getUserDataPUSH(s);P({...F}),Y({...Z})},[h,n,v,d,W,s]);return r.useEffect(()=>{if(p!==he.coreContractChain&&p!==he.mainnetCoreContractChain)return;O(null),M(null),P(null),Y(null);let F=new b(l.stakingV2,k.stakingV2,$),Z=new b(l.pushToken,k.pushToken,$),we=new b(l.pushCoreV2,k.pushCoreV2,$),S=new b(l.yieldFarmLP,k.yieldFarming,$),m=new b(l.uniswapV2Router02,k.uniswapV2Router02,$);if(x(F),o(Z),E(we),u(S),B(m),$&&i){var g=s==null?void 0:s.getSigner(i);let C=new b(l.stakingV2,k.stakingV2,g),j=new b(l.pushToken,k.pushToken,g),f=new b(l.pushCoreV2,k.pushCoreV2,g),A=new b(l.yieldFarmLP,k.yieldFarming,g),z=new b(l.uniswapV2Router02,k.uniswapV2Router02,g);x(C),o(j),E(f),u(A),B(z)}Re.getInstance().init(i,F,Z,we,S,m),U(),J(),w(),me()},[i,p]),e.jsxs(e.Fragment,{children:[e.jsx(pt,{logo:"announcement",title:"Staking Program has now ended.",body:"Note: While UNI-V2 LP staking pool has ended, the Push Fee Staking Pool is designed to continue its staking mechanism. However, rewards for stakers will solely come from Core smart contract fee earnings.",setActiveTab:t}),e.jsx(ts,{getLpPoolStats:w,poolStats:L,setPoolStats:V}),e.jsx(Zt,{poolStats:L}),e.jsxs(Es,{children:[e.jsx(Ts,{userDataPush:ae,getUserDataPush:me,PUSHPoolstats:H,getPUSHPoolStats:R}),e.jsx(ls,{lpPoolStats:G,userDataLP:q,getLpPoolStats:w,getUserDataLP:J})]})]})},Es=a(T)`
  @media (max-width: 1300px) {
    flex-direction: column;
  }
