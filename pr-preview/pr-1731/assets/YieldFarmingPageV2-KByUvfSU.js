...
`,$n=({userDataPush:n,getUserDataPush:t,PUSHPoolstats:a,getPUSHPoolStats:o})=>{const{account:s,provider:i}=ke(),[r,l]=u.useState(!1),[d,h]=u.useState(!1),[m,x]=u.useState(null),[M,N]=u.useState(null),[U,I]=u.useState(0),[F,Q]=u.useState(0),[se,J]=u.useState(0),[te,V]=u.useState(""),L=Be(),f=Ve(),v=async C=>{var k=i.getSigner(s);let _=new P(c.pushToken,A.pushToken,k);if(await _.holderDelegation(s,C.address))return!0;try{L.showLoaderToast({loaderMessage:"Delegating! Please wait.."});const q=await _.setHolderDelegation(C.address,"true");return await i.waitForTransaction(q.hash),L.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed! Address Delegated",toastType:"SUCCESS",getToastIcon:oe=>e.jsx(he,{size:oe,color:"green"})}),!0}catch(q){return console.error("Error in delegating",q),L.showMessageToast({toastTitle:"Error",toastMessage:`Transaction failed! ${q.reason}`,toastType:"ERROR",getToastIcon:oe=>e.jsx(H,{size:oe,color:"red"})}),l(!1),!1}},T=async C=>{const k=(await C.userFeesInfo(s)).lastClaimedBlock;if(k.toNumber()!==0){const _=await C.genesisEpoch(),q=await C.epochDuration();return(k-_)/q}},E=async()=>{if(d)return;if(h(!0),(n==null?void 0:n.availableRewards)==0){N("No Rewards to Claim"),h(!1);return}var C=i.getSigner(s);let k=new P(c.pushCoreV2,A.pushCoreV2,C);const _=a==null?void 0:a.currentEpochNumber,q=14;if(!await v(k))return;let oe=1;oe=await T(k),w(),h(!1);let W=0;_-oe<q,W=Math.ceil((_-oe)/q),Q(W),W!=0&&(await ee(W,oe,k,q),t(),J(2),I(0))},ee=async(C,k,_,q)=>{const oe=a==null?void 0:a.currentEpochNumber;let W=0;for(let de=0;de<C;de++){let pe=k;k+=q;let ye=Math.min(k,oe-1);V(`Claiming the rewards from Epoch ${pe} to ${ye} `),await _.harvestPaginated(ye,{gasLimit:91e4}).then(async ae=>{try{L.showLoaderToast({loaderMessage:"Waiting for confirmation"}),await i.waitForTransaction(ae.hash),L.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:re=>e.jsx(he,{size:re,color:"green"})}),W++,I(W)}catch{console.error("Error in the transaction",ae);return}}).catch(ae=>{throw console.error("Error in claiming the reward",ae),L.showMessageToast({toastTitle:"Error",toastMessage:`Transaction failed! ${ae.reason}`,toastType:"ERROR",getToastIcon:re=>e.jsx(H,{size:re,color:"red"})}),V(""),l(!1),t(),J(1),I(0),ae})}},Y=async()=>{if(r)return;if(l(!0),G(n==null?void 0:n.userStaked)==0){x("Nothing to unstake, You need to stake first"),l(!1);return}var C=i.getSigner(s);let k=new P(c.pushCoreV2,A.pushCoreV2,C);const _=await v(k);if(h(!1),!_)return;const q=a==null?void 0:a.currentEpochNumber,oe=14;let W=0;if(W=await T(k),W>=q-1){l(!1),x("PUSH cannot be unstaked until current epoch is over."),L.showMessageToast({toastTitle:"Unstaking Error",toastMessage:"You cannot unstake until Current Epoch gets over.",toastType:"ERROR",getToastIcon:pe=>e.jsx(H,{size:pe,color:"red"})});return}w();const de=Math.ceil((q-W)/oe);Q(de),de>1&&await ee(de-1,W,k,oe),V("Unstaking Your Push Tokens. Please wait..."),k.unstake().then(async pe=>{L.showLoaderToast({loaderMessage:"Unstaking! Waiting for Confirmation..."});try{await i.waitForTransaction(pe.hash),L.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:ye=>e.jsx(he,{size:ye,color:"green"})}),o(),t(),l(!1),J(2),I(0)}catch(ye){console.error("Error",ye),L.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${ye.name}+ ")`,toastType:"ERROR",getToastIcon:ae=>e.jsx(H,{size:ae,color:"red"})}),V(""),l(!1)}}).catch(pe=>{console.error("Error: ",pe);const ye=pe.reason.includes("PushCoreV2::unstake:"),ae=pe.reason.includes("PushCoreV2::harvestPaginated:");if(ye||ae)x("PUSH cannot be unstaked until current epoch is over.");else{let re=pe.reason.slice(pe.reason.indexOf("::")+1);re=re.replace("unstake:",""),L.showMessageToast({toastTitle:"Error",toastMessage:`${re}`,toastType:"ERROR",getToastIcon:Le=>e.jsx(H,{size:Le,color:"red"})})}l(!1),t(),J(1),I(0)})};u.useEffect(()=>{N(null),x(null)},[s]);const{isModalOpen:we,showModal:z,ModalComponent:ne}=tt(),O=Be(),S=ve(600),{isModalOpen:b,showModal:w,ModalComponent:B}=tt();return e.jsxs(Jn,{children:[e.jsx(ne,{InnerComponent:Rt,InnerComponentProps:{title:"PUSH",getUserData:t,getPoolStats:o,setUnstakeErrorMessage:x,setWithdrawErrorMessage:N},toastObject:O,modalPosition:nt.ON_PARENT}),e.jsx(B,{InnerComponent:_n,InnerComponentProps:{currentTransactionNo:U,totalTransactionNo:F,transactionSteps:se,transactionText:te,setCurrentTransactionNo:I,setTotalTransactionNo:Q,setTransactionSteps:J,claimRewards:E,unstakeTokensPaginated:Y},onConfirm:()=>{},modalPadding:"0px",modalPosition:nt.ON_ROOT}),e.jsx(R,{margin:"0px 0px 20px 0px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(Yn,{children:"PUSH Fee Staking Pool"}),e.jsxs(qn,{children:["Current APR",e.jsxs(Te,{color:"#D53A94",fontWeight:"600",margin:"0 5px 0 5px",children:[">",Z(a==null?void 0:a.stakingAPR),"% + Fee"]}),e.jsx(Hn,{})]})]}):e.jsxs(De,{padding:"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:"234px",margin:"0 0 10px 0"}),e.jsx(g,{height:"12px",width:"112px"})]})}),e.jsxs(R,{flex:"5",children:[e.jsxs(Kn,{border:`1px solid ${f.stakingBorder}`,borderRadius:"16px",children:[e.jsx(R,{margin:S?"0px 6px 0 0 ":"0px 18px 0px 0px",padding:S?" 7px":"10px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(It,{children:"Current Reward"}),e.jsxs($,{fontSize:S?"18px":"24px",fontWeight:"600",color:"#D53A94",letterSpacing:"normal",children:[Z(G(a==null?void 0:a.currentReward))," PUSH"]})]}):e.jsxs(De,{padding:S?"0px":"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:S?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(g,{height:"12px",width:S?"65px":"100px}"})]})}),e.jsx(Zn,{width:"10px",height:"100%"}),e.jsx(R,{margin:S?"0 0 0 6px":"0 0 0 18px",padding:S?" 7px":"10px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(It,{children:"Total Staked"}),e.jsxs(Xn,{fontSize:S?"18px":"24px",fontWeight:"600",letterSpacing:"normal",children:[Z(G(a==null?void 0:a.totalStakedAmount))," PUSH"]})]}):e.jsxs(De,{padding:S?"0px":"5px 15px 0 15px",children:[e.jsx(g,{height:"12px",width:S?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(g,{height:"12px",width:S?"65px":"100px}"})]})})]}),e.jsx(j,{alignSelf:"end",margin:"12px 13px 24px 0px",color:"#575D73",letterSpacing:"normal",children:a?e.jsxs(e.Fragment,{children:[e.jsx(Nt,{children:"Current Epoch"}),e.jsx(Nt,{children:a==null?void 0:a.currentEpochNumber})]}):e.jsx(De,{padding:"5px 0px 0 15px",children:e.jsx(g,{height:"12px",width:"124px"})})}),n?e.jsxs(R,{children:[e.jsxs(j,{justifyContent:"space-between",margin:S?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ke,{children:["User Deposit",e.jsx(Ze,{children:e.jsx(K,{ToolTipTitle:"User Deposited",ToolTipBody:"Amount of PUSH Token User Staked",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Xe,{children:[" ",Z(G(n==null?void 0:n.userStaked))," PUSH"]})]}),e.jsxs(j,{justifyContent:"space-between",margin:S?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ke,{children:["Rewards Claimed",e.jsx(Ze,{children:e.jsx(K,{ToolTipTitle:"Rewards Claimed",ToolTipBody:"Amount of Push Claimed by User",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Xe,{children:[" ",Z((n==null?void 0:n.claimedReward).toFixed(2))," PUSH"]})]}),e.jsxs(j,{justifyContent:"space-between",margin:S?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ke,{children:["Current Epoch Reward",e.jsx(Ze,{children:e.jsx(K,{ToolTipTitle:"Current Epoch Reward",ToolTipBody:"Displays the approximate latest reward amount for current epoch",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Xe,{children:[" ",Z((n==null?void 0:n.potentialReward).toFixed(2))," PUSH"]})]}),e.jsxs(j,{justifyContent:"space-between",margin:S?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ke,{children:["Available for Claiming",e.jsx(Ze,{children:e.jsx(K,{ToolTipTitle:"Available for Claiming",ToolTipBody:"Amount of Push Token Available to claim",children:e.jsx(le,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Xe,{children:[" ",Z((n==null?void 0:n.availableRewards).toFixed(2))," PUSH"]})]})]}):e.jsxs(Ce,{padding:"0 15px 15px 15px",width:"100%",maxWidth:" -webkit-fill-available",borderRadius:"5px",children:[e.jsxs(j,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(j,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(j,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]}),e.jsxs(j,{justifyContent:"space-between",children:[e.jsx(g,{height:"12px",width:"164px"}),e.jsx(g,{height:"12px",width:"72px"})]})]})]}),e.jsx(R,{padding:S?"0px ":"0px 14px",margin:"24px 0px 24px 0px",children:n?e.jsxs(e.Fragment,{children:[e.jsx(j,{children:e.jsx(ea,{onClick:z,children:" Stake $PUSH"})}),e.jsxs(Qn,{children:[(a==null?void 0:a.currentEpochNumber)<=2?e.jsx(Ut,{ToolTipTitle:"You can unstake once epoch 2 ends.",ButtonTitle:"Unstake PUSH"}):G(n==null?void 0:n.userStaked)==0||m!==null?e.jsx(Ut,{ToolTipTitle:m||"Nothing to unstake, Stake First",ButtonTitle:"Unstake PUSH"}):e.jsx(Qe,{border:`1px solid ${f.activeButtonText}`,background:"transparent",color:f.activeButtonText,cursor:"pointer",onClick:Y,style:{margin:"0px 10px 0px 0px"},children:r?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:f.activeButtonText,title:"Unstaking",titleColor:f.activeButtonText}):"Unstake $PUSH"}),(n==null?void 0:n.availableRewards)===0?e.jsx(K,{bottom:"-30px",ToolTipTitle:"No Rewards to Claim",error:!0,left:"40px",ToolTipWidth:"10rem",children:e.jsx(Qe,{border:"none",background:f.disableButtonBg,cursor:"default",color:f.disabledButtonText,children:d?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:"#D53A94"}):"Claim Rewards"})}):e.jsx(Qe,{border:`1px solid ${f.activeButtonText}`,background:"transparent",color:f.activeButtonText,cursor:"pointer",onClick:E,children:d?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:f.activeButtonText,title:"Claiming",titleColor:f.activeButtonText}):"Claim Rewards"})]})]}):e.jsxs(De,{width:"100%",children:[e.jsx(g,{height:"49px",width:"100%",margin:"0 0 8px 0"}),e.jsx(g,{height:"49px",width:"100%"})]})})]})},Ut=n=>{const t=Ve();return e.jsx(K,{error:!0,ToolTipTitle:n.ToolTipTitle,ToolTipWidth:"16rem",margin:"0 10px 0 0",bottom:"-30px",children:e.jsx(Qe,{border:"none",background:t.disableButtonBg,cursor:"default",color:t.disabledButtonText,children:n.ButtonTitle})})},Hn=()=>{const[n,t]=u.useState(!1),a=()=>t(!1),o=u.useRef(null);return Wt(o,()=>a()),e.jsxs(Wn,{ref:o,children:[e.jsx(le,{onClick:()=>t(!n),src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}}),n&&e.jsx(Gn,{id:"channel",children:e.jsx(Tt,{title:"",body:"Push Fee Pool APR distributes yield farming rewards + fee earned by protocol. More Info "})})]})},Wn=p.div`
  width: 34%;
  width: 100%;
  min-width: none;
  max-width: none;
...
`,Bt=p(Te)`
  ...
  height: 17px;
  width: fit-content;
`,qt=()=>e.jsx(Vt,{children:e.jsx(Dt,{})}),Vt=p(ze)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
