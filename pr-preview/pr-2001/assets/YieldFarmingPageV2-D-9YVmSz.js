...
`;ge.coreContractChain;const Qt=({setActiveTab:t})=>{const{account:s,provider:o}=ke(),[l,r]=n.useState(null),[a,h]=n.useState(null),[x,d]=n.useState(null),[u,v]=n.useState(null),[E,_]=n.useState(null),[B,N]=n.useState(null),[V,G]=n.useState(null),[O,ee]=n.useState(null),[F,ae]=n.useState(null),[Y,H]=n.useState(null),P=o==null?void 0:o.getSigner(s),$=n.useCallback(async()=>{const U=await be.getInstance().getPoolStats();N({...U})},[l,a,x,u,E]),M=n.useCallback(async()=>{const U=await be.getInstance().getPUSHPoolStats();G({...U})},[l,a,x,u,E]),w=n.useCallback(async U=>{const Z=await be.getInstance().getLPPoolStats(U);ee({...Z})},[l,a,x,u,E]),R=n.useCallback(async()=>{const U=await be.getInstance().getUserData(u);ae({...U})},[u]),K=n.useCallback(async()=>{const U=await be.getInstance().getUserData(x);H({...U})},[x]);n.useEffect(()=>{let U=new C(p.pushToken,k.pushToken,P),Z=new C(p.staking,k.staking,P),Te=new C(p.depYieldFarmPUSH,k.yieldFarming,P),S=new C(p.depYieldFarmLP,k.yieldFarming,P),m=new C(p.uniswapV2Router02,k.uniswapV2Router02,P);if(r(U),h(Z),v(Te),d(S),_(m),P&&s){var g=o.getSigner(s);let b=new C(p.pushToken,k.pushToken,g),j=new C(p.staking,k.staking,g),f=new C(p.depYieldFarmPUSH,k.yieldFarming,g),A=new C(p.depYieldFarmLP,k.yieldFarming,g),z=new C(p.uniswapV2Router02,k.uniswapV2Router02,g);r(b),h(j),v(f),d(A),_(z)}},[s]),n.useEffect(()=>{l!=null&&a!=null&&u!=null&&(be.getInstance().init(s,l,a,u,x,E),$())},[$]),n.useEffect(()=>{B&&we(B)},[B]);const we=async U=>{M(),w(U),R(),K()};return e.jsxs(e.Fragment,{children:[e.jsx(Tt,{logo:"WarningCircle",title:"This reward program (V1) has ended.",body:"To continue earning rewards please migrate to new pools.",setActiveTab:t}),e.jsxs(Xt,{children:[e.jsx(gt,{poolName:"PUSH",userData:F,PoolStats:V,poolAddress:p.depYieldFarmPUSH,getUserData:R,getPoolStats:M,tokenAddress:p.pushToken,setActiveTab:t}),e.jsx(gt,{poolName:"UNI-V2",userData:Y,PoolStats:O,poolAddress:p.depYieldFarmLP,getUserData:K,getPoolStats:w,tokenAddress:p.uniV2LPToken,setActiveTab:t})]})]})},Xt=i(T)`
...
`,Zt=({poolStats:t})=>{function s(l){return l==null?void 0:l.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",")}const o=Ee(600);return e.jsx(es,{justifyContent:"stretch",children:t?e.jsxs(e.Fragment,{children:[e.jsx(ft,{fontSize:o?"16px":"18px",textAlign:"left",fontWeight:600,children:"Push Price"}),e.jsxs(T,{gap:"5px",justifyContent:"flex-end",children:[e.jsxs(ft,{fontSize:o?"18px ":"24px",textAlign:"left",fontWeight:600,children:["$",s(t==null?void 0:t.pushPrice.toFixed(2))]}),e.jsx(oe,{width:"25px",height:o?"20px":"27px",src:Ft("svg/uniswapLogo.svg"),alt:"Uniswap Logo"})]})]}):e.jsxs(ts,{children:[e.jsx(c,{height:"12px",width:"135px",margin:"10px 0 10px 0"}),e.jsx(c,{height:"12px",width:"135px",margin:"10px 0 10px 0"})]})})},es=i(T)`
  flex-direction: row;
...
`,Ae=i(Ce)`
  ...
  border-radius: 5px;
  gap: 5px;
`,Fs=({setActiveTab:t})=>{const{provider:s,account:o,chainId:l}=ke(),[r,a]=n.useState(),[h,x]=n.useState(),[d,u]=n.useState(),[v,E]=n.useState(),[_,B]=n.useState(),[N,V]=n.useState(null),[G,O]=n.useState(null),[ee,F]=n.useState(null),[ae,Y]=n.useState(null),[H,P]=n.useState(null),$=s==null?void 0:s.getSigner(o),M=n.useCallback(async()=>{const U=await Re.getInstance().getPoolStats(s);V({...U})},[h,r,v,d,_,s]),w=n.useCallback(async()=>{const U=await Re.getInstance().getPoolStats(s),Z=await Re.getInstance().getLPPoolStats(U);O({...Z})},[h,r,v,d,_,s]),R=n.useCallback(async()=>{},[]),K=n.useCallback(async()=>{const U=await Re.getInstance().getUserDataLP();F({...U})},[h,r,v,d,_]),we=n.useCallback(async()=>{const[U,Z]=await Re.getInstance().getUserDataPUSH(s);P({...U}),Y({...Z})},[h,r,v,d,_,s]);return n.useEffect(()=>{if(l!==ge.coreContractChain&&l!==ge.mainnetCoreContractChain)return;O(null),F(null),P(null),Y(null);let U=new C(p.stakingV2,k.stakingV2,$),Z=new C(p.pushToken,k.pushToken,$),Te=new C(p.pushCoreV2,k.pushCoreV2,$),S=new C(p.yieldFarmLP,k.yieldFarming,$),m=new C(p.uniswapV2Router02,k.uniswapV2Router02,$);if(x(U),a(Z),E(Te),u(S),B(m),$&&o){var g=s==null?void 0:s.getSigner(o);let b=new C(p.stakingV2,k.stakingV2,g),j=new C(p.pushToken,k.pushToken,g),f=new C(p.pushCoreV2,k.pushCoreV2,g),A=new C(p.yieldFarmLP,k.yieldFarming,g),z=new C(p.uniswapV2Router02,k.uniswapV2Router02,g);x(b),a(j),E(f),u(A),B(z)}Re.getInstance().init(o,U,Z,Te,S,m),M(),K(),w(),we()},[o,l]),e.jsxs(e.Fragment,{children:[e.jsx(Tt,{logo:"announcement",title:"New V2 Pools are now Live! Stake or migrate now.",body:"Users who were part of the previous Push staking program, need to migrate to new pools to continue earning rewards. Click",setActiveTab:t}),e.jsx(ss,{getLpPoolStats:w,poolStats:N,setPoolStats:V}),e.jsx(Zt,{poolStats:N}),e.jsxs(Ms,{children:[e.jsx(fs,{userDataPush:ae,getUserDataPush:we,PUSHPoolstats:H,getPUSHPoolStats:R}),e.jsx(ps,{lpPoolStats:G,userDataLP:ee,getLpPoolStats:w,getUserDataLP:K})]})]})},Ms=i(T)`
  @media (max-width: 1300px) {
    flex-direction: column;
  }
