import{e6 as i,e9 as G,e1 as t,ea as le,e3 as N,e4 as q,eY as J,eO as p,eT as K,dY as pe,ei as xe,d_ as l,fp as ce,f4 as he,gE as ge,fq as me,fz as fe,gF as w,ed as h,ee as Q,gx as X,gG as ue,fn as we,__tla as je}from"./index-CWATc5SK.js";import{b as Ce,__tla as ye}from"./PushTokenContractHelper-D9lx5T4P.js";import{E as be,__tla as ve}from"./EmptyNotificationSettings-CnDxLphH.js";import{T as j,__tla as ke}from"./Tag-C3Cn8tyK.js";let ee,te,ie,ne,oe,Le=Promise.all([(()=>{try{return je}catch{}})(),(()=>{try{return ye}catch{}})(),(()=>{try{return ve}catch{}})(),(()=>{try{return ke}catch{}})()]).then(async()=>{let C,y,b,v,k,L,M,_,g,T,m,H,S,$;ie=({text:e,onClick:s,isLoading:n,topMargin:o,loaderTitle:r})=>{const a=G();return t.jsx(le,{theme:a,children:t.jsx(C,{style:{marginTop:o||"55px"},children:n?t.jsx(y,{children:t.jsx(N,{type:q.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:r??"",titleColor:"#fff"})}):t.jsx(J,{onClick:s,variant:"primary",size:"large",children:e})})})},C=i.div`
  display: flex;
