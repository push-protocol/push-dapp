import{q as c,db as t,dc as p,dd as U,df as P,R as o,X as k,m as e,dg as b,dh as B,de as l,dq as C,I as s,dr as w,ds as R,dj as W,M as q,N as H,dt as L,n as K,du as X,S as Z,__tla as Q}from"./index-BQgCmPi5.js";import{D as V,__tla as Y}from"./index-B3hXAzYv.js";let $,ee=Promise.all([(()=>{try{return Q}catch{}})(),(()=>{try{return Y}catch{}})()]).then(async()=>{let T,x,j,M,E,f,I,A;T=a=>/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(String(a).toLowerCase()),x=a=>a.trim().length===0,j=()=>{P.pageview("/support");const a=["Support","Integrate","Others"],[n,i]=o.useState(0),[g,_]=o.useState(""),[h,F]=o.useState(""),[N,G]=o.useState(a[0]),[u,O]=o.useState(""),[m,z]=o.useState(""),[y,d]=o.useState(""),S=k(),v=r=>{if(r.preventDefault(),T(h))if(x(g))d("Name can't be empty"),i(0);else if(x(u))d("Subject can't be empty"),i(0);else if(x(m))d("Message can't be empty"),i(0);else{i(1);const J={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({from:h,name:g,topic:N,sub:u,msg:m})};fetch("https://backend-kovan.epns.io/apis/mailing/sendMail",J).then(D=>D.json()).then(D=>{i(2)}).catch(D=>{d("Mayday! Mayday! something went wrong. Please retry..."),i(0)})}else d("Incorrect e-mail, please check and retry!"),i(0)};return e.jsx(M,{children:e.jsxs(b,{alignSelf:"stretch",justifyContent:"flex-start",children:[e.jsxs(b,{alignSelf:"stretch",justifyContent:"flex-start",children:[e.jsx(B,{children:e.jsx(l,{weight:"400",size:"32px",color:S.color,children:"Support"})}),e.jsx(l,{color:S.default.secondaryColor,weight:"400",size:"16px",textTransform:"none",textAlign:"center",spacing:"0.03em",margin:"0px 0px",children:"Let's get in touch!"})]}),e.jsx(b,{alignSelf:"stretch",children:e.jsx(C,{flex:"1",direction:"row",self:"stretch",margin:"0px",size:"1.1rem",onSubmit:v,children:e.jsxs(s,{self:"stretch",align:"stretch",justify:"stretch",margin:"10px -15px",children:[n===0&&e.jsxs(e.Fragment,{children:[e.jsxs(w,{align:"stretch",children:[e.jsxs(s,{flex:"1",margin:"15px",justify:"flex-start",align:"stretch",minWidth:"280px",children:[e.jsx(f,{required:!0,radius:"4px",padding:"12px",bg:"#fff",border:"12px",placeholder:"John Wick",value:g,onChange:r=>{_(r.target.value)},autocomplete:"name",style:{}}),g.trim().length===0&&e.jsx(l,{padding:"4px 10px",right:"0px",top:"0px",pos:"absolute",color:"#fff",bg:"#000",size:"0.7rem",z:"1",children:"Name"})]}),e.jsxs(s,{flex:"5",margin:"15px",justify:"flex-start",align:"stretch",minWidth:"280px",children:[e.jsx(f,{required:!0,placeholder:"john@wick.com",radius:"4px",padding:"12px",bg:"#fff",value:h,onChange:r=>{F(r.target.value)},autocomplete:"email"}),h.trim().length===0&&e.jsx(l,{padding:"4px 10px",right:"0px",top:"0px",pos:"absolute",color:"#fff",bg:"#000",size:"0.7rem",z:"1",children:"E-mail"})]})]}),e.jsx(s,{flex:"5",justify:"flex-start",align:"stretch",minWidth:"280px",margin:"15px",children:e.jsx(E,{options:a,onChange:r=>G(r.value),value:N,placeholder:"Select an option"})}),e.jsxs(s,{justify:"center",align:"stretch",minWidth:"280px",margin:"15px",children:[e.jsx(f,{required:!0,placeholder:"I want to tell you guys a secret!",radius:"4px",padding:"12px",bg:"#fff",value:u,onChange:r=>{O(r.target.value)},autocomplete:"on"}),u.trim().length===0&&e.jsx(l,{padding:"4px 10px",right:"0px",top:"0px",pos:"absolute",color:"#fff",bg:"#000",size:"0.7rem",z:"1",children:"Subject"})]}),e.jsx(s,{justify:"center",align:"stretch",minWidth:"280px",margin:"15px",children:e.jsx(I,{required:!0,placeholder:"This is where you will tell us that secret, or a bug or whatever is on your mind.",rows:"6",radius:"4px",padding:"12px",bg:"#fff",value:m,onChange:r=>{z(r.target.value)},autocomplete:"off"})})]}),n===2&&e.jsx(s,{align:"center",margin:"0px 10px",children:e.jsxs(w,{color:"#e20880",bg:"#000",padding:"10px 15px",columnGap:"0px",rowGap:"0px",children:[e.jsx(R,{size:24,color:"#fff"}),e.jsx(l,{padding:"0px 0px 0px 8px",color:"#fff",textTransform:"uppercase",spacing:"0.1em",children:"Message Sent! We will be in Touch :)"})]})}),y&&n===0&&e.jsx(s,{align:"center",margin:"0px 10px",children:e.jsx(s,{color:"#e20880",bg:"#000",padding:"10px 15px",margin:"15px",children:e.jsx(l,{color:"#fff",textTransform:"uppercase",spacing:"0.1em",children:y})})}),e.jsx(s,{justify:"stretch",self:"stretch",align:"stretch",minWidth:"280px",children:n!==2&&e.jsxs(W,{bg:"#000",color:"#fff",border:S.buttonBd,flex:"1",radius:"4px",disabled:n,margin:"15px",padding:"12px 15px",children:[n===1&&e.jsx(q,{type:H.SEAMLESS,spinnerColor:"#fff",spinnerSize:24}),n===0&&e.jsx(L,{cursor:"hand",color:"#fff",weight:"400",size:".9em",spacing:"0.2em",type:"submit",value:"Submit"})]})})]})})})]})})},M=c(K)`
	align-items: center;
	align-self: center;
