import{q as s,db as t,dc as l,dd as D,df as m,E as u,x as N,D as T,R as a,m as e,dp as h,n as L,z as d,S as f,__tla as $}from"./index-BZA5HzNp.js";import{S as x,__tla as p}from"./SendNotifications-DgUKLLTY.js";import{__tla as O}from"./index-DM_LO7X8.js";import{__tla as R}from"./Tag-BbgBwA2u.js";import{__tla as g}from"./TransitionGroupContext-BGrWWmn-.js";let _,G=Promise.all([(()=>{try{return $}catch{}})(),(()=>{try{return p}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return R}catch{}})(),(()=>{try{return g}catch{}})()]).then(async()=>{d.coreContractChain;function A(){m.pageview("/send_notificaiton"),u(),N(),T(n=>n.contracts),T(n=>n.admin),d.coreContractChain;const[r,J]=a.useState(2),[M,y]=a.useState(!0);a.useState(null),a.useState(null);const[o,b]=a.useState(!0);a.useState([]);const[E,I]=a.useState(null),U=()=>I(null);return a.useEffect(()=>{E&&U()},[E]),e.jsx(i,{children:r===2&&M?e.jsxs(e.Fragment,{children:[!o&&e.jsx(h,{replace:!0,to:"/dashboard"}),o&&e.jsx(x,{})]}):e.jsx(S,{children:"Channel details are being loaded, please wait\u2026"})})}let i,S,c;i=s(L)`
  align-items: center;
  align-self: center;
