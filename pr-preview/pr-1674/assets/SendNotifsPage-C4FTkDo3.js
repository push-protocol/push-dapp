import{q as s,c_ as t,c$ as l,d0 as D,d2 as m,dc as u,x as N,dd as T,R as a,m as e,de as h,n as L,z as _,S as f,__tla as $}from"./index-DwvJv0p6.js";import{S as x,__tla as O}from"./SendNotifications-BiH7brJF.js";import{__tla as p}from"./index-D3R4c9as.js";import{__tla as R}from"./Tag-CCdiZbWf.js";import{__tla as g}from"./TransitionGroupContext-2oSAR1RI.js";let d,G=Promise.all([(()=>{try{return $}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return p}catch{}})(),(()=>{try{return R}catch{}})(),(()=>{try{return g}catch{}})()]).then(async()=>{_.coreContractChain;function A(){m.pageview("/send_notificaiton"),u(),N(),T(n=>n.contracts),T(n=>n.admin),_.coreContractChain;const[r,J]=a.useState(2),[M,y]=a.useState(!0);a.useState(null),a.useState(null);const[o,j]=a.useState(!0);a.useState([]);const[E,I]=a.useState(null),U=()=>I(null);return a.useEffect(()=>{E&&U()},[E]),e.jsx(i,{children:r===2&&M?e.jsxs(e.Fragment,{children:[!o&&e.jsx(h,{replace:!0,to:"/dashboard"}),o&&e.jsx(x,{})]}):e.jsx(S,{children:"Channel details are being loaded, please wait\u2026"})})}let i,S,c;i=s(L)`
  align-items: center;
  align-self: center;
