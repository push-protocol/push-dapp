import{r as y,ho as Fn,hp as Pc,hq as be,m as t,hr as st,hs as De,ht as je,hu as lt,e2 as ct,hv as Uc,e1 as re,hw as Kt,hx as Gn,hy as Lc,hz as Yt,hA as Vt,hB as ge,hC as $n,hD as dt,hE as zc,hF as Oc,q as b,X as pe,eq as ie,di as Le,dj as ze,dd as Z,I as W,d1 as de,en as ht,_ as ji,g2 as Bi,eo as Be,x as Se,d7 as Ye,dc as pt,dX as Xt,dW as Zt,d5 as Qe,z as fe,c_ as ee,d8 as Nc,hG as Fc,hH as ut,hI as Gc,D as Te,n as ke,L as gt,R as ae,dk as Oe,d0 as K,dt as Ne,eF as Fe,er as ne,d3 as ue,dz as Hn,dA as Si,hJ as Ti,fc as $c,dp as Re,fo as Ge,em as Wn,hK as qn,dY as Me,eN as Hc,gc as ki,eb as ei,dv as ft,fR as Wc,dw as xt,hL as Mi,hM as qc,du as Jn,eO as Kn,da as Jc,hN as Kc,hO as Yc,hP as Vc,hQ as mt,eL as Yn,e6 as _i,dr as Di,hR as Xc,A as Zc,hS as Vn,hT as ed,fw as td,hU as id,dl as Xn,s as Zn,h4 as ti,hV as nd,hW as rd,df as er,g5 as ad,h7 as od,hX as sd,dT as At,hY as tr,dH as ir,gZ as ld,hZ as cd,d4 as dd,o as hd,y as pd,h_ as ud,dC as Qi,ga as gd,h$ as nr,i0 as rr,i1 as fd,i2 as xd,i3 as md,i4 as Ad,i5 as wd,i6 as Ri,c$ as $e,d2 as bd,S as vd,__tla as yd}from"./index-PKM8SQQT.js";import{S as Cd,N as Id,__tla as Ed}from"./RedCircle-CiOjGO9F.js";import{M as ar,g as or,S as jd,F as Pi,m as Ui,a as sr,C as lr,b as cr,i as Bd,c as Sd,__tla as Td}from"./ChannelInfoList-CDhC1EcX.js";import{T as kd,__tla as Md}from"./Tag-CkeDcDEF.js";import{M as _d,a as Dd,__tla as Qd}from"./EmptyNotificationSettings-BoTp-72Z.js";import{D as Rd,__tla as Pd}from"./index-CS6ValBC.js";import{D as Ud,__tla as Ld}from"./entry-Cdv0ZpYz.js";import{__tla as zd}from"./TransitionGroupContext-DfUadxOV.js";import{__tla as Od}from"./index.es-Dhfxxu1a.js";import"./browser-CeceZ__e.js";import{__tla as Nd}from"./index.esm-Bc3sin77.js";let dr,Fd=Promise.all([(()=>{try{return yd}catch{}})(),(()=>{try{return Ed}catch{}})(),(()=>{try{return Td}catch{}})(),(()=>{try{return Md}catch{}})(),(()=>{try{return Qd}catch{}})(),(()=>{try{return Pd}catch{}})(),(()=>{try{return Ld}catch{}})(),(()=>{try{return zd}catch{}})(),(()=>{try{return Od}catch{}})(),(()=>{try{return Nd}catch{}})()]).then(async()=>{const hr=e=>{const[n,i]=y.useState(!1),[r,s]=y.useState(null),d=y.useCallback(async(a,...c)=>{i(!0);try{const p=await a(...c);return i(!1),p}catch(p){throw i(!1),s(p),p}},[]),o=y.useCallback(async(...a)=>{try{return await d(e,...a)}catch(c){throw console.error(c),c}},[e,d]);return{loading:n,error:r,executeAsyncFunction:o}};function pr(e,n=0,i=1){return Pc(e,n,i)}function ur(e){e=e.slice(1);const n=new RegExp(`.{1,${e.length>=6?2:1}}`,"g");let i=e.match(n);return i&&i[0].length===1&&(i=i.map(r=>r+r)),i?`rgb${i.length===4?"a":""}(${i.map((r,s)=>s<3?parseInt(r,16):Math.round(parseInt(r,16)/255*1e3)/1e3).join(", ")})`:""}function Li(e){if(e.type)return e;if(e.charAt(0)==="#")return Li(ur(e));const n=e.indexOf("("),i=e.substring(0,n);if(["rgb","rgba","hsl","hsla","color"].indexOf(i)===-1)throw new Error(Fn(9,e));let r=e.substring(n+1,e.length-1),s;if(i==="color"){if(r=r.split(" "),s=r.shift(),r.length===4&&r[3].charAt(0)==="/"&&(r[3]=r[3].slice(1)),["srgb","display-p3","a98-rgb","prophoto-rgb","rec-2020"].indexOf(s)===-1)throw new Error(Fn(10,s))}else r=r.split(",");return r=r.map(d=>parseFloat(d)),{type:i,values:r,colorSpace:s}}function gr(e){const{type:n,colorSpace:i}=e;let{values:r}=e;return n.indexOf("rgb")!==-1?r=r.map((s,d)=>d<3?parseInt(s,10):s):n.indexOf("hsl")!==-1&&(r[1]=`${r[1]}%`,r[2]=`${r[2]}%`),n.indexOf("color")!==-1?r=`${i} ${r.join(" ")}`:r=`${r.join(", ")}`,`${n}(${r})`}function fr(e,n){return e=Li(e),n=pr(n),(e.type==="rgb"||e.type==="hsl")&&(e.type+="a"),e.type==="color"?e.values[3]=`/${n}`:e.values[3]=n,gr(e)}const xr=y.createContext(),mr=()=>y.useContext(xr)??!1;function Ar(e){return String(e).match(/[\d.\-+]*\s*(.*)/)[1]||""}function wr(e){return parseFloat(e)}function br(e){const{className:n,classes:i,pulsate:r=!1,rippleX:s,rippleY:d,rippleSize:o,in:a,onExited:c,timeout:p}=e,[h,l]=y.useState(!1),f=be(n,i.ripple,i.rippleVisible,r&&i.ripplePulsate),u={width:o,height:o,top:-(o/2)+d,left:-(o/2)+s},g=be(i.child,h&&i.childLeaving,r&&i.childPulsate);return!a&&!h&&l(!0),y.useEffect(()=>{if(!a&&c!=null){const A=setTimeout(c,p);return()=>{clearTimeout(A)}}},[c,a,p]),t.jsx("span",{className:f,style:u,children:t.jsx("span",{className:g})})}const ve=st("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),vr=["center","classes","className"];let wt=e=>e,zi,Oi,Ni,Fi;const ii=550,yr=80,Cr=De(zi||(zi=wt`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`,io=b.p`
  ...
  margin-left: 12px;
  color: ${e=>e.theme.editChannelPrimaryText};
`,no=50,ro=fe.coreContractChain;function ao({DropdownRef:e,isDropdownOpen:n,closeDropdown:i}){pt();const{account:r,chainId:s}=Se(),{epnsWriteProvider:d,epnsCommWriteProvider:o}=Z(M=>M.contracts),{channelDetails:a}=Z(M=>M.admin),{CHANNNEL_DEACTIVATED_STATE:c,CHANNEL_BLOCKED_STATE:p}=Z(M=>M.channels);Z(M=>M.user),ae.useContext(ei);const h=pe(),{channelState:l}=a,f=ro===s,u=Ge(425),{isModalOpen:g,showModal:A,ModalComponent:x}=ft(),{isModalOpen:m,showModal:E,ModalComponent:v}=ft(),{isModalOpen:B,showModal:S,ModalComponent:D}=ft(),C=n&&!g&&!m&&!B;Ne(e,()=>C&&i()),ae.useState(!1),ae.useState(no);const[j,Q]=ae.useState(0),T=l===c,_=l===p,O=_||T;ae.useEffect(()=>{Q(+Wc.formatBigNumberToMetric(a.poolContribution,!0))},[r,a.poolContribution]),Be();const U=()=>{_||(T?E():A())},z=Be(),L=d.reactivateChannel,w=Be(),I=()=>d.deactivateChannel(),k=Be(),R=async(M,G)=>{if(!(M==""||G=="")&&!(M<60))try{const P=M+"+"+G,N=Mi(P);return d.addSubGraph(N)}catch(P){console.error(P)}};return t.jsxs(t.Fragment,{children:[t.jsx("div",{children:t.jsx(oo,{background:h,children:t.jsxs(so,{children:[fe.appEnv!=="prod"&&t.jsx(on,{disabled:O,onClick:()=>!O&&S(),children:t.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[t.jsx(yt,{src:ya,alt:"cube"}),t.jsx("div",{style:{width:"10px"}}),"Add SubGraph Details"]})}),f&&t.jsx(on,{isChannelDeactivated:T,onClick:U,children:t.jsx(lo,{isChannelBlocked:_,isChannelDeactivated:T,children:t.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[_?t.jsx(yt,{src:tn,alt:"red-bell"}):T?t.jsx(yt,{src:Ca,alt:"green-bell"}):t.jsx(yt,{src:tn,alt:"red-bell"}),t.jsx("div",{style:{width:"10px"}}),_?"Channel Blocked":T?"Activate Channel":"Deactivate Channel"]})})})]})})}),t.jsx(x,{InnerComponent:Sa,onConfirm:I,toastObject:w,modalPosition:xt.ON_ROOT}),t.jsx(v,{InnerComponent:Pa,onConfirm:L,toastObject:z,modalMargin:u?"10rem 1rem 0 1rem":"",modalPosition:xt.ON_ROOT}),t.jsx(D,{InnerComponent:Ia,onConfirm:R,toastObject:k,modalPosition:xt.ON_ROOT})]})}const oo=b.div`
  position: absolute;
  right: 20px;
  display: flex;
  flex-direction: column-reverse;
...
`,qe=e=>e.trim().length==0;function pc({closeEditChannel:e,UploadLogoComponent:n,displayUplaodLogoModal:i}){const{account:r,provider:s}=Se(),{channelDetails:d,aliasDetails:{isAliasVerified:o,aliasAddrFromContract:a}}=Z(H=>H.admin),{epnsReadProvider:c,epnsWriteProvider:p}=Z(H=>H.contracts),h=50,[l,f]=y.useState(d==null?void 0:d.name),[u,g]=y.useState(d==null?void 0:d.info),[A,x]=y.useState(d==null?void 0:d.url),[m,E]=y.useState(d==null?void 0:d.icon),[v,B]=y.useState(d==null?void 0:d.icon),[S,D]=y.useState(d==null?void 0:d.icon),[C,j]=y.useState(S),[Q,T]=y.useState(null),[_,O]=y.useState(!1),[U,z]=y.useState({name:"",description:"",address:"",url:""}),[L,w]=y.useState(!1),[I,k]=y.useState(0),[R,M]=y.useState(0),[G,P]=y.useState(!1),N=Be();y.useEffect(()=>{r&&async function(){const H=await c.channelUpdateCounter(r);k(h*(Number(H)+1))}()},[r]),y.useEffect(()=>{!r||!s||async function(){const H=await or({address:r,provider:s,contractAddress:Me.epnscore});M(parseInt(H));const X=parseInt(H);X>=I&&X!=0?O(!0):O(!1)}()},[r,s]);const F=async()=>{if(w(!0),!s)return;const H=s.getSigner(r);N.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{const X=await sr({signer:H,contractAddress:Me.epnscore,amount:I-R});console.debug("response",X),X&&(w(!1),M(I),O(!0),N.showMessageToast({toastTitle:"Success",toastMessage:"Successfully approved Push!",toastType:"SUCCESS",getToastIcon:se=>t.jsx(Fe,{size:se,color:"green"})}))}catch(X){console.error(X),X.code=="ACTION_REJECTED"?N.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:se=>t.jsx(ne,{size:se,color:"red"})}):(N.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in approving PUSH Token",toastType:"ERROR",getToastIcon:se=>t.jsx(ne,{size:se,color:"red"})}),console.error("Error --> %o",X),console.error({err:X}))}w(!1)},V=()=>{P(!1)},he=Ge(600),te=y.useRef(null);Ne(te,()=>{V()});const Y=()=>(z(""),qe(l)||qe(u)||qe(A)?(qe(l)&&z(H=>({...H,name:"Please, enter the channel name."})),qe(u)&&z(H=>({...H,description:"Please, enter the channel description"})),qe(A)&&z(H=>({...H,url:"Please, enter the channel url"})),!1):jt(l,125)?jt(A,125)?ui(A)?!0:(z(H=>({...H,url:"Channel URL is invalid! Please enter a valid url!"})),!1):(z(H=>({...H,url:"Channel Url should not exceed 125 characters! Please retry!"})),!1):(z(H=>({...H,name:"Channel Name should not exceed 125 characters! Please retry!"})),!1)),J=()=>!(l!==(d==null?void 0:d.name)||u!==(d==null?void 0:d.info)||A!==(d==null?void 0:d.url)||v!==(d==null?void 0:d.icon)),oe=async H=>{try{if(!Y())return;w(!0);const X=JSON.stringify({name:l,info:u,url:A,icon:v,aliasDetails:d.aliasDetails||nr({chainId:parseInt(d.chain_id),address:d.address})});console.debug(X);const se=await rr(X);console.debug("IPFS storagePointer:",se);const le="1+"+se,Ie=Mi(le),ce=ki(I.toString(),18);N.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const Ae=await p.updateChannelMeta(r,Ie,ce,{gasLimit:1e6});console.debug(Ae),await Ae.wait(),w(!1),N.showMessageToast({toastTitle:"Success",toastMessage:"Channel Updated Successfully",toastType:"SUCCESS",getToastIcon:ye=>t.jsx(Fe,{size:ye,color:"green"})}),setTimeout(()=>{window.location.reload()},2e3)}catch(X){w(!1),console.error(X.message),X.code=="ACTION_REJECTED"?N.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:se=>t.jsx(ne,{size:se,color:"red"})}):(N.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in updating channel Details",toastType:"ERROR",getToastIcon:se=>t.jsx(ne,{size:se,color:"red"})}),console.error("Error --> %o",X),console.error({err:X}))}},me=async H=>{await Ui({noOfTokens:H,provider:s,account:r})};return y.useEffect(()=>{S&&(console.debug("Image cropped",S),Rn(S,function(H){const X=Pn(H);console.debug("response",X),X.success&&(console.debug("Cropped Image....",S),B(S))}))},[S]),t.jsxs(uc,{ref:te,children:[t.jsx(n,{InnerComponent:tc,InnerComponentProps:{setChannelLogo:E,channelLogo:m,croppedImage:S,setCroppedImage:D,setChannelFile:B,imageSrc:C,setImageSrc:j,imageType:Q,setImageType:T,errorInfo:U,setErrorInfo:z},modalPosition:xt.ON_PARENT}),t.jsxs(gc,{children:[t.jsxs(mc,{children:[t.jsx(Ac,{src:m}),t.jsx(fc,{onClick:()=>{i(),P(!0)},children:"Upload Logo"})]}),!he&&t.jsx(wc,{}),t.jsx(Yl,{channelName:l,setChannelName:f,channelInfo:u,setChannelInfo:g,channelURL:A,setChannelURL:x,editChannel:oe,errorInfo:U,setErrorInfo:z})]}),t.jsxs(bc,{children:[t.jsxs("div",{children:[t.jsx(vc,{children:"Channel edit fee"}),t.jsx(yc,{children:"Editing channel details requires fees to be deposited"})]}),t.jsxs(ie,{flex:"0",children:[_?t.jsx(xc,{src:ec}):null,t.jsxs(Cc,{children:[I," PUSH"]})]})]}),t.jsx(Pi,{noOfPushTokensToCheck:I,containerProps:{width:"100%"},onMintPushToken:me}),L?t.jsx(t.Fragment,{children:t.jsxs(Ic,{children:[t.jsx(Spinner,{size:42,color:ee.COLORS.PRIMARY_PINK,type:Si.PROCESSING}),t.jsx(Ec,{children:"Verifying Transaction"})]})}):t.jsx(t.Fragment,{children:t.jsxs(jc,{children:[t.jsx(Bc,{onClick:e,children:"Cancel"}),R>=I?t.jsx(Ii,{disabled:J(),style:{background:J()?" #F4DCEA":"#CF1C84"},onClick:oe,children:"Save Changes"}):t.jsx(Ii,{onClick:F,children:"Approve PUSH"})]})})]})}const uc=b(ue)`
  padding: 0px;
...
`;b.div`
  ...
  margin-bottom: 15px;
  overflow: hidden;
`;let zn;dr=()=>t.jsx(zn,{children:t.jsx(_c,{})}),zn=b(vd)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
