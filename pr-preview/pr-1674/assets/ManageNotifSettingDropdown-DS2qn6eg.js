import{q as u,B as D,eb as xe,r as f,ec as fe,m as n,x as se,D as oe,E as re,z as P,F as we,H as ae,X as ie,J as E,K as Se,ed as me,M as le,N as de,Q as A,U as be,V as ce,Y as k,dz as pe,O as ye,T as je,ee as ve,__tla as Ce}from"./index-BCJmBPvR.js";import{I as Me,R as Te,__tla as De}from"./RangeSlider-Dt8_RSrV.js";let I,ue,he,ge,$,Ee=Promise.all([(()=>{try{return Ce}catch{}})(),(()=>{try{return De}catch{}})()]).then(async()=>{let B,V,O,W,S,_,H,U,F,N,J,K,X,Y,q,Q,R,G,Z,ee,te,L,ne;I=({children:e,renderDropdownContainer:r,showDropdown:s,toggleDropdown:a,closeDropdown:o,containerPadding:h,centerOnMobile:l})=>{const p=f.useRef(null),c=f.useRef(null);return fe(p,c,o),n.jsxs(B,{ref:p,onClick:a,children:[e,s&&n.jsx(V,{containerPadding:h,centerOnMobile:l,children:n.jsx("div",{ref:c,onClick:t=>t.stopPropagation(),children:r})})]})},B=u.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
