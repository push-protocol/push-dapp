...
`,Bt=p(Te)`
  ...
  height: 17px;
  width: fit-content;
`,Jt=()=>e.jsx(Vt,{children:e.jsx(Lt,{})}),Vt=p(ze)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
`});export{ba as __tla,Jt as default};
