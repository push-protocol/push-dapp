import{e6 as i,e9 as N,e1 as t,ea as le,e3 as q,e4 as G,eY as J,eO as p,eT as K,dY as pe,ei as xe,d_ as l,fp as ce,f4 as he,gc as ge,fq as me,fz as fe,gM as w,ed as h,ee as Q,gJ as X,gN as ue,fn as we,__tla as je}from"./index-Cn1vmTNj.js";import{c as Ce,__tla as ye}from"./PushTokenContractHelper-BwmeEVap.js";import{E as be,__tla as ve}from"./EmptyNotificationSettings-D6aigcJY.js";import{T as j,__tla as ke}from"./Tag-CwDeGLo3.js";let ee,te,ie,ne,oe,Le=Promise.all([(()=>{try{return je}catch{}})(),(()=>{try{return ye}catch{}})(),(()=>{try{return ve}catch{}})(),(()=>{try{return ke}catch{}})()]).then(async()=>{let C,y,b,v,k,L,M,_,g,T,m,H,S,$;ie=({text:e,onClick:s,isLoading:n,topMargin:o,loaderTitle:r})=>{const a=N();return t.jsx(le,{theme:a,children:t.jsx(C,{style:{marginTop:o||"55px"},children:n?t.jsx(y,{children:t.jsx(q,{type:G.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:r??"",titleColor:"#fff"})}):t.jsx(J,{onClick:s,variant:"primary",size:"large",children:e})})})},C=i.div`
  display: flex;
