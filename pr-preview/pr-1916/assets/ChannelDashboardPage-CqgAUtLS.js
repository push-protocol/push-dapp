import{d$ as l,e2 as e,il as Se,fZ as _e,fY as Q,im as Pt,e7 as o,e9 as Z,fE as V,e4 as Ka,e5 as Ya,f3 as _,ed as ee,eU as ce,gr as nt,ex as _t,i4 as Ja,fH as de,dZ as me,e3 as qa,f0 as ne,es as Xa,f2 as Me,en as Qa,ep as Za,eY as je,em as se,eR as O,e$ as eo,io as to,ip as Ee,iq as io,er as Oe,eb as Ue,ea as Fe,ek as H,fm as at,eT as D,fq as ue,fN as fe,fO as Y,eW as J,fw as Ot,fx as ot,ir as rt,h6 as no,is as ao,gz as ke,gq as Ut,it as Ft,eo as Ge,gO as oo,eq as Gt,fs as Re,ft as Ie,iu as Vt,iv as ro,gP as Ht,fG as Wt,d_ as so,iw as lo,ix as co,iy as po,iz as st,fL as lt,f8 as ct,iA as xo,e1 as ho,fj as go,fn as mo,iB as uo,iC as fo,fS as wo,iD as yo,eS as we,iE as bo,iF as Co,iG as jo,iH as vo,iI as dt,iJ as To,eV as Ao,e8 as So,__tla as Mo}from"./index-CMjHumvI.js";import{f as Kt,c as Eo,a as ae,g as Ve,s as De,u as He,b as ko,d as pt,e as Yt,h as Ro,i as We,j as xt,k as ve,l as Jt,__tla as Io}from"./DefaultPropsProvider-Bv0PIdGd.js";import{S as Do,N as Lo,__tla as No}from"./RedCircle-yo_nuO2w.js";import{M as qt,S as zo,F as Xt,C as Qt,a as Zt,__tla as $o}from"./ChannelInfoList-CijjHLqb.js";import{a as Bo,__tla as Po}from"./Tag-ZN7L2zre.js";import{E as _o,__tla as Oo}from"./EPNSCoreHelper-BbcOpbKF.js";import{a as ei,m as ti,b as ii,__tla as Uo}from"./PushTokenContractHelper-DZcxQ8Kj.js";import{M as Fo,a as Go,__tla as Vo}from"./EmptyNotificationSettings-CpRtoScR.js";import{a as ni,b as ai,__tla as Ho}from"./ValidationHelper-DzbGj_lm.js";import{I as Wo,__tla as Ko}from"./ImportPushTokenMessage-DI0Ni-e5.js";import{a as Yo,__tla as Jo}from"./IpfsHelper-BXND0Kkh.js";import{v as qo,C as Xo,__tla as Qo}from"./CreateChannel-D2ShKNHm.js";import{__tla as Zo}from"./TransitionGroupContext-CO05UEKA.js";import{__tla as er}from"./index.esm-BhU5m5Cz.js";import"./browser-Cr_ZWWON.js";import{__tla as tr}from"./Stepper-ed39Rlph.js";import{__tla as ir}from"./StakingVariant-BVCOmtd3.js";import{__tla as nr}from"./useMutation-BVL8RBxw.js";import{__tla as ar}from"./index.esm-QWbEES0I.js";import"./Common.form-Ds5bAxK4.js";let oi,or=Promise.all([(()=>{try{return Mo}catch{}})(),(()=>{try{return Io}catch{}})(),(()=>{try{return No}catch{}})(),(()=>{try{return $o}catch{}})(),(()=>{try{return Po}catch{}})(),(()=>{try{return Oo}catch{}})(),(()=>{try{return Uo}catch{}})(),(()=>{try{return Vo}catch{}})(),(()=>{try{return Ho}catch{}})(),(()=>{try{return Ko}catch{}})(),(()=>{try{return Jo}catch{}})(),(()=>{try{return Qo}catch{}})(),(()=>{try{return Zo}catch{}})(),(()=>{try{return er}catch{}})(),(()=>{try{return tr}catch{}})(),(()=>{try{return ir}catch{}})(),(()=>{try{return nr}catch{}})(),(()=>{try{return ar}catch{}})()]).then(async()=>{function ri(t,a=0,i=1){return Eo(t,a,i)}function si(t){t=t.slice(1);const a=new RegExp(`.{1,${t.length>=6?2:1}}`,"g");let i=t.match(a);return i&&i[0].length===1&&(i=i.map(n=>n+n)),i?`rgb${i.length===4?"a":""}(${i.map((n,s)=>s<3?parseInt(n,16):Math.round(parseInt(n,16)/255*1e3)/1e3).join(", ")})`:""}function ht(t){if(t.type)return t;if(t.charAt(0)==="#")return ht(si(t));const a=t.indexOf("("),i=t.substring(0,a);if(["rgb","rgba","hsl","hsla","color"].indexOf(i)===-1)throw new Error(Kt(9,t));let n=t.substring(a+1,t.length-1),s;if(i==="color"){if(n=n.split(" "),s=n.shift(),n.length===4&&n[3].charAt(0)==="/"&&(n[3]=n[3].slice(1)),["srgb","display-p3","a98-rgb","prophoto-rgb","rec-2020"].indexOf(s)===-1)throw new Error(Kt(10,s))}else n=n.split(",");return n=n.map(r=>parseFloat(r)),{type:i,values:n,colorSpace:s}}function li(t){const{type:a,colorSpace:i}=t;let{values:n}=t;return a.indexOf("rgb")!==-1?n=n.map((s,r)=>r<3?parseInt(s,10):s):a.indexOf("hsl")!==-1&&(n[1]=`${n[1]}%`,n[2]=`${n[2]}%`),a.indexOf("color")!==-1?n=`${i} ${n.join(" ")}`:n=`${n.join(", ")}`,`${a}(${n})`}function ci(t,a){return t=ht(t),a=ri(a),(t.type==="rgb"||t.type==="hsl")&&(t.type+="a"),t.type==="color"?t.values[3]=`/${a}`:t.values[3]=a,li(t)}function di(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function pi(t){return parseFloat(t)}function xi(t){const{className:a,classes:i,pulsate:n=!1,rippleX:s,rippleY:r,rippleSize:w,in:x,onExited:c,timeout:p}=t,[g,u]=l.useState(!1),h=ae(a,i.ripple,i.rippleVisible,n&&i.ripplePulsate),m={width:w,height:w,top:-(w/2)+r,left:-(w/2)+s},d=ae(i.child,g&&i.childLeaving,n&&i.childPulsate);return!x&&!g&&u(!0),l.useEffect(()=>{if(!x&&c!=null){const T=setTimeout(c,p);return()=>{clearTimeout(T)}}},[c,x,p]),e.jsx("span",{className:h,style:m,children:e.jsx("span",{className:d})})}const ie=Ve("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),hi=["center","classes","className"];let Le=t=>t,gt,mt,ut,ft;const Ke=550,gi=80,mi=Se(gt||(gt=Le`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`)),Pi=De("span",{name:"MuiSkeleton",slot:"Root",overridesResolver:(t,a)=>{const{ownerState:i}=t;return[a.root,a[i.variant],i.animation!==!1&&a[i.animation],i.hasChildren&&a.withChildren,i.hasChildren&&!i.width&&a.fitContent,i.hasChildren&&!i.height&&a.heightAuto]}})(({theme:t,ownerState:a})=>{const i=di(t.shape.borderRadius)||"px",n=pi(t.shape.borderRadius);return Q({display:"block",backgroundColor:t.vars?t.vars.palette.Skeleton.bg:ci(t.palette.text.primary,t.palette.mode==="light"?.11:.13),height:"1.2em"},a.variant==="text"&&{marginTop:0,marginBottom:0,height:"auto",transformOrigin:"0 55%",transform:"scale(1, 0.60)",borderRadius:`${n}${i}/${Math.round(n/.6*10)/10}${i}`,"&:empty:before":{content:'"\\00a0"'}},a.variant==="circular"&&{borderRadius:"50%"},a.variant==="rounded"&&{borderRadius:(t.vars||t).shape.borderRadius},a.hasChildren&&{"& > *":{visibility:"hidden"}},a.hasChildren&&!a.width&&{maxWidth:"fit-content"},a.hasChildren&&!a.height&&{height:"auto"})},({ownerState:t})=>t.animation==="pulse"&&Pt(bt||(bt=Ne`
    ...
    `),Bi,(a.vars||a).palette.action.hover)),ze=l.forwardRef(function(t,a){const i=He({props:t,name:"MuiSkeleton"}),{animation:n="pulse",className:s,component:r="span",height:w,style:x,variant:c="text",width:p}=i,g=_e(i,Ni),u=Q({},i,{animation:n,component:r,variant:c,hasChildren:!!g.children}),h=zi(u);return e.jsx(Pi,Q({as:r,ref:a,className:ae(h.root,s),ownerState:u},g,{style:Q({width:p,height:w},x)}))}),jt=()=>(Z(),e.jsxs(V,{children:[e.jsxs(_i,{children:[e.jsxs(Oi,{children:[e.jsx(ze,{variant:"rectangular",sx:{bgcolor:"#F4F5FA"},style:{width:"8rem",height:"8rem",borderRadius:"32px",marginRight:"2%"}}),e.jsxs(Ui,{children:[e.jsx(ze,{variant:"rectangular",sx:{bgcolor:"#F4F5FA"},style:{width:"40%",height:"2.2rem",borderRadius:"5px",marginTop:"3%"}}),e.jsx(ze,{variant:"rectangular",sx:{bgcolor:"#F4F5FA"},style:{width:"20%",height:"1.1rem",borderRadius:"5px",marginTop:"2%"}})]})]}),e.jsx(ze,{variant:"rectangular",sx:{bgcolor:"#F4F5FA"},style:{width:"100%",height:"2.7rem",borderRadius:"9px",marginTop:"4%"}})]}),e.jsx(V,{padding:"40px 0 40px 0",children:e.jsx(Ka,{type:Ya.SEAMLESS,title:"Loading Channel Details. Please wait..."})})]})),_i=o.div`
  width: 100%;
  display: flex;
...
`,Ui=o.div`
  ...
  display: flex;
  flex-direction: column;
`,Fi=()=>{var i,n;const t=Z(),{aliasDetails:{aliasChainId:a}}=_(s=>s.admin);return e.jsxs(ee,{margin:"15px 20px 15px 20px",flex:"1",display:"flex",direction:"column",children:[e.jsxs(ce,{textAlign:"center",margin:"30px 0px 0px 0px",color:t.color,size:"16px",textTransform:"none",weight:"500",children:["We\u2019re setting up your channel on the ",(n=(i=nt[a])==null?void 0:i.label)==null?void 0:n.split(" ")[0]," Alias Network."]})," ",e.jsx(ce,{textAlign:"center",margin:"5px 0px 60px 0px",color:t.color,size:"16px",textTransform:"none",weight:"500",children:"This usually takes around 5 minutes."}),e.jsxs(ee,{display:"flex",direction:"row",align:"center",margin:"50px 0px",children:[e.jsx(_t,{color:"#cf1c84",loading:!0,height:13,width:4}),e.jsx(Ja,{margin:"auto 15px",textTransform:"none",color:t.color,size:"16px",weight:"600",children:"Processing"})]})]})},Gi=()=>{var n;de();const t=Z(),{switchChain:a}=me(),{aliasDetails:{aliasChainId:i}}=_(s=>s.admin);return e.jsxs(ee,{margin:"15px 20px 15px 20px",flex:"1",display:"flex",direction:"column",children:[e.jsxs(ce,{textAlign:"center",margin:"30px 0px 0px 0px",color:t.color,size:"16px",textTransform:"none",weight:"500",line:"24px",children:["Change your wallet network to ",e.jsx(Vi,{children:(n=nt[i])==null?void 0:n.label})," to start ",e.jsx("br",{}),"verifying your Channel Alias."]}),e.jsx(qa,{display:"flex",alignSelf:"center",alignItems:"center",margin:"spacing-xxxl spacing-none spacing-xxl spacing-none",children:e.jsx(ne,{variant:"primary",onClick:()=>a(i),size:"large",children:e.jsx(Xa,{color:"white",children:"Change Network"})})})]})},Vi=o.b`
  color: #cf1c84;
`,Hi=({aliasEthAccount:t,setAliasVerified:a})=>{var U,f;const i=Z(),{account:n,provider:s,chainId:r}=me(),w=s.getSigner(n),x=Me(),c=new Qa(nt[r].commAddress,Za.epnsComm,w),[p,g]=l.useState(""),[u,h]=l.useState(!1),m=t,d={80002:{label:"Amoy MATIC",url:"https://faucet.polygon.technology/"},97:{label:"Testnet BNB",url:"https://testnet.bnbchain.org/faucet-smart"},11155420:{label:"Sepolia OpETH",url:"https://faucet.quicknode.com/optimism/sepolia"},2442:{label:"Polygon zkEVM ETH",url:"https://faucet.polygon.technology/"},421614:{label:"Sepolia ArbETH",url:"https://faucet.quicknode.com/arbitrum/sepolia"},123:{label:"Fuse SPARK",url:"https://chaindrop.org/?chainid=123&token=0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"},111557560:{label:"Cyber ETH",url:"https://cyber-testnet.testnets.rollbridge.app/"},84532:{label:"Base Sepolia",url:"https://www.alchemy.com/faucets/base-sepolia"},59141:{label:"Linea Sepolia",url:"https://www.infura.io/faucet/linea"}},T=async()=>{m==t&&$()},P=async()=>{const{aliasVerified:S}=await io({account:n,chainId:r}).then(A=>A?(x(a(A.is_alias_verified)),{aliasVerified:A.is_alias_verified}):{aliasVerified:null});return{aliasVerified:S}},$=()=>{g("Processing"),c.verifyChannelAlias(m).then(async S=>{console.debug(S),g("Transaction Sent! It usually takes 5mins to verify."),await S.wait(1),setTimeout(()=>{g("Transaction Mined!")},2e3),setTimeout(()=>{g("Loading...")},2e3);const A=setInterval(async()=>{const{aliasVerified:L}=await P();L&&(setTimeout(()=>{h(!0)},1e3),clearInterval(A),x(Ee(0)))},5e3)}).catch(()=>{g("There was an error"),setTimeout(()=>{g("")},2e3)})};return e.jsxs(ee,{margin:"15px 20px 15px 20px",flex:"1",display:"flex",direction:"column",children:[e.jsx(je,{textAlign:"center",margin:"60px 0px 0px 0px",color:i.color,fontSize:"16px",textTransform:"none",fontWeight:"500",lineHeight:"24px",maxWidth:"400px",children:"You\u2019re almost there! Verify the Channel Alias to enable sending notifications from it."}),p===""&&e.jsx(ce,{textAlign:"center",margin:"60px 0px 0px 0px",color:"#CF1C84",size:"16px",textTransform:"none",weight:"500",line:"24px",children:n}),p===""&&se.appEnv!=="prod"&&e.jsxs(je,{padding:"10px",margin:"10px",borderRadius:O.ADJUSTMENTS.RADIUS.SMALL,background:i.default.secondaryBg,color:i.default.secondaryColor,children:["You will need"," ",e.jsx(eo,{href:(U=d[r])==null?void 0:U.url,target:"_blank",children:(f=d[r])==null?void 0:f.label})," ","to proceed."]}),!u&&(p?e.jsxs(ee,{display:"flex",direction:"row",align:"center",margin:"60px 0px 0px 0px",children:[e.jsx(_t,{color:"#cf1c84",loading:!0,height:13,width:4}),e.jsx(ce,{color:i.color,weight:"600",textTransform:"none",line:"22px",size:"16px",margin:"0px 10px",children:p})]}):e.jsx(ee,{width:"15em",self:"center",align:"center",margin:"60px auto 0px auto",children:e.jsx(ne,{variant:"primary",size:"medium",onClick:T,children:"Verify Alias Address"})})),u&&e.jsxs(ee,{display:"flex",direction:"row",align:"center",margin:"60px 0px 0px 0px",children:[e.jsx(to,{color:"#30CC8B",size:30}),e.jsx(ce,{color:i.color,weight:"600",textTransform:"none",line:"22px",size:"16px",margin:"0px 10px",children:"Verification Complete"})]})]})},Wi=({aliasEthAccount:t,setAliasVerified:a})=>{const{processingState:i}=_(n=>n.channelCreation);return e.jsxs(Ue,{children:[e.jsxs(Ki,{children:[e.jsxs(Je,{type:i>=1?"active":"inactive",active:i==1?"active":"inactive",children:[e.jsx("div",{children:"Waiting for Setup"}),e.jsx(Ye,{type:i>=1?"active":"inactive"})]}),e.jsxs(Je,{type:i>=2?"active":"inactive",active:i==2?"active":"inactive",children:[e.jsx("div",{children:"Change Network"}),e.jsx(Ye,{type:i>=2?"active":"inactive"})]}),e.jsxs(Je,{type:i>=3?"active":"inactive",active:i==3?"active":"inactive",children:[e.jsx("div",{children:"Verify Alias Network"}),e.jsx(Ye,{type:i>=3?"active":"inactive"})]}),e.jsx(Yi,{})]}),i===1&&e.jsx(Fi,{}),i===2&&e.jsx(Gi,{}),i===3&&e.jsx(Hi,{aliasEthAccount:t,setAliasVerified:a})]})},Ki=o.div`
  display: flex;
  flex-direction: row;
...
`,Je=o.div`
  ...
  ${({active:t})=>t==="active"&&Oe`
    ...
    `};
`,vt=({heading:t,subHeading:a})=>{const i=Z();return e.jsx(Fe,{theme:i,children:e.jsxs(Ji,{children:[e.jsx(qi,{style:{color:i.default.color},children:t}),e.jsx(Xi,{style:{color:i.modalMessageColor},children:a})]})})},Ji=o.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  margin-bottom: 4%;
...
`,Xi=o.h4`
  ...
  margin: 0;
  padding: 0;
`,qe=H.forwardRef(({title:t},a)=>{const i=Z();return e.jsx(Fe,{theme:i,children:e.jsxs(Qi,{children:[e.jsx(Zi,{style:{color:i.modalMessageColor},children:t}),e.jsx(en,{ref:a,radius:"12px",padding:"0.8rem",border:"1px solid #BAC4D6",style:{color:i.modalMessageColor}})]})})}),Qi=o.div`
  display: flex;
  flex-direction: column;
  margin: 3% 0%;
`,Zi=o.h4`
...
`,Pn=o.p`
  ...
  margin-left: 12px;
  color: ${t=>t.theme.editChannelPrimaryText};
`,_n=50,On=se.coreContractChain;function Un({DropdownRef:t,isDropdownOpen:a,closeDropdown:i}){Me();const{account:n,chainId:s}=me(),{epnsWriteProvider:r,epnsCommWriteProvider:w}=_(W=>W.contracts),{channelDetails:x}=_(W=>W.admin),{CHANNNEL_DEACTIVATED_STATE:c,CHANNEL_BLOCKED_STATE:p}=_(W=>W.channels);_(W=>W.user);const g=Z(),{channelState:u}=x,h=On===s,m=ke(425),{isModalOpen:d,showModal:T,ModalComponent:P}=Re(),{isModalOpen:$,showModal:U,ModalComponent:f}=Re(),{isModalOpen:S,showModal:A,ModalComponent:L}=Re(),G=a&&!d&&!$&&!S;ue(t,()=>G&&i()),H.useState(!1),H.useState(_n);const[K,R]=H.useState(0),B=u===c,N=u===p,y=N||B;H.useEffect(()=>{R(+_o.formatBigNumberToMetric(x.poolContribution,!0))},[n,x.poolContribution]),de();const E=()=>{N||(B?U():T())},k=de(),C=r.reactivateChannel,M=de(),j=()=>r.deactivateChannel(),pe=de(),re=async(W,xe)=>{if(!(W==""||xe=="")&&!(W<60))try{const oe=W+"+"+xe,F=Vt(oe);return r.addSubGraph(F)}catch(oe){console.error(oe)}};return e.jsxs(e.Fragment,{children:[e.jsx("div",{children:e.jsx(Fn,{background:g,children:e.jsxs(Gn,{children:[se.appEnv!=="prod"&&e.jsx(Et,{disabled:y,onClick:()=>!y&&A(),children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[e.jsx($e,{src:an,alt:"cube"}),e.jsx("div",{style:{width:"10px"}}),"Add SubGraph Details"]})}),h&&e.jsx(Et,{isChannelDeactivated:B,onClick:E,children:e.jsx(Vn,{isChannelBlocked:N,isChannelDeactivated:B,children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[N?e.jsx($e,{src:Tt,alt:"red-bell"}):B?e.jsx($e,{src:on,alt:"green-bell"}):e.jsx($e,{src:Tt,alt:"red-bell"}),e.jsx("div",{style:{width:"10px"}}),N?"Channel Blocked":B?"Activate Channel":"Deactivate Channel"]})})})]})})}),e.jsx(P,{InnerComponent:dn,onConfirm:j,toastObject:M,modalPosition:Ie.ON_ROOT}),e.jsx(f,{InnerComponent:wn,onConfirm:C,toastObject:k,modalMargin:m?"10rem 1rem 0 1rem":"",modalPosition:Ie.ON_ROOT}),e.jsx(L,{InnerComponent:rn,onConfirm:re,toastObject:pe,modalPosition:Ie.ON_ROOT})]})}const Fn=o.div`
  position: absolute;
  right: 20px;
  display: flex;
  flex-direction: column-reverse;
...
`,$e=o.img`
  ...
  padding: 0;
  margin: 0;
`;function kt(){const t=H.useRef(null),[a,i]=H.useState(!1);Z();const n=()=>{i(r=>!r)},s=()=>{i(!1)};return e.jsxs(V,{flex:"0",ref:t,children:[e.jsx(Hn,{active:a,onClick:n}),a&&e.jsx(Un,{DropdownRef:t,isDropdownOpen:a,closeDropdown:s})]})}o.div`
  flex: 1;
  display: flex;
...
`,Wn="DD MMM, YYYY";function Kn({isChannelExpired:t,setIsChannelExpired:a,showEditChannel:i,destroyChannel:n}){var ge,q,Ce;const{account:s,chainId:r,wallet:w}=me(),{delegatees:x,channelDetails:c,canVerify:p,aliasDetails:{isAliasVerified:g,aliasAddrFromContract:u}}=_(I=>I.admin),{channelSettings:h}=_(I=>I.channels),{userPushSDKInstance:m}=_(I=>I.user),{handleConnectWalletAndEnableProfile:d}=l.useContext(Wt),{CHANNEL_ACTIVE_STATE:T,CHANNNEL_DEACTIVATED_STATE:P}=_(I=>I.channels),{processingState:$}=_(I=>I.channelCreation),[U,f]=l.useState([]),[S,A]=l.useState("");let{channelState:L}=c;L||(L=c.activation_status);const G=L===T,K=L===P,R=se.coreContractChain===r,B=ke(600),[N,y]=l.useState([s]),[E,k]=l.useState(void 0);_(I=>I.contracts);const C=so(),{isModalOpen:M,showModal:j,ModalComponent:pe}=Re(),re=de(),W=async()=>{m.signer||await d({wallet:w}),j()},xe=async I=>m.channel.delegate.add(lt(I,r)),oe=c.expiryTime?lo(((ge=c.expiryTime)==null?void 0:ge.toString())*1e3):"",F=c.expiryTime?co(((q=c.expiryTime)==null?void 0:q.toString())*1e3):!0,le=c.expiryTime?po(((Ce=c.expiryTime)==null?void 0:Ce.toString())*1e3,14):"";l.useEffect(()=>{c.channelType==st.TIMEBOUND&&(F||a(!0))},[F]),l.useEffect(()=>{},[c,p]),l.useEffect(()=>{!c||!R||async function(){const I=c.channelStartBlock.toString(),te=await new Ut(se.coreRPC).getBlock(+I),v=Ft(te.timestamp*1e3);A(v.format(Wn))}()},[c]),l.useEffect(()=>{s&&(!x||!x.length?k(s):k(R?x[0].channel:x[0].alias_address))},[x,s]),l.useEffect(()=>{s&&(async()=>{try{const I=lt(s,r),te=await m.channel.delegate.get({channel:I});if(te){const v=te.map(z=>z);v.unshift(s),y(v)}}catch(I){console.error(I)}})()},[s,r]);const he=async I=>{let te=m;if(!(!te.signer&&(te=await d({wallet:w}),!te)))return te.channel.delegate.remove(lt(I,r))},be=()=>{C(ho.ChannelSettings)};return e.jsxs(J,{children:[e.jsxs(Jn,{justifyContent:"flex-start",alignSelf:"stretch",children:[e.jsx(qn,{src:c.icon}),e.jsxs(Xe,{alignItems:"flex-start",padding:"5px 0px",children:[e.jsxs(ra,{children:[c.name,p&&e.jsx(Xn,{src:"/verify.png"})]}),e.jsxs(Xe,{alignItems:"flex-start",flex:"initial",padding:"5px 0px",children:[R&&u&&!g||!R&&!g?e.jsx(ia,{children:"Alias Network Setup Pending"}):e.jsxs(Yn,{justifyContent:"flex-start",children:[e.jsxs(ea,{children:[e.jsx("img",{style:{width:"15px"},src:"/subcount.svg",alt:"subscount"}),e.jsx(na,{children:c.subscriber_count})]}),e.jsxs(ta,{active:G,children:[K&&e.jsx(ct,{width:"12px",src:Do,margin:"0 5px 2px 0px",height:"30px"}),G?"Active":K?"Deactivated":"Blocked"]}),c.channelType==st.TIMEBOUND&&!t&&e.jsxs(V,{background:"#C5EFD1",flex:"0",borderRadius:"25px",margin:"0 0 10px 10px",height:"30px",children:[e.jsx(ct,{width:"16px",src:"svg/ExpiresTimer.svg",alt:"expiryTimer",padding:"0 6px 0 9px"}),e.jsxs(je,{color:"#30CC8B",fontWeight:"600",padding:"0 9px 0 0",children:["Expires on ",oe]})]}),c.channelType==st.TIMEBOUND&&t&&e.jsxs(V,{background:"#FFD8D8",flex:"0",borderRadius:"25px",margin:"0 0 10px 10px",height:"30px",children:[e.jsx(ct,{width:"16px",src:"svg/ExpiredTimer.svg",alt:"expiryTimer",padding:"0 6px 0 9px"}),e.jsxs(je,{color:"#E93636",fontWeight:"600",padding:"0 9px 0 0",children:["Expired on ",oe]})]})]}),S&&e.jsxs(aa,{children:["Created ",S]})]})]})]}),B&&e.jsxs(V,{zIndex:"1",padding:"0 0 15px 0",alignSelf:"center",display:"flex",gap:"8px",children:[!t&&R&&e.jsx(ne,{onClick:i,size:"small",variant:"outline",children:"Edit Channel"}),!t&&e.jsx(kt,{}),t&&R&&e.jsx(ne,{onClick:n,size:"small",variant:"danger",children:"Delete Channel"})]}),t&&e.jsx(J,{alignItems:"flex-start",children:e.jsxs(It,{margin:"25px 0 0 0",children:[e.jsx(je,{color:"#D53A94",children:"Note:"})," Channel will auto delete on"," ",e.jsx(je,{fontWeight:"600",children:le})]})}),e.jsx(J,{alignItems:"flex-start",children:e.jsx(It,{children:c.info})}),p&&e.jsx(Xe,{alignItems:"flex-start",padding:"5px 0px",children:e.jsx(sa,{children:e.jsxs(oa,{children:[e.jsx("span",{children:"verified by:"}),e.jsx(Qn,{src:U.icon}),e.jsx(Zn,{children:U.name})]})})}),$===0&&e.jsxs(J,{children:[e.jsx(Ue,{children:e.jsxs(Dt,{flex:"5",minWidth:"280px",self:"stretch",align:"stretch",margin:"10px 0px 30px 0px",radius:"20px",border:"1px solid #D4DCEA",children:[e.jsx(Qt,{title:"Notification Settings",description:"Customize notification preferences for users",Button:e.jsx(Fo,{onClick:be})}),e.jsx(Zt,{account:s,isAddress:!1,items:h[s],isLoading:!1,onClickEmptyListButton:be,emptyListButtonTitle:"Add Setting"})]})}),e.jsx(Ue,{children:e.jsxs(Dt,{flex:"5",minWidth:"280px",self:"stretch",align:"stretch",margin:"10px 0px 30px 0px",radius:"20px",border:"1px solid #D4DCEA",children:[e.jsx(Qt,{title:"Channel Delegates",description:"Delegates can send notifications on behalf of the channel",Button:e.jsx(Go,{onClick:W})}),e.jsx(Zt,{account:s,isAddress:!0,items:N,isLoading:!1,addressDropdownOptions:[{text:"Remove",onClick:he,icon:e.jsx(xo,{})}]})]})})]}),e.jsx(pe,{InnerComponent:tn,onConfirm:xe,toastObject:re,modalPosition:Ie.ON_ROOT})]})}const Xe=o(J)`
  @media (max-width: 767px) {
    align-items: center;
  }
`,Yn=o(V)`
...
`,ye=t=>t.trim().length==0;function ja(t,a){var i=new XMLHttpRequest;i.onload=function(){var n=new FileReader;n.onloadend=function(){a(n.result)},n.readAsDataURL(i.response)},i.open("GET",t),i.responseType="blob",i.send()}const va=t=>{var a=qo,i=t.split(";base64,").pop(),n=wo.from(i,"base64"),s=a(n);return s.width>128||s.height>128?(console.error("Image size check failed... returning"),{success:0,info:"Image size check failed, Image should be 128X128PX"}):(console.debug("Image verification",i.charAt(0)),i.charAt(0)==="/"?{success:1,info:"Image checks passed"}:i.charAt(0)==="i"?{success:1,info:"Image checks passed"}:{success:0,info:"Image extension should be jpg or png"})};function Ta({closeEditChannel:t,UploadLogoComponent:a,displayUplaodLogoModal:i}){const{account:n,provider:s}=me(),{channelDetails:r,aliasDetails:{isAliasVerified:w,aliasAddrFromContract:x}}=_(v=>v.admin),{epnsReadProvider:c,epnsWriteProvider:p}=_(v=>v.contracts),g=50,[u,h]=l.useState(r==null?void 0:r.name),[m,d]=l.useState(r==null?void 0:r.info),[T,P]=l.useState(r==null?void 0:r.url),[$,U]=l.useState(r==null?void 0:r.icon),[f,S]=l.useState(r==null?void 0:r.icon),[A,L]=l.useState(r==null?void 0:r.icon),[G,K]=l.useState(A),[R,B]=l.useState(null),[N,y]=l.useState(!1),[E,k]=l.useState({name:"",description:"",address:"",url:""}),[C,M]=l.useState(!1),[j,pe]=l.useState(0),[re,W]=l.useState(0),[xe,oe]=l.useState(!1),F=de();l.useEffect(()=>{n&&async function(){const v=await c.channelUpdateCounter(n);pe(g*(Number(v)+1))}()},[n]),l.useEffect(()=>{!n||!s||async function(){const v=await ei({address:n,provider:s,contractAddress:Ge.epnscore});W(parseInt(v));const z=parseInt(v);z>=j&&z!=0?y(!0):y(!1)}()},[n,s]);const le=async()=>{if(M(!0),!s)return;const v=s.getSigner(n);F.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{const z=await ii({signer:v,contractAddress:Ge.epnscore,amount:j-re});console.debug("response",z),z&&(M(!1),W(j),y(!0),F.showMessageToast({toastTitle:"Success",toastMessage:"Successfully approved Push!",toastType:"SUCCESS",getToastIcon:X=>e.jsx(fe,{size:X,color:"green"})}))}catch(z){console.error(z),z.code=="ACTION_REJECTED"?F.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:X=>e.jsx(Y,{size:X,color:"red"})}):(F.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in approving PUSH Token",toastType:"ERROR",getToastIcon:X=>e.jsx(Y,{size:X,color:"red"})}),console.error("Error --> %o",z),console.error({err:z}))}M(!1)},he=()=>{oe(!1)},be=ke(600),ge=l.useRef(null);ue(ge,()=>{he()});const q=()=>(k(""),ye(u)||ye(m)||ye(T)?(ye(u)&&k(v=>({...v,name:"Please, enter the channel name."})),ye(m)&&k(v=>({...v,description:"Please, enter the channel description"})),ye(T)&&k(v=>({...v,url:"Please, enter the channel url"})),!1):ai(u,125)?ai(T,125)?ni(T)?!0:(k(v=>({...v,url:"Channel URL is invalid! Please enter a valid url!"})),!1):(k(v=>({...v,url:"Channel Url should not exceed 125 characters! Please retry!"})),!1):(k(v=>({...v,name:"Channel Name should not exceed 125 characters! Please retry!"})),!1)),Ce=()=>!(u!==(r==null?void 0:r.name)||m!==(r==null?void 0:r.info)||T!==(r==null?void 0:r.url)||f!==(r==null?void 0:r.icon)),I=async v=>{try{if(!q())return;M(!0);const z=JSON.stringify({name:u,info:m,url:T,icon:f,aliasDetails:r.aliasDetails||yo({chainId:parseInt(r.chain_id),address:r.address})});console.debug(z);const X=await Yo(z);console.debug("IPFS storagePointer:",X);const Ze="1+"+X,et=Vt(Ze),tt=Gt(j.toString(),18);F.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const Be=await p.updateChannelMeta(n,et,tt,{gasLimit:1e6});console.debug(Be),await Be.wait(),M(!1),F.showMessageToast({toastTitle:"Success",toastMessage:"Channel Updated Successfully",toastType:"SUCCESS",getToastIcon:Te=>e.jsx(fe,{size:Te,color:"green"})}),setTimeout(()=>{window.location.reload()},2e3)}catch(z){M(!1),console.error(z.message),z.code=="ACTION_REJECTED"?F.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:X=>e.jsx(Y,{size:X,color:"red"})}):(F.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in updating channel Details",toastType:"ERROR",getToastIcon:X=>e.jsx(Y,{size:X,color:"red"})}),console.error("Error --> %o",z),console.error({err:z}))}},te=async v=>{await ti({noOfTokens:v,provider:s,account:n})};return l.useEffect(()=>{A&&(console.debug("Image cropped",A),ja(A,function(v){const z=va(v);console.debug("response",z),z.success&&(console.debug("Cropped Image....",A),S(A))}))},[A]),e.jsxs(Aa,{ref:ge,children:[e.jsx(a,{InnerComponent:ha,InnerComponentProps:{setChannelLogo:U,channelLogo:$,croppedImage:A,setCroppedImage:L,setChannelFile:S,imageSrc:G,setImageSrc:K,imageType:R,setImageType:B,errorInfo:E,setErrorInfo:k},modalPosition:Ie.ON_PARENT}),e.jsxs(Sa,{children:[e.jsxs(Ea,{children:[e.jsx(ka,{src:$}),e.jsx(ne,{variant:"secondary",onClick:()=>{i(),oe(!0)},children:"Upload Logo"})]}),!be&&e.jsx(Ra,{}),e.jsx(la,{channelName:u,setChannelName:h,channelInfo:m,setChannelInfo:d,channelURL:T,setChannelURL:P,editChannel:I,errorInfo:E,setErrorInfo:k})]}),e.jsxs(Ia,{children:[e.jsxs("div",{children:[e.jsx(Da,{children:"Channel edit fee"}),e.jsx(La,{children:"Editing channel details requires fees to be deposited"})]}),e.jsxs(V,{flex:"0",children:[N?e.jsx(Ma,{src:xa}):null,e.jsxs(Na,{children:[j," PUSH"]})]})]}),e.jsx(Xt,{noOfPushTokensToCheck:j,containerProps:{width:"100%"},onMintPushToken:te}),C?e.jsx(e.Fragment,{children:e.jsxs(za,{children:[e.jsx(Spinner,{size:42,color:O.COLORS.PRIMARY_PINK,type:ot.PROCESSING}),e.jsx($a,{children:"Verifying Transaction"})]})}):e.jsx(e.Fragment,{children:e.jsxs(Ba,{children:[e.jsx(ne,{onClick:t,variant:"outline",size:"large",children:"Cancel"}),re>=j?e.jsx(ne,{disabled:Ce(),onClick:I,size:"large",children:"Save Changes"}):e.jsx(ne,{onClick:le,size:"large",children:"Approve PUSH"})]})})]})}const Aa=o(J)`
  padding: 0px;
...
`,Pa=10;let Lt=null;const _a=()=>{Z();const{account:t,chainId:a,wallet:i}=me(),{channelDetails:n,delegatees:s,aliasDetails:{aliasAddr:r,aliasEthAddr:w,isAliasVerified:x,aliasAddrFromContract:c}}=_(y=>y.admin),{processingState:p}=_(y=>y.channelCreation),{epnsWriteProvider:g}=_(y=>y.contracts),{userPushSDKInstance:u}=_(y=>y.user);l.useContext(Wt);const h=n&&n!=="unfetched",m=de(),d=Me(),[T,P]=l.useState(!1);l.useState(!0);const[$,U]=l.useState(!1),f=se.coreContractChain===a,S=ke(600);l.useEffect(()=>{if(!f||!n||c||n==="unfetched")return;const y=bo(n);if(y){const{address:E,chainId:k}=y;d(Co(E)),d(jo(k))}else d(Ee(0))},[n,c]);const A=async y=>{let{alias_address:E=null,is_alias_verified:k=null}=await To({userPushSDKInstance:u,address:y}).then(C=>C);return E=="NULL"&&(E=null),{aliasAddress:E,aliasVerified:k}};l.useEffect(()=>{!f||!c||p===0||(Lt=setInterval(async()=>{const{aliasAddress:y,aliasVerified:E}=await A(t);y?(d(vo(y)),E?(d(dt(!0)),d(Ee(0))):(d(Ee(2)),d(dt(!1)))):p!=0&&p!=1&&d(Ee(1))},Pa*1e3))},[c]),r!==null&&clearInterval(Lt);const L=async()=>{try{m.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const y=await g.destroyTimeBoundChannel(t,{gasLimit:1e6});console.debug(y),console.debug("Check: "+t),await y.wait(),m.showMessageToast({toastTitle:"Success",toastMessage:"Successfully deleted the channel",toastType:"SUCCESS",getToastIcon:E=>e.jsx(Y,{size:E,color:"green"})}),d(rt(null))}catch(y){console.error(y),y.code=="ACTION_REJECTED"?m.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:E=>e.jsx(Y,{size:E,color:"red"})}):m.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in deleting the channel",toastType:"ERROR",getToastIcon:E=>e.jsx(Y,{size:E,color:"red"})})}},G=()=>{U(!0)},K=()=>{U(!1)},{isModalOpen:R,showModal:B,ModalComponent:N}=Re();return e.jsxs(V,{children:[(n==="unfetched"||p===null)&&e.jsx(jt,{}),n!=="unfetched"&&e.jsxs(J,{justifyContent:p===0&&"flex-start",height:"fit-content",children:[!n&&p===0&&e.jsx(Xo,{}),h&&p!==null&&e.jsx(Oa,{children:$?e.jsx(Ta,{closeEditChannel:K,UploadLogoComponent:N,displayUplaodLogoModal:B,isUploadLogoModalOpen:R}):e.jsxs(e.Fragment,{children:[n&&!S&&e.jsxs(V,{zIndex:"1",gap:"8px",children:[!T&&f&&e.jsx(ne,{onClick:G,size:"small",variant:"outline",children:"Edit Channel"}),!T&&e.jsx(kt,{}),T&&f&&e.jsx(ne,{onClick:L,size:"small",variant:"danger",children:"Delete Channel"})]}),n?e.jsx(Kn,{isChannelExpired:T,setIsChannelExpired:P,showEditChannel:G,destroyChannel:L}):""]})}),p!==0&&p!==null&&h&&!$&&e.jsx(e.Fragment,{children:e.jsx(Wi,{aliasEthAccount:w,setAliasVerified:dt})})]})]})},Oa=o(J)`
  align-items: center;
  align-self: center;
...
`;se.coreContractChain;function Ua(){Ao.pageview("/channel_dashboard");const[t,a]=H.useState(!0),[i,n]=H.useState(null),s=()=>n(null);return H.useEffect(()=>{i&&s()},[i]),e.jsxs(e.Fragment,{children:[t?e.jsx(_a,{}):e.jsx(jt,{}),i&&e.jsx(Lo,{notification:i,clearToast:s})]})}o.div`
  flex: 1;
  display: flex;

  margin-bottom: 15px;
  overflow: hidden;
`;let Nt;oi=()=>e.jsx(Nt,{children:e.jsx(Ua,{})}),Nt=o(So)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
