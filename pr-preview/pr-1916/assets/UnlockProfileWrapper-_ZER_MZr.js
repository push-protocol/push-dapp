...
`,T=d(X)`
  ...
  gap: 16px;
  display: flex;
`;P=(e=>(e.BOTTOM_BAR="bottombar",e.MODAL="modal",e))(P||{});let S,O;S={type:"modal"},H=({type:e=S.type,showConnectModal:n=!1,description:o,onClose:p,modalType:l="portal"})=>{const w=e==="modal"&&l==="portal",u=e==="modal"&&l==="container",{isModalOpen:b,showModal:i,ModalComponent:y}=d2();return c.useEffect(()=>{u&&n&&i()},[e,n]),t.jsxs(t.Fragment,{children:[e==="bottombar"&&t.jsx(O,{className:e,children:t.jsx(f,{InnerComponentProps:{type:e,description:o},onClose:p})}),w&&t.jsx(c2,{isOpen:n,onClose:p,size:"small",acceptButtonProps:null,cancelButtonProps:null,children:t.jsx(f,{InnerComponentProps:{type:e,description:o},onClose:p})}),u&&t.jsx(y,{InnerComponent:f,InnerComponentProps:{type:e,description:o},modalRadius:"24px",modalBorder:!1,modalPosition:p2.ON_PARENT})]})},O=d(h)`
  flex: initial;
  border-radius: 24px;
  padding: 24px;
  align-items: center;
