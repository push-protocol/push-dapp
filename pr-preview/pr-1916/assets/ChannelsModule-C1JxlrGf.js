...
`,Jn=s(Vn)`
  ...
  ${e=>e.active&&`
    ...
    `}
`,Kn=20,Zn=({channelID:e,loadTeaser:r,playTeaser:a,minimal:n,profileType:i})=>{const c=de(),{data:l,isLoading:p}=an(e,1,Kn),{data:b,isLoading:d}=bo(e),m=Kt();return t.jsxs(Yn,{children:[t.jsx(Xn,{flex:"initial",alignItems:"flex-start",padding:"0px",children:t.jsx(sn,{onClick:()=>{m(tt.Channels)}})}),t.jsxs(t.Fragment,{children:[b&&!d&&t.jsx(ct,{channelObjectProp:b,loadTeaser:r,playTeaser:a,minimal:n,profileType:i}),!d&&t.jsxs(ei,{children:[t.jsx(ee,{fontSize:"20px",fontWeight:"500",color:c.color,children:"Recent Notifications"}),t.jsx(ti,{color:c.color,children:"Showing preview of the latest non-encrypted notifications sent by the channel."})]}),t.jsxs(qn,{children:[p&&t.jsx(ne,{type:ie.SEAMLESS,spinnerSize:40}),!(l!=null&&l.length)&&!p&&t.jsx("div",{style:{textAlign:"center"},children:t.jsx(en,{title:"You currently have no notifications, try subscribing to some channels."})}),l==null?void 0:l.map((f,y)=>{const v=f.message.payload;return t.jsx(Qn,{children:t.jsx(wo,{notificationTitle:v.title,notificationBody:v.body,cta:v.cta,image:v.embed,app:f.channel.name,icon:f.channel.icon,url:f.channel.url,chainName:f.source,theme:c.scheme})},`${f.payload_id}`)})]})]})]})},Yn=s.div`
  display: flex;
  flex: 1;
  flex-direction: column;
