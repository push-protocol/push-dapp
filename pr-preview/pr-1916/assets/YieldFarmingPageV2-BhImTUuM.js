...
`,Ae=i(be)`
  ...
  border-radius: 5px;
  gap: 5px;
`,Rs=({setActiveTab:t})=>{const{provider:s,account:o,chainId:l}=ye(),[r,a]=n.useState(),[h,x]=n.useState(),[d,u]=n.useState(),[v,E]=n.useState(),[_,B]=n.useState(),[N,$]=n.useState(null),[G,O]=n.useState(null),[ee,F]=n.useState(null),[ae,Y]=n.useState(null),[H,k]=n.useState(null),V=s==null?void 0:s.getSigner(o),M=n.useCallback(async()=>{const U=await Re.getInstance().getPoolStats(s);$({...U})},[h,r,v,d,_,s]),w=n.useCallback(async()=>{const U=await Re.getInstance().getPoolStats(s),Q=await Re.getInstance().getLPPoolStats(U);O({...Q})},[h,r,v,d,_,s]),R=n.useCallback(async()=>{},[]),K=n.useCallback(async()=>{const U=await Re.getInstance().getUserDataLP();F({...U})},[h,r,v,d,_]),we=n.useCallback(async()=>{const[U,Q]=await Re.getInstance().getUserDataPUSH(s);k({...U}),Y({...Q})},[h,r,v,d,_,s]);return n.useEffect(()=>{if(l!==ge.coreContractChain&&l!==ge.mainnetCoreContractChain)return;O(null),F(null),k(null),Y(null);let U=new b(p.stakingV2,y.stakingV2,V),Q=new b(p.pushToken,y.pushToken,V),Te=new b(p.pushCoreV2,y.pushCoreV2,V),f=new b(p.yieldFarmLP,y.yieldFarming,V),m=new b(p.uniswapV2Router02,y.uniswapV2Router02,V);if(x(U),a(Q),E(Te),u(f),B(m),V&&o){var g=s==null?void 0:s.getSigner(o);let C=new b(p.stakingV2,y.stakingV2,g),S=new b(p.pushToken,y.pushToken,g),j=new b(p.pushCoreV2,y.pushCoreV2,g),A=new b(p.yieldFarmLP,y.yieldFarming,g),z=new b(p.uniswapV2Router02,y.uniswapV2Router02,g);x(C),a(S),E(j),u(A),B(z)}Re.getInstance().init(o,U,Q,Te,f,m),M(),K(),w(),we()},[o,l]),e.jsxs(e.Fragment,{children:[e.jsx(wt,{logo:"announcement",title:"New V2 Pools are now Live! Stake or migrate now.",body:"Users who were part of the previous Push staking program, need to migrate to new pools to continue earning rewards. Click",setActiveTab:t}),e.jsx(ts,{getLpPoolStats:w,poolStats:N,setPoolStats:$}),e.jsx(Xt,{poolStats:N}),e.jsxs(Fs,{children:[e.jsx(Ts,{userDataPush:ae,getUserDataPush:we,PUSHPoolstats:H,getPUSHPoolStats:R}),e.jsx(ls,{lpPoolStats:G,userDataLP:ee,getLpPoolStats:w,getUserDataLP:K})]})]})},Fs=i(T)`
  @media (max-width: 1300px) {
    flex-direction: column;
  }
