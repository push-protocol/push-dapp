import{e7 as d,er as O,fE as re,d$ as f,fF as ae,e2 as t,dZ as G,f3 as Q,f2 as X,em as P,fG as ie,fH as Z,e9 as q,eY as v,fI as le,fJ as ce,fK as de,es as pe,f0 as ge,e4 as ee,e5 as te,fL as k,fM as he,fN as ne,fO as E,f8 as se,fP as ue,fQ as xe,fR as fe,__tla as we}from"./index-CMjHumvI.js";import{u as Se,n as me}from"./notifSetting-DrLKauYy.js";let I,oe,je=Promise.all([(()=>{try{return we}catch{}})()]).then(async()=>{let A,_,$,B,W,V,H,F,z,U,N,J,K,L,Y;I=({children:n,renderDropdownContainer:p,showDropdown:a,toggleDropdown:g,closeDropdown:s,containerPadding:u,centerOnMobile:i})=>{const c=f.useRef(null),l=f.useRef(null);return ae(c,l,s),t.jsxs(A,{ref:c,onClick:g,children:[n,a&&t.jsx(_,{containerPadding:u,centerOnMobile:i,children:t.jsx("div",{ref:l,onClick:e=>e.stopPropagation(),children:p})})]})},A=d.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
