import{e7 as s,eR as t,eS as l,eT as E,eV as U,f2 as u,dZ as f,f3 as T,ek as e,e2 as a,f4 as h,eb as N,em as D,e8 as L,__tla as $}from"./index-BI8iCxJK.js";import{S as p,__tla as x}from"./SendNotifications-DWgoBNYY.js";import{__tla as O}from"./index-DBTraUOb.js";import{__tla as R}from"./Tag-CF37hDEd.js";import{__tla as g}from"./TransitionGroupContext-DTYxJTZU.js";import{__tla as G}from"./useIsFocusVisible-BV4na-nq.js";import{__tla as J}from"./useEventCallback-BVObTnan.js";let A,y=Promise.all([(()=>{try{return $}catch{}})(),(()=>{try{return x}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return R}catch{}})(),(()=>{try{return g}catch{}})(),(()=>{try{return G}catch{}})(),(()=>{try{return J}catch{}})()]).then(async()=>{D.coreContractChain;function M(){U.pageview("/send_notificaiton"),u(),f(),T(n=>n.contracts),T(n=>n.admin),D.coreContractChain;const[r,j]=e.useState(2),[d,b]=e.useState(!0);e.useState(null),e.useState(null);const[c,w]=e.useState(!0);e.useState([]);const[_,I]=e.useState(null),m=()=>I(null);return e.useEffect(()=>{_&&m()},[_]),a.jsx(i,{children:r===2&&d?a.jsxs(a.Fragment,{children:[!c&&a.jsx(h,{replace:!0,to:"/dashboard"}),c&&a.jsx(p,{})]}):a.jsx(S,{children:"Channel details are being loaded, please wait\u2026"})})}let i,S,o;i=s(N)`
  align-items: center;
  align-self: center;
