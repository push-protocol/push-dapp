import{b6 as Oe,a_ as h,aZ as e,bA as k,dm as Ge,bV as se,b7 as l,b1 as Fe,c1 as Je,bQ as Ve,dn as E,bB as qe,dp as He,dq as Ke,bD as le,d0 as de,b9 as pe,c_ as ce,cw as ue,c7 as We,by as f,c8 as Ze,bL as Y,df as xe,d1 as q,bd as he,bO as ee,bN as Xe,cP as Qe,c3 as Ye,bK as et,c4 as tt,dr as rt,bz as O,bC as nt,ba as ge,b3 as it,a$ as at,__tla as ot}from"./index-Bmx9PYec.js";import{__tla as st}from"./Tag-XMziD7m4.js";import{I as lt,__tla as dt}from"./index.esm-BugnNCXm.js";import{M as pt,g as ct,S as ut,F as xt,m as ht,a as gt,C as mt,b as ft,__tla as bt}from"./ChannelInfoList-BX_0QphD.js";import{I as St,__tla as yt}from"./SendNotifications-Q-Aglpff.js";import{A as wt,__tla as Nt}from"./EmptyNotificationSettings-G2heHdFk.js";import{__tla as jt}from"./TransitionGroupContext-d_U_HM2j.js";import{__tla as Tt}from"./index.es-Cak9dSFn.js";import"./browser-CeceZ__e.js";import{__tla as Et}from"./index-VQKHLdeF.js";import{__tla as Ct}from"./index.esm-0jOarfwy.js";let me,At=Promise.all([(()=>{try{return ot}catch{}})(),(()=>{try{return st}catch{}})(),(()=>{try{return dt}catch{}})(),(()=>{try{return bt}catch{}})(),(()=>{try{return yt}catch{}})(),(()=>{try{return Nt}catch{}})(),(()=>{try{return jt}catch{}})(),(()=>{try{return Tt}catch{}})(),(()=>{try{return Et}catch{}})(),(()=>{try{return Ct}catch{}})()]).then(async()=>{function fe(r){return Oe({tag:"svg",attr:{viewBox:"0 0 256 256",fill:"currentColor"},child:[{tag:"path",attr:{d:"M230.14,70.54,185.46,25.85a20,20,0,0,0-28.29,0L33.86,149.17A19.85,19.85,0,0,0,28,163.31V208a20,20,0,0,0,20,20H92.69a19.86,19.86,0,0,0,14.14-5.86L230.14,98.82a20,20,0,0,0,0-28.28ZM91,204H52V165l84-84,39,39ZM192,103,153,64l18.34-18.34,39,39Z"}}]})(r)}const L=r=>r.trim().length==0,be=({setErrorInfo:r,lowerLimit:x,upperLimit:S,type:y,settingName:i,defaultValue:o,sliderStep:w})=>{r(void 0);let d=!1;return L(i)&&(r(a=>({...a,settingName:"Setting Name is required"})),d=!0),(y===2||y===3)&&(L(x)&&(r(a=>({...a,lowerLimit:"Minimum range is required"})),d=!0),L(S)&&(r(a=>({...a,upperLimit:"Maximum range is required"})),d=!0),(typeof o=="string"?L(o):L(o.lower)||L(o.upper))&&(typeof o=="string"?r(a=>({...a,default:"Default value is required"})):(L(o.lower)&&r(a=>({...a,defaultStart:"Default start value is required"})),L(o.upper)&&r(a=>({...a,defaultEnd:"Default end value is required"}))),d=!0),L(w)&&(r(a=>({...a,sliderStep:"Slider step is required"})),d=!0),!L(x)&&!L(S)&&!L(w)&&(Number(x)<0&&(r(a=>({...a,lowerLimit:"Minimum range should be greater than 0"})),d=!0),Number(S)<0&&(r(a=>({...a,upperLimit:"Maximum range should be greater than 0"})),d=!0),Number(x)>Number(S)&&(r(a=>({...a,lowerLimit:"Minimum range should be less than maximum range"})),d=!0),typeof o=="string"?(Number(o)<Number(x)||Number(o)>Number(S))&&(r(a=>({...a,default:"Default value not in range"})),d=!0):((Number(o.lower)<Number(x)||Number(o.lower)>Number(S))&&(r(a=>({...a,defaultStart:"Default value not in range"})),d=!0),(Number(o.upper)<Number(x)||Number(o.upper)>Number(S)||Number(o.lower)>Number(o.upper))&&(r(a=>({...a,defaultEnd:"Default value not in range"})),d=!0)),Number(w)<=0&&(r(a=>({...a,sliderStep:"Slider step should be greater than 0"})),d=!0),Number(w)>Number(S)-Number(x)&&(r(a=>({...a,sliderStep:"Slider step should be less than range"})),d=!0))),!d},Se=({checked:r,onChange:x})=>e.jsx(ye,{id:"Checkbox-switch",type:"checkbox",checked:r,onChange:x}),ye=h.input`
  cursor: pointer;
  z-index: 1;
  border-radius: 15px;
  width: 16px;
