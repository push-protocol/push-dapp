...
`,Lt=a(N)`
  ...
  font-size: 0.625rem;
  text-align:left;
`,ge="data:image/svg+xml,%3csvg%20width='17'%20height='17'%20viewBox='0%200%2017%2017'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20clip-path='url(%23clip0_15284_45077)'%3e%3cpath%20d='M8.5%2014.5C11.8137%2014.5%2014.5%2011.8137%2014.5%208.5C14.5%205.18629%2011.8137%202.5%208.5%202.5C5.18629%202.5%202.5%205.18629%202.5%208.5C2.5%2011.8137%205.18629%2014.5%208.5%2014.5Z'%20stroke='%23797D8F'%20stroke-width='1.2'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M8%208C8.13261%208%208.25979%208.05268%208.35355%208.14645C8.44732%208.24021%208.5%208.36739%208.5%208.5V11C8.5%2011.1326%208.55268%2011.2598%208.64645%2011.3536C8.74021%2011.4473%208.86739%2011.5%209%2011.5'%20stroke='%23797D8F'%20stroke-width='1.2'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M8.25%206.5C8.66421%206.5%209%206.16421%209%205.75C9%205.33579%208.66421%205%208.25%205C7.83579%205%207.5%205.33579%207.5%205.75C7.5%206.16421%207.83579%206.5%208.25%206.5Z'%20fill='%23797D8F'/%3e%3c/g%3e%3cdefs%3e%3cclipPath%20id='clip0_15284_45077'%3e%3crect%20width='16'%20height='16'%20fill='white'%20transform='translate(0.5%200.5)'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e",ot=({poolName:t,userData:s,PoolStats:i,poolAddress:p,getUserData:n,tokenAddress:o,setActiveTab:h})=>{const{account:x,provider:d,wallet:u,isWalletConnected:v,connect:E}=ke(),[W,B]=r.useState(!1),[L,V]=r.useState(!1),[G,O]=r.useState(!1),[X,M]=r.useState(null),[ae,Y]=r.useState(null),[H,P]=r.useState(null),[$,U]=r.useState(0),w=ze(),R=_e(),J=async()=>{if(!v){E();return}if(!L){if((s==null?void 0:s.totalAvailableReward)==0){P("No Rewards to Claim"),V(!1);return}V(!0);var m=d.getSigner(x);new C(p,k.yieldFarming,m).massHarvest().then(async g=>{w.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{await d.waitForTransaction(g.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:b=>e.jsx(xe,{size:b,color:"green"})}),n(),V(!1)}catch(b){w.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${b.name}+ ")`,toastType:"ERROR",getToastIcon:j=>e.jsx(D,{size:j,color:"red"})}),V(!1)}}).catch(g=>{w.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Cancelled!",toastType:"ERROR",getToastIcon:b=>e.jsx(D,{size:b,color:"red"})}),V(!1)})}},me=async()=>{if(!v){E();return}if(W)return;B(!0);const m=_(s.epochStakeNext);if(m==0){Y("Nothing to unstake, Stake Now in new reward program."),B(!1);return}var g=d.getSigner(x);let b=new C(l.staking,k.staking,g);await b.balanceOf(x,o),b.withdraw(o,I.from(m).mul(I.from(10).pow(18))).then(async j=>{w.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{await d.waitForTransaction(j.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:f=>e.jsx(xe,{size:f,color:"green"})}),B(!1),n()}catch(f){console.error("Error",f),w.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${f.name}+ ")`,toastType:"ERROR",getToastIcon:A=>e.jsx(D,{size:A,color:"red"})}),B(!1)}}).catch(j=>{w.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Cancelled! ${j.message}`,toastType:"ERROR",getToastIcon:f=>e.jsx(D,{size:f,color:"red"})}),B(!1)})},F=async()=>{if(!v){E();return}if(G)return;let m=3;const g=_(s.epochStakeNext);if(g==0){w.showMessageToast({toastTitle:"Error",toastMessage:"Nothing to Withdraw!",toastType:"ERROR",getToastIcon:Z=>e.jsx(D,{size:Z,color:"red"})}),O(!1),M(null);return}var b=d.getSigner(x);let j=new C(l.staking,k.staking,b);const f=o===l.pushToken?l.pushCoreV2:l.stakingV2;var A=new C(o,k.pushToken,b);let z=await A.allowance(x,f),te=_(z);parseInt(te)>=parseInt(g)?(m=2,U(50)):(m=3,U(33)),O(!0),M(`Withdrawing 1/${m}`);let se;se=j.withdraw(o,I.from(g).mul(I.from(10).pow(18))),se.then(async Z=>{if(w.showLoaderToast({loaderMessage:"Withdrawing! Please Wait..."}),await d.waitForTransaction(Z.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Successfully withdrawn!",toastType:"SUCCESS",getToastIcon:ce=>e.jsx(xe,{size:ce,color:"green"})}),o===l.pushToken){var Q=new C(o,k.pushToken,b);let ce=await Q.allowance(x,l.pushCoreV2),oe=_(ce);parseInt(oe)>=parseInt(g)?we(Z,g,m):(Z=Q.approve(l.pushCoreV2,I.from(g).mul(I.from(10).pow(18))),M(`Approving 2/${m}`),U(66),Z.then(async ne=>{w.showLoaderToast({loaderMessage:"Approving! Please Wait..."}),await d.waitForTransaction(ne.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Successfully Approved!",toastType:"SUCCESS",getToastIcon:Te=>e.jsx(xe,{size:Te,color:"green"})}),we(ne,g,m)}).catch(ne=>{console.error("Error in approving 2",ne),w.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Failed! Could Not Approve",toastType:"ERROR",getToastIcon:Te=>e.jsx(D,{size:Te,color:"red"})}),O(!1),M(null),n(),U(0)}))}else{var Q=new C(o,k.pushToken,b);let oe=await Q.allowance(x,l.stakingV2),ne=_(oe);parseInt(ne)>=parseInt(g)?q(Z,g,m):(Z=Q.approve(l.stakingV2,I.from(g).mul(I.from(10).pow(18))),M(`Approving 2/${m}`),U(66),Z.then(async Te=>{w.showLoaderToast({loaderMessage:"Approving! Please Wait..."}),await d.waitForTransaction(Te.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Successfully Approved!",toastType:"SUCCESS",getToastIcon:tt=>e.jsx(xe,{size:tt,color:"green"})}),q(Te,g,m)}).catch(Te=>{console.error("Error in approving",Te),w.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Failed! Could Not Approve",toastType:"ERROR",getToastIcon:tt=>e.jsx(D,{size:tt,color:"red"})}),O(!1),M(null),n(),U(0)}))}}).catch(Z=>{console.error("Error in withdrawing: ",Z),w.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Failed! Could Not Withdraw!",toastType:"ERROR",getToastIcon:Q=>e.jsx(D,{size:Q,color:"red"})}),O(!1),M(null),U(0)})},q=async(m,g,b)=>{if(!v){E();return}var j=d.getSigner(x),f=new C(l.stakingV2,k.stakingV2,j);M(`Staking ${b}/${b}`),U(100),m=f.deposit(o,I.from(g).mul(I.from(10).pow(18))),m.then(async A=>{w.showLoaderToast({loaderMessage:"Depositing to V2 ! Please Wait..."}),await d.waitForTransaction(A.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!Successfully Deposited the UNI-V2 Token to V2 ",toastType:"SUCCESS",getToastIcon:z=>e.jsx(xe,{size:z,color:"green"})}),O(!1),n(),M(null),h(0)}).catch(A=>{console.error("Error in depositing: ",A),w.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Failed! Could Not Deposit the Amount",toastType:"ERROR",getToastIcon:z=>e.jsx(D,{size:z,color:"red"})}),O(!1),n(),M(null),U(0)})},we=async(m,g,b)=>{if(!v){E();return}var j=d.getSigner(x);let f=new C(l.pushCoreV2,k.pushCoreV2,j);M(`Staking ${b}/${b}`),U(100),m=f.stake(I.from(g).mul(I.from(10).pow(18))),m.then(async A=>{w.showLoaderToast({loaderMessage:"Depositing to V2 ! Please Wait..."}),await d.waitForTransaction(A.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed! Successfully Deposited the Push Token to V2 ",toastType:"SUCCESS",getToastIcon:z=>e.jsx(xe,{size:z,color:"green"})}),O(!1),n(),M(null),h(0)}).catch(A=>{console.error("Error in depositing: ",A),w.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Failed! Could Not Deposit Push Token",toastType:"ERROR",getToastIcon:z=>e.jsx(D,{size:z,color:"red"})}),O(!1),n(),M(null),U(0)})};r.useEffect(()=>{P(null),Y(null)},[x]);const S=Ee(600);return e.jsxs(Vt,{margin:t==="UNI-V2"?" 10px 0 10px 10px ":"  10px 10px 10px 0",children:[e.jsx(y,{margin:"0px 0px 20px 0",children:i?e.jsxs(e.Fragment,{children:[e.jsxs($t,{children:[t==="UNI-V2"?"Uniswap V2 Staking Pool":"PUSH Staking Pool ",e.jsx(Bt,{children:"Deprecated"})]}),e.jsxs(Xe,{children:["Current APR"," ",e.jsx(je,{color:"#D53A94",fontWeight:"600",children:"0%"})]})]}):e.jsxs(Ue,{padding:"15px 15px 0 15px",children:[e.jsx(c,{height:"15px",width:"234px",margin:"0 0 10px 0"}),e.jsx(c,{height:"15px",width:"112px"})]})}),e.jsxs(y,{children:[e.jsxs(Wt,{border:`1px solid ${R.stakingBorder}`,borderRadius:"16px",children:[e.jsx(y,{margin:S?"0px 6px 0 0 ":"0px 18px 0px 0px",padding:S?" 7px":"10px",children:i?e.jsxs(e.Fragment,{children:[e.jsx(Xe,{children:"Current Reward"}),e.jsx(N,{fontSize:S?"18px":"24px",fontWeight:"600",color:"#D53A94",letterSpacing:"normal",children:"0 PUSH"})]}):e.jsxs(Ue,{padding:S?"0px":"5px 15px 0 15px",children:[e.jsx(c,{height:"12px",width:S?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(c,{height:"12px",width:S?"65px":"100px}"})]})}),e.jsx(Ot,{width:"10px",height:"100%"}),e.jsx(y,{margin:S?"0px 6px 0 0 ":"0px 18px 0px 0px",padding:S?" 7px":"10px",children:i?e.jsxs(e.Fragment,{children:[e.jsx(Xe,{children:"Total Staked"}),e.jsxs(Ht,{fontSize:S?"18px":"24px",fontWeight:"600",letterSpacing:"normal",children:[ee(_(i==null?void 0:i.poolBalance))," ",t=="UNI-V2"?"UNI-V2":"PUSH"]})]}):e.jsxs(Ue,{padding:S?"0px":"5px 15px 0 15px",children:[e.jsx(c,{height:"12px",width:S?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(c,{height:"12px",width:S?"65px":"100px}"})]})})]}),e.jsx(T,{alignSelf:"end",margin:"12px 13px 24px 0px",color:"#575D73",letterSpacing:"normal",children:i?e.jsxs(e.Fragment,{children:[e.jsx(nt,{padding:"0px 5px 0px 0px",children:"Current Epoch"}),e.jsx(nt,{margin:"0 0 0 5px",children:"100 / 100"})]}):e.jsx(Ue,{padding:"6px 0px 0 15px",children:e.jsx(c,{height:"17px",width:"124px"})})}),e.jsx(_t,{children:s?e.jsxs(y,{children:[e.jsxs(T,{justifyContent:"space-between",margin:S?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ie,{children:["User Deposit",e.jsx(Ne,{children:e.jsx(K,{ToolTipTitle:"User Deposited",ToolTipBody:`Amount of ${t} Token User Staked`,children:e.jsx(re,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(De,{children:[" ",_(s==null?void 0:s.epochStakeNext)," ",t=="UNI-V2"?"UNI-V2":"PUSH"]})]}),e.jsxs(T,{justifyContent:"space-between",margin:S?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ie,{children:["Rewards Claimed",e.jsx(Ne,{children:e.jsx(K,{ToolTipTitle:"Rewards Claimed",ToolTipBody:"Amount of Push Claimed by User",children:e.jsx(re,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(De,{children:[" ",ee(((s==null?void 0:s.totalAccumulatedReward)-(s==null?void 0:s.totalAvailableReward)).toFixed(2))," ","PUSH"]})]}),e.jsxs(T,{justifyContent:"space-between",margin:S?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ie,{children:["Current Epoch Reward",e.jsx(Ne,{children:e.jsx(K,{ToolTipTitle:"Current Epoch Reward",ToolTipBody:"Displays the approximate latest reward amount for current epoch",children:e.jsx(re,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsx(De,{children:"0 PUSH"})]}),e.jsxs(T,{justifyContent:"space-between",margin:S?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Ie,{children:["Available for Claiming",e.jsx(Ne,{children:e.jsx(K,{ToolTipTitle:"Available for Claiming",ToolTipBody:"Amount of Push Token Available to claim",children:e.jsx(re,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(De,{children:[ee(s==null?void 0:s.totalAvailableReward)," PUSH"]})]})]}):e.jsxs(Ce,{padding:"16px 15px 16px 15px",width:"100%",maxWidth:" -webkit-fill-available",borderRadius:"5px",children:[e.jsxs(T,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(c,{height:"12px",width:"164px"}),e.jsx(c,{height:"12px",width:"72px"})]}),e.jsxs(T,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(c,{height:"12px",width:"164px"}),e.jsx(c,{height:"12px",width:"72px"})]}),e.jsxs(T,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(c,{height:"12px",width:"164px"}),e.jsx(c,{height:"12px",width:"72px"})]}),e.jsxs(T,{justifyContent:"space-between",children:[e.jsx(c,{height:"12px",width:"164px"}),e.jsx(c,{height:"12px",width:"72px"})]})]})})]}),e.jsx(Gt,{padding:S?"0px ":"0px 14px",margin:"24px 0px 0px 0px",children:s?e.jsxs(e.Fragment,{children:[e.jsx(rt,{children:_(s==null?void 0:s.epochStakeNext)==="0"?e.jsx(K,{error:!0,ToolTipTitle:"Nothing to Withdraw, so you cannot Migrate.",ToolTipWidth:"16rem",bottom:"-50px",margin:"0 0 15px 0",children:e.jsx(Me,{border:"none",cursor:"default",background:R.disableButtonBg,color:R.disabledButtonText,children:e.jsx(lt,{children:!G&&X==null&&e.jsxs(Ge,{color:R.disabledButtonText,weight:"400",cursor:"default",children:["Migrate to ",t==="UNI-V2"?"UNI-V2 ":"PUSH Fee"," Pool"]})})})}):e.jsxs(Yt,{onClick:F,children:[e.jsx(Kt,{style:{width:`${$}%`}}),e.jsxs(lt,{children:[!G&&X==null&&e.jsxs(Ge,{color:"#FFF",weight:"400",cursor:"pointer",children:["Migrate to ",t==="UNI-V2"?"UNI-V2 ":"PUSH Fee"," Pool"]}),G&&X!=null&&e.jsx(le,{type:pe.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:X,titleColor:"#FFF"})]})]})}),e.jsxs(rt,{children:[_(s==null?void 0:s.epochStakeNext)==="0"?e.jsx(K,{error:!0,ToolTipTitle:ae||"Nothing to unstake, Stake First",ToolTipWidth:"16rem",margin:"0 10px 0 0",bottom:"-30px",children:e.jsx(Me,{border:"none",cursor:"default",background:R.disableButtonBg,color:R.disabledButtonText,children:W?e.jsx(le,{type:pe.SEAMLESS,spinnerSize:26,spinnerColor:R.activeButtonText,title:"Claiming",titleColor:R.activeButtonText}):` Unstake ${t}`})}):e.jsx(Me,{border:`1px solid ${R.activeButtonText}`,background:"transparent",color:R.activeButtonText,cursor:"pointer",margin:"0 10px 0 0",onClick:me,children:W?e.jsx(le,{type:pe.SEAMLESS,spinnerSize:26,spinnerColor:R.activeButtonText,title:"Unstaking",titleColor:R.activeButtonText}):` Unstake ${t}`}),(s==null?void 0:s.totalAvailableReward)==="0.00"?e.jsx(K,{bottom:"-30px",ToolTipTitle:"No Rewards to Claim",error:!0,ToolTipWidth:"10rem",children:e.jsx(Me,{border:"none",cursor:"default",background:R.disableButtonBg,color:R.disabledButtonText,children:L?e.jsx(le,{type:pe.SEAMLESS,spinnerSize:26,spinnerColor:R.activeButtonText,title:"Claiming",titleColor:R.activeButtonText}):" Claim Rewards"})}):e.jsx(Me,{border:`1px solid ${R.activeButtonText}`,background:"transparent",color:R.activeButtonText,cursor:"pointer",onClick:J,children:L?e.jsx(le,{type:pe.SEAMLESS,spinnerSize:26,spinnerColor:R.activeButtonText,title:"Claiming",titleColor:R.activeButtonText}):"Claim Rewards"})]})]}):e.jsxs(Ue,{width:"100%",children:[e.jsx(c,{height:"49px",width:"100%",margin:"0 0 11px 0"}),e.jsx(c,{height:"49px",width:"100%"})]})})]})},Vt=a(We)`
...
`,Ue=a(Ce)`
  ...
  border-radius: 5px;
  gap: 5px;
`,pt=({logo:t,title:s,body:i,setActiveTab:p})=>{const n=Ee(600);return e.jsxs(T,{style:{color:t==="announcement"?"white":"#333"},justifyContent:"stretch",padding:n?"12px":"16px",background:t==="announcement"?"linear-gradient(90deg, #121315 -2.55%, #2A2A39 32.62%, #8E317A 68.34%, #121315 102.97%)":"#FFF7DA",borderRadius:"16px",children:[e.jsx(re,{width:t==="announcement"?"60px":"32px",height:t==="announcement"?"60px":"32px",src:Rt(`svg/${t}.svg`),alt:"Announcement Logo"}),e.jsxs(y,{margin:t==="announcement"?"0 0 0 16px":"0 0 0 13px",justifyContent:"center",alignItems:"flex-start",gap:t==="announcement"?"4px":"0px",children:[e.jsx(N,{color:"inherit",fontSize:n?"20px":"24px",textAlign:"left",fontWeight:500,children:s}),e.jsxs(N,{color:"inherit",fontSize:n?"12px":"16px",textAlign:"left",fontWeight:500,children:[i," ",s.includes("New V2")&&e.jsxs(e.Fragment,{children:[e.jsx(Jt,{onClick:()=>p(1),children:"here"})," to migrate."]})]})]})]})},Jt=a(vt)`
  cursor: pointer;
  color: #fff;
...
`;he.coreContractChain;const Qt=({setActiveTab:t})=>{const{account:s,provider:i}=ke(),[p,n]=r.useState(null),[o,h]=r.useState(null),[x,d]=r.useState(null),[u,v]=r.useState(null),[E,W]=r.useState(null),[B,L]=r.useState(null),[V,G]=r.useState(null),[O,X]=r.useState(null),[M,ae]=r.useState(null),[Y,H]=r.useState(null),P=i==null?void 0:i.getSigner(s),$=r.useCallback(async()=>{const F=await be.getInstance().getPoolStats();L({...F})},[p,o,x,u,E]),U=r.useCallback(async()=>{const F=await be.getInstance().getPUSHPoolStats();G({...F})},[p,o,x,u,E]),w=r.useCallback(async F=>{const q=await be.getInstance().getLPPoolStats(F);X({...q})},[p,o,x,u,E]),R=r.useCallback(async()=>{const F=await be.getInstance().getUserData(u);ae({...F})},[u]),J=r.useCallback(async()=>{const F=await be.getInstance().getUserData(x);H({...F})},[x]);r.useEffect(()=>{let F=new C(l.pushToken,k.pushToken,P),q=new C(l.staking,k.staking,P),we=new C(l.depYieldFarmPUSH,k.yieldFarming,P),S=new C(l.depYieldFarmLP,k.yieldFarming,P),m=new C(l.uniswapV2Router02,k.uniswapV2Router02,P);if(n(F),h(q),v(we),d(S),W(m),P&&s){var g=i.getSigner(s);let b=new C(l.pushToken,k.pushToken,g),j=new C(l.staking,k.staking,g),f=new C(l.depYieldFarmPUSH,k.yieldFarming,g),A=new C(l.depYieldFarmLP,k.yieldFarming,g),z=new C(l.uniswapV2Router02,k.uniswapV2Router02,g);n(b),h(j),v(f),d(A),W(z)}},[s]),r.useEffect(()=>{p!=null&&o!=null&&u!=null&&(be.getInstance().init(s,p,o,u,x,E),$())},[$]),r.useEffect(()=>{B&&me(B)},[B]);const me=async F=>{U(),w(F),R(),J()};return e.jsxs(e.Fragment,{children:[e.jsx(pt,{logo:"WarningCircle",title:"This reward program (V1) has ended.",body:"To continue earning rewards please migrate to new pools.",setActiveTab:t}),e.jsxs(Zt,{children:[e.jsx(ot,{poolName:"PUSH",userData:M,PoolStats:V,poolAddress:l.depYieldFarmPUSH,getUserData:R,getPoolStats:U,tokenAddress:l.pushToken,setActiveTab:t}),e.jsx(ot,{poolName:"UNI-V2",userData:Y,PoolStats:O,poolAddress:l.depYieldFarmLP,getUserData:J,getPoolStats:w,tokenAddress:l.uniV2LPToken,setActiveTab:t})]})]})},Zt=a(T)`
...
`,qt=({poolStats:t})=>{function s(p){return p==null?void 0:p.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",")}const i=Ee(600);return e.jsx(Xt,{justifyContent:"stretch",children:t?e.jsxs(e.Fragment,{children:[e.jsx(xt,{fontSize:i?"16px":"18px",textAlign:"left",fontWeight:600,children:"Push Price"}),e.jsxs(T,{gap:"5px",justifyContent:"flex-end",children:[e.jsxs(xt,{fontSize:i?"18px ":"24px",textAlign:"left",fontWeight:600,children:["$",s(t==null?void 0:t.pushPrice.toFixed(2))]}),e.jsx(re,{width:"25px",height:i?"20px":"27px",src:Rt("svg/uniswapLogo.svg"),alt:"Uniswap Logo"})]})]}):e.jsxs(es,{children:[e.jsx(c,{height:"12px",width:"135px",margin:"10px 0 10px 0"}),e.jsx(c,{height:"12px",width:"135px",margin:"10px 0 10px 0"})]})})},Xt=a(T)`
  flex-direction: row;
...
`,is=a(Ce)`
  ...
  border-radius: 5px;
  gap: 5px;
`,Tt=({onClose:t,InnerComponentProps:s,toastObject:i})=>{const{title:p,getUserData:n,getPoolStats:o,setUnstakeErrorMessage:h,setWithdrawErrorMessage:x}=s,{account:d,provider:u,isWalletConnected:v,connect:E}=ke(),[W,B]=r.useState(0),[L,V]=r.useState(0),[G,O]=r.useState(!1),[X,M]=r.useState(!1),[ae,Y]=r.useState(!1);r.useState(null),r.useContext(Ls);const[H,P]=r.useState(0),$=()=>{h(null),x(null),t()},U=_e(),w=r.useRef(null);Vs(w,()=>$());const R=async()=>{var m=u.getSigner(d);const g=p==="Uni-V2"?l.uniV2LPToken:l.pushToken,b=new C(g,k.uniV2LpToken,m);let j=Ws(await b.balanceOf(d));B(parseInt(j.toString().replace(/\D/,""))||0)},J=async()=>{M(!0);var m=u.getSigner(d);let g;p==="Uni-V2"?g=await new C(l.uniV2LPToken,k.uniV2LpToken,m).allowance(d,l.stakingV2):g=await new C(l.pushToken,k.uniV2LpToken,m).allowance(d,l.pushCoreV2),V(_(g)),M(!1)};r.useEffect(()=>{R(),J()},[]);const me=async()=>{if(!v){E();return}if(G||X)return;M(!0);var m=u.getSigner(d);let g;const b=Bs(H.toString(),18);p==="Uni-V2"?g=new C(l.uniV2LPToken,k.uniV2LpToken,m).approve(l.stakingV2,b):g=new C(l.pushToken,k.uniV2LpToken,m).approve(l.pushCoreV2,b),g.then(async j=>{i.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{await u.waitForTransaction(j.hash),i.showMessageToast({toastTitle:"Success",toastMessage:`Successfully approved ${p} Tokens!`,toastType:"SUCCESS",getToastIcon:f=>e.jsx(xe,{size:f,color:"green"})}),M(!1),O(!0)}catch(f){console.error("Error",f),i.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:A=>e.jsx(D,{size:A,color:"red"})}),M(!1)}}).catch(j=>{console.error("Error",j),i.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature",toastType:"ERROR",getToastIcon:f=>e.jsx(D,{size:f,color:"red"})}),M(!1)})},F=async()=>{if(!v){E();return}if(ae||!G)return;if(Y(!0),H==0){i.showMessageToast({toastTitle:"Error",toastMessage:`You need to deposit atleast 1 ${p} token `,toastType:"ERROR",getToastIcon:b=>e.jsx(D,{size:b,color:"red"})}),Y(!1);return}var m=u.getSigner(d);let g;p==="Uni-V2"?g=new C(l.stakingV2,k.stakingV2,m).deposit(l.uniV2LPToken,I.from(H).mul(I.from(10).pow(18))):g=new C(l.pushCoreV2,k.pushCoreV2,m).stake(I.from(H).mul(I.from(10).pow(18))),g.then(async b=>{i.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{await u.waitForTransaction(b.hash),i.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:j=>e.jsx(xe,{size:j,color:"green"})}),o(),n(),Y(!1),$()}catch(j){console.error("Error",j),i.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${j.name}+ ")`,toastType:"ERROR",getToastIcon:f=>e.jsx(D,{size:f,color:"red"})}),Y(!1)}}).catch(b=>{console.error("Error in depositing",b),b.reason=b.reason.slice(b.reason.indexOf("::")+1),i.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Cancelled! ${b.reason}`,toastType:"ERROR",getToastIcon:j=>e.jsx(D,{size:j,color:"red"})}),Y(!1)})},q=m=>{m.preventDefault(),P(parseInt(m.target.value.replace(/\D/,""))||0),L>=parseInt(m.target.value.replace(/\D/,""))?O(!0):O(!1)},we=m=>{P(parseInt(m.toString().replace(/\D/,""))||0)},S=Ee(600);return e.jsxs(as,{children:[e.jsxs(T,{justifyContent:"space-between",children:[e.jsx(os,{children:p==="Uni-V2"?"Uniswap V2 Staking Pool":"Push Fee Staking Pool"}),e.jsx(it,{onClick:()=>$(),style:{cursor:"pointer"}})]}),e.jsxs(y,{children:[e.jsx($s,{weight:"500",size:"14px",self:"baseline",color:U.stakingSecondaryText,children:"You are Staking"}),e.jsxs(T,{width:"-webkit-fill-available",background:U.default.bg,height:"60px",padding:S?"8px":"14px",borderRadius:"12px",border:`1px solid ${U.modalBorderColor}`,children:[e.jsx(ns,{placeholder:"Enter Amount",flex:"2",radius:"4px",size:"32px",height:"32px",self:"auto",bg:"#FFF",color:U.stakingSecondaryText,value:H,onChange:m=>{m.preventDefault(),q(m)},autoFocus:!0}),e.jsxs(rs,{onClick:()=>we(W),children:["Max: ",W]})]})]}),e.jsxs(T,{margin:"20px 0",gap:"12px",children:[e.jsxs(ie,{variant:"primary",size:"medium",onClick:me,disabled:!!G,children:[!G&&!X&&e.jsxs(Ge,{color:"#FFFFFF",weight:"400",cursor:"pointer",children:["Approve ",p]}),X&&!G&&e.jsx(le,{type:pe.SEAMLESS,spinnerSize:26,spinnerColor:"#fff",title:"Approving",titleColor:"#FFF"}),G&&e.jsx(Ge,{color:U.emptyButtonText,weight:"600",cursor:"default",children:"Approved"})]}),e.jsxs(ie,{variant:"outline",size:"medium",disabled:!!(!G||ae),onClick:F,children:[!ae&&"Deposit",ae&&e.jsx(le,{type:pe.SEAMLESS,spinnerSize:26,spinnerColor:"#FFFFFF",title:"Depositing",titleColor:"#FFF"})]})]})]})},as=a.div`
  padding: 16px 20px;
  width: 340px;
  font-family: 'FK Grotesk Neu';
  font-style: normal;
...
`,rs=a.p`
  ...
  margin: 0px;
  cursor: pointer;
`,ls=({lpPoolStats:t,userDataLP:s,getLpPoolStats:i,getUserDataLP:p})=>{const{account:n,provider:o}=ke(),[h,x]=r.useState(!1),[d,u]=r.useState(!1),[v,E]=r.useState(null),[W,B]=r.useState(null),L=ze(),V=_e(),G=async()=>{if(h)return;x(!0);const $=_(s.epochStakeNext);if($==0){B("Nothing to unstake. You need to stake first"),x(!1);return}var U=o.getSigner(n);let w=new C(l.stakingV2,k.stakingV2,U);await w.balanceOf(n,l.uniV2LPToken),w.withdraw(l.uniV2LPToken,I.from($).mul(I.from(10).pow(18))).then(async R=>{L.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{await o.waitForTransaction(R.hash),L.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:J=>e.jsx(xe,{size:J,color:"green"})}),x(!1),i(),p()}catch(J){console.error("Error",J),L.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${J.name}+ ")`,toastType:"ERROR",getToastIcon:me=>e.jsx(D,{size:me,color:"red"})}),x(!1)}}).catch(R=>{L.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Cancelled!",toastType:"ERROR",getToastIcon:J=>e.jsx(D,{size:J,color:"red"})}),x(!1)})},O=async()=>{if(!d){if((s==null?void 0:s.totalAvailableReward)==0){E("No Rewards to Claim!");return}if(console.debug("Lp POOL stats",t),!t.currentEpochLP||t.currentEpochLP==1){L.showMessageToast({toastTitle:"Error",toastMessage:"Harvest unlocks from Epoch 2!)",toastType:"ERROR",getToastIcon:U=>e.jsx(D,{size:U,color:"red"})});return}u(!0);var $=o.getSigner(n);new C(l.yieldFarmLP,k.yieldFarming,$).massHarvest().then(async U=>{L.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{await o.waitForTransaction(U.hash),L.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:w=>e.jsx(xe,{size:w,color:"green"})}),p(),u(!1)}catch(w){L.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${w.name}+ ")`,toastType:"ERROR",getToastIcon:R=>e.jsx(D,{size:R,color:"red"})}),u(!1)}}).catch(U=>{L.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Cancelled!",toastType:"ERROR",getToastIcon:w=>e.jsx(D,{size:w,color:"red"})}),u(!1)})}};r.useEffect(()=>{E(null),B(null)},[n]);const X=()=>{(t==null?void 0:t.currentEpochLP.toNumber())+1<=(t==null?void 0:t.totalEpochLP.toNumber())?ae():L.showMessageToast({toastTitle:"Error",toastMessage:"Epochs have ended!",toastType:"ERROR",getToastIcon:$=>e.jsx(D,{size:$,color:"red"})})},{isModalOpen:M,showModal:ae,ModalComponent:Y}=Ke(),H=ze(),P=Ee(600);return e.jsxs(ps,{children:[e.jsx(Y,{InnerComponent:Tt,InnerComponentProps:{title:"Uni-V2",getUserData:p,getPoolStats:i,setUnstakeErrorMessage:B,setWithdrawErrorMessage:E},toastObject:H,modalPosition:Je.ON_PARENT}),e.jsx(y,{margin:"0px 0px 20px 0px",children:t?e.jsx(e.Fragment,{children:e.jsx(xs,{children:"Uniswap V2 LP Staking Pool"})}):e.jsxs(Fe,{padding:"5px 15px 0 15px",children:[e.jsx(c,{height:"12px",width:"234px",margin:"0 0 10px 0"}),e.jsx(c,{height:"12px",width:"112px"})]})}),e.jsxs(y,{flex:"5",children:[e.jsxs(ds,{border:`1px solid ${V.stakingBorder}`,borderRadius:"16px",children:[e.jsx(y,{padding:P?" 1px":"8px",children:t?e.jsxs(e.Fragment,{children:[e.jsx(ft,{children:"Current Reward"}),e.jsx(N,{fontSize:P?"18px":"24px",fontWeight:"600",color:"#D53A94",letterSpacing:"normal",children:"0 PUSH"})]}):e.jsxs(Fe,{padding:P?"0px":"5px 15px 0 15px",children:[e.jsx(c,{height:"12px",width:P?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(c,{height:"12px",width:P?"65px":"100px}"})]})}),e.jsx(cs,{width:"10px",height:"100%"}),e.jsx(y,{padding:P?" 1px":"8px",children:t?e.jsxs(e.Fragment,{children:[e.jsx(ft,{children:"Total Staked"}),e.jsxs(hs,{fontSize:P?"18px":"24px",fontWeight:"600",letterSpacing:"normal",children:[ee(_(t==null?void 0:t.poolBalance))," UNI-V2"]})]}):e.jsxs(Fe,{padding:P?"0px":"5px 15px 0 15px",children:[e.jsx(c,{height:"12px",width:P?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(c,{height:"12px",width:P?"65px":"100px}"})]})})]}),e.jsx(T,{alignSelf:"end",margin:"12px 13px 24px 0px",color:"#575D73",letterSpacing:"normal",children:t?e.jsxs(e.Fragment,{children:[e.jsx(jt,{children:"Current Epoch"}),e.jsxs(jt,{children:[Math.min(t==null?void 0:t.currentEpochLP,t==null?void 0:t.totalEpochLP).toString(),"/",t==null?void 0:t.totalEpochLP.toString()]})]}):e.jsx(Fe,{padding:"5px 0px 0 15px",children:e.jsx(c,{height:"12px",width:"124px"})})}),s?e.jsxs(y,{children:[e.jsxs(T,{justifyContent:"space-between",margin:P?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Le,{children:["User Deposit",e.jsx(Ve,{children:e.jsx(K,{ToolTipTitle:"User Deposited",ToolTipBody:"Amount of PUSH Token User Staked",children:e.jsx(re,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs($e,{children:[_(s==null?void 0:s.epochStakeNext)," UNI-V2"]})]}),e.jsxs(T,{justifyContent:"space-between",margin:P?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Le,{children:["Rewards Claimed",e.jsx(Ve,{children:e.jsx(K,{ToolTipTitle:"Rewards Claimed",ToolTipBody:"Amount of Push Claimed by User",children:e.jsx(re,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs($e,{children:[" ",ee(((s==null?void 0:s.totalAccumulatedReward)-(s==null?void 0:s.totalAvailableReward)).toFixed(2))," ","PUSH"]})]}),e.jsxs(T,{justifyContent:"space-between",margin:P?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Le,{children:["Current Epoch Reward",e.jsx(Ve,{children:e.jsx(K,{ToolTipTitle:"Current Epoch Reward",ToolTipBody:"Displays the approximate latest reward amount for current epoch",children:e.jsx(re,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs($e,{children:[" ",ee(s==null?void 0:s.potentialUserReward)," PUSH"]})]}),e.jsxs(T,{justifyContent:"space-between",margin:P?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Le,{children:["Available for Claiming",e.jsx(Ve,{children:e.jsx(K,{ToolTipTitle:"Available for Claiming",ToolTipBody:"Amount of Push Token Available to claim",children:e.jsx(re,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs($e,{children:[" ",ee(s==null?void 0:s.totalAvailableReward)," PUSH"]})]})]}):e.jsxs(Ce,{padding:"0 15px 15px 15px",width:"100%",maxWidth:" -webkit-fill-available",borderRadius:"5px",children:[e.jsxs(T,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(c,{height:"12px",width:"164px"}),e.jsx(c,{height:"12px",width:"72px"})]}),e.jsxs(T,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(c,{height:"12px",width:"164px"}),e.jsx(c,{height:"12px",width:"72px"})]}),e.jsxs(T,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(c,{height:"12px",width:"164px"}),e.jsx(c,{height:"12px",width:"72px"})]}),e.jsxs(T,{justifyContent:"space-between",children:[e.jsx(c,{height:"12px",width:"164px"}),e.jsx(c,{height:"12px",width:"72px"})]})]})]}),e.jsx(y,{padding:P?"0px ":"0px 14px",margin:"24px 0px 24px 0px",children:s?e.jsxs(e.Fragment,{children:[e.jsx(T,{children:e.jsx(ie,{variant:"primary",size:"medium",disabled:!0,block:!0,onClick:()=>{X()},children:"Stake $UNI-V2 LP Tokens"})}),e.jsxs(gs,{children:[e.jsx(Qe,{width:"50%",children:_(s==null?void 0:s.epochStakeNext)==="0"?e.jsx(K,{error:!0,ToolTipTitle:"Nothing to unstake! Stake First.",ToolTipWidth:"16rem",bottom:"-30px",children:e.jsx(ie,{disabled:!0,size:"medium",block:!0,children:h?e.jsx(le,{type:pe.SEAMLESS,spinnerSize:26,spinnerColor:"#D53A94"}):"Unstake $UNI-V2"})}):e.jsx(ie,{size:"medium",variant:"outline",block:!0,onClick:G,children:h?e.jsx(le,{type:pe.SEAMLESS,spinnerSize:26,spinnerColor:V.activeButtonText,title:"Unstaking",titleColor:V.activeButtonText}):"Unstake $UNI-V2"})}),e.jsx(Qe,{width:"50%",children:(s==null?void 0:s.totalAvailableReward)==="0.00"?e.jsx(K,{bottom:"-30px",left:"40px",ToolTipTitle:"No Rewards to Claim!",error:!0,ToolTipWidth:"10rem",children:e.jsx(ie,{disabled:!0,size:"medium",block:!0,children:d?e.jsx(le,{type:pe.SEAMLESS,spinnerSize:26,spinnerColor:"#FFFFF"}):"Claim Rewards"})}):e.jsx(ie,{variant:"outline",size:"medium",block:!0,onClick:()=>O(),children:d?e.jsx(le,{type:pe.SEAMLESS,spinnerSize:26,spinnerColor:V.activeButtonText,title:"Claiming",titleColor:V.activeButtonText}):"Claim Rewards"})})]})]}):e.jsxs(Fe,{width:"100%",children:[e.jsx(c,{height:"49px",width:"100%",margin:"0 0 8px 0"}),e.jsx(c,{height:"49px",width:"100%"})]})})]})},ps=a(We)`
  border: 1px solid ${t=>t.theme.stakingBorder};
  border-radius: 24px;
  padding: 20px;
...
`,us=t=>r.createElement("svg",{width:29,height:28,viewBox:"0 0 29 28",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},r.createElement("path",{d:"M26.1673 14.0002C26.1673 20.4431 20.9436 25.6668 14.5007 25.6668C8.05773 25.6668 2.83398 20.4431 2.83398 14.0002C2.83398 7.55725 8.05773 2.3335 14.5007 2.3335C20.9436 2.3335 26.1673 7.55725 26.1673 14.0002Z",fill:"#30CC8B"}),r.createElement("path",{d:"M20.6751 8.5083L12.7593 16.4335L9.49146 13.175L7.8418 14.8246L12.7616 19.7328L22.3254 10.158L20.6751 8.5083Z",fill:"white"})),ms=({onClose:t,InnerComponentProps:s})=>{const{currentTransactionNo:i,totalTransactionNo:p,transactionSteps:n,transactionText:o,setCurrentTransactionNo:h,setTotalTransactionNo:x,setTransactionSteps:d,claimRewards:u,unstakeTokensPaginated:v}=s,E=()=>{d(0),t()},W=async()=>{d(0),x(0),h(0),o!=null&&o.includes("Unstaking")?v():u()};return e.jsx(ws,{children:p?e.jsxs(e.Fragment,{children:[e.jsx(T,{justifyContent:"end",children:e.jsx(it,{onClick:()=>E(),style:{cursor:"pointer"}})}),n===0&&e.jsxs(e.Fragment,{children:[e.jsx(Ut,{size:42,color:de.COLORS.PRIMARY_PINK,type:Ft.PROCESSING}),e.jsxs(y,{gap:"24px",margin:"16px 0 0 0",children:[e.jsxs(y,{children:[e.jsxs(N,{fontSize:"28px",fontWeight:"500",letterSpacing:"normal",children:["Please sign transaction ",i,"/",p]}),e.jsx(N,{fontSize:"18px",fontWeight:"400",color:"#657795",children:"Processing your request"})]}),e.jsx(N,{fontSize:"18px",fontWeight:"400",color:"#657795",children:o}),e.jsx(y,{padding:"16px",children:e.jsx(N,{fontSize:"16px",fontWeight:"400",color:"#D53A94",children:"Confirm the request in your wallet"})})]})]}),n===1&&e.jsxs(y,{gap:"24px",children:[e.jsx(y,{gap:"9px",children:e.jsx(N,{fontSize:"28px",fontWeight:"500",letterSpacing:"normal",children:"Transaction Error"})}),e.jsx(y,{children:e.jsx(ie,{variant:"primary",size:"medium",onClick:W,children:"Retry"})})]}),n===2&&e.jsxs(y,{gap:"24px",children:[e.jsxs(y,{children:[e.jsx(us,{height:"50px",width:"50px"}),e.jsxs(y,{gap:"9px",children:[e.jsx(N,{fontSize:"28px",fontWeight:"500",letterSpacing:"normal",children:"Transactions Successful"}),e.jsx(N,{fontSize:"18px",fontWeight:"400",color:"#657795",children:"You have claimed all the rewards."})]})]}),e.jsx(ie,{variant:"primary",size:"medium",onClick:E,children:"Close"})]})]}):e.jsx(Ut,{size:42,color:de.COLORS.PRIMARY_PINK,type:Ft.PROCESSING})})},ws=a(y)`
  min-width: 493px;
  padding: 32px 24px;
`,Ts=({userDataPush:t,getUserDataPush:s,PUSHPoolstats:i,getPUSHPoolStats:p})=>{const{account:n,provider:o}=ke(),[h,x]=r.useState(!1),[d,u]=r.useState(!1),[v,E]=r.useState(null),[W,B]=r.useState(null),[L,V]=r.useState(0),[G,O]=r.useState(0),[X,M]=r.useState(0),[ae,Y]=r.useState(""),H=ze(),P=_e(),$=async j=>{var f=o.getSigner(n);let A=new C(l.pushToken,k.pushToken,f);if(await A.holderDelegation(n,j.address))return!0;try{H.showLoaderToast({loaderMessage:"Delegating! Please wait.."});const z=await A.setHolderDelegation(j.address,"true");return await o.waitForTransaction(z.hash),H.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed! Address Delegated",toastType:"SUCCESS",getToastIcon:te=>e.jsx(xe,{size:te,color:"green"})}),!0}catch(z){return console.error("Error in delegating",z),H.showMessageToast({toastTitle:"Error",toastMessage:`Transaction failed! ${z.reason}`,toastType:"ERROR",getToastIcon:te=>e.jsx(D,{size:te,color:"red"})}),x(!1),!1}},U=async j=>{const f=(await j.userFeesInfo(n)).lastClaimedBlock;if(f.toNumber()!==0){const A=await j.genesisEpoch(),z=await j.epochDuration();return(f-A)/z}},w=async()=>{if(d)return;if(u(!0),(t==null?void 0:t.availableRewards)==0){B("No Rewards to Claim"),u(!1);return}var j=o.getSigner(n);let f=new C(l.pushCoreV2,k.pushCoreV2,j);const A=i==null?void 0:i.currentEpochNumber,z=14;if(!await $(f))return;let te=1;te=await U(f),g(),u(!1);let se=0;A-te<z,se=Math.ceil((A-te)/z),O(se),se!=0&&(await R(se,te,f,z),s(),M(2),V(0))},R=async(j,f,A,z)=>{const te=i==null?void 0:i.currentEpochNumber;let se=0;for(let Z=0;Z<j;Z++){let Q=f;f+=z;let ce=Math.min(f,te-1);Y(`Claiming the rewards from Epoch ${Q} to ${ce} `),await A.harvestPaginated(ce,{gasLimit:91e4}).then(async oe=>{try{H.showLoaderToast({loaderMessage:"Waiting for confirmation"}),await o.waitForTransaction(oe.hash),H.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:ne=>e.jsx(xe,{size:ne,color:"green"})}),se++,V(se)}catch{console.error("Error in the transaction",oe);return}}).catch(oe=>{throw console.error("Error in claiming the reward",oe),H.showMessageToast({toastTitle:"Error",toastMessage:`Transaction failed! ${oe.reason}`,toastType:"ERROR",getToastIcon:ne=>e.jsx(D,{size:ne,color:"red"})}),Y(""),x(!1),s(),M(1),V(0),oe})}},J=async()=>{if(h)return;if(x(!0),_(t==null?void 0:t.userStaked)==0){E("Nothing to unstake, You need to stake first"),x(!1);return}var j=o.getSigner(n);let f=new C(l.pushCoreV2,k.pushCoreV2,j);const A=await $(f);if(u(!1),!A)return;const z=i==null?void 0:i.currentEpochNumber,te=14;let se=0;if(se=await U(f),se>=z-1){x(!1),E("PUSH cannot be unstaked until current epoch is over."),H.showMessageToast({toastTitle:"Unstaking Error",toastMessage:"You cannot unstake until Current Epoch gets over.",toastType:"ERROR",getToastIcon:Q=>e.jsx(D,{size:Q,color:"red"})});return}g();const Z=Math.ceil((z-se)/te);O(Z),Z>1&&await R(Z-1,se,f,te),Y("Unstaking Your Push Tokens. Please wait..."),f.unstake().then(async Q=>{H.showLoaderToast({loaderMessage:"Unstaking! Waiting for Confirmation..."});try{await o.waitForTransaction(Q.hash),H.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:ce=>e.jsx(xe,{size:ce,color:"green"})}),p(),s(),x(!1),M(2),V(0)}catch(ce){console.error("Error",ce),H.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${ce.name}+ ")`,toastType:"ERROR",getToastIcon:oe=>e.jsx(D,{size:oe,color:"red"})}),Y(""),x(!1)}}).catch(Q=>{console.error("Error: ",Q);const ce=Q.reason.includes("PushCoreV2::unstake:"),oe=Q.reason.includes("PushCoreV2::harvestPaginated:");if(ce||oe)E("PUSH cannot be unstaked until current epoch is over.");else{let ne=Q.reason.slice(Q.reason.indexOf("::")+1);ne=ne.replace("unstake:",""),H.showMessageToast({toastTitle:"Error",toastMessage:`${ne}`,toastType:"ERROR",getToastIcon:Te=>e.jsx(D,{size:Te,color:"red"})})}x(!1),s(),M(1),V(0)})};r.useEffect(()=>{B(null),E(null)},[n]);const{isModalOpen:me,showModal:F,ModalComponent:q}=Ke(),we=ze(),S=Ee(600),{isModalOpen:m,showModal:g,ModalComponent:b}=Ke();return e.jsxs(fs,{children:[e.jsx(q,{InnerComponent:Tt,InnerComponentProps:{title:"PUSH",getUserData:s,getPoolStats:p,setUnstakeErrorMessage:E,setWithdrawErrorMessage:B},toastObject:we,modalPosition:Je.ON_PARENT}),e.jsx(b,{InnerComponent:ms,InnerComponentProps:{currentTransactionNo:L,totalTransactionNo:G,transactionSteps:X,transactionText:ae,setCurrentTransactionNo:V,setTotalTransactionNo:O,setTransactionSteps:M,claimRewards:w,unstakeTokensPaginated:J},onConfirm:()=>{},modalPadding:"0px",modalPosition:Je.ON_ROOT}),e.jsx(y,{margin:"0px 0px 20px 0px",children:i?e.jsx(e.Fragment,{children:e.jsx(js,{children:"PUSH Fee Staking Pool"})}):e.jsxs(Ae,{padding:"5px 15px 0 15px",children:[e.jsx(c,{height:"12px",width:"234px",margin:"0 0 10px 0"}),e.jsx(c,{height:"12px",width:"112px"})]})}),e.jsxs(y,{flex:"5",children:[e.jsxs(Ss,{border:`1px solid ${P.stakingBorder}`,borderRadius:"16px",children:[e.jsx(y,{padding:S?" 1px":"8px",children:i?e.jsxs(e.Fragment,{children:[e.jsx(bt,{children:"Current Reward"}),e.jsxs(N,{fontSize:S?"18px":"24px",fontWeight:"600",color:"#D53A94",letterSpacing:"normal",children:[ee(_(i==null?void 0:i.currentReward))," PUSH"]})]}):e.jsxs(Ae,{padding:S?"0px":"5px 15px 0 15px",children:[e.jsx(c,{height:"12px",width:S?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(c,{height:"12px",width:S?"65px":"100px}"})]})}),e.jsx(bs,{width:"10px",height:"100%"}),e.jsx(y,{padding:S?" 1px":"8px",children:i?e.jsxs(e.Fragment,{children:[e.jsx(bt,{children:"Total Staked"}),e.jsxs(Cs,{fontSize:S?"18px":"24px",fontWeight:"600",letterSpacing:"normal",children:[ee(_(i==null?void 0:i.totalStakedAmount))," PUSH"]})]}):e.jsxs(Ae,{padding:S?"0px":"5px 15px 0 15px",children:[e.jsx(c,{height:"12px",width:S?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(c,{height:"12px",width:S?"65px":"100px}"})]})})]}),e.jsx(T,{alignSelf:"end",margin:"12px 13px 24px 0px",color:"#575D73",letterSpacing:"normal",children:i?e.jsxs(e.Fragment,{children:[e.jsx(Ct,{children:"Current Epoch"}),e.jsx(Ct,{children:i==null?void 0:i.currentEpochNumber})]}):e.jsx(Ae,{padding:"5px 0px 0 15px",children:e.jsx(c,{height:"12px",width:"124px"})})}),t?e.jsxs(y,{children:[e.jsxs(T,{justifyContent:"space-between",margin:S?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Be,{children:["User Deposit",e.jsx(Oe,{children:e.jsx(K,{ToolTipTitle:"User Deposited",ToolTipBody:"Amount of PUSH Token User Staked",children:e.jsx(re,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(He,{children:[" ",ee(_(t==null?void 0:t.userStaked))," PUSH"]})]}),e.jsxs(T,{justifyContent:"space-between",margin:S?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Be,{children:["Rewards Claimed",e.jsx(Oe,{children:e.jsx(K,{ToolTipTitle:"Rewards Claimed",ToolTipBody:"Amount of Push Claimed by User",children:e.jsx(re,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(He,{children:[" ",ee((t==null?void 0:t.claimedReward).toFixed(2))," PUSH"]})]}),e.jsxs(T,{justifyContent:"space-between",margin:S?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Be,{children:["Current Epoch Reward",e.jsx(Oe,{children:e.jsx(K,{ToolTipTitle:"Current Epoch Reward",ToolTipBody:"Displays the approximate latest reward amount for current epoch",children:e.jsx(re,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(He,{children:[" ",ee((t==null?void 0:t.potentialReward).toFixed(2))," PUSH"]})]}),e.jsxs(T,{justifyContent:"space-between",margin:S?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Be,{children:["Available for Claiming",e.jsx(Oe,{children:e.jsx(K,{ToolTipTitle:"Available for Claiming",ToolTipBody:"Amount of Push Token Available to claim",children:e.jsx(re,{src:ge,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(He,{children:[" ",ee((t==null?void 0:t.availableRewards).toFixed(2))," PUSH"]})]})]}):e.jsxs(Ce,{padding:"0 15px 15px 15px",width:"100%",maxWidth:" -webkit-fill-available",borderRadius:"5px",children:[e.jsxs(T,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(c,{height:"12px",width:"164px"}),e.jsx(c,{height:"12px",width:"72px"})]}),e.jsxs(T,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(c,{height:"12px",width:"164px"}),e.jsx(c,{height:"12px",width:"72px"})]}),e.jsxs(T,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(c,{height:"12px",width:"164px"}),e.jsx(c,{height:"12px",width:"72px"})]}),e.jsxs(T,{justifyContent:"space-between",children:[e.jsx(c,{height:"12px",width:"164px"}),e.jsx(c,{height:"12px",width:"72px"})]})]})]}),e.jsx(y,{padding:S?"0px ":"0px 14px",margin:"24px 0px 24px 0px",children:t?e.jsxs(e.Fragment,{children:[e.jsx(T,{children:e.jsx(ie,{variant:"primary",size:"medium",block:!0,onClick:F,children:"Stake $PUSH"})}),e.jsxs(ks,{children:[e.jsx(Qe,{width:"50%",children:(i==null?void 0:i.currentEpochNumber)<=2?e.jsx(St,{ToolTipTitle:"You can unstake once epoch 2 ends.",ButtonTitle:"Unstake PUSH"}):_(t==null?void 0:t.userStaked)==0||v!==null?e.jsx(St,{ToolTipTitle:v||"Nothing to unstake, Stake First",ButtonTitle:"Unstake PUSH"}):e.jsx(ie,{variant:"outline",size:"medium",block:!0,onClick:J,children:h?e.jsx(le,{type:pe.SEAMLESS,spinnerSize:26,spinnerColor:P.activeButtonText,title:"Unstaking",titleColor:P.activeButtonText}):"Unstake $PUSH"})}),e.jsx(Qe,{width:"50%",children:(t==null?void 0:t.availableRewards)===0?e.jsx(K,{bottom:"-30px",ToolTipTitle:"No Rewards to Claim",error:!0,left:"40px",ToolTipWidth:"10rem",children:e.jsx(ie,{size:"medium",block:!0,disabled:!0,children:d?e.jsx(le,{type:pe.SEAMLESS,spinnerSize:26,spinnerColor:"#D53A94"}):"Claim Rewards"})}):e.jsx(ie,{variant:"outline",size:"medium",block:!0,onClick:w,children:d?e.jsx(le,{type:pe.SEAMLESS,spinnerSize:26,spinnerColor:P.activeButtonText,title:"Claiming",titleColor:P.activeButtonText}):"Claim Rewards"})})]})]}):e.jsxs(Ae,{width:"100%",children:[e.jsx(c,{height:"49px",width:"100%",margin:"0 0 8px 0"}),e.jsx(c,{height:"49px",width:"100%"})]})})]})},St=t=>e.jsx(K,{error:!0,ToolTipTitle:t.ToolTipTitle,ToolTipWidth:"16rem",bottom:"-30px",children:e.jsx(ie,{size:"medium",block:!0,disabled:!0,children:t.ButtonTitle})});a.div`
  width: 34%;
  width: 100%;
  min-width: none;
  max-width: none;
...
`,Ae=a(Ce)`
  ...
  border-radius: 5px;
  gap: 5px;
`,ys=({setActiveTab:t})=>{const{provider:s,account:i,chainId:p}=ke(),[n,o]=r.useState(),[h,x]=r.useState(),[d,u]=r.useState(),[v,E]=r.useState(),[W,B]=r.useState(),[L,V]=r.useState(null),[G,O]=r.useState(null),[X,M]=r.useState(null),[ae,Y]=r.useState(null),[H,P]=r.useState(null),$=s==null?void 0:s.getSigner(i),U=r.useCallback(async()=>{const F=await Re.getInstance().getPoolStats(s);V({...F})},[h,n,v,d,W,s]),w=r.useCallback(async()=>{const F=await Re.getInstance().getPoolStats(s),q=await Re.getInstance().getLPPoolStats(F);O({...q})},[h,n,v,d,W,s]),R=r.useCallback(async()=>{},[]),J=r.useCallback(async()=>{const F=await Re.getInstance().getUserDataLP();M({...F})},[h,n,v,d,W]),me=r.useCallback(async()=>{const[F,q]=await Re.getInstance().getUserDataPUSH(s);P({...F}),Y({...q})},[h,n,v,d,W,s]);return r.useEffect(()=>{if(p!==he.coreContractChain&&p!==he.mainnetCoreContractChain)return;O(null),M(null),P(null),Y(null);let F=new C(l.stakingV2,k.stakingV2,$),q=new C(l.pushToken,k.pushToken,$),we=new C(l.pushCoreV2,k.pushCoreV2,$),S=new C(l.yieldFarmLP,k.yieldFarming,$),m=new C(l.uniswapV2Router02,k.uniswapV2Router02,$);if(x(F),o(q),E(we),u(S),B(m),$&&i){var g=s==null?void 0:s.getSigner(i);let b=new C(l.stakingV2,k.stakingV2,g),j=new C(l.pushToken,k.pushToken,g),f=new C(l.pushCoreV2,k.pushCoreV2,g),A=new C(l.yieldFarmLP,k.yieldFarming,g),z=new C(l.uniswapV2Router02,k.uniswapV2Router02,g);x(b),o(j),E(f),u(A),B(z)}Re.getInstance().init(i,F,q,we,S,m),U(),J(),w(),me()},[i,p]),e.jsxs(e.Fragment,{children:[e.jsx(pt,{logo:"announcement",title:"Staking Program has now ended.",body:"Note: While UNI-V2 LP staking pool has ended, the Push Fee Staking Pool is designed to continue its staking mechanism. However, rewards for stakers will solely come from Core smart contract fee earnings.",setActiveTab:t}),e.jsx(ts,{getLpPoolStats:w,poolStats:L,setPoolStats:V}),e.jsx(qt,{poolStats:L}),e.jsxs(Es,{children:[e.jsx(Ts,{userDataPush:ae,getUserDataPush:me,PUSHPoolstats:H,getPUSHPoolStats:R}),e.jsx(ls,{lpPoolStats:G,userDataLP:X,getLpPoolStats:w,getUserDataLP:J})]})]})},Es=a(T)`
  @media (max-width: 1300px) {
    flex-direction: column;
  }
...
`,Pt=a(je)`
  ...
  height: 17px;
  width: fit-content;
`,At=()=>e.jsx(Gs,{children:e.jsx(kt,{})})});export{Ks as __tla,At as default};
