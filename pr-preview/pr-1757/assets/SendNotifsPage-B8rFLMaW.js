import{a_ as s,by as t,bz as l,bA as D,bC as u,bM as N,b9 as m,bN as T,ba as a,aZ as e,bO as h,b3 as L,bd as A,a$ as f,__tla as $}from"./index-BH6Jm5Rc.js";import{S as x,__tla as O}from"./SendNotifications-CC9e7NcB.js";import{__tla as b}from"./index-DSnsnCzH.js";import{__tla as p}from"./Tag-DU9DA1Xg.js";import{__tla as R}from"./TransitionGroupContext-DzIu1s03.js";let _,g=Promise.all([(()=>{try{return $}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return b}catch{}})(),(()=>{try{return p}catch{}})(),(()=>{try{return R}catch{}})()]).then(async()=>{A.coreContractChain;function M(){u.pageview("/send_notificaiton"),N(),m(),T(n=>n.contracts),T(n=>n.admin),A.coreContractChain;const[r,G]=a.useState(2),[d,J]=a.useState(!0);a.useState(null),a.useState(null);const[c,y]=a.useState(!0);a.useState([]);const[E,I]=a.useState(null),U=()=>I(null);return a.useEffect(()=>{E&&U()},[E]),e.jsx(i,{children:r===2&&d?e.jsxs(e.Fragment,{children:[!c&&e.jsx(h,{replace:!0,to:"/dashboard"}),c&&e.jsx(x,{})]}):e.jsx(S,{children:"Channel details are being loaded, please wait\u2026"})})}let i,S,o;i=s(L)`
  align-items: center;
  align-self: center;
