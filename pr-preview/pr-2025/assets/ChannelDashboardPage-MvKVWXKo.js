...
`,Ft=({options:e,item:o})=>{const[i,n]=l.useState(!1),a=l.useRef();return he(a,()=>n(!1)),t.jsxs("div",{children:[t.jsx(Do,{onClick:()=>n(!0)}),i&&t.jsx(Lo,{onMouseLeave:()=>n(!1),ref:a,children:e.map(({icon:r,onClick:c,text:p},d)=>t.jsxs(zo,{onClick:()=>c(o),index:d,children:[r,t.jsx(No,{children:p})]},d))})]})},Do=s(ar)`
