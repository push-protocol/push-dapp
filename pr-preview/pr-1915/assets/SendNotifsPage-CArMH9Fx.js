import{e6 as s,eR as t,eS as l,eT as T,eV as m,f2 as u,dY as f,f3 as D,ek as e,e1 as a,f4 as N,eb as h,em as _,e7 as L,__tla as $}from"./index-cxV55chu.js";import{S as x,__tla as O}from"./SendNotifications-Cn7suY49.js";import{__tla as p}from"./index-DpGHdbjY.js";import{__tla as R}from"./Tag-BI4ZD_tf.js";import{__tla as g}from"./TransitionGroupContext-CLo70okt.js";let A,G=Promise.all([(()=>{try{return $}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return p}catch{}})(),(()=>{try{return R}catch{}})(),(()=>{try{return g}catch{}})()]).then(async()=>{_.coreContractChain;function M(){m.pageview("/send_notificaiton"),u(),f(),D(n=>n.contracts),D(n=>n.admin),_.coreContractChain;const[r,J]=e.useState(2),[d,y]=e.useState(!0);e.useState(null),e.useState(null);const[c,b]=e.useState(!0);e.useState([]);const[E,I]=e.useState(null),U=()=>I(null);return e.useEffect(()=>{E&&U()},[E]),a.jsx(i,{children:r===2&&d?a.jsxs(a.Fragment,{children:[!c&&a.jsx(N,{replace:!0,to:"/dashboard"}),c&&a.jsx(x,{})]}):a.jsx(S,{children:"Channel details are being loaded, please wait\u2026"})})}let i,S,o;i=s(h)`
  align-items: center;
  align-self: center;
