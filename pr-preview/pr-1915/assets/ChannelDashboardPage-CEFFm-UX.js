import{iz as Pt,iA as Ka,d_ as l,iB as ne,e1 as e,iC as Ue,iD as Se,iE as Me,iF as Oe,fZ as _e,iG as Ya,fY as Q,iH as nt,iI as Ut,iJ as Ja,iK as Fe,iL as at,iM as je,iN as Ot,iO as _t,e6 as o,e9 as Z,fE as V,e3 as Xa,e4 as qa,f3 as U,ed as ee,eU as ce,gr as ot,ex as Ft,ii as Qa,fH as de,dY as me,e2 as Za,f0 as ae,es as eo,f2 as Ee,en as to,ep as io,eY as ve,em as se,eR as O,e$ as no,iP as ao,iQ as ke,iR as oo,er as Ge,eb as Ve,ea as He,ek as H,fm as rt,eT as D,fq as ue,fN as fe,fO as Y,eW as J,fw as Gt,fx as st,iS as lt,g$ as ro,iT as so,gT as Re,gq as Vt,iU as Ht,eo as We,gG as lo,eq as Wt,fs as Ie,ft as De,iV as Kt,iW as co,gH as Yt,fG as Jt,dZ as po,iX as xo,iY as ho,iZ as go,i_ as ct,fL as dt,f8 as pt,i$ as mo,e0 as uo,fj as fo,fn as wo,j0 as yo,j1 as bo,fS as Co,j2 as jo,eS as we,j3 as vo,j4 as To,j5 as Ao,j6 as So,j7 as xt,j8 as Mo,eV as Eo,e7 as ko,__tla as Ro}from"./index-cxV55chu.js";import{S as Io,N as Do,__tla as Lo}from"./RedCircle-DNitqzuN.js";import{M as Xt,S as No,F as qt,C as Qt,a as Zt,__tla as zo}from"./ChannelInfoList-CuS1LGIz.js";import{a as $o,__tla as Bo}from"./Tag-BI4ZD_tf.js";import{E as Po,__tla as Uo}from"./EPNSCoreHelper-B93Sh5ZX.js";import{a as ei,m as ti,b as ii,__tla as Oo}from"./PushTokenContractHelper-RS8PN-2f.js";import{M as _o,a as Fo,__tla as Go}from"./EmptyNotificationSettings-CuclOsvR.js";import{a as ni,b as ai,__tla as Vo}from"./ValidationHelper-BVt6ZjTX.js";import{I as Ho,__tla as Wo}from"./ImportPushTokenMessage-BOMAmzZ0.js";import{a as Ko,__tla as Yo}from"./IpfsHelper-CzTIG6Ag.js";import{v as Jo,C as Xo,__tla as qo}from"./CreateChannel-DD8XUs9e.js";import{__tla as Qo}from"./TransitionGroupContext-CLo70okt.js";import{__tla as Zo}from"./index.esm-BzuKDYgR.js";import"./browser-Cr_ZWWON.js";import{__tla as er}from"./Stepper-DMYHRDXN.js";import{__tla as tr}from"./StakingVariant-BYpeWaKw.js";import{__tla as ir}from"./useMutation-BruDBZ7T.js";import{__tla as nr}from"./index.esm-BaNszSyF.js";import"./Common.form-Ds5bAxK4.js";let oi,ar=Promise.all([(()=>{try{return Ro}catch{}})(),(()=>{try{return Lo}catch{}})(),(()=>{try{return zo}catch{}})(),(()=>{try{return Bo}catch{}})(),(()=>{try{return Uo}catch{}})(),(()=>{try{return Oo}catch{}})(),(()=>{try{return Go}catch{}})(),(()=>{try{return Vo}catch{}})(),(()=>{try{return Wo}catch{}})(),(()=>{try{return Yo}catch{}})(),(()=>{try{return qo}catch{}})(),(()=>{try{return Qo}catch{}})(),(()=>{try{return Zo}catch{}})(),(()=>{try{return er}catch{}})(),(()=>{try{return tr}catch{}})(),(()=>{try{return ir}catch{}})(),(()=>{try{return nr}catch{}})()]).then(async()=>{function ri(t,a=0,i=1){return Ka(t,a,i)}function si(t){t=t.slice(1);const a=new RegExp(`.{1,${t.length>=6?2:1}}`,"g");let i=t.match(a);return i&&i[0].length===1&&(i=i.map(n=>n+n)),i?`rgb${i.length===4?"a":""}(${i.map((n,s)=>s<3?parseInt(n,16):Math.round(parseInt(n,16)/255*1e3)/1e3).join(", ")})`:""}function ht(t){if(t.type)return t;if(t.charAt(0)==="#")return ht(si(t));const a=t.indexOf("("),i=t.substring(0,a);if(["rgb","rgba","hsl","hsla","color"].indexOf(i)===-1)throw new Error(Pt(9,t));let n=t.substring(a+1,t.length-1),s;if(i==="color"){if(n=n.split(" "),s=n.shift(),n.length===4&&n[3].charAt(0)==="/"&&(n[3]=n[3].slice(1)),["srgb","display-p3","a98-rgb","prophoto-rgb","rec-2020"].indexOf(s)===-1)throw new Error(Pt(10,s))}else n=n.split(",");return n=n.map(r=>parseFloat(r)),{type:i,values:n,colorSpace:s}}function li(t){const{type:a,colorSpace:i}=t;let{values:n}=t;return a.indexOf("rgb")!==-1?n=n.map((s,r)=>r<3?parseInt(s,10):s):a.indexOf("hsl")!==-1&&(n[1]=`${n[1]}%`,n[2]=`${n[2]}%`),a.indexOf("color")!==-1?n=`${i} ${n.join(" ")}`:n=`${n.join(", ")}`,`${a}(${n})`}function ci(t,a){return t=ht(t),a=ri(a),(t.type==="rgb"||t.type==="hsl")&&(t.type+="a"),t.type==="color"?t.values[3]=`/${a}`:t.values[3]=a,li(t)}function di(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function pi(t){return parseFloat(t)}function xi(t){const{className:a,classes:i,pulsate:n=!1,rippleX:s,rippleY:r,rippleSize:w,in:x,onExited:c,timeout:p}=t,[g,u]=l.useState(!1),h=ne(a,i.ripple,i.rippleVisible,n&&i.ripplePulsate),m={width:w,height:w,top:-(w/2)+r,left:-(w/2)+s},d=ne(i.child,g&&i.childLeaving,n&&i.childPulsate);return!x&&!g&&u(!0),l.useEffect(()=>{if(!x&&c!=null){const T=setTimeout(c,p);return()=>{clearTimeout(T)}}},[c,x,p]),e.jsx("span",{className:h,style:m,children:e.jsx("span",{className:d})})}const ie=Ue("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),hi=["center","classes","className"];let Le=t=>t,gt,mt,ut,ft;const Ke=550,gi=80,mi=Se(gt||(gt=Le`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`,Pn=o.p`
  ...
  margin-left: 12px;
  color: ${t=>t.theme.editChannelPrimaryText};
`,Un=50,On=se.coreContractChain;function _n({DropdownRef:t,isDropdownOpen:a,closeDropdown:i}){Ee();const{account:n,chainId:s}=me(),{epnsWriteProvider:r,epnsCommWriteProvider:w}=U(W=>W.contracts),{channelDetails:x}=U(W=>W.admin),{CHANNNEL_DEACTIVATED_STATE:c,CHANNEL_BLOCKED_STATE:p}=U(W=>W.channels);U(W=>W.user);const g=Z(),{channelState:u}=x,h=On===s,m=Re(425),{isModalOpen:d,showModal:T,ModalComponent:P}=Ie(),{isModalOpen:$,showModal:_,ModalComponent:f}=Ie(),{isModalOpen:S,showModal:A,ModalComponent:L}=Ie(),G=a&&!d&&!$&&!S;ue(t,()=>G&&i()),H.useState(!1),H.useState(Un);const[K,R]=H.useState(0),B=u===c,N=u===p,y=N||B;H.useEffect(()=>{R(+Po.formatBigNumberToMetric(x.poolContribution,!0))},[n,x.poolContribution]),de();const E=()=>{N||(B?_():T())},k=de(),C=r.reactivateChannel,M=de(),j=()=>r.deactivateChannel(),pe=de(),re=async(W,xe)=>{if(!(W==""||xe=="")&&!(W<60))try{const oe=W+"+"+xe,F=Kt(oe);return r.addSubGraph(F)}catch(oe){console.error(oe)}};return e.jsxs(e.Fragment,{children:[e.jsx("div",{children:e.jsx(Fn,{background:g,children:e.jsxs(Gn,{children:[se.appEnv!=="prod"&&e.jsx(Et,{disabled:y,onClick:()=>!y&&A(),children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[e.jsx($e,{src:an,alt:"cube"}),e.jsx("div",{style:{width:"10px"}}),"Add SubGraph Details"]})}),h&&e.jsx(Et,{isChannelDeactivated:B,onClick:E,children:e.jsx(Vn,{isChannelBlocked:N,isChannelDeactivated:B,children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[N?e.jsx($e,{src:Tt,alt:"red-bell"}):B?e.jsx($e,{src:on,alt:"green-bell"}):e.jsx($e,{src:Tt,alt:"red-bell"}),e.jsx("div",{style:{width:"10px"}}),N?"Channel Blocked":B?"Activate Channel":"Deactivate Channel"]})})})]})})}),e.jsx(P,{InnerComponent:dn,onConfirm:j,toastObject:M,modalPosition:De.ON_ROOT}),e.jsx(f,{InnerComponent:wn,onConfirm:C,toastObject:k,modalMargin:m?"10rem 1rem 0 1rem":"",modalPosition:De.ON_ROOT}),e.jsx(L,{InnerComponent:rn,onConfirm:re,toastObject:pe,modalPosition:De.ON_ROOT})]})}const Fn=o.div`
  position: absolute;
  right: 20px;
  display: flex;
  flex-direction: column-reverse;
...
`,Pa=10;let Lt=null;const Ua=()=>{Z();const{account:t,chainId:a,wallet:i}=me(),{channelDetails:n,delegatees:s,aliasDetails:{aliasAddr:r,aliasEthAddr:w,isAliasVerified:x,aliasAddrFromContract:c}}=U(y=>y.admin),{processingState:p}=U(y=>y.channelCreation),{epnsWriteProvider:g}=U(y=>y.contracts),{userPushSDKInstance:u}=U(y=>y.user);l.useContext(Jt);const h=n&&n!=="unfetched",m=de(),d=Ee(),[T,P]=l.useState(!1);l.useState(!0);const[$,_]=l.useState(!1),f=se.coreContractChain===a,S=Re(600);l.useEffect(()=>{if(!f||!n||c||n==="unfetched")return;const y=vo(n);if(y){const{address:E,chainId:k}=y;d(To(E)),d(Ao(k))}else d(ke(0))},[n,c]);const A=async y=>{let{alias_address:E=null,is_alias_verified:k=null}=await Mo({userPushSDKInstance:u,address:y}).then(C=>C);return E=="NULL"&&(E=null),{aliasAddress:E,aliasVerified:k}};l.useEffect(()=>{!f||!c||p===0||(Lt=setInterval(async()=>{const{aliasAddress:y,aliasVerified:E}=await A(t);y?(d(So(y)),E?(d(xt(!0)),d(ke(0))):(d(ke(2)),d(xt(!1)))):p!=0&&p!=1&&d(ke(1))},Pa*1e3))},[c]),r!==null&&clearInterval(Lt);const L=async()=>{try{m.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const y=await g.destroyTimeBoundChannel(t,{gasLimit:1e6});console.debug(y),console.debug("Check: "+t),await y.wait(),m.showMessageToast({toastTitle:"Success",toastMessage:"Successfully deleted the channel",toastType:"SUCCESS",getToastIcon:E=>e.jsx(Y,{size:E,color:"green"})}),d(lt(null))}catch(y){console.error(y),y.code=="ACTION_REJECTED"?m.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:E=>e.jsx(Y,{size:E,color:"red"})}):m.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in deleting the channel",toastType:"ERROR",getToastIcon:E=>e.jsx(Y,{size:E,color:"red"})})}},G=()=>{_(!0)},K=()=>{_(!1)},{isModalOpen:R,showModal:B,ModalComponent:N}=Ie();return e.jsxs(V,{children:[(n==="unfetched"||p===null)&&e.jsx(jt,{}),n!=="unfetched"&&e.jsxs(J,{justifyContent:p===0&&"flex-start",height:"fit-content",children:[!n&&p===0&&e.jsx(Xo,{}),h&&p!==null&&e.jsx(Oa,{children:$?e.jsx(Ta,{closeEditChannel:K,UploadLogoComponent:N,displayUplaodLogoModal:B,isUploadLogoModalOpen:R}):e.jsxs(e.Fragment,{children:[n&&!S&&e.jsxs(V,{zIndex:"1",gap:"8px",children:[!T&&f&&e.jsx(ae,{onClick:G,size:"small",variant:"outline",children:"Edit Channel"}),!T&&e.jsx(kt,{}),T&&f&&e.jsx(ae,{onClick:L,size:"small",variant:"danger",children:"Delete Channel"})]}),n?e.jsx(Kn,{isChannelExpired:T,setIsChannelExpired:P,showEditChannel:G,destroyChannel:L}):""]})}),p!==0&&p!==null&&h&&!$&&e.jsx(e.Fragment,{children:e.jsx(Wi,{aliasEthAccount:w,setAliasVerified:xt})})]})]})},Oa=o(J)`
  align-items: center;
  align-self: center;
