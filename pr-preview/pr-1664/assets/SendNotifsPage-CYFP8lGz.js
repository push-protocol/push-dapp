import{q as s,cY as t,cZ as l,c_ as D,d0 as m,da as u,x as N,db as T,R as a,m as e,dc as h,n as L,z as _,S as f,__tla as $}from"./index-BTFf4Wyu.js";import{S as x,__tla as O}from"./SendNotifications-CHnJTkx-.js";import{__tla as p}from"./index-DktOm7IV.js";import{__tla as R}from"./Tag-B9I1Aen2.js";import{__tla as g}from"./TransitionGroupContext-XLowtahn.js";let A,G=Promise.all([(()=>{try{return $}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return p}catch{}})(),(()=>{try{return R}catch{}})(),(()=>{try{return g}catch{}})()]).then(async()=>{_.coreContractChain;function d(){m.pageview("/send_notificaiton"),u(),N(),T(n=>n.contracts),T(n=>n.admin),_.coreContractChain;const[r,J]=a.useState(2),[M,y]=a.useState(!0);a.useState(null),a.useState(null);const[o,b]=a.useState(!0);a.useState([]);const[E,I]=a.useState(null),U=()=>I(null);return a.useEffect(()=>{E&&U()},[E]),e.jsx(i,{children:r===2&&M?e.jsxs(e.Fragment,{children:[!o&&e.jsx(h,{replace:!0,to:"/dashboard"}),o&&e.jsx(x,{})]}):e.jsx(S,{children:"Channel details are being loaded, please wait\u2026"})})}let i,S,c;i=s(L)`
  align-items: center;
  align-self: center;
