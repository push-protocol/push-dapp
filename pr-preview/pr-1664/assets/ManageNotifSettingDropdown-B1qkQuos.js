import{q as u,B as E,ec as xe,r as f,ed as fe,m as n,x as se,D as oe,E as re,z as A,F as we,H as ae,X as ie,J as j,K as Se,M as le,N as de,Q as P,U as me,V as ce,Y as I,dA as pe,O as be,T as ye,ee as je,__tla as ve}from"./index-C8vLncdU.js";import{I as Me,R as Ce,__tla as Te}from"./RangeSlider-BtS1Z6R3.js";let _,ue,he,ge,$,De=Promise.all([(()=>{try{return ve}catch{}})(),(()=>{try{return Te}catch{}})()]).then(async()=>{let B,W,O,V,S,k,H,U,F,N,J,K,X,Y,q,Q,R,G,Z,ee,te,L,ne;_=({children:e,renderDropdownContainer:r,showDropdown:s,toggleDropdown:a,closeDropdown:o,containerPadding:h,centerOnMobile:i})=>{const p=f.useRef(null),c=f.useRef(null);return fe(p,c,o),n.jsxs(B,{ref:p,onClick:a,children:[e,s&&n.jsx(W,{containerPadding:h,centerOnMobile:i,children:n.jsx("div",{ref:c,onClick:t=>t.stopPropagation(),children:r})})]})},B=u.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
...
`,G=u.span`
  ${e=>e.hideIt&&E`
      visibility: hidden;
    `};
`,Z=({centerOnMobile:e,optOutHandler:r,channelSetting:s,channelDetail:a,userSetting:o,closeDropdown:h})=>{const[i,p]=f.useState(!1),c=ie();return n.jsxs(ee,{children:[s&&s.length!=0&&n.jsx(te,{children:n.jsx(J,{centerOnMobile:e,channelDetail:a,userSetting:o,channelSetting:s,onSuccessSave:h,children:n.jsxs(L,{flexDirection:"row",children:[n.jsx(pe,{width:"20px",height:"20px",src:"svg/manageSettings.svg",alt:"Settings Logo"}),n.jsx(j,{color:c.viewChannelPrimaryText,fontWeight:500,fontSize:"14px",children:"Manage Settings"})]})})}),n.jsxs(L,{flexDirection:"row",onClick:()=>r({setLoading:p}),children:[n.jsx(pe,{width:"20px",height:"20px",src:"svg/optout.svg",alt:"Opt-out Logo"}),n.jsxs(j,{color:c.viewChannelPrimaryText,fontWeight:500,fontSize:"14px",children:[i&&n.jsx(le,{type:de.SEAMLESS,spinnerSize:16,spinnerColor:"#000"}),!i&&n.jsx(ne,{hideIt:i,children:"Opt-out"})]})]})]})},ue=e=>{const{children:r,centerOnMobile:s,userSetting:a,channelDetail:o,onSuccessOptout:h}=e,[i,p]=f.useState(!1),{chainId:c,provider:t,account:d}=se();oe(T=>T.user);const l=re(),v=f.useMemo(()=>o&&(o!=null&&o.channel_settings)?JSON.parse(o==null?void 0:o.channel_settings):null,[o]),z=()=>{p(!i)},M=()=>{p(!1)},m=c===A.coreContractChain,b=ae(),C=async({setLoading:T})=>{const y=T||(()=>{});y(!0);try{let x=o.channel;m||(x=o.alias_address),b.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const w=await t.getSigner(d);await be.channels.unsubscribe({signer:w,channelAddress:P(x,c),userAddress:P(d,c),onSuccess:()=>{l(ye({channelAddress:x,status:!1})),l(je(x)),b.showMessageToast({toastTitle:"Success",toastMessage:"Successfully opted out of channel !",toastType:"SUCCESS",getToastIcon:g=>n.jsx(ce,{size:g,color:"green"})}),h(),M()},onError:()=>{console.error("opt out error"),b.showMessageToast({toastTitle:"Error",toastMessage:"There was an error opting out of channel",toastType:"ERROR",getToastIcon:g=>n.jsx(I,{size:g,color:"red"})})},env:A.pushNodesEnv})}catch(x){b.showMessageToast({toastTitle:"Error",toastMessage:`There was an error opting into channel ( ${x.message} )`,toastType:"ERROR",getToastIcon:w=>n.jsx(I,{size:w,color:"red"})}),console.error(x)}finally{y(!1)}};return n.jsx(_,{showDropdown:i,toggleDropdown:z,closeDropdown:M,renderDropdownContainer:n.jsx(Z,{centerOnMobile:s,userSetting:a,channelSetting:v,channelDetail:o,optOutHandler:C,closeDropdown:M}),containerPadding:"12px 16px",centerOnMobile:s,children:r})},ee=u.div`
