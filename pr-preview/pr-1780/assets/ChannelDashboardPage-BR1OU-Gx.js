import{b7 as v,g0 as Nn,g1 as Bc,g2 as ye,aZ as t,g3 as rt,g4 as De,g5 as Be,g6 as at,cC as ot,g7 as Tc,cB as ne,g8 as Jt,g9 as Fn,ga as Sc,gb as Kt,gc as Vt,gd as fe,ge as Gn,gf as st,gg as kc,gh as Mc,a_ as b,b1 as pe,d0 as te,bU as Ne,bV as Fe,bP as Z,b5 as q,bC as me,cZ as lt,be as Ii,eK as Ei,c_ as Te,b9 as Se,bg as Hn,bM as ge,cH as _c,bO as ct,cv as Xt,cu as Zt,bG as Qe,bd as Ae,bz as ee,bJ as Rc,gi as Dc,gj as dt,gk as Qc,bh as ke,b3 as Me,b2 as ht,ba as se,bW as Ge,bB as V,c2 as He,df as We,d1 as ie,bE as ue,c8 as Wn,c9 as ji,gl as Bi,dO as Uc,gm as Pc,d_ as $e,cY as $n,gn as qn,cw as _e,dm as Lc,en as Ti,c4 as pt,ex as zc,c5 as ut,go as Si,gp as Oc,dn as Yn,cP as ki,bL as Nc,gq as Fc,gr as Gc,gs as Hc,gt,dl as Jn,cK as Mi,b$ as _i,gu as Wc,bb as $c,gv as Kn,gw as qc,e6 as Yc,gx as Jc,bX as Vn,b8 as Xn,fI as ei,gy as Kc,gz as Vc,bR as Zn,eN as Xc,fL as Zc,gA as ed,cs as ft,gB as er,cg as tr,fn as td,gC as id,bF as nd,b4 as rd,bc as ad,gD as od,cb as Ri,gE as sd,gF as ir,gG as nr,gH as ld,gI as cd,gJ as dd,gK as hd,gL as pd,gM as Di,bA as qe,bD as ud,a$ as gd,__tla as fd}from"./index-BceMmvbP.js";import{S as xd,N as md,__tla as Ad}from"./RedCircle-CyCuxfSV.js";import{M as rr,g as ar,S as wd,F as Qi,m as Ui,a as or,C as sr,b as lr,i as bd,c as yd,__tla as vd}from"./ChannelInfoList-Ct6Pk6pQ.js";import{T as Cd,__tla as Id}from"./Tag-DLBoTrUH.js";import{M as Ed,a as jd,__tla as Bd}from"./EmptyNotificationSettings-CPRzZ84P.js";import{D as Td,__tla as Sd}from"./index-klQgbi3e.js";import{D as kd,__tla as Md}from"./entry-io2UnRvd.js";import{__tla as _d}from"./TransitionGroupContext-C74NdrUW.js";import{__tla as Rd}from"./index.es-B2eeBxyr.js";import"./browser-CeceZ__e.js";import{__tla as Dd}from"./index.esm-BufAEVsP.js";let cr,Qd=Promise.all([(()=>{try{return fd}catch{}})(),(()=>{try{return Ad}catch{}})(),(()=>{try{return vd}catch{}})(),(()=>{try{return Id}catch{}})(),(()=>{try{return Bd}catch{}})(),(()=>{try{return Sd}catch{}})(),(()=>{try{return Md}catch{}})(),(()=>{try{return _d}catch{}})(),(()=>{try{return Rd}catch{}})(),(()=>{try{return Dd}catch{}})()]).then(async()=>{const dr=e=>{const[n,i]=v.useState(!1),[r,s]=v.useState(null),h=v.useCallback(async(c,...o)=>{i(!0);try{const d=await c(...o);return i(!1),d}catch(d){throw i(!1),s(d),d}},[]),a=v.useCallback(async(...c)=>{try{return await h(e,...c)}catch(o){throw console.error(o),o}},[e,h]);return{loading:n,error:r,executeAsyncFunction:a}};function hr(e,n=0,i=1){return Bc(e,n,i)}function pr(e){e=e.slice(1);const n=new RegExp(`.{1,${e.length>=6?2:1}}`,"g");let i=e.match(n);return i&&i[0].length===1&&(i=i.map(r=>r+r)),i?`rgb${i.length===4?"a":""}(${i.map((r,s)=>s<3?parseInt(r,16):Math.round(parseInt(r,16)/255*1e3)/1e3).join(", ")})`:""}function Pi(e){if(e.type)return e;if(e.charAt(0)==="#")return Pi(pr(e));const n=e.indexOf("("),i=e.substring(0,n);if(["rgb","rgba","hsl","hsla","color"].indexOf(i)===-1)throw new Error(Nn(9,e));let r=e.substring(n+1,e.length-1),s;if(i==="color"){if(r=r.split(" "),s=r.shift(),r.length===4&&r[3].charAt(0)==="/"&&(r[3]=r[3].slice(1)),["srgb","display-p3","a98-rgb","prophoto-rgb","rec-2020"].indexOf(s)===-1)throw new Error(Nn(10,s))}else r=r.split(",");return r=r.map(h=>parseFloat(h)),{type:i,values:r,colorSpace:s}}function ur(e){const{type:n,colorSpace:i}=e;let{values:r}=e;return n.indexOf("rgb")!==-1?r=r.map((s,h)=>h<3?parseInt(s,10):s):n.indexOf("hsl")!==-1&&(r[1]=`${r[1]}%`,r[2]=`${r[2]}%`),n.indexOf("color")!==-1?r=`${i} ${r.join(" ")}`:r=`${r.join(", ")}`,`${n}(${r})`}function gr(e,n){return e=Pi(e),n=hr(n),(e.type==="rgb"||e.type==="hsl")&&(e.type+="a"),e.type==="color"?e.values[3]=`/${n}`:e.values[3]=n,ur(e)}const fr=v.createContext(),xr=()=>v.useContext(fr)??!1;function mr(e){return String(e).match(/[\d.\-+]*\s*(.*)/)[1]||""}function Ar(e){return parseFloat(e)}function wr(e){const{className:n,classes:i,pulsate:r=!1,rippleX:s,rippleY:h,rippleSize:a,in:c,onExited:o,timeout:d}=e,[u,l]=v.useState(!1),f=ye(n,i.ripple,i.rippleVisible,r&&i.ripplePulsate),p={width:a,height:a,top:-(a/2)+h,left:-(a/2)+s},g=ye(i.child,u&&i.childLeaving,r&&i.childPulsate);return!c&&!u&&l(!0),v.useEffect(()=>{if(!c&&o!=null){const A=setTimeout(o,d);return()=>{clearTimeout(A)}}},[o,c,d]),t.jsx("span",{className:f,style:p,children:t.jsx("span",{className:g})})}const ve=rt("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),br=["center","classes","className"];let xt=e=>e,Li,zi,Oi,Ni;const ti=550,yr=80,vr=De(Li||(Li=xt`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`)),Wr=e=>{const{classes:n,variant:i,color:r}=e,s={root:["root",`color${fe(r)}`,i],dashed:["dashed",`dashedColor${fe(r)}`],bar1:["bar",`barColor${fe(r)}`,(i==="indeterminate"||i==="query")&&"bar1Indeterminate",i==="determinate"&&"bar1Determinate",i==="buffer"&&"bar1Buffer"],bar2:["bar",i!=="buffer"&&`barColor${fe(r)}`,i==="buffer"&&`color${fe(r)}`,(i==="indeterminate"||i==="query")&&"bar2Indeterminate",i==="buffer"&&"bar2Buffer"]};return Vt(s,Or,n)},ni=(e,n)=>n==="inherit"?"currentColor":e.vars?e.vars.palette.LinearProgress[`${n}Bg`]:e.palette.mode==="light"?kc(e.palette[n].main,.62):Mc(e.palette[n].main,.5),$r=Be("span",{name:"MuiLinearProgress",slot:"Root",overridesResolver:(e,n)=>{const{ownerState:i}=e;return[n.root,n[`color${fe(i.color)}`],n[i.variant]]}})(({ownerState:e,theme:n})=>ne({position:"relative",overflow:"hidden",display:"block",height:4,zIndex:0,"@media print":{colorAdjust:"exact"},backgroundColor:ni(n,e.color)},e.color==="inherit"&&e.variant!=="buffer"&&{backgroundColor:"none","&::before":{content:'""',position:"absolute",left:0,top:0,right:0,bottom:0,backgroundColor:"currentColor",opacity:.3}},e.variant==="buffer"&&{backgroundColor:"transparent"},e.variant==="query"&&{transform:"rotate(180deg)"})),qr=Be("span",{name:"MuiLinearProgress",slot:"Dashed",overridesResolver:(e,n)=>{const{ownerState:i}=e;return[n.dashed,n[`dashedColor${fe(i.color)}`]]}})(({ownerState:e,theme:n})=>{const i=ni(n,e.color);return ne({position:"absolute",marginTop:0,height:"100%",width:"100%"},e.color==="inherit"&&{opacity:.3},{backgroundImage:`radial-gradient(${i} 0%, ${i} 16%, transparent 42%)`,backgroundSize:"10px 10px",backgroundPosition:"0 -23px"})},st(Wi||(Wi=Ye`
  ...
  `),Hr)),Yr=Be("span",{name:"MuiLinearProgress",slot:"Bar1",overridesResolver:(e,n)=>{const{ownerState:i}=e;return[n.bar,n[`barColor${fe(i.color)}`],(i.variant==="indeterminate"||i.variant==="query")&&n.bar1Indeterminate,i.variant==="determinate"&&n.bar1Determinate,i.variant==="buffer"&&n.bar1Buffer]}})(({ownerState:e,theme:n})=>ne({width:"100%",position:"absolute",left:0,bottom:0,top:0,transition:"transform 0.2s linear",transformOrigin:"left",backgroundColor:e.color==="inherit"?"currentColor":(n.vars||n).palette[e.color].main},e.variant==="determinate"&&{transition:`transform .${ii}s linear`},e.variant==="buffer"&&{zIndex:1,transition:`transform .${ii}s linear`}),({ownerState:e})=>(e.variant==="indeterminate"||e.variant==="query")&&st($i||($i=Ye`
    ...
    `),Gr)),Kr=v.forwardRef(function(e,n){const i=at({props:e,name:"MuiLinearProgress"}),{className:r,color:s="primary",value:h,valueBuffer:a,variant:c="indeterminate"}=i,o=ot(i,Nr),d=ne({},i,{color:s,variant:c}),u=Wr(d),l=xr(),f={},p={bar1:{},bar2:{}};if((c==="determinate"||c==="buffer")&&h!==void 0){f["aria-valuenow"]=Math.round(h),f["aria-valuemin"]=0,f["aria-valuemax"]=100;let g=h-100;l&&(g=-g),p.bar1.transform=`translateX(${g}%)`}if(c==="buffer"&&a!==void 0){let g=(a||0)-100;l&&(g=-g),p.bar2.transform=`translateX(${g}%)`}return t.jsxs($r,ne({className:ye(u.root,r),ownerState:d,role:"progressbar"},f,{ref:n},o,{children:[c==="buffer"?t.jsx(qr,{className:u.dashed,ownerState:d}):null,t.jsx(Yr,{className:u.bar1,ownerState:d,style:p.bar1}),c==="determinate"?null:t.jsx(Jr,{className:u.bar2,ownerState:d,style:p.bar2})]}))});function Vr(e){return Jt("MuiSkeleton",e)}rt("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const Xr=["animation","className","component","height","style","variant","width"];let mt=e=>e,Yi,Ji,Ki,Vi;const Zr=e=>{const{classes:n,variant:i,animation:r,hasChildren:s,width:h,height:a}=e;return Vt({root:["root",i,r,s&&"withChildren",s&&!h&&"fitContent",s&&!a&&"heightAuto"]},Vr,n)},ea=De(Yi||(Yi=mt`
  0% {
    opacity: 1;
  }
...
`,Ke=e=>e.trim().length==0;function sc({closeEditChannel:e,UploadLogoComponent:n,displayUplaodLogoModal:i}){const{account:r,provider:s}=Se(),{channelDetails:h,aliasDetails:{isAliasVerified:a,aliasAddrFromContract:c}}=Z(W=>W.admin),{epnsReadProvider:o,epnsWriteProvider:d}=Z(W=>W.contracts),u=50,[l,f]=v.useState(h==null?void 0:h.name),[p,g]=v.useState(h==null?void 0:h.info),[A,x]=v.useState(h==null?void 0:h.url),[m,C]=v.useState(h==null?void 0:h.icon),[y,B]=v.useState(h==null?void 0:h.icon),[T,M]=v.useState(h==null?void 0:h.icon),[E,j]=v.useState(T),[R,Q]=v.useState(null),[_,P]=v.useState(!1),[U,N]=v.useState({name:"",description:"",address:"",url:""}),[L,w]=v.useState(!1),[I,S]=v.useState(0),[D,k]=v.useState(0),[F,z]=v.useState(!1),O=Te();v.useEffect(()=>{r&&async function(){const W=await o.channelUpdateCounter(r);S(u*(Number(W)+1))}()},[r]),v.useEffect(()=>{!r||!s||async function(){const W=await ar({address:r,provider:s,contractAddress:_e.epnscore});k(parseInt(W));const J=parseInt(W);J>=I&&J!=0?P(!0):P(!1)}()},[r,s]);const H=async()=>{if(w(!0),!s)return;const W=s.getSigner(r);O.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{const J=await or({signer:W,contractAddress:_e.epnscore,amount:I-D});console.debug("response",J),J&&(w(!1),k(I),P(!0),O.showMessageToast({toastTitle:"Success",toastMessage:"Successfully approved Push!",toastType:"SUCCESS",getToastIcon:oe=>t.jsx(We,{size:oe,color:"green"})}))}catch(J){console.error(J),J.code=="ACTION_REJECTED"?O.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:oe=>t.jsx(ie,{size:oe,color:"red"})}):(O.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in approving PUSH Token",toastType:"ERROR",getToastIcon:oe=>t.jsx(ie,{size:oe,color:"red"})}),console.error("Error --> %o",J),console.error({err:J}))}w(!1)},Y=()=>{z(!1)},ce=$e(600),re=v.useRef(null);He(re,()=>{Y()});const X=()=>(N(""),Ke(l)||Ke(p)||Ke(A)?(Ke(l)&&N(W=>({...W,name:"Please, enter the channel name."})),Ke(p)&&N(W=>({...W,description:"Please, enter the channel description"})),Ke(A)&&N(W=>({...W,url:"Please, enter the channel url"})),!1):Ct(l,125)?Ct(A,125)?pi(A)?!0:(N(W=>({...W,url:"Channel URL is invalid! Please enter a valid url!"})),!1):(N(W=>({...W,url:"Channel Url should not exceed 125 characters! Please retry!"})),!1):(N(W=>({...W,name:"Channel Name should not exceed 125 characters! Please retry!"})),!1)),ae=()=>!(l!==(h==null?void 0:h.name)||p!==(h==null?void 0:h.info)||A!==(h==null?void 0:h.url)||y!==(h==null?void 0:h.icon)),$=async W=>{try{if(!X())return;w(!0);const J=JSON.stringify({name:l,info:p,url:A,icon:y,aliasDetails:h.aliasDetails||ir({chainId:parseInt(h.chain_id),address:h.address})});console.debug(J);const oe=await nr(J);console.debug("IPFS storagePointer:",oe);const Ce="1+"+oe,de=Si(Ce),Le=Ti(I.toString(),18);O.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const he=await d.updateChannelMeta(r,de,Le,{gasLimit:1e6});console.debug(he),await he.wait(),w(!1),O.showMessageToast({toastTitle:"Success",toastMessage:"Channel Updated Successfully",toastType:"SUCCESS",getToastIcon:xe=>t.jsx(We,{size:xe,color:"green"})}),setTimeout(()=>{window.location.reload()},2e3)}catch(J){w(!1),console.error(J.message),J.code=="ACTION_REJECTED"?O.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:oe=>t.jsx(ie,{size:oe,color:"red"})}):(O.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in updating channel Details",toastType:"ERROR",getToastIcon:oe=>t.jsx(ie,{size:oe,color:"red"})}),console.error("Error --> %o",J),console.error({err:J}))}},le=async W=>{await Ui({noOfTokens:W,provider:s,account:r})};return v.useEffect(()=>{T&&(console.debug("Image cropped",T),Dn(T,function(W){const J=Qn(W);console.debug("response",J),J.success&&(console.debug("Cropped Image....",T),B(T))}))},[T]),t.jsxs(lc,{ref:re,children:[t.jsx(n,{InnerComponent:Xl,InnerComponentProps:{setChannelLogo:C,channelLogo:m,croppedImage:T,setCroppedImage:M,setChannelFile:B,imageSrc:E,setImageSrc:j,imageType:R,setImageType:Q,errorInfo:U,setErrorInfo:N},modalPosition:ut.ON_PARENT}),t.jsxs(cc,{children:[t.jsxs(hc,{children:[t.jsx(pc,{src:m}),t.jsx(ge,{variant:"secondary",onClick:()=>{i(),z(!0)},children:"Upload Logo"})]}),!ce&&t.jsx(uc,{}),t.jsx(ql,{channelName:l,setChannelName:f,channelInfo:p,setChannelInfo:g,channelURL:A,setChannelURL:x,editChannel:$,errorInfo:U,setErrorInfo:N})]}),t.jsxs(gc,{children:[t.jsxs("div",{children:[t.jsx(fc,{children:"Channel edit fee"}),t.jsx(xc,{children:"Editing channel details requires fees to be deposited"})]}),t.jsxs(te,{flex:"0",children:[_?t.jsx(dc,{src:Vl}):null,t.jsxs(mc,{children:[I," PUSH"]})]})]}),t.jsx(Qi,{noOfPushTokensToCheck:I,containerProps:{width:"100%"},onMintPushToken:le}),L?t.jsx(t.Fragment,{children:t.jsxs(Ac,{children:[t.jsx(Spinner,{size:42,color:ee.COLORS.PRIMARY_PINK,type:ji.PROCESSING}),t.jsx(wc,{children:"Verifying Transaction"})]})}):t.jsx(t.Fragment,{children:t.jsxs(bc,{children:[t.jsx(ge,{onClick:e,variant:"outline",size:"large",children:"Cancel"}),D>=I?t.jsx(ge,{disabled:ae(),onClick:$,size:"large",children:"Save Changes"}):t.jsx(ge,{onClick:H,size:"large",children:"Approve PUSH"})]})})]})}const lc=b(ue)`
  padding: 0px;
