...
`,y=r(R)`
  ...
  justify-content: center;
  align-items: center;
`,Q=()=>{let{spaceid:t}=Te();return s.jsx(P,{children:s.jsx($,{spaceid:t})})},P=r(me)`
  flex: 1;
