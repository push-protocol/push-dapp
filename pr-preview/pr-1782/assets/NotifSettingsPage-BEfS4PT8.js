...
`,Ce=({title:r,description:x,onCancel:S,disabled:y,onClick:i,feeRequired:o})=>{const{account:w,provider:d}=pe(),[a,C]=l.useState(0),[B,g]=l.useState(!1),[$,u]=l.useState(!1),I=ce();l.useEffect(()=>{!w||!d||async function(){const N=await yt({address:w,provider:d,contractAddress:ue.epnscore});C(parseInt(N));const c=parseInt(N);c>=o&&c!=0?g(!0):g(!1)}()},[w,d]);const b=async()=>{if(u(!0),!d)return;const N=d.getSigner(w);I.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{const c=await Nt({signer:N,contractAddress:ue.epnscore,amount:o-a});console.debug("response",c),c&&(u(!1),C(o),g(!0),I.showMessageToast({toastTitle:"Success",toastMessage:"Successfully approved Push!",toastType:"SUCCESS",getToastIcon:_=>e.jsx(xe,{size:_,color:"green"})}))}catch(c){console.error(c),c.code=="ACTION_REJECTED"?I.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:_=>e.jsx(q,{size:_,color:"red"})}):(I.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in approving PUSH Token",toastType:"ERROR",getToastIcon:_=>e.jsx(q,{size:_,color:"red"})}),console.error("Error --> %o",c),console.error({err:c}))}u(!1)};return e.jsxs(e.Fragment,{children:[e.jsxs(Ae,{children:[e.jsxs("div",{children:[e.jsx(Me,{children:r}),e.jsx(Le,{children:x})]}),e.jsxs(de,{flex:"0",children:[B?e.jsx(ve,{src:ct}):null,e.jsxs(De,{children:[o," PUSH"]})]})]}),e.jsx(ut,{noOfPushTokensToCheck:o,containerProps:{width:"100%"},onMintPushToken:async N=>{await wt({noOfTokens:N,provider:d,account:w})}}),$?e.jsx(e.Fragment,{children:e.jsxs(Ie,{children:[e.jsx(Ze,{size:42,color:f.COLORS.PRIMARY_PINK,type:We.PROCESSING}),e.jsx(_e,{children:"Verifying Transaction"})]})}):e.jsx(e.Fragment,{children:e.jsxs($e,{children:[e.jsx(Q,{onClick:S,disabled:!1,variant:"outline",size:"large",children:"Cancel"}),a>=o?e.jsx(Q,{onClick:i,disabled:y,size:"large",children:"Save Changes"}):e.jsx(Q,{onClick:b,size:"large",disabled:y,children:"Approve PUSH"})]})})]})},ve=h.img``,Ae=h(le)`
