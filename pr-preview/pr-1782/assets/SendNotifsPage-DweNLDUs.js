import{a_ as s,bB as t,bC as l,bD as D,bF as u,bQ as m,b9 as N,bR as T,ba as a,aZ as e,bS as h,b3 as L,bd as _,a$ as f,__tla as $}from"./index-x4yuoUxs.js";import{S as x,__tla as O}from"./SendNotifications-wVZ-OElM.js";import{__tla as b}from"./index-3NDeyD0x.js";import{__tla as p}from"./Tag-mBP3xzQw.js";import{__tla as R}from"./TransitionGroupContext-BBf81mK4.js";let A,g=Promise.all([(()=>{try{return $}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return b}catch{}})(),(()=>{try{return p}catch{}})(),(()=>{try{return R}catch{}})()]).then(async()=>{_.coreContractChain;function M(){u.pageview("/send_notificaiton"),m(),N(),T(n=>n.contracts),T(n=>n.admin),_.coreContractChain;const[r,G]=a.useState(2),[d,J]=a.useState(!0);a.useState(null),a.useState(null);const[c,y]=a.useState(!0);a.useState([]);const[E,I]=a.useState(null),U=()=>I(null);return a.useEffect(()=>{E&&U()},[E]),e.jsx(i,{children:r===2&&d?e.jsxs(e.Fragment,{children:[!c&&e.jsx(h,{replace:!0,to:"/dashboard"}),c&&e.jsx(x,{})]}):e.jsx(S,{children:"Channel details are being loaded, please wait\u2026"})})}let i,S,o;i=s(L)`
  align-items: center;
  align-self: center;
