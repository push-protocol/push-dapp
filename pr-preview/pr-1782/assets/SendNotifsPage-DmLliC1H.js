import{b6 as s,bH as t,bI as l,bJ as _,bL as m,bV as u,aY as h,bW as D,bg as a,b1 as e,bX as L,bb as N,bi as T,b7 as f,__tla as $}from"./index-Cr8KHY-Q.js";import{S as b,__tla as p}from"./SendNotifications-CxfhGe8y.js";import{__tla as x}from"./index-DZtE8zy2.js";import{__tla as O}from"./Tag-DeNOPUtz.js";import{__tla as g}from"./TransitionGroupContext-CxfdJo9T.js";import{__tla as R}from"./slicedToArray-DZdLKFO2.js";let A,G=Promise.all([(()=>{try{return $}catch{}})(),(()=>{try{return p}catch{}})(),(()=>{try{return x}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return g}catch{}})(),(()=>{try{return R}catch{}})()]).then(async()=>{T.coreContractChain;function M(){m.pageview("/send_notificaiton"),u(),h(),D(n=>n.contracts),D(n=>n.admin),T.coreContractChain;const[r,J]=a.useState(2),[I,y]=a.useState(!0);a.useState(null),a.useState(null);const[c,j]=a.useState(!0);a.useState([]);const[E,d]=a.useState(null),U=()=>d(null);return a.useEffect(()=>{E&&U()},[E]),e.jsx(i,{children:r===2&&I?e.jsxs(e.Fragment,{children:[!c&&e.jsx(L,{replace:!0,to:"/dashboard"}),c&&e.jsx(b,{})]}):e.jsx(S,{children:"Channel details are being loaded, please wait\u2026"})})}let i,S,o;i=s(N)`
  align-items: center;
  align-self: center;
