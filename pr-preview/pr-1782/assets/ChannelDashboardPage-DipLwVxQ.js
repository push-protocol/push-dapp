import{fo as Bt,fp as Ya,a$ as l,fq as ie,b1 as e,fr as Oe,fs as Se,ft as Me,fu as Ue,cR as Fe,fv as Ja,cQ as Q,fw as it,fx as Ot,fy as Xa,fz as _e,fA as at,fB as je,fC as Ut,fD as Ft,b6 as o,b9 as Z,d1 as G,b3 as qa,b4 as Qa,b$ as O,bd as ee,bP as ce,c_ as ot,bs as _t,eP as Za,c$ as de,aY as me,b2 as eo,bY as ae,bp as to,b_ as Ee,bj as no,bl as io,bT as ve,bi as se,bM as U,bW as ao,fE as oo,fF as ke,fG as ro,bq as Ge,bb as Ve,ba as He,bg as V,ch as rt,bO as D,cl as ue,dt as fe,d2 as Y,bR as J,cr as Gt,cs as st,fH as lt,dF as so,fI as lo,dw as Re,cZ as Vt,fJ as Ht,bk as We,dp as co,bn as Wt,cn as Ie,eC as po,co as De,fK as Kt,fL as ho,dq as Yt,dj as Jt,aZ as xo,fM as go,fN as mo,fO as uo,fP as ct,ee as Xt,de as dt,c2 as pt,fQ as fo,b0 as bo,ce as Co,ci as wo,fR as yo,fS as jo,cK as vo,fT as To,fU as Ao,bN as be,fV as So,fW as Mo,fX as Eo,fY as ko,fZ as ht,bQ as Ro,b7 as Io,__tla as Do}from"./index-ocjBr9gs.js";import{S as No,N as Lo,__tla as zo}from"./RedCircle-8Wwj2rZQ.js";import{M as qt,S as $o,F as Qt,C as Zt,a as en,__tla as Po}from"./ChannelInfoList-B9-Xq2xc.js";import{a as Bo,__tla as Oo}from"./Tag-DeYhg5BJ.js";import{g as tn,m as nn,a as an,__tla as Uo}from"./PushTokenContractHelper-CWsIdxbj.js";import{M as Fo,a as _o,__tla as Go}from"./EmptyNotificationSettings-Cz3dBZFc.js";import{a as on,b as rn,__tla as Vo}from"./ValidationHelper-Cy7_AsYr.js";import{I as Ho,__tla as Wo}from"./ImageClipper-CH-8rHq1.js";import{v as Ko,C as Yo,__tla as Jo}from"./CreateChannel-CUIVc-eg.js";import{__tla as Xo}from"./TransitionGroupContext-BiAJHZXh.js";import{__tla as qo}from"./index.esm-BzHzGoFf.js";import{__tla as Qo}from"./useMutation-C9cDnkvj.js";import{__tla as Zo}from"./Stepper-e1Dd9lF8.js";import{__tla as er}from"./index.esm-DebTaVXK.js";import"./Common.form-LPxQflxb.js";let sn,tr=Promise.all([(()=>{try{return Do}catch{}})(),(()=>{try{return zo}catch{}})(),(()=>{try{return Po}catch{}})(),(()=>{try{return Oo}catch{}})(),(()=>{try{return Uo}catch{}})(),(()=>{try{return Go}catch{}})(),(()=>{try{return Vo}catch{}})(),(()=>{try{return Wo}catch{}})(),(()=>{try{return Jo}catch{}})(),(()=>{try{return Xo}catch{}})(),(()=>{try{return qo}catch{}})(),(()=>{try{return Qo}catch{}})(),(()=>{try{return Zo}catch{}})(),(()=>{try{return er}catch{}})()]).then(async()=>{function ln(t,a=0,n=1){return Ya(t,a,n)}function cn(t){t=t.slice(1);const a=new RegExp(`.{1,${t.length>=6?2:1}}`,"g");let n=t.match(a);return n&&n[0].length===1&&(n=n.map(i=>i+i)),n?`rgb${n.length===4?"a":""}(${n.map((i,s)=>s<3?parseInt(i,16):Math.round(parseInt(i,16)/255*1e3)/1e3).join(", ")})`:""}function xt(t){if(t.type)return t;if(t.charAt(0)==="#")return xt(cn(t));const a=t.indexOf("("),n=t.substring(0,a);if(["rgb","rgba","hsl","hsla","color"].indexOf(n)===-1)throw new Error(Bt(9,t));let i=t.substring(a+1,t.length-1),s;if(n==="color"){if(i=i.split(" "),s=i.shift(),i.length===4&&i[3].charAt(0)==="/"&&(i[3]=i[3].slice(1)),["srgb","display-p3","a98-rgb","prophoto-rgb","rec-2020"].indexOf(s)===-1)throw new Error(Bt(10,s))}else i=i.split(",");return i=i.map(r=>parseFloat(r)),{type:n,values:i,colorSpace:s}}function dn(t){const{type:a,colorSpace:n}=t;let{values:i}=t;return a.indexOf("rgb")!==-1?i=i.map((s,r)=>r<3?parseInt(s,10):s):a.indexOf("hsl")!==-1&&(i[1]=`${i[1]}%`,i[2]=`${i[2]}%`),a.indexOf("color")!==-1?i=`${n} ${i.join(" ")}`:i=`${i.join(", ")}`,`${a}(${i})`}function pn(t,a){return t=xt(t),a=ln(a),(t.type==="rgb"||t.type==="hsl")&&(t.type+="a"),t.type==="color"?t.values[3]=`/${a}`:t.values[3]=a,dn(t)}function hn(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function xn(t){return parseFloat(t)}function gn(t){const{className:a,classes:n,pulsate:i=!1,rippleX:s,rippleY:r,rippleSize:b,in:h,onExited:c,timeout:d}=t,[m,u]=l.useState(!1),x=ie(a,n.ripple,n.rippleVisible,i&&n.ripplePulsate),g={width:b,height:b,top:-(b/2)+r,left:-(b/2)+s},p=ie(n.child,m&&n.childLeaving,i&&n.childPulsate);return!h&&!m&&u(!0),l.useEffect(()=>{if(!h&&c!=null){const S=setTimeout(c,d);return()=>{clearTimeout(S)}}},[c,h,d]),e.jsx("span",{className:x,style:g,children:e.jsx("span",{className:p})})}const ne=Oe("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),mn=["center","classes","className"];let Ne=t=>t,gt,mt,ut,ft;const Ke=550,un=80,fn=Se(gt||(gt=Ne`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`),ne.rippleVisible,fn,Ke,({theme:t})=>t.transitions.easing.easeInOut,ne.ripplePulsate,({theme:t})=>t.transitions.duration.shorter,ne.child,ne.childLeaving,bn,Ke,({theme:t})=>t.transitions.easing.easeInOut,ne.childPulsate,Cn,({theme:t})=>t.transitions.easing.easeInOut),jn=l.forwardRef(function(t,a){const n=Ue({props:t,name:"MuiTouchRipple"}),{center:i=!1,classes:s={},className:r}=n,b=Fe(n,mn),[h,c]=l.useState([]),d=l.useRef(0),m=l.useRef(null);l.useEffect(()=>{m.current&&(m.current(),m.current=null)},[h]);const u=l.useRef(!1),x=Ja(),g=l.useRef(null),p=l.useRef(null),S=l.useCallback(f=>{const{pulsate:M,rippleX:E,rippleY:B,rippleSize:H,cb:K}=f;c(I=>[...I,e.jsx(yn,{classes:{ripple:ie(s.ripple,ne.ripple),rippleVisible:ie(s.rippleVisible,ne.rippleVisible),ripplePulsate:ie(s.ripplePulsate,ne.ripplePulsate),child:ie(s.child,ne.child),childLeaving:ie(s.childLeaving,ne.childLeaving),childPulsate:ie(s.childPulsate,ne.childPulsate)},timeout:Ke,pulsate:M,rippleX:E,rippleY:B,rippleSize:H},d.current)]),d.current+=1,m.current=K},[s]),L=l.useCallback((f={},M={},E=()=>{})=>{const{pulsate:B=!1,center:H=i||M.pulsate,fakeElement:K=!1}=M;if((f==null?void 0:f.type)==="mousedown"&&u.current){u.current=!1;return}(f==null?void 0:f.type)==="touchstart"&&(u.current=!0);const I=K?null:p.current,$=I?I.getBoundingClientRect():{width:0,height:0,left:0,top:0};let C,v,_;if(H||f===void 0||f.clientX===0&&f.clientY===0||!f.clientX&&!f.touches)C=Math.round($.width/2),v=Math.round($.height/2);else{const{clientX:P,clientY:T}=f.touches&&f.touches.length>0?f.touches[0]:f;C=Math.round(P-$.left),v=Math.round(T-$.top)}if(H)_=Math.sqrt((2*$.width**2+$.height**2)/3),_%2===0&&(_+=1);else{const P=Math.max(Math.abs((I?I.clientWidth:0)-C),C)*2+2,T=Math.max(Math.abs((I?I.clientHeight:0)-v),v)*2+2;_=Math.sqrt(P**2+T**2)}f!=null&&f.touches?g.current===null&&(g.current=()=>{S({pulsate:B,rippleX:C,rippleY:v,rippleSize:_,cb:E})},x.start(un,()=>{g.current&&(g.current(),g.current=null)})):S({pulsate:B,rippleX:C,rippleY:v,rippleSize:_,cb:E})},[i,S,x]),z=l.useCallback(()=>{L({},{pulsate:!0})},[L]),R=l.useCallback((f,M)=>{if(x.clear(),(f==null?void 0:f.type)==="touchend"&&g.current){g.current(),g.current=null,x.start(0,()=>{R(f,M)});return}g.current=null,c(E=>E.length>0?E.slice(1):E),m.current=M},[x]);return l.useImperativeHandle(a,()=>({pulsate:z,start:L,stop:R}),[z,L,R]),e.jsx(wn,Q({className:ie(ne.root,s.root,r),ref:p},b,{children:e.jsx(Bo,{component:null,exit:!0,children:h})}))});function vn(t){return it("MuiButtonBase",t)}const Tn=Oe("MuiButtonBase",["root","disabled","focusVisible"]),An=["action","centerRipple","children","className","component","disabled","disableRipple","disableTouchRipple","focusRipple","focusVisibleClassName","LinkComponent","onBlur","onClick","onContextMenu","onDragLeave","onFocus","onFocusVisible","onKeyDown","onKeyUp","onMouseDown","onMouseLeave","onMouseUp","onTouchEnd","onTouchMove","onTouchStart","tabIndex","TouchRippleProps","touchRippleRef","type"],Sn=t=>{const{disabled:a,focusVisible:n,focusVisibleClassName:i,classes:s}=t,r=at({root:["root",a&&"disabled",n&&"focusVisible"]},vn,s);return n&&i&&(r.root+=` ${i}`),r},Mn=Me("button",{name:"MuiButtonBase",slot:"Root",overridesResolver:(t,a)=>a.root})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${Tn.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),En=l.forwardRef(function(t,a){const n=Ue({props:t,name:"MuiButtonBase"}),{action:i,centerRipple:s=!1,children:r,className:b,component:h="button",disabled:c=!1,disableRipple:d=!1,disableTouchRipple:m=!1,focusRipple:u=!1,LinkComponent:x="a",onBlur:g,onClick:p,onContextMenu:S,onDragLeave:L,onFocus:z,onFocusVisible:R,onKeyDown:f,onKeyUp:M,onMouseDown:E,onMouseLeave:B,onMouseUp:H,onTouchEnd:K,onTouchMove:I,onTouchStart:$,tabIndex:C=0,TouchRippleProps:v,touchRippleRef:_,type:P}=n,T=Fe(n,An),A=l.useRef(null),y=l.useRef(null),pe=Ot(y,_),{isFocusVisibleRef:re,onFocus:W,onBlur:he,ref:oe}=Xa(),[F,le]=l.useState(!1);c&&F&&le(!1),l.useImperativeHandle(i,()=>({focusVisible:()=>{le(!0),A.current.focus()}}),[]);const[xe,we]=l.useState(!1);l.useEffect(()=>{we(!0)},[]);const ge=xe&&!d&&!c;l.useEffect(()=>{F&&u&&!d&&xe&&y.current.pulsate()},[d,u,F,xe]);function X(w,$t,Ka=m){return _e(Pt=>($t&&$t(Pt),!Ka&&y.current&&y.current[w](Pt),!0))}const ye=X("start",E),k=X("stop",S),te=X("stop",L),j=X("stop",H),N=X("stop",w=>{F&&w.preventDefault(),B&&B(w)}),q=X("start",$),Ze=X("stop",K),et=X("stop",I),tt=X("stop",w=>{he(w),re.current===!1&&le(!1),g&&g(w)},!1),Pe=_e(w=>{A.current||(A.current=w.currentTarget),W(w),re.current===!0&&(le(!0),R&&R(w)),z&&z(w)}),Te=()=>{const w=A.current;return h&&h!=="button"&&!(w.tagName==="A"&&w.href)},nt=l.useRef(!1),Ga=_e(w=>{u&&!nt.current&&F&&y.current&&w.key===" "&&(nt.current=!0,y.current.stop(w,()=>{y.current.start(w)})),w.target===w.currentTarget&&Te()&&w.key===" "&&w.preventDefault(),f&&f(w),w.target===w.currentTarget&&Te()&&w.key==="Enter"&&!c&&(w.preventDefault(),p&&p(w))}),Va=_e(w=>{u&&w.key===" "&&y.current&&F&&!w.defaultPrevented&&(nt.current=!1,y.current.stop(w,()=>{y.current.pulsate(w)})),M&&M(w),p&&w.target===w.currentTarget&&Te()&&w.key===" "&&!w.defaultPrevented&&p(w)});let Be=h;Be==="button"&&(T.href||T.to)&&(Be=x);const Ae={};Be==="button"?(Ae.type=P===void 0?"button":P,Ae.disabled=c):(!T.href&&!T.to&&(Ae.role="button"),c&&(Ae["aria-disabled"]=c));const Ha=Ot(a,oe,A),zt=Q({},n,{centerRipple:s,component:h,disabled:c,disableRipple:d,disableTouchRipple:m,focusRipple:u,tabIndex:C,focusVisible:F}),Wa=Sn(zt);return e.jsxs(Mn,Q({as:Be,className:ie(Wa.root,b),ownerState:zt,onBlur:tt,onClick:p,onContextMenu:k,onFocus:Pe,onKeyDown:Ga,onKeyUp:Va,onMouseDown:ye,onMouseLeave:N,onMouseUp:j,onDragLeave:te,onTouchEnd:Ze,onTouchMove:et,onTouchStart:q,ref:Ha,tabIndex:c?-1:C,type:P},Ae,T,{children:[r,ge?e.jsx(jn,Q({ref:pe,center:s},v)):null]}))});function kn(t){return it("MuiIconButton",t)}const Rn=Oe("MuiIconButton",["root","disabled","colorInherit","colorPrimary","colorSecondary","colorError","colorInfo","colorSuccess","colorWarning","edgeStart","edgeEnd","sizeSmall","sizeMedium","sizeLarge"]),In=["edge","children","className","color","disabled","disableFocusRipple","size"],Dn=t=>{const{classes:a,disabled:n,color:i,edge:s,size:r}=t,b={root:["root",n&&"disabled",i!=="default"&&`color${je(i)}`,s&&`edge${je(s)}`,`size${je(r)}`]};return at(b,kn,a)},Nn=Me(En,{name:"MuiIconButton",slot:"Root",overridesResolver:(t,a)=>{const{ownerState:n}=t;return[a.root,n.color!=="default"&&a[`color${je(n.color)}`],n.edge&&a[`edge${je(n.edge)}`],a[`size${je(n.size)}`]]}})(({theme:t,ownerState:a})=>Q({textAlign:"center",flex:"0 0 auto",fontSize:t.typography.pxToRem(24),padding:8,borderRadius:"50%",overflow:"visible",color:(t.vars||t).palette.action.active,transition:t.transitions.create("background-color",{duration:t.transitions.duration.shortest})},!a.disableRipple&&{"&:hover":{backgroundColor:t.vars?`rgba(${t.vars.palette.action.activeChannel} / ${t.vars.palette.action.hoverOpacity})`:Ut(t.palette.action.active,t.palette.action.hoverOpacity),"@media (hover: none)":{backgroundColor:"transparent"}}},a.edge==="start"&&{marginLeft:a.size==="small"?-3:-12},a.edge==="end"&&{marginRight:a.size==="small"?-3:-12}),({theme:t,ownerState:a})=>{var n;const i=(n=(t.vars||t).palette)==null?void 0:n[a.color];return Q({},a.color==="inherit"&&{color:"inherit"},a.color!=="inherit"&&a.color!=="default"&&Q({color:i==null?void 0:i.main},!a.disableRipple&&{"&:hover":Q({},i&&{backgroundColor:t.vars?`rgba(${i.mainChannel} / ${t.vars.palette.action.hoverOpacity})`:Ut(i.main,t.palette.action.hoverOpacity)},{"@media (hover: none)":{backgroundColor:"transparent"}})}),a.size==="small"&&{padding:5,fontSize:t.typography.pxToRem(18)},a.size==="large"&&{padding:12,fontSize:t.typography.pxToRem(28)},{[`&.${Rn.disabled}`]:{backgroundColor:"transparent",color:(t.vars||t).palette.action.disabled}})}),Ln=l.forwardRef(function(t,a){const n=Ue({props:t,name:"MuiIconButton"}),{edge:i=!1,children:s,className:r,color:b="default",disabled:h=!1,disableFocusRipple:c=!1,size:d="medium"}=n,m=Fe(n,In),u=Q({},n,{edge:i,color:b,disabled:h,disableFocusRipple:c,size:d}),x=Dn(u);return e.jsx(Nn,Q({className:ie(x.root,r),centerRipple:!0,focusRipple:!c,disabled:h,ref:a},m,{ownerState:u,children:s}))});function zn(t){return it("MuiSkeleton",t)}Oe("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const $n=["animation","className","component","height","style","variant","width"];let Le=t=>t,bt,Ct,wt,yt;const Pn=t=>{const{classes:a,variant:n,animation:i,hasChildren:s,width:r,height:b}=t;return at({root:["root",n,i,s&&"withChildren",s&&!r&&"fitContent",s&&!b&&"heightAuto"]},zn,a)},Bn=Se(bt||(bt=Le`
  0% {
    opacity: 1;
  }
...
`)),Un=Me("span",{name:"MuiSkeleton",slot:"Root",overridesResolver:(t,a)=>{const{ownerState:n}=t;return[a.root,a[n.variant],n.animation!==!1&&a[n.animation],n.hasChildren&&a.withChildren,n.hasChildren&&!n.width&&a.fitContent,n.hasChildren&&!n.height&&a.heightAuto]}})(({theme:t,ownerState:a})=>{const n=hn(t.shape.borderRadius)||"px",i=xn(t.shape.borderRadius);return Q({display:"block",backgroundColor:t.vars?t.vars.palette.Skeleton.bg:pn(t.palette.text.primary,t.palette.mode==="light"?.11:.13),height:"1.2em"},a.variant==="text"&&{marginTop:0,marginBottom:0,height:"auto",transformOrigin:"0 55%",transform:"scale(1, 0.60)",borderRadius:`${i}${n}/${Math.round(i/.6*10)/10}${n}`,"&:empty:before":{content:'"\\00a0"'}},a.variant==="circular"&&{borderRadius:"50%"},a.variant==="rounded"&&{borderRadius:(t.vars||t).shape.borderRadius},a.hasChildren&&{"& > *":{visibility:"hidden"}},a.hasChildren&&!a.width&&{maxWidth:"fit-content"},a.hasChildren&&!a.height&&{height:"auto"})},({ownerState:t})=>t.animation==="pulse"&&Ft(wt||(wt=Le`
    ...
    `),Bn),({ownerState:t,theme:a})=>t.animation==="wave"&&Ft(yt||(yt=Le`
      position: relative;
      overflow: hidden;
...
`,Oi=o.p`
  ...
  margin-left: 12px;
  color: ${t=>t.theme.editChannelPrimaryText};
`,Ui=50,Fi=se.coreContractChain;function _i({DropdownRef:t,isDropdownOpen:a,closeDropdown:n}){Ee();const{account:i,chainId:s}=me(),{epnsWriteProvider:r,epnsCommWriteProvider:b}=O(W=>W.contracts),{channelDetails:h}=O(W=>W.admin),{CHANNNEL_DEACTIVATED_STATE:c,CHANNEL_BLOCKED_STATE:d}=O(W=>W.channels);O(W=>W.user);const m=Z(),{channelState:u}=h,x=Fi===s,g=Re(425),{isModalOpen:p,showModal:S,ModalComponent:L}=Ie(),{isModalOpen:z,showModal:R,ModalComponent:f}=Ie(),{isModalOpen:M,showModal:E,ModalComponent:B}=Ie(),H=a&&!p&&!z&&!M;ue(t,()=>H&&n()),V.useState(!1),V.useState(Ui);const[K,I]=V.useState(0),$=u===c,C=u===d,v=C||$;V.useEffect(()=>{I(+po.formatBigNumberToMetric(h.poolContribution,!0))},[i,h.poolContribution]),de();const _=()=>{C||($?R():S())},P=de(),T=r.reactivateChannel,A=de(),y=()=>r.deactivateChannel(),pe=de(),re=async(W,he)=>{if(!(W==""||he=="")&&!(W<60))try{const oe=W+"+"+he,F=Kt(oe);return r.addSubGraph(F)}catch(oe){console.error(oe)}};return e.jsxs(e.Fragment,{children:[e.jsx("div",{children:e.jsx(Gi,{background:m,children:e.jsxs(Vi,{children:[se.appEnv!=="prod"&&e.jsx(Et,{disabled:v,onClick:()=>!v&&E(),children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[e.jsx($e,{src:oi,alt:"cube"}),e.jsx("div",{style:{width:"10px"}}),"Add SubGraph Details"]})}),x&&e.jsx(Et,{isChannelDeactivated:$,onClick:_,children:e.jsx(Hi,{isChannelBlocked:C,isChannelDeactivated:$,children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[C?e.jsx($e,{src:Tt,alt:"red-bell"}):$?e.jsx($e,{src:ri,alt:"green-bell"}):e.jsx($e,{src:Tt,alt:"red-bell"}),e.jsx("div",{style:{width:"10px"}}),C?"Channel Blocked":$?"Activate Channel":"Deactivate Channel"]})})})]})})}),e.jsx(L,{InnerComponent:pi,onConfirm:y,toastObject:A,modalPosition:De.ON_ROOT}),e.jsx(f,{InnerComponent:Ci,onConfirm:T,toastObject:P,modalMargin:g?"10rem 1rem 0 1rem":"",modalPosition:De.ON_ROOT}),e.jsx(B,{InnerComponent:si,onConfirm:re,toastObject:pe,modalPosition:De.ON_ROOT})]})}const Gi=o.div`
  position: absolute;
  right: 20px;
  display: flex;
  flex-direction: column-reverse;
...
`,Ce=t=>t.trim().length==0;function va(t,a){var n=new XMLHttpRequest;n.onload=function(){var i=new FileReader;i.onloadend=function(){a(i.result)},i.readAsDataURL(n.response)},n.open("GET",t),n.responseType="blob",n.send()}const Ta=t=>{var a=Ko,n=t.split(";base64,").pop(),i=vo.from(n,"base64"),s=a(i);return s.width>128||s.height>128?(console.error("Image size check failed... returning"),{success:0,info:"Image size check failed, Image should be 128X128PX"}):(console.debug("Image verification",n.charAt(0)),n.charAt(0)==="/"?{success:1,info:"Image checks passed"}:n.charAt(0)==="i"?{success:1,info:"Image checks passed"}:{success:0,info:"Image extension should be jpg or png"})};function Aa({closeEditChannel:t,UploadLogoComponent:a,displayUplaodLogoModal:n}){const{account:i,provider:s}=me(),{channelDetails:r,aliasDetails:{isAliasVerified:b,aliasAddrFromContract:h}}=O(j=>j.admin),{epnsReadProvider:c,epnsWriteProvider:d}=O(j=>j.contracts),m=50,[u,x]=l.useState(r==null?void 0:r.name),[g,p]=l.useState(r==null?void 0:r.info),[S,L]=l.useState(r==null?void 0:r.url),[z,R]=l.useState(r==null?void 0:r.icon),[f,M]=l.useState(r==null?void 0:r.icon),[E,B]=l.useState(r==null?void 0:r.icon),[H,K]=l.useState(E),[I,$]=l.useState(null),[C,v]=l.useState(!1),[_,P]=l.useState({name:"",description:"",address:"",url:""}),[T,A]=l.useState(!1),[y,pe]=l.useState(0),[re,W]=l.useState(0),[he,oe]=l.useState(!1),F=de();l.useEffect(()=>{i&&async function(){const j=await c.channelUpdateCounter(i);pe(m*(Number(j)+1))}()},[i]),l.useEffect(()=>{!i||!s||async function(){const j=await tn({address:i,provider:s,contractAddress:We.epnscore});W(parseInt(j));const N=parseInt(j);N>=y&&N!=0?v(!0):v(!1)}()},[i,s]);const le=async()=>{if(A(!0),!s)return;const j=s.getSigner(i);F.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{const N=await an({signer:j,contractAddress:We.epnscore,amount:y-re});console.debug("response",N),N&&(A(!1),W(y),v(!0),F.showMessageToast({toastTitle:"Success",toastMessage:"Successfully approved Push!",toastType:"SUCCESS",getToastIcon:q=>e.jsx(fe,{size:q,color:"green"})}))}catch(N){console.error(N),N.code=="ACTION_REJECTED"?F.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:q=>e.jsx(Y,{size:q,color:"red"})}):(F.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in approving PUSH Token",toastType:"ERROR",getToastIcon:q=>e.jsx(Y,{size:q,color:"red"})}),console.error("Error --> %o",N),console.error({err:N}))}A(!1)},xe=()=>{oe(!1)},we=Re(600),ge=l.useRef(null);ue(ge,()=>{xe()});const X=()=>(P(""),Ce(u)||Ce(g)||Ce(S)?(Ce(u)&&P(j=>({...j,name:"Please, enter the channel name."})),Ce(g)&&P(j=>({...j,description:"Please, enter the channel description"})),Ce(S)&&P(j=>({...j,url:"Please, enter the channel url"})),!1):rn(u,125)?rn(S,125)?on(S)?!0:(P(j=>({...j,url:"Channel URL is invalid! Please enter a valid url!"})),!1):(P(j=>({...j,url:"Channel Url should not exceed 125 characters! Please retry!"})),!1):(P(j=>({...j,name:"Channel Name should not exceed 125 characters! Please retry!"})),!1)),ye=()=>!(u!==(r==null?void 0:r.name)||g!==(r==null?void 0:r.info)||S!==(r==null?void 0:r.url)||f!==(r==null?void 0:r.icon)),k=async j=>{try{if(!X())return;A(!0);const N=JSON.stringify({name:u,info:g,url:S,icon:f,aliasDetails:r.aliasDetails||To({chainId:parseInt(r.chain_id),address:r.address})});console.debug(N);const q=await Ao(N);console.debug("IPFS storagePointer:",q);const Ze="1+"+q,et=Kt(Ze),tt=Wt(y.toString(),18);F.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const Pe=await d.updateChannelMeta(i,et,tt,{gasLimit:1e6});console.debug(Pe),await Pe.wait(),A(!1),F.showMessageToast({toastTitle:"Success",toastMessage:"Channel Updated Successfully",toastType:"SUCCESS",getToastIcon:Te=>e.jsx(fe,{size:Te,color:"green"})}),setTimeout(()=>{window.location.reload()},2e3)}catch(N){A(!1),console.error(N.message),N.code=="ACTION_REJECTED"?F.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:q=>e.jsx(Y,{size:q,color:"red"})}):(F.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in updating channel Details",toastType:"ERROR",getToastIcon:q=>e.jsx(Y,{size:q,color:"red"})}),console.error("Error --> %o",N),console.error({err:N}))}},te=async j=>{await nn({noOfTokens:j,provider:s,account:i})};return l.useEffect(()=>{E&&(console.debug("Image cropped",E),va(E,function(j){const N=Ta(j);console.debug("response",N),N.success&&(console.debug("Cropped Image....",E),M(E))}))},[E]),e.jsxs(Sa,{ref:ge,children:[e.jsx(a,{InnerComponent:ga,InnerComponentProps:{setChannelLogo:R,channelLogo:z,croppedImage:E,setCroppedImage:B,setChannelFile:M,imageSrc:H,setImageSrc:K,imageType:I,setImageType:$,errorInfo:_,setErrorInfo:P},modalPosition:De.ON_PARENT}),e.jsxs(Ma,{children:[e.jsxs(ka,{children:[e.jsx(Ra,{src:z}),e.jsx(ae,{variant:"secondary",onClick:()=>{n(),oe(!0)},children:"Upload Logo"})]}),!we&&e.jsx(Ia,{}),e.jsx(ca,{channelName:u,setChannelName:x,channelInfo:g,setChannelInfo:p,channelURL:S,setChannelURL:L,editChannel:k,errorInfo:_,setErrorInfo:P})]}),e.jsxs(Da,{children:[e.jsxs("div",{children:[e.jsx(Na,{children:"Channel edit fee"}),e.jsx(La,{children:"Editing channel details requires fees to be deposited"})]}),e.jsxs(G,{flex:"0",children:[C?e.jsx(Ea,{src:xa}):null,e.jsxs(za,{children:[y," PUSH"]})]})]}),e.jsx(Qt,{noOfPushTokensToCheck:y,containerProps:{width:"100%"},onMintPushToken:te}),T?e.jsx(e.Fragment,{children:e.jsxs($a,{children:[e.jsx(Spinner,{size:42,color:U.COLORS.PRIMARY_PINK,type:st.PROCESSING}),e.jsx(Pa,{children:"Verifying Transaction"})]})}):e.jsx(e.Fragment,{children:e.jsxs(Ba,{children:[e.jsx(ae,{onClick:t,variant:"outline",size:"large",children:"Cancel"}),re>=y?e.jsx(ae,{disabled:ye(),onClick:k,size:"large",children:"Save Changes"}):e.jsx(ae,{onClick:le,size:"large",children:"Approve PUSH"})]})})]})}const Sa=o(J)`
  padding: 0px;
...
`,Oa=10;let Nt=null;const Ua=()=>{Z();const{account:t,chainId:a,wallet:n}=me(),{channelDetails:i,delegatees:s,aliasDetails:{aliasAddr:r,aliasEthAddr:b,isAliasVerified:h,aliasAddrFromContract:c}}=O(C=>C.admin),{processingState:d}=O(C=>C.channelCreation),{epnsWriteProvider:m}=O(C=>C.contracts);O(C=>C.user),l.useContext(Jt);const u=i&&i!=="unfetched",x=de(),g=Ee(),[p,S]=l.useState(!1);l.useState(!0);const[L,z]=l.useState(!1),R=se.coreContractChain===a,f=Re(600);l.useEffect(()=>{if(!R||!i||c||i==="unfetched")return;const C=So(i);if(C){const{address:v,chainId:_}=C;g(Mo(v)),g(Eo(_))}else g(ke(0))},[i,c]);const M=async C=>{let{aliasAddress:v=null,isAliasVerified:_=null}=await Xt.getInstance().getChannelDetailsFromAddress(C);return v=="NULL"&&(v=null),{aliasAddress:v,aliasVerified:_}};l.useEffect(()=>{!R||!c||d===0||(Nt=setInterval(async()=>{const{aliasAddress:C,aliasVerified:v}=await M(t);C?(g(ko(C)),v?(g(ht(!0)),g(ke(0))):(g(ke(2)),g(ht(!1)))):d!=0&&d!=1&&g(ke(1))},Oa*1e3))},[c]),r!==null&&clearInterval(Nt);const E=async()=>{try{x.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const C=await m.destroyTimeBoundChannel(t,{gasLimit:1e6});console.debug(C),console.debug("Check: "+t),await C.wait(),x.showMessageToast({toastTitle:"Success",toastMessage:"Successfully deleted the channel",toastType:"SUCCESS",getToastIcon:v=>e.jsx(Y,{size:v,color:"green"})}),g(lt(null))}catch(C){console.error(C),C.code=="ACTION_REJECTED"?x.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:v=>e.jsx(Y,{size:v,color:"red"})}):x.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in deleting the channel",toastType:"ERROR",getToastIcon:v=>e.jsx(Y,{size:v,color:"red"})})}},B=()=>{z(!0)},H=()=>{z(!1)},{isModalOpen:K,showModal:I,ModalComponent:$}=Ie();return e.jsxs(G,{children:[(i==="unfetched"||d===null)&&e.jsx(jt,{}),i!=="unfetched"&&e.jsxs(J,{justifyContent:d===0&&"flex-start",height:"fit-content",children:[!i&&d===0&&e.jsx(Yo,{}),u&&d!==null&&e.jsx(Fa,{children:L?e.jsx(Aa,{closeEditChannel:H,UploadLogoComponent:$,displayUplaodLogoModal:I,isUploadLogoModalOpen:K}):e.jsxs(e.Fragment,{children:[i&&!f&&e.jsxs(G,{zIndex:"1",gap:"8px",children:[!p&&R&&e.jsx(ae,{onClick:B,size:"small",variant:"outline",children:"Edit Channel"}),!p&&e.jsx(kt,{}),p&&R&&e.jsx(ae,{onClick:E,size:"small",variant:"danger",children:"Delete Channel"})]}),i?e.jsx(Yi,{isChannelExpired:p,setIsChannelExpired:S,showEditChannel:B,destroyChannel:E}):""]})}),d!==0&&d!==null&&u&&!L&&e.jsx(e.Fragment,{children:e.jsx(Yn,{aliasEthAccount:b,setAliasVerified:ht})})]})]})},Fa=o(J)`
  align-items: center;
  align-self: center;
