...
`)),Un=Me("span",{name:"MuiSkeleton",slot:"Root",overridesResolver:(t,a)=>{const{ownerState:n}=t;return[a.root,a[n.variant],n.animation!==!1&&a[n.animation],n.hasChildren&&a.withChildren,n.hasChildren&&!n.width&&a.fitContent,n.hasChildren&&!n.height&&a.heightAuto]}})(({theme:t,ownerState:a})=>{const n=hn(t.shape.borderRadius)||"px",i=xn(t.shape.borderRadius);return Q({display:"block",backgroundColor:t.vars?t.vars.palette.Skeleton.bg:pn(t.palette.text.primary,t.palette.mode==="light"?.11:.13),height:"1.2em"},a.variant==="text"&&{marginTop:0,marginBottom:0,height:"auto",transformOrigin:"0 55%",transform:"scale(1, 0.60)",borderRadius:`${i}${n}/${Math.round(i/.6*10)/10}${n}`,"&:empty:before":{content:'"\\00a0"'}},a.variant==="circular"&&{borderRadius:"50%"},a.variant==="rounded"&&{borderRadius:(t.vars||t).shape.borderRadius},a.hasChildren&&{"& > *":{visibility:"hidden"}},a.hasChildren&&!a.width&&{maxWidth:"fit-content"},a.hasChildren&&!a.height&&{height:"auto"})},({ownerState:t})=>t.animation==="pulse"&&Ft(yt||(yt=Le`
    ...
    `),Pn),({ownerState:t,theme:a})=>t.animation==="wave"&&Ft(wt||(wt=Le`
      position: relative;
      overflow: hidden;
...
`,Oi=o.p`
  ...
  margin-left: 12px;
  color: ${t=>t.theme.editChannelPrimaryText};
`,Ui=50,Fi=se.coreContractChain;function _i({DropdownRef:t,isDropdownOpen:a,closeDropdown:n}){Ee();const{account:i,chainId:s}=me(),{epnsWriteProvider:r,epnsCommWriteProvider:b}=O(W=>W.contracts),{channelDetails:h}=O(W=>W.admin),{CHANNNEL_DEACTIVATED_STATE:c,CHANNEL_BLOCKED_STATE:d}=O(W=>W.channels);O(W=>W.user);const m=Z(),{channelState:u}=h,x=Fi===s,g=Re(425),{isModalOpen:p,showModal:S,ModalComponent:L}=Ie(),{isModalOpen:z,showModal:R,ModalComponent:f}=Ie(),{isModalOpen:M,showModal:E,ModalComponent:P}=Ie(),H=a&&!p&&!z&&!M;ue(t,()=>H&&n()),V.useState(!1),V.useState(Ui);const[K,I]=V.useState(0),$=u===c,C=u===d,v=C||$;V.useEffect(()=>{I(+po.formatBigNumberToMetric(h.poolContribution,!0))},[i,h.poolContribution]),de();const _=()=>{C||($?R():S())},B=de(),T=r.reactivateChannel,A=de(),w=()=>r.deactivateChannel(),pe=de(),re=async(W,he)=>{if(!(W==""||he=="")&&!(W<60))try{const oe=W+"+"+he,F=Kt(oe);return r.addSubGraph(F)}catch(oe){console.error(oe)}};return e.jsxs(e.Fragment,{children:[e.jsx("div",{children:e.jsx(Gi,{background:m,children:e.jsxs(Vi,{children:[se.appEnv!=="prod"&&e.jsx(Et,{disabled:v,onClick:()=>!v&&E(),children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[e.jsx($e,{src:oi,alt:"cube"}),e.jsx("div",{style:{width:"10px"}}),"Add SubGraph Details"]})}),x&&e.jsx(Et,{isChannelDeactivated:$,onClick:_,children:e.jsx(Hi,{isChannelBlocked:C,isChannelDeactivated:$,children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[C?e.jsx($e,{src:Tt,alt:"red-bell"}):$?e.jsx($e,{src:ri,alt:"green-bell"}):e.jsx($e,{src:Tt,alt:"red-bell"}),e.jsx("div",{style:{width:"10px"}}),C?"Channel Blocked":$?"Activate Channel":"Deactivate Channel"]})})})]})})}),e.jsx(L,{InnerComponent:pi,onConfirm:w,toastObject:A,modalPosition:De.ON_ROOT}),e.jsx(f,{InnerComponent:Ci,onConfirm:T,toastObject:B,modalMargin:g?"10rem 1rem 0 1rem":"",modalPosition:De.ON_ROOT}),e.jsx(P,{InnerComponent:si,onConfirm:re,toastObject:pe,modalPosition:De.ON_ROOT})]})}const Gi=o.div`
  position: absolute;
  right: 20px;
  display: flex;
  flex-direction: column-reverse;
