import{b6 as i,b9 as N,b1 as t,ba as le,b3 as G,b4 as q,bY as J,bO as p,bT as K,aY as pe,bi as xe,a$ as l,cm as ce,c2 as he,dv as ge,cn as me,cw as fe,dw as w,bd as h,be as Q,dl as X,dx as ue,ck as we,__tla as je}from"./index-BirspV-x.js";import{b as Ce,__tla as be}from"./PushTokenContractHelper-CSEJhZNL.js";import{E as ye,__tla as ve}from"./EmptyNotificationSettings-CjKraccO.js";import{T as j,__tla as ke}from"./Tag-CGw1ArTX.js";let ee,te,ie,ne,oe,Le=Promise.all([(()=>{try{return je}catch{}})(),(()=>{try{return be}catch{}})(),(()=>{try{return ve}catch{}})(),(()=>{try{return ke}catch{}})()]).then(async()=>{let C,b,y,v,k,L,M,_,g,T,m,$,H,S;ie=({text:e,onClick:s,isLoading:n,topMargin:o,loaderTitle:r})=>{const a=N();return t.jsx(le,{theme:a,children:t.jsx(C,{style:{marginTop:o||"55px"},children:n?t.jsx(b,{children:t.jsx(G,{type:q.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:r??"",titleColor:"#fff"})}):t.jsx(J,{onClick:s,variant:"primary",size:"large",children:e})})})},C=i.div`
  display: flex;
