import{fj as Pt,fk as Ja,a$ as l,fl as ie,b1 as e,fm as Oe,fn as Se,fo as Me,fp as Ue,cP as _e,fq as Ya,cO as Q,fr as it,fs as Ot,ft as Xa,fu as Fe,fv as at,fw as je,fx as Ut,fy as _t,b6 as o,b9 as Z,d0 as G,b3 as qa,b4 as Qa,bW as O,bd as ee,bK as ce,cZ as ot,bn as Ft,eK as Za,c_ as de,aY as me,b2 as eo,bT as ae,bl as to,bV as Ee,cI as no,cH as io,bO as ve,bi as se,bH as U,bR as ao,fz as oo,fA as ke,fB as ro,bm as Ge,bb as Ve,ba as He,bg as V,cb as rt,bJ as D,cf as ue,dp as fe,d1 as J,bM as Y,cl as Gt,cm as st,fC as lt,dA as so,fD as lo,dr as Re,cY as Vt,fE as Ht,cJ as Ke,dk as co,en as Kt,ch as Ie,ex as po,ci as De,fF as Wt,fG as ho,dl as Jt,df as Yt,aZ as xo,fH as go,fI as mo,fJ as uo,fK as ct,e8 as Xt,da as dt,bZ as pt,fL as fo,b0 as bo,c8 as Co,cc as yo,fM as wo,fN as jo,cF as vo,fO as To,fP as Ao,bI as be,fQ as So,fR as Mo,fS as Eo,fT as ko,fU as ht,bL as Ro,b7 as Io,__tla as Do}from"./index-D2obaA8e.js";import{S as No,N as Lo,__tla as zo}from"./RedCircle-B2zRoLzQ.js";import{M as qt,S as $o,F as Qt,C as Zt,a as en,__tla as Bo}from"./ChannelInfoList-CKyxD9Ue.js";import{a as Po,__tla as Oo}from"./Tag-CZHgcWie.js";import{g as tn,m as nn,a as an,__tla as Uo}from"./UniswapWidget-CqcqyfYk.js";import{M as _o,a as Fo,__tla as Go}from"./EmptyNotificationSettings-DDmebHFT.js";import{a as on,b as rn,__tla as Vo}from"./ValidationHelper-BGsRuZ0r.js";import{I as Ho,v as Ko,C as Wo,__tla as Jo}from"./CreateChannel-CNakrnOA.js";import{__tla as Yo}from"./TransitionGroupContext-CLU50ncN.js";import{__tla as Xo}from"./slicedToArray-Dfk4nthM.js";import{__tla as qo}from"./index.es-9_WTjoyh.js";import"./browser-CeceZ__e.js";import{__tla as Qo}from"./index.esm-cG8JyexQ.js";import{__tla as Zo}from"./ErrorFilled-Dqx9mlUI.js";import{__tla as er}from"./Stepper-CP-dgV3R.js";import{__tla as tr}from"./useMutation-BE_Jfo12.js";import{__tla as nr}from"./index.esm-A8AFZX5f.js";import"./Common.form-LPxQflxb.js";let sn,ir=Promise.all([(()=>{try{return Do}catch{}})(),(()=>{try{return zo}catch{}})(),(()=>{try{return Bo}catch{}})(),(()=>{try{return Oo}catch{}})(),(()=>{try{return Uo}catch{}})(),(()=>{try{return Go}catch{}})(),(()=>{try{return Vo}catch{}})(),(()=>{try{return Jo}catch{}})(),(()=>{try{return Yo}catch{}})(),(()=>{try{return Xo}catch{}})(),(()=>{try{return qo}catch{}})(),(()=>{try{return Qo}catch{}})(),(()=>{try{return Zo}catch{}})(),(()=>{try{return er}catch{}})(),(()=>{try{return tr}catch{}})(),(()=>{try{return nr}catch{}})()]).then(async()=>{function ln(t,a=0,n=1){return Ja(t,a,n)}function cn(t){t=t.slice(1);const a=new RegExp(`.{1,${t.length>=6?2:1}}`,"g");let n=t.match(a);return n&&n[0].length===1&&(n=n.map(i=>i+i)),n?`rgb${n.length===4?"a":""}(${n.map((i,s)=>s<3?parseInt(i,16):Math.round(parseInt(i,16)/255*1e3)/1e3).join(", ")})`:""}function xt(t){if(t.type)return t;if(t.charAt(0)==="#")return xt(cn(t));const a=t.indexOf("("),n=t.substring(0,a);if(["rgb","rgba","hsl","hsla","color"].indexOf(n)===-1)throw new Error(Pt(9,t));let i=t.substring(a+1,t.length-1),s;if(n==="color"){if(i=i.split(" "),s=i.shift(),i.length===4&&i[3].charAt(0)==="/"&&(i[3]=i[3].slice(1)),["srgb","display-p3","a98-rgb","prophoto-rgb","rec-2020"].indexOf(s)===-1)throw new Error(Pt(10,s))}else i=i.split(",");return i=i.map(r=>parseFloat(r)),{type:n,values:i,colorSpace:s}}function dn(t){const{type:a,colorSpace:n}=t;let{values:i}=t;return a.indexOf("rgb")!==-1?i=i.map((s,r)=>r<3?parseInt(s,10):s):a.indexOf("hsl")!==-1&&(i[1]=`${i[1]}%`,i[2]=`${i[2]}%`),a.indexOf("color")!==-1?i=`${n} ${i.join(" ")}`:i=`${i.join(", ")}`,`${a}(${i})`}function pn(t,a){return t=xt(t),a=ln(a),(t.type==="rgb"||t.type==="hsl")&&(t.type+="a"),t.type==="color"?t.values[3]=`/${a}`:t.values[3]=a,dn(t)}function hn(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function xn(t){return parseFloat(t)}function gn(t){const{className:a,classes:n,pulsate:i=!1,rippleX:s,rippleY:r,rippleSize:b,in:h,onExited:c,timeout:d}=t,[m,u]=l.useState(!1),x=ie(a,n.ripple,n.rippleVisible,i&&n.ripplePulsate),g={width:b,height:b,top:-(b/2)+r,left:-(b/2)+s},p=ie(n.child,m&&n.childLeaving,i&&n.childPulsate);return!h&&!m&&u(!0),l.useEffect(()=>{if(!h&&c!=null){const S=setTimeout(c,d);return()=>{clearTimeout(S)}}},[c,h,d]),e.jsx("span",{className:x,style:g,children:e.jsx("span",{className:p})})}const ne=Oe("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),mn=["center","classes","className"];let Ne=t=>t,gt,mt,ut,ft;const We=550,un=80,fn=Se(gt||(gt=Ne`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`,Oi=o.p`
  ...
  margin-left: 12px;
  color: ${t=>t.theme.editChannelPrimaryText};
`,Ui=50,_i=se.coreContractChain;function Fi({DropdownRef:t,isDropdownOpen:a,closeDropdown:n}){Ee();const{account:i,chainId:s}=me(),{epnsWriteProvider:r,epnsCommWriteProvider:b}=O(K=>K.contracts),{channelDetails:h}=O(K=>K.admin),{CHANNNEL_DEACTIVATED_STATE:c,CHANNEL_BLOCKED_STATE:d}=O(K=>K.channels);O(K=>K.user);const m=Z(),{channelState:u}=h,x=_i===s,g=Re(425),{isModalOpen:p,showModal:S,ModalComponent:L}=Ie(),{isModalOpen:z,showModal:R,ModalComponent:f}=Ie(),{isModalOpen:M,showModal:E,ModalComponent:P}=Ie(),H=a&&!p&&!z&&!M;ue(t,()=>H&&n()),V.useState(!1),V.useState(Ui);const[W,I]=V.useState(0),$=u===c,C=u===d,v=C||$;V.useEffect(()=>{I(+po.formatBigNumberToMetric(h.poolContribution,!0))},[i,h.poolContribution]),de();const F=()=>{C||($?R():S())},B=de(),T=r.reactivateChannel,A=de(),w=()=>r.deactivateChannel(),pe=de(),re=async(K,he)=>{if(!(K==""||he=="")&&!(K<60))try{const oe=K+"+"+he,_=Wt(oe);return r.addSubGraph(_)}catch(oe){console.error(oe)}};return e.jsxs(e.Fragment,{children:[e.jsx("div",{children:e.jsx(Gi,{background:m,children:e.jsxs(Vi,{children:[se.appEnv!=="prod"&&e.jsx(Et,{disabled:v,onClick:()=>!v&&E(),children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[e.jsx($e,{src:oi,alt:"cube"}),e.jsx("div",{style:{width:"10px"}}),"Add SubGraph Details"]})}),x&&e.jsx(Et,{isChannelDeactivated:$,onClick:F,children:e.jsx(Hi,{isChannelBlocked:C,isChannelDeactivated:$,children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[C?e.jsx($e,{src:Tt,alt:"red-bell"}):$?e.jsx($e,{src:ri,alt:"green-bell"}):e.jsx($e,{src:Tt,alt:"red-bell"}),e.jsx("div",{style:{width:"10px"}}),C?"Channel Blocked":$?"Activate Channel":"Deactivate Channel"]})})})]})})}),e.jsx(L,{InnerComponent:pi,onConfirm:w,toastObject:A,modalPosition:De.ON_ROOT}),e.jsx(f,{InnerComponent:Ci,onConfirm:T,toastObject:B,modalMargin:g?"10rem 1rem 0 1rem":"",modalPosition:De.ON_ROOT}),e.jsx(P,{InnerComponent:si,onConfirm:re,toastObject:pe,modalPosition:De.ON_ROOT})]})}const Gi=o.div`
  position: absolute;
  right: 20px;
  display: flex;
  flex-direction: column-reverse;
...
`,$e=o.img`
  ...
  padding: 0;
  margin: 0;
`;function kt(){const t=V.useRef(null),[a,n]=V.useState(!1);Z();const i=()=>{n(r=>!r)},s=()=>{n(!1)};return e.jsxs(G,{flex:"0",ref:t,children:[e.jsx(Ki,{active:a,onClick:i}),a&&e.jsx(Fi,{DropdownRef:t,isDropdownOpen:a,closeDropdown:s})]})}o.div`
  flex: 1;
  display: flex;
...
`,Wi="DD MMM, YYYY";function Ji({isChannelExpired:t,setIsChannelExpired:a,showEditChannel:n,destroyChannel:i}){var ge,X,we;const{account:s,chainId:r,wallet:b}=me(),{delegatees:h,channelDetails:c,canVerify:d,aliasDetails:{isAliasVerified:m,aliasAddrFromContract:u}}=O(k=>k.admin),{channelSettings:x}=O(k=>k.channels),{userPushSDKInstance:g}=O(k=>k.user),{handleConnectWalletAndEnableProfile:p}=l.useContext(Yt),{CHANNEL_ACTIVE_STATE:S,CHANNNEL_DEACTIVATED_STATE:L}=O(k=>k.channels),{processingState:z}=O(k=>k.channelCreation),[R,f]=l.useState([]),[M,E]=l.useState("");let{channelState:P}=c;P||(P=c.activation_status);const H=P===S,W=P===L,I=se.coreContractChain===r,$=Re(600),[C,v]=l.useState([s]),[F,B]=l.useState(void 0);O(k=>k.contracts);const T=xo(),{isModalOpen:A,showModal:w,ModalComponent:pe}=Ie(),re=de(),K=async()=>{g.signer||await p({wallet:b}),w()},he=async k=>g.channel.delegate.add(dt(k,r)),oe=c.expiryTime?go(((ge=c.expiryTime)==null?void 0:ge.toString())*1e3):"",_=c.expiryTime?mo(((X=c.expiryTime)==null?void 0:X.toString())*1e3):!0,le=c.expiryTime?uo(((we=c.expiryTime)==null?void 0:we.toString())*1e3,14):"";l.useEffect(()=>{c.channelType==ct.TIMEBOUND&&(_||a(!0))},[_]),l.useEffect(()=>{!c||!d||async function(){let k=await Xt.getInstance().getChannelJsonAsync(c.verifiedBy);f(k)}()},[c,d]),l.useEffect(()=>{!c||!I||async function(){const k=c.channelStartBlock.toString(),te=await new Vt(se.coreRPC).getBlock(+k),j=Ht(te.timestamp*1e3);E(j.format(Wi))}()},[c]),l.useEffect(()=>{s&&(!h||!h.length?B(s):B(I?h[0].channel:h[0].alias_address))},[h,s]),l.useEffect(()=>{s&&(async()=>{try{const k=dt(s,r),te=await g.channel.delegate.get({channel:k});if(te){const j=te.map(N=>N);j.unshift(s),v(j)}}catch(k){console.error(k)}})()},[s,r]);const xe=async k=>{let te=g;if(!(!te.signer&&(te=await p({wallet:b}),!te)))return te.channel.delegate.remove(dt(k,r))},ye=()=>{T(bo.ChannelSettings)};return e.jsxs(Y,{children:[e.jsxs(Xi,{justifyContent:"flex-start",alignSelf:"stretch",children:[e.jsx(qi,{src:c.icon}),e.jsxs(qe,{alignItems:"flex-start",padding:"5px 0px",children:[e.jsxs(sa,{children:[c.name,d&&e.jsx(Qi,{src:"/verify.png"})]}),e.jsxs(qe,{alignItems:"flex-start",flex:"initial",padding:"5px 0px",children:[I&&u&&!m||!I&&!m?e.jsx(ia,{children:"Alias Network Setup Pending"}):e.jsxs(Yi,{justifyContent:"flex-start",children:[e.jsxs(ta,{children:[e.jsx("img",{style:{width:"15px"},src:"/subcount.svg",alt:"subscount"}),e.jsx(aa,{children:c.subscriber_count})]}),e.jsxs(na,{active:H,children:[W&&e.jsx(pt,{width:"12px",src:No,margin:"0 5px 2px 0px",height:"30px"}),H?"Active":W?"Deactivated":"Blocked"]}),c.channelType==ct.TIMEBOUND&&!t&&e.jsxs(G,{background:"#C5EFD1",flex:"0",borderRadius:"25px",margin:"0 0 10px 10px",height:"30px",children:[e.jsx(pt,{width:"16px",src:"svg/ExpiresTimer.svg",alt:"expiryTimer",padding:"0 6px 0 9px"}),e.jsxs(ve,{color:"#30CC8B",fontWeight:"600",padding:"0 9px 0 0",children:["Expires on ",oe]})]}),c.channelType==ct.TIMEBOUND&&t&&e.jsxs(G,{background:"#FFD8D8",flex:"0",borderRadius:"25px",margin:"0 0 10px 10px",height:"30px",children:[e.jsx(pt,{width:"16px",src:"svg/ExpiredTimer.svg",alt:"expiryTimer",padding:"0 6px 0 9px"}),e.jsxs(ve,{color:"#E93636",fontWeight:"600",padding:"0 9px 0 0",children:["Expired on ",oe]})]})]}),M&&e.jsxs(oa,{children:["Created ",M]})]})]})]}),$&&e.jsxs(G,{zIndex:"1",padding:"0 0 15px 0",alignSelf:"center",display:"flex",gap:"8px",children:[!t&&I&&e.jsx(ae,{onClick:n,size:"small",variant:"outline",children:"Edit Channel"}),!t&&e.jsx(kt,{}),t&&I&&e.jsx(ae,{onClick:i,size:"small",variant:"danger",children:"Delete Channel"})]}),t&&e.jsx(Y,{alignItems:"flex-start",children:e.jsxs(It,{margin:"25px 0 0 0",children:[e.jsx(ve,{color:"#D53A94",children:"Note:"})," Channel will auto delete on"," ",e.jsx(ve,{fontWeight:"600",children:le})]})}),e.jsx(Y,{alignItems:"flex-start",children:e.jsx(It,{children:c.info})}),d&&e.jsx(qe,{alignItems:"flex-start",padding:"5px 0px",children:e.jsx(la,{children:e.jsxs(ra,{children:[e.jsx("span",{children:"verified by:"}),e.jsx(Zi,{src:R.icon}),e.jsx(ea,{children:R.name})]})})}),z===0&&e.jsxs(Y,{children:[e.jsx(Ve,{children:e.jsxs(Dt,{flex:"5",minWidth:"280px",self:"stretch",align:"stretch",margin:"10px 0px 30px 0px",radius:"20px",border:"1px solid #D4DCEA",children:[e.jsx(Zt,{title:"Notification Settings",description:"Customize notification preferences for users",Button:e.jsx(_o,{onClick:ye})}),e.jsx(en,{account:s,isAddress:!1,items:x[s],isLoading:!1,onClickEmptyListButton:ye,emptyListButtonTitle:"Add Setting"})]})}),e.jsx(Ve,{children:e.jsxs(Dt,{flex:"5",minWidth:"280px",self:"stretch",align:"stretch",margin:"10px 0px 30px 0px",radius:"20px",border:"1px solid #D4DCEA",children:[e.jsx(Zt,{title:"Channel Delegates",description:"Delegates can send notifications on behalf of the channel",Button:e.jsx(Fo,{onClick:K})}),e.jsx(en,{account:s,isAddress:!0,items:C,isLoading:!1,addressDropdownOptions:[{text:"Remove",onClick:xe,icon:e.jsx(fo,{})}]})]})})]}),e.jsx(pe,{InnerComponent:ii,onConfirm:he,toastObject:re,modalPosition:De.ON_ROOT})]})}const qe=o(Y)`
  @media (max-width: 767px) {
    align-items: center;
  }
`,Yi=o(G)`
...
`,Oa=10;let Nt=null;const Ua=()=>{Z();const{account:t,chainId:a,wallet:n}=me(),{channelDetails:i,delegatees:s,aliasDetails:{aliasAddr:r,aliasEthAddr:b,isAliasVerified:h,aliasAddrFromContract:c}}=O(C=>C.admin),{processingState:d}=O(C=>C.channelCreation),{epnsWriteProvider:m}=O(C=>C.contracts);O(C=>C.user),l.useContext(Yt);const u=i&&i!=="unfetched",x=de(),g=Ee(),[p,S]=l.useState(!1);l.useState(!0);const[L,z]=l.useState(!1),R=se.coreContractChain===a,f=Re(600);l.useEffect(()=>{if(!R||!i||c||i==="unfetched")return;const C=So(i);if(C){const{address:v,chainId:F}=C;g(Mo(v)),g(Eo(F))}else g(ke(0))},[i,c]);const M=async C=>{let{aliasAddress:v=null,isAliasVerified:F=null}=await Xt.getInstance().getChannelDetailsFromAddress(C);return v=="NULL"&&(v=null),{aliasAddress:v,aliasVerified:F}};l.useEffect(()=>{!R||!c||d===0||(Nt=setInterval(async()=>{const{aliasAddress:C,aliasVerified:v}=await M(t);C?(g(ko(C)),v?(g(ht(!0)),g(ke(0))):(g(ke(2)),g(ht(!1)))):d!=0&&d!=1&&g(ke(1))},Oa*1e3))},[c]),r!==null&&clearInterval(Nt);const E=async()=>{try{x.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const C=await m.destroyTimeBoundChannel(t,{gasLimit:1e6});console.debug(C),console.debug("Check: "+t),await C.wait(),x.showMessageToast({toastTitle:"Success",toastMessage:"Successfully deleted the channel",toastType:"SUCCESS",getToastIcon:v=>e.jsx(J,{size:v,color:"green"})}),g(lt(null))}catch(C){console.error(C),C.code=="ACTION_REJECTED"?x.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:v=>e.jsx(J,{size:v,color:"red"})}):x.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in deleting the channel",toastType:"ERROR",getToastIcon:v=>e.jsx(J,{size:v,color:"red"})})}},P=()=>{z(!0)},H=()=>{z(!1)},{isModalOpen:W,showModal:I,ModalComponent:$}=Ie();return e.jsxs(G,{children:[(i==="unfetched"||d===null)&&e.jsx(jt,{}),i!=="unfetched"&&e.jsxs(Y,{justifyContent:d===0&&"flex-start",height:"fit-content",children:[!i&&d===0&&e.jsx(Wo,{}),u&&d!==null&&e.jsx(_a,{children:L?e.jsx(Aa,{closeEditChannel:H,UploadLogoComponent:$,displayUplaodLogoModal:I,isUploadLogoModalOpen:W}):e.jsxs(e.Fragment,{children:[i&&!f&&e.jsxs(G,{zIndex:"1",gap:"8px",children:[!p&&R&&e.jsx(ae,{onClick:P,size:"small",variant:"outline",children:"Edit Channel"}),!p&&e.jsx(kt,{}),p&&R&&e.jsx(ae,{onClick:E,size:"small",variant:"danger",children:"Delete Channel"})]}),i?e.jsx(Ji,{isChannelExpired:p,setIsChannelExpired:S,showEditChannel:P,destroyChannel:E}):""]})}),d!==0&&d!==null&&u&&!L&&e.jsx(e.Fragment,{children:e.jsx(Jn,{aliasEthAccount:b,setAliasVerified:ht})})]})]})},_a=o(Y)`
  align-items: center;
  align-self: center;
