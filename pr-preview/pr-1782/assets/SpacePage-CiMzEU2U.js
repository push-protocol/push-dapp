import{a$ as a,d8 as oe,d9 as n,da as ne,db as Z,dc as T,cq as re,b6 as r,bJ as m,dd as de,aY as K,de as ce,df as q,b9 as le,dg as pe,aZ as Ee,b1 as s,bM as F,bZ as he,dh as xe,di as Se,bH as S,bI as I,dj as ue,b4 as fe,bi as ge,b5 as Te,b7 as me,__tla as Ie}from"./index-Cr8KHY-Q.js";import{L as Ce,__tla as ke}from"./LoaderSpinner-DqejyJbx.js";let X,Me=Promise.all([(()=>{try{return Ie}catch{}})(),(()=>{try{return ke}catch{}})()]).then(async()=>{let w,k,M,b,D,N,O,_,v,L,j,V,$,U,R,y,H;w=({account:t,env:l,chainId:u,socketType:E})=>{const[e,f]=a.useState(null),[d,p]=a.useState(e==null?void 0:e.connected),[c,h]=a.useState(""),[g,A]=a.useState(""),{videoCallData:C,incomingCall:Q,connectWrapper:ee,requestWrapper:te,acceptRequestWrapper:se,isVideoCallInitiator:P}=a.useContext(oe),ae=()=>{e==null||e.on(n.EVENTS.CONNECT,()=>{p(!0)}),e==null||e.on(n.EVENTS.DISCONNECT,()=>{p(!1)}),e==null||e.on(n.EVENTS.USER_FEEDS,x=>{var B,G,J,W,z,Y;try{const{payload:o}=x||{};if(Object.keys(o).length>0)if(((G=(B=o==null?void 0:o.data)==null?void 0:B.additionalMeta)==null?void 0:G.type)===`${Z.ADDITIONAL_META_TYPE.PUSH_VIDEO}+1`){const i=JSON.parse(o.data.additionalMeta.data);console.debug("RECIEVED VIDEO DATA",i),i.status===T.VideoCallStatus.INITIALIZED?Q(i):i.status===T.VideoCallStatus.RECEIVED||i.status===T.VideoCallStatus.RETRY_RECEIVED?ee(i):i.status===T.VideoCallStatus.DISCONNECTED?window.location.reload():i.status===T.VideoCallStatus.RETRY_INITIALIZED&&P()?te({senderAddress:i.recipientAddress,recipientAddress:i.senderAddress,chatId:i.chatId,retry:!0}):i.status===T.VideoCallStatus.RETRY_INITIALIZED&&!P()&&se({signalData:i.signalData,senderAddress:i.recipientAddress,recipientAddress:i.senderAddress,chatId:i.chatId,retry:!0})}else((W=(J=o==null?void 0:o.data)==null?void 0:J.additionalMeta)==null?void 0:W.data)==="PUSH SPACE META MESSAGE"||((Y=(z=o==null?void 0:o.data)==null?void 0:z.additionalMeta)==null?void 0:Y.type)===`${Z.ADDITIONAL_META_TYPE.PUSH_SPACE}+1`||re(o)}catch(o){console.error("DAPP Error while diplaying received Notification: ",o)}}),e==null||e.on(n.EVENTS.CHAT_RECEIVED_MESSAGE,x=>{h(x)}),e==null||e.on(n.EVENTS.CHAT_GROUPS,x=>{console.info(x),A(x)})},ie=()=>{e==null||e.off(n.EVENTS.CONNECT),e==null||e.off(n.EVENTS.DISCONNECT),e==null||e.off(n.EVENTS.USER_FEEDS),e==null||e.off(n.EVENTS.CHAT_GROUPS),e==null||e.off(n.EVENTS.CHAT_RECEIVED_MESSAGE)};return a.useEffect(()=>(e&&ae(),()=>{e&&ie()}),[e]),a.useEffect(()=>{if(t&&u&&l){e&&(e==null||e.disconnect());const x=n.createSocketConnection({user:E=="chat"?t:ne(t,u),socketType:E,env:l});f(x)}},[t,u,l]),{epnsSDKSocket:e,isSDKSocketConnected:d,messagesSinceLastConnection:c,groupInformationSinceLastConnection:g}},k="data:image/svg+xml,%3csvg%20width='25'%20height='26'%20viewBox='0%200%2025%2026'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M2.58697%2010.5215V15.478'%20stroke='black'%20stroke-width='3.13045'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M9.1957%203.91268V22.0868'%20stroke='black'%20stroke-width='3.13045'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M15.8047%207.21688L15.8047%2018.7822'%20stroke='black'%20stroke-width='3.13045'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M22.4132%2010.5215L22.4132%2015.478'%20stroke='black'%20stroke-width='3.13045'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e",M="data:image/svg+xml,%3csvg%20width='25'%20height='26'%20viewBox='0%200%2025%2026'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M2.58594%2010.5215V15.4781'%20stroke='%23787E99'%20stroke-width='3.13045'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M9.19531%203.91309V22.0872'%20stroke='%23787E99'%20stroke-width='3.13045'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M15.8047%207.2168L15.8047%2018.7822'%20stroke='%23787E99'%20stroke-width='3.13045'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M22.4141%2010.5215L22.4141%2015.4781'%20stroke='%23787E99'%20stroke-width='3.13045'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e",b=t=>a.createElement("svg",{width:48,height:48,viewBox:"0 0 48 48",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},a.createElement("path",{d:"M0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24Z",fill:"#D53A94"}),a.createElement("path",{d:"M15.75 23.999H32.2496",stroke:"white",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"}),a.createElement("path",{d:"M24.0039 15.75V32.2496",stroke:"white",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})),D=({spaceid:t})=>{const{SpaceFeedComponent:l,SpaceInvitesComponent:u,CreateSpaceComponent:E}=a.useContext(de),{account:e}=K(),{setSpaceId:f,spaceInvites:d}=a.useContext(ce),{connectedUser:p}=a.useContext(q),c=le(),h=pe(m.mobileL);a.useEffect(()=>{t&&f(t)},[t]);let g=Ee();const A=C=>{f(C),g(`/spaces/${C}`)};return s.jsxs(N,{children:[s.jsxs(O,{children:[s.jsx(F,{width:"48px",maxWidth:"48px",borderRadius:"100%",overflow:"hidden",margin:"0 5px 0 0",children:s.jsx(he,{alt:"Profile",src:p==null?void 0:p.profilePicture})}),s.jsx(_,{children:xe(e,6)}),s.jsx(v,{children:h?s.jsx(E,{children:s.jsx(b,{})}):s.jsx(E,{})}),s.jsx(u,{children:s.jsxs(j,{children:[s.jsx(Se,{src:(c==null?void 0:c.scheme)=="light"?k:M,srcSet:(c==null?void 0:c.scheme)=="light"?k:M,width:"30px"}),d>0&&s.jsx(L,{children:d})]})})]}),s.jsx(V,{children:s.jsx(l,{showTabs:!0,orientation:"vertical",width:h?360:"100%",height:"100%",onBannerClickHandler:C=>{A(C)}})})]})},N=r.div`
