...
`,Xt=c($)`
  ...
  font-size: 0.625rem;
  text-align:left;
`,me="data:image/svg+xml,%3csvg%20width='17'%20height='17'%20viewBox='0%200%2017%2017'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20clip-path='url(%23clip0_15284_45077)'%3e%3cpath%20d='M8.5%2014.5C11.8137%2014.5%2014.5%2011.8137%2014.5%208.5C14.5%205.18629%2011.8137%202.5%208.5%202.5C5.18629%202.5%202.5%205.18629%202.5%208.5C2.5%2011.8137%205.18629%2014.5%208.5%2014.5Z'%20stroke='%23797D8F'%20stroke-width='1.2'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M8%208C8.13261%208%208.25979%208.05268%208.35355%208.14645C8.44732%208.24021%208.5%208.36739%208.5%208.5V11C8.5%2011.1326%208.55268%2011.2598%208.64645%2011.3536C8.74021%2011.4473%208.86739%2011.5%209%2011.5'%20stroke='%23797D8F'%20stroke-width='1.2'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M8.25%206.5C8.66421%206.5%209%206.16421%209%205.75C9%205.33579%208.66421%205%208.25%205C7.83579%205%207.5%205.33579%207.5%205.75C7.5%206.16421%207.83579%206.5%208.25%206.5Z'%20fill='%23797D8F'/%3e%3c/g%3e%3cdefs%3e%3cclipPath%20id='clip0_15284_45077'%3e%3crect%20width='16'%20height='16'%20fill='white'%20transform='translate(0.5%200.5)'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e",Y=n=>n.div(y.from(10).pow(18)).toString(),X=n=>{var t;return(t=n==null?void 0:n.toString())==null?void 0:t.replace(/\B(?=(\d{3})+(?!\d))/g,",")},Zt=function(n,t=null){return y.from(n)},Qt=function(n){return n.div(Zt(10).pow(18))},wt=({poolName:n,userData:t,PoolStats:a,poolAddress:o,getUserData:s,tokenAddress:i,setActiveTab:r})=>{const{account:l,provider:p,wallet:h,isWalletConnected:g,connect:x}=Pe(),[M,F]=u.useState(!1),[L,_]=u.useState(!1),[J,O]=u.useState(!1),[ee,U]=u.useState(null),[ie,G]=u.useState(null),[W,b]=u.useState(null),[D,I]=u.useState(0),w=Ve(),R=qe(),K=async()=>{if(!g){x();return}if(!L){if((t==null?void 0:t.totalAvailableReward)==0){b("No Rewards to Claim"),_(!1);return}_(!0);var f=p.getSigner(l);new k(o,A.yieldFarming,f).massHarvest().then(async T=>{w.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{await p.waitForTransaction(T.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:P=>e.jsx(he,{size:P,color:"green"})}),s(),_(!1)}catch(P){w.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${P.name}+ ")`,toastType:"ERROR",getToastIcon:C=>e.jsx(H,{size:C,color:"red"})}),_(!1)}}).catch(T=>{w.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Cancelled!",toastType:"ERROR",getToastIcon:P=>e.jsx(H,{size:P,color:"red"})}),_(!1)})}},we=async()=>{if(!g){x();return}if(M)return;F(!0);const f=Y(t.epochStakeNext);if(f==0){G("Nothing to unstake, Stake Now in new reward program."),F(!1);return}var T=p.getSigner(l);let P=new k(d.staking,A.staking,T);await P.balanceOf(l,i),P.withdraw(i,y.from(f).mul(y.from(10).pow(18))).then(async C=>{w.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{await p.waitForTransaction(C.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!",toastType:"SUCCESS",getToastIcon:E=>e.jsx(he,{size:E,color:"green"})}),F(!1),s()}catch(E){console.error("Error",E),w.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Failed! (" +${E.name}+ ")`,toastType:"ERROR",getToastIcon:V=>e.jsx(H,{size:V,color:"red"})}),F(!1)}}).catch(C=>{w.showMessageToast({toastTitle:"Error",toastMessage:`Transaction Cancelled! ${C.message}`,toastType:"ERROR",getToastIcon:E=>e.jsx(H,{size:E,color:"red"})}),F(!1)})},z=async()=>{if(!g){x();return}if(J)return;let f=3;const T=Y(t.epochStakeNext);if(T==0){w.showMessageToast({toastTitle:"Error",toastMessage:"Nothing to Withdraw!",toastType:"ERROR",getToastIcon:te=>e.jsx(H,{size:te,color:"red"})}),O(!1),U(null);return}var P=p.getSigner(l);let C=new k(d.staking,A.staking,P);const E=i===d.pushToken?d.pushCoreV2:d.stakingV2;var V=new k(i,A.pushToken,P);let B=await V.allowance(l,E),se=Y(B);parseInt(se)>=parseInt(T)?(f=2,I(50)):(f=3,I(33)),O(!0),U(`Withdrawing 1/${f}`);let oe;oe=C.withdraw(i,y.from(T).mul(y.from(10).pow(18))),oe.then(async te=>{if(w.showLoaderToast({loaderMessage:"Withdrawing! Please Wait..."}),await p.waitForTransaction(te.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Successfully withdrawn!",toastType:"SUCCESS",getToastIcon:ye=>e.jsx(he,{size:ye,color:"green"})}),i===d.pushToken){var Z=new k(i,A.pushToken,P);let ye=await Z.allowance(l,d.pushCoreV2),pe=Y(ye);parseInt(pe)>=parseInt(T)?fe(te,T,f):(te=Z.approve(d.pushCoreV2,y.from(T).mul(y.from(10).pow(18))),U(`Approving 2/${f}`),I(66),te.then(async de=>{w.showLoaderToast({loaderMessage:"Approving! Please Wait..."}),await p.waitForTransaction(de.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Successfully Approved!",toastType:"SUCCESS",getToastIcon:Se=>e.jsx(he,{size:Se,color:"green"})}),fe(de,T,f)}).catch(de=>{console.error("Error in approving 2",de),w.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Failed! Could Not Approve",toastType:"ERROR",getToastIcon:Se=>e.jsx(H,{size:Se,color:"red"})}),O(!1),U(null),s(),I(0)}))}else{var Z=new k(i,A.pushToken,P);let pe=await Z.allowance(l,d.stakingV2),de=Y(pe);parseInt(de)>=parseInt(T)?ne(te,T,f):(te=Z.approve(d.stakingV2,y.from(T).mul(y.from(10).pow(18))),U(`Approving 2/${f}`),I(66),te.then(async Se=>{w.showLoaderToast({loaderMessage:"Approving! Please Wait..."}),await p.waitForTransaction(Se.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Successfully Approved!",toastType:"SUCCESS",getToastIcon:xt=>e.jsx(he,{size:xt,color:"green"})}),ne(Se,T,f)}).catch(Se=>{console.error("Error in approving",Se),w.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Failed! Could Not Approve",toastType:"ERROR",getToastIcon:xt=>e.jsx(H,{size:xt,color:"red"})}),O(!1),U(null),s(),I(0)}))}}).catch(te=>{console.error("Error in withdrawing: ",te),w.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Failed! Could Not Withdraw!",toastType:"ERROR",getToastIcon:Z=>e.jsx(H,{size:Z,color:"red"})}),O(!1),U(null),I(0)})},ne=async(f,T,P)=>{if(!g){x();return}var C=p.getSigner(l),E=new k(d.stakingV2,A.stakingV2,C);U(`Staking ${P}/${P}`),I(100),f=E.deposit(i,y.from(T).mul(y.from(10).pow(18))),f.then(async V=>{w.showLoaderToast({loaderMessage:"Depositing to V2 ! Please Wait..."}),await p.waitForTransaction(V.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed!Successfully Deposited the UNI-V2 Token to V2 ",toastType:"SUCCESS",getToastIcon:B=>e.jsx(he,{size:B,color:"green"})}),O(!1),s(),U(null),r(0)}).catch(V=>{console.error("Error in depositing: ",V),w.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Failed! Could Not Deposit the Amount",toastType:"ERROR",getToastIcon:B=>e.jsx(H,{size:B,color:"red"})}),O(!1),s(),U(null),I(0)})},fe=async(f,T,P)=>{if(!g){x();return}var C=p.getSigner(l);let E=new k(d.pushCoreV2,A.pushCoreV2,C);U(`Staking ${P}/${P}`),I(100),f=E.stake(y.from(T).mul(y.from(10).pow(18))),f.then(async V=>{w.showLoaderToast({loaderMessage:"Depositing to V2 ! Please Wait..."}),await p.waitForTransaction(V.hash),w.showMessageToast({toastTitle:"Success",toastMessage:"Transaction Completed! Successfully Deposited the Push Token to V2 ",toastType:"SUCCESS",getToastIcon:B=>e.jsx(he,{size:B,color:"green"})}),O(!1),s(),U(null),r(0)}).catch(V=>{console.error("Error in depositing: ",V),w.showMessageToast({toastTitle:"Error",toastMessage:"Transaction Failed! Could Not Deposit Push Token",toastType:"ERROR",getToastIcon:B=>e.jsx(H,{size:B,color:"red"})}),O(!1),s(),U(null),I(0)})};u.useEffect(()=>{b(null),G(null)},[l]);const j=Re(600);return e.jsxs(en,{margin:n==="UNI-V2"?" 10px 0 10px 10px ":"  10px 10px 10px 0",children:[e.jsx(v,{margin:"0px 0px 20px 0",children:a?e.jsxs(e.Fragment,{children:[e.jsxs(tn,{children:[n==="UNI-V2"?"Uniswap V2 Staking Pool":"PUSH Staking Pool ",e.jsx(nn,{children:"Deprecated"})]}),e.jsxs(at,{children:["Current APR"," ",e.jsx(Te,{color:"#D53A94",fontWeight:"600",children:"0%"})]})]}):e.jsxs(Ie,{padding:"15px 15px 0 15px",children:[e.jsx(m,{height:"15px",width:"234px",margin:"0 0 10px 0"}),e.jsx(m,{height:"15px",width:"112px"})]})}),e.jsxs(v,{children:[e.jsxs(on,{border:`1px solid ${R.stakingBorder}`,borderRadius:"16px",children:[e.jsx(v,{margin:j?"0px 6px 0 0 ":"0px 18px 0px 0px",padding:j?" 7px":"10px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(at,{children:"Current Reward"}),e.jsx($,{fontSize:j?"18px":"24px",fontWeight:"600",color:"#D53A94",letterSpacing:"normal",children:"0 PUSH"})]}):e.jsxs(Ie,{padding:j?"0px":"5px 15px 0 15px",children:[e.jsx(m,{height:"12px",width:j?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(m,{height:"12px",width:j?"65px":"100px}"})]})}),e.jsx(an,{width:"10px",height:"100%"}),e.jsx(v,{margin:j?"0px 6px 0 0 ":"0px 18px 0px 0px",padding:j?" 7px":"10px",children:a?e.jsxs(e.Fragment,{children:[e.jsx(at,{children:"Total Staked"}),e.jsxs(sn,{fontSize:j?"18px":"24px",fontWeight:"600",letterSpacing:"normal",children:[X(Y(a==null?void 0:a.poolBalance))," ",n=="UNI-V2"?"UNI-V2":"PUSH"]})]}):e.jsxs(Ie,{padding:j?"0px":"5px 15px 0 15px",children:[e.jsx(m,{height:"12px",width:j?"100px":"135px",margin:"0 0 8px 0"}),e.jsx(m,{height:"12px",width:j?"65px":"100px}"})]})})]}),e.jsx(S,{alignSelf:"end",margin:"12px 13px 24px 0px",color:"#575D73",letterSpacing:"normal",children:a?e.jsxs(e.Fragment,{children:[e.jsx(ft,{padding:"0px 5px 0px 0px",children:"Current Epoch"}),e.jsx(ft,{margin:"0 0 0 5px",children:"100 / 100"})]}):e.jsx(Ie,{padding:"6px 0px 0 15px",children:e.jsx(m,{height:"17px",width:"124px"})})}),e.jsx(rn,{children:t?e.jsxs(v,{children:[e.jsxs(S,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Be,{children:["User Deposit",e.jsx(_e,{children:e.jsx(q,{ToolTipTitle:"User Deposited",ToolTipBody:`Amount of ${n} Token User Staked`,children:e.jsx(re,{src:me,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Oe,{children:[" ",Y(t==null?void 0:t.epochStakeNext)," ",n=="UNI-V2"?"UNI-V2":"PUSH"]})]}),e.jsxs(S,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Be,{children:["Rewards Claimed",e.jsx(_e,{children:e.jsx(q,{ToolTipTitle:"Rewards Claimed",ToolTipBody:"Amount of Push Claimed by User",children:e.jsx(re,{src:me,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Oe,{children:[" ",X(((t==null?void 0:t.totalAccumulatedReward)-(t==null?void 0:t.totalAvailableReward)).toFixed(2))," ","PUSH"]})]}),e.jsxs(S,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Be,{children:["Current Epoch Reward",e.jsx(_e,{children:e.jsx(q,{ToolTipTitle:"Current Epoch Reward",ToolTipBody:"Displays the approximate latest reward amount for current epoch",children:e.jsx(re,{src:me,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsx(Oe,{children:"0 PUSH"})]}),e.jsxs(S,{justifyContent:"space-between",margin:j?"0px 0px 12px 0px":"0px 13px 12px 13px",children:[e.jsxs(Be,{children:["Available for Claiming",e.jsx(_e,{children:e.jsx(q,{ToolTipTitle:"Available for Claiming",ToolTipBody:"Amount of Push Token Available to claim",children:e.jsx(re,{src:me,alt:"Info-Logo",width:"16px",style:{cursor:"pointer"}})})})]}),e.jsxs(Oe,{children:[X(t==null?void 0:t.totalAvailableReward)," PUSH"]})]})]}):e.jsxs(ke,{padding:"16px 15px 16px 15px",width:"100%",maxWidth:" -webkit-fill-available",borderRadius:"5px",children:[e.jsxs(S,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(m,{height:"12px",width:"164px"}),e.jsx(m,{height:"12px",width:"72px"})]}),e.jsxs(S,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(m,{height:"12px",width:"164px"}),e.jsx(m,{height:"12px",width:"72px"})]}),e.jsxs(S,{justifyContent:"space-between",margin:"0 0 23px 0",children:[e.jsx(m,{height:"12px",width:"164px"}),e.jsx(m,{height:"12px",width:"72px"})]}),e.jsxs(S,{justifyContent:"space-between",children:[e.jsx(m,{height:"12px",width:"164px"}),e.jsx(m,{height:"12px",width:"72px"})]})]})})]}),e.jsx(ln,{padding:j?"0px ":"0px 14px",margin:"24px 0px 0px 0px",children:t?e.jsxs(e.Fragment,{children:[e.jsx(St,{children:Y(t==null?void 0:t.epochStakeNext)==="0"?e.jsx(q,{error:!0,ToolTipTitle:"Nothing to Withdraw, so you cannot Migrate.",ToolTipWidth:"16rem",bottom:"-50px",margin:"0 0 15px 0",children:e.jsx(Ue,{border:"none",cursor:"default",background:R.disableButtonBg,color:R.disabledButtonText,children:e.jsx(bt,{children:!J&&ee==null&&e.jsxs(Xe,{color:R.disabledButtonText,weight:"400",cursor:"default",children:["Migrate to ",n==="UNI-V2"?"UNI-V2 ":"PUSH Fee"," Pool"]})})})}):e.jsxs(pn,{onClick:z,children:[e.jsx(dn,{style:{width:`${D}%`}}),e.jsxs(bt,{children:[!J&&ee==null&&e.jsxs(Xe,{color:"#FFF",weight:"400",cursor:"pointer",children:["Migrate to ",n==="UNI-V2"?"UNI-V2 ":"PUSH Fee"," Pool"]}),J&&ee!=null&&e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:ee,titleColor:"#FFF"})]})]})}),e.jsxs(St,{children:[Y(t==null?void 0:t.epochStakeNext)==="0"?e.jsx(q,{error:!0,ToolTipTitle:ie||"Nothing to unstake, Stake First",ToolTipWidth:"16rem",margin:"0 10px 0 0",bottom:"-30px",children:e.jsx(Ue,{border:"none",cursor:"default",background:R.disableButtonBg,color:R.disabledButtonText,children:M?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:R.activeButtonText,title:"Claiming",titleColor:R.activeButtonText}):` Unstake ${n}`})}):e.jsx(Ue,{border:`1px solid ${R.activeButtonText}`,background:"transparent",color:R.activeButtonText,cursor:"pointer",margin:"0 10px 0 0",onClick:we,children:M?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:R.activeButtonText,title:"Unstaking",titleColor:R.activeButtonText}):` Unstake ${n}`}),(t==null?void 0:t.totalAvailableReward)==="0.00"?e.jsx(q,{bottom:"-30px",ToolTipTitle:"No Rewards to Claim",error:!0,ToolTipWidth:"10rem",children:e.jsx(Ue,{border:"none",cursor:"default",background:R.disableButtonBg,color:R.disabledButtonText,children:L?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:R.activeButtonText,title:"Claiming",titleColor:R.activeButtonText}):" Claim Rewards"})}):e.jsx(Ue,{border:`1px solid ${R.activeButtonText}`,background:"transparent",color:R.activeButtonText,cursor:"pointer",onClick:K,children:L?e.jsx(ce,{type:ue.SEAMLESS,spinnerSize:26,spinnerColor:R.activeButtonText,title:"Claiming",titleColor:R.activeButtonText}):"Claim Rewards"})]})]}):e.jsxs(Ie,{width:"100%",children:[e.jsx(m,{height:"49px",width:"100%",margin:"0 0 11px 0"}),e.jsx(m,{height:"49px",width:"100%"})]})})]})},en=c(De)`
...
`,ze=c(ke)`
  ...
  border-radius: 5px;
  gap: 5px;
`,Kn=({setActiveTab:n})=>{const{provider:t,account:a,chainId:o}=Pe(),[s,i]=u.useState(),[r,l]=u.useState(),[p,h]=u.useState(),[g,x]=u.useState(),[M,F]=u.useState(),[L,_]=u.useState(null),[J,O]=u.useState(null),[ee,U]=u.useState(null),[ie,G]=u.useState(null),[W,b]=u.useState(null),D=t==null?void 0:t.getSigner(a),I=u.useCallback(async()=>{const z=await Ce.getInstance().getPoolStats(t);_({...z})},[r,s,g,p,M,t]),w=u.useCallback(async()=>{const z=await Ce.getInstance().getPoolStats(t),ne=await Ce.getInstance().getLPPoolStats(z);O({...ne})},[r,s,g,p,M,t]),R=u.useCallback(async()=>{},[]),K=u.useCallback(async()=>{const z=await Ce.getInstance().getUserDataLP();U({...z})},[r,s,g,p,M]),we=u.useCallback(async()=>{const[z,ne]=await Ce.getInstance().getUserDataPUSH(t);b({...z}),G({...ne})},[r,s,g,p,M,t]);return u.useEffect(()=>{if(o!==Q.coreContractChain&&o!==Q.mainnetCoreContractChain)return;O(null),U(null),b(null),G(null);let z=new k(d.stakingV2,A.stakingV2,D),ne=new k(d.pushToken,A.pushToken,D),fe=new k(d.pushCoreV2,A.pushCoreV2,D),j=new k(d.yieldFarmLP,A.yieldFarming,D),f=new k(d.uniswapV2Router02,A.uniswapV2Router02,D);if(l(z),i(ne),x(fe),h(j),F(f),D&&a){var T=t==null?void 0:t.getSigner(a);let P=new k(d.stakingV2,A.stakingV2,T),C=new k(d.pushToken,A.pushToken,T),E=new k(d.pushCoreV2,A.pushCoreV2,T),V=new k(d.yieldFarmLP,A.yieldFarming,T),B=new k(d.uniswapV2Router02,A.uniswapV2Router02,T);l(P),i(C),x(E),h(V),F(B)}Ce.getInstance().init(a,z,ne,fe,j,f),I(),K(),w(),we()},[a,o]),e.jsxs(e.Fragment,{children:[e.jsx(jt,{logo:"announcement",title:"New V2 Pools are now Live! Stake or migrate now.",body:"Users who were part of the previous Push staking program, need to migrate to new pools to continue earning rewards. Click",setActiveTab:n}),e.jsx(yn,{getLpPoolStats:w,poolStats:L,setPoolStats:_}),e.jsx(xn,{poolStats:L}),e.jsxs(qn,{children:[e.jsx(Dn,{userDataPush:ie,getUserDataPush:we,PUSHPoolstats:W,getPUSHPoolStats:R}),e.jsx(An,{lpPoolStats:J,userDataLP:ee,getLpPoolStats:w,getUserDataLP:K})]})]})},qn=c(S)`
  @media (max-width: 1300px) {
    flex-direction: column;
  }
