...
`,Xt=({poolStats:t})=>{function s(l){return l==null?void 0:l.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",")}const o=Pe(600);return e.jsx(es,{justifyContent:"stretch",children:t?e.jsxs(e.Fragment,{children:[e.jsx(Tt,{fontSize:o?"16px":"18px",textAlign:"left",fontWeight:600,children:"Push Price"}),e.jsxs(T,{gap:"5px",justifyContent:"flex-end",children:[e.jsxs(Tt,{fontSize:o?"18px ":"24px",textAlign:"left",fontWeight:600,children:["$",s(t==null?void 0:t.pushPrice.toFixed(2))]}),e.jsx(oe,{width:"25px",height:o?"20px":"27px",src:Ft("svg/uniswapLogo.svg"),alt:"Uniswap Logo"})]})]}):e.jsxs(ts,{children:[e.jsx(c,{height:"12px",width:"135px",margin:"10px 0 10px 0"}),e.jsx(c,{height:"12px",width:"135px",margin:"10px 0 10px 0"})]})})},es=i(T)`
  flex-direction: row;
