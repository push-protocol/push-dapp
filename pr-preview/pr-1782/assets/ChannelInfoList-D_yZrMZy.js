import{b6 as i,b9 as Y,b1 as t,ba as le,b3 as G,b4 as X,bX as q,bN as p,bS as J,aY as pe,bi as xe,a$ as l,cl as ce,c1 as he,du as ge,cm as me,cv as fe,dv as w,bd as h,be as K,dk as Q,dw as ue,cj as we,__tla as je}from"./index-DM7ZIfOI.js";import{b as Ce,__tla as be}from"./PushTokenContractHelper-BCFi3VC4.js";import{E as ye,__tla as ve}from"./EmptyNotificationSettings-BkcLLJ8R.js";import{T as j,__tla as ke}from"./Tag-yD0t-foj.js";let ee,te,ie,ne,oe,Le=Promise.all([(()=>{try{return je}catch{}})(),(()=>{try{return be}catch{}})(),(()=>{try{return ve}catch{}})(),(()=>{try{return ke}catch{}})()]).then(async()=>{let C,b,y,v,k,L,M,_,g,S,m,T,$,H;ie=({text:e,onClick:s,isLoading:n,topMargin:o,loaderTitle:r})=>{const a=Y();return t.jsx(le,{theme:a,children:t.jsx(C,{style:{marginTop:o||"55px"},children:n?t.jsx(b,{children:t.jsx(G,{type:X.SEAMLESS,spinnerSize:26,spinnerColor:"#FFF",title:r??"",titleColor:"#fff"})}):t.jsx(q,{onClick:s,variant:"primary",size:"large",children:e})})})},C=i.div`
  display: flex;
