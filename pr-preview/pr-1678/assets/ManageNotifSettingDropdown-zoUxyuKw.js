import{q as u,B as E,eb as xe,r as f,ec as fe,m as n,x as se,D as oe,E as re,z as P,F as we,H as ae,X as ie,J as j,K as Se,M as le,N as de,Q as A,U as me,V as ce,Y as I,dz as pe,O as be,T as ye,ed as je,__tla as ve}from"./index-CKK9e80c.js";import{I as Me,R as Ce,__tla as Te}from"./RangeSlider-DdoL0VQR.js";let _,ue,he,ge,$,De=Promise.all([(()=>{try{return ve}catch{}})(),(()=>{try{return Te}catch{}})()]).then(async()=>{let B,W,O,V,S,k,H,U,F,N,J,K,X,Y,q,Q,R,G,Z,ee,te,L,ne;_=({children:e,renderDropdownContainer:r,showDropdown:s,toggleDropdown:a,closeDropdown:o,containerPadding:h,centerOnMobile:i})=>{const p=f.useRef(null),c=f.useRef(null);return fe(p,c,o),n.jsxs(B,{ref:p,onClick:a,children:[e,s&&n.jsx(W,{containerPadding:h,centerOnMobile:i,children:n.jsx("div",{ref:c,onClick:t=>t.stopPropagation(),children:r})})]})},B=u.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
