...
`;c.button`
  ...
  ${e=>e.disabled&&X`
    ...
    `}
`;let Ne,Me,xe,ge,Le,ze,Rt,Nt;Ne=c(ca)`
  &.v1 {
    background-color: #adb5bd;
  }
  &.v2 {
...
`,Rt=()=>o.jsx(Nt,{children:o.jsx(oa,{})}),Nt=c(ga)`
  ...
  align-self: stretch;
  justify-content: flex-start;
`,Ht=Object.freeze(Object.defineProperty({__proto__:null,default:Rt},Symbol.toStringTag,{value:"Module"}))});export{Ht as N,Ta as __tla,Ve as p,ne as u};
