import{iJ as Pt,iK as Ya,d_ as l,iL as ne,e1 as e,iM as Oe,iN as Se,iO as Me,iP as Ue,g5 as _e,iQ as Ja,g4 as Q,iR as nt,iS as Ot,iT as Xa,iU as Fe,iV as at,iW as je,iX as Ut,iY as _t,e6 as o,e9 as Z,fB as G,e3 as qa,e4 as Qa,e$ as O,ed as ee,eP as ce,gA as ot,es as Ft,it as Za,fE as de,dY as me,e2 as eo,eY as ae,eq as to,e_ as Ee,ej as io,el as no,eT as ve,ei as se,eM as U,eW as ao,iZ as oo,i_ as ke,i$ as ro,ep as Ge,eb as Ve,ea as We,eg as V,fi as rt,eO as I,fm as ue,fK as fe,fL as Y,eR as J,fs as Gt,ft as st,j0 as lt,ha as so,j1 as lo,h2 as Re,gz as Vt,j2 as Wt,ek as He,gR as co,en as Ht,fo as Ie,ie as po,fp as De,j3 as Kt,j4 as ho,gS as Yt,fD as Jt,dZ as xo,j5 as go,j6 as mo,j7 as uo,j8 as ct,gF as Xt,fI as dt,f4 as pt,j9 as fo,e0 as Co,ff as wo,fj as yo,ja as bo,jb as jo,f_ as vo,jc as To,jd as Ao,eN as Ce,je as So,jf as Mo,jg as Eo,jh as ko,ji as ht,eQ as Ro,e7 as Io,__tla as Do}from"./index-DAXpAYdb.js";import{S as No,N as Lo,__tla as zo}from"./RedCircle-ivRjKsGg.js";import{M as qt,S as $o,F as Qt,C as Zt,a as ei,__tla as Bo}from"./ChannelInfoList-Dw5DrWCJ.js";import{a as Po,__tla as Oo}from"./Tag-D_ihi1sZ.js";import{a as ti,m as ii,b as ni,__tla as Uo}from"./PushTokenContractHelper-DSSJ_Ri0.js";import{M as _o,a as Fo,__tla as Go}from"./EmptyNotificationSettings-DI0XIp3H.js";import{a as ai,b as oi,__tla as Vo}from"./ValidationHelper-KPr55Rzv.js";import{I as Wo,__tla as Ho}from"./ImportPushTokenMessage-rc-JvURR.js";import{v as Ko,C as Yo,__tla as Jo}from"./CreateChannel-4DW9PEAn.js";import{__tla as Xo}from"./TransitionGroupContext-Bn3I_npI.js";import{__tla as qo}from"./index.esm-DY6598JU.js";import{__tla as Qo}from"./Stepper-DnuVI8Yc.js";import{__tla as Zo}from"./StakingVariant-CMQNaqCS.js";import{__tla as er}from"./useMutation-qS0-nboi.js";import{__tla as tr}from"./index.esm-BIIrG7X_.js";import"./Common.form-iMV6nXze.js";let ri,ir=Promise.all([(()=>{try{return Do}catch{}})(),(()=>{try{return zo}catch{}})(),(()=>{try{return Bo}catch{}})(),(()=>{try{return Oo}catch{}})(),(()=>{try{return Uo}catch{}})(),(()=>{try{return Go}catch{}})(),(()=>{try{return Vo}catch{}})(),(()=>{try{return Ho}catch{}})(),(()=>{try{return Jo}catch{}})(),(()=>{try{return Xo}catch{}})(),(()=>{try{return qo}catch{}})(),(()=>{try{return Qo}catch{}})(),(()=>{try{return Zo}catch{}})(),(()=>{try{return er}catch{}})(),(()=>{try{return tr}catch{}})()]).then(async()=>{function si(t,a=0,i=1){return Ya(t,a,i)}function li(t){t=t.slice(1);const a=new RegExp(`.{1,${t.length>=6?2:1}}`,"g");let i=t.match(a);return i&&i[0].length===1&&(i=i.map(n=>n+n)),i?`rgb${i.length===4?"a":""}(${i.map((n,s)=>s<3?parseInt(n,16):Math.round(parseInt(n,16)/255*1e3)/1e3).join(", ")})`:""}function xt(t){if(t.type)return t;if(t.charAt(0)==="#")return xt(li(t));const a=t.indexOf("("),i=t.substring(0,a);if(["rgb","rgba","hsl","hsla","color"].indexOf(i)===-1)throw new Error(Pt(9,t));let n=t.substring(a+1,t.length-1),s;if(i==="color"){if(n=n.split(" "),s=n.shift(),n.length===4&&n[3].charAt(0)==="/"&&(n[3]=n[3].slice(1)),["srgb","display-p3","a98-rgb","prophoto-rgb","rec-2020"].indexOf(s)===-1)throw new Error(Pt(10,s))}else n=n.split(",");return n=n.map(r=>parseFloat(r)),{type:i,values:n,colorSpace:s}}function ci(t){const{type:a,colorSpace:i}=t;let{values:n}=t;return a.indexOf("rgb")!==-1?n=n.map((s,r)=>r<3?parseInt(s,10):s):a.indexOf("hsl")!==-1&&(n[1]=`${n[1]}%`,n[2]=`${n[2]}%`),a.indexOf("color")!==-1?n=`${i} ${n.join(" ")}`:n=`${n.join(", ")}`,`${a}(${n})`}function di(t,a){return t=xt(t),a=si(a),(t.type==="rgb"||t.type==="hsl")&&(t.type+="a"),t.type==="color"?t.values[3]=`/${a}`:t.values[3]=a,ci(t)}function pi(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function hi(t){return parseFloat(t)}function xi(t){const{className:a,classes:i,pulsate:n=!1,rippleX:s,rippleY:r,rippleSize:f,in:h,onExited:c,timeout:d}=t,[m,u]=l.useState(!1),x=ne(a,i.ripple,i.rippleVisible,n&&i.ripplePulsate),g={width:f,height:f,top:-(f/2)+r,left:-(f/2)+s},p=ne(i.child,m&&i.childLeaving,n&&i.childPulsate);return!h&&!m&&u(!0),l.useEffect(()=>{if(!h&&c!=null){const E=setTimeout(c,d);return()=>{clearTimeout(E)}}},[c,h,d]),e.jsx("span",{className:x,style:g,children:e.jsx("span",{className:p})})}const ie=Oe("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),gi=["center","classes","className"];let Ne=t=>t,gt,mt,ut,ft;const Ke=550,mi=80,ui=Se(gt||(gt=Ne`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`)),wi=Me("span",{name:"MuiTouchRipple",slot:"Root"})({overflow:"hidden",pointerEvents:"none",position:"absolute",zIndex:0,top:0,right:0,bottom:0,left:0,borderRadius:"inherit"}),yi=Me(xi,{name:"MuiTouchRipple",slot:"Ripple"})(ft||(ft=Ne`
  opacity: 0;
  position: absolute;
...
`),ie.rippleVisible,ui,Ke,({theme:t})=>t.transitions.easing.easeInOut,ie.ripplePulsate,({theme:t})=>t.transitions.duration.shorter,ie.child,ie.childLeaving,fi,Ke,({theme:t})=>t.transitions.easing.easeInOut,ie.childPulsate,Ci,({theme:t})=>t.transitions.easing.easeInOut),bi=l.forwardRef(function(t,a){const i=Ue({props:t,name:"MuiTouchRipple"}),{center:n=!1,classes:s={},className:r}=i,f=_e(i,gi),[h,c]=l.useState([]),d=l.useRef(0),m=l.useRef(null);l.useEffect(()=>{m.current&&(m.current(),m.current=null)},[h]);const u=l.useRef(!1),x=Ja(),g=l.useRef(null),p=l.useRef(null),E=l.useCallback(C=>{const{pulsate:A,rippleX:b,rippleY:D,rippleSize:W,cb:K}=C;c(R=>[...R,e.jsx(yi,{classes:{ripple:ne(s.ripple,ie.ripple),rippleVisible:ne(s.rippleVisible,ie.rippleVisible),ripplePulsate:ne(s.ripplePulsate,ie.ripplePulsate),child:ne(s.child,ie.child),childLeaving:ne(s.childLeaving,ie.childLeaving),childPulsate:ne(s.childPulsate,ie.childPulsate)},timeout:Ke,pulsate:A,rippleX:b,rippleY:D,rippleSize:W},d.current)]),d.current+=1,m.current=K},[s]),L=l.useCallback((C={},A={},b=()=>{})=>{const{pulsate:D=!1,center:W=n||A.pulsate,fakeElement:K=!1}=A;if((C==null?void 0:C.type)==="mousedown"&&u.current){u.current=!1;return}(C==null?void 0:C.type)==="touchstart"&&(u.current=!0);const R=K?null:p.current,B=R?R.getBoundingClientRect():{width:0,height:0,left:0,top:0};let w,T,F;if(W||C===void 0||C.clientX===0&&C.clientY===0||!C.clientX&&!C.touches)w=Math.round(B.width/2),T=Math.round(B.height/2);else{const{clientX:P,clientY:S}=C.touches&&C.touches.length>0?C.touches[0]:C;w=Math.round(P-B.left),T=Math.round(S-B.top)}if(W)F=Math.sqrt((2*B.width**2+B.height**2)/3),F%2===0&&(F+=1);else{const P=Math.max(Math.abs((R?R.clientWidth:0)-w),w)*2+2,S=Math.max(Math.abs((R?R.clientHeight:0)-T),T)*2+2;F=Math.sqrt(P**2+S**2)}C!=null&&C.touches?g.current===null&&(g.current=()=>{E({pulsate:D,rippleX:w,rippleY:T,rippleSize:F,cb:b})},x.start(mi,()=>{g.current&&(g.current(),g.current=null)})):E({pulsate:D,rippleX:w,rippleY:T,rippleSize:F,cb:b})},[n,E,x]),z=l.useCallback(()=>{L({},{pulsate:!0})},[L]),$=l.useCallback((C,A)=>{if(x.clear(),(C==null?void 0:C.type)==="touchend"&&g.current){g.current(),g.current=null,x.start(0,()=>{$(C,A)});return}g.current=null,c(b=>b.length>0?b.slice(1):b),m.current=A},[x]);return l.useImperativeHandle(a,()=>({pulsate:z,start:L,stop:$}),[z,L,$]),e.jsx(wi,Q({className:ne(ie.root,s.root,r),ref:p},f,{children:e.jsx(Po,{component:null,exit:!0,children:h})}))});function ji(t){return nt("MuiButtonBase",t)}const vi=Oe("MuiButtonBase",["root","disabled","focusVisible"]),Ti=["action","centerRipple","children","className","component","disabled","disableRipple","disableTouchRipple","focusRipple","focusVisibleClassName","LinkComponent","onBlur","onClick","onContextMenu","onDragLeave","onFocus","onFocusVisible","onKeyDown","onKeyUp","onMouseDown","onMouseLeave","onMouseUp","onTouchEnd","onTouchMove","onTouchStart","tabIndex","TouchRippleProps","touchRippleRef","type"],Ai=t=>{const{disabled:a,focusVisible:i,focusVisibleClassName:n,classes:s}=t,r=at({root:["root",a&&"disabled",i&&"focusVisible"]},ji,s);return i&&n&&(r.root+=` ${n}`),r},Si=Me("button",{name:"MuiButtonBase",slot:"Root",overridesResolver:(t,a)=>a.root})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${vi.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),Mi=l.forwardRef(function(t,a){const i=Ue({props:t,name:"MuiButtonBase"}),{action:n,centerRipple:s=!1,children:r,className:f,component:h="button",disabled:c=!1,disableRipple:d=!1,disableTouchRipple:m=!1,focusRipple:u=!1,LinkComponent:x="a",onBlur:g,onClick:p,onContextMenu:E,onDragLeave:L,onFocus:z,onFocusVisible:$,onKeyDown:C,onKeyUp:A,onMouseDown:b,onMouseLeave:D,onMouseUp:W,onTouchEnd:K,onTouchMove:R,onTouchStart:B,tabIndex:w=0,TouchRippleProps:T,touchRippleRef:F,type:P}=i,S=_e(i,Ti),M=l.useRef(null),j=l.useRef(null),pe=Ot(j,F),{isFocusVisibleRef:re,onFocus:H,onBlur:he,ref:oe}=Xa(),[_,le]=l.useState(!1);c&&_&&le(!1),l.useImperativeHandle(n,()=>({focusVisible:()=>{le(!0),M.current.focus()}}),[]);const[xe,ye]=l.useState(!1);l.useEffect(()=>{ye(!0)},[]);const ge=xe&&!d&&!c;l.useEffect(()=>{_&&u&&!d&&xe&&j.current.pulsate()},[d,u,_,xe]);function X(y,$t,Ka=m){return Fe(Bt=>($t&&$t(Bt),!Ka&&j.current&&j.current[y](Bt),!0))}const be=X("start",b),k=X("stop",E),te=X("stop",L),v=X("stop",W),N=X("stop",y=>{_&&y.preventDefault(),D&&D(y)}),q=X("start",B),Ze=X("stop",K),et=X("stop",R),tt=X("stop",y=>{he(y),re.current===!1&&le(!1),g&&g(y)},!1),Be=Fe(y=>{M.current||(M.current=y.currentTarget),H(y),re.current===!0&&(le(!0),$&&$(y)),z&&z(y)}),Te=()=>{const y=M.current;return h&&h!=="button"&&!(y.tagName==="A"&&y.href)},it=l.useRef(!1),Ga=Fe(y=>{u&&!it.current&&_&&j.current&&y.key===" "&&(it.current=!0,j.current.stop(y,()=>{j.current.start(y)})),y.target===y.currentTarget&&Te()&&y.key===" "&&y.preventDefault(),C&&C(y),y.target===y.currentTarget&&Te()&&y.key==="Enter"&&!c&&(y.preventDefault(),p&&p(y))}),Va=Fe(y=>{u&&y.key===" "&&j.current&&_&&!y.defaultPrevented&&(it.current=!1,j.current.stop(y,()=>{j.current.pulsate(y)})),A&&A(y),p&&y.target===y.currentTarget&&Te()&&y.key===" "&&!y.defaultPrevented&&p(y)});let Pe=h;Pe==="button"&&(S.href||S.to)&&(Pe=x);const Ae={};Pe==="button"?(Ae.type=P===void 0?"button":P,Ae.disabled=c):(!S.href&&!S.to&&(Ae.role="button"),c&&(Ae["aria-disabled"]=c));const Wa=Ot(a,oe,M),zt=Q({},i,{centerRipple:s,component:h,disabled:c,disableRipple:d,disableTouchRipple:m,focusRipple:u,tabIndex:w,focusVisible:_}),Ha=Ai(zt);return e.jsxs(Si,Q({as:Pe,className:ne(Ha.root,f),ownerState:zt,onBlur:tt,onClick:p,onContextMenu:k,onFocus:Be,onKeyDown:Ga,onKeyUp:Va,onMouseDown:be,onMouseLeave:N,onMouseUp:v,onDragLeave:te,onTouchEnd:Ze,onTouchMove:et,onTouchStart:q,ref:Wa,tabIndex:c?-1:w,type:P},Ae,S,{children:[r,ge?e.jsx(bi,Q({ref:pe,center:s},T)):null]}))});function Ei(t){return nt("MuiIconButton",t)}const ki=Oe("MuiIconButton",["root","disabled","colorInherit","colorPrimary","colorSecondary","colorError","colorInfo","colorSuccess","colorWarning","edgeStart","edgeEnd","sizeSmall","sizeMedium","sizeLarge"]),Ri=["edge","children","className","color","disabled","disableFocusRipple","size"],Ii=t=>{const{classes:a,disabled:i,color:n,edge:s,size:r}=t,f={root:["root",i&&"disabled",n!=="default"&&`color${je(n)}`,s&&`edge${je(s)}`,`size${je(r)}`]};return at(f,Ei,a)},Di=Me(Mi,{name:"MuiIconButton",slot:"Root",overridesResolver:(t,a)=>{const{ownerState:i}=t;return[a.root,i.color!=="default"&&a[`color${je(i.color)}`],i.edge&&a[`edge${je(i.edge)}`],a[`size${je(i.size)}`]]}})(({theme:t,ownerState:a})=>Q({textAlign:"center",flex:"0 0 auto",fontSize:t.typography.pxToRem(24),padding:8,borderRadius:"50%",overflow:"visible",color:(t.vars||t).palette.action.active,transition:t.transitions.create("background-color",{duration:t.transitions.duration.shortest})},!a.disableRipple&&{"&:hover":{backgroundColor:t.vars?`rgba(${t.vars.palette.action.activeChannel} / ${t.vars.palette.action.hoverOpacity})`:Ut(t.palette.action.active,t.palette.action.hoverOpacity),"@media (hover: none)":{backgroundColor:"transparent"}}},a.edge==="start"&&{marginLeft:a.size==="small"?-3:-12},a.edge==="end"&&{marginRight:a.size==="small"?-3:-12}),({theme:t,ownerState:a})=>{var i;const n=(i=(t.vars||t).palette)==null?void 0:i[a.color];return Q({},a.color==="inherit"&&{color:"inherit"},a.color!=="inherit"&&a.color!=="default"&&Q({color:n==null?void 0:n.main},!a.disableRipple&&{"&:hover":Q({},n&&{backgroundColor:t.vars?`rgba(${n.mainChannel} / ${t.vars.palette.action.hoverOpacity})`:Ut(n.main,t.palette.action.hoverOpacity)},{"@media (hover: none)":{backgroundColor:"transparent"}})}),a.size==="small"&&{padding:5,fontSize:t.typography.pxToRem(18)},a.size==="large"&&{padding:12,fontSize:t.typography.pxToRem(28)},{[`&.${ki.disabled}`]:{backgroundColor:"transparent",color:(t.vars||t).palette.action.disabled}})}),Ni=l.forwardRef(function(t,a){const i=Ue({props:t,name:"MuiIconButton"}),{edge:n=!1,children:s,className:r,color:f="default",disabled:h=!1,disableFocusRipple:c=!1,size:d="medium"}=i,m=_e(i,Ri),u=Q({},i,{edge:n,color:f,disabled:h,disableFocusRipple:c,size:d}),x=Ii(u);return e.jsx(Di,Q({className:ne(x.root,r),centerRipple:!0,focusRipple:!c,disabled:h,ref:a},m,{ownerState:u,children:s}))});function Li(t){return nt("MuiSkeleton",t)}Oe("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const zi=["animation","className","component","height","style","variant","width"];let Le=t=>t,Ct,wt,yt,bt;const $i=t=>{const{classes:a,variant:i,animation:n,hasChildren:s,width:r,height:f}=t;return at({root:["root",i,n,s&&"withChildren",s&&!r&&"fitContent",s&&!f&&"heightAuto"]},Li,a)},Bi=Se(Ct||(Ct=Le`
  0% {
    opacity: 1;
  }
...
`)),Oi=Me("span",{name:"MuiSkeleton",slot:"Root",overridesResolver:(t,a)=>{const{ownerState:i}=t;return[a.root,a[i.variant],i.animation!==!1&&a[i.animation],i.hasChildren&&a.withChildren,i.hasChildren&&!i.width&&a.fitContent,i.hasChildren&&!i.height&&a.heightAuto]}})(({theme:t,ownerState:a})=>{const i=pi(t.shape.borderRadius)||"px",n=hi(t.shape.borderRadius);return Q({display:"block",backgroundColor:t.vars?t.vars.palette.Skeleton.bg:di(t.palette.text.primary,t.palette.mode==="light"?.11:.13),height:"1.2em"},a.variant==="text"&&{marginTop:0,marginBottom:0,height:"auto",transformOrigin:"0 55%",transform:"scale(1, 0.60)",borderRadius:`${n}${i}/${Math.round(n/.6*10)/10}${i}`,"&:empty:before":{content:'"\\00a0"'}},a.variant==="circular"&&{borderRadius:"50%"},a.variant==="rounded"&&{borderRadius:(t.vars||t).shape.borderRadius},a.hasChildren&&{"& > *":{visibility:"hidden"}},a.hasChildren&&!a.width&&{maxWidth:"fit-content"},a.hasChildren&&!a.height&&{height:"auto"})},({ownerState:t})=>t.animation==="pulse"&&_t(yt||(yt=Le`
    ...
    `),Pi,(a.vars||a).palette.action.hover)),ze=l.forwardRef(function(t,a){const i=Ue({props:t,name:"MuiSkeleton"}),{animation:n="pulse",className:s,component:r="span",height:f,style:h,variant:c="text",width:d}=i,m=_e(i,zi),u=Q({},i,{animation:n,component:r,variant:c,hasChildren:!!m.children}),x=$i(u);return e.jsx(Oi,Q({as:r,ref:a,className:ne(x.root,s),ownerState:u},m,{style:Q({width:d,height:f},h)}))}),jt=()=>(Z(),e.jsxs(G,{children:[e.jsxs(Ui,{children:[e.jsxs(_i,{children:[e.jsx(ze,{variant:"rectangular",sx:{bgcolor:"#F4F5FA"},style:{width:"8rem",height:"8rem",borderRadius:"32px",marginRight:"2%"}}),e.jsxs(Fi,{children:[e.jsx(ze,{variant:"rectangular",sx:{bgcolor:"#F4F5FA"},style:{width:"40%",height:"2.2rem",borderRadius:"5px",marginTop:"3%"}}),e.jsx(ze,{variant:"rectangular",sx:{bgcolor:"#F4F5FA"},style:{width:"20%",height:"1.1rem",borderRadius:"5px",marginTop:"2%"}})]})]}),e.jsx(ze,{variant:"rectangular",sx:{bgcolor:"#F4F5FA"},style:{width:"100%",height:"2.7rem",borderRadius:"9px",marginTop:"4%"}})]}),e.jsx(G,{padding:"40px 0 40px 0",children:e.jsx(qa,{type:Qa.SEAMLESS,title:"Loading Channel Details. Please wait..."})})]})),Ui=o.div`
  width: 100%;
  display: flex;
...
`,Je=o.div`
  ...
  ${({active:t})=>t==="active"&&Ge`
    ...
    `};
`,vt=({heading:t,subHeading:a})=>{const i=Z();return e.jsx(We,{theme:i,children:e.jsxs(Xi,{children:[e.jsx(qi,{style:{color:i.default.color},children:t}),e.jsx(Qi,{style:{color:i.modalMessageColor},children:a})]})})},Xi=o.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  margin-bottom: 4%;
...
`,Qi=o.h4`
  ...
  margin: 0;
  padding: 0;
`,Xe=V.forwardRef(({title:t},a)=>{const i=Z();return e.jsx(We,{theme:i,children:e.jsxs(Zi,{children:[e.jsx(en,{style:{color:i.modalMessageColor},children:t}),e.jsx(tn,{ref:a,radius:"12px",padding:"0.8rem",border:"1px solid #BAC4D6",style:{color:i.modalMessageColor}})]})})}),Zi=o.div`
  display: flex;
  flex-direction: column;
  margin: 3% 0%;
`,en=o.h4`
...
`;o.img`
  height: 36px;
  width: 17px;
`;const Cn="DD MMM, YYYY",wn=({onConfirm:t,onClose:a,toastObject:i})=>{const n=Z(),{chainId:s,account:r,provider:f}=me(),h=Ee(),{channelDetails:c,canVerify:d,aliasDetails:{isAliasVerified:m,aliasAddrFromContract:u}}=O(S=>S.admin),{CHANNEL_ACTIVE_STATE:x,CHANNNEL_DEACTIVATED_STATE:g}=O(S=>S.channels),[p,E]=l.useState("");let{channelState:L}=c;L||(L=c.activation_status);const z=L===x,$=L===g,[C,A]=l.useState(!1),[b,D]=l.useState(!1),[W,K]=l.useState(0),R=()=>!C&&a(),B=l.useRef(null);ue(B,()=>R());const w=se.coreContractChain===s;Re(600),l.useEffect(()=>{!c||!w||async function(){const S=c.channelStartBlock.toString(),M=await new Vt(se.coreRPC).getBlock(+S),j=Wt(M.timestamp*1e3);E(j.format(Cn))}()},[c]),l.useEffect(()=>{!r||!f||async function(){const S=await ti({address:r,provider:f,contractAddress:He.epnscore});K(parseInt(S));const M=parseInt(S);M>=50&&M!=0?D(!0):D(!1)}()},[r,f]);const T=async S=>{await ii({noOfTokens:S,provider:f,account:r})},F=async()=>{if(A(!0),!f)return;const S=f.getSigner(r);i.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{const M=await ni({signer:S,contractAddress:He.epnscore,amount:50-W});console.debug("response",M),M&&(K(50),D(!0),i.showMessageToast({toastTitle:"Success",toastMessage:"Successfully approved Push!",toastType:"SUCCESS",getToastIcon:j=>e.jsx(fe,{size:j,color:"green"})}),A(!1))}catch(M){console.error(M),M.code=="ACTION_REJECTED"?i.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:j=>e.jsx(Y,{size:j,color:"red"})}):(i.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in approving PUSH Token",toastType:"ERROR",getToastIcon:j=>e.jsx(Y,{size:j,color:"red"})}),console.error("Error --> %o",M),console.error({err:M}))}A(!1)},P=async()=>{A(!0);try{const S=Ht("50",18),M=await t(S);i.showMessageToast({toastTitle:"Reactivating channel",toastMessage:"Reactivate channel.",toastType:"SUCCESS",getToastIcon:j=>e.jsx(fe,{size:j,color:"green"})}),await M.wait(),console.info("Transaction Mined!"),i.showMessageToast({toastTitle:"Channel Reactivated",toastMessage:"Channel has been reactivated. You can now send notifications from it",toastType:"SUCCESS",getToastIcon:j=>e.jsx(fe,{size:j,color:"green"})}),h(lt({...c,channelState:x})),a(),A(!1)}catch(S){console.error("Error reactivateChannel",{err:S}),i.showMessageToast({toastTitle:"Transaction Failed",toastMessage:"Channel reactivation failed.",toastType:"ERROR",getToastIcon:M=>e.jsx(Y,{size:M,color:"red"})}),A(!1)}};return e.jsx(We,{theme:n,children:e.jsxs(yn,{ref:B,children:[e.jsxs(bn,{children:[e.jsx(jn,{children:"Reactivate Channel"}),e.jsx(Ni,{onClick:R,style:{padding:"0",marginRight:"0.5rem"},sx:{"&:hover":{backgroundColor:"transparent"}},children:e.jsx(co,{size:"1.5rem",style:{color:n.modalIconColor}})})]}),e.jsxs(Tn,{justifyContent:"flex-start",alignSelf:"stretch",children:[e.jsx(An,{src:c.icon}),e.jsxs(At,{alignItems:"flex-start",padding:"5px 0px",children:[e.jsxs(Dn,{children:[c.name,d&&e.jsx(Sn,{src:"/verify.png"})]}),e.jsxs(At,{alignItems:"flex-start",flex:"initial",padding:"5px 0px",children:[w&&u&&!m||!w&&!m?e.jsx(kn,{children:"Alias Network Setup Pending"}):e.jsxs(vn,{justifyContent:"flex-start",children:[e.jsxs(Mn,{children:[e.jsx("img",{style:{width:"15px"},src:"/subcount.svg",alt:"subscount"}),e.jsx(Rn,{children:c.subscriber_count})]}),e.jsx(En,{active:z,children:z?"Active":$?"Deactivated":"Blocked"})]}),p&&e.jsxs(In,{children:["Created ",p]})]})]})]}),e.jsxs(Nn,{children:[e.jsx(Ln,{children:"Channel reactivation fee"}),e.jsxs(G,{flex:"0",children:[b?e.jsx(zn,{src:$o}):null,e.jsxs($n,{children:[50," PUSH"]})]})]}),e.jsx(Qt,{noOfPushTokensToCheck:50,containerProps:{width:"100%"},onMintPushToken:T}),C?e.jsxs(Pn,{children:[e.jsx(Gt,{size:42,color:U.COLORS.PRIMARY_PINK,type:st.PROCESSING}),e.jsx(On,{children:"Verifying Transaction"})]}):e.jsx(Bn,{children:W>=50?e.jsx(Mt,{onClick:P,children:"Reactivate"}):e.jsx(Mt,{onClick:F,children:"Approve PUSH"})})]})})},yn=o.div`
  width: 30vw;
  display: flex;
  flex-direction: column;
  background: ${t=>t.theme.modalContentBackground};
...
`,On=o.p`
  ...
  margin-left: 12px;
  color: ${t=>t.theme.editChannelPrimaryText};
`,Un=50,_n=se.coreContractChain;function Fn({DropdownRef:t,isDropdownOpen:a,closeDropdown:i}){Ee();const{account:n,chainId:s}=me(),{epnsWriteProvider:r,epnsCommWriteProvider:f}=O(H=>H.contracts),{channelDetails:h}=O(H=>H.admin),{CHANNNEL_DEACTIVATED_STATE:c,CHANNEL_BLOCKED_STATE:d}=O(H=>H.channels);O(H=>H.user);const m=Z(),{channelState:u}=h,x=_n===s,g=Re(425),{isModalOpen:p,showModal:E,ModalComponent:L}=Ie(),{isModalOpen:z,showModal:$,ModalComponent:C}=Ie(),{isModalOpen:A,showModal:b,ModalComponent:D}=Ie(),W=a&&!p&&!z&&!A;ue(t,()=>W&&i()),V.useState(!1),V.useState(Un);const[K,R]=V.useState(0),B=u===c,w=u===d,T=w||B;V.useEffect(()=>{R(+po.formatBigNumberToMetric(h.poolContribution,!0))},[n,h.poolContribution]),de();const F=()=>{w||(B?$():E())},P=de(),S=r.reactivateChannel,M=de(),j=()=>r.deactivateChannel(),pe=de(),re=async(H,he)=>{if(!(H==""||he=="")&&!(H<60))try{const oe=H+"+"+he,_=Kt(oe);return r.addSubGraph(_)}catch(oe){console.error(oe)}};return e.jsxs(e.Fragment,{children:[e.jsx("div",{children:e.jsx(Gn,{background:m,children:e.jsxs(Vn,{children:[se.appEnv!=="prod"&&e.jsx(Et,{disabled:T,onClick:()=>!T&&b(),children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[e.jsx($e,{src:on,alt:"cube"}),e.jsx("div",{style:{width:"10px"}}),"Add SubGraph Details"]})}),x&&e.jsx(Et,{isChannelDeactivated:B,onClick:F,children:e.jsx(Wn,{isChannelBlocked:w,isChannelDeactivated:B,children:e.jsxs("div",{style:{display:"flex",justifyContent:"flex-start",alignItems:"center"},children:[w?e.jsx($e,{src:Tt,alt:"red-bell"}):B?e.jsx($e,{src:rn,alt:"green-bell"}):e.jsx($e,{src:Tt,alt:"red-bell"}),e.jsx("div",{style:{width:"10px"}}),w?"Channel Blocked":B?"Activate Channel":"Deactivate Channel"]})})})]})})}),e.jsx(L,{InnerComponent:pn,onConfirm:j,toastObject:M,modalPosition:De.ON_ROOT}),e.jsx(C,{InnerComponent:wn,onConfirm:S,toastObject:P,modalMargin:g?"10rem 1rem 0 1rem":"",modalPosition:De.ON_ROOT}),e.jsx(D,{InnerComponent:sn,onConfirm:re,toastObject:pe,modalPosition:De.ON_ROOT})]})}const Gn=o.div`
  position: absolute;
  right: 20px;
  display: flex;
  flex-direction: column-reverse;
...
`,$e=o.img`
  ...
  padding: 0;
  margin: 0;
`;function kt(){const t=V.useRef(null),[a,i]=V.useState(!1);Z();const n=()=>{i(r=>!r)},s=()=>{i(!1)};return e.jsxs(G,{flex:"0",ref:t,children:[e.jsx(Hn,{active:a,onClick:n}),a&&e.jsx(Fn,{DropdownRef:t,isDropdownOpen:a,closeDropdown:s})]})}o.div`
  flex: 1;
  display: flex;
...
`,we=t=>t.trim().length==0;function va(t,a){var i=new XMLHttpRequest;i.onload=function(){var n=new FileReader;n.onloadend=function(){a(n.result)},n.readAsDataURL(i.response)},i.open("GET",t),i.responseType="blob",i.send()}const Ta=t=>{var a=Ko,i=t.split(";base64,").pop(),n=vo.from(i,"base64"),s=a(n);return s.width>128||s.height>128?(console.error("Image size check failed... returning"),{success:0,info:"Image size check failed, Image should be 128X128PX"}):(console.debug("Image verification",i.charAt(0)),i.charAt(0)==="/"?{success:1,info:"Image checks passed"}:i.charAt(0)==="i"?{success:1,info:"Image checks passed"}:{success:0,info:"Image extension should be jpg or png"})};function Aa({closeEditChannel:t,UploadLogoComponent:a,displayUplaodLogoModal:i}){const{account:n,provider:s}=me(),{channelDetails:r,aliasDetails:{isAliasVerified:f,aliasAddrFromContract:h}}=O(v=>v.admin),{epnsReadProvider:c,epnsWriteProvider:d}=O(v=>v.contracts),m=50,[u,x]=l.useState(r==null?void 0:r.name),[g,p]=l.useState(r==null?void 0:r.info),[E,L]=l.useState(r==null?void 0:r.url),[z,$]=l.useState(r==null?void 0:r.icon),[C,A]=l.useState(r==null?void 0:r.icon),[b,D]=l.useState(r==null?void 0:r.icon),[W,K]=l.useState(b),[R,B]=l.useState(null),[w,T]=l.useState(!1),[F,P]=l.useState({name:"",description:"",address:"",url:""}),[S,M]=l.useState(!1),[j,pe]=l.useState(0),[re,H]=l.useState(0),[he,oe]=l.useState(!1),_=de();l.useEffect(()=>{n&&async function(){const v=await c.channelUpdateCounter(n);pe(m*(Number(v)+1))}()},[n]),l.useEffect(()=>{!n||!s||async function(){const v=await ti({address:n,provider:s,contractAddress:He.epnscore});H(parseInt(v));const N=parseInt(v);N>=j&&N!=0?T(!0):T(!1)}()},[n,s]);const le=async()=>{if(M(!0),!s)return;const v=s.getSigner(n);_.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});try{const N=await ni({signer:v,contractAddress:He.epnscore,amount:j-re});console.debug("response",N),N&&(M(!1),H(j),T(!0),_.showMessageToast({toastTitle:"Success",toastMessage:"Successfully approved Push!",toastType:"SUCCESS",getToastIcon:q=>e.jsx(fe,{size:q,color:"green"})}))}catch(N){console.error(N),N.code=="ACTION_REJECTED"?_.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:q=>e.jsx(Y,{size:q,color:"red"})}):(_.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in approving PUSH Token",toastType:"ERROR",getToastIcon:q=>e.jsx(Y,{size:q,color:"red"})}),console.error("Error --> %o",N),console.error({err:N}))}M(!1)},xe=()=>{oe(!1)},ye=Re(600),ge=l.useRef(null);ue(ge,()=>{xe()});const X=()=>(P(""),we(u)||we(g)||we(E)?(we(u)&&P(v=>({...v,name:"Please, enter the channel name."})),we(g)&&P(v=>({...v,description:"Please, enter the channel description"})),we(E)&&P(v=>({...v,url:"Please, enter the channel url"})),!1):oi(u,125)?oi(E,125)?ai(E)?!0:(P(v=>({...v,url:"Channel URL is invalid! Please enter a valid url!"})),!1):(P(v=>({...v,url:"Channel Url should not exceed 125 characters! Please retry!"})),!1):(P(v=>({...v,name:"Channel Name should not exceed 125 characters! Please retry!"})),!1)),be=()=>!(u!==(r==null?void 0:r.name)||g!==(r==null?void 0:r.info)||E!==(r==null?void 0:r.url)||C!==(r==null?void 0:r.icon)),k=async v=>{try{if(!X())return;M(!0);const N=JSON.stringify({name:u,info:g,url:E,icon:C,aliasDetails:r.aliasDetails||To({chainId:parseInt(r.chain_id),address:r.address})});console.debug(N);const q=await Ao(N);console.debug("IPFS storagePointer:",q);const Ze="1+"+q,et=Kt(Ze),tt=Ht(j.toString(),18);_.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const Be=await d.updateChannelMeta(n,et,tt,{gasLimit:1e6});console.debug(Be),await Be.wait(),M(!1),_.showMessageToast({toastTitle:"Success",toastMessage:"Channel Updated Successfully",toastType:"SUCCESS",getToastIcon:Te=>e.jsx(fe,{size:Te,color:"green"})}),setTimeout(()=>{window.location.reload()},2e3)}catch(N){M(!1),console.error(N.message),N.code=="ACTION_REJECTED"?_.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:q=>e.jsx(Y,{size:q,color:"red"})}):(_.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in updating channel Details",toastType:"ERROR",getToastIcon:q=>e.jsx(Y,{size:q,color:"red"})}),console.error("Error --> %o",N),console.error({err:N}))}},te=async v=>{await ii({noOfTokens:v,provider:s,account:n})};return l.useEffect(()=>{b&&(console.debug("Image cropped",b),va(b,function(v){const N=Ta(v);console.debug("response",N),N.success&&(console.debug("Cropped Image....",b),A(b))}))},[b]),e.jsxs(Sa,{ref:ge,children:[e.jsx(a,{InnerComponent:ga,InnerComponentProps:{setChannelLogo:$,channelLogo:z,croppedImage:b,setCroppedImage:D,setChannelFile:A,imageSrc:W,setImageSrc:K,imageType:R,setImageType:B,errorInfo:F,setErrorInfo:P},modalPosition:De.ON_PARENT}),e.jsxs(Ma,{children:[e.jsxs(ka,{children:[e.jsx(Ra,{src:z}),e.jsx(ae,{variant:"secondary",onClick:()=>{i(),oe(!0)},children:"Upload Logo"})]}),!ye&&e.jsx(Ia,{}),e.jsx(ca,{channelName:u,setChannelName:x,channelInfo:g,setChannelInfo:p,channelURL:E,setChannelURL:L,editChannel:k,errorInfo:F,setErrorInfo:P})]}),e.jsxs(Da,{children:[e.jsxs("div",{children:[e.jsx(Na,{children:"Channel edit fee"}),e.jsx(La,{children:"Editing channel details requires fees to be deposited"})]}),e.jsxs(G,{flex:"0",children:[w?e.jsx(Ea,{src:xa}):null,e.jsxs(za,{children:[j," PUSH"]})]})]}),e.jsx(Qt,{noOfPushTokensToCheck:j,containerProps:{width:"100%"},onMintPushToken:te}),S?e.jsx(e.Fragment,{children:e.jsxs($a,{children:[e.jsx(Spinner,{size:42,color:U.COLORS.PRIMARY_PINK,type:st.PROCESSING}),e.jsx(Ba,{children:"Verifying Transaction"})]})}):e.jsx(e.Fragment,{children:e.jsxs(Pa,{children:[e.jsx(ae,{onClick:t,variant:"outline",size:"large",children:"Cancel"}),re>=j?e.jsx(ae,{disabled:be(),onClick:k,size:"large",children:"Save Changes"}):e.jsx(ae,{onClick:le,size:"large",children:"Approve PUSH"})]})})]})}const Sa=o(J)`
  padding: 0px;
...
`,Oa=10;let Nt=null;const Ua=()=>{Z();const{account:t,chainId:a,wallet:i}=me(),{channelDetails:n,delegatees:s,aliasDetails:{aliasAddr:r,aliasEthAddr:f,isAliasVerified:h,aliasAddrFromContract:c}}=O(w=>w.admin),{processingState:d}=O(w=>w.channelCreation),{epnsWriteProvider:m}=O(w=>w.contracts);O(w=>w.user),l.useContext(Jt);const u=n&&n!=="unfetched",x=de(),g=Ee(),[p,E]=l.useState(!1);l.useState(!0);const[L,z]=l.useState(!1),$=se.coreContractChain===a,C=Re(600);l.useEffect(()=>{if(!$||!n||c||n==="unfetched")return;const w=So(n);if(w){const{address:T,chainId:F}=w;g(Mo(T)),g(Eo(F))}else g(ke(0))},[n,c]);const A=async w=>{let{aliasAddress:T=null,isAliasVerified:F=null}=await Xt.getInstance().getChannelDetailsFromAddress(w);return T=="NULL"&&(T=null),{aliasAddress:T,aliasVerified:F}};l.useEffect(()=>{!$||!c||d===0||(Nt=setInterval(async()=>{const{aliasAddress:w,aliasVerified:T}=await A(t);w?(g(ko(w)),T?(g(ht(!0)),g(ke(0))):(g(ke(2)),g(ht(!1)))):d!=0&&d!=1&&g(ke(1))},Oa*1e3))},[c]),r!==null&&clearInterval(Nt);const b=async()=>{try{x.showLoaderToast({loaderMessage:"Waiting for Confirmation..."});const w=await m.destroyTimeBoundChannel(t,{gasLimit:1e6});console.debug(w),console.debug("Check: "+t),await w.wait(),x.showMessageToast({toastTitle:"Success",toastMessage:"Successfully deleted the channel",toastType:"SUCCESS",getToastIcon:T=>e.jsx(Y,{size:T,color:"green"})}),g(lt(null))}catch(w){console.error(w),w.code=="ACTION_REJECTED"?x.showMessageToast({toastTitle:"Error",toastMessage:"User denied message signature.",toastType:"ERROR",getToastIcon:T=>e.jsx(Y,{size:T,color:"red"})}):x.showMessageToast({toastTitle:"Error",toastMessage:"There was an error in deleting the channel",toastType:"ERROR",getToastIcon:T=>e.jsx(Y,{size:T,color:"red"})})}},D=()=>{z(!0)},W=()=>{z(!1)},{isModalOpen:K,showModal:R,ModalComponent:B}=Ie();return e.jsxs(G,{children:[(n==="unfetched"||d===null)&&e.jsx(jt,{}),n!=="unfetched"&&e.jsxs(J,{justifyContent:d===0&&"flex-start",height:"fit-content",children:[!n&&d===0&&e.jsx(Yo,{}),u&&d!==null&&e.jsx(_a,{children:L?e.jsx(Aa,{closeEditChannel:W,UploadLogoComponent:B,displayUplaodLogoModal:R,isUploadLogoModalOpen:K}):e.jsxs(e.Fragment,{children:[n&&!C&&e.jsxs(G,{zIndex:"1",gap:"8px",children:[!p&&$&&e.jsx(ae,{onClick:D,size:"small",variant:"outline",children:"Edit Channel"}),!p&&e.jsx(kt,{}),p&&$&&e.jsx(ae,{onClick:b,size:"small",variant:"danger",children:"Delete Channel"})]}),n?e.jsx(Yn,{isChannelExpired:p,setIsChannelExpired:E,showEditChannel:D,destroyChannel:b}):""]})}),d!==0&&d!==null&&u&&!L&&e.jsx(e.Fragment,{children:e.jsx(Ki,{aliasEthAccount:f,setAliasVerified:ht})})]})]})},_a=o(J)`
  align-items: center;
  align-self: center;
...
`;se.coreContractChain;function Fa(){Ro.pageview("/channel_dashboard");const[t,a]=V.useState(!0),[i,n]=V.useState(null),s=()=>n(null);return V.useEffect(()=>{i&&s()},[i]),e.jsxs(e.Fragment,{children:[t?e.jsx(Ua,{}):e.jsx(jt,{}),i&&e.jsx(Lo,{notification:i,clearToast:s})]})}o.div`
  flex: 1;
  display: flex;

  margin-bottom: 15px;
  overflow: hidden;
`;let Lt;ri=()=>e.jsx(Lt,{children:e.jsx(Fa,{})}),Lt=o(Io)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
  justify-content: flex-start;
`});export{ir as __tla,ri as default};
