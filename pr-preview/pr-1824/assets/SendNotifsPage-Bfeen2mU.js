import{b6 as s,bK as t,bL as l,bM as D,bO as u,bY as m,aY as L,bZ as T,bg as a,b1 as e,b_ as N,bb as h,bi as _,b7 as f,__tla as $}from"./index-COtUxmek.js";import{S as b,__tla as O}from"./SendNotifications-DTISNs20.js";import{__tla as x}from"./index-fxlKtJVH.js";import{__tla as p}from"./Tag-CKyvRXp_.js";import{__tla as g}from"./TransitionGroupContext-CCCOgYi6.js";let A,R=Promise.all([(()=>{try{return $}catch{}})(),(()=>{try{return O}catch{}})(),(()=>{try{return x}catch{}})(),(()=>{try{return p}catch{}})(),(()=>{try{return g}catch{}})()]).then(async()=>{_.coreContractChain;function M(){u.pageview("/send_notificaiton"),m(),L(),T(n=>n.contracts),T(n=>n.admin),_.coreContractChain;const[r,G]=a.useState(2),[d,J]=a.useState(!0);a.useState(null),a.useState(null);const[c,y]=a.useState(!0);a.useState([]);const[E,I]=a.useState(null),U=()=>I(null);return a.useEffect(()=>{E&&U()},[E]),e.jsx(i,{children:r===2&&d?e.jsxs(e.Fragment,{children:[!c&&e.jsx(N,{replace:!0,to:"/dashboard"}),c&&e.jsx(b,{})]}):e.jsx(S,{children:"Channel details are being loaded, please wait\u2026"})})}let i,S,o;i=s(h)`
  align-items: center;
  align-self: center;
