...
`,mn=({poolStats:n})=>{function t(o){return o==null?void 0:o.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",")}const a=Re(600);return e.jsx(yn,{justifyContent:"stretch",children:n?e.jsxs(e.Fragment,{children:[e.jsx(Et,{fontSize:a?"16px":"18px",textAlign:"left",fontWeight:600,children:"Push Price"}),e.jsxs(E,{gap:"5px",justifyContent:"flex-end",children:[e.jsxs(Et,{fontSize:a?"18px ":"24px",textAlign:"left",fontWeight:600,children:["$",t(n==null?void 0:n.pushPrice.toFixed(2))]}),e.jsx(le,{width:"25px",height:a?"20px":"27px",src:"svg/uniswapLogo.svg",alt:"Uniswap Logo"})]})]}):e.jsxs(Tn,{children:[e.jsx(g,{height:"12px",width:"135px",margin:"10px 0 10px 0"}),e.jsx(g,{height:"12px",width:"135px",margin:"10px 0 10px 0"})]})})},yn=p(E)`
  flex-direction: row;
...
`;Q.coreContractChain;let Lt,Dt,zt,gt,Bt,Vt;Lt=()=>{wa.pageview("/yield");const[n,t]=u.useState(0),[a,o]=u.useState(!1),{account:s,chainId:i,switchChain:r}=Ce(),l=()=>{const x=Q.allowedNetworks[0];i!==1&&i!==5&&r(x)};u.useEffect(()=>{i!==1&&i!==11155111&&(h(),l())},[i]);const{isModalOpen:d,showModal:h,ModalComponent:m}=tt();return e.jsxs(Dt,{children:[e.jsx(m,{InnerComponent:aa,onConfirm:()=>{},modalPadding:"0px",modalPosition:nt.ON_PARENT}),e.jsxs(zt,{children:[e.jsx(gt,{isActive:!n,onClick:()=>{o(!0),t(0)},children:"Yield Farming V2"}),e.jsxs(gt,{isActive:n,onClick:()=>{o(!1),t(1)},children:["Yield Farming V1 ",e.jsx(Bt,{children:"Deprecated"})]})]}),n===0&&e.jsx(ta,{setActiveTab:t}),n===1&&e.jsx(xn,{setActiveTab:t})]})},Dt=p(ze)`
	align-items: stretch;
	align-self: center;
  flex: 1;
	background: ${n=>n.theme.default.bg};
...
`,Kt=()=>e.jsx(Vt,{children:e.jsx(Lt,{})}),Vt=p(ze)`
  ...
  flex-direction: column;
  align-self: stretch;
`});export{Sa as __tla,Kt as default};
