import{aV as d,bP as C,bE as le,b0 as f,dU as ce,b4 as t,a$ as Q,bF as Z,bK as ee,bg as R,c4 as de,bJ as te,a_ as ne,bL as y,dM as pe,ba as se,bb as oe,ci as k,dO as he,bU as re,bV as D,cj as ae,ds as ge,dB as ue,gp as xe,__tla as fe}from"./index-IfN6ri3H.js";import{I as be,R as we,__tla as Se}from"./RangeSlider-P5GL09mo.js";let E,ie,P,me=Promise.all([(()=>{try{return fe}catch{}})(),(()=>{try{return Se}catch{}})()]).then(async()=>{let $,A,O,B,V,W,F,U,H,J,K,_,N,X,Y,q,z,G;E=({children:n,renderDropdownContainer:r,showDropdown:s,toggleDropdown:g,closeDropdown:o,containerPadding:u,centerOnMobile:l})=>{const c=f.useRef(null),p=f.useRef(null);return ce(c,p,o),t.jsxs($,{ref:c,onClick:g,children:[n,s&&t.jsx(A,{containerPadding:u,centerOnMobile:l,children:t.jsx("div",{ref:p,onClick:e=>e.stopPropagation(),children:r})})]})},$=d.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
