...
`,vn=r.span`
  ${e=>e.hideIt&&ve`
      visibility: hidden;
    `};
`,lt=({channelName:e,channelDescription:a,channelLogoSrc:s,height:n})=>t.jsxs(jn,{style:{borderRadius:n<250?"0.125rem 1rem 1rem 1rem":"1rem 1rem 1rem 0.125rem"},children:[t.jsx(Sn,{children:"Channel was recently updated"}),t.jsx(En,{children:"Previously"}),t.jsxs(Cn,{children:[t.jsx(Tn,{children:t.jsx(kn,{src:s})}),t.jsxs(An,{children:[t.jsx(Bn,{children:e}),t.jsx(_n,{children:a})]})]})]}),jn=r(de)`
...
`,_n=r(Se)`
  ...
  text-align: left;
  margin-top: 3px;
`,ct=({verifierIcon:e,verifierName:a,height:s})=>{const n=(a==null?void 0:a.length)>15?a.substring(0,15)+"...":a;return t.jsxs($n,{style:{width:212+(n&&n.length*2)+"px",borderRadius:s<160?"0.125rem 1rem 1rem 1rem":"1rem 1rem 1rem 0.125rem"},children:[t.jsx(dt,{children:"Verified By:"}),t.jsx(Dn,{src:e}),t.jsx(dt,{children:n})]})},$n=r(de)`
  box-sizing: border-box;
  height: 37px;
  max-height: 37px;
  background: #131313;
...
`,It=r(L)`
  width: 100%;
  margin-right: 10px;
`;var Nt=(e=>(e.CHANNEL="Channel",e.CHANNEL_PROFILE="Profile",e))(Nt||{});let zt,Pt;an=({channelID:e,loadTeaser:a,playTeaser:s})=>(wo.pageview(nt.Channels),t.jsx(zt,{children:t.jsxs(Pt,{children:[t.jsx($i,{loadTeaser:a,playTeaser:s,minimal:!!e}),e&&t.jsx(Kn,{channelID:e,loadTeaser:a,playTeaser:s,minimal:!1,profileType:"Profile"})]})})),zt=r.div`
  align-items: stretch;
  align-self: stretch;
  flex: 1;
  background: ${e=>e.theme.default.bg};
...
`,Pt=r.div`
  ...
  overflow: hidden;
`});export{an as C,ot as S,W,Oo as __tla};
