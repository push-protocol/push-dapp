import { bD as e, b4 as J, b1 as G, aQ as V, bL as c, b2 as ee, bo as o, bB as X, bX as k, aA as E, c8 as W, b6 as te, ab as ae, C as u, al as de, at as me, bg as R, bN as ue, aS as be, bj as K, b$ as he, c0 as ke, __tla as __tla_0 } from "./index-D1Swtpz3.js";
import { k4 as tl, k5 as al, k6 as rl, k7 as sl, k8 as nl, __tla as __tla_1 } from "./index-D1Swtpz3.js";
import { d as q, t as j, s as xe, e as fe, m as ye, __tla as __tla_2 } from "./number-BF137vdC.js";
let et, tt, at, rt, st, nt, lt, ot, dt, mt, ut, ct, it, pt, bt, ht, kt, xt, ft, yt, Et, Ct, wt, vt, Tt, Ut, St, gt, At, Bt, Ft, Mt, zt, Dt, It, _t, Ht, Pt, Ot, Lt, Nt, Rt, Kt, Gt, Vt, Xt, qt, jt, Zt, $t, Wt, Qt, Yt, Jt, ea, ta, aa, ra, sa, na, la, oa, ca, ia, pa, da, ma, ua, Ea, Ca, ba, ha, ka, xa, fa, ya, wa, va, Ta, Ua, Sa, ga, Aa, Ba, Fa, za, Ma, Da, Ia, _a, Ha, Pa, Oa, La, qa, ja, Xa, Wa, Qa, Za, $a, Ya, er, Ja, tr, ar, rr, sr, Na, Ra, Ka, Ga, nr, Va, lr, or, cr, ir, pr, dr, mr, ur, br, hr, kr, xr, fr, yr, Er, Cr, wr, vr, Tr, Ur, Sr, gr, Ar, Br, Fr, Mr, zr, Dr, Ir, _r, Hr, Pr, Or, Lr, Nr, Rr, Kr, Gr, Vr, Xr, qr, jr, Zr, $r, Wr, Qr, Yr, Jr, es, ts, rs, as, ss, ps, cs, is, ns, ls, os, ds, ms, us, hs, ks, xs, bs, fs, ys, Es, Cs, ws, vs, Ts, Us, Ss, gs, As, Bs, Fs, Ms, zs, Ds, Is, _s, Hs, Ps, Os, Ls, Ns, Rs, Ks, Gs, pn, dn, Vs, Xs, qs, js, Zs, $s, Ws, Qs, Ys, Js, en, tn, an, rn, sn, nn, ln, on, cn, mn, un, bn, kn, xn, fn, yn, hn, En, Cn, wn, vn, Tn, Un, Sn, gn, An, Bn, Fn, Mn, zn, Dn, In, _n, Hn, Pn, On, Ln, Nn, Rn, Kn, Gn, Vn, Xn, qn, jn, Zn, $n, Wn, Qn, Yn;
let __tla = Promise.all([
  ...
  Z = {
    block: V({
      format(t) {
        var _a2;
        return {
          transactions: (_a2 = t.transactions) == null ? void 0 : _a2.map((r) => {
            if (typeof r == "string") return r;
            const n = ee(r);
            return n.typeHex === "0x7e" && (n.isSystemTx = r.isSystemTx, n.mint = r.mint ? c(r.mint) : void 0, n.sourceHash = r.sourceHash, n.type = "deposit"), n;
          }),
    ...
    transaction: G({
      format(t) {
        const a = {};
        return t.type === "0x7e" && (a.isSystemTx = t.isSystemTx, a.mint = t.mint ? c(t.mint) : void 0, a.sourceHash = t.sourceHash, a.type = "deposit"), a;
      }
    }),
    transactionReceipt: J({
      format(t) {
        return {
          l1GasPrice: t.l1GasPrice ? c(t.l1GasPrice) : null,
          l1GasUsed: t.l1GasUsed ? c(t.l1GasUsed) : null,
          l1Fee: t.l1Fee ? c(t.l1Fee) : null,
  ...
  function ve(t) {
    Ue(t);
    const { sourceHash: a, data: r, from: n, gas: l, isSystemTx: i, mint: p, to: d, value: m } = t, b = [
      a,
      n,
      d ?? "0x",
      p ? o(p) : "0x",
  ...
  function Ue(t) {
    const { from: a, to: r } = t;
    if (a && !k(a)) throw new E({
      address: a
    });
    if (r && !k(r)) throw new E({
      address: r
    });
  }
  let s, T, U, S, g, A, Se, ge, Ae;
  s = {
    contracts: Ee,
    formatters: Z,
    serializers: we
  ...
  Ae = {
    estimateFeesPerGas: async (t) => {
      var _a2;
      if (!((_a2 = t.request) == null ? void 0 : _a2.feeCurrency)) return null;
  ...
  function se(t) {
    return t.type === "cip64" ? true : Me(t) && w(t.feeCurrency);
  }
  const ze = {
    block: V({
      exclude: [
      ...
      format(t) {
        var _a2;
        const a = (_a2 = t.transactions) == null ? void 0 : _a2.map((r) => typeof r == "string" ? r : {
          ...ee(r),
          feeCurrency: r.feeCurrency,
          ...r.type !== "0x7b" ? {
            gatewayFee: r.gatewayFee ? c(r.gatewayFee) : null,
    ...
    transaction: G({
      format(t) {
        ...
        return t.type === "0x7b" ? a.type = "cip64" : (t.type === "0x7c" && (a.type = "cip42"), a.gatewayFee = t.gatewayFee ? c(t.gatewayFee) : null, a.gatewayFeeRecipient = t.gatewayFeeRecipient), a;
      }
    }),
  ...
  function _e(t, a) {
    Pe(t);
    const { chainId: r, gas: n, nonce: l, to: i, value: p, maxFeePerGas: d, maxPriorityFeePerGas: m, accessList: b, feeCurrency: f, data: y } = t, h = [
      o(r),
      l ? o(l) : "0x",
      m ? o(m) : "0x",
      d ? o(d) : "0x",
  ...
  const He = 2n ** 256n - 1n;
  function Pe(t) {
    const { chainId: a, maxPriorityFeePerGas: r, gasPrice: n, maxFeePerGas: l, to: i, feeCurrency: p } = t;
    if (a <= 0) throw new ae({
      chainId: a
    });
    if (i && !k(i)) throw new E({
      address: i
    });
    if (n) throw new u("`gasPrice` is not a valid CIP-64 Transaction attribute.");
    if (w(l) && l > He) throw new de({
      maxFeePerGas: l
    });
    if (w(r) && w(l) && r > l) throw new me({
      maxFeePerGas: l,
      maxPriorityFeePerGas: r
    });
    if (w(p) && !k(p)) throw new u("`feeCurrency` MUST be a token address for CIP-64 transactions.");
    if (re(p)) throw new u("`feeCurrency` must be provided for CIP-64 transactions.");
  }
  let ne, B, F, Oe, $, Q, le;
  ne = {
    formatters: ze,
  ...
  le = {
    block: V({
      format(t) {
        var _a2;
        const a = (_a2 = t.transactions) == null ? void 0 : _a2.map((r) => {
          var _a3;
          if (typeof r == "string") return r;
          const n = (_a3 = le.transaction) == null ? void 0 : _a3.format(r);
          return n.typeHex === "0x71" ? n.type = "eip712" : n.typeHex === "0xff" && (n.type = "priority"), n;
        });
        return {
          l1BatchNumber: t.l1BatchNumber ? c(t.l1BatchNumber) : null,
          l1BatchTimestamp: t.l1BatchTimestamp ? c(t.l1BatchTimestamp) : null,
          transactions: a
        };
      }
    }),
    transaction: G({
      format(t) {
        ...
        return t.type === "0x71" ? a.type = "eip712" : t.type === "0xff" && (a.type = "priority"), {
          ...a,
          l1BatchNumber: t.l1BatchNumber ? c(t.l1BatchNumber) : null,
          l1BatchTxIndex: t.l1BatchTxIndex ? c(t.l1BatchTxIndex) : null
        };
      }
    }),
    transactionReceipt: J({
      format(t) {
        return {
          ...
          logs: t.logs.map((a) => ({
            ...be(a),
            l1BatchNumber: a.l1BatchNumber ? c(a.l1BatchNumber) : null,
            transactionLogIndex: ue(a.transactionLogIndex),
            logType: a.logType
          })),
          l2ToL1Logs: t.l2ToL1Logs.map((a) => ({
            blockNumber: c(a.blockHash),
            blockHash: a.blockHash,
            l1BatchNumber: c(a.l1BatchNumber),
            transactionIndex: c(a.transactionIndex),
            shardId: c(a.shardId),
...
`)), Object.defineProperty(this, "name", {
  ...
  function ce(t) {
    const { chainId: a, to: r, from: n, paymaster: l, paymasterInput: i } = t;
    if (!oe(t)) throw new Le();
    if (!a || a <= 0) throw new ae({
      chainId: a
    });
    if (r && !k(r)) throw new E({
      address: r
    });
    if (n && !k(n)) throw new E({
      address: n
    });
    if (l && !k(l)) throw new E({
      address: l
    });
    if (l && !i) throw new u("`paymasterInput` must be provided when `paymaster` is defined");
    if (!l && i) throw new u("`paymaster` must be provided when `paymasterInput` is defined");
  }
  function Ne(t, a) {
    return oe(t) ? Ke(t) : q(t, a);
  }
  const Re = {
    transaction: Ne
  };
  function Ke(t) {
    const { chainId: a, gas: r, nonce: n, to: l, from: i, value: p, maxFeePerGas: d, maxPriorityFeePerGas: m, customSignature: b, factoryDeps: f, paymaster: y, paymasterInput: h, gasPerPubdata: v, data: ie } = t;
    ce(t);
    const pe = [
      n ? o(n) : "0x",
      m ? o(m) : "0x",
  ...
  class Ge extends u {
    constructor({ givenLength: a, maxBytecodeSize: r }) {
      super(`Bytecode cannot be longer than ${r} bytes. Given length: ${a}`), Object.defineProperty(this, "name", {
        enumerable: true,
        configurable: true,
        writable: true,
  ...
  function qe(t) {
    const a = K(t);
    if (a.length % 32 !== 0) throw new Xe({
      givenLength: a.length
    });
    if (a.length > Q) throw new Ge({
      givenLength: a.length,
      maxBytecodeSize: Q
    });
    const r = he(a), n = K(r), l = a.length / 32;
    if (l % 2 === 0) throw new Ve({
      givenLengthInWords: l
    });
    const i = K(l), p = ke(i, {
      size: 2
    }), d = new Uint8Array([
  ...
  function Ze(t) {
    const { gas: a, nonce: r, to: n, from: l, value: i, maxFeePerGas: p, maxPriorityFeePerGas: d, factoryDeps: m, paymaster: b, paymasterInput: f, gasPerPubdata: y, data: h } = t;
    return {
      txType: 113n,
      from: BigInt(l),
      to: n ? BigInt(n) : 0n,
      ...
      maxFeePerGas: p ?? 0n,
      maxPriorityFeePerGas: d ?? 0n,
      paymaster: b ? BigInt(b) : 0n,
      nonce: r ? BigInt(r) : 0n,
      value: i ?? 0n,
      data: h || "0x0",
      factoryDeps: (m == null ? void 0 : m.map((v) => o(qe(v)))) ?? [],
      paymasterInput: f || "0x"
    };
  }
  let x, M, z, $e, We, D, I, C, _, H, Qe, P, O, L, N, Y;
  x = {
    formatters: le,
    serializers: Re,
    custom: {
...
export {
  ...
  St as bearNetworkChainTestnet,
  gt as berachainTestnet,
  At as bevmMainnet,
  Bt as bitTorrent,
  ...
  aa as darwinia,
  ra as defichainEvm,
  sa as defichainEvmTestnet,
  na as degen,
  la as dfk,
  oa as dodochainTestnet,
  ca as dogechain,
  ia as dreyerxMainnet,
  pa as edgeless,
  da as edgelessTestnet,
  ma as edgeware,
  ua as edgewareTestnet,
  Ea as ekta,
  Ca as ektaTestnet,
  ba as eon,
  ha as eos,
  ka as eosTestnet,
  xa as etherlinkTestnet,
  fa as evmos,
  ya as evmosTestnet,
  wa as fantom,
  va as fantomSonicTestnet,
  Ta as fantomTestnet,
  Ua as fibo,
  Sa as filecoin,
  ga as filecoinCalibration,
  Aa as filecoinHyperspace,
  Ba as flare,
  Fa as flareTestnet,
  za as flowMainnet,
  Ma as flowPreviewnet,
  Da as flowTestnet,
  Ia as foundry,
  _a as fraxtal,
  Ha as fraxtalTestnet,
  Pa as funkiSepolia,
  Oa as fuse,
  La as fuseSparknet,
  qa as gnosis,
  ...
  $a as harmonyOne,
  Ya as hedera,
  er as hederaPreviewnet,
  Ja as hederaTestnet,
  tr as holesky,
  ar as immutableZkEvm,
  rr as immutableZkEvmTestnet,
  sr as inEVM,
  Na as iotex,
  Ra as iotexTestnet,
  Ka as jbc,
  Ga as jbcTestnet,
  nr as kakarotSepolia,
  Va as karura,
  lr as kava,
  or as kavaTestnet,
  cr as kcc,
  ...
  ur as l3x,
  br as l3xTestnet,
  hr as lightlinkPegasus,
  kr as lightlinkPhoenix,
  xr as linea,
  fr as lineaGoerli,
  yr as lineaSepolia,
  Er as lineaTestnet,
  ...
  Sr as mandala,
  gr as manta,
  Ar as mantaSepoliaTestnet,
  Br as mantaTestnet,
  Fr as mantle,
  Mr as mantleSepoliaTestnet,
  zr as mantleTestnet,
  Dr as merlin,
  Ir as metachain,
  _r as metachainIstanbul,
  Hr as metalL2,
  Pr as meter,
  Or as meterTestnet,
  Lr as metis,
  ...
  as as oasys,
  ss as okc,
  ps as oortMainnetDev,
  cs as opBNB,
  is as opBNBTestnet,
  ns as optimism,
  ls as optimismGoerli,
  os as optimismSepolia,
  ds as otimDevnet,
  ms as palm,
  us as palmTestnet,
  hs as pgn,
  ...
  Cs as polygonMumbai,
  ws as polygonZkEvm,
  vs as polygonZkEvmCardona,
  Ts as polygonZkEvmTestnet,
  Us as pulsechain,
  Ss as pulsechainV4,
  gs as qMainnet,
  As as qTestnet,
  ...
  zs as ronin,
  Ds as rootstock,
  Is as rootstockTestnet,
  _s as rss3,
  Hs as rss3Sepolia,
  Ps as saigon,
  Os as sapphire,
  Ls as sapphireTestnet,
  Ns as scroll,
  Rs as scrollSepolia,
  Ks as scrollTestnet,
  Gs as seiDevnet,
  nl as sepolia,
  pn as shardeumSphinx,
  dn as shibarium,
  Vs as shimmer,
  Xs as shimmerTestnet,
  qs as skaleBlockBrawlers,
  js as skaleCalypso,
  Zs as skaleCalypsoTestnet,
  $s as skaleCryptoBlades,
  Ws as skaleCryptoColosseum,
  Qs as skaleEuropa,
  Ys as skaleEuropaTestnet,
  Js as skaleExorde,
  en as skaleHumanProtocol,
  tn as skaleNebula,
  an as skaleNebulaTestnet,
  rn as skaleRazor,
  sn as skaleTitan,
  nn as skaleTitanTestnet,
  ln as songbird,
  on as songbirdTestnet,
  cn as spicy,
  mn as stratis,
  un as syscoin,
  bn as syscoinTestnet,
  kn as taikoHekla,
  xn as taikoJolnir,
  fn as taikoKatla,
  yn as taikoTestnetSepolia,
  hn as taraxa,
  En as taraxaTestnet,
  Cn as telcoinTestnet,
  wn as telos,
  vn as telosTestnet,
  Tn as tenet,
  Un as thaiChain,
  Sn as thunderTestnet,
  gn as vechain,
  An as wanchain,
  Bn as wanchainTestnet,
  Fn as wemix,
  Mn as wemixTestnet,
  zn as x1Testnet,
  Dn as xLayer,
  ...
  _n as xdcTestnet,
  Hn as yooldoVerse,
  Pn as yooldoVerseTestnet,
  On as zetachain,
  Ln as zetachainAthensTestnet,
  Nn as zhejiang,
  Rn as zilliqa,
  Kn as zilliqaTestnet,
  Gn as zkFair,
  Vn as zkFairTestnet,
  Xn as zkSync,
  qn as zkSyncInMemoryNode,
  jn as zkSyncLocalNode,
  Zn as zkSyncSepoliaTestnet,
  $n as zkSyncTestnet,
  Wn as zora,
  Qn as zoraSepolia,
  Yn as zoraTestnet
