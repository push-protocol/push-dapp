...
let __tla = Promise.all([
  ...
  function x() {
    if (h) return l;
    h = 1, l = a, a.displayName = "qsharp", a.aliases = [
      "qs"
    ];
    function a(o) {
      (function(n) {
        function t(r, i) {
          return r.replace(/<<(\d+)>>/g, function(u, w) {
            return "(?:" + i[+w] + ")";
          });
        }
        function e(r, i, u) {
        ...
        function s(r, i) {
          for (var u = 0; u < i; u++) r = r.replace(/<<self>>/g, function() {
            return "(?:" + r + ")";
          });
        ...
        var c = RegExp(q(p.type + " " + p.other)), v = /\b[A-Za-z_]\w*\b/.source, g = t(/<<0>>(?:\s*\.\s*<<0>>)*/.source, [
          v
        ]), d = {
          keyword: c,
          punctuation: /[<>()?,.:[\]]/
        ...
        n.languages.qsharp = n.languages.extend("clike", {
          ...
          "class-name": [
            {
              pattern: e(/(\b(?:as|open)\s+)<<0>>(?=\s*(?:;|as\b))/.source, [
                g
              ]),
              lookbehind: true,
              inside: d
            ...
            {
              pattern: e(/(\bnamespace\s+)<<0>>(?=\s*\{)/.source, [
                g
              ]),
              lookbehind: true,
              inside: d
