...
`,d=x(M)`
  color: #e20880;
  font-weight: 500;
`,I=()=>e.jsx(f,{children:e.jsx(T,{})}),f=x(v)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
`});export{C as __tla,I as default};
