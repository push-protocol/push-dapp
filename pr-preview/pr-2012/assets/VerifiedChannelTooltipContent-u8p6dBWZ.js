import { ea as e, er as N, gh as _, eQ as U, fe as D, h0 as F, h1 as O, f_ as E, h2 as q, h3 as B, e7 as Z, eb as i, ep as h, gY as z, h4 as G, h5 as Q, h6 as W, eq as Y, ev as J, e5 as X, h7 as $, ga as e2, h8 as s2, gf as j, gX as V, gc as I, fR as t2, en as v, h9 as P, ha as n2, hb as r2, hc as o2, hd as a2, __tla as __tla_0 } from "./index-D1Swtpz3.js";
import { P as i2, __tla as __tla_1 } from "./PushLogo-DhyMjQJb.js";
let f2, L2, b2, S2, m2;
let __tla = Promise.all([
  ...
  b2 = ({ children: r, channelDetail: n, onSuccess: o, userSetting: l, profileModalVisibility: d, onChangeProfileModalVisibility: c }) => {
    const { account: x, chainId: u, provider: m, wallet: b } = X(), { handleConnectWalletAndEnableProfile: S } = $(), [s, a] = Z.useState(void 0), { userPushSDKInstance: t } = U((g) => g.user), f = n && (n == null ? void 0 : n.channel_settings) ? JSON.parse(n == null ? void 0 : n.channel_settings) : null, { mutate: H, isPending: A } = C2(), { mutate: K, isPending: R } = p2(), L = e2();
    Z.useEffect(() => {
