...
import { eG as U, fE as l, en as xe, ea as e, fX as Et, hi as Tt, eT as E, hj as N, ej as s, e5 as Te, e7 as i, ga as Me, ee as _e, fP as Se, eW as me, fT as x, fS as f, fb as ae, fW as je, eV as He, ec as pe, ed as de, f1 as Ge, hk as Pt, fh as st, gc as D, fD as S, fC as C, gR as ce, gb as jt, el as Fe, fO as Rt, fg as St, hl as ot, hm as Mt, ev as ie, hn as Ft, g0 as vt, fi as Oe, fj as We, eb as Ye, fG as Ct, fm as it, fn as at, eX as le, e_ as Be, ho as Ce, eS as At, eZ as ve, __tla as __tla_0 } from "./index-UiBHnyIz.js";
import { n as q, f as J, b as It, __tla as __tla_1 } from "./StakingHelper-D5FXu8oL.js";
import { C as Ut, __tla as __tla_2 } from "./ContentLayout-CSrgH2F5.js";
let Gn;
  ...
  const _fe = class _fe {
    constructor() {
      ...
      __publicField(this, "getPoolStats", () => new Promise(async (n, a) => {
        ...
        const R = ke(await this.state.pushToken.attach(l.uniV2LPToken).totalSupply()), W = (p * m + d * y) / R / m;
        n({
          currentEpoch: o,
          lpToPushRatio: W
        });
      ...
      __publicField(this, "getUserData", async (n) => new Promise(async (a, c) => {
        if (this.state.account) {
          ...
          let d = this.getAccumulatedReward(o, n), h = this.getTotalAvailableRewards(p, o, n), [y, R] = await Promise.all([
            d,
            h
          ]);
          a({
...
`, he = "data:image/svg+xml,%3csvg%20width='17'%20height='17'%20viewBox='0%200%2017%2017'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20clip-path='url(%23clip0_15284_45077)'%3e%3cpath%20d='M8.5%2014.5C11.8137%2014.5%2014.5%2011.8137%2014.5%208.5C14.5%205.18629%2011.8137%202.5%208.5%202.5C5.18629%202.5%202.5%205.18629%202.5%208.5C2.5%2011.8137%205.18629%2014.5%208.5%2014.5Z'%20stroke='%23797D8F'%20stroke-width='1.2'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M8%208C8.13261%208%208.25979%208.05268%208.35355%208.14645C8.44732%208.24021%208.5%208.36739%208.5%208.5V11C8.5%2011.1326%208.55268%2011.2598%208.64645%2011.3536C8.74021%2011.4473%208.86739%2011.5%209%2011.5'%20stroke='%23797D8F'%20stroke-width='1.2'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M8.25%206.5C8.66421%206.5%209%206.16421%209%205.75C9%205.33579%208.66421%205%208.25%205C7.83579%205%207.5%205.33579%207.5%205.75C7.5%206.16421%207.83579%206.5%208.25%206.5Z'%20fill='%23797D8F'/%3e%3c/g%3e%3cdefs%3e%3cclipPath%20id='clip0_15284_45077'%3e%3crect%20width='16'%20height='16'%20fill='white'%20transform='translate(0.5%200.5)'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e", ct = ({ poolName: t, userData: n, PoolStats: a, poolAddress: c, getUserData: o, tokenAddress: r, setActiveTab: m }) => {
    const { account: p, provider: d, isWalletConnected: h, connect: y } = Te(), [R, V] = i.useState(false), [W, L] = i.useState(false), [Y, $] = i.useState(false), [X, z] = i.useState(null), [K, se] = i.useState(null), [ee, P] = i.useState(null), [B, A] = i.useState(0), T = Me(), k = _e(), Z = async () => {
      if (!h) {
        y();
        return;
      }
      ...
      let u = await w.allowance(p, g), M = J(u);
      parseInt(M) >= parseInt(I) ? (v = 2, A(50)) : (v = 3, A(33)), $(true), z(`Withdrawing 1/${v}`);
      let G;
...
`;
  ...
  const qt = ({ setActiveTab: t }) => {
    const { account: n, provider: a } = Te(), [c, o] = i.useState(null), [r, m] = i.useState(null), [p, d] = i.useState(null), [h, y] = i.useState(null), [R, V] = i.useState(null), [W, L] = i.useState(null), [Y, $] = i.useState(null), [X, z] = i.useState(null), [K, se] = i.useState(null), [ee, P] = i.useState(null), B = a == null ? void 0 : a.getSigner(n), A = i.useCallback(async () => {
    ...
    i.useEffect(() => {
      ...
      if (o(F), m(te), y(j), d(v), V(I), B && n) {
        var b = a.getSigner(n);
        let _ = new S(l.pushToken, C.pushToken, b), g = new S(l.staking, C.staking, b), w = new S(l.depYieldFarmPUSH, C.yieldFarming, b), u = new S(l.depYieldFarmLP, C.yieldFarming, b), M = new S(l.uniswapV2Router02, C.uniswapV2Router02, b);
        o(_), m(g), y(w), d(u), V(M);
      }
    }, [
      n
    ]), i.useEffect(() => {
      c != null && r != null && h != null && (fe.getInstance().init(n, c, r, h, p, R), A());
    }, [
      A
    ]), i.useEffect(() => {
      W && ge(W);
...
`, sn = ({ getLpPoolStats: t, poolStats: n, setPoolStats: a }) => {
    ...
    const d = () => {
      if (n == null ? void 0 : n.epochEndTimestamp) {
        ...
        y < 0 && (a(null), t());
        const R = Math.floor(y / (1e3 * 60 * 60 * 24)), V = Math.floor(y % (1e3 * 60 * 60 * 24) / (1e3 * 60 * 60)), W = Math.floor(y % (1e3 * 60 * 60) / (1e3 * 60)), L = Math.floor(y % (1e3 * 60) / 1e3);
        o(`${R}D ${V}H ${W}M ${L}S`);
      }
    };
    return Fe.useEffect(() => {
...
`, yt = ({ onClose: t, InnerComponentProps: n, toastObject: a }) => {
    const { title: c, getUserData: o, getPoolStats: r, setUnstakeErrorMessage: m, setWithdrawErrorMessage: p } = n, { account: d, provider: h, isWalletConnected: y, connect: R } = Te(), [V, W] = i.useState(0), [L, Y] = i.useState(0), [$, X] = i.useState(false), [z, K] = i.useState(false), [se, ee] = i.useState(false), [P, B] = i.useState(null), { handleConnectWalletAndEnableProfile: A } = i.useContext(Rt), [T, k] = i.useState(0), Z = () => {
      m(null), p(null), t();
    ...
    const F = async () => {
      ...
      let M = It(await u.balanceOf(d));
      W(parseInt(M.toString().replace(/\D/, "")) || 0);
    }, te = async () => {
      K(true);
      var g = h.getSigner(d);
      let w;
    ...
    const j = async () => {
      ...
      c === "Uni-V2" ? w = new S(l.uniV2LPToken, C.uniV2LpToken, g).approve(l.stakingV2, u) : w = new S(l.pushToken, C.uniV2LpToken, g).approve(l.pushCoreV2, u), w.then(async (M) => {
        a.showLoaderToast({
          loaderMessage: "Waiting for Confirmation..."
        });
        try {
          await h.waitForTransaction(M.hash), a.showMessageToast({
            toastTitle: "Success",
        ...
        console.error("Error", M), a.showMessageToast({
          toastTitle: "Error",
          toastMessage: "User denied message signature",
          toastType: "ERROR",
      ...
      c === "Uni-V2" ? w = new S(l.stakingV2, C.stakingV2, g).deposit(l.uniV2LPToken, U.from(T).mul(U.from(10).pow(18))) : w = new S(l.pushCoreV2, C.pushCoreV2, g).stake(U.from(T).mul(U.from(10).pow(18))), w.then(async (u) => {
        ...
        try {
          ...
          console.error("Error", M), a.showMessageToast({
            toastTitle: "Error",
            toastMessage: `Transaction Failed! (" +${M.name}+ ")`,
            toastType: "ERROR",
            getToastIcon: (G) => e.jsx(D, {
              size: G,
              color: "red"
      ...
      g.preventDefault(), k(parseInt(g.target.value.replace(/\D/, "")) || 0), L >= parseInt(g.target.value.replace(/\D/, "")) ? X(true) : X(false);
    }, b = (g) => {
...
`, dn = ({ lpPoolStats: t, userDataLP: n, getLpPoolStats: a, getUserDataLP: c }) => {
    const { account: o, provider: r } = Te(), [m, p] = i.useState(false), [d, h] = i.useState(false), [y, R] = i.useState(null), [V, W] = i.useState(null), L = Me(), Y = _e(), $ = async () => {
      if (m) return;
      p(true);
      ...
      await T.balanceOf(o, l.uniV2LPToken), T.withdraw(l.uniV2LPToken, U.from(B).mul(U.from(10).pow(18))).then(async (Z) => {
        L.showLoaderToast({
          loaderMessage: "Waiting for Confirmation..."
        });
        try {
          await r.waitForTransaction(Z.hash), L.showMessageToast({
            toastTitle: "Success",
            toastMessage: "Transaction Completed!",
            toastType: "SUCCESS",
      ...
      new S(l.yieldFarmLP, C.yieldFarming, B).massHarvest().then(async (k) => {
        ...
        try {
          ...
          L.showMessageToast({
            toastTitle: "Error",
            toastMessage: `Transaction Failed! (" +${Z.name}+ ")`,
            toastType: "ERROR",
            getToastIcon: (H) => e.jsx(D, {
              size: H,
              color: "red"
    ...
    }, { showModal: K, ModalComponent: se } = Oe(), ee = Me(), P = Se(600);
    return e.jsxs(xn, {
      children: [
        e.jsx(se, {
          InnerComponent: yt,
...
`, fn = (t) => i.createElement("svg", {
    ...
    const { currentTransactionNo: a, totalTransactionNo: c, transactionSteps: o, transactionText: r, setCurrentTransactionNo: m, setTotalTransactionNo: p, setTransactionSteps: d, claimRewards: h, unstakeTokensPaginated: y } = n, R = () => {
      d(0), t();
    }, V = async () => {
...
`, Sn = ({ userDataPush: t, getUserDataPush: n, PUSHPoolstats: a, getPUSHPoolStats: c }) => {
    const { account: o, provider: r } = Te(), [m, p] = i.useState(false), [d, h] = i.useState(false), [y, R] = i.useState(null), [V, W] = i.useState(null), [L, Y] = i.useState(0), [$, X] = i.useState(0), [z, K] = i.useState(0), [se, ee] = i.useState(""), P = Me(), B = _e(), A = async (b) => {
      var _ = r.getSigner(o);
      ...
      let O = 0;
      w - G < u, O = Math.ceil((w - G) / u), X(O), O != 0 && (await Z(O, G, g, u), n(), K(2), Y(0));
    }, Z = async (b, _, g, w) => {
      ...
      if (p(true), J(t == null ? void 0 : t.userStaked) == 0) {
        R("Nothing to unstake, You need to stake first"), p(false);
        return;
      }
      var _ = r.getSigner(o);
      let g = new S(l.pushCoreV2, C.pushCoreV2, _);
      const w = await A(g);
      if (h(false), !w) return;
      const u = a == null ? void 0 : a.currentEpochNumber, M = 14;
      let G = 0;
      if (G = await T(g), G >= u - 1) {
        p(false), R("PUSH cannot be unstaked until current epoch is over."), P.showMessageToast({
      ...
      v();
      const O = Math.ceil((u - G) / M);
      X(O), O > 1 && await Z(O - 1, G, g, M), ee("Unstaking Your Push Tokens. Please wait..."), g.unstake().then(async (re) => {
        P.showLoaderToast({
        ...
        if (ne || oe) R("PUSH cannot be unstaked until current epoch is over.");
        else {
    ...
    const { showModal: ge, ModalComponent: F } = Oe(), te = Me(), j = Se(600), { showModal: v, ModalComponent: I } = Oe();
    return e.jsxs(yn, {
      children: [
        e.jsx(F, {
          InnerComponent: yt,
...
`, Re = s(je)`
  ...
  gap: 5px;
`, An = ({ setActiveTab: t }) => {
    const { provider: n, account: a, chainId: c } = Te(), [o, r] = i.useState(), [m, p] = i.useState(), [d, h] = i.useState(), [y, R] = i.useState(), [V, W] = i.useState(), [L, Y] = i.useState(null), [$, X] = i.useState(null), [z, K] = i.useState(null), [se, ee] = i.useState(null), [P, B] = i.useState(null), A = n == null ? void 0 : n.getSigner(a), T = i.useCallback(async () => {
    ...
    return i.useEffect(() => {
      ...
      if (p(F), r(te), R(j), h(v), W(I), A && a) {
        var b = n == null ? void 0 : n.getSigner(a);
        let _ = new S(l.stakingV2, C.stakingV2, b), g = new S(l.pushToken, C.pushToken, b), w = new S(l.pushCoreV2, C.pushCoreV2, b), u = new S(l.yieldFarmLP, C.yieldFarming, b), M = new S(l.uniswapV2Router02, C.uniswapV2Router02, b);
        p(_), r(g), R(w), h(u), W(M);
      }
