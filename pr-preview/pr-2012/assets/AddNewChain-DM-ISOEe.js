import { f_ as E, he as B, hf as L, en as k, ea as e, gQ as Y, eb as s, eP as S, gr as P, gs as G, ev as I, e5 as N, e7 as v, ep as g, eQ as V, gC as F, ga as _, e6 as R, e9 as j, gc as K, gR as H, gU as Q, eq as W, gf as z, gV as J, __tla as __tla_0 } from "./index-C2jH2XEK.js";
import { S as X, __tla as __tla_1 } from "./Stepper-n0dM99Ny.js";
import { u as Z, F as ee, c as ae, b as se, a as M, __tla as __tla_2 } from "./index.esm-BAVu81oq.js";
import { i as ne, __tla as __tla_3 } from "./ValidationHelper-fik1mGJg.js";
import { U as ie, a as te, __tla as __tla_4 } from "./UnlockProfileWrapper-DJ8_s0pY.js";
import { C as re, __tla as __tla_5 } from "./ContentLayout-CMvbJl9T.js";
let ke;
let __tla = Promise.all([
  ...
  let oe, le, ce, de, he, ue, ge, U, pe, xe, D, me, fe, Ce, we;
  oe = (a) => a;
  le = (a) => a;
  ...
  U = k.allowedNetworks.filter((a) => a != k.coreContractChain);
  pe = ae().shape({
  ...
  me = ({ isLoading: a, channelDetails: i }) => {
    const n = Y(U), { values: t, handleSubmit: d, handleChange: h, errors: c, touched: u } = D(), p = i == null ? void 0 : i.aliases.find((r) => r.alias_blockchain_id === t.chainId && r.is_alias_verified), C = () => !(!p && t.alias);
    return e.jsxs(s, {
      width: "100%",
      display: "flex",
  ...
  we = () => {
    const [a, i] = v.useState("newaddress"), [n, t] = v.useState([
      "newaddress"
    ]), [d, h] = v.useState(true), c = _(), { mutate: u, isPending: p, isError: C } = he(), { userPushSDKInstance: r } = V((l) => l.user), { account: x, chainId: w, switchChain: m } = N(), { data: f } = F(x), { data: A } = Q({
      alias: x,
      aliasChain: J[w]
    }), y = R();
    v.useEffect(() => {
