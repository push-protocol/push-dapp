import { eH as T, __tla as __tla_0 } from "./index-UiBHnyIz.js";
let L;
let __tla = Promise.all([
  ...
  function R(s, c) {
    for (var r = 0; r < c.length; r++) {
      ...
      if (typeof t != "string" && !Array.isArray(t)) {
        for (const e in t) if (e !== "default" && !(e in s)) {
          const a = Object.getOwnPropertyDescriptor(t, e);
          a && Object.defineProperty(s, e, a.get ? a : {
            enumerable: true,
            get: () => t[e]
          });
        }
  ...
  function x() {
    ...
    function s(c) {
      (function(r) {
        var t = /(?:"(?:""|[^"])*"(?!")|'(?:''|[^'])*'(?!'))/.source, e = /\b(?:\d[\da-f]*x|\d+(?:\.\d+)?(?:e[+-]?\d+)?)\b/i, a = {
          pattern: RegExp(t + "[bx]"),
          alias: "number"
        }, m = {
          pattern: /&[a-z_]\w*/i
