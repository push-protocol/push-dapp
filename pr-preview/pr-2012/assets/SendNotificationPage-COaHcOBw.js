import { f_ as W, gM as Y, gw as $, ea as s, eb as o, ep as x, gx as z, gN as Q, gO as H, en as N, gf as J, gP as X, e7 as w, e5 as V, ga as Z, eQ as S, gQ as ee, gc as se, gR as ae, gs as j, gS as R, eq as b, gr as v, g7 as te, gt as ne, g1 as ie, ev as re, gT as oe, gU as le, gC as ce, e6 as de, gV as ue, __tla as __tla_0 } from "./index-UiBHnyIz.js";
import { c as pe, a as c, u as he, __tla as __tla_1 } from "./index.esm-BhnmBROZ.js";
import { g as ge, a as d, b as E } from "./Common.form-NbJ1DVkQ.js";
import { U as xe, a as me, __tla as __tla_2 } from "./UnlockProfileWrapper-D0r3iC3q.js";
import { C as fe, __tla as __tla_3 } from "./ContentLayout-CSrgH2F5.js";
let De;
let __tla = Promise.all([
  ...
  let Ce, be, ye, ve, ke, je, Se, Te, Ie, Ae, Re, we, Me, Le;
  Ce = (n) => n;
  ...
  ke = (n, a) => {
    var _a, _b;
    return [
      ...((_b = (_a = n == null ? void 0 : n.aliases) == null ? void 0 : _a.filter((i) => i.is_alias_verified && H(i.alias_address) === a)) == null ? void 0 : _b.map((i) => parseInt(i.alias_blockchain_id))) || [],
      N.coreContractChain
    ];
  };
  je = (n, a) => {
  ...
  Ie = (n, a, r) => {
    var _a;
    return r ? J(n.channel, parseInt(a)) : ((_a = n.aliases.find((l) => l.alias_blockchain_id === a)) == null ? void 0 : _a.alias_address) || n.channel;
  };
  Ae = [
    {
      label: "Broadcast",
  ...
  Me = ({ channelDetails: n }) => {
    const [a, r] = w.useState([]), { chainId: i, switchChain: l, account: m } = V(), { mutate: u, isPending: f } = ye(), C = Z(), { userPushSDKInstance: p } = S((t) => t.user), { delegatees: M } = S((t) => t.admin), B = oe === i, T = je(M, n), y = (M == null ? void 0 : M.find((t) => {
      var _a;
      return t.channel === ((_a = T[0]) == null ? void 0 : _a.value);
    })) || n, L = ee(ke(y, m)), e = he({
      initialValues: we(T, L),
