import { e7 as l, i1 as vn, iS as Tn, ic as Q, i3 as ke, el as B, ea as t, iT as De, iU as vt, ee as J, fS as _, ec as pt, ed as ht, ej as s, eQ as P, ei as K, eV as ge, g9 as xt, eF as Xt, ij as An, ga as xe, e5 as fe, eb as Sn, ev as ie, ep as Mn, fc as Re, fD as En, fC as In, eW as ue, en as le, eX as N, f0 as kn, iV as Dn, iW as Ie, iX as Rn, eg as Ve, eq as Ue, ef as Le, hn as lt, fg as me, e_ as v, gX as ye, gc as X, fm as Jt, fn as ut, eT as ee, iY as gt, fi as Te, fb as ze, fj as Ae, g3 as Ln, fP as Ce, g8 as qt, iZ as Zt, fE as He, i_ as $n, hj as Nn, i$ as Pn, g0 as Qt, iH as en, j0 as Bn, fr as Fn, ek as tn, gl as nn, hO as On, fO as on, e6 as Un, j1 as zn, j2 as Vn, j3 as Hn, j4 as et, gf as tt, j5 as _n, e9 as Gn, j6 as sn, j7 as Wn, hx as Kn, j8 as Yn, j9 as Xn, fA as Jn, ja as qn, iK as Zn, jb as Qn, jc as ei, jd as ti, je as ni, jf as nt, jg as ii, eZ as be, eS as oi, jh as si, f1 as ai, __tla as __tla_0 } from "./index-AGa8OPve.js";
import { f as Tt, c as ri, a as oe, g as Ge, u as We, b as li, s as $e, d as ft, e as At, h as ci, i as Be, j as mt, k as Se, l as St, __tla as __tla_1 } from "./DefaultPropsProvider-Dyd1_dbz.js";
import { T as Mt, E as di, __tla as __tla_2 } from "./EPNSCoreHelper-Babxb-TT.js";
import { b as pi, g as an, m as rn, c as ln, __tla as __tla_3 } from "./StakingVariant-C__XZ4lS.js";
import { E as hi, M as xi, A as ui, __tla as __tla_4 } from "./EmptyNotificationSettings-D8AcCqA8.js";
import { a as cn, b as Et, __tla as __tla_5 } from "./ValidationHelper-BpbvX9K7.js";
import { I as gi, __tla as __tla_6 } from "./ImageClipper-CZzBVJiP.js";
import { v as fi, C as mi, __tla as __tla_7 } from "./CreateChannel-XyZpjU5t.js";
import { __tla as __tla_8 } from "./index.esm-B6nwok6Y.js";
import { __tla as __tla_9 } from "./useGetPaymentDetails-Bvhdr89l.js";
import { __tla as __tla_10 } from "./Stepper-B_xIUEnx.js";
import { __tla as __tla_11 } from "./ImportPushTokenMessage-CR0dBMpD.js";
import { __tla as __tla_12 } from "./useGetChannelCategories-CMCkL1sF.js";
import { __tla as __tla_13 } from "./index.esm-DSACWjwa.js";
...
`), se.rippleVisible, Li, ct, ({ theme: e }) => e.transitions.easing.easeInOut, se.ripplePulsate, ({ theme: e }) => e.transitions.duration.shorter, se.child, se.childLeaving, $i, ct, ({ theme: e }) => e.transitions.easing.easeInOut, se.childPulsate, Ni, ({ theme: e }) => e.transitions.easing.easeInOut), Fi = l.forwardRef(function(i, n) {
  ...
  const Ui = Ge("MuiButtonBase", [
    ...
    }), Ye = U("start", Y), Xe = U("stop", q), Je = U("stop", k), Ne = U("stop", (y) => {
...
`, ao = () => {
    var _a, _b;
    const e = J(), { aliasDetails: { aliasChainId: i } } = P((n) => n.admin);
    return t.jsxs(K, {
    ...
    var _a;
    xe();
    const e = J(), { switchChain: i } = fe(), { aliasDetails: { aliasChainId: n } } = P((o) => o.admin);
    return t.jsxs(K, {
      margin: "15px 20px 15px 20px",
      flex: "1",
      display: "flex",
...
`, co = ({ aliasEthAccount: e, setAliasVerified: i }) => {
    var _a, _b;
    const n = J(), { account: o, provider: a, chainId: r } = fe(), d = a.getSigner(o), h = Re(), c = new En(xt[r].commAddress, In.epnsComm, d), [p, g] = l.useState(""), [C, x] = l.useState(false), m = e, u = {
      80002: {
        label: "Amoy MATIC",
...
`, Eo = (e) => l.createElement("svg", {
    ...
    const o = J(), a = Re(), { channelDetails: r } = P((x) => x.admin), { CHANNNEL_DEACTIVATED_STATE: d } = P((x) => x.channels), [h, c] = B.useState(false), p = () => !h && i(), g = B.useRef(null);
    me(g, () => p());
    const C = () => {
...
`, _o = (e) => l.createElement("svg", {
    ...
    const o = J(), { chainId: a, account: r, provider: d } = fe(), h = Re(), { channelDetails: c, canVerify: p, aliasDetails: { isAliasVerified: g, aliasAddrFromContract: C } } = P((f) => f.admin), { CHANNEL_ACTIVE_STATE: x, CHANNNEL_DEACTIVATED_STATE: m } = P((f) => f.channels), [u, T] = l.useState("");
...
`, xs = 50, us = le.coreContractChain;
  function gs({ DropdownRef: e, isDropdownOpen: i, closeDropdown: n }) {
    Re();
    const { account: o, chainId: a } = fe(), { epnsWriteProvider: r, epnsCommWriteProvider: d } = P((z) => z.contracts), { channelDetails: h } = P((z) => z.admin), { CHANNNEL_DEACTIVATED_STATE: c, CHANNEL_BLOCKED_STATE: p } = P((z) => z.channels), { userPushSDKInstance: g } = P((z) => z.user), C = J(), { channelState: x } = h, m = us === a, u = Ce(425), { isModalOpen: T, showModal: F, ModalComponent: L } = Te(), { isModalOpen: V, showModal: D, ModalComponent: b } = Te(), { isModalOpen: M, showModal: E, ModalComponent: H } = Te(), G = i && !T && !V && !M;
    me(e, () => G && n());
...
`, ia = ({ channelName: e, setChannelName: i, channelInfo: n, setChannelInfo: o, channelURL: a, setChannelURL: r, editChannel: d, errorInfo: h, setErrorInfo: c }) => {
    const p = J(), g = ({ message: x }) => t.jsxs(K, {
      display: "flex",
      align: "center",
      self: "flex-start",
      direction: "row",
...
`, ve = (e) => e.trim().length == 0;
  ...
  const Ca = (e) => {
    var i = fi, n = e.split(";base64,").pop(), o = Jn.from(n, "base64"), a = i(o);
  ...
  function ba({ closeEditChannel: e, UploadLogoComponent: i, displayUplaodLogoModal: n }) {
    ...
    const I = () => (R(""), ve(C) || ve(m) || ve(T) ? (ve(C) && R((S) => ({
      ...
      try {
        ...
        const Ye = "1+" + ne, Xe = en(Ye), Je = Qt(j.toString(), 18);
        Z.showLoaderToast({
          loaderMessage: "Waiting for Confirmation..."
        });
        const Ne = await p.updateChannelMeta(o, Xe, Je, {
          gasLimit: 1e6
        });
