...
let __tla = Promise.all([
  ...
  function m(a, o) {
    for (var r = 0; r < o.length; r++) {
      ...
      if (typeof n != "string" && !Array.isArray(n)) {
        for (const t in n) if (t !== "default" && !(t in a)) {
  ...
  function $() {
    if (u) return l;
    u = 1, l = a, a.displayName = "asciidoc", a.aliases = [
      "adoc"
    ];
    function a(o) {
      (function(r) {
