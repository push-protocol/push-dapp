import { ea as s, er as Q, eA as H, eb as t, ep as a, g1 as k, eq as U, e7 as u, gw as X, e6 as s1, eQ as e1, fY as T, fD as Z, gW as o1, fE as L, g0 as t1, gB as O, e5 as n1, gX as r1, gY as a1, gL as i1, gr as l1, en as c1, eP as p1, ev as d1, gZ as P, gf as x1, g_ as f1, gK as C1, g$ as u1, go as h1, __tla as __tla_0 } from "./index-UiBHnyIz.js";
import { p as G, f as N, __tla as __tla_1 } from "./index-74ddwHaO.js";
import { T as W, __tla as __tla_2 } from "./Tick-BlgUNvcN.js";
import { u as g1, c as j1, a as m1, __tla as __tla_3 } from "./index.esm-BhnmBROZ.js";
import { u as V, __tla as __tla_4 } from "./useDisclosure-DhG6xuj0.js";
import { a as y1 } from "./Common.form-NbJ1DVkQ.js";
import { u as D1, __tla as __tla_5 } from "./useGetPaymentDetails-uYbJwT71.js";
import { C as E1, __tla as __tla_6 } from "./ContentLayout-CSrgH2F5.js";
let z1;
let __tla = Promise.all([
  ...
  let w1, A1, _1, b1, v1, S1, B1, P1, L1, U1, F1, I1, M1, V1;
  w1 = (e) => {
    const { svgProps: n, ...o } = e;
    return s.jsx(Q, {
      ...
      children: [
        ...
        s.jsxs(t, {
          ...
          children: [
            s.jsx(a, {
              variant: "h2-semibold",
              children: e == null ? void 0 : e.value.toLocaleString("en-US", {
                style: "currency",
                currency: "USD"
              })
            }),
            (e == null ? void 0 : e.value) > 0 && s.jsx(a, {
              color: "text-tertiary",
              variant: "bs-semibold",
        ...
        s.jsx(t, {
          ...
          children: (_a = G(e == null ? void 0 : e.description)) == null ? void 0 : _a.map((n, o) => s.jsxs(t, {
            flexDirection: "row",
            display: "flex",
            gap: "spacing-xxs",
            children: [
          ...
          }, `${o}-plan-benefits-item-keys`))
        })
      ]
    });
  };
  v1 = ({ plan: e, modalControl: n, paymentId: o, account: r }) => {
    var _a;
    const [i, c] = u.useState(false), { mode: f } = X(), { isOpen: h, onClose: g } = n, D = s1(), { userPushSDKInstance: E } = e1((p) => p.user), B = async () => {
      c(true);
      try {
        return await E.channel.info(r) || null;
      } catch (p) {
        return console.error("Error fetching channel details:", p), null;
      }
    }, j = async () => {
      const p = await B();
      c(false), D(p ? `/channel/${r}?paymentId=${o}` : `/channel/create?paymentId=${o}`);
    };
    return s.jsx(T, {
      size: "medium",
      isOpen: h,
          ...
          s.jsxs(t, {
            ...
            children: [
              ...
              s.jsx(t, {
                ...
                flexDirection: "column",
                gap: "spacing-sm",
                children: (_a = G(e == null ? void 0 : e.description)) == null ? void 0 : _a.map((p, w) => s.jsxs(t, {
                  flexDirection: "row",
                  display: "flex",
                  gap: "spacing-xxs",
                  children: [
  ...
  S1 = "0x0000000000000000000000000000000000000001";
  B1 = [
  ...
  L1 = async (e, n, o, r, i) => {
    if (i || r(), e !== S1) try {
      const f = await new Z(n, B1, o).balanceOf(e);
      return o1(f, 6);
    } catch (c) {
  ...
  U1 = async (e, n, o) => {
    var _a;
    try {
      const r = o.getSigner(), i = (_a = L) == null ? void 0 : _a.usdcTokenAddress, c = new Z(i, P1, r), f = t1(e.toString(), 6), h = await c.transfer(n, f);
      console.log("Transaction sent:", h.hash);
      const g = await h.wait();
      return console.log("Transaction confirmed:", g), g;
    } catch (r) {
      throw console.error("Error sending USDC:", r), r;
    }
  };
  F1 = async (e, n, o) => await o.getSigner(n).signMessage(e);
  I1 = ({ modalControl: e, plan: n, selectedPlanType: o }) => {
    const { isOpen: r, onClose: i } = e;
    return s.jsx(T, {
      size: "small",
      isOpen: r,
      onClose: i,
            ...
            children: [
              s.jsxs(a, {
                ...
                children: [
                  ...
                  o === "12" ? (n == null ? void 0 : n.value) * 12 : n == null ? void 0 : n.value,
                  " USDC"
                ]
              }),
              s.jsx(a, {
  ...
  M1 = ({ selectedPlan: e }) => {
    ...
    ], o = V(), r = V(), { account: i, isWalletConnected: c, connect: f, chainId: h } = n1(), g = x1(i, h), [D] = r1(), E = D.get("type"), B = (l) => l === "yearly" || l === "monthly", [j, p] = u.useState(B(E) ? E : "monthly"), [w, m] = u.useState(false), [A, z] = u.useState(null), [F, y] = u.useState(null), [_, b] = u.useState(null), I = (e == null ? void 0 : e.value) ? (e == null ? void 0 : e.value) * (j === "yearly" ? 12 * 0.85 : 1) : 0, { mutate: $ } = a1(), { data: v, refetch: R } = D1({
      paymentId: _
    });
    u.useEffect(() => {
      b(null), y(null), (async () => {
        var _a2;
        if (window.ethereum && i) {
          const x = new P(window.ethereum), d = await L1(i, (_a2 = L) == null ? void 0 : _a2.usdcTokenAddress, x, f, c);
          z(d);
        }
      })();
    }, [
      ...
      if (!_) return;
      const l = setInterval(() => {
        R(), console.log("retry fetching details");
      }, 5e3), x = setTimeout(() => {
        clearInterval(l), console.log("Stopped polling after 1 minute"), m(false);
      }, 6e4);
      return ((v == null ? void 0 : v.payment_status) === "SUCCESS" || (v == null ? void 0 : v.payment_status) === "FAILED") && (clearInterval(l), clearTimeout(x), (v == null ? void 0 : v.payment_status) === "SUCCESS" && (o.onClose(), r.open(), m(false))), () => {
        clearInterval(l), clearTimeout(x);
      };
    }, [
      _,
      v == null ? void 0 : v.payment_status
    ]);
    const q = () => {
      window.open("https://faucet.circle.com/", "_blank");
    }, Y = async () => {
      var _a2;
      c || await f(), m(true), o.open();
      const l = j === "yearly" ? (e == null ? void 0 : e.value) * 12 * 0.85 : e == null ? void 0 : e.value, x = new P(window.ethereum);
      try {
        const d = await K();
        if (!(d == null ? void 0 : d.success)) {
          console.error("Purchase failed:", d == null ? void 0 : d.error), y("Something went wrong while processing the purchase"), b(null), m(false), o.onClose();
          return;
        }
        await x.send("eth_requestAccounts", []), await U1(l, (_a2 = L) == null ? void 0 : _a2.usdcRecipient, x);
      } catch (d) {
        b(null), console.error("Transaction failed:", d), (d == null ? void 0 : d.message.includes("User denied transaction")) ? (console.log("User rejected the transaction"), y("Something went wrong while processing the payment")) : (d == null ? void 0 : d.message.includes("transfer amount exceeds balance")) ? (console.log("Insufficient balance"), y("Insufficient balance")) : (console.log("Something went wrong while processing the payment"), y("Something went wrong while processing the payment")), m(false), o.onClose();
      }
    }, K = async () => {
      var _a2;
      try {
        const l = {
          body: {
            channel: g,
            pricingPlanId: (_a2 = e == null ? void 0 : e.id) == null ? void 0 : _a2.toString()
          }
        }, x = f1(JSON.stringify({
          channel: l.body.channel,
          content: l.body.pricingPlanId
        })), d = new P(window.ethereum), J = await F1(x, i, d);
        return new Promise((M) => {
          var _a3;
          $({
            channel: g,
            pricingPlanId: (_a3 = e == null ? void 0 : e.id) == null ? void 0 : _a3.toString(),
            currency: "USDC",
            network: h,
            verificationProof: J,
            email: C.values.email,
            duration: j === "yearly" ? "12" : "1"
          }, {
            onSuccess: (S) => {
              b(S == null ? void 0 : S.paymentId), M({
                success: true,
                data: S
              });
            },
      ...
      validationSchema: j1({
        email: m1().email("Invalid email address").required(y1("Email"))
      }),
      onSubmit: Y
    });
    return s.jsxs(t, {
      ...
      children: [
        o.isOpen && s.jsx(I1, {
          modalControl: o,
          plan: e,
          selectedPlanType: j === "yearly" ? "12" : "1"
        }),
        r.isOpen && s.jsx(v1, {
          modalControl: r,
          plan: e,
          ...
          children: s.jsxs(t, {
            ...
            children: [
              ...
              s.jsx(l1, {
                ...
                onChange: C.handleChange("email"),
                error: C.touched.email && !!C.errors.email,
                errorMessage: C.touched.email ? C.errors.email : ""
              }),
              s.jsxs(t, {
                display: "flex",
                flexDirection: "column",
                ...
                children: [
                  ...
                  A && parseInt(A) < I && ((_a = c1) == null ? void 0 : _a.appEnv) != "prod" && s.jsx(k, {
                    style: {
                      alignSelf: "center"
                    },
                    to: "#",
  ...
  V1 = ({ index: e }) => {
    const { data: n, isLoading: o } = C1(), r = n == null ? void 0 : n.find((i) => (i == null ? void 0 : i.id) == u1.toNumber(e));
    return o ? s.jsx(t, {
      display: "flex",
