  ...
  function d(r, p) {
    for (var e = 0; e < p.length; e++) {
      ...
      if (typeof a != "string" && !Array.isArray(a)) {
        for (const n in a) if (n !== "default" && !(n in r)) {
          const t = Object.getOwnPropertyDescriptor(a, n);
          t && Object.defineProperty(r, n, t.get ? t : {
            enumerable: true,
            get: () => a[n]
          });
        }
    ...
    function r(p) {
      (function(e) {
        ...
        a.forEach(function(t) {
          var i = t;
          if (typeof t != "string" && (i = t.alias, t = t.lang), e.languages[i]) {
            var o = {};
            o["inline-lang-" + i] = {
              pattern: RegExp(n.replace("<lang>", t.replace(/([.+*?\/\\(){}\[\]])/g, "\\$1")), "i"),
              inside: e.util.clone(e.languages.pure["inline-lang"].inside)
            }, o["inline-lang-" + i].inside.rest = e.util.clone(e.languages[i]), e.languages.insertBefore("pure", "inline-lang", o);
          }
