...
import { eK as Q, __tla as __tla_0 } from "./index-Kvkq3-iW.js";
let i, We;
let __tla = Promise.all([
  ...
  function se(s) {
    ...
    var n = null, p = 0, r = p, e = false, h = p, P = p, m = false, y = p;
  ...
  function te(s) {
    ...
    var n = u.rootData, p = n === void 0 ? s : n, r = null, e = 0, h = e, P = false, m = e, y = e, o = false, t = e;
    ...
    if (P) e = h, r !== null && (h ? r.length = h : r = null);
    else {
      var S = {
        instancePath: a,
        schemaPath: "#/anyOf",
  ...
  function l(s) {
    ...
    if (e === 0) if (s && Q(s) == "object" && !Array.isArray(s)) {
      var h;
      if (s.chainId === void 0 && (h = "chainId") || s.address === void 0 && (h = "address") || s.decimals === void 0 && (h = "decimals") || s.name === void 0 && (h = "name") || s.symbol === void 0 && (h = "symbol")) return l.errors = [
        {
          instancePath: a,
          schemaPath: "#/required",
          keyword: "required",
      ...
      var P = e;
      for (var m in s) if (!(m === "chainId" || m === "address" || m === "decimals" || m === "name" || m === "symbol" || m === "logoURI" || m === "tags" || m === "extensions")) return l.errors = [
        {
          instancePath: a,
      ...
      if (P === e) {
        if (s.chainId !== void 0) {
          var y = s.chainId, o = e;
          if (!(typeof y == "number" && !(y % 1) && !isNaN(y) && isFinite(y))) return l.errors = [
            {
          ...
          if (e === o && typeof y == "number" && isFinite(y) && (y < 1 || isNaN(y))) return l.errors = [
            {
              instancePath: a + "/chainId",
        ...
        if (t) {
          ...
          if (t) {
            if (s.decimals !== void 0) {
              ...
              if (e === g && typeof f == "number" && isFinite(f)) {
                if (f > 255 || isNaN(f)) return l.errors = [
                  {
                    instancePath: a + "/decimals",
                ...
                if (f < 0 || isNaN(f)) return l.errors = [
                  {
                    instancePath: a + "/decimals",
            ...
            if (t) {
              if (s.name !== void 0) {
                ...
                if (w) e = F, r !== null && (F ? r.length = F : r = null);
                  ...
                  return r === null ? r = [
                    D
                  ] : r.push(D), e++, l.errors = r, false;
                }
                if (e === k) if (typeof I == "string") {
                  if (v(I) > 40) return l.errors = [
                    {
                      instancePath: a + "/name",
              ...
              if (t) {
                if (s.symbol !== void 0) {
                  ...
                  if (E) e = z, r !== null && (z ? r.length = z : r = null);
                    ...
                    return r === null ? r = [
                      j
                    ] : r.push(j), e++, l.errors = r, false;
                  }
                  if (e === A) if (typeof c == "string") {
                    if (v(c) > 20) return l.errors = [
                      {
                        instancePath: a + "/symbol",
                  ...
                  if (t) {
                    if (s.tags !== void 0) {
                      ...
                      if (e === S) if (Array.isArray(R)) {
                        if (R.length > 10) return l.errors = [
                          {
                            instancePath: a + "/tags",
  ...
  i = function(s) {
    ...
    if (e === 0) if (s && Q(s) == "object" && !Array.isArray(s)) {
      var h;
      if (s.name === void 0 && (h = "name") || s.timestamp === void 0 && (h = "timestamp") || s.version === void 0 && (h = "version") || s.tokens === void 0 && (h = "tokens")) return i.errors = [
        {
          instancePath: a,
          schemaPath: "#/required",
          keyword: "required",
      ...
      if (P === e) {
        ...
        if (t) {
          ...
          if (t) {
            if (s.version !== void 0) {
              var f = s.version, g = e, I = e;
              if (e === I) if (f && Q(f) == "object" && !Array.isArray(f)) {
                var k;
                if (f.major === void 0 && (k = "major") || f.minor === void 0 && (k = "minor") || f.patch === void 0 && (k = "patch")) return i.errors = [
                  {
                ...
                var F = e;
                for (var w in f) if (!(w === "major" || w === "minor" || w === "patch")) return i.errors = [
                  {
                    instancePath: a + "/version",
                ...
                if (e === z) if (Array.isArray(A)) {
                  ...
                  for (var E = true, G = A.length, $ = 0; $ < G; $++) {
                    ...
                    l(A[$], {
                      ...
                      parentDataProperty: $,
                      rootData: p
                    }) || (r = r === null ? l.errors : r.concat(l.errors), e = r.length);
                    var E = M === e;
                    if (!E) break;
                  }
                } else return i.errors = [
                      ...
                      if (e === be) if (Y && Q(Y) == "object" && !Array.isArray(Y)) {
                        ...
                        if (Te) for (var _ in Y) {
                          ...
                          if (e === Fe) if (C && Q(C) == "object" && !Array.isArray(C)) {
                            var fe = void 0;
                            if (C.name === void 0 && (fe = "name") || C.description === void 0 && (fe = "description")) return i.errors = [
                              {
                            ...
                            if (qe === e) {
                              if (C.name !== void 0) {
                                var he = C.name, Le = e;
                                if (e === Le) if (typeof he == "string") {
                                  if (v(he) > 20) return i.errors = [
                                    {
