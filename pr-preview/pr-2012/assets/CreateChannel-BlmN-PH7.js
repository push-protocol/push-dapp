import { ea as i, er as Ke, fD as He, fE as xe, fC as ze, f_ as Xe, jh as Ze, ji as Qe, jj as et, jk as qe, fA as K, jl as _e, jm as tt, jn as nt, eH as rt, e5 as Q, eb as g, gr as Te, gs as it, gt as at, ev as R, ep as E, fk as st, fm as ot, jo as ct, en as ye, em as lt, e7 as S, f4 as dt, hJ as ht, eq as ut, e6 as gt, gX as pt, hS as ft, hT as mt, eP as xt, gf as yt, iJ as vt, g0 as Ct, iG as It, j3 as wt, e9 as St, __tla as __tla_0 } from "./index-UiBHnyIz.js";
import { S as Et, a as jt, u as Pt, __tla as __tla_1 } from "./StakingVariant-yZjGbtoa.js";
import { u as _t, __tla as __tla_2 } from "./useGetPaymentDetails-uYbJwT71.js";
import { S as Tt, __tla as __tla_3 } from "./Stepper-CsJYxjyU.js";
import { I as kt, P as Ut, __tla as __tla_4 } from "./ImportPushTokenMessage-CVRBoR1n.js";
import { u as Ft, __tla as __tla_5 } from "./useGetChannelCategories-BsAwGAU0.js";
import { u as Nt, F as Lt, b as Bt, c as bt, a as V, __tla as __tla_6 } from "./index.esm-BhnmBROZ.js";
import { a as Y, U as Dt, b as ke } from "./Common.form-NbJ1DVkQ.js";
import { I as At, __tla as __tla_7 } from "./ImageClipper-BOy0ulja.js";
let Cr, vr;
...
`, vn = "IHDR", De = "CgBI";
  ...
  function Pn(e, t, n) {
    ...
    r + a > s && (a = s - r - 10);
    const o = K.alloc(a), f = W.openSync(t, "r");
  ...
  const bn = ee, Dn = te, An = ne, Rn = re, Mn = ie, On = O, Gn = ae, Hn = se, zn = oe, qn = ce, Vn = le, Yn = de, Jn = he, Wn = ue, $n = ge, Kn = pe;
  M.typeHandlers = {
    bmp: bn.BMP,
    cur: Dn.CUR,
    dds: An.DDS,
  ...
  (function(e, t) {
    ...
    function d(h) {
      return n(this, void 0, void 0, function* () {
        ...
        const x = Math.min(u, y), j = K.alloc(x);
  ...
  var Qn = ve.exports;
  let er, tr, Ee, nr, je, rr, $, Me, ir, ar, sr, or, Oe, cr, lr, Ge;
  vr = rt(Qn);
  er = bt().shape({
  ...
  Cr = () => {
    const { account: e, provider: t, isWalletConnected: n, chainId: r, connect: a } = Q(), s = yt(e, r), o = gt(), [f] = pt(), y = f.get("paymentId"), v = ye.coreContractChain === r, { mutate: l } = Pt(), { mutate: d } = Ot(), [w, m] = S.useState("channelInfo"), [h, c] = S.useState([
    ...
    }, [x, j] = S.useState(false), [U, P] = S.useState($), [H, z] = S.useState(Me), { data: b } = ft({
      channelId: s
      ...
      l({
        ...
        onError: (C) => (console.log("Error in approving PUSH Token", C), C.code === 4001 || C.code === "ACTION_REJECTED" ? (console.log("Signature error ", C), q(1, "User Rejected Signature. Please try again.")) : q(2, "Transaction failed due to one of the following reasons:"), P($), false)
      });
    }, Pe = (p, k) => {
      let C = wt.GENERAL;
      const N = "1+" + k, D = It(N);
      T(70, "Please complete the transaction in your wallet to continue.", "Creating Channel..."), d({
        ...
        onError: (F) => {
          console.log("Error in transaction from query >>>>", F), F.code === 4001 || F.code === "ACTION_REJECTED" ? (console.log("Signature error ", F), q(1, "User Rejected Signature. Please try again."), P($)) : (console.error("Error in creating channel--> %o", F), console.error({
            error: F
