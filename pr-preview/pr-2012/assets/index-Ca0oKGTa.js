import { fA as x, eH as Qt, id as _e, __tla as __tla_0 } from "./index-C2jH2XEK.js";
let Mr;
let __tla = Promise.all([
  ...
  const v = {
    ...
    provider: {
      userRejectedRequest: (t) => ae(M.provider.userRejectedRequest, t),
      unauthorized: (t) => ae(M.provider.unauthorized, t),
      unsupportedMethod: (t) => ae(M.provider.unsupportedMethod, t),
      disconnected: (t) => ae(M.provider.disconnected, t),
      chainDisconnected: (t) => ae(M.provider.chainDisconnected, t),
      unsupportedChain: (t) => ae(M.provider.unsupportedChain, t),
      custom: (t) => {
  ...
  function Q(t) {
    return we(`0x${BigInt(t).toString(16)}`);
  }
  function an(t) {
  ...
  function Ge(t) {
    if (x.isBuffer(t)) return t;
    if (typeof t == "string") {
      if (Oe(t)) {
        const e = ct(t, false);
        return x.from(e, "hex");
      }
      return x.from(t, "utf8");
    }
  ...
  function pe(t) {
    ...
    if (typeof t == "number") return BigInt(ye(t));
    if (typeof t == "string") {
  ...
  const Ee = "4.3.0", hn = "@coinbase/wallet-sdk";
  ...
  class Ws {
    ...
    async handshake(e) {
      ...
      const c = await un("public", a.sender);
      await this.keyManager.setPeerPublicKey(c);
      const u = (await this.decryptResponseMessage(a)).result;
    ...
    async decryptResponseMessage(e) {
      ...
      if (a) {
        const d = Object.entries(a).map(([u, l]) => ({
          id: Number(u),
          rpcUrl: l
        }));
  ...
  (function(t) {
    Object.defineProperty(t, "__esModule", {
      value: true
    }), t.Hash = t.nextTick = t.byteSwapIfBE = t.isLE = void 0, t.isBytes = s, t.u8 = i, t.u32 = r, t.createView = o, t.rotr = a, t.rotl = c, t.byteSwap = d, t.byteSwap32 = u, t.bytesToHex = p, t.hexToBytes = C, t.asyncLoop = b, t.utf8ToBytes = w, t.toBytes = k, t.concatBytes = U, t.checkOpts = ne, t.wrapConstructor = xe, t.wrapConstructorWithOpts = oe, t.wrapXOFConstructorWithOpts = he, t.randomBytes = fe;
    const e = De, n = ee;
    function s(h) {
    ...
    function d(h) {
      return h << 24 & 4278190080 | h << 8 & 16711680 | h >>> 8 & 65280 | h >>> 24 & 255;
    }
    t.byteSwapIfBE = t.isLE ? (h) => h : (h) => d(h);
    function u(h) {
      for (let _ = 0; _ < h.length; _++) h[_] = d(h[_]);
    }
    const l = Array.from({
      length: 256
    }, (h, _) => _.toString(16).padStart(2, "0"));
    function p(h) {
      (0, n.abytes)(h);
      let _ = "";
      for (let A = 0; A < h.length; A++) _ += l[h[A]];
      return _;
    }
    const f = {
      _0: 48,
    ...
    function m(h) {
      if (h >= f._0 && h <= f._9) return h - f._0;
      if (h >= f.A && h <= f.F) return h - (f.A - 10);
      if (h >= f.a && h <= f.f) return h - (f.a - 10);
    }
    function C(h) {
      if (typeof h != "string") throw new Error("hex string expected, got " + typeof h);
      const _ = h.length, A = _ / 2;
      if (_ % 2) throw new Error("hex string expected, got unpadded hex of length " + _);
      const L = new Uint8Array(A);
      for (let R = 0, D = 0; R < A; R++, D += 2) {
        const mt = m(h.charCodeAt(D)), yt = m(h.charCodeAt(D + 1));
    ...
    t.nextTick = g;
    async function b(h, _, A) {
      let L = Date.now();
      for (let R = 0; R < h; R++) {
        A(R);
        const D = Date.now() - L;
        D >= 0 && D < _ || (await (0, t.nextTick)(), L += D);
      }
    }
    function w(h) {
    ...
    function k(h) {
      return typeof h == "string" && (h = w(h)), (0, n.abytes)(h), h;
    }
    function U(...h) {
      let _ = 0;
      ...
      for (let L = 0, R = 0; L < h.length; L++) {
        const D = h[L];
        A.set(D, R), R += D.length;
      }
      return A;
    }
    class H {
    ...
    function xe(h) {
      const _ = (L) => h().update(k(L)).digest(), A = h();
      return _.outputLen = A.outputLen, _.blockLen = A.blockLen, _.create = () => h(), _;
    }
    function oe(h) {
      const _ = (L, R) => h(R).update(k(L)).digest(), A = h({});
      return _.outputLen = A.outputLen, _.blockLen = A.blockLen, _.create = (L) => h(L), _;
    }
    function he(h) {
      const _ = (L, R) => h(R).update(k(L)).digest(), A = h({});
      return _.outputLen = A.outputLen, _.blockLen = A.blockLen, _.create = (L) => h(L), _;
    ...
    function fe(h = 32) {
      if (e.crypto && typeof e.crypto.getRandomValues == "function") return e.crypto.getRandomValues(new Uint8Array(h));
      if (e.crypto && typeof e.crypto.randomBytes == "function") return e.crypto.randomBytes(h);
  ...
  S.keccakP = jn;
  const ce = ee, ve = y, F = On, Dn = [], Un = [], Hn = [], zs = BigInt(0), ge = BigInt(1), Zs = BigInt(2), Gs = BigInt(7), Ys = BigInt(256), Js = BigInt(113);
  for (let t = 0, e = ge, n = 1, s = 0; t < 24; t++) {
    [n, s] = [
      s,
      (2 * n + 3 * s) % 5
    ], Dn.push(2 * (5 * s + n)), Un.push((t + 1) * (t + 2) / 2 % 64);
    let i = zs;
    for (let r = 0; r < 7; r++) e = (e << ge ^ (e >> Gs) * Js) % Ys, e & Zs && (i ^= ge << (ge << BigInt(r)) - ge);
    Hn.push(i);
  }
  const [Qs, Xs] = (0, ve.split)(Hn, true), xt = (t, e, n) => n > 32 ? (0, ve.rotlBH)(t, e, n) : (0, ve.rotlSH)(t, e, n), St = (t, e, n) => n > 32 ? (0, ve.rotlBL)(t, e, n) : (0, ve.rotlSL)(t, e, n);
  function jn(t, e = 24) {
    const n = new Uint32Array(10);
    for (let s = 24 - e; s < 24; s++) {
      for (let o = 0; o < 10; o++) n[o] = t[o] ^ t[o + 10] ^ t[o + 20] ^ t[o + 30] ^ t[o + 40];
      for (let o = 0; o < 10; o += 2) {
        const a = (o + 8) % 10, c = (o + 2) % 10, d = n[c], u = n[c + 1], l = xt(d, u, 1) ^ n[a], p = St(d, u, 1) ^ n[a + 1];
        for (let f = 0; f < 50; f += 10) t[o + f] ^= l, t[o + f + 1] ^= p;
      }
      let i = t[2], r = t[3];
      for (let o = 0; o < 24; o++) {
        const a = Un[o], c = xt(i, r, a), d = St(i, r, a), u = Dn[o];
        i = t[u], r = t[u + 1], t[u] = c, t[u + 1] = d;
      }
  ...
  class Ce extends F.Hash {
    constructor(e, n, s, i = false, r = 24) {
      if (super(), this.blockLen = e, this.suffix = n, this.outputLen = s, this.enableXOF = i, this.rounds = r, this.pos = 0, this.posOut = 0, this.finished = false, this.destroyed = false, (0, ce.anumber)(s), 0 >= this.blockLen || this.blockLen >= 200) throw new Error("Sha3 supports only keccak-f1600 function");
    ...
    writeInto(e) {
      (0, ce.aexists)(this, false), (0, ce.abytes)(e), this.finish();
    ...
    xof(e) {
      return (0, ce.anumber)(e), this.xofInto(new Uint8Array(e));
    }
    digestInto(e) {
      if ((0, ce.aoutput)(e, this), this.finished) throw new Error("digest() was already called");
    ...
    _cloneInto(e) {
      ...
      return e || (e = new Ce(n, s, i, o, r)), e.state32.set(this.state32), e.pos = this.pos, e.posOut = this.posOut, e.finished = this.finished, e.rounds = r, e.suffix = s, e.outputLen = i, e.enableXOF = o, e.destroyed = this.destroyed, e;
    }
  }
  S.Keccak = Ce;
  const te = (t, e, n) => (0, F.wrapConstructor)(() => new Ce(e, t, n));
  S.sha3_224 = te(6, 144, 224 / 8);
  S.sha3_256 = te(6, 136, 256 / 8);
  S.sha3_384 = te(6, 104, 384 / 8);
  S.sha3_512 = te(6, 72, 512 / 8);
  S.keccak_224 = te(1, 144, 224 / 8);
  S.keccak_256 = te(1, 136, 256 / 8);
  S.keccak_384 = te(1, 104, 384 / 8);
  S.keccak_512 = te(1, 72, 512 / 8);
  const Bn = (t, e, n) => (0, F.wrapXOFConstructorWithOpts)((s = {}) => new Ce(e, t, s.dkLen === void 0 ? n : s.dkLen, true));
  S.shake128 = Bn(31, 168, 128 / 8);
  S.shake256 = Bn(31, 136, 256 / 8);
  const { keccak_256: ei } = S;
  function Wn(t) {
    return x.allocUnsafe(t).fill(0);
  }
  function ti(t) {
  ...
  function Ue(t) {
    if (!x.isBuffer(t)) if (Array.isArray(t)) t = x.from(t);
    else if (typeof t == "string") Kn(t) ? t = x.from(oi(Fn(t)), "hex") : t = x.from(t);
    else if (typeof t == "number") t = intToBuffer(t);
    else if (t == null) t = x.allocUnsafe(0);
    else if (typeof t == "bigint") t = qn(t);
    else if (t.toArray) t = x.from(t.toArray());
  ...
  function ri(t, e) {
    ...
    return x.from(ei(new Uint8Array(t)));
  }
  function oi(t) {
  ...
  function V(t, e) {
    ...
    if (t === "string") return V("bytes", new x(e, "utf8"));
    if (ci(t)) {
      ...
      if (t === "bytes") return e = new x(e), i = x.concat([
        V("uint256", e.length),
        e
      ]), e.length % 32 !== 0 && (i = x.concat([
        i,
        O.zeros(32 - e.length % 32)
      ])), i;
      if (t.startsWith("bytes")) {
        if (n = le(t), n < 1 || n > 32) throw new Error("Invalid bytes<N> width: " + n);
        return O.setLengthRight(e, 32);
      } else if (t.startsWith("uint")) {
        if (n = le(t), n % 8 || n < 8 || n > 256) throw new Error("Invalid uint<N> width: " + n);
        s = ie(e);
        ...
        if (n = le(t), n % 8 || n < 8 || n > 256) throw new Error("Invalid int<N> width: " + n);
        s = ie(e);
        const a = O.bitLengthFromBigInt(s);
  ...
  function Gn(t, e) {
    ...
    for (var n, s, i = [], r = 0; r < t.length; r++) {
      var o = zn(t[r]), a = e[r];
      if (o === "bytes") i.push(a);
      else if (o === "string") i.push(new x(a, "utf8"));
      else if (o === "bool") i.push(new x(a ? "01" : "00", "hex"));
      else if (o === "address") i.push(O.setLength(a, 20));
      else if (o.startsWith("bytes")) {
        if (n = le(o), n < 1 || n > 32) throw new Error("Invalid bytes<N> width: " + n);
        i.push(O.setLengthRight(a, n));
      } else if (o.startsWith("uint")) {
        if (n = le(o), n % 8 || n < 8 || n > 256) throw new Error("Invalid uint<N> width: " + n);
        s = ie(a);
        ...
        if (n = le(o), n % 8 || n < 8 || n > 256) throw new Error("Invalid int<N> width: " + n);
        s = ie(a);
        const c = O.bitLengthFromBigInt(s);
  ...
  const B = $n, be = ui, Yn = {
    ...
    encodeData(t, e, n, s = true) {
      ...
      if (s) {
        const o = (a, c, d) => {
          ...
          if (c === "string") return typeof d == "string" && (d = x.from(d, "utf8")), [
            "bytes32",
            B.keccak(d)
          ];
          if (c.lastIndexOf("]") === c.length - 1) {
            const u = c.slice(0, c.lastIndexOf("[")), l = d.map((p) => o(a, u, p));
            return [
              "bytes32",
              B.keccak(be.rawEncode(l.map(([p]) => p), l.map(([, p]) => p)))
            ];
          }
          return [
            c,
        ...
        else if (o.type === "string") i.push("bytes32"), typeof a == "string" && (a = x.from(a, "utf8")), a = B.keccak(a), r.push(a);
    ...
    hash(t, e = true) {
      ...
      return s.push(this.hashStruct("EIP712Domain", n.domain, n.types, e)), n.primaryType !== "EIP712Domain" && s.push(this.hashStruct(n.primaryType, n.message, n.types, e)), B.keccak(x.concat(s));
    }
  };
  var hi = {
  ...
  function fi(t) {
    ...
    return be.soliditySHA3([
      "bytes32",
      "bytes32"
    ], [
      be.soliditySHA3(new Array(t.length).fill("string"), i),
      be.soliditySHA3(s, n)
    ]);
  }
  const Ie = Qt(hi), pi = "walletUsername", Qe = "Addresses", gi = "AppVersion";
  function N(t) {
  ...
  class _i {
    ...
    async encrypt(e) {
      ...
      const s = crypto.getRandomValues(new Uint8Array(12)), i = await crypto.subtle.importKey("raw", Ae(n), {
        ...
        name: "AES-GCM",
        iv: s
      }, i, r.encode(e)), a = 16, c = o.slice(o.byteLength - a), d = o.slice(0, o.byteLength - a), u = new Uint8Array(c), l = new Uint8Array(d), p = new Uint8Array([
        ...s,
        ...u,
        ...l
      ]);
      ...
      return new Promise((s, i) => {
        (async function() {
          const r = await crypto.subtle.importKey("raw", Ae(n), {
            ...
            "encrypt",
            "decrypt"
          ]), o = Ae(e), a = o.slice(0, 12), c = o.slice(12, 28), d = o.slice(28), u = new Uint8Array([
            ...d,
            ...c
          ]), l = {
            name: "AES-GCM",
          ...
          try {
            const p = await window.crypto.subtle.decrypt(l, r, u), f = new TextDecoder();
            s(f.decode(p));
          } catch (p) {
            i(p);
          }
  ...
  function Jn(t) {
    return typeof t == "string" && (t = Si(t)), ut(t), t;
  }
  class Ii {
    clone() {
      return this._cloneInto();
  ...
  class Ti extends Ii {
    ...
    digestInto(e) {
      ...
      for (let l = 0; l < d; l++) a.setUint32(4 * l, u[l], r);
    }
    digest() {
  ...
  class Ni extends Ti {
    ...
    process(e, n) {
      ...
      let { A: s, B: i, C: r, D: o, E: a, F: c, G: d, H: u } = this;
      for (let l = 0; l < 64; l++) {
        const p = q(a, 6) ^ q(a, 11) ^ q(a, 25), f = u + p + Mi(a, c, d) + Ri[l] + J[l] | 0, C = (q(s, 2) ^ q(s, 13) ^ q(s, 22)) + Pi(s, i, r) | 0;
        u = d, d = c, c = a, a = o + f | 0, o = r, r = i, i = s, s = f + C | 0;
      }
      s = s + this.A | 0, i = i + this.B | 0, r = r + this.C | 0, o = o + this.D | 0, a = a + this.E | 0, c = c + this.F | 0, d = d + this.G | 0, u = u + this.H | 0, this.set(s, i, r, o, a, c, d, u);
    }
    roundClean() {
      J.fill(0);
    }
  ...
  class de {
    ...
    static create(e) {
      ...
      return new de(e, n, s).save();
    }
    static load(e) {
      const n = e.getItem(Mt), s = e.getItem(Tt), i = e.getItem(Pt);
      return n && i ? new de(e, n, i, s === "1") : null;
    }
    get linked() {
      return this._linked;
    }
  ...
  var He, I, es, re, Rt, ts, ns, ss, ht, Xe, et, ke = {}, is = [], Bi = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, ft = Array.isArray;
  function X(t, e) {
  ...
  function Nt(t) {
    (!t.__d && (t.__d = true) && re.push(t) && !Re.__r++ || Rt !== I.debounceRendering) && ((Rt = I.debounceRendering) || ts)(Re);
  }
  function Re() {
    for (var t, e, n, s, i, r, o, a = 1; re.length; ) re.length > a && re.sort(ns), t = re.shift(), a = re.length, t.__d && (n = void 0, i = (s = (e = t).__v).__e, r = [], o = [], e.__P && ((n = X({}, s)).__v = s.__v + 1, I.vnode && I.vnode(n), gt(e.__P, n, s, e.__n, e.__P.namespaceURI, 32 & s.__u ? [
      i
    ] : null, r, i ?? ue(s), !!(32 & s.__u), o), n.__v = s.__v, n.__.__k[n.__i] = n, cs(r, n, o), n.__e != i && rs(n)));
    Re.__r = 0;
  }
  function os(t, e, n, s, i, r, o, a, c, d, u) {
    var l, p, f, m, C, g, b = s && s.__k || is, w = e.length;
    for (c = Wi(n, e, b, c, w), l = 0; l < w; l++) (f = n.__k[l]) != null && (p = f.__i === -1 ? ke : b[f.__i] || ke, f.__i = l, g = gt(t, f, p, i, r, o, a, c, d, u), m = f.__e, f.ref && p.ref != f.ref && (p.ref && _t(p.ref, null, f), u.push(f.ref, f.__c || m, f)), C == null && m != null && (C = m), 4 & f.__u || p.__k === f.__k ? c = as(f, c, t) : typeof f.type == "function" && g !== void 0 ? c = g : m && (c = m.nextSibling), f.__u &= -7);
    return n.__e = C, c;
  }
  function Wi(t, e, n, s, i) {
    var r, o, a, c, d, u = n.length, l = u, p = 0;
    ...
    if (l) for (r = 0; r < u; r++) (a = n[r]) != null && !(2 & a.__u) && (a.__e == s && (s = ue(a)), ls(a, a));
    return s;
  }
  function as(t, e, n) {
    var s, i;
  ...
  function Le(t, e, n, s, i) {
    ...
    else if (e[0] == "o" && e[1] == "n") r = e != (e = e.replace(ss, "$1")), e = e.toLowerCase() in t || e == "onFocusOut" || e == "onFocusIn" ? e.toLowerCase().slice(2) : e.slice(2), t.l || (t.l = {}), t.l[e + r] = n, n ? s ? n.t = s.t : (n.t = ht, t.addEventListener(e, r ? et : Xe, r)) : t.removeEventListener(e, r ? et : Xe, r);
    else {
  ...
  function gt(t, e, n, s, i, r, o, a, c, d) {
    var u, l, p, f, m, C, g, b, w, k, U, H, ne, xe, oe, he, fe, h = e.type;
    if (e.constructor !== void 0) return null;
    128 & n.__u && (c = !!(32 & n.__u), r = [
      a = e.__e = n.__e
    ]), (u = I.__b) && u(e);
    e: if (typeof h == "function") try {
      if (b = e.props, w = "prototype" in h && h.prototype.render, k = (u = h.contextType) && s[u.__c], U = u ? k ? k.props.value : u.__ : s, n.__c ? g = (l = e.__c = n.__c).__ = l.__E : (w ? e.__c = l = new h(b, U) : (e.__c = l = new Pe(b, U), l.constructor = h, l.render = Ki), k && k.sub(l), l.props = b, l.state || (l.state = {}), l.context = U, l.__n = s, p = l.__d = true, l.__h = [], l._sb = []), w && l.__s == null && (l.__s = l.state), w && h.getDerivedStateFromProps != null && (l.__s == l.state && (l.__s = X({}, l.__s)), X(l.__s, h.getDerivedStateFromProps(b, l.__s))), f = l.props, m = l.state, l.__v = e, p) w && h.getDerivedStateFromProps == null && l.componentWillMount != null && l.componentWillMount(), w && l.componentDidMount != null && l.__h.push(l.componentDidMount);
      else {
        if (w && h.getDerivedStateFromProps == null && b !== f && l.componentWillReceiveProps != null && l.componentWillReceiveProps(b, U), !l.__e && (l.shouldComponentUpdate != null && l.shouldComponentUpdate(b, l.__s, U) === false || e.__v == n.__v)) {
          for (e.__v != n.__v && (l.props = b, l.state = l.__s, l.__d = false), e.__e = n.__e, e.__k = n.__k, e.__k.some(function(_) {
            _ && (_.__ = e);
      ...
      if (l.context = U, l.props = b, l.__P = t, l.__e = false, ne = I.__r, xe = 0, w) {
        for (l.state = l.__s, l.__d = false, ne && ne(e), u = l.render(l.props, l.state, l.context), oe = 0; oe < l._sb.length; oe++) l.__h.push(l._sb[oe]);
        l._sb = [];
      } else do
        l.__d = false, ne && ne(e), u = l.render(l.props, l.state, l.context), l.state = l.__s;
      while (l.__d && ++xe < 25);
      l.state = l.__s, l.getChildContext != null && (s = X(X({}, s), l.getChildContext())), w && !p && l.getSnapshotBeforeUpdate != null && (C = l.getSnapshotBeforeUpdate(f, m)), a = os(t, ft(he = u != null && u.type === je && u.key == null ? u.props.children : u) ? he : [
        he
      ], e, n, s, i, r, o, a, c, d), l.base = e.__e, e.__u &= -161, l.__h.length && o.push(l), g && (l.__E = l.__ = null);
    } catch (_) {
      if (e.__v = null, c || r != null) if (_.then) {
        for (e.__u |= c ? 160 : 128; a && a.nodeType == 8 && a.nextSibling; ) a = a.nextSibling;
        r[r.indexOf(a)] = null, e.__e = a;
      } else for (fe = r.length; fe--; ) pt(r[fe]);
      else e.__e = n.__e, e.__k = n.__k;
      I.__e(_, e, n);
    }
    else r == null && e.__v == n.__v ? (e.__k = n.__k, e.__e = n.__e) : a = e.__e = Vi(n.__e, e, n, s, i, r, o, c, d);
    return (u = I.diffed) && u(e), 128 & e.__u ? void 0 : a;
  }
  function cs(t, e, n) {
    for (var s = 0; s < n.length; s++) _t(n[s], n[++s], n[++s]);
    I.__c && I.__c(e, t), t.some(function(i) {
      try {
  ...
  function Vi(t, e, n, s, i, r, o, a, c) {
    var d, u, l, p, f, m, C, g = n.props, b = e.props, w = e.type;
    ...
    if (t == null) {
      ...
      t = document.createElementNS(i, w, b.is && b), a && (I.__m && I.__m(e, r), a = false), r = null;
    }
    if (w === null) g === b || a && t.data === b || (t.data = b);
    else {
      if (r = r && He.call(t.childNodes), g = n.props || ke, !a && r != null) for (g = {}, d = 0; d < t.attributes.length; d++) g[(f = t.attributes[d]).name] = f.value;
      ...
      for (d in b) f = b[d], d == "children" ? p = f : d == "dangerouslySetInnerHTML" ? u = f : d == "value" ? m = f : d == "checked" ? C = f : a && typeof f != "function" || g[d] === f || Le(t, d, f, g[d], i);
      if (u) a || l && (u.__html === l.__html || u.__html === t.innerHTML) || (t.innerHTML = u.__html), e.__k = [];
  ...
  function ls(t, e, n) {
    var s, i;
    if (I.unmount && I.unmount(t), (s = t.ref) && (s.current && s.current !== t.__e || _t(s, null, e)), (s = t.__c) != null) {
  ...
  function tt(t, e, n) {
    var s, i, r, o;
    e == document && (e = document.documentElement), I.__ && I.__(t, e), i = (s = false) ? null : e.__k, r = [], o = [], gt(e, t = e.__k = E(je, null, [
      t
    ]), i || ke, ke, e.namespaceURI, i ? null : e.firstChild ? He.call(e.childNodes) : null, r, i ? i.__e : e.firstChild, s, o), cs(r, t, o);
  }
  He = is.slice, I = {
  ...
  }, Re.__r = 0, ss = /(PointerCapture)$|Capture$/i, ht = 0, Xe = Dt(false), et = Dt(true);
  var Ne, P, $e, Ut, nt = 0, ds = [], T = I, Ht = T.__b, jt = T.__r, Bt = T.diffed, Wt = T.__c, qt = T.unmount, Vt = T.__;
  function us(t, e) {
  ...
  const fs = (t) => E("div", {
    class: _e("-cbwsdk-snackbar-container")
    ...
    return E("div", {
      class: _e("-cbwsdk-snackbar-instance", s && "-cbwsdk-snackbar-instance-hidden", r && "-cbwsdk-snackbar-instance-expanded")
    }, E("div", {
      ...
      class: _e("-cbwsdk-snackbar-instance-menu-item", c.isRed && "-cbwsdk-snackbar-instance-menu-item-is-red"),
      onClick: c.onClick,
      key: d
    }, E("svg", {
      width: c.svgWidth,
      ...
      class: _e("-cbwsdk-snackbar-instance-menu-item-info", c.isRed && "-cbwsdk-snackbar-instance-menu-item-info-is-red")
    }, c.info)))));
  };
  class tr {
    constructor() {
  ...
  const ir = ({ title: t, buttonText: e, darkMode: n, onButtonClick: s, onDismiss: i }) => {
    ...
    return E(fs, {
      ...
      class: _e("-cbwsdk-redirect-dialog-box", r)
    }, E("p", null, t), E("button", {
      onClick: s
    }, e))));
  ...
  class z {
    ...
    subscribe() {
      const e = de.load(this.storage) || de.create(this.storage), { linkAPIUrl: n } = this, s = new wi({
        session: e,
        linkAPIUrl: n,
        listener: this
  ...
  class ps {
    ...
    updateProviderInfo(e, n) {
      ...
      this._storage.setItem(Zt, n.toString(10)), ye(n) !== i && ((s = this.callback) === null || s === void 0 || s.call(this, "chainChanged", Q(n)));
    }
    async watchAsset(e) {
    ...
    async addEthereumChain(e) {
      ...
      const o = this.initializeRelay(), { rpcUrls: a = [], blockExplorerUrls: c = [], chainName: d, iconUrls: u = [], nativeCurrency: l } = i, p = await o.addEthereumChain(r.toString(), a, u, c, d, l);
      if (N(p)) return false;
    ...
    _prepareTransactionParams(e) {
      ...
      const s = e.to ? G(e.to) : null, i = e.value != null ? pe(e.value) : BigInt(0), r = e.data ? Ge(e.data) : x.alloc(0), o = e.nonce != null ? ye(e.nonce) : null, a = e.gasPrice != null ? pe(e.gasPrice) : null, c = e.maxFeePerGas != null ? pe(e.maxFeePerGas) : null, d = e.maxPriorityFeePerGas != null ? pe(e.maxPriorityFeePerGas) : null, u = e.gas != null ? pe(e.gas) : null, l = e.chainId ? ye(e.chainId) : this.getChainId();
      return {
        fromAddress: n,
        toAddress: s,
        weiValue: i,
...
Please see https://www.smartwallet.dev/guides/tips/popup-tips#cross-origin-opener-policy for more information.`, pr = () => {
  ...
  function vr(t) {
    ...
    return n.searchParams.set("version", Ee), n.searchParams.set("code", e.code.toString()), n.searchParams.set("message", e.message), Object.assign(Object.assign({}, e), {
      docUrl: n.href
    });
  }
  function kr(t) {
  ...
  (function(t) {
    ...
    function r(c, d, u, l, p) {
      if (typeof u != "function") throw new TypeError("The listener must be a function");
      var f = new i(u, l || c, p), m = n ? n + d : d;
    ...
    a.prototype.eventNames = function() {
      ...
      for (l in u = this._events) e.call(u, l) && d.push(n ? l.slice(1) : l);
    ...
    }, a.prototype.emit = function(d, u, l, p, f, m) {
      var C = n ? n + d : d;
      ...
      if (g.fn) {
        switch (g.once && this.removeListener(d, g.fn, void 0, true), b) {
          ...
          case 2:
            return g.fn.call(g.context, u), true;
          case 3:
            return g.fn.call(g.context, u, l), true;
          case 4:
            return g.fn.call(g.context, u, l, p), true;
          case 5:
            return g.fn.call(g.context, u, l, p, f), true;
          case 6:
            return g.fn.call(g.context, u, l, p, f, m), true;
        }
        ...
        for (k = 0; k < U; k++) switch (g[k].once && this.removeListener(d, g[k].fn, void 0, true), b) {
          case 1:
            ...
            break;
          case 2:
            g[k].fn.call(g[k].context, u);
            break;
          case 3:
            g[k].fn.call(g[k].context, u, l);
            break;
          case 4:
            g[k].fn.call(g[k].context, u, l, p);
            break;
          default:
      ...
      return true;
    }, a.prototype.on = function(d, u, l) {
      return r(this, d, u, l, false);
    }, a.prototype.once = function(d, u, l) {
      return r(this, d, u, l, true);
    }, a.prototype.removeListener = function(d, u, l, p) {
      var f = n ? n + d : d;
      if (!this._events[f]) return this;
      if (!u) return o(this, f), this;
      var m = this._events[f];
      if (m.fn) m.fn === u && (!p || m.once) && (!l || m.context === l) && o(this, f);
      else {
        for (var C = 0, g = [], b = m.length; C < b; C++) (m[C].fn !== u || p && !m[C].once || l && m[C].context !== l) && g.push(m[C]);
        g.length ? this._events[f] = g.length === 1 ? g[0] : g : o(this, f);
      }
      return this;
    }, a.prototype.removeAllListeners = function(d) {
      var u;
      return d ? (u = n ? n + d : d, this._events[u] && o(this, u)) : (this._events = new s(), this._eventsCount = 0), this;
  ...
  Mr = class {
    ...
    storeLatestVersion() {
      new K("CBWSDK").setItem("VERSION", Ee);
    }
  };
});
export {
