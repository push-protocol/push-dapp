import { iy as mn, eH as yn, __tla as __tla_0 } from "./index-C2jH2XEK.js";
import { a as xn, __tla as __tla_1 } from "./markup-BqEupAgm.js";
import { a as bn, __tla as __tla_2 } from "./css-BvwRDpA_.js";
import { a as wn, __tla as __tla_3 } from "./clike-iJdlVtbO.js";
import { a as Cn, __tla as __tla_4 } from "./javascript-CZtYjZZf.js";
let Hl;
let __tla = Promise.all([
  ...
  z.boolean = X();
  z.booleanish = X();
  z.overloadedBoolean = X();
  z.number = X();
  z.spaceSeparated = X();
  z.commaSeparated = X();
  z.commaOrSpaceSeparated = X();
  function X() {
    return Math.pow(2, ++$n);
  }
  var Xe = Ke, Oe = z, Je = be;
  be.prototype = new Xe();
  ...
  }), we = z, Gn = le, O = we.booleanish, D = we.number, Y = we.spaceSeparated, Vn = Gn({
    transform: Kn,
    properties: {
  ...
  var ee = z, Yn = le, Xn = Ze, h = ee.boolean, Jn = ee.overloadedBoolean, re = ee.booleanish, x = ee.number, L = ee.spaceSeparated, ue = ee.commaSeparated, Qn = Yn({
    space: "html",
    attributes: {
  ...
  function Mr(e, n, r) {
    var t, f, v;
    if (typeof r != "object" || !("length" in r)) return He(e, n, r);
    for (f = r.length, t = -1, v = []; ++t < f; ) v[t] = He(e, n, r[t]);
    return v;
  }
  function He(e, n, r) {
    var t = r;
  ...
  rn.displayName = "html";
  var Rr = rn, jr = Rr;
  const qr = "\xC6", Hr = "&", zr = "\xC1", _r = "\xC2", Br = "\xC0", Wr = "\xC5", Fr = "\xC3", Gr = "\xC4", Vr = "\xA9", Kr = "\xC7", Yr = "\xD0", Xr = "\xC9", Jr = "\xCA", Qr = "\xC8", Zr = "\xCB", ea = ">", na = "\xCD", ra = "\xCE", aa = "\xCC", ta = "\xCF", la = "<", ia = "\xD1", oa = "\xD3", sa = "\xD4", ua = "\xD2", ca = "\xD8", fa = "\xD5", da = "\xD6", va = '"', pa = "\xAE", ga = "\xDE", ha = "\xDA", ma = "\xDB", ya = "\xD9", xa = "\xDC", ba = "\xDD", wa = "\xE1", Ca = "\xE2", Sa = "\xB4", Aa = "\xE6", Ea = "\xE0", Pa = "&", Ta = "\xE5", $a = "\xE3", ka = "\xE4", La = "\xA6", Oa = "\xE7", Ma = "\xB8", Ia = "\xA2", Da = "\xA9", Ua = "\xA4", Na = "\xB0", Ra = "\xF7", ja = "\xE9", qa = "\xEA", Ha = "\xE8", za = "\xF0", _a = "\xEB", Ba = "\xBD", Wa = "\xBC", Fa = "\xBE", Ga = ">", Va = "\xED", Ka = "\xEE", Ya = "\xA1", Xa = "\xEC", Ja = "\xBF", Qa = "\xEF", Za = "\xAB", et = "<", nt = "\xAF", rt = "\xB5", at = "\xB7", tt = "\xA0", lt = "\xAC", it = "\xF1", ot = "\xF3", st = "\xF4", ut = "\xF2", ct = "\xAA", ft = "\xBA", dt = "\xF8", vt = "\xF5", pt = "\xF6", gt = "\xB6", ht = "\xB1", mt = "\xA3", yt = '"', xt = "\xBB", bt = "\xAE", wt = "\xA7", Ct = "\xAD", St = "\xB9", At = "\xB2", Et = "\xB3", Pt = "\xDF", Tt = "\xFE", $t = "\xD7", kt = "\xFA", Lt = "\xFB", Ot = "\xF9", Mt = "\xA8", It = "\xFC", Dt = "\xFD", Ut = "\xA5", Nt = "\xFF", Rt = {
    AElig: qr,
    AMP: Hr,
    Aacute: zr,
    Acirc: _r,
  ...
  var ze = Rt, _e = jt, Jt = an, Qt = Ht, tn = Gt, Zt = Yt, el = vl, nl = {}.hasOwnProperty, Q = String.fromCharCode, rl = Function.prototype, Be = {
    warning: null,
    reference: null,
    text: null,
    warningContext: null,
  ...
  function pl(e, n) {
    var r = n.additional, t = n.nonTerminated, f = n.text, v = n.reference, m = n.warning, u = n.textContext, g = n.referenceContext, E = n.warningContext, $ = n.position, C = n.indent || [], B = e.length, j = 0, oe = -1, M = $.column || 1, J = $.line || 1, q = "", l = [], a, s, o, i, d, p, c, y, S, I, H, W, _, N, ne, w, k, P, b;
    for (typeof r == "string" && (r = r.charCodeAt(0)), w = T(), y = m ? de : rl, j--, B++; ++j < B; ) if (d === We && (M = C[oe] || 1), d = e.charCodeAt(j), d === Fe) {
      ...
      for (_ = j + 1, W = _, b = _, c === ul ? (b = ++W, c = e.charCodeAt(b), c === cl || c === fl ? (N = Ee, b = ++W) : N = Pe) : N = Z, a = "", H = "", i = "", ne = fe[N], b--; ++b < B && (c = e.charCodeAt(b), !!ne(c)); ) i += Q(c), N === Z && nl.call(ze, i) && (a = i, H = ze[i]);
      o = e.charCodeAt(b) === il, o && (b++, s = N === Z ? Zt(i) : false, s && (a = i, H = s)), P = 1 + b - _, !o && !t || (i ? N === Z ? (o && !H ? y(cn, 1) : (a !== i && (b = W + a.length, P = 1 + b - W, o = false), o || (S = a ? ln : sn, n.attribute ? (c = e.charCodeAt(b), c === sl ? (y(S, P), H = null) : tn(c) ? H = null : y(S, P)) : y(S, P))), p = H) : (o || y(on, P), p = parseInt(i, Te[N]), gl(p) ? (y(fn, P), p = Q(dl)) : p in _e ? (y(me, P), p = _e[p]) : (I = "", hl(p) && y(me, P), p > 65535 && (p -= 65536, I += Q(p >>> 10 | 55296), p = 56320 | p & 1023), p = I + Q(p))) : N !== Z && y(un, P)), p ? (R(), w = T(), j = b - 1, M += b - _ + 1, l.push(p), k = T(), k.offset++, v && v.call(g, p, {
        start: w,
        end: k
      ...
      function $(l, a, s, o, i, d) {
        for (var p in s) if (!(!s.hasOwnProperty(p) || !s[p])) {
          ...
          for (var y = 0; y < c.length; ++y) {
            ...
            var S = c[y], I = S.inside, H = !!S.lookbehind, W = !!S.greedy, _ = S.alias;
            ...
            for (var ne = S.pattern || S, w = o.next, k = i; w !== a.tail && !(d && k >= d.reach); k += w.value.length, w = w.next) {
              ...
              if (!(P instanceof g)) {
                var b = 1, T;
                if (W) {
                  if (T = E(ne, k, l, H), !T || T.index >= l.length) break;
                ...
                } else if (T = E(ne, 0, P, H), !T) continue;
