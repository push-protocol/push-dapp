const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-fgYlUzIX.js","assets/index-AGa8OPve.js","assets/index-Dlk3sXhy.css"])))=>i.map(i=>d[i]);
import { fA as pe, eN as me, __tla as __tla_0 } from "./index-AGa8OPve.js";
...
let __tla = Promise.all([
  ...
  class $e {
    ...
    async initUi() {
      if (typeof window < "u") {
        await me(() => import("./index-fgYlUzIX.js").then(async (m2) => {
          await m2.__tla;
          return m2;
