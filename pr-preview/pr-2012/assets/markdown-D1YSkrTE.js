...
let __tla = Promise.all([
  ...
  function E(l, b) {
    for (var e = 0; e < b.length; e++) {
      ...
      if (typeof s != "string" && !Array.isArray(s)) {
        for (const o in s) if (o !== "default" && !(o in l)) {
          const d = Object.getOwnPropertyDescriptor(s, o);
          d && Object.defineProperty(l, o, d.get ? d : {
            enumerable: true,
            get: () => s[o]
          });
        }
  ...
  function C() {
    if (_) return m;
    _ = 1, m = l, l.displayName = "markdown", l.aliases = [
      "md"
    ];
    function l(b) {
      (function(e) {
        ...
        e.languages.markdown = e.languages.extend("markup", {}), e.languages.insertBefore("markdown", "prolog", {
          ...
          function n(i) {
            if (!(!i || typeof i == "string")) for (var r = 0, p = i.length; r < p; r++) {
              var u = i[r];
              if (u.type !== "code") {
                n(u.content);
                continue;
              }
              var g = u.content[1], a = u.content[3];
              if (g && a && g.type === "code-language" && a.type === "code-block" && typeof g.content == "string") {
                var c = g.content.replace(/\b#/g, "sharp").replace(/\b\+\+/g, "pp");
                c = (/[a-z][\w-]*/i.exec(c) || [
                  ""
                ])[0].toLowerCase();
                var k = "language-" + c;
                a.alias ? typeof a.alias == "string" ? a.alias = [
                  a.alias,
                  k
                ] : a.alias.push(k) : a.alias = [
                  k
                ];
              }
            }
          ...
          if (t.type === "code-block") {
            for (var n = "", i = 0, r = t.classes.length; i < r; i++) {
              var p = t.classes[i], u = /language-(.+)/.exec(p);
              if (u) {
                n = u[1];
                break;
              }
            ...
            if (g) t.content = e.highlight($(t.content.value), g, n);
              ...
              t.attributes.id = a, e.plugins.autoloader.loadLanguages(n, function() {
                var c = document.getElementById(a);
                c && (c.innerHTML = e.highlight(c.textContent, e.languages[n], n));
              });
            }
          }
        });
        var y = RegExp(e.languages.markup.tag.pattern.source, "gi"), v = {
          amp: "&",
          lt: "<",
          gt: ">",
          quot: '"'
        ...
        function $(t) {
          var n = t.replace(y, "");
          return n = n.replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, function(i, r) {
            if (r = r.toLowerCase(), r[0] === "#") {
              var p;
              return r[1] === "x" ? p = parseInt(r.slice(2), 16) : p = Number(r.slice(1)), x(p);
            } else {
              var u = v[r];
              return u || i;
            }
