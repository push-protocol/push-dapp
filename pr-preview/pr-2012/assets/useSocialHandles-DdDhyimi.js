import { f3 as W, fs as Z, f_ as O, hW as se, hX as ae, hY as re, ea as e, eA as M, hZ as oe, h_ as le, h$ as ce, e5 as $, h7 as U, e7 as h, gn as L, eQ as q, fY as z, eb as s, ep as a, gr as B, eq as Q, gB as de, gl as X, g1 as ee, en as V, ev as ge, __tla as __tla_0 } from "./index-UiBHnyIz.js";
import { u as _, c as R, a as H, __tla as __tla_1 } from "./index.esm-BhnmBROZ.js";
import { a as ne } from "./Common.form-NbJ1DVkQ.js";
import { C as ie, __tla as __tla_2 } from "./CopyButton-Dtk3JOVP.js";
import { D as G, __tla as __tla_3 } from "./Discord-WhjbuhH9.js";
import { u as N, __tla as __tla_4 } from "./useDisclosure-DhG6xuj0.js";
let Be, Me, $e, D, Le;
let __tla = Promise.all([
  ...
  pe = async (n) => {
    const i = await W({
      method: "POST",
      url: `${Z()}/apis/v1/users/verify/init/${n == null ? void 0 : n.caipAddress}/${n.social_platform}`,
      data: {
  ...
  fe = async (n) => {
    const i = await W({
      method: "POST",
      url: `${Z()}/apis/v1/users/verify/${n == null ? void 0 : n.caipAddress}/${n == null ? void 0 : n.social_platform}`,
      data: {
        value: n == null ? void 0 : n.value,
  ...
  xe = async (n) => {
    const i = await W({
      method: "POST",
      url: `${Z()}/apis/v1/users/${n == null ? void 0 : n.channelAddress}`,
      data: {
        verificationProof: n == null ? void 0 : n.verificationProof
      }
    });
  ...
  Be = ({ modalControl: n, refetchSocialHandleStatus: i, setErrorMessage: t, setSuccessMessage: C }) => {
    const { isOpen: v, onClose: p } = n, { account: b, wallet: u } = $(), { handleConnectWalletAndEnableProfile: f } = U(), [c, m] = h.useState(false), j = L({
      account: b
  ...
  Me = ({ modalControl: n, refetchSocialHandleStatus: i, setErrorMessage: t, setSuccessMessage: C }) => {
    var _a, _b;
    const { isOpen: v, onClose: p } = n, { account: b, wallet: u } = $(), { handleConnectWalletAndEnableProfile: f } = U(), c = L({
      account: b
  ...
  $e = ({ modalControl: n, refetchSocialHandleStatus: i }) => {
    var _a, _b;
    const { isOpen: t, onClose: C } = n, { account: v, wallet: p } = $(), { handleConnectWalletAndEnableProfile: b } = U(), u = L({
      account: v
