import { ea as t, er as Z, f_ as X, hg as ee, e5 as E, eb as s, ep as f, ev as A, es as te, gO as W, h9 as re, hh as ie, hb as ne, hc as $, hd as ae, h6 as se, e6 as K, eQ as le, h7 as oe, e8 as ue, e7 as w, eP as ce, e9 as O, fE as de, g0 as pe, ej as ge, gr as M, h4 as me, h5 as he, gY as z, eq as fe, fY as xe, gK as be, __tla as __tla_0 } from "./index-D1Swtpz3.js";
import { C as we, __tla as __tla_1 } from "./ContentLayout-jbLa4puu.js";
import { u as je, __tla as __tla_2 } from "./useDisclosure-D9xeWJDT.js";
import { C as Se, __tla as __tla_3 } from "./ChannelDashboardNullState-DtR2G8Kr.js";
import { A as ye, __tla as __tla_4 } from "./Add-9Yfu_231.js";
import { u as Ne, S as ve, g as Ce, a as ke, __tla as __tla_5 } from "./StakingVariant-DNq5gXe8.js";
import { u as Me, c as Re, F as Ve, d as g, e as B, a as Pe, f as _, b as De, __tla as __tla_6 } from "./index.esm-CwzlWqAK.js";
import { c as V, g as C, d as H } from "./Common.form-B0yEfNXt.js";
let nt;
let __tla = Promise.all([
  ...
  let Ie, Fe, Te, q, Be, He, qe, Oe, U, Ue, We, $e, ze, _e, Ke, Ge, Je;
  ...
  Be = ({ newSettings: e, channelSettings: r }) => {
    ...
    const { mutate: L, isPending: D } = Ne(), I = async () => {
    ...
    }, { mutate: F, isPending: T } = Le(), Y = async () => {
      let p = j;
      ...
      F({
        ...
        onSuccess: (d) => {
          d.transactionHash && (o(), n(`${O.ChannelDashboard(i)}`));
        },
        onError: (d) => {
      ...
      children: [
        ...
        t.jsxs(s, {
          ...
          children: [
            t.jsx(A, {
              variant: "outline",
              onClick: () => n(`${O.ChannelDashboard(i)}`),
              children: "Cancel"
            }),
            x >= q ? t.jsx(A, {
              onClick: Y,
  ...
  Oe = ({ children: e, initialValue: r, onSubmit: n }) => {
    const i = He(r), a = Me({
      initialValues: i,
  ...
  Ue = ({ checked: e, onChange: r }) => t.jsx(We, {
    id: "Checkbox-switch",
    type: "checkbox",
    checked: e,
    onChange: r
...
`;
  $e = () => {
    const { values: e, handleChange: r, setFieldValue: n, errors: i, touched: a } = U(), c = w.useMemo(() => {
  ...
  ze = () => {
    const { values: e, handleChange: r, touched: n, errors: i, setFieldValue: a } = U();
    return t.jsx(s, {
      width: "100%",
      children: t.jsx("form", {
        onSubmit: () => {
  ...
  _e = ({ isOpen: e, onClose: r, settingsToEdit: n, handleSettingsChange: i }) => {
    const { values: a, validateForm: c, setTouched: y, dirty: N, resetForm: j } = U(), S = async (o) => {
      if (y({
        settingName: true,
        defaultValue: true,
