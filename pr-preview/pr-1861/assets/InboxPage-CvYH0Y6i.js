...
`;t($)`
  width: 100%;
  margin-right: 10px;
`;const me=10,Mt=({showFilter:e,setShowFilter:r,search:s,setSearch:i})=>{const n=je(),{userPushSDKInstance:a}=H(l=>l.user),d=u.useRef(null);He(d,()=>e&&r(!1));const{account:x,chainId:S,provider:g}=ke(),{subscriptionStatus:y}=H(l=>l.channels),E=oe(),[w,k]=u.useState(null),j=()=>k(null),{run:R}=H(l=>l.userJourney),{notifications:P,page:J,finishedFetching:C}=H(l=>l.spam),[D,K]=u.useState(!1),[N,I]=u.useState(!1),U=({msg:l})=>o.jsx(Ht,{children:o.jsx(Ft,{children:l})});u.useEffect(()=>{w&&j()},[w]);const ge={POLYGON_TEST_AMOY:80002,ETH_TEST_KOVAN:42,ETH_TEST_GOERLI:5,ETH_TEST_SEPOLIA:11155111,POLYGON_MAINNET:137,ETH_MAINNET:1},ue=async()=>{if(!(N||C||R||!a)){I(!0);try{const l=await a.notification.list("SPAM",{limit:me,page:J,raw:!0});let b=q.utils.parseApiResponse(l);b.forEach((p,h)=>{p.date=l[h].epoch,p.epoch=new Date(p.date).getTime()/1e3});const c=l.map(async(p,h)=>{p.channel=l[h].sender;let f=l[h].sender;return{...p}});b=await Promise.all(c),n(fi(b)),b.length===0&&n(Xe())}catch(l){console.error(l)}finally{I(!1)}}},we=async()=>{if(!(N||D||R)){K(!0),I(!0);try{const l=await a.notification.list("SPAM",{limit:me,page:1,raw:!0});P.length||n(Ve());let b=q.utils.parseApiResponse(l);b.forEach((p,h)=>{p.date=l[h].epoch,p.epoch=new Date(p.date).getTime()/1e3});const c=b.map(async(p,h)=>{p.channel=l[h].sender;let f=l[h].sender;return{...p}});b=await Promise.all(c),n(pi({notifs:b,pageSize:me})),b.length===0&&n(Xe())}catch(l){console.error(l)}finally{K(!1),I(!1)}}};u.useEffect(()=>{a&&we()},[a]);const be=async()=>{ue(),n(Ve())},ve=l=>Number(l)===P.length-1&&!C&&!D,F=ci(),ye=async(l,b)=>{if(!l)return;let c=l;if(!c)return;console.debug(c),F.showLoaderToast({loaderMessage:"Waiting for Confirmation..."}),console.debug(g,x);const p=await g.getSigner(x);console.debug(p),console.debug({signer:p,channelAddress:ce(l,ge[b]),userAddress:ce(x,S)}),await q.channels.subscribe({signer:p,channelAddress:ce(l,S),userAddress:ce(x,S),onSuccess:()=>{F.showMessageToast({toastTitle:"Success",toastMessage:"Successfully opted into channel !",toastType:"SUCCESS",getToastIcon:h=>o.jsx(di,{size:h,color:"green"})}),n(xi({channelAddress:l,status:!0}))},onError:h=>{console.error(h),F.showMessageToast({toastTitle:"Error",toastMessage:"There was an error opting into channel",toastType:"ERROR",getToastIcon:f=>o.jsx(hi,{size:f,color:"red"})})},env:Ae.pushNodesEnv})},Se=l=>y[l],Ee=async({secret:l,title:b,message:c,image:p,cta:h})=>{try{let f=await O.decryptWithWalletRPCMethod(g,l,x);const m=await O.decryptWithAES(c,f);let v=await O.decryptWithAES(b,f),A=await O.decryptWithAES(p,f),L=await O.decryptWithAES(h,f);return{title:v,body:m,image:A,cta:L}}catch(f){f.code===4001?(console.error(f),_.dark(o.jsx(U,{msg:"User denied message decryption"}),{position:"bottom-right",type:_.TYPE.ERROR,autoClose:5e3,hideProgressBar:!0,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0})):f.code===-32601?(console.error(f),_.dark(o.jsx(U,{msg:"Your wallet doesn't support message decryption."}),{position:"bottom-right",type:_.TYPE.ERROR,autoClose:5e3,hideProgressBar:!0,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0})):(console.error(f),_.dark(o.jsx(U,{msg:"There was an error in message decryption"}),{position:"bottom-right",type:_.TYPE.ERROR,autoClose:5e3,hideProgressBar:!0,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0}))}};return o.jsx(Ge,{theme:E,children:o.jsx(Ut,{children:o.jsxs(Lt,{children:[P&&o.jsxs(It,{id:"scrollstyle-secondary",children:[D&&o.jsx($,{padding:"10px 20px",children:o.jsx(ae,{type:se.SEAMLESS})}),P.map((l,b)=>{const{cta:c,title:p,message:h,app:f,icon:m,image:v,secret:A,notification:L,channel:M,blockchain:G,url:Te}=l;return o.jsxs(zt,{children:[ve(b)&&!N&&o.jsx(B,{onEnter:be}),o.jsx(_e,{notificationTitle:p,notificationBody:h,cta:c,app:f,icon:m,image:v,theme:E.scheme,subscribeFn:()=>ye(M,G),isSpam:!0,isSubscribedFn:async()=>Se(M),isSecret:A!="",decryptFn:()=>Ee({secret:A,title:p,message:h,image:v,cta:c}),chainName:G,url:Te})]},b)}),N&&!D&&o.jsx(ae,{type:se.SEAMLESS})]}),!P.length&&!N&&o.jsx(Nt,{children:o.jsx(Ze,{title:"You currently have no spam notifications."})}),w&&o.jsx(Be,{notification:w,clearToast:j})]})})})},Nt=t.div`
  padding: 20px;
  display: flex;
  justify-content: center;
  align-items: center;
...
`,Ft=t.div`
  margin: 0px 10px;
`,Gt=({isSpam:e})=>{const[r,s]=u.useState(!e),[i,n]=u.useState(!1),[a,d]=u.useState("");oe();const x=Fe(),S=()=>s(y=>!y),g=y=>{S(),n(!1),d(""),x(y)};return o.jsxs(Wt,{children:[o.jsx(Yt,{children:o.jsxs(Jt,{children:[o.jsx(Ie,{isActive:r,onClick:()=>g(Oe.Inbox),children:"Inbox"}),o.jsx(Ie,{isActive:!r,onClick:()=>g(Oe.Spam),children:"Spam"})]})}),r?o.jsx(St,{showFilter:i,setShowFilter:n,search:a,setSearch:d}):o.jsx(Mt,{showFilter:i,setShowFilter:n,search:a,setSearch:d})]})},Wt=t.div`
  height: 100%;
  width: 100%;
`,Yt=t.div`
  margin: 0px 30px;
...
`;const Kt=Ae.coreContractChain,Vt=({isSpam:e})=>{mi.pageview(Oe.Inbox);const r=je(),{account:s,chainId:i,provider:n}=ke(),{epnsReadProvider:a,epnsCommReadProvider:d}=H(E=>E.contracts),[x,S]=z.useState(null),g=()=>S(null);oe();const y=Kt===i;return z.useEffect(()=>{x&&g()},[x]),z.useEffect(()=>{i&&async function(){const E=y?n:new gi(Ae.coreRPC),w=new Qe(ui.epnscore,qe.epnscore,E),k=wi[i].commAddress,j=new Qe(k,qe.epnsComm,n);r(bi(j)),r(vi(w))}()},[s,i]),z.useEffect(()=>{!a||!d||a.pushChannelAdmin().then(E=>{r(yi(E))}).catch(E=>{console.error({err:E})})},[a,d]),o.jsx(Xt,{children:o.jsxs(Qt,{children:[o.jsx("div",{className:"joyride"}),o.jsx(Gt,{isSpam:e}),x&&o.jsx(Be,{notification:x,clearToast:g})]})})},Xt=t(Si)`
  align-items: stretch;
  align-self: stretch;
  flex: 1;
  background: ${e=>e.theme.default.bg};
...
`,t.div`
  margin: 0px 10px;
`;let Ue;et=()=>{const e=Ei();return o.jsx(Ue,{children:o.jsx(Vt,{isSpam:e.pathname==="/spam"})})},Ue=t(Ti)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
`});export{Ci as __tla,et as default};
