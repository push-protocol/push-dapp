import{e7 as a,eO as e,eP as i,eQ as T,eR as s,fb as I,e9 as M,fc as A,e1 as t,eT as n,eU as m,eW as N,eb as u,eX as U,ed as h,fd as $,e8 as L,__tla as b}from"./index-B4-oOb9U.js";let f,G=Promise.all([(()=>{try{return b}catch{}})()]).then(async()=>{function E(){const r=I(),l=M(),{run:S}=A(p=>p.userJourney),g=()=>{S===!1&&r($(!0))};return t.jsx(c,{children:t.jsxs(n,{children:[t.jsxs(n,{align:"stretch",justify:"flex-start",margin:"0px 0px 40px 0px",children:[t.jsx(m,{children:t.jsx(s,{weight:"400",size:"32px",color:l.color,children:"Live Walkthrough"})}),t.jsx(s,{color:l.default.secondaryColor,weight:"400",size:"16px",textTransform:"none",textAlign:"center",spacing:"normal",margin:"0px 0px",children:"Let's walk you through the core functions of Push (EPNS), the communication protocol of Web3!"})]}),t.jsx(n,{justify:"flex-start",children:t.jsx(x,{children:t.jsxs(o,{onClick:()=>{g()},hover:"#e20880",children:[t.jsx(s,{color:l.color,children:"\u{1F449} Show me everything!"}),t.jsx(N,{size:20,color:"#ddd"})]})})})]})})}let c,o,d,x,D;c=a(u)`
  align-items: center;
  align-self: center;
