import{e7 as d,el as O,fB as re,d_ as f,fC as ae,e1 as t,dY as G,fc as X,fb as q,ej as k,fD as ie,fE as Q,e9 as Z,eV as v,fF as le,fG as ce,fH as de,em as pe,ep as ge,e3 as ee,e4 as te,fI as A,fJ as he,fK as ne,fL as E,f1 as se,fM as ue,fN as xe,fO as fe,__tla as we}from"./index-CaeazFax.js";import{u as Se,n as me}from"./notifSetting-DrLKauYy.js";let oe,je=Promise.all([(()=>{try{return we}catch{}})()]).then(async()=>{let I,P,_,B,$,V,W,H,F,z,U,N,J,K,L,Y;I=({children:n,renderDropdownContainer:p,showDropdown:a,toggleDropdown:g,closeDropdown:s,containerPadding:u,centerOnMobile:i})=>{const c=f.useRef(null),l=f.useRef(null);return ae(c,l,s),t.jsxs(P,{ref:c,onClick:g,children:[n,a&&t.jsx(_,{containerPadding:u,centerOnMobile:i,children:t.jsx("div",{ref:l,onClick:e=>e.stopPropagation(),children:p})})]})},P=d.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
