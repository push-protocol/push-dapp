...
`;ge.coreContractChain;const Zt=({setActiveTab:t})=>{const{account:s,provider:o}=ye(),[l,r]=n.useState(null),[a,h]=n.useState(null),[x,d]=n.useState(null),[u,v]=n.useState(null),[E,_]=n.useState(null),[B,N]=n.useState(null),[V,G]=n.useState(null),[O,ee]=n.useState(null),[F,ae]=n.useState(null),[Y,H]=n.useState(null),k=o==null?void 0:o.getSigner(s),$=n.useCallback(async()=>{const U=await Ce.getInstance().getPoolStats();N({...U})},[l,a,x,u,E]),M=n.useCallback(async()=>{const U=await Ce.getInstance().getPUSHPoolStats();G({...U})},[l,a,x,u,E]),w=n.useCallback(async U=>{const Q=await Ce.getInstance().getLPPoolStats(U);ee({...Q})},[l,a,x,u,E]),R=n.useCallback(async()=>{const U=await Ce.getInstance().getUserData(u);ae({...U})},[u]),K=n.useCallback(async()=>{const U=await Ce.getInstance().getUserData(x);H({...U})},[x]);n.useEffect(()=>{let U=new b(p.pushToken,y.pushToken,k),Q=new b(p.staking,y.staking,k),fe=new b(p.depYieldFarmPUSH,y.yieldFarming,k),T=new b(p.depYieldFarmLP,y.yieldFarming,k),m=new b(p.uniswapV2Router02,y.uniswapV2Router02,k);if(r(U),h(Q),v(fe),d(T),_(m),k&&s){var g=o.getSigner(s);let C=new b(p.pushToken,y.pushToken,g),S=new b(p.staking,y.staking,g),j=new b(p.depYieldFarmPUSH,y.yieldFarming,g),A=new b(p.depYieldFarmLP,y.yieldFarming,g),z=new b(p.uniswapV2Router02,y.uniswapV2Router02,g);r(C),h(S),v(j),d(A),_(z)}},[s]),n.useEffect(()=>{l!=null&&a!=null&&u!=null&&(Ce.getInstance().init(s,l,a,u,x,E),$())},[$]),n.useEffect(()=>{B&&we(B)},[B]);const we=async U=>{M(),w(U),R(),K()};return e.jsxs(e.Fragment,{children:[e.jsx(wt,{logo:"WarningCircle",title:"This reward program (V1) has ended.",body:"To continue earning rewards please migrate to new pools.",setActiveTab:t}),e.jsxs(Xt,{children:[e.jsx(ht,{poolName:"PUSH",userData:F,PoolStats:V,poolAddress:p.depYieldFarmPUSH,getUserData:R,getPoolStats:M,tokenAddress:p.pushToken,setActiveTab:t}),e.jsx(ht,{poolName:"UNI-V2",userData:Y,PoolStats:O,poolAddress:p.depYieldFarmLP,getUserData:K,getPoolStats:w,tokenAddress:p.uniV2LPToken,setActiveTab:t})]})]})},Xt=i(f)`
...
`,Ae=i(be)`
  ...
  border-radius: 5px;
  gap: 5px;
`,Rs=({setActiveTab:t})=>{const{provider:s,account:o,chainId:l}=ye(),[r,a]=n.useState(),[h,x]=n.useState(),[d,u]=n.useState(),[v,E]=n.useState(),[_,B]=n.useState(),[N,V]=n.useState(null),[G,O]=n.useState(null),[ee,F]=n.useState(null),[ae,Y]=n.useState(null),[H,k]=n.useState(null),$=s==null?void 0:s.getSigner(o),M=n.useCallback(async()=>{const U=await Re.getInstance().getPoolStats(s);V({...U})},[h,r,v,d,_,s]),w=n.useCallback(async()=>{const U=await Re.getInstance().getPoolStats(s),Q=await Re.getInstance().getLPPoolStats(U);O({...Q})},[h,r,v,d,_,s]),R=n.useCallback(async()=>{},[]),K=n.useCallback(async()=>{const U=await Re.getInstance().getUserDataLP();F({...U})},[h,r,v,d,_]),we=n.useCallback(async()=>{const[U,Q]=await Re.getInstance().getUserDataPUSH(s);k({...U}),Y({...Q})},[h,r,v,d,_,s]);return n.useEffect(()=>{if(l!==ge.coreContractChain&&l!==ge.mainnetCoreContractChain)return;O(null),F(null),k(null),Y(null);let U=new b(p.stakingV2,y.stakingV2,$),Q=new b(p.pushToken,y.pushToken,$),fe=new b(p.pushCoreV2,y.pushCoreV2,$),T=new b(p.yieldFarmLP,y.yieldFarming,$),m=new b(p.uniswapV2Router02,y.uniswapV2Router02,$);if(x(U),a(Q),E(fe),u(T),B(m),$&&o){var g=s==null?void 0:s.getSigner(o);let C=new b(p.stakingV2,y.stakingV2,g),S=new b(p.pushToken,y.pushToken,g),j=new b(p.pushCoreV2,y.pushCoreV2,g),A=new b(p.yieldFarmLP,y.yieldFarming,g),z=new b(p.uniswapV2Router02,y.uniswapV2Router02,g);x(C),a(S),E(j),u(A),B(z)}Re.getInstance().init(o,U,Q,fe,T,m),M(),K(),w(),we()},[o,l]),e.jsxs(e.Fragment,{children:[e.jsx(wt,{logo:"announcement",title:"New V2 Pools are now Live! Stake or migrate now.",body:"Users who were part of the previous Push staking program, need to migrate to new pools to continue earning rewards. Click",setActiveTab:t}),e.jsx(ts,{getLpPoolStats:w,poolStats:N,setPoolStats:V}),e.jsx(qt,{poolStats:N}),e.jsxs(Fs,{children:[e.jsx(fs,{userDataPush:ae,getUserDataPush:we,PUSHPoolstats:H,getPUSHPoolStats:R}),e.jsx(ls,{lpPoolStats:G,userDataLP:ee,getLpPoolStats:w,getUserDataLP:K})]})]})},Fs=i(f)`
  @media (max-width: 1300px) {
    flex-direction: column;
  }
...
`,Ds=i.div``;ge.coreContractChain;let yt,kt,Pt,rt,Et;yt=()=>{_s.pageview("/yield");const[t,s]=n.useState(0),[o,l]=n.useState(!1),{account:r,chainId:a,switchChain:h}=ye(),x=()=>{const E=ge.allowedNetworks[0];a!==1&&a!==5&&h(E)};n.useEffect(()=>{a!==1&&a!==11155111&&(u(),x())},[a]);const{isModalOpen:d,showModal:u,ModalComponent:v}=Je();return e.jsxs(kt,{children:[e.jsx(v,{InnerComponent:Ms,onConfirm:()=>{},modalPadding:"0px",modalPosition:Ke.ON_PARENT}),e.jsxs(Pt,{children:[e.jsx(rt,{isActive:!t,onClick:()=>{l(!0),s(0)},children:"Yield Farming V2"}),e.jsxs(rt,{isActive:t,onClick:()=>{l(!1),s(1)},children:["Yield Farming V1 ",e.jsx(Et,{children:"Deprecated"})]})]}),t===0&&e.jsx(Rs,{setActiveTab:s}),t===1&&e.jsx(Zt,{setActiveTab:s})]})},kt=i(We)`
	align-items: stretch;
	align-self: center;
  flex: 1;
	background: ${t=>t.theme.default.bg};
  ...
  box-sizing: border-box;
  width: calc(
    100% - ${Xe.MINI_MODULES.DESKTOP.RIGHT} - ${Xe.MINI_MODULES.DESKTOP.LEFT} -
  ...
  @media ${Ze.tablet} {
    width: calc(
      100% - ${Xe.MINI_MODULES.TABLET.RIGHT} - ${Xe.MINI_MODULES.TABLET.LEFT} -
...
`,Et=i(me)`
  ...
  height: 17px;
  width: fit-content;
`,zt=()=>e.jsx(Ks,{children:e.jsx(yt,{})})});export{Xs as __tla,zt as default};
