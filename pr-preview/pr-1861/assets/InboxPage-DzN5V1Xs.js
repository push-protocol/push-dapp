...
`,Ft=t.div`
  margin: 0px 10px;
`,Gt=({isSpam:e})=>{const[r,s]=u.useState(!e),[i,n]=u.useState(!1),[a,c]=u.useState("");oe();const x=Fe(),S=()=>s(y=>!y),m=y=>{S(),n(!1),c(""),x(y)};return o.jsxs(Wt,{children:[o.jsx(Yt,{children:o.jsxs(Jt,{children:[o.jsx(Ie,{isActive:r,onClick:()=>m(_e.Inbox),children:"Inbox"}),o.jsx(Ie,{isActive:!r,onClick:()=>m(_e.Spam),children:"Spam"})]})}),r?o.jsx(St,{showFilter:i,setShowFilter:n,search:a,setSearch:c}):o.jsx(Mt,{showFilter:i,setShowFilter:n,search:a,setSearch:c})]})},Wt=t.div`
  height: 100%;
  width: 100%;
`,Yt=t.div`
  margin: 0px 30px;
...
`;const Kt=Oe.coreContractChain,Vt=({isSpam:e})=>{gi.pageview(_e.Inbox);const r=je(),{account:s,chainId:i,provider:n}=ke(),{epnsReadProvider:a,epnsCommReadProvider:c}=H(E=>E.contracts),[x,S]=U.useState(null),m=()=>S(null);oe();const y=Kt===i;return U.useEffect(()=>{x&&m()},[x]),U.useEffect(()=>{i&&async function(){const E=y?n:new mi(Oe.coreRPC),w=new qe(ui.epnscore,Qe.epnscore,E),k=wi[i].commAddress,j=new qe(k,Qe.epnsComm,n);r(bi(j)),r(vi(w))}()},[s,i]),U.useEffect(()=>{!a||!c||(a.pushChannelAdmin().then(E=>{r(yi(E))}).catch(E=>{console.error({err:E})}),a!=null&&c!=null&&(Si.getInstance().init(s,a,c),Ei.getInstance().init(s,a,c,i)))},[a,c]),o.jsx(Xt,{children:o.jsxs(qt,{children:[o.jsx("div",{className:"joyride"}),o.jsx(Gt,{isSpam:e}),x&&o.jsx(Be,{notification:x,clearToast:m})]})})},Xt=t(Ti)`
  align-items: stretch;
  align-self: stretch;
  flex: 1;
  background: ${e=>e.theme.default.bg};
