...
`;c.button`
  ...
  ${e=>e.disabled&&X`
    ...
    `}
`;let Ne,Me,ge,xe,Le,ze,Ct,Nt;Ne=c(ca)`
  &.v1 {
    background-color: #adb5bd;
  }
  &.v2 {
...
`,ze=c(ga)`
  color: #e20880;
  font-weight: 500;
`,Ct=()=>o.jsx(Nt,{children:o.jsx(oa,{})}),Nt=c(xa)`
  flex: 1;
  flex-direction: column;
  align-self: stretch;
  justify-content: flex-start;
