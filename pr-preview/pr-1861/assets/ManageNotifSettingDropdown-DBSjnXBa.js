import{e7 as d,el as O,fE as re,d_ as f,fF as ae,e1 as t,dY as G,fc as Q,fb as X,ej as P,fG as ie,fH as q,e9 as Z,eV as v,fI as le,fJ as ce,fK as de,em as pe,ep as ge,e3 as ee,e4 as te,fL as k,fM as he,fN as ne,fO as E,f1 as se,fP as ue,fQ as xe,fR as fe,__tla as we}from"./index-lklA0Vfr.js";import{u as Se,n as me}from"./notifSetting-DrLKauYy.js";let oe,je=Promise.all([(()=>{try{return we}catch{}})()]).then(async()=>{let I,A,_,$,B,V,W,H,F,z,U,N,J,K,L,Y;I=({children:n,renderDropdownContainer:p,showDropdown:a,toggleDropdown:g,closeDropdown:s,containerPadding:u,centerOnMobile:i})=>{const c=f.useRef(null),l=f.useRef(null);return ae(c,l,s),t.jsxs(A,{ref:c,onClick:g,children:[n,a&&t.jsx(_,{containerPadding:u,centerOnMobile:i,children:t.jsx("div",{ref:l,onClick:e=>e.stopPropagation(),children:p})})]})},A=d.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
