import{e7 as d,en as O,fH as re,d_ as f,fI as ae,e1 as t,dY as Y,fh as Q,fg as q,ej as P,fJ as ie,fK as G,e9 as Z,eX as v,fL as le,fM as ce,fN as de,eo as pe,es as ge,e3 as ee,e4 as te,fO as k,fP as he,fQ as ne,fR as E,f6 as se,fS as ue,fT as xe,fU as fe,__tla as we}from"./index-tumxrPY4.js";import{u as Se,n as me}from"./notifSetting-DrLKauYy.js";let oe,je=Promise.all([(()=>{try{return we}catch{}})()]).then(async()=>{let I,A,_,$,B,W,V,H,U,z,F,N,J,K,L,X;I=({children:n,renderDropdownContainer:p,showDropdown:a,toggleDropdown:g,closeDropdown:s,containerPadding:u,centerOnMobile:i})=>{const c=f.useRef(null),l=f.useRef(null);return ae(c,l,s),t.jsxs(A,{ref:c,onClick:g,children:[n,a&&t.jsx(_,{containerPadding:u,centerOnMobile:i,children:t.jsx("div",{ref:l,onClick:e=>e.stopPropagation(),children:p})})]})},A=d.span`
  position: relative;
  margin: 0;
  padding: 0;
  background: none;
