...
export function useInactiveListener() {
  ...
  const getErrorMessage = () => {
    if (appConfig.coreContractChain === 42)
      ...
      return 'Unsupported Network, please connect to the Ethereum Sepolia, Polygon Amoy, BNB testnet, Optimism Sepolia, Arbitrum Sepolia, Linea Sepolia or Polygon zkEVM testnet';
    else
      return 'Unsupported Network, please connect to the Ethereum, Polygon, BNB, Optimism, Arbitrum, Linea or Polygon zkEVM Mainnet';
  };
