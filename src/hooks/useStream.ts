...
import { NotificationEvent, NotificationEventType, STREAM } from '@pushprotocol/restapi/src/lib/pushstream/pushStreamTypes';
...
const useSDKStream = () => {
    ...
    useEffect(() => {
        ...
        eventlistener(userPushSDKInstance, STREAM.NOTIF, (feedItem: NotificationEvent) => {
            /**
