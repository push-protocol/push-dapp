...
const YieldStatsSection = ({ getLpPoolStats, poolStats, setPoolStats }) => {
        ...
        {poolStats ? (
          <>
            <StatsText>
              ...
              <SecondaryText>{`$ ${numberWithCommas(poolStats?.totalValueLocked.toFixed(2))}`}</SecondaryText>
            </StatsText>
          </>
        ) : (
          <SkeletonLoader />
        ...
        {formattedDuration ? (
          <>
            <StatsText>
              ...
              <TextBox justifyContent="end">
                <SecondaryText>{formattedDuration}</SecondaryText>
                <SpanV2
                  color="#fff"
                  fontSize="16px"
                  fontWeight="600"
...
const SkeletonLoader = () => {
  ...
  return (
    <SkeletonContainer padding="21px 15px">
      <SkeletonLine
        height="12px"
        width="135px"
        margin="0 0 10px 0"
