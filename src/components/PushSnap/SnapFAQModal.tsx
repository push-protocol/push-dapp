            ...
            {openIndex == 1 && (
              <Answer>
                ...
                >
                  ...
                  and click on Receive Notifications section, from there install the snap by giving it the required
                  permissions, after adding addresses, you’re all set to start receiving notifications.
                </SpanV2>
              </Answer>
            )}
          </QnAItem>
            ...
            {openIndex == 2 && (
              <Answer>
                <SpanV2
                  ...
                  textAlign="left"
                >
                  The addresses to receive notifications can be added only after signing a message, which proves the
                  ownership of that address, hence un-owned addresses cannot be added.
                </SpanV2>
              </Answer>
            )}
          </QnAItem>
            ...
            {openIndex == 3 && (
              <Answer>
                <SpanV2
                  ...
                  textAlign="left"
                >
                  Yes, the snap can run only on in-app notifications, to avail that, you need to go through the push
                  snap settings in push dapp and turn off pop-up notifications.
                </SpanV2>
              </Answer>
            )}
          </QnAItem>
            ...
            {openIndex == 5 && (
              <Answer>
                <SpanV2
                  ...
                  textAlign="left"
                >
                  No, the snap does not have access to the Ethereum provider nor the signer hence the snap cannot
                  initiate any kind of transaction that may or may not involve asset transfers.
                </SpanV2>
              </Answer>
            )}
          </QnAItem>
            ...
            {openIndex == 6 && (
              <Answer>
                <SpanV2
                  ...
                  textAlign="left"
                >
                  Snap has an in-built feature to snooze frequent pop-up notifications, if you receive more than 25
                  notifications within 5 minutes, it automatically goes into snooze mode and notification would only
                  come in the MetaMask. This settings can be reset from the Dapp{' '}
                  <Link
                    href="https://app.push.org/snap"
                    target="_blank"
                  >
          ...
          <QnAItem>
            ...
            {openIndex == 8 && (
              <Answer>
                ...
                <UL>
                  <LI>
                    Go to snap settings on Push Dapp{' '}
                    <Link
                      href="https://app.push.org/snap"
                      target="_blank"
                    >
          ...
          <QnAItem>
            ...
            >
              <Span color={theme.color}>
                If I add more than one wallet to Push Snap, will I receive notifications for all of them?
              </Span>
              {openIndex === 9 ? (
                <UpArrow
                  color="#ADB0BE"
