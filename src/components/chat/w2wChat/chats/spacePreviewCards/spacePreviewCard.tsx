...
const SpacePreviewCard = ({ borderRadius, background, spaceData }) => {
  const remindMe = () => {};

  return (
    <SpacePreviewContainer borderRadius={borderRadius} background={background}>
      <SpacePreviewHeader>
        <ItemVV2
          width="32px"
          height="32px"
      ...
      <RemindButton onClick={() => remindMe()}>Remind Me</RemindButton>
