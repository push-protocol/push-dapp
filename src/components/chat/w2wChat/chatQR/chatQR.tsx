...
const ChatQR = ({ type = LOADER_TYPE.STANDALONE, overlay = LOADER_OVERLAY.NORMAL, blur = 0, width = 'auto' }) => {
        ...
        <>
          {pgpPvtKey ? (
            ...
            >
              ...
              <QRContainer>
                <TextContainer>
                  <QRHeading>Set up Push Chat on your phone</QRHeading>
                  <TextInfo>
                  ...
                  <div>
                    <NoteText>
                      ...
                      The QR code enables mobile app that supports Push Protocol to read and send messages. Only scan it
                      with mobile apps you trust.
                    </NoteText>
                  </div>
                </TextContainer>
                <ItemHV2>{qrcode}</ItemHV2>
              </QRContainer>
            </Container>
          ) : null}
        </>
