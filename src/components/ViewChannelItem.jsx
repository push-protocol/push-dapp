...
import { Button, deviceMediaQ } from 'blocks';
            ...
            <ChannelLogoOuter>
              <ChannelLogoInner minimal={minimal}>
                {loading ? (
                  ...
                  <ChannelLogoImg src={`${channelObject.iconV2 ? channelObject.iconV2 : channelObject.icon}`} />
                )}
              </ChannelLogoInner>
            </ChannelLogoOuter>
          </ChannelLogo>
                ...
                {isOwner && (
                  <>
                    {profileType == 'Profile' ? (
                      ...
                      <OwnerLabel disabled>Owner</OwnerLabel>
                    )}
                  </>
                )}
