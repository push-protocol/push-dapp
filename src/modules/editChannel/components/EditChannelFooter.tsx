...
const EditChannelFooter: FC<EditChannelFooterProps> = ({
  ...
  const { values: formValues, isValid, initialValues, errors } = useEditChannelForm();
  ...
  const handleEditChannel = async () => {
    ...
    console.log("formValues.channelIcon", formValues.channelIcon);
  ...
  return (
    <Box display="flex" flexDirection="column" alignSelf="stretch" gap='spacing-xs'>
