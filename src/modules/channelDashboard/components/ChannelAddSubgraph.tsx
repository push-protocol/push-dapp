...
const ChannelAddSubgraph: FC<ChannelAddSubgraphProps> = ({ setActiveState }) => {
  ...
  return (
    ...
    >
      <ModalHeader title="Add Subgraph" description="Enter Subgraph ID and Poll time (atleast 60 sec)" />
