...
import { Content, H2V2, ItemVV2, SectionV2, SpanV2 } from 'components/reusables/SharedStylingV2';
        ...
        <BodySection>
          <Content className="content">
            ...
            >
              ...
              <TextH2>
                <SpanV2 className="text">Create Your Channel</SpanV2>
              </TextH2>
              <SpanV2 className="body-text">
...
const BodySection = styled(SectionV2)`
  margin: 0px 0px 40px;
