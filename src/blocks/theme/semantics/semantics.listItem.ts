...
export const listItemSemantics = {
  'background-default': { light: surfaceSemantics['primary'], dark: surfaceSemantics['primary'] },
  'background-hover': { light: surfaceSemantics['secondary'].light, dark: surfaceSemantics['secondary'].dark },
  ...
  'text-error': { light: textSemantics['state-danger-bold'].light, dark: textSemantics['state-danger-bold'].dark },
  ...
  'icon-error': { light: iconSemantics['state-danger-bold'].light, dark: iconSemantics['state-danger-bold'].dark },
