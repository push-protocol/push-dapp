...
export const alertSemantics = {
  ...
  'icon-basic': { light: colorPrimitives['gray-200'], dark: colorPrimitives['gray-100'] },
  ...
  'text-cta-basic': { light: colorPrimitives['gray-500'], dark: colorPrimitives['gray-300'] },
  ...
  'background-basic': { light: colorPrimitives['white-100'], dark: colorPrimitives['gray-900'] },
  ...
  'stroke-basic': { light: colorPrimitives['gray-300'], dark: colorPrimitives['gray-700'] },
};
