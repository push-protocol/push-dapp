      ...
      <Channel>
        <Notice>
          ...
          {uploadDone && !processing && (
            <Info>
              Image Verified! Just fill in your other information and hit <b>Beam me up</b> to create your channel...
              literal goosebumps!!!
            </Info>
          )}
          {!uploadDone && (
            <>
              <Info>
                <b>Push</b> (previously EPNS) makes it extremely easy to open and maintain a genuine channel of
                communication with your users.
              </Info>
              <Info>
                The only step for <b>You</b> or your <b>dApp</b> or even your <b>Smart Contract</b> is opening up the
                channel.
              </Info>
              <Info>
                Rest of the heavy lifting of securely connecting users, wallets, device tokens, listening to and
                ensuring sent events, forming and delivering payload to each mobile or destop devices and informing them
                and you about it is done automagically by EPNS.
              </Info>
            </>
          )}
        </Notice>
        ...
        <>
          {!uploadDone && (
            <DropzoneContainer>
              <Info>
                Drop in your channel <b>(dApp or Website) official logo</b> here and submit first.
              </Info>
              <Dropzone
